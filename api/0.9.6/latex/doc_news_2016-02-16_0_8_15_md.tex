...
See \href{https://libelektra.org}{\texttt{ https\+://libelektra.\+org}}\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2721}{}\doxysection{Overview}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2721}
...
\item the spec mount.
\end{DoxyEnumerate}\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2723}{}\doxysection{Spec Plugin}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2723}
...
But we want {\ttfamily check/type} to be not only a documentation, but also enforced.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2724}{}\doxysection{Spec Mount}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2724}
...
The main idea of the spec-\/mount is\+: search a plugin for every specification (metadata) found in the spec-\/namespace.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2725}{}\doxysection{General Mount Improvements}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2725}
...
Thanks to Manuel Mausz for fixing many bugs related to the library split and also adapting all the bindings for it.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2727}{}\doxysubsection{Benchmark}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2727}
...
{\ttfamily libelektra.\+so} is still present for compatibility reasons. It should not be used for new applications. Some unimportant parts, however, moved to the \char`\"{}sugar\char`\"{} libraries. E.\+g. the symbol {\ttfamily elektra\+Key\+Cut\+Name\+Part} is no longer part of {\ttfamily libelektra.\+so}.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2729}{}\doxysubsection{Bootstrapping}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2729}
...
\href{https://github.com/ElektraInitiative/libelektra/blob/master/doc/decisions/bootstrap.md}{\texttt{ Details are here}}\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2730}{}\doxysection{Plugins}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2730}
...
Larger changes were done in the following plugins\+:\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2731}{}\doxysubsection{INI}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2731}
...
A huge thanks to Thomas Waser.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2732}{}\doxysubsection{Rename}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2732}
Thanks to Thomas Waser {\ttfamily rename} is now fixed for cascading keys. Additionally, it does not change the {\ttfamily sync} status of the keys so that notification plugins work properly afterwards.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2733}{}\doxysubsection{Crypto}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2733}
...
Thanks to Peter Nirschl, especially the patience for also supporting different platforms where dependencies need to be handled differently.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2734}{}\doxysection{KDB}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2734}
...
\end{DoxyItemize}\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2736}{}\doxysection{C++11 migration}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2736}
...
If you haven\textquotesingle{}t removed it from your flags already, there is no use anymore to set {\ttfamily ENABLE\+\_\+\+CXX11}.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2737}{}\doxysection{Documentation}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2737}
...
\end{DoxyItemize}\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2739}{}\doxysection{Packaging and Build System}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2739}
...
Read about \href{https://github.com/ElektraInitiative/libelektra\#packages}{\texttt{ other packages here}}.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2740}{}\doxysection{Fixes and Improvements}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2740}
...
\end{DoxyItemize}\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2741}{}\doxysection{Get It!}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2741}
...
already built API-\/\+Docu can be found \href{https://doc.libelektra.org/api/0.8.15/html/}{\texttt{ here}}\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2742}{}\doxysection{Stay tuned!}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2742}
