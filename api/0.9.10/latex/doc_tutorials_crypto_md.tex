...
\item {\ttfamily fcrypt}.
\end{DoxyEnumerate}\hypertarget{doc_tutorials_crypto_md_autotoc_md3801}{}\doxysection{Prerequisites -\/ Gnu\+PG}\label{doc_tutorials_crypto_md_autotoc_md3801}
...
The {\ttfamily fcrypt} plugin and the {\ttfamily crypto} plugin support both versions (version 1 and version 2) of GPG.\hypertarget{doc_tutorials_crypto_md_autotoc_md3802}{}\doxysection{Introduction}\label{doc_tutorials_crypto_md_autotoc_md3802}
...
We also show how to approach integrity with the signature features of the {\ttfamily fcrypt} plugin.\hypertarget{doc_tutorials_crypto_md_autotoc_md3803}{}\doxysection{Configuration File Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md3803}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3804}{}\doxysection{Configuration File Signatures}\label{doc_tutorials_crypto_md_autotoc_md3804}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3805}{}\doxysubsection{Combining Signatures and Encryption}\label{doc_tutorials_crypto_md_autotoc_md3805}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3806}{}\doxysection{Configuration Value Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md3806}
...
As a result you get \char`\"{}1234\char`\"{}.\hypertarget{doc_tutorials_crypto_md_autotoc_md3808}{}\doxysubsection{Disabling Encryption}\label{doc_tutorials_crypto_md_autotoc_md3808}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3809}{}\doxysubsection{Complete Example}\label{doc_tutorials_crypto_md_autotoc_md3809}
The complete example looks like this\+:
