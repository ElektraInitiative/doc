...
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md547}{}\doxysubsection{$<$tt$>$benchmark\+\_\+storage$<$/tt$>$}\label{md_src_plugins_quickdump_benchmarks_autotoc_md547}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md548}{}\doxysubsection{$<$tt$>$benchmark\+\_\+plugingetset$<$/tt$>$}\label{md_src_plugins_quickdump_benchmarks_autotoc_md548}
...
\hline
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ no. of keys }&\PBS\raggedleft \cellcolor{\tableheadbgcolor}\textbf{ raw size WP (B) }&\PBS\raggedleft \cellcolor{\tableheadbgcolor}\textbf{ raw size W\+OP (B)  }\\\cline{1-3}
\endfirsthead
\hline
\endfoot
\hline
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md550}{}\doxysubsubsection{Version 1}\label{md_src_plugins_quickdump_benchmarks_autotoc_md550}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md551}{}\doxyparagraph{File sizes}\label{md_src_plugins_quickdump_benchmarks_autotoc_md551}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md552}{}\doxyparagraph{get and set}\label{md_src_plugins_quickdump_benchmarks_autotoc_md552}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md553}{}\doxyparagraph{get only}\label{md_src_plugins_quickdump_benchmarks_autotoc_md553}
The values are mean ± standard deviation. {\ttfamily factor} is {\ttfamily dump / quickdump} like above
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md554}{}\doxysubsubsection{Version 2}\label{md_src_plugins_quickdump_benchmarks_autotoc_md554}
Running the same {\ttfamily benchmark\+\_\+plugingetset} tests with version 2 of the plugin yields\+:\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md555}{}\doxyparagraph{File sizes}\label{md_src_plugins_quickdump_benchmarks_autotoc_md555}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md556}{}\doxyparagraph{get and set}\label{md_src_plugins_quickdump_benchmarks_autotoc_md556}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md557}{}\doxyparagraph{get only}\label{md_src_plugins_quickdump_benchmarks_autotoc_md557}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md558}{}\doxysubsubsection{Version 3}\label{md_src_plugins_quickdump_benchmarks_autotoc_md558}
Running the same {\ttfamily benchmark\+\_\+plugingetset} tests with version 3 of the plugin yields\+:\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md559}{}\doxyparagraph{File sizes}\label{md_src_plugins_quickdump_benchmarks_autotoc_md559}
{\ttfamily factor} is {\ttfamily v1 / v2} like above (bigger is better)
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md560}{}\doxyparagraph{get and set}\label{md_src_plugins_quickdump_benchmarks_autotoc_md560}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md561}{}\doxyparagraph{get only}\label{md_src_plugins_quickdump_benchmarks_autotoc_md561}
