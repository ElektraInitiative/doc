...
Elektra provides a mature, consistent and easily comprehensible API. Its modularity effectively avoids code duplication across applications and tools concerning their configuration tasks. Elektra abstracts from cross-\/platform-\/related issues and enables applications to be aware of other applications\textquotesingle{} configurations, leveraging easy application integration.\hypertarget{README_md_autotoc_md3765}{}\doxysection{Often Used Links}\label{README_md_autotoc_md3765}
...
\end{DoxyItemize}\hypertarget{README_md_autotoc_md3766}{}\doxysection{Overview}\label{README_md_autotoc_md3766}
...
In case you are worried about linking to such a powerful library. The core is a small library implemented in C, works cross-\/platform, and does not need any external dependencies. There are bindings for other languages in case C is too low-\/level for you.\hypertarget{README_md_autotoc_md3767}{}\doxysection{Contact}\label{README_md_autotoc_md3767}
Do not hesitate to ask any question on \href{https://issues.libelektra.org/}{\texttt{ Git\+Hub issue tracker}} or directly to one of the \mbox{\hyperlink{doc_AUTHORS_md}{authors}}.\hypertarget{README_md_autotoc_md3768}{}\doxysection{Quickstart}\label{README_md_autotoc_md3768}
\hypertarget{README_md_autotoc_md3769}{}\doxysubsection{Installation}\label{README_md_autotoc_md3769}
...
\hypertarget{README_md_autotoc_md3770}{}\doxysubsection{Usage}\label{README_md_autotoc_md3770}
...
\end{DoxyItemize}\hypertarget{README_md_autotoc_md3771}{}\doxysubsection{Documentation}\label{README_md_autotoc_md3771}
...
\hypertarget{README_md_autotoc_md3772}{}\doxysection{Facts and Features}\label{README_md_autotoc_md3772}
...
\item Elektra is able to log and notify other software on any configuration changes, for example, using \mbox{\hyperlink{md_src_plugins_dbus_README_src_plugins_dbus_README_md}{Dbus}} and \mbox{\hyperlink{md_src_plugins_journald_README_src_plugins_journald_README_md}{Journald}}.
\item Elektra can improve robustness by rejecting invalid configuration via \mbox{\hyperlink{md_src_plugins_type_README_src_plugins_type_README_md}{type checking}}, \mbox{\hyperlink{md_src_plugins_validation_README_src_plugins_validation_README_md}{regex}} and more.
\item Elektra provides different mechanisms to \mbox{\hyperlink{md_src_plugins_resolver_README_src_plugins_resolver_README_md}{locate configuration files}}.
\item Elektra supports different ways to \mbox{\hyperlink{md_src_plugins_ccode_README_src_plugins_ccode_README_md}{escape}} and \mbox{\hyperlink{md_src_plugins_iconv_README_src_plugins_iconv_README_md}{encode}} content of configuration files.
\end{DoxyItemize}
\item Elektra is multi-\/process safe and can be used in multi-\/threaded programs.
\item Elektra (except for some \mbox{\hyperlink{src_plugins_README_md}{plugins}}) is portable and completely written in ANSI C99.
...
\end{DoxyItemize}\hypertarget{README_md_autotoc_md3773}{}\doxysection{News}\label{README_md_autotoc_md3773}
Go to the \href{https://www.libelektra.org}{\texttt{ website}}, see the news, and its \href{https://www.libelektra.org/news/feed.rss}{\texttt{ RSS feed}}.\hypertarget{README_md_autotoc_md3774}{}\doxysection{Download}\label{README_md_autotoc_md3774}
...
Releases can be downloaded from \href{https://www.libelektra.org/ftp/elektra/releases/}{\texttt{ here}}.\hypertarget{README_md_autotoc_md3775}{}\doxysection{Build Server}\label{README_md_autotoc_md3775}
The \href{https://build.libelektra.org/}{\texttt{ build server}} builds Elektra for every pull request and on every commit in various ways and also produces \href{https://doc.libelektra.org/coverage/master/debian-buster-full/}{\texttt{ LCOV code coverage report}}.\hypertarget{README_md_autotoc_md3776}{}\doxysection{Contributing}\label{README_md_autotoc_md3776}
Take a look at \mbox{\hyperlink{doc_IDEAS_md}{how to start contributing}}.\hypertarget{README_md_autotoc_md3777}{}\doxysection{Goals}\label{README_md_autotoc_md3777}
