...
\Hypertarget{doc_decisions_6_implemented_deferred_plugin_calls_md_md_doc_decisions_6_implemented_deferred_plugin_calls}%
 \hypertarget{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2297}{}\doxysection{Issue}\label{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2297}
...
Other examples is the \char`\"{}multifile\char`\"{} plugin which use multiple plugins to support different file formats. These plugins also \char`\"{}hide\char`\"{} functions exported by encapsulated plugins.\hypertarget{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2298}{}\doxysection{Constraints}\label{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2298}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2299}{}\doxysection{Assumptions}\label{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2299}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2300}{}\doxysection{Considered Alternatives}\label{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2300}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2301}{}\doxysection{Decision}\label{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2301}
...
Plugins that support deferred calls shall have the following declaration for their functions {\ttfamily void some\+Plugin\+Function (Plugin $\ast$ plugin, Key\+Set $\ast$ parameters)}. The calling developer is responsible for ensuring that the called functions have a compatible declaration. Encapsulated plugins that do not export a specified function name are omitted.\hypertarget{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2302}{}\doxysection{Argument}\label{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2302}
The solution allows changing encapsulating plugin implementations without breaking callers.\hypertarget{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2303}{}\doxysection{Implications}\label{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2303}
The called function receive their parameters via a Key\+Set.

While called functions could return data using the {\ttfamily parameters} Key\+Set (or a separate Key\+Set) there is no defined moment when the data can be collected. Defining such a moment would break the lazy-\/loading constraint. It is recommended to use callbacks passed as {\ttfamily parameters}. Callback function declarations are not limited by this decision.\hypertarget{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2304}{}\doxysection{Related Decisions}\label{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2304}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2305}{}\doxysection{Notes}\label{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2305}
