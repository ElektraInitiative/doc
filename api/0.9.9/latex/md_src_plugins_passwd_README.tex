...
This plugin parses {\ttfamily passwd} files, e.\+g. {\ttfamily /etc/passwd}.\hypertarget{md_src_plugins_passwd_README_autotoc_md382}{}\doxysection{Installation}\label{md_src_plugins_passwd_README_autotoc_md382}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/experimental}.\hypertarget{md_src_plugins_passwd_README_autotoc_md383}{}\doxysection{Implementation Details}\label{md_src_plugins_passwd_README_autotoc_md383}
...
For writing {\ttfamily putpwent} (GNU\+\_\+\+SOURCE) will be used. If it is not available the plugin will write straight to the config file.\hypertarget{md_src_plugins_passwd_README_autotoc_md384}{}\doxysection{Requirements}\label{md_src_plugins_passwd_README_autotoc_md384}
For the plugin to be build at least {\ttfamily POSIX\+\_\+\+C\+\_\+\+SOURCE $>$= 200809L} compatibility is required.\hypertarget{md_src_plugins_passwd_README_autotoc_md385}{}\doxysection{Configuration}\label{md_src_plugins_passwd_README_autotoc_md385}
If the config key {\ttfamily index} is set to {\ttfamily name} passwd entries will be sorted by name, if not set or set to {\ttfamily uid} passwd entries will be sorted by uid\hypertarget{md_src_plugins_passwd_README_autotoc_md386}{}\doxysection{Fields}\label{md_src_plugins_passwd_README_autotoc_md386}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_passwd_README_autotoc_md387}{}\doxysection{Usage}\label{md_src_plugins_passwd_README_autotoc_md387}
