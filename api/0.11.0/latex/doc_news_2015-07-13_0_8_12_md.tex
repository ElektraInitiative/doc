...
Again we managed to release with new features, many build system fixes and also other improvements.\hypertarget{doc_news_2015-07-13_0_8_12_md_autotoc_md3284}{}\doxysection{dir namespace}\label{doc_news_2015-07-13_0_8_12_md_autotoc_md3284}
...
Obviously, that does not only work with kdb, but with every elektrified tool.\hypertarget{doc_news_2015-07-13_0_8_12_md_autotoc_md3285}{}\doxysubsection{mount files in dir namespaces}\label{doc_news_2015-07-13_0_8_12_md_autotoc_md3285}
...
In both cases keys below dir/sw/editor would be in the INI file {\ttfamily .dir/editor.\+ini} and not in the file {\ttfamily .dir/default.\+ecf}.\hypertarget{doc_news_2015-07-13_0_8_12_md_autotoc_md3286}{}\doxysubsection{dir together with spec namespace}\label{doc_news_2015-07-13_0_8_12_md_autotoc_md3286}
...
Especially the specification provides flexibility not present in other configuration systems.\hypertarget{doc_news_2015-07-13_0_8_12_md_autotoc_md3288}{}\doxysection{Qt-\/\+Gui 0.\+0.\+7}\label{doc_news_2015-07-13_0_8_12_md_autotoc_md3288}
...
The GUI can be handy for many purposes, e.\+g. we use it already as xml and json editor. Note that there are still \href{https://git.libelektra.org/issues}{\texttt{ some bugs}}.\hypertarget{doc_news_2015-07-13_0_8_12_md_autotoc_md3289}{}\doxysection{Other fixes}\label{doc_news_2015-07-13_0_8_12_md_autotoc_md3289}
...
\end{DoxyItemize}\hypertarget{doc_news_2015-07-13_0_8_12_md_autotoc_md3290}{}\doxysection{Compatibility}\label{doc_news_2015-07-13_0_8_12_md_autotoc_md3290}
...
These two points are also the only unit tests that fail when Elektra 0.\+8.\+12 is used with 0.\+8.\+11 unit tests.\hypertarget{doc_news_2015-07-13_0_8_12_md_autotoc_md3291}{}\doxysection{Build Server}\label{doc_news_2015-07-13_0_8_12_md_autotoc_md3291}
...
\end{DoxyItemize}\hypertarget{doc_news_2015-07-13_0_8_12_md_autotoc_md3292}{}\doxysection{Get It!}\label{doc_news_2015-07-13_0_8_12_md_autotoc_md3292}
...
already built API documentation can be found \href{https://doc.libelektra.org/api/0.8.12/html/}{\texttt{ here}}\hypertarget{doc_news_2015-07-13_0_8_12_md_autotoc_md3293}{}\doxysection{Stay tuned!}\label{doc_news_2015-07-13_0_8_12_md_autotoc_md3293}
