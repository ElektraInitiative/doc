...
This plugin works on Mozilla preference files and is used in Elektra’s \mbox{\hyperlink{md_src_plugins_mozprefs_autoconfig_README_src_plugins_mozprefs_autoconfig_README_md}{Firefox autoconfig script}}.\hypertarget{md_src_plugins_mozprefs_README_autotoc_md359}{}\doxysection{Installation}\label{md_src_plugins_mozprefs_README_autotoc_md359}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/extra}.\hypertarget{md_src_plugins_mozprefs_README_autotoc_md360}{}\doxysubsection{Preference Types}\label{md_src_plugins_mozprefs_README_autotoc_md360}
...
Only Keys below one of these points are valid, everything else will be dropped\hypertarget{md_src_plugins_mozprefs_README_autotoc_md361}{}\doxysubsection{Data Types}\label{md_src_plugins_mozprefs_README_autotoc_md361}

\begin{DoxyItemize}
\item {\ttfamily integer}
\item {\ttfamily string}
\item {\ttfamily boolean}
\end{DoxyItemize}\hypertarget{md_src_plugins_mozprefs_README_autotoc_md362}{}\doxysubsection{Hierarchy}\label{md_src_plugins_mozprefs_README_autotoc_md362}
...
will all result in {\ttfamily lock\+Pref(\char`\"{}a.\+lock.\+key\char`\"{}, \char`\"{}lock\char`\"{});}\hypertarget{md_src_plugins_mozprefs_README_autotoc_md363}{}\doxysection{Example}\label{md_src_plugins_mozprefs_README_autotoc_md363}
