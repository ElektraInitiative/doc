...
\Hypertarget{doc_GETSTARTED_md_md_doc_GETSTARTED}%
 This document is intended for developers who want to get started with developing with Elektra.\hypertarget{doc_GETSTARTED_md_autotoc_md2330}{}\doxysection{Skill requirements}\label{doc_GETSTARTED_md_autotoc_md2330}
...
\end{DoxyItemize}\hypertarget{doc_GETSTARTED_md_autotoc_md2331}{}\doxysection{Software requirements}\label{doc_GETSTARTED_md_autotoc_md2331}
...
\end{DoxyCode}
\hypertarget{doc_GETSTARTED_md_autotoc_md2332}{}\doxysection{Installation}\label{doc_GETSTARTED_md_autotoc_md2332}
...
\end{DoxyCode}
\hypertarget{doc_GETSTARTED_md_autotoc_md2333}{}\doxysection{Hello first steps!}\label{doc_GETSTARTED_md_autotoc_md2333}
