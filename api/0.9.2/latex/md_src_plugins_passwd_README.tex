...
This plugin parses {\ttfamily passwd} files, e.\+g. {\ttfamily /etc/passwd}.\hypertarget{md_src_plugins_passwd_README_autotoc_md517}{}\doxysection{Implementation Details}\label{md_src_plugins_passwd_README_autotoc_md517}
...
For writing {\ttfamily putpwent} (G\+N\+U\+\_\+\+S\+O\+U\+R\+CE) will be used. If it is not available the plugin will write straight to the config file.\hypertarget{md_src_plugins_passwd_README_autotoc_md518}{}\doxysection{Requirements}\label{md_src_plugins_passwd_README_autotoc_md518}
For the plugin to be build at least {\ttfamily P\+O\+S\+I\+X\+\_\+\+C\+\_\+\+S\+O\+U\+R\+CE $>$= 200809L} compatibility is required.\hypertarget{md_src_plugins_passwd_README_autotoc_md519}{}\doxysection{Configuration}\label{md_src_plugins_passwd_README_autotoc_md519}
If the config key {\ttfamily index} is set to {\ttfamily name} passwd entries will be sorted by name, if not set or set to {\ttfamily uid} passwd entries will be sorted by uid\hypertarget{md_src_plugins_passwd_README_autotoc_md520}{}\doxysection{Fields}\label{md_src_plugins_passwd_README_autotoc_md520}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_passwd_README_autotoc_md521}{}\doxysection{Usage}\label{md_src_plugins_passwd_README_autotoc_md521}
