...
\Hypertarget{doc_help_kdb-get_md_md_doc_help_kdb_get}%
 \hypertarget{doc_help_kdb-get_md_autotoc_md2559}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-get_md_autotoc_md2559}
{\ttfamily kdb get $<$key name$>$}

Where {\ttfamily key name} is the name of the key.\hypertarget{doc_help_kdb-get_md_autotoc_md2560}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-get_md_autotoc_md2560}
This command is used to retrieve the value of a key.

If you enter a {\ttfamily key name} starting with a leading {\ttfamily /}, then a cascading lookup will be performed in order to attempt to locate the key. In this case, using the {\ttfamily -\/v} option allows the user to see the full key name of the key if it is found.\hypertarget{doc_help_kdb-get_md_autotoc_md2561}{}\doxysection{LIMITATIONS}\label{doc_help_kdb-get_md_autotoc_md2561}
Only keys within the mount point or below the {\ttfamily $<$key name$>$} will be considered during a cascading lookup. A workaround is to pass the {\ttfamily -\/a} option. Use the command {\ttfamily kdb get -\/v $<$key name$>$} to see if an override or a fallback was considered by the lookup.\hypertarget{doc_help_kdb-get_md_autotoc_md2562}{}\doxysection{RETURN VALUES}\label{doc_help_kdb-get_md_autotoc_md2562}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-get_md_autotoc_md2563}{}\doxysection{OPTIONS}\label{doc_help_kdb-get_md_autotoc_md2563}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-get_md_autotoc_md2564}{}\doxysection{EXAMPLES}\label{doc_help_kdb-get_md_autotoc_md2564}
...
This command will actually get {\ttfamily user\+:/sw/elektra/kdb/\#0/current/format} if the bookmarks commands from \mbox{\hyperlink{doc_help_kdb-set_md}{kdb-\/set(1)}} man pages are executed before.\hypertarget{doc_help_kdb-get_md_autotoc_md2565}{}\doxysection{SEE ALSO}\label{doc_help_kdb-get_md_autotoc_md2565}
