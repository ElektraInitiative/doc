...
\Hypertarget{doc_COMPILE_md_md_doc_COMPILE}%
 \hypertarget{doc_COMPILE_md_autotoc_md1625}{}\doxysection{Dependencies}\label{doc_COMPILE_md_autotoc_md1625}
...
Or on RPM based systems (Cent\+OS)\+:
...
Or on mac\+OS, most of the build tools can be obtained by installing Xcode (from the App Store). Other required tools may be installed using \href{http://brew.sh/}{\texttt{ brew}}. First install brew as described on their website. Then issue the following command to get cmake to complete the basic requirements\+:
...
\end{DoxyCode}
\hypertarget{doc_COMPILE_md_autotoc_md1626}{}\doxysection{Quick Guide}\label{doc_COMPILE_md_autotoc_md1626}
...
The last line only runs tests not writing into your system. See \mbox{\hyperlink{doc_TESTING_md}{TESTING}} for how to run more tests. Afterwards you can use {\ttfamily sudo make install \&\& sudo ldconfig} to install Elektra. See \mbox{\hyperlink{doc_INSTALL_md}{INSTALL}} for more information about installation of self-\/compiled Elektra (such as how to uninstall it).\hypertarget{doc_COMPILE_md_autotoc_md1627}{}\doxysection{Optional Dependencies}\label{doc_COMPILE_md_autotoc_md1627}
\begin{quote}
...
To build documentation you need doxygen (we recommend 1.\+8.\+8+), graphviz and \href{https://github.com/apjanke/ronn-ng/blob/master/INSTALLING.md}{\texttt{ ronn-\/ng}}\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{apt-\/get install doxygen graphviz}
...
To build PDF documentation you need {\ttfamily pdflatex} with


\begin{DoxyCode}{0}
\DoxyCodeLine{apt-\/get install pdflatex \(\backslash\)}
\DoxyCodeLine{        texlive-\/fonts-\/recommended texlive-\/fonts-\/extra \(\backslash\)}
\DoxyCodeLine{        texlive-\/latex-\/recommended texlive-\/latex-\/extra \(\backslash\)}
\DoxyCodeLine{        texlive-\/math-\/extra}
...
\DoxyCodeLine{dh-\/python python3-\/all python3-\/dev default-\/jdk libjna-\/java ruby-\/dev flex bison}

\end{DoxyCode}
\hypertarget{doc_COMPILE_md_autotoc_md1628}{}\doxysection{Preparation}\label{doc_COMPILE_md_autotoc_md1628}
...
Some scripts in the folder of the same name may help you running cmake.\hypertarget{doc_COMPILE_md_autotoc_md1629}{}\doxysubsection{Compilers}\label{doc_COMPILE_md_autotoc_md1629}
...
gcc   &gcc (GCC) 11.\+1.\+1 20210531 (Red Hat 11.\+1.\+1-\/3)   &x86\+\_\+64-\/redhat-\/linux    \\\cline{1-3}
gcc   &gcc-\/11 (Homebrew GCC 11.\+1.\+0\+\_\+1) 11.\+1.\+0   &x86\+\_\+64-\/apple-\/darwin20    \\\cline{1-3}
clang   &clang version 12.\+0.\+0 (Fedora 12.\+0.\+0-\/0.\+3.\+rc1.\+fc34)   &x86\+\_\+64-\/unknown-\/linux-\/gnu    \\\cline{1-3}
clang   &Apple clang version 12.\+0.\+5 (clang-\/1205.\+0.\+22.\+9)   &x86\+\_\+64-\/apple-\/darwin20.\+5.\+0   \\\cline{1-3}
\end{longtabu}
...
To change the compiler with {\ttfamily ccmake}, you may need to toggle advanced options (key {\ttfamily t}).\hypertarget{doc_COMPILE_md_autotoc_md1630}{}\doxysubsection{Options}\label{doc_COMPILE_md_autotoc_md1630}
...
Examples for this are especially in the subsection {\ttfamily PLUGINS} below, but they work in the same fashion for {\ttfamily BINDINGS} and {\ttfamily TOOLS}.\hypertarget{doc_COMPILE_md_autotoc_md1631}{}\doxysubsubsection{Plugins}\label{doc_COMPILE_md_autotoc_md1631}
...
\item \mbox{\hyperlink{md_src_plugins_list_README_src_plugins_list_README_md}{list}} delegates work to a list of plugins. Needed for tests. (Required with {\ttfamily ENABLE\+\_\+\+TESTING}.)
...
You can add resolver with any combination of the flags, even if they are not available in {\ttfamily ALL}.\hypertarget{doc_COMPILE_md_autotoc_md1632}{}\doxysubsubsection{Tools}\label{doc_COMPILE_md_autotoc_md1632}
...
\end{DoxyCode}
\hypertarget{doc_COMPILE_md_autotoc_md1633}{}\doxysubsubsection{Bindings}\label{doc_COMPILE_md_autotoc_md1633}
...
For a list of available bindings see binding\textquotesingle{}s README.md.\hypertarget{doc_COMPILE_md_autotoc_md1634}{}\doxysubsubsection{$<$tt$>$\+CMAKE\+\_\+\+BUILD\+\_\+\+TYPE$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1634}
{\ttfamily Debug}, {\ttfamily Release} or {\ttfamily Rel\+With\+Deb\+Info} See help bar at bottom of {\ttfamily ccmake} for that option or\+: \href{http://www.cmake.org/Wiki/CMake_Useful_Variables}{\texttt{ http\+://www.\+cmake.\+org/\+Wiki/\+CMake\+\_\+\+Useful\+\_\+\+Variables}}\hypertarget{doc_COMPILE_md_autotoc_md1635}{}\doxysubsection{$<$tt$>$\+BUILD\+\_\+\+SHARED BUILD\+\_\+\+FULL BUILD\+\_\+\+STATIC$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1635}
...
\end{DoxyCode}
\hypertarget{doc_COMPILE_md_autotoc_md1636}{}\doxysubsubsection{BUILD\+\_\+\+DOCUMENTATION}\label{doc_COMPILE_md_autotoc_md1636}
...
\hypertarget{doc_COMPILE_md_autotoc_md1637}{}\doxysubsubsection{Developer Options}\label{doc_COMPILE_md_autotoc_md1637}
...
Continue reading \mbox{\hyperlink{doc_TESTING_md}{testing}} for more information about testing.\hypertarget{doc_COMPILE_md_autotoc_md1638}{}\doxysubsubsection{$<$tt$>$\+CMAKE\+\_\+\+INSTALL\+\_\+\+PREFIX$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1638}
{\ttfamily CMAKE\+\_\+\+INSTALL\+\_\+\+PREFIX} defaults to {\ttfamily /usr/local}. So by default most files will installed below {\ttfamily /usr/local}. Exceptions to this are files handled by \href{\#install_system_files}{\texttt{ INSTALL\+\_\+\+SYSTEM\+\_\+\+FILES}}.

Edit that cache entry to change that behavior. Also called system prefix within the documentation.

If you want to create a package afterwards it is ok to use paths that you can write to (e.\+g. {\ttfamily -\/DCMAKE\+\_\+\+INSTALL\+\_\+\+PREFIX=/home/username/})\hypertarget{doc_COMPILE_md_autotoc_md1639}{}\doxysubsubsection{$<$tt$>$\+LIB\+\_\+\+SUFFIX$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1639}
Lets you install libraries into architecture specific folder. E.\+g. for 32/64 bit systems you might install libraries under {\ttfamily lib64}. Set {\ttfamily LIB\+\_\+\+SUFFIX} to {\ttfamily 64} to achieve exactly that. So the system library folder will be {\ttfamily CMAKE\+\_\+\+INSTALL\+\_\+\+PREFIX/lib64} then.\hypertarget{doc_COMPILE_md_autotoc_md1640}{}\doxysubsubsection{$<$tt$>$\+TARGET\+\_\+\+INCLUDE\+\_\+\+FOLDER$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1640}
By default include folders will be installed below {\ttfamily CMAKE\+\_\+\+INSTALL\+\_\+\+PREFIX/include/elektra}. This entry let you change the elektra. If the entry is empty, the include files will be installed directly to {\ttfamily CMAKE\+\_\+\+INSTALL\+\_\+\+PREFIX/include}.\hypertarget{doc_COMPILE_md_autotoc_md1641}{}\doxysubsubsection{$<$tt$>$\+TARGET\+\_\+\+PLUGIN\+\_\+\+FOLDER$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1641}
Similar to above, but with the plugins. Default is\+: {\ttfamily CMAKE\+\_\+\+INSTALL\+\_\+\+PREFIX/lib\$\{LIB\+\_\+\+SUFFIX\}/elektra} It can be also left empty to install plugins next to other libraries.\hypertarget{doc_COMPILE_md_autotoc_md1642}{}\doxysubsubsection{$<$tt$>$\+GTEST\+\_\+\+ROOT$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1642}
...
It is recommended that you browse through all of the options using {\ttfamily ccmake}. Afterwards press {\ttfamily c} again (maybe multiple times until all variables are resolved) and then {\ttfamily g} to generate. Finally press {\ttfamily e} to exit.\hypertarget{doc_COMPILE_md_autotoc_md1643}{}\doxysubsubsection{$<$tt$>$\+INSTALL\+\_\+\+BUILD\+\_\+\+TOOLS$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1643}
Specifies that the build tools, i.\+e. {\ttfamily elektra-\/export-\/symbols} and {\ttfamily elektra-\/export-\/symbols} are installed (by default off). Is needed for cross-\/compilation.\hypertarget{doc_COMPILE_md_autotoc_md1644}{}\doxysubsubsection{$<$tt$>$\+INSTALL\+\_\+\+SYSTEM\+\_\+\+FILES$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1644}
...
\hypertarget{doc_COMPILE_md_autotoc_md1645}{}\doxysubsubsection{$<$tt$>$\+ENABLE\+\_\+\+OPTIMIZATIONS$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1645}
In order to keep the binaries as small as possible this flag allows to trade memory for speed.\hypertarget{doc_COMPILE_md_autotoc_md1646}{}\doxysection{Building}\label{doc_COMPILE_md_autotoc_md1646}
\hypertarget{doc_COMPILE_md_autotoc_md1647}{}\doxysubsection{Without IDE}\label{doc_COMPILE_md_autotoc_md1647}
...
Continue by reading \mbox{\hyperlink{doc_INSTALL_md}{INSTALL}}.\hypertarget{doc_COMPILE_md_autotoc_md1648}{}\doxysubsection{With Code\+Blocks}\label{doc_COMPILE_md_autotoc_md1648}
...
{\bfseries{Note 3\+:}} for Gentoo is recommend to emerge sys-\/apps/lsb-\/release to name the package right even thou not required.\hypertarget{doc_COMPILE_md_autotoc_md1649}{}\doxysection{Maintainer\textquotesingle{}s Guide}\label{doc_COMPILE_md_autotoc_md1649}
\hypertarget{doc_COMPILE_md_autotoc_md1650}{}\doxysubsection{Multiarch}\label{doc_COMPILE_md_autotoc_md1650}
...
\end{DoxyCode}
\hypertarget{doc_COMPILE_md_autotoc_md1651}{}\doxysubsection{$<$tt$>$\+RPATH$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1651}
...
Elektra’s use case for {\ttfamily RPATH} is considered acceptable, so we recommend to use it because\+:
...
Alternatively, which gives you the advantage not to clutter the main library path, is to add the plugin folder in {\ttfamily /etc/ld.so.\+conf.\+d/elektra}. Note that it still allows applications to link against plugins.\hypertarget{doc_COMPILE_md_autotoc_md1652}{}\doxysection{Troubleshooting}\label{doc_COMPILE_md_autotoc_md1652}
\hypertarget{doc_COMPILE_md_autotoc_md1653}{}\doxysubsection{Dependencies not Available for Cent OS}\label{doc_COMPILE_md_autotoc_md1653}
...
\end{DoxyCode}
\hypertarget{doc_COMPILE_md_autotoc_md1654}{}\doxysubsection{Cross Compiling}\label{doc_COMPILE_md_autotoc_md1654}
