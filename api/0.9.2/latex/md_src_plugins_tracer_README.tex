...
This plugin is added on every possible position within a backend. It allows you to trace when the backend is executed.\hypertarget{md_src_plugins_tracer_README_autotoc_md694}{}\doxysection{Usage}\label{md_src_plugins_tracer_README_autotoc_md694}
...
Now the 2 placements in get are called.\hypertarget{md_src_plugins_tracer_README_autotoc_md695}{}\doxysection{Module Loading}\label{md_src_plugins_tracer_README_autotoc_md695}
