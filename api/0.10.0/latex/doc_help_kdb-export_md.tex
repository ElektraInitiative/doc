...
\Hypertarget{doc_help_kdb-export_md_md_doc_help_kdb_export}%
 \hypertarget{doc_help_kdb-export_md_autotoc_md2876}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-export_md_autotoc_md2876}
{\ttfamily kdb export $<$source$>$ \mbox{[}$<$format$>$\mbox{]}}~\newline
\hypertarget{doc_help_kdb-export_md_autotoc_md2877}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-export_md_autotoc_md2877}
...
\hypertarget{doc_help_kdb-export_md_autotoc_md2878}{}\doxysection{USAGE}\label{doc_help_kdb-export_md_autotoc_md2878}
Where {\ttfamily source} is the path of the key(s) you want to export. Additionally, the user can specify a format to use by passing it as the option argument {\ttfamily format}.~\newline
 ...
 The {\ttfamily storage} plugin can be configured at compile-\/time or changed by the link {\ttfamily libelektra-\/plugin-\/storage.\+so}.\hypertarget{doc_help_kdb-export_md_autotoc_md2879}{}\doxysection{OPTIONS}\label{doc_help_kdb-export_md_autotoc_md2879}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-export_md_autotoc_md2880}{}\doxysection{KDB}\label{doc_help_kdb-export_md_autotoc_md2880}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-export_md_autotoc_md2881}{}\doxysection{EXAMPLES}\label{doc_help_kdb-export_md_autotoc_md2881}
...
\end{DoxyCode}
\hypertarget{doc_help_kdb-export_md_autotoc_md2882}{}\doxysection{Note}\label{doc_help_kdb-export_md_autotoc_md2882}
