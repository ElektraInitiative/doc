...
This is good for power saving on laptops, but not a good idea on production use otherwise. So it is strongly recommended to always add this plugin.\hypertarget{md_src_plugins_sync_README_autotoc_md560}{}\doxysection{Usage}\label{md_src_plugins_sync_README_autotoc_md560}
