...
\Hypertarget{doc_tutorials_namespaces_md_md_doc_tutorials_namespaces}%
 \hypertarget{doc_tutorials_namespaces_md_autotoc_md3671}{}\doxysection{Structure of the Key Database}\label{doc_tutorials_namespaces_md_autotoc_md3671}
...
For example {\ttfamily kdb get /b/c} should return {\ttfamily Value 2} now, if you set the values before.\hypertarget{doc_tutorials_namespaces_md_autotoc_md3672}{}\doxysection{Namespaces}\label{doc_tutorials_namespaces_md_autotoc_md3672}
...
At this point the key database should have this structure\+: \hypertarget{doc_tutorials_namespaces_md_autotoc_md3673}{}\doxysubsection{Cascading Keys}\label{doc_tutorials_namespaces_md_autotoc_md3673}
...
Having namespaces enables both admins and users to set specific parts of the application\textquotesingle{}s configuration, as you will see in the following example.\hypertarget{doc_tutorials_namespaces_md_autotoc_md3674}{}\doxysection{How it Works on the Command Line (kdb)}\label{doc_tutorials_namespaces_md_autotoc_md3674}
