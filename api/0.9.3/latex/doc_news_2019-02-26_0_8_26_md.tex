...
\item The \hyperlink{autotoc_md619_src_plugins_resolver_README_md}{`resolver` plugin} and its tests now better support {\ttfamily K\+D\+B\+\_\+\+D\+B\+\_\+\+S\+Y\+S\+T\+EM} and {\ttfamily K\+D\+B\+\_\+\+D\+B\+\_\+\+S\+P\+EC} paths using {\ttfamily $\sim$} to refer to a home directory. \+\_\+(Klemens Böswirth)\+\_\+
