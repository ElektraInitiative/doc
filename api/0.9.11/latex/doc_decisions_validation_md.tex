...
\Hypertarget{doc_decisions_validation_md_md_doc_decisions_validation}%
 \hypertarget{doc_decisions_validation_md_autotoc_md2213}{}\doxysection{Problem}\label{doc_decisions_validation_md_autotoc_md2213}
...
If validation of a key fails, each plugin decides on its own how to handle the issue and proceed in ways that might be different from what is expected or desired.\hypertarget{doc_decisions_validation_md_autotoc_md2214}{}\doxysection{Constraints}\label{doc_decisions_validation_md_autotoc_md2214}
\hypertarget{doc_decisions_validation_md_autotoc_md2215}{}\doxysection{Assumptions}\label{doc_decisions_validation_md_autotoc_md2215}
...
\end{DoxyItemize}\hypertarget{doc_decisions_validation_md_autotoc_md2216}{}\doxysection{Considered Alternatives}\label{doc_decisions_validation_md_autotoc_md2216}
...
\end{DoxyItemize}\hypertarget{doc_decisions_validation_md_autotoc_md2217}{}\doxysection{Decision}\label{doc_decisions_validation_md_autotoc_md2217}
Use a wrapper plugin to iterate over the keyset and delegate the validation of each key to the corresponding validation plugin.\hypertarget{doc_decisions_validation_md_autotoc_md2218}{}\doxysection{Rationale}\label{doc_decisions_validation_md_autotoc_md2218}
...
\end{DoxyItemize}\hypertarget{doc_decisions_validation_md_autotoc_md2219}{}\doxysection{Implications}\label{doc_decisions_validation_md_autotoc_md2219}
...
returning 1 if validation succeeded, 0 on failure\hypertarget{doc_decisions_validation_md_autotoc_md2220}{}\doxysection{Related Decisions}\label{doc_decisions_validation_md_autotoc_md2220}
\hypertarget{doc_decisions_validation_md_autotoc_md2221}{}\doxysection{Notes}\label{doc_decisions_validation_md_autotoc_md2221}
