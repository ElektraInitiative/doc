...
virtual \mbox{\hyperlink{classkdb_1_1ElektraDiff}{Elektra\+Diff}} \mbox{\hyperlink{classkdb_1_1KDB_ae9473c14d2310006fb90aadfd4a227af}{calculate\+Changes}} (\mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} \&changed\+Key\+Set, std\+::string const \&parent\+Key\+Name)
\begin{DoxyCompactList}\small\item\em Calculates the changes between the provided \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} and the current state of the \mbox{\hyperlink{classkdb_1_1KDB}{KDB}}. \end{DoxyCompactList}\item 
virtual \mbox{\hyperlink{classkdb_1_1ElektraDiff}{Elektra\+Diff}} \mbox{\hyperlink{classkdb_1_1KDB_aaba81ae9328086987972cbfe47a930bc}{calculate\+Changes}} (\mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} \&changed\+Key\+Set, \mbox{\hyperlink{classkdb_1_1Key}{Key}} \&parent\+Key)
\begin{DoxyCompactList}\small\item\em Calculates the changes between the provided \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} and the current state of the \mbox{\hyperlink{classkdb_1_1KDB}{KDB}}. \end{DoxyCompactList}\item 
ckdb\+::\+KDB $\ast$ \mbox{\hyperlink{classkdb_1_1KDB_acaa10fdc06db154ae1fa9196870d50b6}{get\+Kdb}} () const
\begin{DoxyCompactList}\small\item\em Passes out the raw kdb pointer. \end{DoxyCompactList}\item 
ckdb\+::\+KDB $\ast$ \mbox{\hyperlink{classkdb_1_1KDB_a99c219fbfc7687333f16c4d7d660f434}{operator$\ast$}} () const
\begin{DoxyCompactList}\small\item\em Is an abbreviation for get\+Kdb. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\mbox{\Hypertarget{classkdb_1_1KDB_aaba81ae9328086987972cbfe47a930bc}\label{classkdb_1_1KDB_aaba81ae9328086987972cbfe47a930bc}} 
\index{kdb::KDB@{kdb::KDB}!calculateChanges@{calculateChanges}}
\index{calculateChanges@{calculateChanges}!kdb::KDB@{kdb::KDB}}
\doxysubsubsection{\texorpdfstring{calculateChanges()}{calculateChanges()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily \mbox{\hyperlink{classkdb_1_1ElektraDiff}{Elektra\+Diff}} kdb\+::\+KDB\+::calculate\+Changes (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} \&}]{changed\+Key\+Set,  }\item[{\mbox{\hyperlink{classkdb_1_1Key}{Key}} \&}]{parent\+Key }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}



Calculates the changes between the provided \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} and the current state of the \mbox{\hyperlink{classkdb_1_1KDB}{KDB}}. 


\begin{DoxyParams}{Parameters}
{\em changed\+Key\+Set} & the keyset that should be used to diff \\
\hline
{\em parent\+Key} & only changes same or below this keys are calculated\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
a diff with all the changes 
\end{DoxyReturn}
\mbox{\Hypertarget{classkdb_1_1KDB_ae9473c14d2310006fb90aadfd4a227af}\label{classkdb_1_1KDB_ae9473c14d2310006fb90aadfd4a227af}} 
\index{kdb::KDB@{kdb::KDB}!calculateChanges@{calculateChanges}}
\index{calculateChanges@{calculateChanges}!kdb::KDB@{kdb::KDB}}
\doxysubsubsection{\texorpdfstring{calculateChanges()}{calculateChanges()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily \mbox{\hyperlink{classkdb_1_1ElektraDiff}{Elektra\+Diff}} kdb\+::\+KDB\+::calculate\+Changes (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} \&}]{changed\+Key\+Set,  }\item[{std\+::string const \&}]{parent\+Key\+Name }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}
...
{\em changed\+Key\+Set} & the keyset that should be used to diff \\
\hline
{\em parent\+Key\+Name} & only changes same or below this keys are calculated\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
a diff with all the changes 
...
\mbox{\Hypertarget{classkdb_1_1KDB_acaa10fdc06db154ae1fa9196870d50b6}\label{classkdb_1_1KDB_acaa10fdc06db154ae1fa9196870d50b6}} 
\index{kdb::KDB@{kdb::KDB}!getKdb@{getKdb}}
\index{getKdb@{getKdb}!kdb::KDB@{kdb::KDB}}
\doxysubsubsection{\texorpdfstring{getKdb()}{getKdb()}}
{\footnotesize\ttfamily ckdb\+::\+KDB $\ast$ kdb\+::\+KDB\+::get\+Kdb (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}
...
\mbox{\hyperlink{group__kdb_gadb54dc9fda17ee07deb9444df745c96f}{kdb\+Close()}} to \mbox{\hyperlink{classkdb_1_1KDB_a1b3ff4a68c2c935d67dce843bc4ad01b}{close}} the session of a \mbox{\hyperlink{classkdb_1_1Key}{Key}} database opened by \mbox{\hyperlink{group__kdb_ga844e1299a84c3fbf1d3a905c5c893ba5}{kdb\+Open()}} 
\end{DoxySeeAlso}
\mbox{\Hypertarget{classkdb_1_1KDB_a99c219fbfc7687333f16c4d7d660f434}\label{classkdb_1_1KDB_a99c219fbfc7687333f16c4d7d660f434}} 
\index{kdb::KDB@{kdb::KDB}!operator$\ast$@{operator$\ast$}}
\index{operator$\ast$@{operator$\ast$}!kdb::KDB@{kdb::KDB}}
\doxysubsubsection{\texorpdfstring{operator$\ast$()}{operator*()}}
{\footnotesize\ttfamily ckdb\+::\+KDB $\ast$ kdb\+::\+KDB\+::operator$\ast$ (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}



Is an abbreviation for get\+Kdb. 
...
\end{DoxyNote}
\begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{classkdb_1_1KDB_acaa10fdc06db154ae1fa9196870d50b6}{get\+Kdb()}} 
\end{DoxySeeAlso}
...
The \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} {\ttfamily ks} must be a valid \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}}, i.\+e., constructed with \mbox{\hyperlink{group__keyset_ga671e1aaee3ae9dc13b4834a4ddbd2c3c}{ks\+New()}}. 

The \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} {\ttfamily ks} must only contain only keys in the {\ttfamily spec\+:/}, {\ttfamily dir\+:/}, {\ttfamily user\+:/}, {\ttfamily system\+:/}, {\ttfamily default\+:/} or {\ttfamily proc\+:/} namespaces. 
