...
\Hypertarget{doc_tutorials_specification_md_md_doc_tutorials_specification}%
 \hypertarget{doc_tutorials_specification_md_autotoc_md4038}{}\doxysection{Overview}\label{doc_tutorials_specification_md_autotoc_md4038}
\hypertarget{doc_tutorials_specification_md_autotoc_md4039}{}\doxysubsection{Introduction}\label{doc_tutorials_specification_md_autotoc_md4039}
In this tutorial you will learn how to interactively use the {\ttfamily Spec\+Elektra} specification language and {\ttfamily kdb} to write a configuration specification for an example application.\hypertarget{doc_tutorials_specification_md_autotoc_md4040}{}\doxysubsection{What you should already know}\label{doc_tutorials_specification_md_autotoc_md4040}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md4041}{}\doxysubsection{What you’ll learn}\label{doc_tutorials_specification_md_autotoc_md4041}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md4042}{}\doxysubsection{What you\textquotesingle{}ll do}\label{doc_tutorials_specification_md_autotoc_md4042}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md4043}{}\doxysection{Example App Overview}\label{doc_tutorials_specification_md_autotoc_md4043}
...
\item a backup date
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md4044}{}\doxysection{Getting Started}\label{doc_tutorials_specification_md_autotoc_md4044}
...
Otherwise refer to the \href{https://www.libelektra.org/getstarted/guide}{\texttt{ getting started guide}} to install it.\hypertarget{doc_tutorials_specification_md_autotoc_md4045}{}\doxysection{Mounting the Specification}\label{doc_tutorials_specification_md_autotoc_md4045}
\hypertarget{doc_tutorials_specification_md_autotoc_md4046}{}\doxysubsection{Step 1\+: Mount a Specification File}\label{doc_tutorials_specification_md_autotoc_md4046}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md4047}{}\doxysubsection{Step 2\+: Define a mountpoint}\label{doc_tutorials_specification_md_autotoc_md4047}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md4048}{}\doxysubsection{Step 3\+: Do a specification mount}\label{doc_tutorials_specification_md_autotoc_md4048}
...
For more information about namespaces in Elektra please see \href{https://www.libelektra.org/manpages/elektra-namespaces}{\texttt{ here}}, a tutorial about the topic is available \href{https://www.libelektra.org/tutorials/namespaces}{\texttt{ here}}.\hypertarget{doc_tutorials_specification_md_autotoc_md4049}{}\doxysection{Adding your first key to the specification}\label{doc_tutorials_specification_md_autotoc_md4049}
\hypertarget{doc_tutorials_specification_md_autotoc_md4050}{}\doxysubsection{Step 1\+: Adding the server port}\label{doc_tutorials_specification_md_autotoc_md4050}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md4051}{}\doxysubsection{Step 2\+: Adding more metadata}\label{doc_tutorials_specification_md_autotoc_md4051}
...
In this example, the {\ttfamily network} plugin and the {\ttfamily type} plugin are emitting warnings or errors, because the valid ranges for {\ttfamily port} and {\ttfamily unsigned\+\_\+short} are the same.\hypertarget{doc_tutorials_specification_md_autotoc_md4052}{}\doxysubsection{Step 3\+: Adding boolean keys}\label{doc_tutorials_specification_md_autotoc_md4052}
...
You can read more about this in the documentation for the \href{https://www.libelektra.org/plugins/type\#normalization}{\texttt{ type plugin}}.\hypertarget{doc_tutorials_specification_md_autotoc_md4053}{}\doxysection{Adding the database keys to the specification}\label{doc_tutorials_specification_md_autotoc_md4053}
\hypertarget{doc_tutorials_specification_md_autotoc_md4054}{}\doxysubsection{Step 1\+: Adding the database ip}\label{doc_tutorials_specification_md_autotoc_md4054}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md4055}{}\doxysubsection{Step 2\+: Adding the database dialect}\label{doc_tutorials_specification_md_autotoc_md4055}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md4056}{}\doxysection{Adding the backup date}\label{doc_tutorials_specification_md_autotoc_md4056}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md4057}{}\doxysection{Final specification code}\label{doc_tutorials_specification_md_autotoc_md4057}
...
\hypertarget{doc_tutorials_specification_md_autotoc_md4058}{}\doxysection{Using the specification}\label{doc_tutorials_specification_md_autotoc_md4058}
...
Please note that also in these examples, the file referred to by the absolute path {\ttfamily /etc/spec.ni} is a {\bfseries{new file}} where the content of the file {\ttfamily ./spec.ni} in the working directory gets imported or copied to.\hypertarget{doc_tutorials_specification_md_autotoc_md4059}{}\doxysection{Cleanup}\label{doc_tutorials_specification_md_autotoc_md4059}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md4061}{}\doxysection{Learn more}\label{doc_tutorials_specification_md_autotoc_md4061}
