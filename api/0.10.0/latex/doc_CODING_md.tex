...
\Hypertarget{doc_CODING_md_md_doc_CODING}%
 This document provides an introduction in how the source code of libelektra is organized and how and where to add functionality.\hypertarget{doc_CODING_md_autotoc_md735}{}\doxysection{Folder structure}\label{doc_CODING_md_autotoc_md735}
...
You can find more information about the structure in the {\ttfamily README.\+md}.\hypertarget{doc_CODING_md_autotoc_md736}{}\doxysection{General Information}\label{doc_CODING_md_autotoc_md736}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md737}{}\doxysection{Source Code}\label{doc_CODING_md_autotoc_md737}
The same guidelines apply to all code in the repository including the plugins.\hypertarget{doc_CODING_md_autotoc_md738}{}\doxysubsection{General Guidelines}\label{doc_CODING_md_autotoc_md738}
...
If you see inconsistency within the rules do not hesitate to open an issue about it.\hypertarget{doc_CODING_md_autotoc_md739}{}\doxysubsection{Code Comments}\label{doc_CODING_md_autotoc_md739}
...
\end{DoxyEnumerate}\hypertarget{doc_CODING_md_autotoc_md740}{}\doxysubsection{Coding Style}\label{doc_CODING_md_autotoc_md740}
...
{\bfseries{Example\+:}} \href{/home/jenkins/workspace/libelektra-release/src/libs/elektra/kdb.c}{\texttt{ src/libs/elektra/kdb.\+c}}\hypertarget{doc_CODING_md_autotoc_md742}{}\doxysubsubsection{Clang Format}\label{doc_CODING_md_autotoc_md742}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md743}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md743}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md744}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md744}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md745}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md745}
...
After that change Text\+Mate will reformat C and C++ code with {\ttfamily clang-\/format} every time you save a file.\hypertarget{doc_CODING_md_autotoc_md746}{}\doxysubsection{C++ Guidelines}\label{doc_CODING_md_autotoc_md746}
...
{\bfseries{Example\+:}} \href{/home/jenkins/workspace/libelektra-release/src/bindings/cpp/include/kdb.hpp}{\texttt{ src/bindings/cpp/include/kdb.\+hpp}}\hypertarget{doc_CODING_md_autotoc_md747}{}\doxysubsection{CMake Guidelines}\label{doc_CODING_md_autotoc_md747}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md748}{}\doxysubsubsection{CMake format}\label{doc_CODING_md_autotoc_md748}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md749}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md749}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md750}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md750}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md751}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md751}
...
in a file called \href{https://macromates.com/blog/2011/git-style-configuration}{\texttt{ {\ttfamily .tm\+\_\+properties}}} in the root of Elektra’s repository.\hypertarget{doc_CODING_md_autotoc_md752}{}\doxysubsection{Java \& Groovy Guidelines}\label{doc_CODING_md_autotoc_md752}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md753}{}\doxysubsubsection{Usage}\label{doc_CODING_md_autotoc_md753}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md754}{}\doxysubsection{Java\+Script Guidelines}\label{doc_CODING_md_autotoc_md754}
\hypertarget{doc_CODING_md_autotoc_md755}{}\doxysubsubsection{Prettier}\label{doc_CODING_md_autotoc_md755}
We use \href{https://prettier.io}{\texttt{ {\ttfamily prettier}}} to format Java\+Script files.\hypertarget{doc_CODING_md_autotoc_md756}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md756}
\doxysubparagraph*{mac\+OS}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md757}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md757}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md758}{}\doxysubsection{Markdown Guidelines}\label{doc_CODING_md_autotoc_md758}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md759}{}\doxysubsubsection{Prettier}\label{doc_CODING_md_autotoc_md759}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md760}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md760}
For information on how to install the tool, please take a look at “\+Java\+Script Guidelines” → “\+Prettier” → “\+Installation”.\hypertarget{doc_CODING_md_autotoc_md761}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md761}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md762}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md762}
...
\item Save your new command\+: {\ttfamily ⌘} + {\ttfamily S}
\end{DoxyEnumerate}
\end{DoxyEnumerate}\hypertarget{doc_CODING_md_autotoc_md763}{}\doxysubsection{Shell Guidelines}\label{doc_CODING_md_autotoc_md763}

\begin{DoxyItemize}
\item Please only use \href{https://en.wikipedia.org/wiki/POSIX}{\texttt{ POSIX}} functionality.
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md764}{}\doxysubsubsection{Shebang}\label{doc_CODING_md_autotoc_md764}
...
Note that even if a shebang is added by a preprocessor macro or similar code generation tools, it must also be present in the templated file.\hypertarget{doc_CODING_md_autotoc_md765}{}\doxysubsubsection{shfmt}\label{doc_CODING_md_autotoc_md765}
We use \href{https://github.com/mvdan/sh}{\texttt{ {\ttfamily shfmt}}} to format Shell files in the repository.\hypertarget{doc_CODING_md_autotoc_md766}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md766}
\doxysubparagraph*{mac\+OS}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md767}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md767}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md768}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md768}
...
\item Save your new command\+: {\ttfamily ⌘} + {\ttfamily S}
\end{DoxyEnumerate}
\end{DoxyEnumerate}\hypertarget{doc_CODING_md_autotoc_md769}{}\doxysubsection{Doxygen Guidelines}\label{doc_CODING_md_autotoc_md769}
...
Further Doxygen documentation can be found in the \mbox{\hyperlink{doc_doxygen_README_md}{Doxygen README}}.\hypertarget{doc_CODING_md_autotoc_md770}{}\doxysubsection{File Headers}\label{doc_CODING_md_autotoc_md770}
...
The duplication of the filename, author and date is not needed, because this information is tracked using Git and \mbox{\hyperlink{doc_AUTHORS_md}{doc/\+AUTHORS.md}} already.\hypertarget{doc_CODING_md_autotoc_md771}{}\doxysection{Further Readings}\label{doc_CODING_md_autotoc_md771}
