...
\end{DoxyItemize}\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md3182}{}\doxysection{XDG Compatibility}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md3182}
...
To make your application (that uses Elektra) XDG aware, you have nothing to do\+: you get it to free. Make sure to always use cascading lookup. Additionally, an XDG conforming application should not write system/ keys.\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md3183}{}\doxysection{Open\+ICC Compatibility}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md3183}
...
Of course this renaming functionality can be used in every situation and is not limited to Open\+ICC.\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md3184}{}\doxysection{Tools}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md3184}
...
\end{DoxyItemize}\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md3185}{}\doxysection{Compatibility}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md3185}
...
\end{DoxyItemize}\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md3186}{}\doxysection{CMake}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md3186}
...
will include all plugins except xmltool.\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md3187}{}\doxysection{Improved comments}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md3187}
...
Additionally, a small API for specific metadata operations emerges. These operations will be moved to a separate library and will not stay in Elektra’s core library.\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md3188}{}\doxysection{Proposal}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md3188}
...
\end{DoxyItemize}\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md3189}{}\doxysection{Java binding}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md3189}
Elektra now fully supports applications written in Java and also Plugins written in the same language.

The \href{https://github.com/ElektraInitiative/libelektra/tree/master/src/bindings/jna}{\texttt{ new binding was developed using jna.}} For the \href{https://github.com/ElektraInitiative/libelektra/tree/master/src/plugins/jni}{\texttt{ plugin interface JNI}} was used. We developed already \href{https://master.libelektra.org/src/bindings/jna/libelektra5j/src/main/java/org/libelektra/plugin}{\texttt{ some plugins}}.\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md3190}{}\doxysection{Qt-\/\+Gui}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md3190}
...
\end{DoxyItemize}\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md3191}{}\doxysection{Further stuff and small fixes}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md3191}
...
\end{DoxyItemize}\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md3192}{}\doxysection{Get It!}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md3192}
...
already built API documentation can be found \href{https://doc.libelektra.org/api/0.8.10/html/}{\texttt{ here}}\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md3193}{}\doxysection{Stay tuned!}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md3193}
