...
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_md_autotoc_md1746}{}\doxysection{Assumptions}\label{doc_decisions_elektra_web_md_autotoc_md1746}
\hypertarget{doc_decisions_elektra_web_md_autotoc_md1747}{}\doxysection{Considered Alternatives}\label{doc_decisions_elektra_web_md_autotoc_md1747}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_md_autotoc_md1748}{}\doxysection{Decision}\label{doc_decisions_elektra_web_md_autotoc_md1748}
Use one cluster daemon (clusterd) to manage all clusters and instances.\hypertarget{doc_decisions_elektra_web_md_autotoc_md1749}{}\doxysection{Rationale}\label{doc_decisions_elektra_web_md_autotoc_md1749}
