...
This plugin works on Mozilla preference files and is used in Elektra’s \mbox{\hyperlink{md_src_plugins_mozprefs_autoconfig_README_src_plugins_mozprefs_autoconfig_README_md}{Firefox autoconfig script}}.\hypertarget{md_src_plugins_mozprefs_README_autotoc_md360}{}\doxysection{Installation}\label{md_src_plugins_mozprefs_README_autotoc_md360}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/extra}.\hypertarget{md_src_plugins_mozprefs_README_autotoc_md361}{}\doxysubsection{Preference Types}\label{md_src_plugins_mozprefs_README_autotoc_md361}
...
Only Keys below one of these points are valid, everything else will be dropped\hypertarget{md_src_plugins_mozprefs_README_autotoc_md362}{}\doxysubsection{Data Types}\label{md_src_plugins_mozprefs_README_autotoc_md362}

\begin{DoxyItemize}
\item {\ttfamily integer}
\item {\ttfamily string}
\item {\ttfamily boolean}
\end{DoxyItemize}\hypertarget{md_src_plugins_mozprefs_README_autotoc_md363}{}\doxysubsection{Hierarchy}\label{md_src_plugins_mozprefs_README_autotoc_md363}
...
will all result in {\ttfamily lock\+Pref(\char`\"{}a.\+lock.\+key\char`\"{}, \char`\"{}lock\char`\"{});}\hypertarget{md_src_plugins_mozprefs_README_autotoc_md364}{}\doxysection{Example}\label{md_src_plugins_mozprefs_README_autotoc_md364}
