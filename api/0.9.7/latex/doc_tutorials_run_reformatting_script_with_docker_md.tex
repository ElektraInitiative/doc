...
This is a step-\/by-\/step guide. Just follow the steps and you are good to go!\hypertarget{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md3728}{}\doxysection{Prerequisites}\label{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md3728}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md3729}{}\doxysection{What to Begin With?}\label{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md3729}
\hypertarget{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md3730}{}\doxysubsection{1. Build Your Own Docker Image}\label{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md3730}
...
The image tag {\ttfamily buildelektra-\/sid} we suggested can be replaced by a name of your own choosing. Note that currently our {\ttfamily sid} image is the only one with all the necessary tools installed.\hypertarget{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md3731}{}\doxysubsection{2. Run the Docker Container}\label{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md3731}
...
Again, if you changed the image tag {\ttfamily buildelektra-\/sid}, please change it above as well.\hypertarget{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md3732}{}\doxysubsection{3. Running the Script}\label{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md3732}
