...
\Hypertarget{doc_help_elektra-spec_md_md_doc_help_elektra_spec}%
 \hypertarget{doc_help_elektra-spec_md_autotoc_md2288}{}\doxysection{INTRODUCTION}\label{doc_help_elektra-spec_md_autotoc_md2288}
...
It is, however, not limited to this but can express any other key database semantics (new plugins might be necessary, though).\hypertarget{doc_help_elektra-spec_md_autotoc_md2289}{}\doxysection{Application}\label{doc_help_elektra-spec_md_autotoc_md2289}
...
So Keys in {\ttfamily spec} allow us to specify which keys are read by the application. The description key will be copied (referred to) to {\ttfamily folder/anotherkey} of any namespace, so that it can easily be accessed.\hypertarget{doc_help_elektra-spec_md_autotoc_md2290}{}\doxysection{Cascading Lookup}\label{doc_help_elektra-spec_md_autotoc_md2290}
...
Note that the fallback, override and cascading works on {\itshape key level}, and not like most other systems have implemented, on configuration {\itshape file level}.\hypertarget{doc_help_elektra-spec_md_autotoc_md2291}{}\doxysection{Validation}\label{doc_help_elektra-spec_md_autotoc_md2291}
...
\end{DoxyCode}
\hypertarget{doc_help_elektra-spec_md_autotoc_md2292}{}\doxysection{Mounting}\label{doc_help_elektra-spec_md_autotoc_md2292}
...
\end{DoxyCode}
\hypertarget{doc_help_elektra-spec_md_autotoc_md2293}{}\doxysection{SEE ALSO}\label{doc_help_elektra-spec_md_autotoc_md2293}
