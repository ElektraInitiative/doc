...
\Hypertarget{doc_help_kdb-mount_md_md_doc_help_kdb_mount}%
 \hypertarget{doc_help_kdb-mount_md_autotoc_md2605}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-mount_md_autotoc_md2605}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{doc_help_kdb-mount_md_autotoc_md2606}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-mount_md_autotoc_md2606}
...
For cascading mount points (starting with {\ttfamily /}) a mount point for the namespace {\ttfamily dir}, {\ttfamily user} and {\ttfamily system} is created. Each of this mount point uses a different configuration file, either below current directory, below home directory or anywhere in the system. Use {\ttfamily kdb file $<$path$>$} to determine where the file(s) are.\hypertarget{doc_help_kdb-mount_md_autotoc_md2608}{}\doxysection{OPTIONS}\label{doc_help_kdb-mount_md_autotoc_md2608}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-mount_md_autotoc_md2609}{}\doxysection{KDB}\label{doc_help_kdb-mount_md_autotoc_md2609}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-mount_md_autotoc_md2610}{}\doxysection{EXAMPLES}\label{doc_help_kdb-mount_md_autotoc_md2610}
...
To recode and rename a configuration file using Elektra\+:~\newline
 {\ttfamily kdb mount recode.\+txt dir\+:/recode ni rename cut=path iconv to=utf8,from=latin1}\hypertarget{doc_help_kdb-mount_md_autotoc_md2611}{}\doxysection{SEE ALSO}\label{doc_help_kdb-mount_md_autotoc_md2611}
