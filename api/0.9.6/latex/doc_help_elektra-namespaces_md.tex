...
\Hypertarget{doc_help_elektra-namespaces_md_md_doc_help_elektra_namespaces}%
 \hypertarget{doc_help_elektra-namespaces_md_autotoc_md2273}{}\doxysection{INTRODUCTION}\label{doc_help_elektra-namespaces_md_autotoc_md2273}
...
In the rest of this document all currently available namespaces in the default order are described.\hypertarget{doc_help_elektra-namespaces_md_autotoc_md2274}{}\doxysection{spec}\label{doc_help_elektra-namespaces_md_autotoc_md2274}
...
spec is not part of cascading mounts, because the specifications often are written in different syntax than the configuration files.\hypertarget{doc_help_elektra-namespaces_md_autotoc_md2275}{}\doxysection{proc}\label{doc_help_elektra-namespaces_md_autotoc_md2275}
...
Keys in the namespace proc can not be stored by their nature. Thus they are ignored by {\ttfamily kdb\+Get} and {\ttfamily kdb\+Set}. They might be different for every invocation of an application.\hypertarget{doc_help_elektra-namespaces_md_autotoc_md2276}{}\doxysection{dir}\label{doc_help_elektra-namespaces_md_autotoc_md2276}
...
Note that Elektra only supports a user directory per KDB instance. Start a new KDB instance if you need different user configuration for different parts of your application. How to change the user may be different dependent on the resolver, e.\+g. by {\ttfamily seteuid()} or by environment variables like {\ttfamily HOME}, {\ttfamily USER}\hypertarget{doc_help_elektra-namespaces_md_autotoc_md2278}{}\doxysection{system}\label{doc_help_elektra-namespaces_md_autotoc_md2278}
The system configuration is the same for every chroot.

The configuration is typically located below {\ttfamily KDB\+\_\+\+DB\+\_\+\+SYSTEM}. Other absolute paths, e.\+g. below {\ttfamily /opt} or {\ttfamily /usr/local/etc} are possible too.\hypertarget{doc_help_elektra-namespaces_md_autotoc_md2279}{}\doxysection{Cascading}\label{doc_help_elektra-namespaces_md_autotoc_md2279}
