...
\Hypertarget{doc_decisions_elektra_web_recursive_md_md_doc_decisions_elektra_web_recursive}%
 \hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1801}{}\doxysection{Problem}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1801}
After deciding how to remotely manage instances and groups of instances (clusters) with Elektra Web, there is still the issue of recursively nested clusters (clusters of clusters).\hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1802}{}\doxysection{Constraints}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1802}
...
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1803}{}\doxysection{Assumptions}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1803}

\begin{DoxyItemize}
\item Use one cluster daemon (clusterd) to manage all clusters and instances.
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1804}{}\doxysection{Considered Alternatives}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1804}
...
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1805}{}\doxysection{Decision}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1805}
Managing the hierarchy in a single clusterd instance.\hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1806}{}\doxysection{Rationale}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1806}
