...
This plugin is a storage plugin that will use the syscall {\ttfamily uname (2)}. No resolver is needed for that plugin to work.\hypertarget{md_src_plugins_uname_README_autotoc_md572}{}\doxysection{Installation}\label{md_src_plugins_uname_README_autotoc_md572}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/extra}.\hypertarget{md_src_plugins_uname_README_autotoc_md573}{}\doxysection{Special Values}\label{md_src_plugins_uname_README_autotoc_md573}
...
\item version
\item machine
\end{DoxyItemize}\hypertarget{md_src_plugins_uname_README_autotoc_md574}{}\doxysection{Restrictions}\label{md_src_plugins_uname_README_autotoc_md574}
This plugin is read-\/only.\hypertarget{md_src_plugins_uname_README_autotoc_md575}{}\doxysection{Example}\label{md_src_plugins_uname_README_autotoc_md575}
