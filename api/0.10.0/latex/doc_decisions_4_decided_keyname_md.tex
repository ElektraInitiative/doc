...
\Hypertarget{doc_decisions_4_decided_keyname_md_md_doc_decisions_4_decided_keyname}%
 \hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2117}{}\doxysection{Problem}\label{doc_decisions_4_decided_keyname_md_autotoc_md2117}
...
The question now is, which representations should be used by {\ttfamily libelektra-\/core} and how.\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2118}{}\doxysection{Constraints}\label{doc_decisions_4_decided_keyname_md_autotoc_md2118}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2119}{}\doxysection{Assumptions}\label{doc_decisions_4_decided_keyname_md_autotoc_md2119}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2120}{}\doxysection{Considered Alternatives}\label{doc_decisions_4_decided_keyname_md_autotoc_md2120}
\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2121}{}\doxysubsection{Only escaped name}\label{doc_decisions_4_decided_keyname_md_autotoc_md2121}
...
Even with a separate namespace field, most benefits of \char`\"{}\+Only unescaped name\char`\"{} are retained. The memory consumption is near minimal (alignment padding can cause a difference). Comparisons are exactly the same, just with an additional namespace byte comparison beforehand.\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2124}{}\doxysubsection{Both escaped and unescaped name}\label{doc_decisions_4_decided_keyname_md_autotoc_md2124}
...
The issue with this approach is the insane memory consumption. Keynames can already be quite long and {\ttfamily Key} is at the base of Elektra. Storing every name twice in only slightly different forms essentially doubles the memory consumption.\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2125}{}\doxysubsection{Both escaped and unescaped name, but only unescaped stored}\label{doc_decisions_4_decided_keyname_md_autotoc_md2125}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2128}{}\doxysection{Rationale}\label{doc_decisions_4_decided_keyname_md_autotoc_md2128}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2129}{}\doxysection{Implications}\label{doc_decisions_4_decided_keyname_md_autotoc_md2129}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2130}{}\doxysection{Related Decisions}\label{doc_decisions_4_decided_keyname_md_autotoc_md2130}
\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2131}{}\doxysection{Notes}\label{doc_decisions_4_decided_keyname_md_autotoc_md2131}
\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2132}{}\doxysubsection{Printing unescaped name in GDB}\label{doc_decisions_4_decided_keyname_md_autotoc_md2132}
