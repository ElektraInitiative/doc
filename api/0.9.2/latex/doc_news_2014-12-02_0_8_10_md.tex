...
\end{DoxyItemize}\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md1934}{}\doxysection{X\+D\+G Compatibility}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md1934}
...
To make your application (that uses Elektra) X\+DG aware, you have nothing to do\+: you get it to free. Make sure to always use cascading lookup. Additionally, an X\+DG conforming application should not write system/ keys.\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md1935}{}\doxysection{Open\+I\+C\+C Compatibility}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md1935}
...
Of course this renaming functionality can be used in every situation and is not limited to Open\+I\+CC.\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md1936}{}\doxysection{Tools}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md1936}
...
\end{DoxyItemize}\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md1937}{}\doxysection{Compatibility}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md1937}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{Key *c = \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}}(\textcolor{stringliteral}{"/org/freedesktop"}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40afc1567f74444ff9c219f7456b652b4ec}{KEY\_CASCADING\_NAME}}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END}});}
\DoxyCodeLine{Key *m = \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}}(\textcolor{stringliteral}{"comment/\#0"}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40a5205cbd2831bc881da3589a95c08e054}{KEY\_META\_NAME}}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END}});}
\end{DoxyCode}
...
\end{DoxyItemize}\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md1938}{}\doxysection{C\+Make}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md1938}
...
will include all plugins except xmltool.\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md1939}{}\doxysection{Improved comments}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md1939}
...
Additionally, a small A\+PI for specific metadata operations emerges. These operations will be moved to a separate library and will not stay in Elektra’s core library.\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md1940}{}\doxysection{Proposal}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md1940}
...
\end{DoxyItemize}\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md1941}{}\doxysection{Java binding}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md1941}
Elektra now fully supports applications written in Java and also Plugins written in the same language.

The \href{https://github.com/ElektraInitiative/libelektra/tree/master/src/bindings/jna}{\texttt{ new binding was developed using jna.}} For the \href{https://github.com/ElektraInitiative/libelektra/tree/master/src/plugins/jni}{\texttt{ plugin interface J\+NI}} was used. We developed already \href{https://master.libelektra.org/src/bindings/jna/libelektra4j/src/main/java/org/libelektra/plugin}{\texttt{ some plugins}}.\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md1942}{}\doxysection{Qt-\/\+Gui}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md1942}
...
\end{DoxyItemize}\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md1943}{}\doxysection{Further stuff and small fixes}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md1943}
...
\end{DoxyItemize}\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md1944}{}\doxysection{Get It!}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md1944}
...
already built A\+P\+I-\/\+Docu can be found \href{https://doc.libelektra.org/api/0.8.10/html/}{\texttt{ here}}\hypertarget{doc_news_2014-12-02_0_8_10_md_autotoc_md1945}{}\doxysection{Stay tuned!}\label{doc_news_2014-12-02_0_8_10_md_autotoc_md1945}
