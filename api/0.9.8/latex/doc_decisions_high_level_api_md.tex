...
\Hypertarget{doc_decisions_high_level_api_md_md_doc_decisions_high_level_api}%
 \hypertarget{doc_decisions_high_level_api_md_autotoc_md1862}{}\doxysection{Problem}\label{doc_decisions_high_level_api_md_autotoc_md1862}
Projects usually do not want to use low-\/level APIs. {\ttfamily KDB} and {\ttfamily Key\+Set} is useful for plugins and to implement APIs but not to be directly used in applications.\hypertarget{doc_decisions_high_level_api_md_autotoc_md1863}{}\doxysection{Constraints}\label{doc_decisions_high_level_api_md_autotoc_md1863}
...
\end{DoxyItemize}
\end{DoxyEnumerate}\hypertarget{doc_decisions_high_level_api_md_autotoc_md1864}{}\doxysection{Assumptions}\label{doc_decisions_high_level_api_md_autotoc_md1864}
...
\end{DoxyItemize}\hypertarget{doc_decisions_high_level_api_md_autotoc_md1865}{}\doxysection{Considered Alternatives}\label{doc_decisions_high_level_api_md_autotoc_md1865}
...
\end{DoxyItemize}\hypertarget{doc_decisions_high_level_api_md_autotoc_md1866}{}\doxysection{Decision}\label{doc_decisions_high_level_api_md_autotoc_md1866}
...
\end{DoxyItemize}\hypertarget{doc_decisions_high_level_api_md_autotoc_md1867}{}\doxysection{Rationale}\label{doc_decisions_high_level_api_md_autotoc_md1867}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_high_level_api_md_autotoc_md1868}{}\doxysection{Implications}\label{doc_decisions_high_level_api_md_autotoc_md1868}
\hypertarget{doc_decisions_high_level_api_md_autotoc_md1869}{}\doxysection{Related Decisions}\label{doc_decisions_high_level_api_md_autotoc_md1869}
\hypertarget{doc_decisions_high_level_api_md_autotoc_md1870}{}\doxysection{Notes}\label{doc_decisions_high_level_api_md_autotoc_md1870}
