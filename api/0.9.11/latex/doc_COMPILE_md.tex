...
\Hypertarget{doc_COMPILE_md_md_doc_COMPILE}%
 \hypertarget{doc_COMPILE_md_autotoc_md1628}{}\doxysection{Dependencies}\label{doc_COMPILE_md_autotoc_md1628}
...
\end{DoxyCode}
\hypertarget{doc_COMPILE_md_autotoc_md1629}{}\doxysection{Quick Guide}\label{doc_COMPILE_md_autotoc_md1629}
...
The last line only runs tests without writing onto your system. See \mbox{\hyperlink{doc_TESTING_md}{TESTING}} for how to run more tests. Afterwards you can use {\ttfamily sudo make install \&\& sudo ldconfig} to install Elektra. See \mbox{\hyperlink{doc_INSTALL_md}{INSTALL}} for more information about installation of self-\/compiled Elektra (such as how to uninstall it).\hypertarget{doc_COMPILE_md_autotoc_md1630}{}\doxysection{Optional Dependencies}\label{doc_COMPILE_md_autotoc_md1630}
\begin{quote}
...
\hypertarget{doc_COMPILE_md_autotoc_md1631}{}\doxysubsection{Documentation dependencies}\label{doc_COMPILE_md_autotoc_md1631}
...
\end{DoxyCode}
\hypertarget{doc_COMPILE_md_autotoc_md1632}{}\doxysubsection{Plugin dependencies}\label{doc_COMPILE_md_autotoc_md1632}
...
\end{DoxyCode}
\hypertarget{doc_COMPILE_md_autotoc_md1633}{}\doxysection{Preparation}\label{doc_COMPILE_md_autotoc_md1633}
...
Some scripts in the folder of the same name may help you running cmake.\hypertarget{doc_COMPILE_md_autotoc_md1634}{}\doxysubsection{Compilers}\label{doc_COMPILE_md_autotoc_md1634}
...
To change the compiler with {\ttfamily ccmake}, you may need to toggle advanced options (key {\ttfamily t}).\hypertarget{doc_COMPILE_md_autotoc_md1635}{}\doxysubsection{Options}\label{doc_COMPILE_md_autotoc_md1635}
...
Examples for this are especially in the subsection {\ttfamily PLUGINS} below, but they work in the same fashion for {\ttfamily BINDINGS} and {\ttfamily TOOLS}.\hypertarget{doc_COMPILE_md_autotoc_md1636}{}\doxysubsubsection{Plugins}\label{doc_COMPILE_md_autotoc_md1636}
...
You can add resolver with any combination of the flags, even if they are not available in {\ttfamily ALL}.\hypertarget{doc_COMPILE_md_autotoc_md1637}{}\doxysubsubsection{Tools}\label{doc_COMPILE_md_autotoc_md1637}
...
\end{DoxyCode}
\hypertarget{doc_COMPILE_md_autotoc_md1638}{}\doxysubsubsection{Bindings}\label{doc_COMPILE_md_autotoc_md1638}
...
For a list of available bindings see binding\textquotesingle{}s README.md.\hypertarget{doc_COMPILE_md_autotoc_md1639}{}\doxysubsubsection{$<$tt$>$\+CMAKE\+\_\+\+BUILD\+\_\+\+TYPE$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1639}
{\ttfamily Debug}, {\ttfamily Release} or {\ttfamily Rel\+With\+Deb\+Info} See help bar at bottom of {\ttfamily ccmake} for that option or\+: \href{http://www.cmake.org/Wiki/CMake_Useful_Variables}{\texttt{ http\+://www.\+cmake.\+org/\+Wiki/\+CMake\+\_\+\+Useful\+\_\+\+Variables}}\hypertarget{doc_COMPILE_md_autotoc_md1640}{}\doxysubsection{$<$tt$>$\+BUILD\+\_\+\+SHARED BUILD\+\_\+\+FULL BUILD\+\_\+\+STATIC$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1640}
...
\end{DoxyCode}
\hypertarget{doc_COMPILE_md_autotoc_md1641}{}\doxysubsubsection{BUILD\+\_\+\+DOCUMENTATION}\label{doc_COMPILE_md_autotoc_md1641}
...
\hypertarget{doc_COMPILE_md_autotoc_md1642}{}\doxysubsubsection{Developer Options}\label{doc_COMPILE_md_autotoc_md1642}
...
Continue reading \mbox{\hyperlink{doc_TESTING_md}{testing}} for more information about testing.\hypertarget{doc_COMPILE_md_autotoc_md1643}{}\doxysubsubsection{$<$tt$>$\+CMAKE\+\_\+\+INSTALL\+\_\+\+PREFIX$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1643}
...
If you want to create a package afterwards it is ok to use paths that you can write to (e.\+g. {\ttfamily -\/DCMAKE\+\_\+\+INSTALL\+\_\+\+PREFIX=/home/username/})\hypertarget{doc_COMPILE_md_autotoc_md1644}{}\doxysubsubsection{$<$tt$>$\+LIB\+\_\+\+SUFFIX$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1644}
Lets you install libraries into architecture specific folder. E.\+g. for 32/64 bit systems you might install libraries under {\ttfamily lib64}. Set {\ttfamily LIB\+\_\+\+SUFFIX} to {\ttfamily 64} to achieve exactly that. So the system library folder will be {\ttfamily CMAKE\+\_\+\+INSTALL\+\_\+\+PREFIX/lib64} then.\hypertarget{doc_COMPILE_md_autotoc_md1645}{}\doxysubsubsection{$<$tt$>$\+TARGET\+\_\+\+INCLUDE\+\_\+\+FOLDER$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1645}
By default include folders will be installed below {\ttfamily CMAKE\+\_\+\+INSTALL\+\_\+\+PREFIX/include/elektra}. This entry let you change the elektra. If the entry is empty, the include files will be installed directly to {\ttfamily CMAKE\+\_\+\+INSTALL\+\_\+\+PREFIX/include}.\hypertarget{doc_COMPILE_md_autotoc_md1646}{}\doxysubsubsection{$<$tt$>$\+TARGET\+\_\+\+PLUGIN\+\_\+\+FOLDER$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1646}
Similar to above, but with the plugins. Default is\+: {\ttfamily CMAKE\+\_\+\+INSTALL\+\_\+\+PREFIX/lib\$\{LIB\+\_\+\+SUFFIX\}/elektra} It can be also left empty to install plugins next to other libraries.\hypertarget{doc_COMPILE_md_autotoc_md1647}{}\doxysubsubsection{$<$tt$>$\+GTEST\+\_\+\+ROOT$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1647}
...
It is recommended that you browse through all the options using {\ttfamily ccmake}. Afterwards press {\ttfamily c} again (maybe multiple times until all variables are resolved) and then {\ttfamily g} to generate. Finally press {\ttfamily e} to exit.\hypertarget{doc_COMPILE_md_autotoc_md1648}{}\doxysubsubsection{$<$tt$>$\+INSTALL\+\_\+\+BUILD\+\_\+\+TOOLS$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1648}
Specifies that the build tools, i.\+e. {\ttfamily elektra-\/export-\/symbols} and {\ttfamily elektra-\/export-\/symbols} are installed (by default off). Is needed for cross-\/compilation.\hypertarget{doc_COMPILE_md_autotoc_md1649}{}\doxysubsubsection{$<$tt$>$\+INSTALL\+\_\+\+SYSTEM\+\_\+\+FILES$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1649}
...
\hypertarget{doc_COMPILE_md_autotoc_md1650}{}\doxysubsubsection{$<$tt$>$\+ENABLE\+\_\+\+OPTIMIZATIONS$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1650}
In order to keep the binaries as small as possible this flag allows trading memory for speed.\hypertarget{doc_COMPILE_md_autotoc_md1651}{}\doxysection{Building}\label{doc_COMPILE_md_autotoc_md1651}
\hypertarget{doc_COMPILE_md_autotoc_md1652}{}\doxysubsection{Without IDE}\label{doc_COMPILE_md_autotoc_md1652}
...
Continue by reading \mbox{\hyperlink{doc_INSTALL_md}{INSTALL}}.\hypertarget{doc_COMPILE_md_autotoc_md1653}{}\doxysubsection{With Code\+Blocks}\label{doc_COMPILE_md_autotoc_md1653}
...
{\bfseries{Note 3\+:}} For Gentoo it\textquotesingle{}s recommended to emerge sys-\/apps/lsb-\/release to name the package right even thou not required.\hypertarget{doc_COMPILE_md_autotoc_md1654}{}\doxysection{Maintainer\textquotesingle{}s Guide}\label{doc_COMPILE_md_autotoc_md1654}
\hypertarget{doc_COMPILE_md_autotoc_md1655}{}\doxysubsection{Multiarch}\label{doc_COMPILE_md_autotoc_md1655}
...
\end{DoxyCode}
\hypertarget{doc_COMPILE_md_autotoc_md1656}{}\doxysubsection{$<$tt$>$\+RPATH$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md1656}
...
Alternatively, which gives you the advantage not to clutter the main library path, is to add the plugin folder in {\ttfamily /etc/ld.so.\+conf.\+d/elektra}. Note that it still allows applications to link against plugins.\hypertarget{doc_COMPILE_md_autotoc_md1657}{}\doxysection{Troubleshooting}\label{doc_COMPILE_md_autotoc_md1657}
\hypertarget{doc_COMPILE_md_autotoc_md1658}{}\doxysubsection{Dependencies not Available for Cent OS}\label{doc_COMPILE_md_autotoc_md1658}
...
\end{DoxyCode}
\hypertarget{doc_COMPILE_md_autotoc_md1659}{}\doxysubsection{Cross Compiling}\label{doc_COMPILE_md_autotoc_md1659}
