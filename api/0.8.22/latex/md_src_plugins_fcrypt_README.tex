...
you might want to consider disabling the sync plugin by entering\+: \begin{DoxyVerb}    kdb set /sw/elektra/kdb/#0/current/plugins ""
...
The G\+PG signature keys can be specified as {\ttfamily sign/key} directly. If you want to use more than one key for signing, just enumerate like\+: \begin{DoxyVerb}sign/key/#0
sign/key/#1
\end{DoxyVerb}
