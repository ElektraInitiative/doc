...
Elektra provides a mature, consistent and easily comprehensible API. Its modularity effectively avoids code duplication across applications and tools concerning their configuration tasks. Elektra abstracts from cross-\/platform-\/related issues and enables applications to be aware of other applications\textquotesingle{} configurations, leveraging easy application integration.\hypertarget{README_md_autotoc_md4141}{}\doxysection{Often Used Links}\label{README_md_autotoc_md4141}
...
\end{DoxyItemize}\hypertarget{README_md_autotoc_md4142}{}\doxysection{Overview}\label{README_md_autotoc_md4142}
...
In case you are worried about linking to such a powerful library. The core is a small library implemented in C, works cross-\/platform, and does not need any external dependencies. There are bindings for other languages in case C is too low-\/level for you.\hypertarget{README_md_autotoc_md4143}{}\doxysection{Contact}\label{README_md_autotoc_md4143}
Do not hesitate to ask any question on \href{https://issues.libelektra.org/}{\texttt{ Git\+Hub issue tracker}} or directly to one of the \mbox{\hyperlink{doc_AUTHORS_md}{authors}}.\hypertarget{README_md_autotoc_md4144}{}\doxysection{Quickstart}\label{README_md_autotoc_md4144}
\hypertarget{README_md_autotoc_md4145}{}\doxysubsection{Installation}\label{README_md_autotoc_md4145}
...
\hypertarget{README_md_autotoc_md4146}{}\doxysubsection{Usage}\label{README_md_autotoc_md4146}
...
\end{DoxyItemize}\hypertarget{README_md_autotoc_md4147}{}\doxysubsection{Documentation}\label{README_md_autotoc_md4147}
...
\begin{DoxyItemize}
\item \href{https://www.libelektra.org/manpages/kdb}{\texttt{ on the Website}}
...
\hypertarget{README_md_autotoc_md4148}{}\doxysection{Facts and Features}\label{README_md_autotoc_md4148}
...
\end{DoxyItemize}\hypertarget{README_md_autotoc_md4149}{}\doxysection{News}\label{README_md_autotoc_md4149}
Go to the \href{https://www.libelektra.org}{\texttt{ website}}, see the news, and its \href{https://www.libelektra.org/news/feed.rss}{\texttt{ RSS feed}}.\hypertarget{README_md_autotoc_md4150}{}\doxysection{Download}\label{README_md_autotoc_md4150}
...
Releases can be downloaded from \href{https://www.libelektra.org/ftp/elektra/releases/}{\texttt{ here}}.\hypertarget{README_md_autotoc_md4151}{}\doxysection{Build Server}\label{README_md_autotoc_md4151}
The \href{https://build.libelektra.org/}{\texttt{ build server}} builds Elektra for every pull request and on every commit in various ways and also produces \href{https://doc.libelektra.org/coverage/master/debian-buster-full/}{\texttt{ LCOV code coverage report}}.\hypertarget{README_md_autotoc_md4152}{}\doxysection{Contributing}\label{README_md_autotoc_md4152}
Take a look at \mbox{\hyperlink{doc_IDEAS_md}{how to start contributing}}.\hypertarget{README_md_autotoc_md4153}{}\doxysection{Goals}\label{README_md_autotoc_md4153}
