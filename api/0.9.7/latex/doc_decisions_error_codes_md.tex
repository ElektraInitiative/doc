...
\Hypertarget{doc_decisions_error_codes_md_md_doc_decisions_error_codes}%
 \hypertarget{doc_decisions_error_codes_md_autotoc_md1812}{}\doxysection{Problem}\label{doc_decisions_error_codes_md_autotoc_md1812}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_codes_md_autotoc_md1813}{}\doxysection{Constraints}\label{doc_decisions_error_codes_md_autotoc_md1813}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_codes_md_autotoc_md1814}{}\doxysection{Assumptions}\label{doc_decisions_error_codes_md_autotoc_md1814}
\hypertarget{doc_decisions_error_codes_md_autotoc_md1815}{}\doxysection{Considered Alternatives}\label{doc_decisions_error_codes_md_autotoc_md1815}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_codes_md_autotoc_md1816}{}\doxysection{Decision}\label{doc_decisions_error_codes_md_autotoc_md1816}
...
To see an explanation of the categories along with a guideline on how to categorize please see the \mbox{\hyperlink{doc_dev_error-categorization_md}{Error Codes Guideline}}\hypertarget{doc_decisions_error_codes_md_autotoc_md1817}{}\doxysection{Rationale}\label{doc_decisions_error_codes_md_autotoc_md1817}
...
These categories are chosen because they can help developers to react programmatically and cover the majority of use cases to our present knowledge. If there is ever the need for another reaction based category, it can be extended very easily.\hypertarget{doc_decisions_error_codes_md_autotoc_md1818}{}\doxysection{Implications}\label{doc_decisions_error_codes_md_autotoc_md1818}
...
Current errors will be migrated.\hypertarget{doc_decisions_error_codes_md_autotoc_md1819}{}\doxysection{Related Decisions}\label{doc_decisions_error_codes_md_autotoc_md1819}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_codes_md_autotoc_md1820}{}\doxysection{Notes}\label{doc_decisions_error_codes_md_autotoc_md1820}
