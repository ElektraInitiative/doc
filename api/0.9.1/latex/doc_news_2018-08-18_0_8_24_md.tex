...
\begin{DoxyItemize}
\item \href{http://libelektra.org/plugins/yamlcpp}{\texttt{ Y\+A\+ML C\+PP}} now requires at least {\ttfamily yaml-\/cpp 0.\+6}, since the current M\+SR test for the plugin triggers two bugs\+:
\begin{DoxyItemize}
