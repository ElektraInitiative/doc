...
\Hypertarget{doc_tutorials_namespaces_md_md_doc_tutorials_namespaces}%
 \hypertarget{doc_tutorials_namespaces_md_autotoc_md4369}{}\doxysection{Structure of the Key Database}\label{doc_tutorials_namespaces_md_autotoc_md4369}
...
For example {\ttfamily kdb get user\+:/tests/b/c} should return {\ttfamily Value 2} now, if you set the values before.\hypertarget{doc_tutorials_namespaces_md_autotoc_md4370}{}\doxysection{Namespaces}\label{doc_tutorials_namespaces_md_autotoc_md4370}
...
At this point the key database should have this structure\+: \hypertarget{doc_tutorials_namespaces_md_autotoc_md4371}{}\doxysubsection{Cascading Keys}\label{doc_tutorials_namespaces_md_autotoc_md4371}
...
Having namespaces enables both admins and users to set specific parts of the application\textquotesingle{}s configuration, as you will see in the following example.\hypertarget{doc_tutorials_namespaces_md_autotoc_md4372}{}\doxysection{How it Works on the Command Line (kdb)}\label{doc_tutorials_namespaces_md_autotoc_md4372}
