...
\end{DoxyItemize}\hypertarget{doc_tutorials_application-integration_md_autotoc_md2548}{}\doxysection{Elektrify}\label{doc_tutorials_application-integration_md_autotoc_md2548}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{Key *parentKey = \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}}(\textcolor{stringliteral}{"/sw/org/myapp/\#0/current"}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END}});}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{KDB *repo = \mbox{\hyperlink{group__kdb_ga6808defe5870f328dd17910aacbdc6ca}{kdbOpen}}(parentKey);}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{KeySet *conf = \mbox{\hyperlink{group__keyset_ga671e1aaee3ae9dc13b4834a4ddbd2c3c}{ksNew}}(200, \mbox{\hyperlink{kdbenum_8c_a7a28fce3773b2c873c94ac80b8b4cd54}{KS\_END}});}
\end{DoxyCode}
...
For more information about that, continue reading \href{https://master.libelektra.org/src/tools/pythongen}{\texttt{ here}}.\hypertarget{doc_tutorials_application-integration_md_autotoc_md2551}{}\doxysection{Specification}\label{doc_tutorials_application-integration_md_autotoc_md2551}
...
To make this work within your application make sure to always call {\ttfamily ks\+Lookup} before using a value from Elektra.\hypertarget{doc_tutorials_application-integration_md_autotoc_md2553}{}\doxysubsection{Specfiles}\label{doc_tutorials_application-integration_md_autotoc_md2553}
