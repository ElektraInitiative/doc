...
\Hypertarget{doc_help_kdb-export_md_md_doc_help_kdb_export}%
 \hypertarget{doc_help_kdb-export_md_autotoc_md2355}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-export_md_autotoc_md2355}
{\ttfamily kdb export $<$source$>$ \mbox{[}$<$format$>$\mbox{]}}~\newline
\hypertarget{doc_help_kdb-export_md_autotoc_md2356}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-export_md_autotoc_md2356}
...
\hypertarget{doc_help_kdb-export_md_autotoc_md2357}{}\doxysection{USAGE}\label{doc_help_kdb-export_md_autotoc_md2357}
Where {\ttfamily source} is the path of the key(s) you want to export. Additionally, the user can specify a format to use by passing it as the option argument {\ttfamily format}.~\newline
 ...
 The {\ttfamily storage} plugin can be configured at compile-\/time or changed by the link {\ttfamily libelektra-\/storage.\+so}.\hypertarget{doc_help_kdb-export_md_autotoc_md2358}{}\doxysection{OPTIONS}\label{doc_help_kdb-export_md_autotoc_md2358}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-export_md_autotoc_md2359}{}\doxysection{KDB}\label{doc_help_kdb-export_md_autotoc_md2359}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-export_md_autotoc_md2360}{}\doxysection{EXAMPLES}\label{doc_help_kdb-export_md_autotoc_md2360}
...
\end{DoxyCode}
\hypertarget{doc_help_kdb-export_md_autotoc_md2361}{}\doxysection{Note}\label{doc_help_kdb-export_md_autotoc_md2361}
