...
\Hypertarget{doc_decisions_4_decided_header_file_structure_md_md_doc_decisions_4_decided_header_file_structure}%
 \hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2085}{}\doxysection{Problem}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2085}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2086}{}\doxysection{Constraints}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2086}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2087}{}\doxysection{Assumptions}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2087}
...
\end{DoxyEnumerate}
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2088}{}\doxysection{Considered Alternatives}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2088}
\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2089}{}\doxysection{Decision}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2089}
The decision is split into 4 subsections \char`\"{}\+Libraries\char`\"{}, \char`\"{}\+Plugins\char`\"{}, \char`\"{}\+Tools\char`\"{} and \char`\"{}\+Tests\char`\"{}, because the different parts of Elektra have different requirements.\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2090}{}\doxysubsection{Libraries}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2090}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2091}{}\doxysubsection{Plugins}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2091}
...
Importantly, however, headers belonging to plugins must not be used outside the plugin.\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2092}{}\doxysubsection{Tools}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2092}
...
Just like with plugins, the headers belonging to tools must not be used elsewhere.\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2093}{}\doxysubsection{Tests}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2093}
...
If a symbol is needed in only one file and for tests, option 1 should be preferred. For symbols that are used in multiple files, a header needs to exist anyway. In any case, these unit tests should not be installed and should statically link the library into the test executable. This way we don\textquotesingle{}t pollute our {\ttfamily symbols.\+map} files and keep the number of exported symbols down.\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2094}{}\doxysection{Rationale}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2094}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2095}{}\doxysection{Implications}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2095}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2096}{}\doxysection{Related Decisions}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2096}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2097}{}\doxysection{Notes}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2097}
