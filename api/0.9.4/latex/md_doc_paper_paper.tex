...
This simplifies writing new applications \mbox{[}\mbox{]} because we can also generate documentation and code to parse command-\/line options. But this technique can also be used to replace existing hand-\/written code.\hypertarget{md_doc_paper_paper_autotoc_md2724}{}\section{References}\label{md_doc_paper_paper_autotoc_md2724}
