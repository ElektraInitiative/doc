...
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_md_autotoc_md1126}{}\doxysection{Assumptions}\label{doc_decisions_elektra_web_md_autotoc_md1126}
\hypertarget{doc_decisions_elektra_web_md_autotoc_md1127}{}\doxysection{Considered Alternatives}\label{doc_decisions_elektra_web_md_autotoc_md1127}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_md_autotoc_md1128}{}\doxysection{Decision}\label{doc_decisions_elektra_web_md_autotoc_md1128}
Use one cluster daemon (clusterd) to manage all clusters and instances.\hypertarget{doc_decisions_elektra_web_md_autotoc_md1129}{}\doxysection{Rationale}\label{doc_decisions_elektra_web_md_autotoc_md1129}
