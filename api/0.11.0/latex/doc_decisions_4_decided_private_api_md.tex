...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_private_api_md_autotoc_md2191}{}\doxysection{Assumptions}\label{doc_decisions_4_decided_private_api_md_autotoc_md2191}
\hypertarget{doc_decisions_4_decided_private_api_md_autotoc_md2192}{}\doxysection{Considered Alternatives}\label{doc_decisions_4_decided_private_api_md_autotoc_md2192}

\begin{DoxyItemize}
\item keep current situation, as described above
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_private_api_md_autotoc_md2193}{}\doxysection{Decision}\label{doc_decisions_4_decided_private_api_md_autotoc_md2193}

\begin{DoxyItemize}
\item Also allow other libraries (e.\+g. a new {\ttfamily libelektra-\/operations}) to access non-\/public API. Such libraries need to have a good reason (e.\+g. performance, impossible otherwise, etc.) why they access non-\/public API and they need to be kept up-\/to-\/date. If a library cannot provide a stable API on top of the unstable non-\/public API, it clearly needs to state which APIs are not stable.
\item Put struct definitions of Key/\+Key\+Set in a separate header file, which gets included by parts that need it (see also \mbox{\hyperlink{doc_decisions_4_decided_header_file_structure_md}{Header File Structure}}).
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_private_api_md_autotoc_md2194}{}\doxysection{Rationale}\label{doc_decisions_4_decided_private_api_md_autotoc_md2194}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_private_api_md_autotoc_md2195}{}\doxysection{Implications}\label{doc_decisions_4_decided_private_api_md_autotoc_md2195}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_private_api_md_autotoc_md2196}{}\doxysection{Related Decisions}\label{doc_decisions_4_decided_private_api_md_autotoc_md2196}

\begin{DoxyItemize}
\item \mbox{\hyperlink{doc_decisions_4_decided_header_file_structure_md}{Header File Structure}}
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_private_api_md_autotoc_md2197}{}\doxysection{Notes}\label{doc_decisions_4_decided_private_api_md_autotoc_md2197}
