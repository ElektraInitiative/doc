...
\Hypertarget{doc_help_kdb-file_md_md_doc_help_kdb_file}%
 \hypertarget{doc_help_kdb-file_md_autotoc_md2371}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-file_md_autotoc_md2371}
{\ttfamily kdb file $<$key name$>$}~\newline


Where {\ttfamily key name} is the name of the key to check.~\newline
\hypertarget{doc_help_kdb-file_md_autotoc_md2372}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-file_md_autotoc_md2372}
This command prints which file a given key is stored in.~\newline
 ...
 This command makes use of Elektra’s {\ttfamily resolver} plugin which the uer can learn more about by running the command {\ttfamily kdb plugin-\/info resolver}.\hypertarget{doc_help_kdb-file_md_autotoc_md2373}{}\doxysection{OPTIONS}\label{doc_help_kdb-file_md_autotoc_md2373}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-file_md_autotoc_md2374}{}\doxysection{KDB}\label{doc_help_kdb-file_md_autotoc_md2374}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-file_md_autotoc_md2375}{}\doxysection{EXAMPLES}\label{doc_help_kdb-file_md_autotoc_md2375}
To find which file a key is stored in\+:~\newline
 {\ttfamily kdb file user\+:/example/key}~\newline
\hypertarget{doc_help_kdb-file_md_autotoc_md2376}{}\doxysection{SEE ALSO}\label{doc_help_kdb-file_md_autotoc_md2376}
