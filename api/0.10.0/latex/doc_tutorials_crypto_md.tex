...
\item {\ttfamily fcrypt}.
\end{DoxyEnumerate}\hypertarget{doc_tutorials_crypto_md_autotoc_md4369}{}\doxysection{Prerequisites -\/ Gnu\+PG}\label{doc_tutorials_crypto_md_autotoc_md4369}
...
The {\ttfamily fcrypt} plugin and the {\ttfamily crypto} plugin support both versions (version 1 and version 2) of GPG.\hypertarget{doc_tutorials_crypto_md_autotoc_md4370}{}\doxysection{Introduction}\label{doc_tutorials_crypto_md_autotoc_md4370}
...
We also show how to approach integrity with the signature features of the {\ttfamily fcrypt} plugin.\hypertarget{doc_tutorials_crypto_md_autotoc_md4371}{}\doxysection{Configuration File Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md4371}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md4372}{}\doxysection{Configuration File Signatures}\label{doc_tutorials_crypto_md_autotoc_md4372}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md4373}{}\doxysubsection{Combining Signatures and Encryption}\label{doc_tutorials_crypto_md_autotoc_md4373}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md4374}{}\doxysection{Configuration Value Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md4374}
...
As a result you get \char`\"{}1234\char`\"{}.\hypertarget{doc_tutorials_crypto_md_autotoc_md4376}{}\doxysubsection{Disabling Encryption}\label{doc_tutorials_crypto_md_autotoc_md4376}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md4377}{}\doxysubsection{Complete Example}\label{doc_tutorials_crypto_md_autotoc_md4377}
The complete example looks like this\+:
