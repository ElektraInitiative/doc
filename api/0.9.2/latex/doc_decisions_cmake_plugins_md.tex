\hypertarget{doc_decisions_cmake_plugins_md_autotoc_md1067}{}\doxysection{Problem}\label{doc_decisions_cmake_plugins_md_autotoc_md1067}
...
\end{DoxyItemize}\hypertarget{doc_decisions_cmake_plugins_md_autotoc_md1068}{}\doxysection{Constraints}\label{doc_decisions_cmake_plugins_md_autotoc_md1068}
...
\end{DoxyItemize}\hypertarget{doc_decisions_cmake_plugins_md_autotoc_md1069}{}\doxysection{Assumptions}\label{doc_decisions_cmake_plugins_md_autotoc_md1069}
\hypertarget{doc_decisions_cmake_plugins_md_autotoc_md1070}{}\doxysection{Considered Alternatives}\label{doc_decisions_cmake_plugins_md_autotoc_md1070}
...
\end{DoxyItemize}\hypertarget{doc_decisions_cmake_plugins_md_autotoc_md1071}{}\doxysection{Decision}\label{doc_decisions_cmake_plugins_md_autotoc_md1071}
...
\end{DoxyItemize}
\end{DoxyEnumerate}\hypertarget{doc_decisions_cmake_plugins_md_autotoc_md1072}{}\doxysection{Rationale}\label{doc_decisions_cmake_plugins_md_autotoc_md1072}
...
\end{DoxyItemize}\hypertarget{doc_decisions_cmake_plugins_md_autotoc_md1073}{}\doxysection{Implications}\label{doc_decisions_cmake_plugins_md_autotoc_md1073}

\begin{DoxyItemize}
\item need to adopt all C\+Make\+Lists.\+txt
\end{DoxyItemize}\hypertarget{doc_decisions_cmake_plugins_md_autotoc_md1074}{}\doxysection{Related Decisions}\label{doc_decisions_cmake_plugins_md_autotoc_md1074}

\begin{DoxyItemize}
\item \mbox{\hyperlink{doc_decisions_plugin_variants_md}{Plugin Variants}}
\end{DoxyItemize}\hypertarget{doc_decisions_cmake_plugins_md_autotoc_md1075}{}\doxysection{Notes}\label{doc_decisions_cmake_plugins_md_autotoc_md1075}
\hypertarget{doc_decisions_cmake_plugins_md_autotoc_md1076}{}\doxysection{Limitations}\label{doc_decisions_cmake_plugins_md_autotoc_md1076}
