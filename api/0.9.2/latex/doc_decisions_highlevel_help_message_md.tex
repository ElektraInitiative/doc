This decision {\itshape does not} assume code-\/generation is used. For the case of code-\/generation see the \href{\#notes}{\texttt{ Notes}} section.\hypertarget{doc_decisions_highlevel_help_message_md_autotoc_md1236}{}\doxysection{Problem}\label{doc_decisions_highlevel_help_message_md_autotoc_md1236}
We want to allow to print the help message no matter what errors happened in {\ttfamily kdb\+Open} or {\ttfamily kdb\+Get}.\hypertarget{doc_decisions_highlevel_help_message_md_autotoc_md1237}{}\doxysection{Constraints}\label{doc_decisions_highlevel_help_message_md_autotoc_md1237}
...
\end{DoxyItemize}\hypertarget{doc_decisions_highlevel_help_message_md_autotoc_md1238}{}\doxysection{Assumptions}\label{doc_decisions_highlevel_help_message_md_autotoc_md1238}
...
\end{DoxyItemize}\hypertarget{doc_decisions_highlevel_help_message_md_autotoc_md1239}{}\doxysection{Considered Alternatives}\label{doc_decisions_highlevel_help_message_md_autotoc_md1239}
...
\end{DoxyItemize}\hypertarget{doc_decisions_highlevel_help_message_md_autotoc_md1240}{}\doxysection{Decision}\label{doc_decisions_highlevel_help_message_md_autotoc_md1240}
Ignore missing {\ttfamily require}d keys (in help mode), but fail for every other error.\hypertarget{doc_decisions_highlevel_help_message_md_autotoc_md1241}{}\doxysection{Rationale}\label{doc_decisions_highlevel_help_message_md_autotoc_md1241}
...
In any case after this the user definitely know how to interact with the K\+DB. Since we assumed that there won\textquotesingle{}t be any errors before the K\+DB was changed, we can assume that the user caused other errors by changing the K\+DB.\hypertarget{doc_decisions_highlevel_help_message_md_autotoc_md1242}{}\doxysection{Notes}\label{doc_decisions_highlevel_help_message_md_autotoc_md1242}
