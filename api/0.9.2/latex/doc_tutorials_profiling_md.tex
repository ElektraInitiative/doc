\hypertarget{doc_tutorials_profiling_md_autotoc_md2753}{}\doxysection{Execution Time}\label{doc_tutorials_profiling_md_autotoc_md2753}
...
\end{DoxyEnumerate}\hypertarget{doc_tutorials_profiling_md_autotoc_md2754}{}\doxysubsection{Callgrind}\label{doc_tutorials_profiling_md_autotoc_md2754}
\hypertarget{doc_tutorials_profiling_md_autotoc_md2755}{}\doxysubsubsection{Choosing the Correct Build Type}\label{doc_tutorials_profiling_md_autotoc_md2755}
...
. We use {\ttfamily Debug} here, which should provide the most detailed profiling information.\hypertarget{doc_tutorials_profiling_md_autotoc_md2756}{}\doxysubsubsection{Disabling $<$tt$>$dlclose$<$/tt$>$ Calls}\label{doc_tutorials_profiling_md_autotoc_md2756}
...
. An unfortunate effect of this code update is that Elektra will now leak memory when it unloads a plugin. On the other hand, Callgrind will be able to add source code information about the ../../src/plugins/yajl/\+R\+E\+A\+D\+ME.md \char`\"{}\+Y\+A\+J\+L\char`\"{} plugin to the profiling output.\hypertarget{doc_tutorials_profiling_md_autotoc_md2757}{}\doxysubsubsection{Building Elektra}\label{doc_tutorials_profiling_md_autotoc_md2757}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_profiling_md_autotoc_md2758}{}\doxysubsubsection{Profiling the Code}\label{doc_tutorials_profiling_md_autotoc_md2758}
...
. You can now select different parts of the call graph on the left to check which parts of the code take a long time to execute.\hypertarget{doc_tutorials_profiling_md_autotoc_md2759}{}\doxysubsection{X\+Ray}\label{doc_tutorials_profiling_md_autotoc_md2759}
\href{https://llvm.org/docs/XRay.html}{\texttt{ X\+Ray}} is an extension for L\+L\+VM that adds profiling code to binaries. Profiling can be dynamically enabled and disabled via the environment variable {\ttfamily X\+R\+A\+Y\+\_\+\+O\+P\+T\+I\+O\+NS}.\hypertarget{doc_tutorials_profiling_md_autotoc_md2760}{}\doxysubsubsection{Choosing the Correct Build Type}\label{doc_tutorials_profiling_md_autotoc_md2760}
