...
\Hypertarget{doc_dev_logging_md_md_doc_dev_logging}%
 \hypertarget{doc_dev_logging_md_autotoc_md2186}{}\doxysection{Quickstart}\label{doc_dev_logging_md_autotoc_md2186}
...
The file sink behaves like syslog, if it has been enabled (see below).\hypertarget{doc_dev_logging_md_autotoc_md2187}{}\doxysection{Step by Step Guide}\label{doc_dev_logging_md_autotoc_md2187}
\hypertarget{doc_dev_logging_md_autotoc_md2188}{}\doxysubsection{Preparation}\label{doc_dev_logging_md_autotoc_md2188}
...
\end{DoxyCode}
\hypertarget{doc_dev_logging_md_autotoc_md2189}{}\doxysubsubsection{Log Everything}\label{doc_dev_logging_md_autotoc_md2189}
...
\end{DoxyCode}
\hypertarget{doc_dev_logging_md_autotoc_md2190}{}\doxysubsubsection{File Specific Logging}\label{doc_dev_logging_md_autotoc_md2190}
...
\end{DoxyCode}
\hypertarget{doc_dev_logging_md_autotoc_md2191}{}\doxysubsection{Enabling and Disabling Sinks}\label{doc_dev_logging_md_autotoc_md2191}
...
\end{DoxyCode}
\hypertarget{doc_dev_logging_md_autotoc_md2192}{}\doxysubsection{Compilation}\label{doc_dev_logging_md_autotoc_md2192}

\begin{DoxyEnumerate}
\item Enable the logger\+: e.\+g. run {\ttfamily cmake} with the switch {\ttfamily -\/DENABLE\+\_\+\+LOGGER=ON}
\item Build Elektra
\end{DoxyEnumerate}\hypertarget{doc_dev_logging_md_autotoc_md2193}{}\doxysection{Log Levels}\label{doc_dev_logging_md_autotoc_md2193}
