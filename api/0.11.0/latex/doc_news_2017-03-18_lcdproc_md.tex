...
\item {\ttfamily kdb editor}, which spawns your favorite editor but validates the configuration file before writing it out.
...
\end{DoxyItemize}\hypertarget{doc_news_2017-03-18_lcdproc_md_autotoc_md3448}{}\doxysection{Validation}\label{doc_news_2017-03-18_lcdproc_md_autotoc_md3448}
Instead of {\ttfamily if}s within the code, we will use Spec\+Elektra for validation. \href{https://www.libelektra.org/man-pages/elektra-glossary}{\texttt{ Spec\+Elektra}} is a configuration specification language that allows us to describe which configuration is valid.
...
\end{DoxyItemize}\hypertarget{doc_news_2017-03-18_lcdproc_md_autotoc_md3449}{}\doxysection{Code Generation}\label{doc_news_2017-03-18_lcdproc_md_autotoc_md3449}
...
\begin{DoxyItemize}
\item For more information about code generation, see the \href{https://www.libelektra.org/tools/pythongen}{\texttt{ tutorial}}
\end{DoxyItemize}\hypertarget{doc_news_2017-03-18_lcdproc_md_autotoc_md3450}{}\doxysection{Risks}\label{doc_news_2017-03-18_lcdproc_md_autotoc_md3450}
...
For more information, see the \href{https://www.libelektra.org/man-pages/elektra-faq}{\texttt{ FAQ}}.\hypertarget{doc_news_2017-03-18_lcdproc_md_autotoc_md3451}{}\doxysection{Win-\/\+Win}\label{doc_news_2017-03-18_lcdproc_md_autotoc_md3451}
...
Obviously, we cannot fully port every FLOSS project ourselves, instead we will handle requests on a first come, first serve basis. Earlier projects will also have an higher impact on the feature set of Elektra, thus you will less likely need to implement your own plugin.\hypertarget{doc_news_2017-03-18_lcdproc_md_autotoc_md3452}{}\doxysection{See Also}\label{doc_news_2017-03-18_lcdproc_md_autotoc_md3452}
