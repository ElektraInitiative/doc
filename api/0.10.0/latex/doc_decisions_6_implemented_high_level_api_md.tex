...
\Hypertarget{doc_decisions_6_implemented_high_level_api_md_md_doc_decisions_6_implemented_high_level_api}%
 \hypertarget{doc_decisions_6_implemented_high_level_api_md_autotoc_md2394}{}\doxysection{Problem}\label{doc_decisions_6_implemented_high_level_api_md_autotoc_md2394}
Projects usually do not want to use low-\/level APIs. {\ttfamily KDB} and {\ttfamily Key\+Set} is useful for plugins and to implement APIs but not to be directly used in applications.\hypertarget{doc_decisions_6_implemented_high_level_api_md_autotoc_md2395}{}\doxysection{Constraints}\label{doc_decisions_6_implemented_high_level_api_md_autotoc_md2395}
...
\end{DoxyItemize}
\end{DoxyEnumerate}\hypertarget{doc_decisions_6_implemented_high_level_api_md_autotoc_md2396}{}\doxysection{Assumptions}\label{doc_decisions_6_implemented_high_level_api_md_autotoc_md2396}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_high_level_api_md_autotoc_md2397}{}\doxysection{Considered Alternatives}\label{doc_decisions_6_implemented_high_level_api_md_autotoc_md2397}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_high_level_api_md_autotoc_md2398}{}\doxysection{Decision}\label{doc_decisions_6_implemented_high_level_api_md_autotoc_md2398}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_high_level_api_md_autotoc_md2399}{}\doxysection{Rationale}\label{doc_decisions_6_implemented_high_level_api_md_autotoc_md2399}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_6_implemented_high_level_api_md_autotoc_md2400}{}\doxysection{Implications}\label{doc_decisions_6_implemented_high_level_api_md_autotoc_md2400}
\hypertarget{doc_decisions_6_implemented_high_level_api_md_autotoc_md2401}{}\doxysection{Related Decisions}\label{doc_decisions_6_implemented_high_level_api_md_autotoc_md2401}
\hypertarget{doc_decisions_6_implemented_high_level_api_md_autotoc_md2402}{}\doxysection{Notes}\label{doc_decisions_6_implemented_high_level_api_md_autotoc_md2402}
