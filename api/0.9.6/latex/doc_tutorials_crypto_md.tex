...
\item {\ttfamily fcrypt}.
\end{DoxyEnumerate}\hypertarget{doc_tutorials_crypto_md_autotoc_md3490}{}\doxysection{Prerequisites -\/ Gnu\+PG}\label{doc_tutorials_crypto_md_autotoc_md3490}
...
The {\ttfamily fcrypt} plugin and the {\ttfamily crypto} plugin support both versions (version 1 and version 2) of GPG.\hypertarget{doc_tutorials_crypto_md_autotoc_md3491}{}\doxysection{Introduction}\label{doc_tutorials_crypto_md_autotoc_md3491}
...
We also show how to approach integrity with the signature features of the {\ttfamily fcrypt} plugin.\hypertarget{doc_tutorials_crypto_md_autotoc_md3492}{}\doxysection{Configuration File Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md3492}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3493}{}\doxysection{Configuration File Signatures}\label{doc_tutorials_crypto_md_autotoc_md3493}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3494}{}\doxysubsection{Combining Signatures and Encryption}\label{doc_tutorials_crypto_md_autotoc_md3494}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3495}{}\doxysection{Configuration Value Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md3495}
...
As a result you get \char`\"{}1234\char`\"{}.\hypertarget{doc_tutorials_crypto_md_autotoc_md3497}{}\doxysubsection{Disabling Encryption}\label{doc_tutorials_crypto_md_autotoc_md3497}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3498}{}\doxysubsection{Complete Example}\label{doc_tutorials_crypto_md_autotoc_md3498}
The complete example looks like this\+:
