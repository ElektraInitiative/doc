...
This plugin checks whether the value of a key is a valid file system path and optionally if correct permissions are set for a certain user.\hypertarget{md_src_plugins_path_README_autotoc_md390}{}\doxysection{Installation}\label{md_src_plugins_path_README_autotoc_md390}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/extra}.\hypertarget{md_src_plugins_path_README_autotoc_md391}{}\doxysection{Purpose}\label{md_src_plugins_path_README_autotoc_md391}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_path_README_autotoc_md392}{}\doxysection{Usage}\label{md_src_plugins_path_README_autotoc_md392}
If the metakey {\ttfamily check/path} is present, it is checked if the value is a valid absolute file system path. If a metavalue is present, an additional check will be done if it is a directory or device file.\hypertarget{md_src_plugins_path_README_autotoc_md393}{}\doxysection{Examples}\label{md_src_plugins_path_README_autotoc_md393}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_path_README_autotoc_md394}{}\doxysection{Future work}\label{md_src_plugins_path_README_autotoc_md394}
