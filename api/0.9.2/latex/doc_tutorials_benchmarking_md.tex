...
\end{DoxyCode}
\hypertarget{doc_tutorials_benchmarking_md_autotoc_md2565}{}\doxysubsection{Using the Plugin Benchmark Helper Tool}\label{doc_tutorials_benchmarking_md_autotoc_md2565}
...
\`{}\`{}\`{} build/bin/benchmark\+\_\+plugingetset benchmarks/data user yamlcpp get \hypertarget{doc_tutorials_benchmarking_md_autotoc_md2566}{}\doxysection{↑              ↑        ↑           ↑}\label{doc_tutorials_benchmarking_md_autotoc_md2566}
\hypertarget{doc_tutorials_benchmarking_md_autotoc_md2567}{}\doxysection{parent directory  namespace  plugin   only use $<$tt$>$get$<$/tt$>$}\label{doc_tutorials_benchmarking_md_autotoc_md2567}
\hypertarget{doc_tutorials_benchmarking_md_autotoc_md2568}{}\doxysection{of config file                       plugin method}\label{doc_tutorials_benchmarking_md_autotoc_md2568}

\begin{DoxyCode}{0}
\DoxyCodeLine{. If you can want you can also use the `time` utility to measure the execution time of the last command:}
\end{DoxyCode}


time build/bin/benchmark\+\_\+plugingetset benchmarks/data user yamlcpp get \#$>$ 0.\+00 real 0.\+00 user 0.\+00 sys \`{}\`{}\`{}

. As you can see in the output above a real configuration file that tests the performance of the ../../src/plugins/yamlcpp/\+R\+E\+A\+D\+ME.md \char`\"{}\+Y\+A\+M\+L C\+P\+P\char`\"{} plugin should be much larger.\hypertarget{doc_tutorials_benchmarking_md_autotoc_md2569}{}\doxysubsubsection{Comparing Execution Times}\label{doc_tutorials_benchmarking_md_autotoc_md2569}
