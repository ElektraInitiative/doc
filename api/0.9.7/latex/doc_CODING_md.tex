...
\Hypertarget{doc_CODING_md_md_doc_CODING}%
 This document provides an introduction in how the source code of libelektra is organized and how and where to add functionality.\hypertarget{doc_CODING_md_autotoc_md1587}{}\doxysection{Folder structure}\label{doc_CODING_md_autotoc_md1587}
...
More about the structure you find in the folder\textquotesingle{}s {\ttfamily README.\+md}.\hypertarget{doc_CODING_md_autotoc_md1588}{}\doxysection{General Information}\label{doc_CODING_md_autotoc_md1588}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1589}{}\doxysection{Source Code}\label{doc_CODING_md_autotoc_md1589}
The same guidelines apply to all code in the repository including the plugins.\hypertarget{doc_CODING_md_autotoc_md1590}{}\doxysubsection{General Guidelines}\label{doc_CODING_md_autotoc_md1590}
...
If you see inconsistency within the rules do not hesitate to open an issue about it.\hypertarget{doc_CODING_md_autotoc_md1591}{}\doxysubsection{Code Comments}\label{doc_CODING_md_autotoc_md1591}
...
\end{DoxyEnumerate}\hypertarget{doc_CODING_md_autotoc_md1592}{}\doxysubsection{Coding Style}\label{doc_CODING_md_autotoc_md1592}
...
{\bfseries{Example\+:}} \href{/home/jenkins/workspace/libelektra-release/src/libs/elektra/kdb.c}{\texttt{ src/libs/elektra/kdb.\+c}}\hypertarget{doc_CODING_md_autotoc_md1594}{}\doxysubsubsection{Clang Format}\label{doc_CODING_md_autotoc_md1594}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1595}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md1595}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1596}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md1596}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1597}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md1597}
...
. After that change Text\+Mate will reformat C and C++ code with {\ttfamily clang-\/format} every time you save a file.\hypertarget{doc_CODING_md_autotoc_md1598}{}\doxysubsection{C++ Guidelines}\label{doc_CODING_md_autotoc_md1598}
...
{\bfseries{Example\+:}} \href{/home/jenkins/workspace/libelektra-release/src/bindings/cpp/include/kdb.hpp}{\texttt{ src/bindings/cpp/include/kdb.\+hpp}}\hypertarget{doc_CODING_md_autotoc_md1599}{}\doxysubsection{CMake Guidelines}\label{doc_CODING_md_autotoc_md1599}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1600}{}\doxysubsubsection{cmake format}\label{doc_CODING_md_autotoc_md1600}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1601}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md1601}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1602}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md1602}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1603}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md1603}
...
in a file called \href{https://macromates.com/blog/2011/git-style-configuration}{\texttt{ {\ttfamily .tm\+\_\+properties}}} in the root of Elektra’s repository.\hypertarget{doc_CODING_md_autotoc_md1604}{}\doxysubsection{Groovy Guidelines}\label{doc_CODING_md_autotoc_md1604}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1605}{}\doxysubsection{Java}\label{doc_CODING_md_autotoc_md1605}
We use a similar style for Java and C/\+C++ code. This means we also use {\ttfamily clang-\/format} to format Java code. For more information on how to install {\ttfamily clang-\/format}, please take a look at the subheading “\+Clang Format” of the {\bfseries{“C Guidelines”}}.\hypertarget{doc_CODING_md_autotoc_md1606}{}\doxysubsubsection{Clang Format}\label{doc_CODING_md_autotoc_md1606}
...
\item Save your new command\+: {\ttfamily ⌘} + {\ttfamily S}
\end{DoxyEnumerate}
\end{DoxyEnumerate}\hypertarget{doc_CODING_md_autotoc_md1608}{}\doxysubsection{Java\+Script Guidelines}\label{doc_CODING_md_autotoc_md1608}
\hypertarget{doc_CODING_md_autotoc_md1609}{}\doxysubsubsection{Prettier}\label{doc_CODING_md_autotoc_md1609}
We use \href{https://prettier.io}{\texttt{ {\ttfamily prettier}}} to format Java\+Script files.\hypertarget{doc_CODING_md_autotoc_md1610}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md1610}
\doxysubparagraph*{mac\+OS}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1611}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md1611}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1612}{}\doxysubsection{Markdown Guidelines}\label{doc_CODING_md_autotoc_md1612}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1613}{}\doxysubsubsection{Prettier}\label{doc_CODING_md_autotoc_md1613}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1614}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md1614}
For information on how to install the tool, please take a look at “\+Java\+Script Guidelines” → “\+Prettier” → “\+Installation”.\hypertarget{doc_CODING_md_autotoc_md1615}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md1615}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1616}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md1616}
...
\item Save your new command\+: {\ttfamily ⌘} + {\ttfamily S}
\end{DoxyEnumerate}
\end{DoxyEnumerate}\hypertarget{doc_CODING_md_autotoc_md1617}{}\doxysubsection{Shell Guidelines}\label{doc_CODING_md_autotoc_md1617}

\begin{DoxyItemize}
\item Please only use \href{https://en.wikipedia.org/wiki/POSIX}{\texttt{ POSIX}} functionality.
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1618}{}\doxysubsubsection{shfmt}\label{doc_CODING_md_autotoc_md1618}
We use \href{https://github.com/mvdan/sh}{\texttt{ {\ttfamily shfmt}}} to format Shell files in the repository.\hypertarget{doc_CODING_md_autotoc_md1619}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md1619}
\doxysubparagraph*{mac\+OS}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1620}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md1620}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1621}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md1621}
...
\item Save your new command\+: {\ttfamily ⌘} + {\ttfamily S}
\end{DoxyEnumerate}
\end{DoxyEnumerate}\hypertarget{doc_CODING_md_autotoc_md1622}{}\doxysubsection{Doxygen Guidelines}\label{doc_CODING_md_autotoc_md1622}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1623}{}\doxysubsection{File Headers}\label{doc_CODING_md_autotoc_md1623}
...
The duplication of the filename, author and date is not needed, because this information is tracked using git and \mbox{\hyperlink{doc_AUTHORS_md}{doc/\+AUTHORS.md}} already.\hypertarget{doc_CODING_md_autotoc_md1624}{}\doxysection{Further Readings}\label{doc_CODING_md_autotoc_md1624}
