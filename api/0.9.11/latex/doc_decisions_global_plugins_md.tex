...
\Hypertarget{doc_decisions_global_plugins_md_md_doc_decisions_global_plugins}%
 \hypertarget{doc_decisions_global_plugins_md_autotoc_md1905}{}\doxysection{Problem}\label{doc_decisions_global_plugins_md_autotoc_md1905}
...
These problems can be traced back to the placement of the plugins. We need to clean up and simplify the placement.\hypertarget{doc_decisions_global_plugins_md_autotoc_md1906}{}\doxysection{Constraints}\label{doc_decisions_global_plugins_md_autotoc_md1906}
...
\end{DoxyItemize}\hypertarget{doc_decisions_global_plugins_md_autotoc_md1907}{}\doxysection{Assumptions}\label{doc_decisions_global_plugins_md_autotoc_md1907}
...
\end{DoxyItemize}\hypertarget{doc_decisions_global_plugins_md_autotoc_md1908}{}\doxysection{Considered Alternatives}\label{doc_decisions_global_plugins_md_autotoc_md1908}
...
\end{DoxyItemize}\hypertarget{doc_decisions_global_plugins_md_autotoc_md1909}{}\doxysection{Decision}\label{doc_decisions_global_plugins_md_autotoc_md1909}
...
Installed plugins will be used.\hypertarget{doc_decisions_global_plugins_md_autotoc_md1910}{}\doxysection{Rationale}\label{doc_decisions_global_plugins_md_autotoc_md1910}
...
\end{DoxyItemize}\hypertarget{doc_decisions_global_plugins_md_autotoc_md1911}{}\doxysection{Implications}\label{doc_decisions_global_plugins_md_autotoc_md1911}
...
\end{DoxyItemize}\hypertarget{doc_decisions_global_plugins_md_autotoc_md1912}{}\doxysection{Related Decisions}\label{doc_decisions_global_plugins_md_autotoc_md1912}

\begin{DoxyItemize}
\item \mbox{\hyperlink{doc_decisions_array_md}{Array}}
\item \mbox{\hyperlink{doc_decisions_ensure_md}{Ensure}}
\end{DoxyItemize}\hypertarget{doc_decisions_global_plugins_md_autotoc_md1913}{}\doxysection{Notes}\label{doc_decisions_global_plugins_md_autotoc_md1913}
