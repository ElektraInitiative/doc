...
Some days ago (16.\+03.\+2017), we met with Harald Geyer and discussed the current situation. We decided that we will elektrify L\+C\+Dproc and remove all the configuration access and parsing code within L\+C\+Dproc. To {\bfseries{elektrify}} an application means to change the application so that it uses Lib\+Elektra afterwards.\hypertarget{doc_news_2017-03-18_lcdproc_md_autotoc_md2127}{}\doxysection{Goals}\label{doc_news_2017-03-18_lcdproc_md_autotoc_md2127}
...
\item L\+C\+Dproc will depend on the yet-\/to-\/be-\/released \href{https://github.com/ElektraInitiative/libelektra/milestone/11}{\texttt{ 0.\+8.\+20}}. We will delay the 0.\+8.\+20 release until all parts for L\+C\+Dproc are tested and ready.
\end{DoxyItemize}
...
\end{DoxyItemize}\hypertarget{doc_news_2017-03-18_lcdproc_md_autotoc_md2128}{}\doxysection{Validation}\label{doc_news_2017-03-18_lcdproc_md_autotoc_md2128}
...
\end{DoxyItemize}\hypertarget{doc_news_2017-03-18_lcdproc_md_autotoc_md2129}{}\doxysection{Code Generation}\label{doc_news_2017-03-18_lcdproc_md_autotoc_md2129}
...
\end{DoxyItemize}\hypertarget{doc_news_2017-03-18_lcdproc_md_autotoc_md2130}{}\doxysection{Risks}\label{doc_news_2017-03-18_lcdproc_md_autotoc_md2130}
...
See \href{https://www.libelektra.org/docgettingstarted/installation}{\texttt{ I\+N\+S\+T\+A\+LL}} for the complete and up-\/to-\/date list.
...
For more information, see the \href{https://www.libelektra.org/manpages/elektra-faq}{\texttt{ F\+AQ}}.\hypertarget{doc_news_2017-03-18_lcdproc_md_autotoc_md2131}{}\doxysection{Win-\/\+Win}\label{doc_news_2017-03-18_lcdproc_md_autotoc_md2131}
...
Obviously, we cannot fully port every F\+L\+O\+SS project ourselves, instead we will handle requests on a first come, first serve basis. Earlier projects will also have an higher impact on the feature set of Elektra, thus you will less likely need to implement your own plugin.\hypertarget{doc_news_2017-03-18_lcdproc_md_autotoc_md2132}{}\doxysection{See Also}\label{doc_news_2017-03-18_lcdproc_md_autotoc_md2132}
