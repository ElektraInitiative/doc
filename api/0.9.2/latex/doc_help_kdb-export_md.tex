\hypertarget{doc_help_kdb-export_md_autotoc_md1648}{}\doxysection{S\+Y\+N\+O\+P\+S\+IS}\label{doc_help_kdb-export_md_autotoc_md1648}
{\ttfamily kdb export $<$source$>$ \mbox{[}$<$format$>$\mbox{]}}~\newline
\hypertarget{doc_help_kdb-export_md_autotoc_md1649}{}\doxysection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{doc_help_kdb-export_md_autotoc_md1649}
...
\hypertarget{doc_help_kdb-export_md_autotoc_md1650}{}\doxysection{U\+S\+A\+GE}\label{doc_help_kdb-export_md_autotoc_md1650}
Where {\ttfamily source} is the path of the key(s) you want to export. Additionally, the user can specify a format to use by passing it as the option argument {\ttfamily format}.~\newline
 ...
 The {\ttfamily storage} plugin can be configured at compile-\/time or changed by the link {\ttfamily libelektra-\/storage.\+so}.\hypertarget{doc_help_kdb-export_md_autotoc_md1651}{}\doxysection{O\+P\+T\+I\+O\+NS}\label{doc_help_kdb-export_md_autotoc_md1651}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-export_md_autotoc_md1652}{}\doxysection{K\+DB}\label{doc_help_kdb-export_md_autotoc_md1652}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-export_md_autotoc_md1653}{}\doxysection{E\+X\+A\+M\+P\+L\+ES}\label{doc_help_kdb-export_md_autotoc_md1653}
...
\DoxyCodeLine{\# cleanup}
\end{DoxyCode}
\hypertarget{doc_help_kdb-export_md_autotoc_md1654}{}\doxysection{Note}\label{doc_help_kdb-export_md_autotoc_md1654}
