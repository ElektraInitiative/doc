...
Elektra follows the goals below, in order of preference. If goals conflict, the higher goal takes precedence.\hypertarget{doc_GOALS_md_autotoc_md2751}{}\doxysection{0. Stability}\label{doc_GOALS_md_autotoc_md2751}
...
\end{DoxyItemize}\hypertarget{doc_GOALS_md_autotoc_md2752}{}\doxysection{1. Goal\+: Simplicity}\label{doc_GOALS_md_autotoc_md2752}
...
\end{DoxyItemize}\hypertarget{doc_GOALS_md_autotoc_md2753}{}\doxysection{2. Goal\+: Robustness}\label{doc_GOALS_md_autotoc_md2753}
...
We tackle this problem by introducing an abstraction layer where these problems are dealt with. The goal is that for improvements in these areas only code changes within Elektra are needed (and not within applications using Elektra). This makes the application\textquotesingle{}s code not only portable towards more systems, but also enables global improvements in configuration systems.\hypertarget{doc_GOALS_md_autotoc_md2754}{}\doxysection{3. Goal\+: Extensibility}\label{doc_GOALS_md_autotoc_md2754}
...
Only key-\/value pairs are the common factor and a way to get and set them, everything else is an extension.\hypertarget{doc_GOALS_md_autotoc_md2755}{}\doxysection{4. Goal\+: Performance}\label{doc_GOALS_md_autotoc_md2755}
...
\hypertarget{doc_GOALS_md_autotoc_md2756}{}\doxysection{Users}\label{doc_GOALS_md_autotoc_md2756}
These goals are about Elektra\textquotesingle{}s users, again in order of importance. Again, lower goals need to be ignored if goals are in conflict.\hypertarget{doc_GOALS_md_autotoc_md2757}{}\doxysubsection{1. Application Developers}\label{doc_GOALS_md_autotoc_md2757}
...
\hypertarget{doc_GOALS_md_autotoc_md2758}{}\doxysubsection{2. Administrators}\label{doc_GOALS_md_autotoc_md2758}
...
\hypertarget{doc_GOALS_md_autotoc_md2759}{}\doxysubsection{3. Maintainers}\label{doc_GOALS_md_autotoc_md2759}
...
\hypertarget{doc_GOALS_md_autotoc_md2760}{}\doxysubsection{4. Possibility to Represent any Configuration File Format}\label{doc_GOALS_md_autotoc_md2760}
...
\hypertarget{doc_GOALS_md_autotoc_md2761}{}\doxysection{Non-\/\+Goals\+:}\label{doc_GOALS_md_autotoc_md2761}
...
\end{DoxyItemize}\hypertarget{doc_GOALS_md_autotoc_md2762}{}\doxysubsection{Further Readings}\label{doc_GOALS_md_autotoc_md2762}
