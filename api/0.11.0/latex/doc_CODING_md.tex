...
\Hypertarget{doc_CODING_md_md_doc_CODING}%
 This document provides an introduction in how the source code of libelektra is organized and how and where to add functionality.\hypertarget{doc_CODING_md_autotoc_md747}{}\doxysection{Folder structure}\label{doc_CODING_md_autotoc_md747}
...
You can find more information about the structure in the {\ttfamily README.\+md}.\hypertarget{doc_CODING_md_autotoc_md748}{}\doxysection{General Information}\label{doc_CODING_md_autotoc_md748}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md749}{}\doxysection{Source Code}\label{doc_CODING_md_autotoc_md749}
The same guidelines apply to all code in the repository including the plugins.\hypertarget{doc_CODING_md_autotoc_md750}{}\doxysubsection{General Guidelines}\label{doc_CODING_md_autotoc_md750}
...
If you see inconsistency within the rules do not hesitate to open an issue about it.\hypertarget{doc_CODING_md_autotoc_md751}{}\doxysubsection{Code Comments}\label{doc_CODING_md_autotoc_md751}
...
\end{DoxyEnumerate}\hypertarget{doc_CODING_md_autotoc_md752}{}\doxysubsection{Coding Style}\label{doc_CODING_md_autotoc_md752}
...
{\bfseries{Example\+:}} \href{/home/jenkins/workspace/libelektra-release/src/libs/elektra/kdb.c}{\texttt{ src/libs/elektra/kdb.\+c}}\hypertarget{doc_CODING_md_autotoc_md754}{}\doxysubsubsection{Clang Format}\label{doc_CODING_md_autotoc_md754}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md755}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md755}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md756}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md756}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md757}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md757}
...
After that change Text\+Mate will reformat C and C++ code with {\ttfamily clang-\/format} every time you save a file.\hypertarget{doc_CODING_md_autotoc_md758}{}\doxysubsection{C++ Guidelines}\label{doc_CODING_md_autotoc_md758}
...
{\bfseries{Example\+:}} \href{/home/jenkins/workspace/libelektra-release/src/bindings/cpp/include/kdb.hpp}{\texttt{ src/bindings/cpp/include/kdb.\+hpp}}\hypertarget{doc_CODING_md_autotoc_md759}{}\doxysubsection{CMake Guidelines}\label{doc_CODING_md_autotoc_md759}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md760}{}\doxysubsubsection{CMake format}\label{doc_CODING_md_autotoc_md760}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md761}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md761}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md762}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md762}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md763}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md763}
...
in a file called \href{https://macromates.com/blog/2011/git-style-configuration}{\texttt{ {\ttfamily .tm\+\_\+properties}}} in the root of Elektra’s repository.\hypertarget{doc_CODING_md_autotoc_md764}{}\doxysubsection{Java \& Groovy Guidelines}\label{doc_CODING_md_autotoc_md764}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md765}{}\doxysubsubsection{Usage}\label{doc_CODING_md_autotoc_md765}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md766}{}\doxysubsection{Java\+Script Guidelines}\label{doc_CODING_md_autotoc_md766}
\hypertarget{doc_CODING_md_autotoc_md767}{}\doxysubsubsection{Prettier}\label{doc_CODING_md_autotoc_md767}
We use \href{https://prettier.io}{\texttt{ {\ttfamily prettier}}} to format Java\+Script files.\hypertarget{doc_CODING_md_autotoc_md768}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md768}
\doxysubparagraph*{mac\+OS}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md769}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md769}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md770}{}\doxysubsection{Markdown Guidelines}\label{doc_CODING_md_autotoc_md770}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md771}{}\doxysubsubsection{Prettier}\label{doc_CODING_md_autotoc_md771}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md772}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md772}
For information on how to install the tool, please take a look at “\+Java\+Script Guidelines” → “\+Prettier” → “\+Installation”.\hypertarget{doc_CODING_md_autotoc_md773}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md773}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md774}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md774}
...
\item Save your new command\+: {\ttfamily ⌘} + {\ttfamily S}
\end{DoxyEnumerate}
\end{DoxyEnumerate}\hypertarget{doc_CODING_md_autotoc_md775}{}\doxysubsection{Shell Guidelines}\label{doc_CODING_md_autotoc_md775}

\begin{DoxyItemize}
\item Please only use \href{https://en.wikipedia.org/wiki/POSIX}{\texttt{ POSIX}} functionality.
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md776}{}\doxysubsubsection{Shebang}\label{doc_CODING_md_autotoc_md776}
...
Note that even if a shebang is added by a preprocessor macro or similar code generation tools, it must also be present in the templated file.\hypertarget{doc_CODING_md_autotoc_md777}{}\doxysubsubsection{shfmt}\label{doc_CODING_md_autotoc_md777}
We use \href{https://github.com/mvdan/sh}{\texttt{ {\ttfamily shfmt}}} to format Shell files in the repository.\hypertarget{doc_CODING_md_autotoc_md778}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md778}
\doxysubparagraph*{mac\+OS}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md779}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md779}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md780}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md780}
...
\item Save your new command\+: {\ttfamily ⌘} + {\ttfamily S}
\end{DoxyEnumerate}
\end{DoxyEnumerate}\hypertarget{doc_CODING_md_autotoc_md781}{}\doxysubsection{Doxygen Guidelines}\label{doc_CODING_md_autotoc_md781}
...
Further Doxygen documentation can be found in the \mbox{\hyperlink{doc_doxygen_README_md}{Doxygen README}}.\hypertarget{doc_CODING_md_autotoc_md782}{}\doxysubsection{File Headers}\label{doc_CODING_md_autotoc_md782}
...
The duplication of the filename, author and date is not needed, because this information is tracked using Git and \mbox{\hyperlink{doc_AUTHORS_md}{doc/\+AUTHORS.md}} already.\hypertarget{doc_CODING_md_autotoc_md783}{}\doxysection{Further Readings}\label{doc_CODING_md_autotoc_md783}
