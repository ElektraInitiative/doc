...
\Hypertarget{doc_decisions_6_implemented_elektra_web_recursive_md_md_doc_decisions_6_implemented_elektra_web_recursive}%
 \hypertarget{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2351}{}\doxysection{Problem}\label{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2351}
After deciding how to remotely manage instances and groups of instances (clusters) with Elektra Web, there is still the issue of recursively nested clusters (clusters of clusters).\hypertarget{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2352}{}\doxysection{Constraints}\label{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2352}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2353}{}\doxysection{Assumptions}\label{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2353}

\begin{DoxyItemize}
\item Use one cluster daemon (clusterd) to manage all clusters and instances.
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2354}{}\doxysection{Considered Alternatives}\label{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2354}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2355}{}\doxysection{Decision}\label{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2355}
Managing the hierarchy in a single clusterd instance.\hypertarget{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2356}{}\doxysection{Rationale}\label{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2356}
