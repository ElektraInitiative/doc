This tutorial explains how to install, configure and run everything that is required for the Snippet Sharing service and website. As operating system we expect Debian Jessie to be used, although most parts should also be applicable to other systems.\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2783}{}\doxysection{What is This?}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2783}
The Snippet Sharing service consists of two parts, a backend (the R\+E\+ST server) and a frontend (an Angular\+JS application executed in the browser), which also includes the Elektra website. The service itself can be used to share configuration snippets, i.\+e. configuration files of arbitrary applications.\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2784}{}\doxysection{Installation}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2784}
\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2785}{}\doxysubsection{Install Dependencies}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2785}
As first step we need to install some dependencies required by the applications.\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2786}{}\doxysubsubsection{Backend}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2786}
...
You\textquotesingle{}ll also need C\+Make and a modern C/\+C++ compiler, so in case you don\textquotesingle{}t have them installed already, use {\ttfamily apt-\/get install build-\/essential cmake} to do so.\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2787}{}\doxyparagraph{A\+P\+T Packages}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2787}
To install all required A\+PT packages at once, simply run\+: {\ttfamily apt-\/get install libboost-\/all-\/dev libpcre3-\/dev zlib1g-\/dev libgcrypt11-\/dev libicu-\/dev python libssl-\/dev}\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2788}{}\doxyparagraph{Cpp\+C\+MS}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2788}
...
Further build and installation information can be found on their \href{http://cppcms.com/wikipp/en/page/cppcms_1x_build}{\texttt{ website}}. It contains also a \href{http://cppcms.com/wikipp/en/page/apt}{\texttt{ guide}} explaining the installation through a dependency manager. Unfortunately, no repository is available for Debian Jessie yet.\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2789}{}\doxyparagraph{Jansson}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2789}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2790}{}\doxyparagraph{Lib\+J\+WT}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2790}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2791}{}\doxysubsubsection{Frontend}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2791}
The frontend does only require the package manager \href{https://www.npmjs.com/}{\texttt{ npm}} ($>$= v3). It is preferred to install it along with \href{https://nodejs.org/}{\texttt{ node\+JS}}, for example via \href{https://nodejs.org/en/download/package-manager/}{\texttt{ provided packages}}. The version that comes via Debian Jessie (v1.\+4) is insufficient. The installation was tested with npm version 3.\+10.\+8-\/9, but it should also work with other versions of 3+.\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2792}{}\doxysubsection{Build \& Install the Applications}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2792}
...
After building Elektra and the applications, we can use {\ttfamily make install} to install them. Further information and troubleshooting can be found in the \mbox{\hyperlink{doc_INSTALL_md}{install guide}}.\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2793}{}\doxysection{Configuration}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2793}
The applications configure themselves as much as possible during build, but some settings have to be set manually afterwards.\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2794}{}\doxysubsection{Backend}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2794}
...
Note\+: here we have not used the option {\ttfamily -\/N system} because the Cpp\+C\+MS configuration is not part of the specification. That means it does not get validated.\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2795}{}\doxysubsection{Frontend}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2795}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2796}{}\doxysection{Running the Applications}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2796}
...
If everything went smooth, both applications should now be online and reachable.\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2797}{}\doxysection{Stopping the Applications}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2797}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2798}{}\doxysection{Additional Tasks}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2798}
\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2799}{}\doxysubsection{A\+P\+I Specification}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2799}
...
In case you change the A\+PI description (and the backend), you may want to ensure that your A\+PI blueprint is still syntax conform. To do so, you can use the tool \href{https://github.com/apiaryio/drafter}{\texttt{ Drafter}}. After installing it, you can use {\ttfamily drafter $<$filename$>$} (e.\+g. {\ttfamily drafter snippet-\/sharing.\+apib}) to run the check.\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2800}{}\doxysubsection{Use Other Webserver Than the Built-\/in Grunt Webserver}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2800}
...
It is required that you set a rewrite rule that serves the {\ttfamily index.\+html} for every request that does not access a static file ({\ttfamily js}, {\ttfamily css}, {\ttfamily png}, {\ttfamily md}, etc.). If you omit this step, it will not be possible to use direct links to access resources of the frontend; accessing the frontend from the {\ttfamily index.\+html} will still work though.\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2801}{}\doxysection{Example Structure}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2801}
...
We assume that Elektra is now installed to the default path on Debian Jessie, which is {\ttfamily /usr/local}.\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2802}{}\doxysubsection{Web Server}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2802}
...
\DoxyCodeLine{</IfModule>}
\end{DoxyCode}
\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2803}{}\doxysubsection{Rest-\/\+Backend}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2803}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2804}{}\doxysubsection{Rest-\/\+Frontend}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2804}
...
During the build, the frontend will be recompiled. It is not taken offline for this though and everything that is necessary to accomplish a clean deployment is taken care of by the compile script as well.\hypertarget{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2805}{}\doxysubsection{Jenkins Build Script}\label{doc_tutorials_snippet-sharing-rest-service_md_autotoc_md2805}
