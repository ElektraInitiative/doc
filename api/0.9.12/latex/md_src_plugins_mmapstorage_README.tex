...
This is a high performance storage plugin that supports full Elektra semantics.\hypertarget{md_src_plugins_mmapstorage_README_autotoc_md346}{}\doxysection{Format}\label{md_src_plugins_mmapstorage_README_autotoc_md346}
The storage format uses Elektra\textquotesingle{}s in-\/memory data layout and employs the {\ttfamily mmap()} system call to read/write data. The format is not portable across different architectures/platforms. The format can be seen as a memory dump of a keyset. Therefore, the files must not be edited by hand. Files written by mmapstorage are not intended to be human-\/readable.\hypertarget{md_src_plugins_mmapstorage_README_autotoc_md347}{}\doxysection{Usage}\label{md_src_plugins_mmapstorage_README_autotoc_md347}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_mmapstorage_README_autotoc_md348}{}\doxysection{Compiling}\label{md_src_plugins_mmapstorage_README_autotoc_md348}
...
The {\ttfamily mmapstorage} will always be compiled on a supported system (see \href{\#dependencies}{\texttt{ Dependencies}}). When zlib is available, we will additionally compile the {\ttfamily mmapstorage\+\_\+crc} variant. The first variant does not do a CRC32 checksum of the critical data, while the second variant always checks the CRC32 checksum for additional security.\hypertarget{md_src_plugins_mmapstorage_README_autotoc_md349}{}\doxysection{Installation}\label{md_src_plugins_mmapstorage_README_autotoc_md349}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The {\ttfamily mmapstorage} variant is part of the {\ttfamily libelektra5} package and the {\ttfamily mmapstorage\+\_\+crc} is part of the {\ttfamily libelektra5-\/extra} package.\hypertarget{md_src_plugins_mmapstorage_README_autotoc_md350}{}\doxysection{Dependencies}\label{md_src_plugins_mmapstorage_README_autotoc_md350}
POSIX compliant system (including XSI extensions).

Additionally, zlib is needed for the {\ttfamily mmapstorage\+\_\+crc} compilation variant\+: {\ttfamily zlib1g-\/dev} or {\ttfamily zlib-\/devel}.\hypertarget{md_src_plugins_mmapstorage_README_autotoc_md351}{}\doxysection{Examples}\label{md_src_plugins_mmapstorage_README_autotoc_md351}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_mmapstorage_README_autotoc_md352}{}\doxysection{Limitations}\label{md_src_plugins_mmapstorage_README_autotoc_md352}
