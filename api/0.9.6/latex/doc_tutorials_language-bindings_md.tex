...
\Hypertarget{doc_tutorials_language-bindings_md_md_doc_tutorials_language_bindings}%
 \hypertarget{doc_tutorials_language-bindings_md_autotoc_md3560}{}\doxysection{Introduction}\label{doc_tutorials_language-bindings_md_autotoc_md3560}
In this section, we will explain the how to write a language binding for Elektra.\hypertarget{doc_tutorials_language-bindings_md_autotoc_md3561}{}\doxysubsection{High-\/level API}\label{doc_tutorials_language-bindings_md_autotoc_md3561}
Writing bindings for the high-\/level API is described in a \mbox{\hyperlink{doc_tutorials_highlevel-bindings_md}{different document}}, since it is a bit less straightforward and needs additional considerations.\hypertarget{doc_tutorials_language-bindings_md_autotoc_md3562}{}\doxysection{TODO}\label{doc_tutorials_language-bindings_md_autotoc_md3562}
...
\end{DoxyEnumerate}
\end{DoxyEnumerate}\hypertarget{doc_tutorials_language-bindings_md_autotoc_md3563}{}\doxysection{CMake Integration}\label{doc_tutorials_language-bindings_md_autotoc_md3563}
\hypertarget{doc_tutorials_language-bindings_md_autotoc_md3564}{}\doxysubsection{Building}\label{doc_tutorials_language-bindings_md_autotoc_md3564}
...
We can then explicitly include the bindings using {\ttfamily cmake -\/DBINDINGS=\char`\"{}our\+\_\+binding\char`\"{} ..} in the build directory and follow the further steps for \mbox{\hyperlink{doc_COMPILE_md}{compilation}}.\hypertarget{doc_tutorials_language-bindings_md_autotoc_md3565}{}\doxysubsection{Testing}\label{doc_tutorials_language-bindings_md_autotoc_md3565}
...
See the Java binding for examples.\hypertarget{doc_tutorials_language-bindings_md_autotoc_md3566}{}\doxysection{Error Handling}\label{doc_tutorials_language-bindings_md_autotoc_md3566}
...
If you have a language which does not support inheritance this way like Go\+Lang, you can still use the error code itself since the hierarchy is integrated in it. For example you can check if the code starts with {\ttfamily C01...} to catch all {\ttfamily Permanent Errors}.\hypertarget{doc_tutorials_language-bindings_md_autotoc_md3567}{}\doxysubsection{Error Message}\label{doc_tutorials_language-bindings_md_autotoc_md3567}
