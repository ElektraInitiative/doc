...
\Hypertarget{doc_tutorials_arrays_md_md_doc_tutorials_arrays}%
 \hypertarget{doc_tutorials_arrays_md_autotoc_md4166}{}\doxysection{Key-\/\+Value Pairs}\label{doc_tutorials_arrays_md_autotoc_md4166}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md4167}{}\doxysection{Array Keys}\label{doc_tutorials_arrays_md_autotoc_md4167}
Since Elektra keys sorts keys alphabetically, we can use the key-\/value pair structure described above to store sequences of values (aka. arrays).\hypertarget{doc_tutorials_arrays_md_autotoc_md4168}{}\doxysubsection{Empty Arrays}\label{doc_tutorials_arrays_md_autotoc_md4168}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md4169}{}\doxysubsection{Array Elements}\label{doc_tutorials_arrays_md_autotoc_md4169}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md4170}{}\doxysubsection{Metadata}\label{doc_tutorials_arrays_md_autotoc_md4170}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md4171}{}\doxysection{Closing Remarks}\label{doc_tutorials_arrays_md_autotoc_md4171}
