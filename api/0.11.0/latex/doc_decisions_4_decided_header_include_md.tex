...
\Hypertarget{doc_decisions_4_decided_header_include_md_md_doc_decisions_4_decided_header_include}%
 \hypertarget{doc_decisions_4_decided_header_include_md_autotoc_md2098}{}\doxysection{Problem}\label{doc_decisions_4_decided_header_include_md_autotoc_md2098}
...
\end{quote}
\hypertarget{doc_decisions_4_decided_header_include_md_autotoc_md2099}{}\doxysubsection{Definitions\+:}\label{doc_decisions_4_decided_header_include_md_autotoc_md2099}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_header_include_md_autotoc_md2101}{}\doxysection{Considered Alternatives}\label{doc_decisions_4_decided_header_include_md_autotoc_md2101}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_header_include_md_autotoc_md2102}{}\doxysection{Decision}\label{doc_decisions_4_decided_header_include_md_autotoc_md2102}
...
These include-\/rules do not apply to tests. Tests can include anything (including {\ttfamily .c} files) from anywhere within the code base to allow testing private APIs.\hypertarget{doc_decisions_4_decided_header_include_md_autotoc_md2103}{}\doxysection{Rationale}\label{doc_decisions_4_decided_header_include_md_autotoc_md2103}
...
See also considered alternatives.\hypertarget{doc_decisions_4_decided_header_include_md_autotoc_md2104}{}\doxysection{Implications}\label{doc_decisions_4_decided_header_include_md_autotoc_md2104}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_header_include_md_autotoc_md2105}{}\doxysection{Related Decisions}\label{doc_decisions_4_decided_header_include_md_autotoc_md2105}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_header_include_md_autotoc_md2106}{}\doxysection{Notes}\label{doc_decisions_4_decided_header_include_md_autotoc_md2106}
