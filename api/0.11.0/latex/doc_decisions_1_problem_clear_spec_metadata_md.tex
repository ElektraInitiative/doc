...
\Hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_md_doc_decisions_1_problem_clear_spec_metadata}%
 \hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1968}{}\doxysection{Problem}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1968}
...
If metadata is merged from different namespaces, e.\+g., {\ttfamily spec\+:} and {\ttfamily user\+:}; metadata from one namespace might end up in keys of other namespaces, e.\+g.; metadata from {\ttfamily spec\+:} might end up in {\ttfamily user\+:}.\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1969}{}\doxysection{Constraints}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1969}
...
\end{DoxyItemize}\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1970}{}\doxysection{Assumptions}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1970}

\begin{DoxyItemize}
\item Metadata can always safely merged from {\ttfamily spec\+:/} to other namespace.
\end{DoxyItemize}\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1971}{}\doxysection{Considered Alternatives}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1971}
...
\end{DoxyItemize}\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1972}{}\doxysection{Decision}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1972}
...
The {\ttfamily kdb mount} tool will add the {\ttfamily meta} plugin configuration when mounting a storage plugin to {\ttfamily spec\+:/}.\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1973}{}\doxysection{Rationale}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1973}
...
\end{DoxyItemize}\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1974}{}\doxysection{Implications}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1974}
...
\end{DoxyItemize}\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1975}{}\doxysection{Related Decisions}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1975}
...
\end{DoxyItemize}\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1976}{}\doxysection{Notes}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1976}
