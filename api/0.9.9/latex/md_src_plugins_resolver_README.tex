...
($\sim$ and {\ttfamily pwd} are resolved from system)\hypertarget{md_src_plugins_resolver_README_autotoc_md482}{}\doxysection{Example}\label{md_src_plugins_resolver_README_autotoc_md482}
...
See \mbox{\hyperlink{doc_tutorials_mount_md}{the mount tutorial}} for more examples.\hypertarget{md_src_plugins_resolver_README_autotoc_md483}{}\doxysection{Variants}\label{md_src_plugins_resolver_README_autotoc_md483}
...
See \mbox{\hyperlink{doc_COMPILE_md}{COMPILE.md}} for a documentation of possible variants.\hypertarget{md_src_plugins_resolver_README_autotoc_md484}{}\doxysection{Installation}\label{md_src_plugins_resolver_README_autotoc_md484}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The default variant of this plugin {\ttfamily resolver\+\_\+fm\+\_\+hpu\+\_\+b} is part of the {\ttfamily libelektra5} package. All other variants are part of the {\ttfamily libelektra5-\/extra} package.\hypertarget{md_src_plugins_resolver_README_autotoc_md485}{}\doxysubsection{XDG Compatibility}\label{md_src_plugins_resolver_README_autotoc_md485}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_resolver_README_autotoc_md486}{}\doxysection{Reading Configuration}\label{md_src_plugins_resolver_README_autotoc_md486}
...
\end{DoxyEnumerate}\hypertarget{md_src_plugins_resolver_README_autotoc_md487}{}\doxysection{Writing Configuration}\label{md_src_plugins_resolver_README_autotoc_md487}
...
We have an optimistic approach. Locking is only used to detect concurrent cooperative processes in the short moment between prepare and commit. A conflict will be raised in that situation. When processes do not lock the file it might be overwritten. This is, however, very unlikely on file systems with nanosecond precision.\hypertarget{md_src_plugins_resolver_README_autotoc_md488}{}\doxysection{Exported Functions and Data}\label{md_src_plugins_resolver_README_autotoc_md488}
The resolver provides 2 functions for other plugins to use.\hypertarget{md_src_plugins_resolver_README_autotoc_md489}{}\doxysubsection{filename}\label{md_src_plugins_resolver_README_autotoc_md489}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_resolver_README_autotoc_md490}{}\doxysubsection{free\+Handle}\label{md_src_plugins_resolver_README_autotoc_md490}
frees the handle returned by {\ttfamily filename}.

Signature\+: {\ttfamily void $\ast$ free\+Handle (Elektra\+Resolved $\ast$ handle)}

where {\ttfamily handle} is the handle returned by {\ttfamily filename}.\hypertarget{md_src_plugins_resolver_README_autotoc_md491}{}\doxysection{Limitations}\label{md_src_plugins_resolver_README_autotoc_md491}
