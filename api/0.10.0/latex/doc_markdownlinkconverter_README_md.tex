...
{\bfseries{The $<$input-\/file$>$ parameter must be an absolute path!}}\hypertarget{doc_markdownlinkconverter_README_md_autotoc_md3151}{}\doxysection{Conventions}\label{doc_markdownlinkconverter_README_md_autotoc_md3151}
...
\end{DoxyItemize}\hypertarget{doc_markdownlinkconverter_README_md_autotoc_md3152}{}\doxysection{Git\+Hub Specialities}\label{doc_markdownlinkconverter_README_md_autotoc_md3152}
...
\end{DoxyItemize}\hypertarget{doc_markdownlinkconverter_README_md_autotoc_md3153}{}\doxysection{Link Validation}\label{doc_markdownlinkconverter_README_md_autotoc_md3153}
\hypertarget{doc_markdownlinkconverter_README_md_autotoc_md3154}{}\doxysubsection{Internal Links}\label{doc_markdownlinkconverter_README_md_autotoc_md3154}
The link validation works with a simple try to {\ttfamily fopen} the file, which the link refers to.\hypertarget{doc_markdownlinkconverter_README_md_autotoc_md3155}{}\doxysubsection{External Links}\label{doc_markdownlinkconverter_README_md_autotoc_md3155}
...
The link-\/checker includes the ability to list links on a whitelist which will not be checked and so on not printed to {\ttfamily stderr} in any case. Furthermore, this is the only way to let {\ttfamily http} links pass as they should be prevented by default. However, this does not mean that the {\ttfamily http} links are reachable as due to the lack of encryption, availability tests are not sensible in this case.\hypertarget{doc_markdownlinkconverter_README_md_autotoc_md3156}{}\doxysection{Further Improvements (\+Which Will be Introduced in a Later Version)\+:}\label{doc_markdownlinkconverter_README_md_autotoc_md3156}
