...
We are proud to release Elektra 0.\+9.\+5.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3799}{}\doxysection{What is Elektra?}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3799}
...
You can try out the latest Elektra release using our docker image \href{https://hub.docker.com/r/elektra/elektra}{\texttt{ elektra/elektra}}. This is the quickest way to get started with Elektra without compiling and other obstacles, simply run {\ttfamily docker run -\/it elektra/elektra}.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3800}{}\doxysection{Highlights}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3800}
...
\label{_hl-1}%
\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3801}{}\doxysubsection{$<$tt$>$kdb\+Open$<$/tt$>$ Contracts}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3801}
...
For more information take a look at \mbox{\hyperlink{doc_dev_kdb-contracts_md}{doc/dev/kdb-\/contracts.md}}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3802}{}\doxysection{Plugins}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3802}
The following section lists news about the \href{https://www.libelektra.org/plugins/readme}{\texttt{ plugins}} we updated in this release.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3803}{}\doxysubsection{Cache}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3803}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3804}{}\doxysubsection{internalnotification}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3804}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3805}{}\doxysubsection{Dbus \& Dbusrecv}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3805}

\begin{DoxyItemize}
\item Internal changes to ensure compatibility with the new {\ttfamily elektra\+Notification\+Contract}. \+\_\+(Klemens Böswirth)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3806}{}\doxysubsection{YAML Smith \& Yan LR}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3806}

\begin{DoxyItemize}
\item Removed plugins {\ttfamily yamlsmith} and {\ttfamily yanlr}. \+\_\+(René Schwaiger)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3807}{}\doxysubsection{Zeromqsend \& Zeromqrecv}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3807}

\begin{DoxyItemize}
\item Internal changes to ensure compatibility with the new {\ttfamily elektra\+Notification\+Contract}. \+\_\+(Klemens Böswirth)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3808}{}\doxysection{Libraries}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3808}
The text below summarizes updates to the \href{https://www.libelektra.org/libraries/readme}{\texttt{ C (and C++)-\/based libraries}} of Elektra.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3809}{}\doxysubsection{Compatibility}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3809}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3810}{}\doxysubsection{Core}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3810}
\label{_key-copy}%
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3811}{}\doxysubsection{Io}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3811}

\begin{DoxyItemize}
\item {\ttfamily elektra\+Set\+Io\+Binding} has been removed. Use {\ttfamily elektra\+Io\+Contract} instead. \+\_\+(Klemens Böswirth)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3812}{}\doxysubsection{Notification}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3812}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3813}{}\doxysection{Bindings}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3813}
Bindings allow you to utilize Elektra using \href{https://www.libelektra.org/bindings/readme}{\texttt{ various programming languages}}. This section keeps you up-\/to-\/date with the multi-\/language support provided by Elektra.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3814}{}\doxysubsection{JNA}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3814}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3815}{}\doxysubsubsection{Outlook}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3815}
Ongoing work on bringing the JNA binding up to scratch and improving developer experience. Both for JNA binding API consumers, as well as future JNA binding contrubutors. \+\_\+(\+Michael Tucek)\+\_\+\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3816}{}\doxysubsection{Python \& Lua}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3816}
Add support for keyset.\+remove(key). \+\_\+(\+Manuel Mausz)\+\_\+\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3817}{}\doxysection{Tools}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3817}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3818}{}\doxysection{Examples}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3818}

\begin{DoxyItemize}
\item Fix enums in examples/spec. \+\_\+(\+Markus Raab)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3819}{}\doxysection{Documentation}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3819}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3820}{}\doxysection{Tests}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3820}

\begin{DoxyItemize}
\item Added small test for jna Return plugin ({\ttfamily Return.\+java}), {\ttfamily Key\+Name\+Iterator.\+java} \+\_\+(@aaronabebe)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3821}{}\doxysection{Packaging}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3821}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3822}{}\doxysection{Build}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3822}
\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3823}{}\doxysubsection{CMake}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3823}

\begin{DoxyItemize}
\item Fix issue where the library runpaths of the jni plugin could not be resolved. \+\_\+(\+Robert Sowula)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3824}{}\doxysubsection{Docker}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3824}

\begin{DoxyItemize}
\item Update Alpine Linux images to version 3.\+13.\+1 and update Elektra release image. \+\_\+(Mihael Pranjić)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3825}{}\doxysection{Infrastructure}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3825}
\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3826}{}\doxysubsection{Cirrus}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3826}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3827}{}\doxysubsection{Git\+Hub Actions}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3827}

\begin{DoxyItemize}
\item Fix issues with {\ttfamily dbus} and java paths, exclude {\ttfamily jni}. \+\_\+(Mihael Pranjić)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3828}{}\doxysubsection{Jenkins}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3828}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3829}{}\doxysection{Website}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3829}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3830}{}\doxysection{Outlook}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3830}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3831}{}\doxysection{Statistics}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3831}
...
Thanks to all authors for making this release possible!\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3832}{}\doxysection{Join the Initiative!}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3832}
...
As first step, you could give us feedback about these release notes. Contact us via our \href{https://issues.libelektra.org}{\texttt{ issue tracker}}.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3833}{}\doxysection{Get the Release!}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3833}
...
Already built API documentation can be found \href{https://doc.libelektra.org/api/0.9.5/html/}{\texttt{ here}} or on \href{https://github.com/ElektraInitiative/doc/tree/master/api/0.9.5}{\texttt{ Git\+Hub}}.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3834}{}\doxysection{Stay tuned!}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3834}
