...
This is because {\ttfamily ld} tries to link {\ttfamily /usr/lib/libaugeas.so.\+0} which is an older version of Augeas. Simply add the path to the newer library to your ld search paths (consult your system documentation on how to do this).\hypertarget{md_src_plugins_augeas_README_autotoc_md59}{}\doxysection{Mounting and Configuration}\label{md_src_plugins_augeas_README_autotoc_md59}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_augeas_README_autotoc_md60}{}\doxysection{Restrictions}\label{md_src_plugins_augeas_README_autotoc_md60}
\hypertarget{md_src_plugins_augeas_README_autotoc_md61}{}\doxysubsection{Inner Node Values}\label{md_src_plugins_augeas_README_autotoc_md61}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_augeas_README_autotoc_md62}{}\doxysubsection{Leaky Abstraction of Order}\label{md_src_plugins_augeas_README_autotoc_md62}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_augeas_README_autotoc_md63}{}\doxysection{Planned Improvements}\label{md_src_plugins_augeas_README_autotoc_md63}
