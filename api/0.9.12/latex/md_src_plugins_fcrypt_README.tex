...
\hypertarget{md_src_plugins_fcrypt_README_autotoc_md198}{}\doxysubsection{Introduction}\label{md_src_plugins_fcrypt_README_autotoc_md198}
...
This plugin encrypts backend files before the commit is executed (thus {\ttfamily precommit}). The plugin decrypts the backend files before the getstorage opens it (thus {\ttfamily pregetstorage}). After the getstorage plugin has read the backend file, the plugin decrypts the backend file again (thus {\ttfamily postgetstorage}).\hypertarget{md_src_plugins_fcrypt_README_autotoc_md199}{}\doxysubsection{Installation}\label{md_src_plugins_fcrypt_README_autotoc_md199}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/experimental}.\hypertarget{md_src_plugins_fcrypt_README_autotoc_md200}{}\doxysubsection{Security Considerations}\label{md_src_plugins_fcrypt_README_autotoc_md200}
...
If the temporary directory is mounted on a hard disk, GPG writes the decrypted data on that disk. Thus we recommend to either mount {\ttfamily /tmp} to a RAM disk or specify another path as temporary directory within the plugin configuration (see Configuration below).\hypertarget{md_src_plugins_fcrypt_README_autotoc_md201}{}\doxysubsection{Known Issues}\label{md_src_plugins_fcrypt_README_autotoc_md201}
...
Please note that this is a workaround until a more sustainable solution is found.\hypertarget{md_src_plugins_fcrypt_README_autotoc_md202}{}\doxysubsection{Dependencies}\label{md_src_plugins_fcrypt_README_autotoc_md202}
\hypertarget{md_src_plugins_fcrypt_README_autotoc_md203}{}\doxysubsubsection{Crypto Plugin}\label{md_src_plugins_fcrypt_README_autotoc_md203}
This plugin uses parts of the {\ttfamily crypto} plugin.\hypertarget{md_src_plugins_fcrypt_README_autotoc_md204}{}\doxysubsubsection{Gnu\+PG (\+GPG)}\label{md_src_plugins_fcrypt_README_autotoc_md204}
Please refer to crypto.\hypertarget{md_src_plugins_fcrypt_README_autotoc_md205}{}\doxysubsection{Restrictions}\label{md_src_plugins_fcrypt_README_autotoc_md205}
Please refer to crypto.\hypertarget{md_src_plugins_fcrypt_README_autotoc_md206}{}\doxysubsection{Examples}\label{md_src_plugins_fcrypt_README_autotoc_md206}
...
\href{https://asciinema.org/a/153014}{\texttt{ https\+://asciinema.\+org/a/153014}}\hypertarget{md_src_plugins_fcrypt_README_autotoc_md207}{}\doxysubsection{Configuration}\label{md_src_plugins_fcrypt_README_autotoc_md207}
\hypertarget{md_src_plugins_fcrypt_README_autotoc_md208}{}\doxysubsubsection{Signatures}\label{md_src_plugins_fcrypt_README_autotoc_md208}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_fcrypt_README_autotoc_md209}{}\doxysubsubsection{GPG Configuration}\label{md_src_plugins_fcrypt_README_autotoc_md209}
The GPG Configuration is described in crypto.\hypertarget{md_src_plugins_fcrypt_README_autotoc_md210}{}\doxysubsubsection{Textmode}\label{md_src_plugins_fcrypt_README_autotoc_md210}
...
Textmode can be disabled by setting {\ttfamily fcrypt/textmode} to {\ttfamily 0} in the plugin configuration.\hypertarget{md_src_plugins_fcrypt_README_autotoc_md211}{}\doxysubsubsection{Temporary Directory}\label{md_src_plugins_fcrypt_README_autotoc_md211}
