...
\Hypertarget{doc_tutorials_java-plugins_md_md_doc_tutorials_java_plugins}%
 This file serves as a tutorial on how to get started with writing a java plugin.\hypertarget{doc_tutorials_java-plugins_md_autotoc_md3554}{}\doxysection{Basics}\label{doc_tutorials_java-plugins_md_autotoc_md3554}
If you want to know more about plugins in general, please check out the \mbox{\hyperlink{doc_tutorials_plugins_md}{How-\/\+To\+: Write a Plugin}} page. If you need a tutorial for java, please check out the \mbox{\hyperlink{doc_tutorials_java-kdb_md}{How-\/\+To\+: Java kdb}} page.\hypertarget{doc_tutorials_java-plugins_md_autotoc_md3555}{}\doxysection{Two Types of Java Plugins}\label{doc_tutorials_java-plugins_md_autotoc_md3555}
...
\begin{DoxyItemize}
\item using JNI plugin
\item using JNA binding
\end{DoxyItemize}

If you would like to write a plugin in Java and look into the documentation, then you will definitely meet two notions like {\ttfamily JNI Plugin} and {\ttfamily JNA Binding}, so let\textquotesingle{}s clarify, what they are.\hypertarget{doc_tutorials_java-plugins_md_autotoc_md3556}{}\doxysubsection{JNI Plugin}\label{doc_tutorials_java-plugins_md_autotoc_md3556}
...
\begin{DoxyItemize}
\item {\ttfamily /path/to/\+SDK/include}
\end{DoxyItemize}

or you can reinstall the Java SDK.\hypertarget{doc_tutorials_java-plugins_md_autotoc_md3557}{}\doxysubsection{JNA Binding}\label{doc_tutorials_java-plugins_md_autotoc_md3557}
...
Here we will look into, how can we write Java Plugins using -\/ {\ttfamily JNA Binding}.\hypertarget{doc_tutorials_java-plugins_md_autotoc_md3558}{}\doxysubsection{Writing a Plugin}\label{doc_tutorials_java-plugins_md_autotoc_md3558}
...
It is expected that each method returns -\/1 if an error occurred or 0 if everything worked as expected.\hypertarget{doc_tutorials_java-plugins_md_autotoc_md3559}{}\doxysubsection{Usage of Plugin}\label{doc_tutorials_java-plugins_md_autotoc_md3559}
