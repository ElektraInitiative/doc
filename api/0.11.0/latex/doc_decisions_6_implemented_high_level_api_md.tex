...
\Hypertarget{doc_decisions_6_implemented_high_level_api_md_md_doc_decisions_6_implemented_high_level_api}%
 \hypertarget{doc_decisions_6_implemented_high_level_api_md_autotoc_md2421}{}\doxysection{Problem}\label{doc_decisions_6_implemented_high_level_api_md_autotoc_md2421}
Projects usually do not want to use low-\/level APIs. {\ttfamily KDB} and {\ttfamily Key\+Set} is useful for plugins and to implement APIs but not to be directly used in applications.\hypertarget{doc_decisions_6_implemented_high_level_api_md_autotoc_md2422}{}\doxysection{Constraints}\label{doc_decisions_6_implemented_high_level_api_md_autotoc_md2422}
...
\end{DoxyItemize}
\end{DoxyEnumerate}\hypertarget{doc_decisions_6_implemented_high_level_api_md_autotoc_md2423}{}\doxysection{Assumptions}\label{doc_decisions_6_implemented_high_level_api_md_autotoc_md2423}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_high_level_api_md_autotoc_md2424}{}\doxysection{Considered Alternatives}\label{doc_decisions_6_implemented_high_level_api_md_autotoc_md2424}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_high_level_api_md_autotoc_md2425}{}\doxysection{Decision}\label{doc_decisions_6_implemented_high_level_api_md_autotoc_md2425}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_high_level_api_md_autotoc_md2426}{}\doxysection{Rationale}\label{doc_decisions_6_implemented_high_level_api_md_autotoc_md2426}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_6_implemented_high_level_api_md_autotoc_md2427}{}\doxysection{Implications}\label{doc_decisions_6_implemented_high_level_api_md_autotoc_md2427}
\hypertarget{doc_decisions_6_implemented_high_level_api_md_autotoc_md2428}{}\doxysection{Related Decisions}\label{doc_decisions_6_implemented_high_level_api_md_autotoc_md2428}
\hypertarget{doc_decisions_6_implemented_high_level_api_md_autotoc_md2429}{}\doxysection{Notes}\label{doc_decisions_6_implemented_high_level_api_md_autotoc_md2429}
