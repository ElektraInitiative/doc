...
The resolver plugin requires this error list to do a proper rollback. Another use case is logging after a failure has happened.\hypertarget{doc_dev_plugins-ordering_md_autotoc_md2206}{}\doxysection{Placements}\label{doc_dev_plugins-ordering_md_autotoc_md2206}
