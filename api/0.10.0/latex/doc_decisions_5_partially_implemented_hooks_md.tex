...
\Hypertarget{doc_decisions_5_partially_implemented_hooks_md_md_doc_decisions_5_partially_implemented_hooks}%
 \hypertarget{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2200}{}\doxysection{Problem}\label{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2200}
...
These problems can be traced back to the placement of the plugins. We need to clean up and simplify the placement.\hypertarget{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2201}{}\doxysection{Constraints}\label{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2201}
...
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2202}{}\doxysection{Assumptions}\label{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2202}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2203}{}\doxysection{Considered Alternatives}\label{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2203}
...
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2204}{}\doxysection{Decision}\label{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2204}
...
We\textquotesingle{}ll hard code the names of the plugins. For changing those plugins symlinks will have to be used.\hypertarget{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2205}{}\doxysection{Rationale}\label{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2205}
...
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2206}{}\doxysection{Implications}\label{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2206}
...
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2207}{}\doxysection{Related Decisions}\label{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2207}
...
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2208}{}\doxysection{Notes}\label{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2208}
