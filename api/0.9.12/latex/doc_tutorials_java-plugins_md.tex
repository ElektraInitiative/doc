...
\Hypertarget{doc_tutorials_java-plugins_md_md_doc_tutorials_java_plugins}%
 This file serves as a tutorial on how to get started with writing a Java plugin.\hypertarget{doc_tutorials_java-plugins_md_autotoc_md4308}{}\doxysection{Basics}\label{doc_tutorials_java-plugins_md_autotoc_md4308}
If you want to know more about plugins in general, please check out the \mbox{\hyperlink{doc_tutorials_plugins_md}{How-\/\+To\+: Write a Plugin}} page. If you need a tutorial for using Key and Key\+Set in Java, please check out the \mbox{\hyperlink{doc_tutorials_java-kdb_md}{How-\/\+To\+: Java kdb}} page.\hypertarget{doc_tutorials_java-plugins_md_autotoc_md4309}{}\doxysection{Two Technologies used in Java Plugins}\label{doc_tutorials_java-plugins_md_autotoc_md4309}
...
\item JNA binding
\end{DoxyItemize}\hypertarget{doc_tutorials_java-plugins_md_autotoc_md4310}{}\doxysubsection{$<$tt$>$process$<$/tt$>$ Plugin}\label{doc_tutorials_java-plugins_md_autotoc_md4310}
...
If you do want to know the details of the {\ttfamily process} protocol, take a look at the \mbox{\hyperlink{md_src_plugins_process_README_src_plugins_process_README_md}{README}} of the {\ttfamily process} plugin.\hypertarget{doc_tutorials_java-plugins_md_autotoc_md4311}{}\doxysubsection{JNA Binding}\label{doc_tutorials_java-plugins_md_autotoc_md4311}
...
We provide a Java binding for Elektra\textquotesingle{}s API via JNA. For more general information about the binding take a look at \mbox{\hyperlink{doc_tutorials_java-kdb_md}{this document}}.\hypertarget{doc_tutorials_java-plugins_md_autotoc_md4312}{}\doxysubsection{Writing a Plugin}\label{doc_tutorials_java-plugins_md_autotoc_md4312}
...
You can find a few examples for Java plugins in the folder \`{}src/bindings/jna/plugins/\`{}. We use separate Gradle projects for every plugin, but that is not a requirement. But creating separate JAR files for each plugin, keeps down the size of the binaries that need to be loaded to mount a plugin.\hypertarget{doc_tutorials_java-plugins_md_autotoc_md4313}{}\doxysubsection{Usage of Plugin}\label{doc_tutorials_java-plugins_md_autotoc_md4313}
