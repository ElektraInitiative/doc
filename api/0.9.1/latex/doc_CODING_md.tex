...
\begin{DoxyItemize}
\item clang-\/format {\ttfamily 6.\+0} in the Debian sid image on the Jenkins build server,
\item clang-\/format {\ttfamily 7.\+0} in the Travis configuration file , and
\item clang-\/format {\ttfamily 7.\+0} in the Cirrus mac\+OS build jobs
\end{DoxyItemize}

\label{doc_CODING_md_autotoc_md984}%
\Hypertarget{doc_CODING_md_autotoc_md984}%
...
. Please note, that both of these commands will install current versions of {\ttfamily clang-\/format} that might format code a little bit differently than Clang-\/\+Format {\ttfamily 6.\+0} in certain edge cases. If you want you can also install Clang-\/\+Format {\ttfamily 7.\+0} using L\+L\+VM {\ttfamily 7.\+0}\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{brew install llvm@7}
\end{DoxyCode}


\subparagraph*{Debian}

In Debian the package for Clang-\/\+Format {\ttfamily 6.\+0} is called {\ttfamily clang-\/format-\/6.\+0}\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{apt-get install clang-format-6.0}
\end{DoxyCode}


\label{doc_CODING_md_autotoc_md985}%
\Hypertarget{doc_CODING_md_autotoc_md985}%
\subparagraph*{Usage}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\# On some systems such as Debian the `cmake-format` executable also contains}
\DoxyCodeLine{\# the version number. For those systems, please replace `clang-format`,}
\DoxyCodeLine{\# with `clang-format-6.0` or `clang-format-7` in the command below.}
...
\Hypertarget{doc_CODING_md_autotoc_md986}%
...
{\bfseries{Example\+:}} \href{/home/mpranj/workspace/libelektra/src/bindings/cpp/include/kdb.hpp}{\texttt{ src/bindings/cpp/include/kdb.\+hpp}}
...
\Hypertarget{doc_CODING_md_autotoc_md990}%
\subparagraph*{Installation}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\# Install cmake format `0.6` with support for YAML config files}
\DoxyCodeLine{pip install cmake-format[yaml]==0.6}
\end{DoxyCode}


. Please make sure, that you install the correct version ({\ttfamily 0.\+6.\+0}) of cmake format\+:
...
\Hypertarget{doc_CODING_md_autotoc_md991}%
\subparagraph*{Usage}
...
\Hypertarget{doc_CODING_md_autotoc_md992}%
\subparagraph*{Tool Integration}
...
\Hypertarget{doc_CODING_md_autotoc_md996}%
\subparagraph*{Usage}
...
\label{doc_CODING_md_autotoc_md999}%
\Hypertarget{doc_CODING_md_autotoc_md999}%
\subparagraph*{Installation}
...
\Hypertarget{doc_CODING_md_autotoc_md1000}%
\subparagraph*{Usage}
...
\Hypertarget{doc_CODING_md_autotoc_md1003}%
\subparagraph*{Installation}

For information on how to install the tool, please take a look at “\+Java\+Script Guidelines” → “\+Prettier” → “\+Installation”.

\label{doc_CODING_md_autotoc_md1004}%
\Hypertarget{doc_CODING_md_autotoc_md1004}%
\subparagraph*{Usage}
...
\Hypertarget{doc_CODING_md_autotoc_md1005}%
\subparagraph*{Tool Integration}
...
We use \href{https://github.com/mvdan/sh}{\texttt{ {\ttfamily shfmt}}} to format Shell files in the repository.

\label{doc_CODING_md_autotoc_md1008}%
\Hypertarget{doc_CODING_md_autotoc_md1008}%
\subparagraph*{Installation}
...
\Hypertarget{doc_CODING_md_autotoc_md1009}%
\subparagraph*{Usage}
...
\DoxyCodeLine{}
\DoxyCodeLine{1. Open the “Bundle Editor”: Press <kbd>\string^</kbd> + <kbd>⌥</kbd> + <kbd>⌘</kbd> + <kbd>B</kbd>}
\DoxyCodeLine{2. Create a new command:}
\DoxyCodeLine{   1. Press <kbd>⌘</kbd> + <kbd>N</kbd>}
...
\DoxyCodeLine{   3. Use <kbd>\string^</kbd> + <kbd>⇧</kbd> + <kbd>H</kbd> as “Key Equivalent”}
