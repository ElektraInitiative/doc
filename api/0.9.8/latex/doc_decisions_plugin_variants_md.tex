...
\Hypertarget{doc_decisions_plugin_variants_md_md_doc_decisions_plugin_variants}%
 \hypertarget{doc_decisions_plugin_variants_md_autotoc_md1953}{}\doxysection{Problem}\label{doc_decisions_plugin_variants_md_autotoc_md1953}
...
The current issue is that there is no way to enumerate possible plugin variants as needed to list all functionality of Elektra.\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1954}{}\doxysection{Constraints}\label{doc_decisions_plugin_variants_md_autotoc_md1954}
...
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1955}{}\doxysection{Assumptions}\label{doc_decisions_plugin_variants_md_autotoc_md1955}

\begin{DoxyItemize}
\item The number of variants needs to be bounded\+: plugin variants need to be fully enumerable
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1956}{}\doxysection{Considered Alternatives}\label{doc_decisions_plugin_variants_md_autotoc_md1956}
...
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1957}{}\doxysection{Decision}\label{doc_decisions_plugin_variants_md_autotoc_md1957}
...
\end{DoxyItemize}
\end{DoxyEnumerate}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1958}{}\doxysubsection{Example}\label{doc_decisions_plugin_variants_md_autotoc_md1958}
...
\end{DoxyCode}
\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1959}{}\doxysection{Rationale}\label{doc_decisions_plugin_variants_md_autotoc_md1959}
...
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1960}{}\doxysection{Implications}\label{doc_decisions_plugin_variants_md_autotoc_md1960}
...
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1961}{}\doxysection{Current state}\label{doc_decisions_plugin_variants_md_autotoc_md1961}
...
gets ignored.\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1962}{}\doxysection{Related Decisions}\label{doc_decisions_plugin_variants_md_autotoc_md1962}

\begin{DoxyItemize}
\item \mbox{\hyperlink{doc_decisions_cmake_plugins_md}{CMake Plugins}}
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1963}{}\doxysection{Notes}\label{doc_decisions_plugin_variants_md_autotoc_md1963}
