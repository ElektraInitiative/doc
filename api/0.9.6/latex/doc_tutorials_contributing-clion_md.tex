...
\end{DoxyItemize}\hypertarget{doc_tutorials_contributing-clion_md_autotoc_md3475}{}\doxysection{Forking the Repository}\label{doc_tutorials_contributing-clion_md_autotoc_md3475}
...
With the project now locally available we can start developing.\hypertarget{doc_tutorials_contributing-clion_md_autotoc_md3477}{}\doxysection{Setting Up the Project}\label{doc_tutorials_contributing-clion_md_autotoc_md3477}
...
Make sure the selected \char`\"{}\+Scheme\char`\"{} is \char`\"{}\+Project\char`\"{}.\hypertarget{doc_tutorials_contributing-clion_md_autotoc_md3478}{}\doxysection{Development}\label{doc_tutorials_contributing-clion_md_autotoc_md3478}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_contributing-clion_md_autotoc_md3479}{}\doxysection{Testing}\label{doc_tutorials_contributing-clion_md_autotoc_md3479}
...
For further information please read \mbox{\hyperlink{doc_TESTING_md}{this}}.\hypertarget{doc_tutorials_contributing-clion_md_autotoc_md3480}{}\doxysection{Commiting Your Changes}\label{doc_tutorials_contributing-clion_md_autotoc_md3480}
...
With this, you\textquotesingle{}ve published your changes to your remote branch of your repository. The next step is merging this change into the original repository.\hypertarget{doc_tutorials_contributing-clion_md_autotoc_md3481}{}\doxysection{Creating a Pull Request}\label{doc_tutorials_contributing-clion_md_autotoc_md3481}
...
If you want to use CLion for creating Pull Request, please check out \href{https://www.jetbrains.com/help/clion/contribute-to-projects.html\#create-pull-request}{\texttt{ this}} link for further information.\hypertarget{doc_tutorials_contributing-clion_md_autotoc_md3482}{}\doxysection{Troubleshooting}\label{doc_tutorials_contributing-clion_md_autotoc_md3482}
\hypertarget{doc_tutorials_contributing-clion_md_autotoc_md3483}{}\doxysubsection{Resolving Missing $\ast$.\+so Library Error In Debug Mode}\label{doc_tutorials_contributing-clion_md_autotoc_md3483}
...
Please refer to \mbox{\hyperlink{doc_COMPILE_md}{this}} tutorial to fix the problem permanently.\hypertarget{doc_tutorials_contributing-clion_md_autotoc_md3484}{}\doxysection{Hints}\label{doc_tutorials_contributing-clion_md_autotoc_md3484}
