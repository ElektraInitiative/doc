...
\Hypertarget{doc_help_kdb-export_md_md_doc_help_kdb_export}%
 \hypertarget{doc_help_kdb-export_md_autotoc_md2482}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-export_md_autotoc_md2482}
{\ttfamily kdb export $<$source$>$ \mbox{[}$<$format$>$\mbox{]}}~\newline
\hypertarget{doc_help_kdb-export_md_autotoc_md2483}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-export_md_autotoc_md2483}
...
\hypertarget{doc_help_kdb-export_md_autotoc_md2484}{}\doxysection{USAGE}\label{doc_help_kdb-export_md_autotoc_md2484}
Where {\ttfamily source} is the path of the key(s) you want to export. Additionally, the user can specify a format to use by passing it as the option argument {\ttfamily format}.~\newline
 ...
 The {\ttfamily storage} plugin can be configured at compile-\/time or changed by the link {\ttfamily libelektra-\/storage.\+so}.\hypertarget{doc_help_kdb-export_md_autotoc_md2485}{}\doxysection{OPTIONS}\label{doc_help_kdb-export_md_autotoc_md2485}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-export_md_autotoc_md2486}{}\doxysection{KDB}\label{doc_help_kdb-export_md_autotoc_md2486}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-export_md_autotoc_md2487}{}\doxysection{EXAMPLES}\label{doc_help_kdb-export_md_autotoc_md2487}
...
\end{DoxyCode}
\hypertarget{doc_help_kdb-export_md_autotoc_md2488}{}\doxysection{Note}\label{doc_help_kdb-export_md_autotoc_md2488}
