...
\Hypertarget{doc_decisions_0a_postponed_plugin_variants_md_md_doc_decisions_0a_postponed_plugin_variants}%
 \hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1843}{}\doxysection{Problem}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1843}
...
The current issue is that there is no way to enumerate possible plugin variants as needed to list all functionality of Elektra.\hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1844}{}\doxysection{Constraints}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1844}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1845}{}\doxysection{Assumptions}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1845}

\begin{DoxyItemize}
\item The number of variants needs to be bounded\+: plugin variants need to be fully enumerable
\end{DoxyItemize}\hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1846}{}\doxysection{Considered Alternatives}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1846}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1847}{}\doxysection{Decision}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1847}
...
\end{DoxyItemize}
\end{DoxyEnumerate}\hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1848}{}\doxysubsection{Example}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1848}
...
\end{DoxyCode}
\hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1849}{}\doxysection{Rationale}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1849}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1850}{}\doxysection{Implications}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1850}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1851}{}\doxysection{Current state}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1851}
...
gets ignored.\hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1852}{}\doxysection{Related Decisions}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1852}

\begin{DoxyItemize}
\item \mbox{\hyperlink{doc_decisions_6_implemented_cmake_plugins_md}{CMake Plugins}}
\end{DoxyItemize}\hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1853}{}\doxysection{Notes}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1853}
