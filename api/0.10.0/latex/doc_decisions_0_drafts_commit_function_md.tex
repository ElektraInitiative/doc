...
\Hypertarget{doc_decisions_0_drafts_commit_function_md_md_doc_decisions_0_drafts_commit_function}%
 \hypertarget{doc_decisions_0_drafts_commit_function_md_autotoc_md1726}{}\doxysection{Problem}\label{doc_decisions_0_drafts_commit_function_md_autotoc_md1726}
...
With the introduction of the new backend, a new {\ttfamily kdb\+Commit} function was introduced to {\ttfamily struct \+\_\+\+Plugin} (matching {\ttfamily kdb\+Error}). We also added a {\ttfamily kdb\+Init}. Therefore, some phases of {\ttfamily kdb\+Get}/{\ttfamily kdb\+Set} now use separate functions, but not all of them do. This partial use of separate functions can be weird and unintuitive.\hypertarget{doc_decisions_0_drafts_commit_function_md_autotoc_md1727}{}\doxysection{Constraints}\label{doc_decisions_0_drafts_commit_function_md_autotoc_md1727}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0_drafts_commit_function_md_autotoc_md1728}{}\doxysection{Assumptions}\label{doc_decisions_0_drafts_commit_function_md_autotoc_md1728}
\hypertarget{doc_decisions_0_drafts_commit_function_md_autotoc_md1729}{}\doxysection{Considered Alternatives}\label{doc_decisions_0_drafts_commit_function_md_autotoc_md1729}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_0_drafts_commit_function_md_autotoc_md1730}{}\doxysection{Decision}\label{doc_decisions_0_drafts_commit_function_md_autotoc_md1730}
\hypertarget{doc_decisions_0_drafts_commit_function_md_autotoc_md1731}{}\doxysection{Rationale}\label{doc_decisions_0_drafts_commit_function_md_autotoc_md1731}
\hypertarget{doc_decisions_0_drafts_commit_function_md_autotoc_md1732}{}\doxysection{Implications}\label{doc_decisions_0_drafts_commit_function_md_autotoc_md1732}
\hypertarget{doc_decisions_0_drafts_commit_function_md_autotoc_md1733}{}\doxysection{Related Decisions}\label{doc_decisions_0_drafts_commit_function_md_autotoc_md1733}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0_drafts_commit_function_md_autotoc_md1734}{}\doxysection{Notes}\label{doc_decisions_0_drafts_commit_function_md_autotoc_md1734}
