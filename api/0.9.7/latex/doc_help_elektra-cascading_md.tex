...
Thus when a key starts with {\ttfamily /} such cascading will automatically performed.\hypertarget{doc_help_elektra-cascading_md_autotoc_md2237}{}\doxysection{SPEC}\label{doc_help_elektra-cascading_md_autotoc_md2237}
...
\end{DoxyCode}
\hypertarget{doc_help_elektra-cascading_md_autotoc_md2238}{}\doxysection{CASCADING}\label{doc_help_elektra-cascading_md_autotoc_md2238}
