...
\Hypertarget{doc_help_kdb-mount_md_md_doc_help_kdb_mount}%
 \hypertarget{doc_help_kdb-mount_md_autotoc_md2485}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-mount_md_autotoc_md2485}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{doc_help_kdb-mount_md_autotoc_md2486}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-mount_md_autotoc_md2486}
...
For cascading mount points (starting with {\ttfamily /}) a mount point for the namespace {\ttfamily dir}, {\ttfamily user} and {\ttfamily system} is created. Each of this mount point uses a different configuration file, either below current directory, below home directory or anywhere in the system. Use {\ttfamily kdb file $<$path$>$} to determine where the file(s) are.\hypertarget{doc_help_kdb-mount_md_autotoc_md2488}{}\doxysection{OPTIONS}\label{doc_help_kdb-mount_md_autotoc_md2488}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-mount_md_autotoc_md2489}{}\doxysection{KDB}\label{doc_help_kdb-mount_md_autotoc_md2489}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-mount_md_autotoc_md2490}{}\doxysection{EXAMPLES}\label{doc_help_kdb-mount_md_autotoc_md2490}
...
To recode and rename a configuration file using Elektra\+:~\newline
 {\ttfamily kdb mount recode.\+txt dir\+:/recode ni rename cut=path iconv to=utf8,from=latin1}\hypertarget{doc_help_kdb-mount_md_autotoc_md2491}{}\doxysection{SEE ALSO}\label{doc_help_kdb-mount_md_autotoc_md2491}
