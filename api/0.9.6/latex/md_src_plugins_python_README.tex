...
What a Python script can do is not really limited by design, so any kind of plugin may be implemented. The python plugin is especially useful to write filter and logging scripts.\hypertarget{md_src_plugins_python_README_autotoc_md388}{}\doxysection{Installation}\label{md_src_plugins_python_README_autotoc_md388}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/python}.\hypertarget{md_src_plugins_python_README_autotoc_md389}{}\doxysection{Usage}\label{md_src_plugins_python_README_autotoc_md389}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_python_README_autotoc_md390}{}\doxysubsection{Plugin Configuration}\label{md_src_plugins_python_README_autotoc_md390}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_python_README_autotoc_md391}{}\doxysubsection{Python Scripts}\label{md_src_plugins_python_README_autotoc_md391}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_python_README_autotoc_md392}{}\doxysection{Example}\label{md_src_plugins_python_README_autotoc_md392}
...
Further examples can be found in the python directory.\hypertarget{md_src_plugins_python_README_autotoc_md393}{}\doxysection{Disclaimer}\label{md_src_plugins_python_README_autotoc_md393}
