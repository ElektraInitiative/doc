...
\item infos/status = configurable readonly preview unfinished
\item infos/metadata =
...
The {\ttfamily curlget} plugin is a resolver using libcurl to upload and download files from/to remote hosts. When mounted with a {\ttfamily URL} as configuration file there will be no changes to the file system. When mounted with a (local) path to a configuration a copy of the remote configuration is kept and used as fallback in {\ttfamily \mbox{\hyperlink{group__kdb_ga28e385fd9cb7ccfe0b2f1ed2f62453a1}{kdb\+Get()}}} if fetching the remote file from the server fails.\hypertarget{md_src_plugins_curlget_README_autotoc_md146}{}\doxysection{Installation}\label{md_src_plugins_curlget_README_autotoc_md146}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/curl}.\hypertarget{md_src_plugins_curlget_README_autotoc_md147}{}\doxysection{Configuration}\label{md_src_plugins_curlget_README_autotoc_md147}
\hypertarget{md_src_plugins_curlget_README_autotoc_md148}{}\doxysubsection{definitions}\label{md_src_plugins_curlget_README_autotoc_md148}
{\ttfamily URL}\+:
...
\end{DoxyItemize}\hypertarget{md_src_plugins_curlget_README_autotoc_md150}{}\doxysection{Example}\label{md_src_plugins_curlget_README_autotoc_md150}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_curlget_README_autotoc_md151}{}\doxysubsection{Mount with HTTP GET + POST and keep local copy}\label{md_src_plugins_curlget_README_autotoc_md151}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_curlget_README_autotoc_md152}{}\doxysubsection{Mount with HTTP GET + POST and keep no local copys}\label{md_src_plugins_curlget_README_autotoc_md152}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_curlget_README_autotoc_md153}{}\doxysubsection{Mount with FTP GET + PUT and keep local copy}\label{md_src_plugins_curlget_README_autotoc_md153}
