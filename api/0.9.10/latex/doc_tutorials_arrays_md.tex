...
\Hypertarget{doc_tutorials_arrays_md_md_doc_tutorials_arrays}%
 \hypertarget{doc_tutorials_arrays_md_autotoc_md3722}{}\doxysection{Key-\/\+Value Pairs}\label{doc_tutorials_arrays_md_autotoc_md3722}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md3723}{}\doxysection{Array Keys}\label{doc_tutorials_arrays_md_autotoc_md3723}
Since Elektra sorts keys alphabetically we can use the key-\/value pair structure described above to store sequences of values (aka. arrays).\hypertarget{doc_tutorials_arrays_md_autotoc_md3724}{}\doxysubsection{Empty Arrays}\label{doc_tutorials_arrays_md_autotoc_md3724}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md3725}{}\doxysubsection{Array Elements}\label{doc_tutorials_arrays_md_autotoc_md3725}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md3726}{}\doxysubsection{Metadata}\label{doc_tutorials_arrays_md_autotoc_md3726}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md3727}{}\doxysection{Closing Remarks}\label{doc_tutorials_arrays_md_autotoc_md3727}
