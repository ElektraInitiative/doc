...
\Hypertarget{doc_tutorials_arrays_md_md_doc_tutorials_arrays}%
 \hypertarget{doc_tutorials_arrays_md_autotoc_md3494}{}\doxysection{Key-\/\+Value Pairs}\label{doc_tutorials_arrays_md_autotoc_md3494}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md3495}{}\doxysection{Array Keys}\label{doc_tutorials_arrays_md_autotoc_md3495}
Since Elektra sorts keys alphabetically we can use the key-\/value pair structure described above to store sequences of values (aka. arrays).\hypertarget{doc_tutorials_arrays_md_autotoc_md3496}{}\doxysubsection{Empty Arrays}\label{doc_tutorials_arrays_md_autotoc_md3496}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md3497}{}\doxysubsection{Array Elements}\label{doc_tutorials_arrays_md_autotoc_md3497}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md3498}{}\doxysubsection{Metadata}\label{doc_tutorials_arrays_md_autotoc_md3498}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md3499}{}\doxysection{Closing Remarks}\label{doc_tutorials_arrays_md_autotoc_md3499}
