...
This plugin allows you to read and write CSV files using Elektra. It aims to be compatible with RFC 4180. Rows and columns are written using Elektra\textquotesingle{}s arrays ({\ttfamily \#0}, {\ttfamily \#1},..). By configuring the plugin you can give columns a name.\hypertarget{md_src_plugins_csvstorage_README_autotoc_md127}{}\doxysection{Configuration}\label{md_src_plugins_csvstorage_README_autotoc_md127}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_src_plugins_csvstorage_README_autotoc_md128}{}\doxysection{Examples}\label{md_src_plugins_csvstorage_README_autotoc_md128}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_csvstorage_README_autotoc_md129}{}\doxysubsection{Usage}\label{md_src_plugins_csvstorage_README_autotoc_md129}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_csvstorage_README_autotoc_md130}{}\doxysection{Column as index}\label{md_src_plugins_csvstorage_README_autotoc_md130}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_csvstorage_README_autotoc_md131}{}\doxysection{Export filter}\label{md_src_plugins_csvstorage_README_autotoc_md131}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_csvstorage_README_autotoc_md132}{}\doxysubsection{Array metakey}\label{md_src_plugins_csvstorage_README_autotoc_md132}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_csvstorage_README_autotoc_md133}{}\doxysubsection{Limitations}\label{md_src_plugins_csvstorage_README_autotoc_md133}
