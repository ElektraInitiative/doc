...
\Hypertarget{doc_tutorials_logger_md_md_doc_tutorials_logger}%
 \hypertarget{doc_tutorials_logger_md_autotoc_md3938}{}\doxysection{Quickstart}\label{doc_tutorials_logger_md_autotoc_md3938}
...
The file sink behaves like syslog, if it has been enabled (see below).\hypertarget{doc_tutorials_logger_md_autotoc_md3939}{}\doxysection{Step by Step Guide}\label{doc_tutorials_logger_md_autotoc_md3939}
\hypertarget{doc_tutorials_logger_md_autotoc_md3940}{}\doxysubsection{Preparation}\label{doc_tutorials_logger_md_autotoc_md3940}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md3941}{}\doxysubsubsection{Log Everything}\label{doc_tutorials_logger_md_autotoc_md3941}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md3942}{}\doxysubsubsection{File Specific Logging}\label{doc_tutorials_logger_md_autotoc_md3942}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md3943}{}\doxysubsection{Enabling and Disabling Sinks}\label{doc_tutorials_logger_md_autotoc_md3943}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md3944}{}\doxysubsection{Compilation}\label{doc_tutorials_logger_md_autotoc_md3944}

\begin{DoxyEnumerate}
\item Enable the logger\+: e.\+g. run {\ttfamily cmake} with the switch {\ttfamily -\/DENABLE\+\_\+\+LOGGER=ON}
\item Build Elektra
\end{DoxyEnumerate}\hypertarget{doc_tutorials_logger_md_autotoc_md3945}{}\doxysection{Log Levels}\label{doc_tutorials_logger_md_autotoc_md3945}
