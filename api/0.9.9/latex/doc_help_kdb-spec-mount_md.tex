...
\Hypertarget{doc_help_kdb-spec-mount_md_md_doc_help_kdb_spec_mount}%
 \hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2687}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-spec-mount_md_autotoc_md2687}
...
{\ttfamily kdb smount} is an alias and can be used in the same way as {\ttfamily kdb spec-\/mount}.\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2688}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-spec-mount_md_autotoc_md2688}
...
\end{DoxyCode}
\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2689}{}\doxysection{IMPORTANT}\label{doc_help_kdb-spec-mount_md_autotoc_md2689}
...
\end{DoxyCode}
\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2690}{}\doxysection{OPTIONS}\label{doc_help_kdb-spec-mount_md_autotoc_md2690}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2691}{}\doxysection{KDB}\label{doc_help_kdb-spec-mount_md_autotoc_md2691}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2692}{}\doxysection{EXAMPLES}\label{doc_help_kdb-spec-mount_md_autotoc_md2692}
...
Additionally, add {\ttfamily ini} plugin (instead of some default resolver) with a config for INI\+:~\newline
 {\ttfamily sudo kdb spec-\/mount /example ini section=NULL}\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2693}{}\doxysection{SEE ALSO}\label{doc_help_kdb-spec-mount_md_autotoc_md2693}
