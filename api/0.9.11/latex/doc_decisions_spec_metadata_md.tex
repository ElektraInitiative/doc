...
\Hypertarget{doc_decisions_spec_metadata_md_md_doc_decisions_spec_metadata}%
 \hypertarget{doc_decisions_spec_metadata_md_autotoc_md2177}{}\doxysection{Problem}\label{doc_decisions_spec_metadata_md_autotoc_md2177}
...
If metadata is merged from different namespaces, e.\+g., {\ttfamily spec\+:} and {\ttfamily user\+:}, metadata from one namespace might end up in keys of other namespaces, e.\+g., metadata from {\ttfamily spec\+:} might end up in {\ttfamily user\+:}.\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2178}{}\doxysection{Constraints}\label{doc_decisions_spec_metadata_md_autotoc_md2178}
...
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2179}{}\doxysection{Assumptions}\label{doc_decisions_spec_metadata_md_autotoc_md2179}

\begin{DoxyItemize}
\item Metadata can always safely merged from {\ttfamily spec\+:/} to other namespace.
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2180}{}\doxysection{Considered Alternatives}\label{doc_decisions_spec_metadata_md_autotoc_md2180}
...
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2181}{}\doxysection{Decision}\label{doc_decisions_spec_metadata_md_autotoc_md2181}
...
The {\ttfamily kdb mount} tool will add the {\ttfamily meta} plugin configuration when mounting a storage plugin to {\ttfamily spec\+:/}.\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2182}{}\doxysection{Rationale}\label{doc_decisions_spec_metadata_md_autotoc_md2182}
...
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2183}{}\doxysection{Implications}\label{doc_decisions_spec_metadata_md_autotoc_md2183}
...
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2184}{}\doxysection{Related Decisions}\label{doc_decisions_spec_metadata_md_autotoc_md2184}
...
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2185}{}\doxysection{Notes}\label{doc_decisions_spec_metadata_md_autotoc_md2185}
