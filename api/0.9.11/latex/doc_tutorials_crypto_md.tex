...
\item {\ttfamily fcrypt}.
\end{DoxyEnumerate}\hypertarget{doc_tutorials_crypto_md_autotoc_md3861}{}\doxysection{Prerequisites -\/ Gnu\+PG}\label{doc_tutorials_crypto_md_autotoc_md3861}
...
The {\ttfamily fcrypt} plugin and the {\ttfamily crypto} plugin support both versions (version 1 and version 2) of GPG.\hypertarget{doc_tutorials_crypto_md_autotoc_md3862}{}\doxysection{Introduction}\label{doc_tutorials_crypto_md_autotoc_md3862}
...
We also show how to approach integrity with the signature features of the {\ttfamily fcrypt} plugin.\hypertarget{doc_tutorials_crypto_md_autotoc_md3863}{}\doxysection{Configuration File Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md3863}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3864}{}\doxysection{Configuration File Signatures}\label{doc_tutorials_crypto_md_autotoc_md3864}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3865}{}\doxysubsection{Combining Signatures and Encryption}\label{doc_tutorials_crypto_md_autotoc_md3865}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3866}{}\doxysection{Configuration Value Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md3866}
...
As a result you get \char`\"{}1234\char`\"{}.\hypertarget{doc_tutorials_crypto_md_autotoc_md3868}{}\doxysubsection{Disabling Encryption}\label{doc_tutorials_crypto_md_autotoc_md3868}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3869}{}\doxysubsection{Complete Example}\label{doc_tutorials_crypto_md_autotoc_md3869}
The complete example looks like this\+:
