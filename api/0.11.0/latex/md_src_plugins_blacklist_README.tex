...
This plugin is a blacklist plugin that blocks the assignment of specific values to a key.\hypertarget{md_src_plugins_blacklist_README_autotoc_md78}{}\doxysection{Usage}\label{md_src_plugins_blacklist_README_autotoc_md78}
...
All values in the array will be rejected. The array indices don\textquotesingle{}t have to be continuous, using e.\+g. only {\ttfamily \#1}, {\ttfamily \#2} and {\ttfamily \#4} is also allowed. Just make sure {\ttfamily check/blacklist} is set to the largest index in the array.\hypertarget{md_src_plugins_blacklist_README_autotoc_md79}{}\doxysection{Installation}\label{md_src_plugins_blacklist_README_autotoc_md79}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/extra}.\hypertarget{md_src_plugins_blacklist_README_autotoc_md80}{}\doxysection{Examples}\label{md_src_plugins_blacklist_README_autotoc_md80}
