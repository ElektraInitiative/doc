...
This plugin is an implementation of a parser and generator of the /etc/fstab file.\hypertarget{md_src_plugins_fstab_README_autotoc_md215}{}\doxysection{Installation}\label{md_src_plugins_fstab_README_autotoc_md215}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/extra}.\hypertarget{md_src_plugins_fstab_README_autotoc_md216}{}\doxysection{Old fstab Entries}\label{md_src_plugins_fstab_README_autotoc_md216}
...
setmntent is used, so it is only conforming to BSD 4.\+3 and linux and you can\textquotesingle{}t use any comments.\hypertarget{md_src_plugins_fstab_README_autotoc_md217}{}\doxysection{New fstab Entries}\label{md_src_plugins_fstab_README_autotoc_md217}
Specification\+:
...
Spaces in the names are replaced by \textbackslash{}040 in the fstab.\hypertarget{md_src_plugins_fstab_README_autotoc_md218}{}\doxysection{Example}\label{md_src_plugins_fstab_README_autotoc_md218}
Mount the plugin\+:
