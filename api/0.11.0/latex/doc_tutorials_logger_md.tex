...
\Hypertarget{doc_tutorials_logger_md_md_doc_tutorials_logger}%
 \hypertarget{doc_tutorials_logger_md_autotoc_md4576}{}\doxysection{Quickstart}\label{doc_tutorials_logger_md_autotoc_md4576}
...
The file sink behaves like syslog, if it has been enabled (see below).\hypertarget{doc_tutorials_logger_md_autotoc_md4577}{}\doxysection{Step by Step Guide}\label{doc_tutorials_logger_md_autotoc_md4577}
\hypertarget{doc_tutorials_logger_md_autotoc_md4578}{}\doxysubsection{Preparation}\label{doc_tutorials_logger_md_autotoc_md4578}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md4579}{}\doxysubsubsection{Log Everything}\label{doc_tutorials_logger_md_autotoc_md4579}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md4580}{}\doxysubsubsection{File Specific Logging}\label{doc_tutorials_logger_md_autotoc_md4580}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md4581}{}\doxysubsection{Enabling and Disabling Sinks}\label{doc_tutorials_logger_md_autotoc_md4581}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md4582}{}\doxysubsection{Compilation}\label{doc_tutorials_logger_md_autotoc_md4582}

\begin{DoxyEnumerate}
\item Enable the logger\+: e.\+g. run {\ttfamily cmake} with the switch {\ttfamily -\/DENABLE\+\_\+\+LOGGER=ON}
\item Build Elektra
\end{DoxyEnumerate}\hypertarget{doc_tutorials_logger_md_autotoc_md4583}{}\doxysection{Log Levels}\label{doc_tutorials_logger_md_autotoc_md4583}
