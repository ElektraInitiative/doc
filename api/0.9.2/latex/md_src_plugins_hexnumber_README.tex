...
This plugin is used to read configuration files that use hexadecimal values. All \char`\"{}hex-\/values\char`\"{} (see below) will be converted into decimal when Elektra reads values from the mounted file. When Elektra writes back to the file the converted values will be converted back and stored as before ({\ttfamily 0X} will be replaced with {\ttfamily 0x}).\hypertarget{md_src_plugins_hexnumber_README_autotoc_md260}{}\doxysubsection{What are \char`\"{}hex-\/values\char`\"{}?}\label{md_src_plugins_hexnumber_README_autotoc_md260}
...
\end{DoxyEnumerate}\hypertarget{md_src_plugins_hexnumber_README_autotoc_md261}{}\doxysection{Configuration}\label{md_src_plugins_hexnumber_README_autotoc_md261}
...
N\+O\+TE\+: be careful when using this option, as any configuration value that contains invalid non-\/hexadecimal characters (i.\+e. does not match {\ttfamily 0\mbox{[}xX\mbox{]}\mbox{[}0-\/9A-\/\+Fa-\/f\mbox{]}+}) will result in an error.
\end{DoxyEnumerate}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_hexnumber_README_autotoc_md262}{}\doxysection{Usage \& Example}\label{md_src_plugins_hexnumber_README_autotoc_md262}
