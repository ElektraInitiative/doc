...
\Hypertarget{doc_help_kdb-cmerge_md_md_doc_help_kdb_cmerge}%
 \hypertarget{doc_help_kdb-cmerge_md_autotoc_md2317}{}\doxysection{NAME}\label{doc_help_kdb-cmerge_md_autotoc_md2317}
kdb-\/cmerge -\/ Join three key sets together\hypertarget{doc_help_kdb-cmerge_md_autotoc_md2318}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-cmerge_md_autotoc_md2318}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-cmerge_md_autotoc_md2319}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-cmerge_md_autotoc_md2319}
{\ttfamily kdb cmerge} can incorporate changes from two modified versions (our and their) into a common preceding version (base) of a key set. This lets you merge the sets of changes represented by the two newer key sets. This is called a three-\/way merge between key sets.~\newline
 ...
 This tool currently exists alongside {\ttfamily kdb merge} until it is completely ready to supersede it. At this moment, cmerge will be renamed to merge.\hypertarget{doc_help_kdb-cmerge_md_autotoc_md2320}{}\doxysection{OPTIONS}\label{doc_help_kdb-cmerge_md_autotoc_md2320}
...
Strategies have their own \mbox{\hyperlink{doc_help_elektra-cmerge-strategy_md}{man page}} which can be accessed with {\ttfamily man elektra-\/cmerge-\/strategies}.\hypertarget{doc_help_kdb-cmerge_md_autotoc_md2321}{}\doxysection{RETURN VALUE}\label{doc_help_kdb-cmerge_md_autotoc_md2321}
...
The result of the merge is stored in {\ttfamily result}.\hypertarget{doc_help_kdb-cmerge_md_autotoc_md2322}{}\doxysection{THREE-\/\+WAY MERGE}\label{doc_help_kdb-cmerge_md_autotoc_md2322}
...
\hypertarget{doc_help_kdb-cmerge_md_autotoc_md2323}{}\doxysection{CONFLICTS}\label{doc_help_kdb-cmerge_md_autotoc_md2323}
...
\hypertarget{doc_help_kdb-cmerge_md_autotoc_md2324}{}\doxysection{EXAMPLES}\label{doc_help_kdb-cmerge_md_autotoc_md2324}
...
\`{}\`{}\`{}~\newline
\hypertarget{doc_help_kdb-cmerge_md_autotoc_md2325}{}\doxysection{SEE ALSO}\label{doc_help_kdb-cmerge_md_autotoc_md2325}
