...
\Hypertarget{doc_decisions_error_codes_md_md_doc_decisions_error_codes}%
 \hypertarget{doc_decisions_error_codes_md_autotoc_md1834}{}\doxysection{Problem}\label{doc_decisions_error_codes_md_autotoc_md1834}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_codes_md_autotoc_md1835}{}\doxysection{Constraints}\label{doc_decisions_error_codes_md_autotoc_md1835}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_codes_md_autotoc_md1836}{}\doxysection{Assumptions}\label{doc_decisions_error_codes_md_autotoc_md1836}
\hypertarget{doc_decisions_error_codes_md_autotoc_md1837}{}\doxysection{Considered Alternatives}\label{doc_decisions_error_codes_md_autotoc_md1837}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_codes_md_autotoc_md1838}{}\doxysection{Decision}\label{doc_decisions_error_codes_md_autotoc_md1838}
...
To see an explanation of the categories along with a guideline on how to categorize please see the \mbox{\hyperlink{doc_dev_error-categorization_md}{Error Codes Guideline}}\hypertarget{doc_decisions_error_codes_md_autotoc_md1839}{}\doxysection{Rationale}\label{doc_decisions_error_codes_md_autotoc_md1839}
...
These categories are chosen because they can help developers to react programmatically and cover the majority of use cases to our present knowledge. If there is ever the need for another reaction based category, it can be extended very easily.\hypertarget{doc_decisions_error_codes_md_autotoc_md1840}{}\doxysection{Implications}\label{doc_decisions_error_codes_md_autotoc_md1840}
...
Current errors will be migrated.\hypertarget{doc_decisions_error_codes_md_autotoc_md1841}{}\doxysection{Related Decisions}\label{doc_decisions_error_codes_md_autotoc_md1841}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_codes_md_autotoc_md1842}{}\doxysection{Notes}\label{doc_decisions_error_codes_md_autotoc_md1842}
