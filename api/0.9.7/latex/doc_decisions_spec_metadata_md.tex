...
\Hypertarget{doc_decisions_spec_metadata_md_md_doc_decisions_spec_metadata}%
 \hypertarget{doc_decisions_spec_metadata_md_autotoc_md2028}{}\doxysection{Problem}\label{doc_decisions_spec_metadata_md_autotoc_md2028}
...
If metadata is merged from different namespaces, e.\+g., {\ttfamily spec\+:} and {\ttfamily user\+:}, metadata from one namespace might end up in keys of other namespaces, e.\+g., metadata from {\ttfamily spec\+:} might end up in {\ttfamily user\+:}.\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2029}{}\doxysection{Constraints}\label{doc_decisions_spec_metadata_md_autotoc_md2029}
...
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2030}{}\doxysection{Assumptions}\label{doc_decisions_spec_metadata_md_autotoc_md2030}

\begin{DoxyItemize}
\item Metadata can always safely merged from {\ttfamily spec\+:/} to other namespace.
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2031}{}\doxysection{Considered Alternatives}\label{doc_decisions_spec_metadata_md_autotoc_md2031}
...
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2032}{}\doxysection{Decision}\label{doc_decisions_spec_metadata_md_autotoc_md2032}
...
The {\ttfamily kdb mount} tool will add the {\ttfamily meta} plugin configuration when mounting a storage plugin to {\ttfamily spec\+:/}.\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2033}{}\doxysection{Rationale}\label{doc_decisions_spec_metadata_md_autotoc_md2033}
...
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2034}{}\doxysection{Implications}\label{doc_decisions_spec_metadata_md_autotoc_md2034}
...
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2035}{}\doxysection{Related Decisions}\label{doc_decisions_spec_metadata_md_autotoc_md2035}
...
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2036}{}\doxysection{Notes}\label{doc_decisions_spec_metadata_md_autotoc_md2036}
