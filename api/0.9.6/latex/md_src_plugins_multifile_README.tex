...
The multifile-\/resolver does so by calling resolver and storage plugins for each file matching a given pattern.\hypertarget{md_src_plugins_multifile_README_autotoc_md349}{}\doxysection{Plugin Configuration}\label{md_src_plugins_multifile_README_autotoc_md349}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_multifile_README_autotoc_md350}{}\doxysection{Usage}\label{md_src_plugins_multifile_README_autotoc_md350}
...
{\ttfamily kdb mount -\/R multifile -\/c storage=\char`\"{}toml\char`\"{},pattern=\char`\"{}$\ast$.\+toml\char`\"{},recursive=,resolver=\char`\"{}resolver\char`\"{} /path /mountpoint}\hypertarget{md_src_plugins_multifile_README_autotoc_md351}{}\doxysection{Examples}\label{md_src_plugins_multifile_README_autotoc_md351}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_multifile_README_autotoc_md352}{}\doxysection{Limitations}\label{md_src_plugins_multifile_README_autotoc_md352}
