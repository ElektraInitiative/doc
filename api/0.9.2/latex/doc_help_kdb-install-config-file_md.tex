\hypertarget{doc_help_kdb-install-config-file_md_autotoc_md1720}{}\doxysection{S\+Y\+N\+O\+P\+S\+IS}\label{doc_help_kdb-install-config-file_md_autotoc_md1720}
...
The script has to be called as administrator (e.\+g. with {\ttfamily sudo}).\hypertarget{doc_help_kdb-install-config-file_md_autotoc_md1721}{}\doxysection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{doc_help_kdb-install-config-file_md_autotoc_md1721}
...
\end{DoxyEnumerate}\hypertarget{doc_help_kdb-install-config-file_md_autotoc_md1722}{}\doxysection{E\+X\+A\+M\+P\+L\+ES}\label{doc_help_kdb-install-config-file_md_autotoc_md1722}
