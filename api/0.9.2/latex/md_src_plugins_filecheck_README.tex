...
The filecheck plugin validates files. It tests\+: encoding, lineendings, B\+OM, printable characters and null bytes.\hypertarget{md_src_plugins_filecheck_README_autotoc_md229}{}\doxysection{Configuration}\label{md_src_plugins_filecheck_README_autotoc_md229}
