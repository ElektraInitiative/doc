...
\Hypertarget{doc_decisions_spec_metadata_md_md_doc_decisions_spec_metadata}%
 \hypertarget{doc_decisions_spec_metadata_md_autotoc_md2145}{}\doxysection{Problem}\label{doc_decisions_spec_metadata_md_autotoc_md2145}
...
If metadata is merged from different namespaces, e.\+g., {\ttfamily spec\+:} and {\ttfamily user\+:}, metadata from one namespace might end up in keys of other namespaces, e.\+g., metadata from {\ttfamily spec\+:} might end up in {\ttfamily user\+:}.\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2146}{}\doxysection{Constraints}\label{doc_decisions_spec_metadata_md_autotoc_md2146}
...
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2147}{}\doxysection{Assumptions}\label{doc_decisions_spec_metadata_md_autotoc_md2147}

\begin{DoxyItemize}
\item Metadata can always safely merged from {\ttfamily spec\+:/} to other namespace.
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2148}{}\doxysection{Considered Alternatives}\label{doc_decisions_spec_metadata_md_autotoc_md2148}
...
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2149}{}\doxysection{Decision}\label{doc_decisions_spec_metadata_md_autotoc_md2149}
...
The {\ttfamily kdb mount} tool will add the {\ttfamily meta} plugin configuration when mounting a storage plugin to {\ttfamily spec\+:/}.\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2150}{}\doxysection{Rationale}\label{doc_decisions_spec_metadata_md_autotoc_md2150}
...
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2151}{}\doxysection{Implications}\label{doc_decisions_spec_metadata_md_autotoc_md2151}
...
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2152}{}\doxysection{Related Decisions}\label{doc_decisions_spec_metadata_md_autotoc_md2152}
...
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2153}{}\doxysection{Notes}\label{doc_decisions_spec_metadata_md_autotoc_md2153}
