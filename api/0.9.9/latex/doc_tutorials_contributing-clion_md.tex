...
\end{DoxyItemize}\hypertarget{doc_tutorials_contributing-clion_md_autotoc_md3726}{}\doxysection{Forking the Repository}\label{doc_tutorials_contributing-clion_md_autotoc_md3726}
...
With the project now locally available we can start developing.\hypertarget{doc_tutorials_contributing-clion_md_autotoc_md3728}{}\doxysection{Setting Up the Project}\label{doc_tutorials_contributing-clion_md_autotoc_md3728}
...
Make sure the selected {\itshape Scheme} is {\itshape Project}.\hypertarget{doc_tutorials_contributing-clion_md_autotoc_md3729}{}\doxysection{Development}\label{doc_tutorials_contributing-clion_md_autotoc_md3729}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_contributing-clion_md_autotoc_md3730}{}\doxysection{Testing}\label{doc_tutorials_contributing-clion_md_autotoc_md3730}
...
With this, you\textquotesingle{}ve published your changes to your remote branch of your repository. The next step is merging this change into the original repository.\hypertarget{doc_tutorials_contributing-clion_md_autotoc_md3732}{}\doxysection{Creating a Pull Request}\label{doc_tutorials_contributing-clion_md_autotoc_md3732}
...
If you want to use CLion for creating Pull Request, please check out \href{https://www.jetbrains.com/help/clion/contribute-to-projects.html\#create-pull-request}{\texttt{ this}} link for further information.\hypertarget{doc_tutorials_contributing-clion_md_autotoc_md3733}{}\doxysection{Troubleshooting}\label{doc_tutorials_contributing-clion_md_autotoc_md3733}
\hypertarget{doc_tutorials_contributing-clion_md_autotoc_md3734}{}\doxysubsection{Resolving Missing $\ast$.\+so Library Error In Debug Mode}\label{doc_tutorials_contributing-clion_md_autotoc_md3734}
...
Please refer to \mbox{\hyperlink{doc_COMPILE_md}{this}} tutorial to fix the problem permanently.\hypertarget{doc_tutorials_contributing-clion_md_autotoc_md3735}{}\doxysection{Hints}\label{doc_tutorials_contributing-clion_md_autotoc_md3735}
