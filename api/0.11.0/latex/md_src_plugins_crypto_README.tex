...
The crypto plugin uses libgcrypt as provider of cryptographic operations.\hypertarget{md_src_plugins_crypto_README_autotoc_md124}{}\doxysection{Installation}\label{md_src_plugins_crypto_README_autotoc_md124}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/crypto}.\hypertarget{md_src_plugins_crypto_README_autotoc_md125}{}\doxysection{Dependencies}\label{md_src_plugins_crypto_README_autotoc_md125}

\begin{DoxyItemize}
\item {\ttfamily libgcrypt20-\/dev} or {\ttfamily libgcrypt-\/devel}
\end{DoxyItemize}\hypertarget{md_src_plugins_crypto_README_autotoc_md126}{}\doxysubsection{Gnu\+PG (\+GPG)}\label{md_src_plugins_crypto_README_autotoc_md126}
GPG is a run-\/time dependency of the crypto plugin. Either the {\ttfamily gpg} or the {\ttfamily gpg2} binary must be installed when using the plugin. Note that {\ttfamily gpg2} will be preferred if both versions are available. The GPG binary can be configured in the plugin configuration as {\ttfamily /gpg/bin} (see {\itshape GPG Configuration} below). If no such configuration is provided, the plugin will look at the PATH environment variable to find the GPG binaries.\hypertarget{md_src_plugins_crypto_README_autotoc_md127}{}\doxysection{How to compile}\label{md_src_plugins_crypto_README_autotoc_md127}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_crypto_README_autotoc_md128}{}\doxysubsection{mac\+OS}\label{md_src_plugins_crypto_README_autotoc_md128}
...
Also a GPG installation is required. The \href{https://gpgtools.org}{\texttt{ GPG Tools}} work fine for us.\hypertarget{md_src_plugins_crypto_README_autotoc_md129}{}\doxysection{Restrictions}\label{md_src_plugins_crypto_README_autotoc_md129}
At the moment the plugin will only run on Unix/\+Linux-\/like systems, that provide implementations for {\ttfamily fork ()} and {\ttfamily execv ()}.\hypertarget{md_src_plugins_crypto_README_autotoc_md130}{}\doxysection{Examples}\label{md_src_plugins_crypto_README_autotoc_md130}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_crypto_README_autotoc_md131}{}\doxysection{Configuration}\label{md_src_plugins_crypto_README_autotoc_md131}
\hypertarget{md_src_plugins_crypto_README_autotoc_md132}{}\doxysubsection{GPG Configuration}\label{md_src_plugins_crypto_README_autotoc_md132}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_crypto_README_autotoc_md133}{}\doxysubsection{Cryptographic Operations}\label{md_src_plugins_crypto_README_autotoc_md133}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_crypto_README_autotoc_md134}{}\doxysubsection{Library Shutdown}\label{md_src_plugins_crypto_README_autotoc_md134}
...
Per default shutdown is disabled to prevent applications like the qt-\/gui from crashing. Shutdown is enabled in the unit tests to prevent memory leaks.\hypertarget{md_src_plugins_crypto_README_autotoc_md135}{}\doxysection{Technical Details}\label{md_src_plugins_crypto_README_autotoc_md135}
\hypertarget{md_src_plugins_crypto_README_autotoc_md136}{}\doxysubsection{Ciphers and Mode of Operation}\label{md_src_plugins_crypto_README_autotoc_md136}
