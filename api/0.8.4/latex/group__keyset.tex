...
\hline
{\em to\-Append} & the Key\-Set that provides the keys that will be transfered \\
\hline
\end{DoxyParams}
...
\hline
{\em to\-Append} & Key that will be appended to ks \\
\hline
\end{DoxyParams}
\begin{DoxySeeAlso}{See Also}
...
Searches for the cutpoint inside the Key\-Set ks. If found it cuts out everything which is below (see \hyperlink{group__keytest_ga03332b5d97c76a4fd2640aca4762b8df}{key\-Is\-Below()}) this key. If not found an empty keyset is returned.
...
\begin{DoxyParams}{Parameters}
{\em source} & has to be an initializised source Key\-Set \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\end{DoxyReturn}
\begin{DoxySeeAlso}{See Also}
ks\-New(0), \hyperlink{group__keyset_ga27e5c16473b02a422238c8d970db7ac8}{ks\-Del()} 
\end{DoxySeeAlso}
...
\end{DoxyReturn}
\begin{DoxySeeAlso}{See Also}
\hyperlink{group__keytest_gab98168409d302fdb65692f6e26f17945}{key\-Compare()} for very powerfull Key lookups in Key\-Sets 
