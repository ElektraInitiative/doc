...
Supports every Key\+Set except when arrays are intermixed with other keys. Has only limited support for metadata.\hypertarget{md_src_plugins_yajl_README_autotoc_md624}{}\doxysection{Installation}\label{md_src_plugins_yajl_README_autotoc_md624}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/yajl}.\hypertarget{md_src_plugins_yajl_README_autotoc_md625}{}\doxysection{Dependencies}\label{md_src_plugins_yajl_README_autotoc_md625}

\begin{DoxyItemize}
\item {\ttfamily libyajl-\/dev} (version 1 and 2 should work)
\end{DoxyItemize}\hypertarget{md_src_plugins_yajl_README_autotoc_md626}{}\doxysection{Types}\label{md_src_plugins_yajl_README_autotoc_md626}
...
Any other type/value will still be treated as string, but the warning {\ttfamily C03200} will be added because of the potential data loss.\hypertarget{md_src_plugins_yajl_README_autotoc_md627}{}\doxysection{Special values}\label{md_src_plugins_yajl_README_autotoc_md627}
...
Arrays are mapped to Elektra’s array convention \#0, \#1,..\hypertarget{md_src_plugins_yajl_README_autotoc_md628}{}\doxysection{Restrictions}\label{md_src_plugins_yajl_README_autotoc_md628}
...
Because of these potential problems a type checker and comments filter are highly recommended.\hypertarget{md_src_plugins_yajl_README_autotoc_md629}{}\doxysection{Usage}\label{md_src_plugins_yajl_README_autotoc_md629}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yajl_README_autotoc_md630}{}\doxysubsection{Directory Values}\label{md_src_plugins_yajl_README_autotoc_md630}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yajl_README_autotoc_md631}{}\doxysubsection{Booleans}\label{md_src_plugins_yajl_README_autotoc_md631}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yajl_README_autotoc_md632}{}\doxysection{Open\+ICC Device Config}\label{md_src_plugins_yajl_README_autotoc_md632}
