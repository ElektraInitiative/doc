\hypertarget{autotoc_md594_src_plugins_reference_examples_complex_README_md}{}\section{Example\+: Validating Complex Recursive Structures}\label{autotoc_md594_src_plugins_reference_examples_complex_README_md}
