...
\end{DoxyItemize}\hypertarget{md_src_plugins_type_README_autotoc_md576}{}\doxysection{Enums}\label{md_src_plugins_type_README_autotoc_md576}
...
Then the value {\ttfamily middle\+\_\+small} would validate. {\ttfamily middle\+\_\+small\+\_\+small} would be allowed as well, because multi-\/values are treated like bitfields.\hypertarget{md_src_plugins_type_README_autotoc_md577}{}\doxysection{Normalization}\label{md_src_plugins_type_README_autotoc_md577}
...
Note\+: If normalization is used, often times you will get a normalization error instead of a type checking error.\hypertarget{md_src_plugins_type_README_autotoc_md578}{}\doxysubsection{Booleans}\label{md_src_plugins_type_README_autotoc_md578}
...
The special value {\ttfamily boolean/restoreas=none} completely disables the restore procedure. In other words, {\ttfamily kdb\+Set} will always return either {\ttfamily 0} or {\ttfamily 1} for boolean values. This is useful, if a storage format with built-\/in support for boolean values is used.\hypertarget{md_src_plugins_type_README_autotoc_md579}{}\doxysubsection{Enums}\label{md_src_plugins_type_README_autotoc_md579}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_type_README_autotoc_md581}{}\doxysection{Limitations}\label{md_src_plugins_type_README_autotoc_md581}
