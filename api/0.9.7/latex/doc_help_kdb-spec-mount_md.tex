...
\Hypertarget{doc_help_kdb-spec-mount_md_md_doc_help_kdb_spec_mount}%
 \hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2561}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-spec-mount_md_autotoc_md2561}
...
{\ttfamily kdb smount} is an alias and can be used in the same way as {\ttfamily kdb spec-\/mount}.\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2562}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-spec-mount_md_autotoc_md2562}
...
\end{DoxyCode}
\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2563}{}\doxysection{IMPORTANT}\label{doc_help_kdb-spec-mount_md_autotoc_md2563}
...
\end{DoxyCode}
\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2564}{}\doxysection{OPTIONS}\label{doc_help_kdb-spec-mount_md_autotoc_md2564}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2565}{}\doxysection{KDB}\label{doc_help_kdb-spec-mount_md_autotoc_md2565}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2566}{}\doxysection{EXAMPLES}\label{doc_help_kdb-spec-mount_md_autotoc_md2566}
...
Additionally, add {\ttfamily ini} plugin (instead of some default resolver) with a config for INI\+:~\newline
 {\ttfamily sudo kdb spec-\/mount /example ini section=NULL}\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2567}{}\doxysection{SEE ALSO}\label{doc_help_kdb-spec-mount_md_autotoc_md2567}
