...
This plugin is a notification plugin, which sends notifications using Zero\+Mq publish ({\ttfamily ZMQ\+\_\+\+PUB}) sockets when the key database (KDB) has been modified. It is compatible with the sending zeromqrecv plugin.\hypertarget{md_src_plugins_zeromqsend_README_autotoc_md663}{}\doxysection{Installation}\label{md_src_plugins_zeromqsend_README_autotoc_md663}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/zeromq}.\hypertarget{md_src_plugins_zeromqsend_README_autotoc_md664}{}\doxysection{Dependencies}\label{md_src_plugins_zeromqsend_README_autotoc_md664}

\begin{DoxyItemize}
\item {\ttfamily libzmq3-\/dev} (Zero\+MQ C bindings $>$ 3.\+2)
\end{DoxyItemize}\hypertarget{md_src_plugins_zeromqsend_README_autotoc_md665}{}\doxysection{Usage}\label{md_src_plugins_zeromqsend_README_autotoc_md665}
...
Since Zero\+MQ sockets only provide a 1\+:n mapping (i.\+e. one publisher with many subscribers or one subscriber and many publishers) the {\ttfamily zeromqsend} and {\ttfamily zeromqrecv} plugins require a XPUB/\+XSUB endpoint. The kdb tool \href{https://www.libelektra.org/tools/hub-zeromq}{\texttt{ \char`\"{}hub-\/zeromq\char`\"{}}} provides these endpoints.\hypertarget{md_src_plugins_zeromqsend_README_autotoc_md666}{}\doxysection{Transport Plugin}\label{md_src_plugins_zeromqsend_README_autotoc_md666}
...
\hypertarget{md_src_plugins_zeromqsend_README_autotoc_md667}{}\doxysection{Configuration}\label{md_src_plugins_zeromqsend_README_autotoc_md667}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_zeromqsend_README_autotoc_md668}{}\doxysection{Notification Format}\label{md_src_plugins_zeromqsend_README_autotoc_md668}
