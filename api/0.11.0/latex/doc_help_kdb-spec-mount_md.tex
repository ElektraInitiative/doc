...
\Hypertarget{doc_help_kdb-spec-mount_md_md_doc_help_kdb_spec_mount}%
 \hypertarget{doc_help_kdb-spec-mount_md_autotoc_md3146}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-spec-mount_md_autotoc_md3146}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md3147}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-spec-mount_md_autotoc_md3147}
...
\end{DoxyCode}
\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md3148}{}\doxysection{IMPORTANT}\label{doc_help_kdb-spec-mount_md_autotoc_md3148}
This command writes into the {\ttfamily /etc} directory and as such it requires root permissions. Use {\ttfamily kdb file system\+:/elektra/mountpoints} to find out where exactly it will write to.\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md3149}{}\doxysection{OPTIONS}\label{doc_help_kdb-spec-mount_md_autotoc_md3149}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md3150}{}\doxysection{KDB}\label{doc_help_kdb-spec-mount_md_autotoc_md3150}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md3151}{}\doxysection{EXAMPLES}\label{doc_help_kdb-spec-mount_md_autotoc_md3151}
...
Additionally, add {\ttfamily ini} plugin (instead of some default resolver) with a config for INI\+:~\newline
 {\ttfamily sudo kdb spec-\/mount /example ini section=NULL}\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md3152}{}\doxysection{SEE ALSO}\label{doc_help_kdb-spec-mount_md_autotoc_md3152}
