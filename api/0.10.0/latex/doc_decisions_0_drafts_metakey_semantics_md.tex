...
\Hypertarget{doc_decisions_0_drafts_metakey_semantics_md_md_doc_decisions_0_drafts_metakey_semantics}%
 \hypertarget{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1760}{}\doxysection{Problem}\label{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1760}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1762}{}\doxysection{Assumptions}\label{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1762}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1763}{}\doxysection{Considered Alternatives}\label{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1763}
\hypertarget{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1764}{}\doxysubsection{Completely Read-\/only}\label{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1764}
...
Copying metadata works the same as above. Since the {\ttfamily Key}s are still read-\/only as long as {\ttfamily source} uses them, we again cannot affect {\ttfamily source} by changing {\ttfamily dest}.\hypertarget{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1766}{}\doxysubsection{Utilize COW implementation}\label{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1766}
\hypertarget{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1767}{}\doxysubsubsection{Issues with Read-\/only Solutions}\label{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1767}
...
For a one-\/time operation the difference might not be big, but if a metakey (probably not {\ttfamily meta\+:/type}), changes many times it will become significant. Every time the simpler solution is used, an entirely new {\ttfamily Key} is created instead of utilizing the COW approach.\hypertarget{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1768}{}\doxysubsubsection{Possible Fix}\label{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1768}
...
To solve the issues mentioned above, {\ttfamily spec} needs to do a few things differently\+:\hypertarget{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1769}{}\doxysubsubsection{Copying Metakeys in $<$tt$>$spec$<$/tt$>$}\label{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1769}
...
\end{DoxyCode}
\hypertarget{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1770}{}\doxysubsubsection{Detecting \& Removing Copied Metakeys in $<$tt$>$spec$<$/tt$>$}\label{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1770}
...
\hypertarget{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1771}{}\doxysection{Decision}\label{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1771}
\hypertarget{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1772}{}\doxysection{Rationale}\label{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1772}
\hypertarget{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1773}{}\doxysection{Implications}\label{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1773}
\hypertarget{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1774}{}\doxysection{Related Decisions}\label{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1774}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1775}{}\doxysection{Notes}\label{doc_decisions_0_drafts_metakey_semantics_md_autotoc_md1775}
