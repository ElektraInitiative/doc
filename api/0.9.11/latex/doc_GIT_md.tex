...
\Hypertarget{doc_GIT_md_md_doc_GIT}%
 \hypertarget{doc_GIT_md_autotoc_md2367}{}\doxysection{Basic GIT Commands}\label{doc_GIT_md_autotoc_md2367}
...
\end{DoxyCode}
\hypertarget{doc_GIT_md_autotoc_md2368}{}\doxysection{Basic Configuration}\label{doc_GIT_md_autotoc_md2368}
make sure to do\+:
...
\end{DoxyCode}
\hypertarget{doc_GIT_md_autotoc_md2369}{}\doxysection{The Commit Message}\label{doc_GIT_md_autotoc_md2369}
...
Most commits should have a longer description in the body.\hypertarget{doc_GIT_md_autotoc_md2370}{}\doxysection{Remote Branches}\label{doc_GIT_md_autotoc_md2370}
...
\end{DoxyVerb}
 This is the development branch. Please try to not work directly on it, but instead you should use feature branches. So the only commits on master should be non-\/fastforward merges from features branches. Commits on master should always compile and all test cases should pass successfully. (see config option above)\hypertarget{doc_GIT_md_autotoc_md2371}{}\doxysection{Local Branches}\label{doc_GIT_md_autotoc_md2371}
...
\end{DoxyCode}
\hypertarget{doc_GIT_md_autotoc_md2372}{}\doxysection{Working with forks}\label{doc_GIT_md_autotoc_md2372}
