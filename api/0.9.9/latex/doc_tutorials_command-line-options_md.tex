...
\Hypertarget{doc_tutorials_command-line-options_md_md_doc_tutorials_command_line_options}%
 \hypertarget{doc_tutorials_command-line-options_md_autotoc_md3703}{}\doxysection{Introduction}\label{doc_tutorials_command-line-options_md_autotoc_md3703}
...
The last parameter {\ttfamily gopts\+Config} can be used to provide additional configuration values to {\ttfamily gopts}. For example, this can be used to configure the auto-\/generated help message. The keys that {\ttfamily gopts} accepts in this Key\+Set will be explained throughout the document . A full list can be found in the \mbox{\hyperlink{md_src_plugins_gopts_README_src_plugins_gopts_README_md}{\`{}gopts\`{} README}}.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3705}{}\doxysection{Specification}\label{doc_tutorials_command-line-options_md_autotoc_md3705}
This section describes the specification used by the command-\/line option and environment variable parser.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3706}{}\doxysubsection{Options}\label{doc_tutorials_command-line-options_md_autotoc_md3706}
...
While you can specify multiple options (or environment variables, see below) for a single key, only one of them can be used at the same time. Using two or more options (or variables) that are all linked to the same key, will result in an error.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3707}{}\doxysubsubsection{Option Arguments}\label{doc_tutorials_command-line-options_md_autotoc_md3707}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3708}{}\doxysubsection{Environment Variables}\label{doc_tutorials_command-line-options_md_autotoc_md3708}
Elektra also supports parsing environment variables in a similar manner. For these there are however, less configuration options. You can simply specify one or more environment variables for a key using the {\ttfamily env} metakey (or {\ttfamily env/\#} meta-\/array for multiple).\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3709}{}\doxysubsection{Arrays}\label{doc_tutorials_command-line-options_md_autotoc_md3709}
...
Environment variables obviously cannot be repeated, instead a behavior similar that used for PATH is adopted. On Windows the variable will be split at each \textquotesingle{};\textquotesingle{} character. On all other systems \textquotesingle{}\+:\textquotesingle{} is used as a separator.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3710}{}\doxysubsection{Parameter Arguments}\label{doc_tutorials_command-line-options_md_autotoc_md3710}
...
If we parse command-\/line options like the POSIX version of getopt(3) does, then we would also stop processing options at the first non-\/option argument. This not the case by default, but we can enable this behavior. To do so, you need to pass a Key {\ttfamily /posixly} with value {\ttfamily 1} in the {\ttfamily gopts\+Config} Key\+Set of the {\ttfamily gopts} contract.
...
\end{DoxyItemize}\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3712}{}\doxysubsection{Sub-\/\+Commands}\label{doc_tutorials_command-line-options_md_autotoc_md3712}
...
The C code for this example is located in {\ttfamily examples/opts\+Commands.\+c}.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3713}{}\doxysubsection{Precedence}\label{doc_tutorials_command-line-options_md_autotoc_md3713}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3714}{}\doxysubsection{Limitations}\label{doc_tutorials_command-line-options_md_autotoc_md3714}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3715}{}\doxysection{Help Message}\label{doc_tutorials_command-line-options_md_autotoc_md3715}
...
\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3716}{}\doxysubsection{Structure of the Help Message}\label{doc_tutorials_command-line-options_md_autotoc_md3716}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3719}{}\doxysubsubsection{Custom Usage Line}\label{doc_tutorials_command-line-options_md_autotoc_md3719}
...
Please note, that this will replace the whole usage line including the program name taken from {\ttfamily argv\mbox{[}0\mbox{]}}.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3720}{}\doxysubsubsection{Adding a Prefix Text}\label{doc_tutorials_command-line-options_md_autotoc_md3720}
If you just want to add information above the options list, but not replace the whole usage line, you can do so by adding a prefix text. This can be done by \href{\#manual-help-message}{\texttt{ manually generating the help message}} or by passing the key {\ttfamily /help/prefix} in the {\ttfamily gopts\+Config} Key\+Set. The value of {\ttfamily /help/prefix} will be inserted between the usage line and the options list.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3721}{}\doxysection{Examples}\label{doc_tutorials_command-line-options_md_autotoc_md3721}
The following specification describes a command line interface similar to the one used by {\ttfamily rm}. (It is based of {\ttfamily rm (GNU coreutils) 8.\+30}).
...
\label{_elektra-opts}%
\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3722}{}\doxysection{Advanced Use\+: Calling $<$tt$>$elektra\+Get\+Opts$<$/tt$>$ directly}\label{doc_tutorials_command-line-options_md_autotoc_md3722}
