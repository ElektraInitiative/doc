Running the reformat-\/all script requires multiple dependencies. To overcome this problem, instead of trying to install all the necessary dependencies on your own, you can easily build a Docker image and run the script inside a Docker container based on this image.\hypertarget{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md2777}{}\doxysection{Who Is This Guide For?}\label{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md2777}
Do you want to run the reformat-\/all script easily and without any hassle? You\textquotesingle{}ve come to the right place.

This is a step-\/by-\/step guide. Just follow the steps and you are good to go!\hypertarget{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md2778}{}\doxysection{Prerequisites}\label{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md2778}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md2779}{}\doxysection{What to Begin With?}\label{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md2779}
\hypertarget{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md2780}{}\doxysubsection{1. Build Your Own Docker Image}\label{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md2780}
...
The image tag {\ttfamily buildelektra-\/sid} we suggested can be replaced by a name of your own choosing. Note that currently our {\ttfamily sid} image is the only one with all the necessary tools installed.\hypertarget{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md2781}{}\doxysubsection{2. Run the Docker Container}\label{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md2781}
...
Again, if you changed the image tag {\ttfamily buildelektra-\/sid}, please change it above as well.\hypertarget{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md2782}{}\doxysubsection{3. Running the Script}\label{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md2782}
