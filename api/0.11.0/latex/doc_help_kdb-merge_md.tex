...
\Hypertarget{doc_help_kdb-merge_md_md_doc_help_kdb_merge}%
 \hypertarget{doc_help_kdb-merge_md_autotoc_md2975}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-merge_md_autotoc_md2975}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-merge_md_autotoc_md2976}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-merge_md_autotoc_md2976}
...
\hypertarget{doc_help_kdb-merge_md_autotoc_md2977}{}\doxysection{THREE-\/\+WAY MERGE}\label{doc_help_kdb-merge_md_autotoc_md2977}
...
\hypertarget{doc_help_kdb-merge_md_autotoc_md2978}{}\doxysection{CONFLICTS}\label{doc_help_kdb-merge_md_autotoc_md2978}
Conflicts occur when a Key has a different value in all three Key\+Sets.~\newline
 Conflicts in a merge can be resolved using a \href{\#STRATEGIES}{\texttt{ strategy}} with the {\ttfamily -\/s} option. To interactively resolve conflicts, use the {\ttfamily -\/i} option.\hypertarget{doc_help_kdb-merge_md_autotoc_md2979}{}\doxysection{OPTIONS}\label{doc_help_kdb-merge_md_autotoc_md2979}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-merge_md_autotoc_md2980}{}\doxysection{RETURN VALUE}\label{doc_help_kdb-merge_md_autotoc_md2980}

\begin{DoxyItemize}
\item 0\+: Successful.
\item 11\+: A conflict occurred during the merge.
\end{DoxyItemize}\hypertarget{doc_help_kdb-merge_md_autotoc_md2981}{}\doxysection{EXAMPLES}\label{doc_help_kdb-merge_md_autotoc_md2981}
...
\hypertarget{doc_help_kdb-merge_md_autotoc_md2982}{}\doxysection{SEE ALSO}\label{doc_help_kdb-merge_md_autotoc_md2982}
