...
\item {\ttfamily fcrypt}.
\end{DoxyEnumerate}\hypertarget{doc_tutorials_crypto_md_autotoc_md4245}{}\doxysection{Prerequisites -\/ Gnu\+PG}\label{doc_tutorials_crypto_md_autotoc_md4245}
...
The {\ttfamily fcrypt} plugin and the {\ttfamily crypto} plugin support both versions (version 1 and version 2) of GPG.\hypertarget{doc_tutorials_crypto_md_autotoc_md4246}{}\doxysection{Introduction}\label{doc_tutorials_crypto_md_autotoc_md4246}
...
We also show how to approach integrity with the signature features of the {\ttfamily fcrypt} plugin.\hypertarget{doc_tutorials_crypto_md_autotoc_md4247}{}\doxysection{Configuration File Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md4247}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md4248}{}\doxysection{Configuration File Signatures}\label{doc_tutorials_crypto_md_autotoc_md4248}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md4249}{}\doxysubsection{Combining Signatures and Encryption}\label{doc_tutorials_crypto_md_autotoc_md4249}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md4250}{}\doxysection{Configuration Value Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md4250}
...
As a result you get \char`\"{}1234\char`\"{}.\hypertarget{doc_tutorials_crypto_md_autotoc_md4252}{}\doxysubsection{Disabling Encryption}\label{doc_tutorials_crypto_md_autotoc_md4252}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md4253}{}\doxysubsection{Complete Example}\label{doc_tutorials_crypto_md_autotoc_md4253}
The complete example looks like this\+:
