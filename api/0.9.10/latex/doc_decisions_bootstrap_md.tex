...
\Hypertarget{doc_decisions_bootstrap_md_md_doc_decisions_bootstrap}%
 \hypertarget{doc_decisions_bootstrap_md_autotoc_md1690}{}\doxysection{Problem}\label{doc_decisions_bootstrap_md_autotoc_md1690}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1691}{}\doxysection{Constraints}\label{doc_decisions_bootstrap_md_autotoc_md1691}

\begin{DoxyItemize}
\item Bootstrap should be fast and not unnecessarily read large files
\end{DoxyItemize}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1692}{}\doxysection{Assumptions}\label{doc_decisions_bootstrap_md_autotoc_md1692}
\hypertarget{doc_decisions_bootstrap_md_autotoc_md1693}{}\doxysection{Considered Alternatives}\label{doc_decisions_bootstrap_md_autotoc_md1693}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1694}{}\doxysection{Decision}\label{doc_decisions_bootstrap_md_autotoc_md1694}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1695}{}\doxysection{Rationale}\label{doc_decisions_bootstrap_md_autotoc_md1695}
\hypertarget{doc_decisions_bootstrap_md_autotoc_md1696}{}\doxysection{Implications}\label{doc_decisions_bootstrap_md_autotoc_md1696}
\hypertarget{doc_decisions_bootstrap_md_autotoc_md1697}{}\doxysection{Related Decisions}\label{doc_decisions_bootstrap_md_autotoc_md1697}
\hypertarget{doc_decisions_bootstrap_md_autotoc_md1698}{}\doxysection{Notes}\label{doc_decisions_bootstrap_md_autotoc_md1698}
