...
This is because {\ttfamily ld} tries to link {\ttfamily /usr/lib/libaugeas.so.\+0} which is an older version of Augeas. Simply add the path to the newer library to your ld search paths (consult your system documentation on how to do this).\hypertarget{md_src_plugins_augeas_README_autotoc_md53}{}\doxysection{Mounting and Configuration}\label{md_src_plugins_augeas_README_autotoc_md53}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_augeas_README_autotoc_md54}{}\doxysection{Restrictions}\label{md_src_plugins_augeas_README_autotoc_md54}
\hypertarget{md_src_plugins_augeas_README_autotoc_md55}{}\doxysubsection{Inner Node Values}\label{md_src_plugins_augeas_README_autotoc_md55}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_augeas_README_autotoc_md56}{}\doxysubsection{Leaky Abstraction of Order}\label{md_src_plugins_augeas_README_autotoc_md56}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_augeas_README_autotoc_md57}{}\doxysection{Planned Improvements}\label{md_src_plugins_augeas_README_autotoc_md57}
