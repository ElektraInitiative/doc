...
Helpers for creating plugins. Make sure to include kdberrors.\-h before including this file if you want warnings/errors to be added.

Proper usage\-: 
\begin{DoxyCode}
\textcolor{keyword}{using namespace }ckdb;
