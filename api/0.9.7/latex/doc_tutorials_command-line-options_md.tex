...
\Hypertarget{doc_tutorials_command-line-options_md_md_doc_tutorials_command_line_options}%
 \hypertarget{doc_tutorials_command-line-options_md_autotoc_md3531}{}\doxysection{Introduction}\label{doc_tutorials_command-line-options_md_autotoc_md3531}
...
The last parameter {\ttfamily gopts\+Config} can be used to provide additional configuration values to {\ttfamily gopts}. For example, this can be used to configure the auto-\/generated help message. The keys that {\ttfamily gopts} accepts in this Key\+Set will be explained throughout the document . A full list can be found in the \mbox{\hyperlink{md_src_plugins_gopts_README_src_plugins_gopts_README_md}{\`{}gopts\`{} README}}.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3533}{}\doxysection{Specification}\label{doc_tutorials_command-line-options_md_autotoc_md3533}
This section describes the specification used by the command-\/line option and environment variable parser.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3534}{}\doxysubsection{Options}\label{doc_tutorials_command-line-options_md_autotoc_md3534}
...
While you can specify multiple options (or environment variables, see below) for a single key, only one of them can be used at the same time. Using two or more options (or variables) that are all linked to the same key, will result in an error.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3535}{}\doxysubsubsection{Option Arguments}\label{doc_tutorials_command-line-options_md_autotoc_md3535}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3536}{}\doxysubsection{Environment Variables}\label{doc_tutorials_command-line-options_md_autotoc_md3536}
Elektra also supports parsing environment variables in a similar manner. For these there are however, less configuration options. You can simply specify one or more environment variables for a key using the {\ttfamily env} metakey (or {\ttfamily env/\#} meta-\/array for multiple).\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3537}{}\doxysubsection{Arrays}\label{doc_tutorials_command-line-options_md_autotoc_md3537}
...
Environment variables obviously cannot be repeated, instead a behavior similar that used for PATH is adopted. On Windows the variable will be split at each \textquotesingle{};\textquotesingle{} character. On all other systems \textquotesingle{}\+:\textquotesingle{} is used as a separator.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3538}{}\doxysubsection{Parameter Arguments}\label{doc_tutorials_command-line-options_md_autotoc_md3538}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3540}{}\doxysubsection{Sub-\/\+Commands}\label{doc_tutorials_command-line-options_md_autotoc_md3540}
...
The C code for this example is located in {\ttfamily examples/opts\+Commands.\+c}.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3541}{}\doxysubsection{Precedence}\label{doc_tutorials_command-line-options_md_autotoc_md3541}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3542}{}\doxysubsection{Limitations}\label{doc_tutorials_command-line-options_md_autotoc_md3542}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3543}{}\doxysection{Help Message}\label{doc_tutorials_command-line-options_md_autotoc_md3543}
...
\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3544}{}\doxysubsection{Structure of the Help Message}\label{doc_tutorials_command-line-options_md_autotoc_md3544}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3547}{}\doxysubsubsection{Custom Usage Line}\label{doc_tutorials_command-line-options_md_autotoc_md3547}
...
Please note, that this will replace the whole usage line including the program name taken from {\ttfamily argv\mbox{[}0\mbox{]}}.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3548}{}\doxysubsubsection{Adding a Prefix Text}\label{doc_tutorials_command-line-options_md_autotoc_md3548}
If you just want to add information above the options list, but not replace the whole usage line, you can do so by adding a prefix text. This can be done by \href{\#manual-help-message}{\texttt{ manually generating the help message}} or by passing the key {\ttfamily /help/prefix} in the {\ttfamily gopts\+Config} Key\+Set. The value of {\ttfamily /help/prefix} will be inserted between the usage line and the options list.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3549}{}\doxysection{Examples}\label{doc_tutorials_command-line-options_md_autotoc_md3549}
...
\label{_elektra-opts}%
\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3550}{}\doxysection{Advanced Use\+: Calling $<$tt$>$elektra\+Get\+Opts$<$/tt$>$ directly}\label{doc_tutorials_command-line-options_md_autotoc_md3550}
