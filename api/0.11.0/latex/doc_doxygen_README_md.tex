...
When referencing Markdown files, the links between them will be resolved with the \mbox{\hyperlink{doc_markdownlinkconverter_README_md}{Markdown Link Converter}}.\hypertarget{doc_doxygen_README_md_autotoc_md2728}{}\doxysection{Usage}\label{doc_doxygen_README_md_autotoc_md2728}
...
Elektra\textquotesingle{}s Doxyfile is located at {\ttfamily $<$PROJECT\+\_\+\+ROOT$>$/doc/\+Doxyfile}. This file is used for the configuration of the whole documentation generation process. The documentation for the Doxyfile can either be found within the file or at the \href{https://www.doxygen.nl/manual/config.html}{\texttt{ Doxygen Website}}.\hypertarget{doc_doxygen_README_md_autotoc_md2729}{}\doxysection{Mermaid JS}\label{doc_doxygen_README_md_autotoc_md2729}
...
For further information on Mermaid JS and Doxygen, \href{https://github.com/tttapa/doxygen-mermaid}{\texttt{ this tutorial}} had been used to include Mermaid JS.\hypertarget{doc_doxygen_README_md_autotoc_md2730}{}\doxysection{Working Locally}\label{doc_doxygen_README_md_autotoc_md2730}
