\hypertarget{doc_tutorials_language-bindings_md_autotoc_md2690}{}\doxysection{Introduction}\label{doc_tutorials_language-bindings_md_autotoc_md2690}
In this section, we will explain the how to write a language binding for Elektra.\hypertarget{doc_tutorials_language-bindings_md_autotoc_md2691}{}\doxysubsection{High-\/level A\+PI}\label{doc_tutorials_language-bindings_md_autotoc_md2691}
Writing bindings for the high-\/level A\+PI is described in a \mbox{\hyperlink{doc_tutorials_highlevel-bindings_md}{different document}}, since it is a bit less straightforward and needs additional considerations.\hypertarget{doc_tutorials_language-bindings_md_autotoc_md2692}{}\doxysection{T\+O\+DO}\label{doc_tutorials_language-bindings_md_autotoc_md2692}
...
\end{DoxyEnumerate}
\end{DoxyEnumerate}\hypertarget{doc_tutorials_language-bindings_md_autotoc_md2693}{}\doxysection{C\+Make Integration}\label{doc_tutorials_language-bindings_md_autotoc_md2693}
\hypertarget{doc_tutorials_language-bindings_md_autotoc_md2694}{}\doxysubsection{Building}\label{doc_tutorials_language-bindings_md_autotoc_md2694}
...
If, for example, our bindings only support linking against a dynamic library we can express that, by using the {\ttfamily B\+U\+I\+L\+D\+\_\+$\ast$} variables in if blocks or by passing {\ttfamily O\+N\+L\+Y\+\_\+\+S\+H\+A\+R\+ED} to {\ttfamily add\+\_\+binding}. You can read more in the \mbox{\hyperlink{doc_COMPILE_md}{compile doc}}.
...
We can then explicitly include the bindings using {\ttfamily cmake -\/D\+B\+I\+N\+D\+I\+N\+GS=\char`\"{}our\+\_\+binding\char`\"{} ..} in the build directory and follow the further steps for \mbox{\hyperlink{doc_COMPILE_md}{compilation}}.\hypertarget{doc_tutorials_language-bindings_md_autotoc_md2695}{}\doxysubsection{Testing}\label{doc_tutorials_language-bindings_md_autotoc_md2695}
...
See the Java binding for examples.\hypertarget{doc_tutorials_language-bindings_md_autotoc_md2696}{}\doxysection{Error Handling}\label{doc_tutorials_language-bindings_md_autotoc_md2696}
...
If you have a language which does not support inheritance this way like Go\+Lang, you can still use the error code itself since the hierarchy is integrated in it. For example you can check if the code starts with {\ttfamily C01...} to catch all {\ttfamily Permanent Errors}.\hypertarget{doc_tutorials_language-bindings_md_autotoc_md2697}{}\doxysubsection{Error Message}\label{doc_tutorials_language-bindings_md_autotoc_md2697}
