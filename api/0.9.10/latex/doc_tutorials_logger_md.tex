...
\Hypertarget{doc_tutorials_logger_md_md_doc_tutorials_logger}%
 \hypertarget{doc_tutorials_logger_md_autotoc_md3878}{}\doxysection{Quickstart}\label{doc_tutorials_logger_md_autotoc_md3878}
...
The file sink behaves like syslog, if it has been enabled (see below).\hypertarget{doc_tutorials_logger_md_autotoc_md3879}{}\doxysection{Step by Step Guide}\label{doc_tutorials_logger_md_autotoc_md3879}
\hypertarget{doc_tutorials_logger_md_autotoc_md3880}{}\doxysubsection{Preparation}\label{doc_tutorials_logger_md_autotoc_md3880}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md3881}{}\doxysubsubsection{Log Everything}\label{doc_tutorials_logger_md_autotoc_md3881}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md3882}{}\doxysubsubsection{File Specific Logging}\label{doc_tutorials_logger_md_autotoc_md3882}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md3883}{}\doxysubsection{Enabling and Disabling Sinks}\label{doc_tutorials_logger_md_autotoc_md3883}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md3884}{}\doxysubsection{Compilation}\label{doc_tutorials_logger_md_autotoc_md3884}

\begin{DoxyEnumerate}
\item Enable the logger\+: e.\+g. run {\ttfamily cmake} with the switch {\ttfamily -\/DENABLE\+\_\+\+LOGGER=ON}
\item Build Elektra
\end{DoxyEnumerate}\hypertarget{doc_tutorials_logger_md_autotoc_md3885}{}\doxysection{Log Levels}\label{doc_tutorials_logger_md_autotoc_md3885}
