...
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md651}{}\doxysubsection{Introduction}\label{md_src_plugins_yamlcpp_README_autotoc_md651}
The YAML CPP plugin reads and writes configuration data via the \href{https://github.com/jbeder/yaml-cpp}{\texttt{ yaml-\/cpp}} library.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md652}{}\doxysubsection{Installation}\label{md_src_plugins_yamlcpp_README_autotoc_md652}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/yamlcpp}.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md653}{}\doxysubsection{Usage}\label{md_src_plugins_yamlcpp_README_autotoc_md653}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md654}{}\doxysubsection{Arrays}\label{md_src_plugins_yamlcpp_README_autotoc_md654}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md655}{}\doxysubsubsection{Nested Arrays}\label{md_src_plugins_yamlcpp_README_autotoc_md655}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md656}{}\doxysubsubsection{Sparse Arrays}\label{md_src_plugins_yamlcpp_README_autotoc_md656}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md657}{}\doxysubsection{Metadata}\label{md_src_plugins_yamlcpp_README_autotoc_md657}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md658}{}\doxysubsection{Binary Data}\label{md_src_plugins_yamlcpp_README_autotoc_md658}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md659}{}\doxysubsection{Empty}\label{md_src_plugins_yamlcpp_README_autotoc_md659}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md660}{}\doxysubsection{Binary Values}\label{md_src_plugins_yamlcpp_README_autotoc_md660}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md661}{}\doxysubsection{Dependencies}\label{md_src_plugins_yamlcpp_README_autotoc_md661}
This plugin requires \href{https://github.com/jbeder/yaml-cpp}{\texttt{ yaml-\/cpp}}. On a Debian based OS the package for the library is called \href{https://packages.debian.org/libyaml-cpp-dev}{\texttt{ {\ttfamily libyaml-\/cpp-\/dev}}}. On mac\+OS you can install the package \href{https://repology.org/project/yaml-cpp}{\texttt{ {\ttfamily yaml-\/cpp}}} via \href{https://brew.sh}{\texttt{ Home\+Brew}}.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md662}{}\doxysubsection{Limitations}\label{md_src_plugins_yamlcpp_README_autotoc_md662}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md663}{}\doxysubsubsection{Leaf Values}\label{md_src_plugins_yamlcpp_README_autotoc_md663}
...
. However, if we use this approach we are not able to support Elektra’s array type properly.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md664}{}\doxyparagraph{Directory Values}\label{md_src_plugins_yamlcpp_README_autotoc_md664}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md665}{}\doxysubsubsection{Special Values}\label{md_src_plugins_yamlcpp_README_autotoc_md665}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md666}{}\doxysubsubsection{Other Limitations}\label{md_src_plugins_yamlcpp_README_autotoc_md666}
