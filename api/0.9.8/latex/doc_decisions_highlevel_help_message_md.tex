...
\Hypertarget{doc_decisions_highlevel_help_message_md_md_doc_decisions_highlevel_help_message}%
 This decision {\itshape does not} assume code-\/generation is used. For the case of code-\/generation see the \href{\#notes}{\texttt{ Notes}} section.\hypertarget{doc_decisions_highlevel_help_message_md_autotoc_md1871}{}\doxysection{Problem}\label{doc_decisions_highlevel_help_message_md_autotoc_md1871}
We want to allow to print the help message no matter what errors happened in {\ttfamily kdb\+Open} or {\ttfamily kdb\+Get}.\hypertarget{doc_decisions_highlevel_help_message_md_autotoc_md1872}{}\doxysection{Constraints}\label{doc_decisions_highlevel_help_message_md_autotoc_md1872}
...
\end{DoxyItemize}\hypertarget{doc_decisions_highlevel_help_message_md_autotoc_md1873}{}\doxysection{Assumptions}\label{doc_decisions_highlevel_help_message_md_autotoc_md1873}
...
\end{DoxyItemize}\hypertarget{doc_decisions_highlevel_help_message_md_autotoc_md1874}{}\doxysection{Considered Alternatives}\label{doc_decisions_highlevel_help_message_md_autotoc_md1874}
...
\end{DoxyItemize}\hypertarget{doc_decisions_highlevel_help_message_md_autotoc_md1875}{}\doxysection{Decision}\label{doc_decisions_highlevel_help_message_md_autotoc_md1875}
Ignore missing {\ttfamily require}d keys (in help mode), but fail for every other error.\hypertarget{doc_decisions_highlevel_help_message_md_autotoc_md1876}{}\doxysection{Rationale}\label{doc_decisions_highlevel_help_message_md_autotoc_md1876}
...
In any case after this the user definitely know how to interact with the KDB. Since we assumed that there won\textquotesingle{}t be any errors before the KDB was changed, we can assume that the user caused other errors by changing the KDB.\hypertarget{doc_decisions_highlevel_help_message_md_autotoc_md1877}{}\doxysection{Notes}\label{doc_decisions_highlevel_help_message_md_autotoc_md1877}
