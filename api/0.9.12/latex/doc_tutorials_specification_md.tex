...
\Hypertarget{doc_tutorials_specification_md_md_doc_tutorials_specification}%
 \hypertarget{doc_tutorials_specification_md_autotoc_md4422}{}\doxysection{Overview}\label{doc_tutorials_specification_md_autotoc_md4422}
\hypertarget{doc_tutorials_specification_md_autotoc_md4423}{}\doxysubsection{Introduction}\label{doc_tutorials_specification_md_autotoc_md4423}
In this tutorial you will learn how to interactively use the {\ttfamily Spec\+Elektra} specification language and {\ttfamily kdb} to write a configuration specification for an example application.\hypertarget{doc_tutorials_specification_md_autotoc_md4424}{}\doxysubsection{What you should already know}\label{doc_tutorials_specification_md_autotoc_md4424}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md4425}{}\doxysubsection{What you’ll learn}\label{doc_tutorials_specification_md_autotoc_md4425}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md4426}{}\doxysubsection{What you\textquotesingle{}ll do}\label{doc_tutorials_specification_md_autotoc_md4426}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md4427}{}\doxysection{Example App Overview}\label{doc_tutorials_specification_md_autotoc_md4427}
...
\item a backup date
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md4428}{}\doxysection{Getting Started}\label{doc_tutorials_specification_md_autotoc_md4428}
...
Otherwise refer to the \href{https://www.libelektra.org/getstarted/guide}{\texttt{ getting started guide}} to install it.\hypertarget{doc_tutorials_specification_md_autotoc_md4429}{}\doxysection{Mounting the Specification}\label{doc_tutorials_specification_md_autotoc_md4429}
\hypertarget{doc_tutorials_specification_md_autotoc_md4430}{}\doxysubsection{Step 1\+: Mount a Specification File}\label{doc_tutorials_specification_md_autotoc_md4430}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md4431}{}\doxysubsection{Step 2\+: Define a mountpoint}\label{doc_tutorials_specification_md_autotoc_md4431}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md4432}{}\doxysubsection{Step 3\+: Do a specification mount}\label{doc_tutorials_specification_md_autotoc_md4432}
...
For more information about namespaces in Elektra please see \href{https://www.libelektra.org/man-pages/elektra-namespaces}{\texttt{ here}}, a tutorial about the topic is available \href{https://www.libelektra.org/tutorials/namespaces}{\texttt{ here}}.\hypertarget{doc_tutorials_specification_md_autotoc_md4433}{}\doxysection{Adding your first key to the specification}\label{doc_tutorials_specification_md_autotoc_md4433}
\hypertarget{doc_tutorials_specification_md_autotoc_md4434}{}\doxysubsection{Step 1\+: Adding the server port}\label{doc_tutorials_specification_md_autotoc_md4434}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md4435}{}\doxysubsection{Step 2\+: Adding more metadata}\label{doc_tutorials_specification_md_autotoc_md4435}
...
In this example, the {\ttfamily network} plugin and the {\ttfamily type} plugin are emitting warnings or errors, because the valid ranges for {\ttfamily port} and {\ttfamily unsigned\+\_\+short} are the same.\hypertarget{doc_tutorials_specification_md_autotoc_md4436}{}\doxysubsection{Step 3\+: Adding boolean keys}\label{doc_tutorials_specification_md_autotoc_md4436}
...
You can read more about this in the documentation for the \href{https://www.libelektra.org/plugins/type\#normalization}{\texttt{ type plugin}}.\hypertarget{doc_tutorials_specification_md_autotoc_md4437}{}\doxysection{Adding the database keys to the specification}\label{doc_tutorials_specification_md_autotoc_md4437}
\hypertarget{doc_tutorials_specification_md_autotoc_md4438}{}\doxysubsection{Step 1\+: Adding the database ip}\label{doc_tutorials_specification_md_autotoc_md4438}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md4439}{}\doxysubsection{Step 2\+: Adding the database dialect}\label{doc_tutorials_specification_md_autotoc_md4439}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md4440}{}\doxysection{Adding the backup date}\label{doc_tutorials_specification_md_autotoc_md4440}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md4441}{}\doxysection{Final specification code}\label{doc_tutorials_specification_md_autotoc_md4441}
...
\hypertarget{doc_tutorials_specification_md_autotoc_md4442}{}\doxysection{Using the specification}\label{doc_tutorials_specification_md_autotoc_md4442}
...
Please note that also in these examples, the file referred to by the absolute path {\ttfamily /etc/spec.ni} is a {\bfseries{new file}} where the content of the file {\ttfamily ./spec.ni} in the working directory gets imported or copied to.\hypertarget{doc_tutorials_specification_md_autotoc_md4443}{}\doxysection{Cleanup}\label{doc_tutorials_specification_md_autotoc_md4443}
...
In case something went wrong and you want to reset the whole content of your kdb, please refer to \href{https://www.libelektra.org/man-pages/kdb-reset}{\texttt{ the man page of kdb reset}}.\hypertarget{doc_tutorials_specification_md_autotoc_md4444}{}\doxysection{Summary}\label{doc_tutorials_specification_md_autotoc_md4444}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md4445}{}\doxysection{Learn more}\label{doc_tutorials_specification_md_autotoc_md4445}
