...
\Hypertarget{doc_tutorials_logger_md_md_doc_tutorials_logger}%
 \hypertarget{doc_tutorials_logger_md_autotoc_md4358}{}\doxysection{Quickstart}\label{doc_tutorials_logger_md_autotoc_md4358}
...
The file sink behaves like syslog, if it has been enabled (see below).\hypertarget{doc_tutorials_logger_md_autotoc_md4359}{}\doxysection{Step by Step Guide}\label{doc_tutorials_logger_md_autotoc_md4359}
\hypertarget{doc_tutorials_logger_md_autotoc_md4360}{}\doxysubsection{Preparation}\label{doc_tutorials_logger_md_autotoc_md4360}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md4361}{}\doxysubsubsection{Log Everything}\label{doc_tutorials_logger_md_autotoc_md4361}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md4362}{}\doxysubsubsection{File Specific Logging}\label{doc_tutorials_logger_md_autotoc_md4362}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md4363}{}\doxysubsection{Enabling and Disabling Sinks}\label{doc_tutorials_logger_md_autotoc_md4363}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md4364}{}\doxysubsection{Compilation}\label{doc_tutorials_logger_md_autotoc_md4364}

\begin{DoxyEnumerate}
\item Enable the logger\+: e.\+g. run {\ttfamily cmake} with the switch {\ttfamily -\/DENABLE\+\_\+\+LOGGER=ON}
\item Build Elektra
\end{DoxyEnumerate}\hypertarget{doc_tutorials_logger_md_autotoc_md4365}{}\doxysection{Log Levels}\label{doc_tutorials_logger_md_autotoc_md4365}
