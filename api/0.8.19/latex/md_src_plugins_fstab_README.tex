...
So if you get the filesystems and change the type of the filesystem of the rootfs and set it again the resulting fstab will be like\+: \begin{DoxyVerb}/dev/sda6       /               ext3>----   >----defaults,errors=remount-ro 0 1
