...
\Hypertarget{doc_help_kdb-import_md_md_doc_help_kdb_import}%
 \hypertarget{doc_help_kdb-import_md_autotoc_md2551}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-import_md_autotoc_md2551}
{\ttfamily kdb import $<$destination$>$ \mbox{[}$<$format$>$\mbox{]}}

Where {\ttfamily destination} is the destination where the user wants the keys to be imported into. {\ttfamily format} is the format of the keys that are imported.\hypertarget{doc_help_kdb-import_md_autotoc_md2552}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-import_md_autotoc_md2552}
...
This command allows a user to import an existing configuration into the key database. The configuration that the user wants to import is read from {\ttfamily stdin}. The user should specify the format that the current configuration or keys are in, otherwise the default format will be used. The default format is {\ttfamily storage} but can be changed by editing the value of the {\ttfamily /sw/elektra/kdb/\#0/current/format} key. The {\ttfamily storage} plugin can be configured at compile-\/time or changed by the link {\ttfamily libelektra-\/storage.\+so}.\hypertarget{doc_help_kdb-import_md_autotoc_md2553}{}\doxysection{CONFLICTS}\label{doc_help_kdb-import_md_autotoc_md2553}
...
The strategies implemented by the merge framework are documented in \mbox{\hyperlink{doc_help_elektra-merge-strategy_md}{elektra-\/merge-\/strategy(7)}}.\hypertarget{doc_help_kdb-import_md_autotoc_md2554}{}\doxysection{OPTIONS}\label{doc_help_kdb-import_md_autotoc_md2554}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-import_md_autotoc_md2555}{}\doxysection{KDB}\label{doc_help_kdb-import_md_autotoc_md2555}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-import_md_autotoc_md2556}{}\doxysection{EXAMPLES}\label{doc_help_kdb-import_md_autotoc_md2556}
...
\end{DoxyCode}
\hypertarget{doc_help_kdb-import_md_autotoc_md2557}{}\doxysection{SEE ALSO}\label{doc_help_kdb-import_md_autotoc_md2557}
