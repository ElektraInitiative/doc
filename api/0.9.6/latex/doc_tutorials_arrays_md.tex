...
\Hypertarget{doc_tutorials_arrays_md_md_doc_tutorials_arrays}%
 \hypertarget{doc_tutorials_arrays_md_autotoc_md3415}{}\doxysection{Key-\/\+Value Pairs}\label{doc_tutorials_arrays_md_autotoc_md3415}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md3416}{}\doxysection{Array Keys}\label{doc_tutorials_arrays_md_autotoc_md3416}
Since Elektra sorts keys alphabetically we can use the key-\/value pair structure described above to store sequences of values (aka. arrays).\hypertarget{doc_tutorials_arrays_md_autotoc_md3417}{}\doxysubsection{Empty Arrays}\label{doc_tutorials_arrays_md_autotoc_md3417}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md3418}{}\doxysubsection{Array Elements}\label{doc_tutorials_arrays_md_autotoc_md3418}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md3419}{}\doxysubsection{Metadata}\label{doc_tutorials_arrays_md_autotoc_md3419}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md3420}{}\doxysection{Closing Remarks}\label{doc_tutorials_arrays_md_autotoc_md3420}
