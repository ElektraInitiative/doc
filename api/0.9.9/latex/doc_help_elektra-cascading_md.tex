...
Thus when a key starts with {\ttfamily /} such cascading will automatically be performed.\hypertarget{doc_help_elektra-cascading_md_autotoc_md2346}{}\doxysection{SPEC}\label{doc_help_elektra-cascading_md_autotoc_md2346}
...
\end{DoxyCode}
\hypertarget{doc_help_elektra-cascading_md_autotoc_md2347}{}\doxysection{CASCADING}\label{doc_help_elektra-cascading_md_autotoc_md2347}
