...
See \href{https://libelektra.org}{\texttt{ https\+://libelektra.\+org}}\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md3328}{}\doxysection{Overview}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md3328}
...
\item the spec mount.
\end{DoxyEnumerate}\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md3330}{}\doxysection{Spec Plugin}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md3330}
...
But we want {\ttfamily check/type} to be not only a documentation, but also enforced.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md3331}{}\doxysection{Spec Mount}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md3331}
...
The main idea of the spec-\/mount is\+: search a plugin for every specification (metadata) found in the spec-\/namespace.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md3332}{}\doxysection{General Mount Improvements}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md3332}
...
Thanks to Manuel Mausz for fixing many bugs related to the library split and also adapting all the bindings for it.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md3334}{}\doxysubsection{Benchmark}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md3334}
...
{\ttfamily libelektra.\+so} is still present for compatibility reasons. It should not be used for new applications. Some unimportant parts, however, moved to the \char`\"{}sugar\char`\"{} libraries. E.\+g. the symbol {\ttfamily elektra\+Key\+Cut\+Name\+Part} is no longer part of {\ttfamily libelektra.\+so}.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md3336}{}\doxysubsection{Bootstrapping}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md3336}
...
\href{https://github.com/ElektraInitiative/libelektra/blob/master/doc/decisions/bootstrap.md}{\texttt{ Details are here}}\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md3337}{}\doxysection{Plugins}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md3337}
...
Larger changes were done in the following plugins\+:\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md3338}{}\doxysubsection{INI}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md3338}
...
A huge thanks to Thomas Waser.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md3339}{}\doxysubsection{Rename}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md3339}
Thanks to Thomas Waser {\ttfamily rename} is now fixed for cascading keys. Additionally, it does not change the {\ttfamily sync} status of the keys so that notification plugins work properly afterwards.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md3340}{}\doxysubsection{Crypto}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md3340}
...
Thanks to Peter Nirschl, especially the patience for also supporting different platforms where dependencies need to be handled differently.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md3341}{}\doxysection{KDB}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md3341}
...
\end{DoxyItemize}\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md3343}{}\doxysection{C++11 migration}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md3343}
...
If you haven\textquotesingle{}t removed it from your flags already, there is no use anymore to set {\ttfamily ENABLE\+\_\+\+CXX11}.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md3344}{}\doxysection{Documentation}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md3344}
...
\end{DoxyItemize}\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md3346}{}\doxysection{Packaging and Build System}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md3346}
...
Read about \href{https://github.com/ElektraInitiative/libelektra\#packages}{\texttt{ other packages here}}.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md3347}{}\doxysection{Fixes and Improvements}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md3347}
...
\end{DoxyItemize}\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md3348}{}\doxysection{Get It!}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md3348}
...
already built API documentation can be found \href{https://doc.libelektra.org/api/0.8.15/html/}{\texttt{ here}}\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md3349}{}\doxysection{Stay tuned!}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md3349}
