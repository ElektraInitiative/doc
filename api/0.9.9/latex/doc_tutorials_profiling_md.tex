...
\Hypertarget{doc_tutorials_profiling_md_md_doc_tutorials_profiling}%
 \hypertarget{doc_tutorials_profiling_md_autotoc_md3884}{}\doxysection{Execution Time}\label{doc_tutorials_profiling_md_autotoc_md3884}
...
\end{DoxyEnumerate}\hypertarget{doc_tutorials_profiling_md_autotoc_md3885}{}\doxysubsection{Callgrind}\label{doc_tutorials_profiling_md_autotoc_md3885}
\hypertarget{doc_tutorials_profiling_md_autotoc_md3886}{}\doxysubsubsection{Choosing the Correct Build Type}\label{doc_tutorials_profiling_md_autotoc_md3886}
...
. We use {\ttfamily Debug} here, which should provide the most detailed profiling information.\hypertarget{doc_tutorials_profiling_md_autotoc_md3887}{}\doxysubsubsection{Disabling $<$tt$>$dlclose$<$/tt$>$ Calls}\label{doc_tutorials_profiling_md_autotoc_md3887}
...
. An unfortunate effect of this code update is that Elektra will now leak memory when it unloads a plugin. On the other hand, Callgrind will be able to add source code information about the \mbox{\hyperlink{md_src_plugins_yajl_README}{YAJL}} plugin to the profiling output.\hypertarget{doc_tutorials_profiling_md_autotoc_md3888}{}\doxysubsubsection{Building Elektra}\label{doc_tutorials_profiling_md_autotoc_md3888}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_profiling_md_autotoc_md3889}{}\doxysubsubsection{Profiling the Code}\label{doc_tutorials_profiling_md_autotoc_md3889}
...
. You can now select different parts of the call graph on the left to check which parts of the code take a long time to execute.\hypertarget{doc_tutorials_profiling_md_autotoc_md3890}{}\doxysubsection{XRay}\label{doc_tutorials_profiling_md_autotoc_md3890}
\href{https://llvm.org/docs/XRay.html}{\texttt{ XRay}} is an extension for LLVM that adds profiling code to binaries. Profiling can be dynamically enabled and disabled via the environment variable {\ttfamily XRAY\+\_\+\+OPTIONS}.\hypertarget{doc_tutorials_profiling_md_autotoc_md3891}{}\doxysubsubsection{Choosing the Correct Build Type}\label{doc_tutorials_profiling_md_autotoc_md3891}
