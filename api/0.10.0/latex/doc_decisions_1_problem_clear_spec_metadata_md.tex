...
\Hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_md_doc_decisions_1_problem_clear_spec_metadata}%
 \hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1953}{}\doxysection{Problem}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1953}
...
If metadata is merged from different namespaces, e.\+g., {\ttfamily spec\+:} and {\ttfamily user\+:}; metadata from one namespace might end up in keys of other namespaces, e.\+g.; metadata from {\ttfamily spec\+:} might end up in {\ttfamily user\+:}.\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1954}{}\doxysection{Constraints}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1954}
...
\end{DoxyItemize}\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1955}{}\doxysection{Assumptions}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1955}

\begin{DoxyItemize}
\item Metadata can always safely merged from {\ttfamily spec\+:/} to other namespace.
\end{DoxyItemize}\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1956}{}\doxysection{Considered Alternatives}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1956}
...
\end{DoxyItemize}\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1957}{}\doxysection{Decision}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1957}
...
The {\ttfamily kdb mount} tool will add the {\ttfamily meta} plugin configuration when mounting a storage plugin to {\ttfamily spec\+:/}.\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1958}{}\doxysection{Rationale}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1958}
...
\end{DoxyItemize}\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1959}{}\doxysection{Implications}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1959}
...
\end{DoxyItemize}\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1960}{}\doxysection{Related Decisions}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1960}
...
\end{DoxyItemize}\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1961}{}\doxysection{Notes}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1961}
