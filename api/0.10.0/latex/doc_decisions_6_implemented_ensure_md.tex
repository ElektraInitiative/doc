\label{doc_decisions_6_implemented_ensure_md_md_doc_decisions_6_implemented_ensure}%
\Hypertarget{doc_decisions_6_implemented_ensure_md_md_doc_decisions_6_implemented_ensure}%
 \hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2342}{}\doxysection{Problem}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2342}
Applications want to ensure that some functionality (hooks) is present in Elektra.\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2343}{}\doxysection{Constraints}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2343}
\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2344}{}\doxysection{Assumptions}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2344}
\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2345}{}\doxysection{Considered Alternatives}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2345}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2346}{}\doxysection{Decision}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2346}
Integrate {\ttfamily kdb\+Ensure} in {\ttfamily kdb\+Open(\+Key $\ast$error\+Key, Key\+Set $\ast$contract)} but only allow hooks.\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2347}{}\doxysection{Rationale}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2347}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2348}{}\doxysection{Implications}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2348}
...
It is safe to use the contract {\ttfamily Key\+Set} also for {\ttfamily kdb\+Get} and {\ttfamily kdb\+Set} invocations. Contract {\ttfamily Key\+Set}s only contain {\ttfamily Key}s below {\ttfamily system\+:/elektra/contract}. Therefore, normal {\ttfamily Key\+Set}s should not interfere.\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2349}{}\doxysection{Related Decisions}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2349}

\begin{DoxyItemize}
\item \mbox{\hyperlink{doc_decisions_5_partially_implemented_hooks_md}{Hooks}}
\item \mbox{\hyperlink{doc_decisions_0_drafts_notifications_md}{Notifications}}
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2350}{}\doxysection{Notes}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2350}

\begin{DoxyItemize}
\item Issue \href{https://issues.libelektra.org/2764}{\texttt{ \#2764}}
\item Implemented in \href{https://pull.libelektra.org/3651}{\texttt{ \#3651}} 
\end{DoxyItemize}