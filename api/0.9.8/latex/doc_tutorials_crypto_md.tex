...
\item {\ttfamily fcrypt}.
\end{DoxyEnumerate}\hypertarget{doc_tutorials_crypto_md_autotoc_md3570}{}\doxysection{Prerequisites -\/ Gnu\+PG}\label{doc_tutorials_crypto_md_autotoc_md3570}
...
The {\ttfamily fcrypt} plugin and the {\ttfamily crypto} plugin support both versions (version 1 and version 2) of GPG.\hypertarget{doc_tutorials_crypto_md_autotoc_md3571}{}\doxysection{Introduction}\label{doc_tutorials_crypto_md_autotoc_md3571}
...
We also show how to approach integrity with the signature features of the {\ttfamily fcrypt} plugin.\hypertarget{doc_tutorials_crypto_md_autotoc_md3572}{}\doxysection{Configuration File Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md3572}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3573}{}\doxysection{Configuration File Signatures}\label{doc_tutorials_crypto_md_autotoc_md3573}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3574}{}\doxysubsection{Combining Signatures and Encryption}\label{doc_tutorials_crypto_md_autotoc_md3574}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3575}{}\doxysection{Configuration Value Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md3575}
...
As a result you get \char`\"{}1234\char`\"{}.\hypertarget{doc_tutorials_crypto_md_autotoc_md3577}{}\doxysubsection{Disabling Encryption}\label{doc_tutorials_crypto_md_autotoc_md3577}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3578}{}\doxysubsection{Complete Example}\label{doc_tutorials_crypto_md_autotoc_md3578}
The complete example looks like this\+:
