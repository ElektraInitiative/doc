...
\Hypertarget{doc_decisions_plugin_variants_md_md_doc_decisions_plugin_variants}%
 \hypertarget{doc_decisions_plugin_variants_md_autotoc_md1966}{}\doxysection{Problem}\label{doc_decisions_plugin_variants_md_autotoc_md1966}
...
The current issue is that there is no way to enumerate possible plugin variants as needed to list all functionality of Elektra.\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1967}{}\doxysection{Constraints}\label{doc_decisions_plugin_variants_md_autotoc_md1967}
...
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1968}{}\doxysection{Assumptions}\label{doc_decisions_plugin_variants_md_autotoc_md1968}

\begin{DoxyItemize}
\item The number of variants needs to be bounded\+: plugin variants need to be fully enumerable
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1969}{}\doxysection{Considered Alternatives}\label{doc_decisions_plugin_variants_md_autotoc_md1969}
...
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1970}{}\doxysection{Decision}\label{doc_decisions_plugin_variants_md_autotoc_md1970}
...
\end{DoxyItemize}
\end{DoxyEnumerate}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1971}{}\doxysubsection{Example}\label{doc_decisions_plugin_variants_md_autotoc_md1971}
...
\end{DoxyCode}
\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1972}{}\doxysection{Rationale}\label{doc_decisions_plugin_variants_md_autotoc_md1972}
...
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1973}{}\doxysection{Implications}\label{doc_decisions_plugin_variants_md_autotoc_md1973}
...
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1974}{}\doxysection{Current state}\label{doc_decisions_plugin_variants_md_autotoc_md1974}
...
gets ignored.\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1975}{}\doxysection{Related Decisions}\label{doc_decisions_plugin_variants_md_autotoc_md1975}

\begin{DoxyItemize}
\item \mbox{\hyperlink{doc_decisions_cmake_plugins_md}{CMake Plugins}}
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1976}{}\doxysection{Notes}\label{doc_decisions_plugin_variants_md_autotoc_md1976}
