...
\Hypertarget{doc_usecases_snippet_sharing_UC_authenticate_md_md_doc_usecases_snippet_sharing_UC_authenticate}%
 \hypertarget{doc_usecases_snippet_sharing_UC_authenticate_md_autotoc_md4567}{}\doxysection{Summary}\label{doc_usecases_snippet_sharing_UC_authenticate_md_autotoc_md4567}
...
\end{DoxyItemize}\hypertarget{doc_usecases_snippet_sharing_UC_authenticate_md_autotoc_md4568}{}\doxysection{Scenarios}\label{doc_usecases_snippet_sharing_UC_authenticate_md_autotoc_md4568}
...
\item {\bfseries{Alternative scenario\+:}} The authentication was not successful (e.\+g. wrong credentials). The user is prompted to check their credentials and retry.
