...
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md611}{}\doxysubsection{Introduction}\label{md_src_plugins_yamlcpp_README_autotoc_md611}
The YAML CPP plugin reads and writes configuration data via the \href{https://github.com/jbeder/yaml-cpp}{\texttt{ yaml-\/cpp}} library.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md612}{}\doxysubsection{Installation}\label{md_src_plugins_yamlcpp_README_autotoc_md612}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/yamlcpp}.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md613}{}\doxysubsection{Usage}\label{md_src_plugins_yamlcpp_README_autotoc_md613}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md614}{}\doxysubsection{Arrays}\label{md_src_plugins_yamlcpp_README_autotoc_md614}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md615}{}\doxysubsubsection{Nested Arrays}\label{md_src_plugins_yamlcpp_README_autotoc_md615}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md616}{}\doxysubsubsection{Sparse Arrays}\label{md_src_plugins_yamlcpp_README_autotoc_md616}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md617}{}\doxysubsection{Metadata}\label{md_src_plugins_yamlcpp_README_autotoc_md617}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md618}{}\doxysubsection{Binary Data}\label{md_src_plugins_yamlcpp_README_autotoc_md618}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md619}{}\doxysubsection{Empty}\label{md_src_plugins_yamlcpp_README_autotoc_md619}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md620}{}\doxysubsection{Binary Values}\label{md_src_plugins_yamlcpp_README_autotoc_md620}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md621}{}\doxysubsection{Dependencies}\label{md_src_plugins_yamlcpp_README_autotoc_md621}
This plugin requires \href{https://github.com/jbeder/yaml-cpp}{\texttt{ yaml-\/cpp}}. On a Debian based OS the package for the library is called \href{https://packages.debian.org/libyaml-cpp-dev}{\texttt{ {\ttfamily libyaml-\/cpp-\/dev}}}. On mac\+OS you can install the package \href{https://repology.org/project/yaml-cpp}{\texttt{ {\ttfamily yaml-\/cpp}}} via \href{https://brew.sh}{\texttt{ Home\+Brew}}.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md622}{}\doxysubsection{Limitations}\label{md_src_plugins_yamlcpp_README_autotoc_md622}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md623}{}\doxysubsubsection{Leaf Values}\label{md_src_plugins_yamlcpp_README_autotoc_md623}
...
. However, if we use this approach we are not able to support Elektra’s array type properly.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md624}{}\doxyparagraph{Directory Values}\label{md_src_plugins_yamlcpp_README_autotoc_md624}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md625}{}\doxysubsubsection{Special Values}\label{md_src_plugins_yamlcpp_README_autotoc_md625}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md626}{}\doxysubsubsection{Other Limitations}\label{md_src_plugins_yamlcpp_README_autotoc_md626}
