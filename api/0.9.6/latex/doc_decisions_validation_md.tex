...
\Hypertarget{doc_decisions_validation_md_md_doc_decisions_validation}%
 \hypertarget{doc_decisions_validation_md_autotoc_md2050}{}\doxysection{Problem}\label{doc_decisions_validation_md_autotoc_md2050}
...
If validation of a key fails, each plugin decides on its own how to handle the issue and proceed in ways that might be different than what is expected or desired.\hypertarget{doc_decisions_validation_md_autotoc_md2051}{}\doxysection{Constraints}\label{doc_decisions_validation_md_autotoc_md2051}
\hypertarget{doc_decisions_validation_md_autotoc_md2052}{}\doxysection{Assumptions}\label{doc_decisions_validation_md_autotoc_md2052}
...
\end{DoxyItemize}\hypertarget{doc_decisions_validation_md_autotoc_md2053}{}\doxysection{Considered Alternatives}\label{doc_decisions_validation_md_autotoc_md2053}
...
\end{DoxyItemize}\hypertarget{doc_decisions_validation_md_autotoc_md2054}{}\doxysection{Decision}\label{doc_decisions_validation_md_autotoc_md2054}
Use a wrapper plugin to iterate over the keyset and delegate the validation of each key to the corresponding validation plugin.\hypertarget{doc_decisions_validation_md_autotoc_md2055}{}\doxysection{Rationale}\label{doc_decisions_validation_md_autotoc_md2055}
...
\end{DoxyItemize}\hypertarget{doc_decisions_validation_md_autotoc_md2056}{}\doxysection{Implications}\label{doc_decisions_validation_md_autotoc_md2056}
...
returning 1 if validation succeeded, 0 on failure\hypertarget{doc_decisions_validation_md_autotoc_md2057}{}\doxysection{Related Decisions}\label{doc_decisions_validation_md_autotoc_md2057}
\hypertarget{doc_decisions_validation_md_autotoc_md2058}{}\doxysection{Notes}\label{doc_decisions_validation_md_autotoc_md2058}
