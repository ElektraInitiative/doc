...
\end{DoxyItemize}\hypertarget{doc_tutorials_application-integration_md_autotoc_md3774}{}\doxysection{Elektrify}\label{doc_tutorials_application-integration_md_autotoc_md3774}
...
For more information about that, continue reading \href{https://master.libelektra.org/src/tools/pythongen}{\texttt{ here}}.\hypertarget{doc_tutorials_application-integration_md_autotoc_md3777}{}\doxysection{Specification}\label{doc_tutorials_application-integration_md_autotoc_md3777}
...
To make this work within your application make sure to always call {\ttfamily ks\+Lookup} before using a value from Elektra.\hypertarget{doc_tutorials_application-integration_md_autotoc_md3779}{}\doxysubsection{Specfiles}\label{doc_tutorials_application-integration_md_autotoc_md3779}
