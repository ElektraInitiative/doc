\label{doc_dev_error-message_md_md_doc_dev_error_message}%
\Hypertarget{doc_dev_error-message_md_md_doc_dev_error_message}%
...
\item If the error reason is in beneath a variable string (such as {\ttfamily errno} or a caught exception), write {\ttfamily \char`\"{}\+Reason\+: \%s\char`\"{}, variable\+\_\+as\+\_\+string} at the end of the error message. Also end the preceding sentence with a dot. Example\+: {\ttfamily \char`\"{}\+XY failed. Reason\+: \%s\char`\"{}, exception.\+what()}.
...
\item Use abbreviations and acronyms with care. Not everybody will know them. You can write them in brackets though. (eg. {\ttfamily No Byte Order Mark (BOM) found} instead of {\ttfamily No BOM found}. But {\ttfamily XML does not support feature xy} is fine).
...
\end{DoxyItemize}\hypertarget{doc_dev_error-message_md_autotoc_md2165}{}\doxysection{Examples}\label{doc_dev_error-message_md_autotoc_md2165}
