...
We are proud to release Elektra 0.\+9.\+1.\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2406}{}\doxysection{What is Elektra?}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2406}
...
You can also read the news \href{https://www.libelektra.org/news/0.9.1-release}{\texttt{ on our website}}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2407}{}\doxysection{Highlights}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2407}

\begin{DoxyItemize}
\item We are working on integrating Elektra into \href{https://kde.org/}{\texttt{ K\+DE}}. A new Elektra plugin called {\ttfamily kconfig} was added which can read K\+DE\textquotesingle{}s kconfig ini files. Additionally we are working on a \href{https://github.com/ElektraInitiative/kconfig}{\texttt{ fork}} of K\+DE\textquotesingle{}s {\ttfamily K\+Config} configuration system and patching it to use libelektra. \+\_\+(\+Dardan Haxhimustafa)\+\_\+ and \+\_\+(\+Felix Resch)\+\_\+
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2408}{}\doxysubsection{Code Generation}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2408}
...
We also created a new C\+Make function that will be available, if you include Elektra via C\+Make\textquotesingle{}s {\ttfamily find\+\_\+package}. The function is called {\ttfamily elektra\+\_\+kdb\+\_\+gen} and can be used to tell C\+Make about files that are generated via {\ttfamily kdb gen}. \+\_\+(Klemens Böswirth)\+\_\+\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2409}{}\doxysubsection{Further Highlights}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2409}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2410}{}\doxysection{Plugins}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2410}
The following section lists news about the \href{https://www.libelektra.org/plugins/readme}{\texttt{ plugins}} we updated in this release.\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2411}{}\doxysubsection{General}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2411}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2412}{}\doxysubsection{Camel}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2412}
We removed the experimental plugin. For a plugin that is able to parse similar syntax, please take a look at the


\begin{DoxyItemize}
\item \mbox{\hyperlink{md_src_plugins_yajl_README_src_plugins_yajl_README_md}{Y\+A\+JL}} , and
\item \mbox{\hyperlink{md_src_plugins_yamlcpp_README_src_plugins_yamlcpp_README_md}{Y\+A\+ML C\+PP}}
\end{DoxyItemize}

plugins. \+\_\+(René Schwaiger)\+\_\+\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2413}{}\doxysubsection{G\+Opts}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2413}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2414}{}\doxysubsection{K\+Config}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2414}

\begin{DoxyItemize}
\item We added a plugin which can be used to parse kconfig I\+NI files. \+\_\+(\+Dardan Haxhimustafa)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2415}{}\doxysubsection{Mmapstorage}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2415}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2416}{}\doxysubsection{Noresolver}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2416}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2417}{}\doxysubsection{Path}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2417}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2418}{}\doxysubsection{Spec}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2418}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2419}{}\doxysubsection{Specload}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2419}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2420}{}\doxysubsection{Tcl}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2420}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2421}{}\doxysubsection{Type}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2421}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2422}{}\doxysubsection{Yajl}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2422}

\begin{DoxyItemize}
\item Yajl now correctly supports Elektras boolean types using the {\ttfamily type} plugin. For example, setting {\ttfamily on}, {\ttfamily enable} or {\ttfamily true} all map to J\+S\+O\+Ns native {\ttfamily true} value. See the \mbox{\hyperlink{md_src_plugins_type_README_src_plugins_type_README_md}{type}} plugin for more details about boolean types. \+\_\+(\+Philipp Gackstatter)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2423}{}\doxysubsection{Y\+Awn}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2423}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2424}{}\doxysubsection{Y\+Ay P\+EG}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2424}

\begin{DoxyItemize}
\item We removed the plugin in favor of \mbox{\hyperlink{md_src_plugins_yanlr_README_src_plugins_yanlr_README_md}{Yan LR}}. \+\_\+(René Schwaiger)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2425}{}\doxysection{Libraries}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2425}
The text below summarizes updates to the \href{https://www.libelektra.org/libraries/readme}{\texttt{ C (and C++)-\/based libraries}} of Elektra.\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2426}{}\doxysubsection{Compatibility}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2426}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2427}{}\doxysubsection{Core}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2427}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2428}{}\doxysubsection{Opts}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2428}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2429}{}\doxysubsection{Proposal}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2429}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2430}{}\doxysection{Bindings}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2430}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2431}{}\doxysubsection{Java}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2431}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2432}{}\doxysubsection{Rust}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2432}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2433}{}\doxysection{Tools}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2433}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2434}{}\doxysection{Scripts}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2434}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2435}{}\doxysection{Documentation}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2435}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2436}{}\doxysection{Tests}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2436}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2437}{}\doxysection{Build}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2437}
\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2438}{}\doxysubsection{C\+Make}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2438}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2439}{}\doxysubsection{Compilation}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2439}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2440}{}\doxysubsection{Docker}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2440}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2441}{}\doxysubsection{Vagrant}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2441}

\begin{DoxyItemize}
\item We added a Vagrantfile for a virtual machine based on Free\+B\+SD 12. \+\_\+(René Schwaiger)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2442}{}\doxysubsection{Other}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2442}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2443}{}\doxysection{Infrastructure}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2443}
\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2444}{}\doxysubsection{Cirrus}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2444}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2445}{}\doxysubsection{Jenkins}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2445}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2446}{}\doxysubsection{Restyled}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2446}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2447}{}\doxysubsection{Travis}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2447}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2448}{}\doxysection{Website}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2448}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2449}{}\doxysection{Outlook}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2449}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2450}{}\doxysection{Statistics}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2450}
...
Thanks to all authors for making this release possible!\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2451}{}\doxysection{Finished Thesis}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2451}
...
\end{DoxyItemize}\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2452}{}\doxysection{Join the Initiative!}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2452}
...
As first step, you could give us feedback about these release notes. Contact us via our \href{https://issues.libelektra.org}{\texttt{ issue tracker}}.\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2453}{}\doxysection{Get the Release!}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2453}
...
Already built A\+P\+I-\/\+Docu can be found \href{https://doc.libelektra.org/api/0.9.1/html/}{\texttt{ here}} or on \href{https://github.com/ElektraInitiative/doc/tree/master/api/0.9.1}{\texttt{ Git\+Hub}}.\hypertarget{doc_news_2019-11-26_0_9_1_md_autotoc_md2454}{}\doxysection{Stay tuned!}\label{doc_news_2019-11-26_0_9_1_md_autotoc_md2454}
