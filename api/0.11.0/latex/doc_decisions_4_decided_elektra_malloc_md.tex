...
\Hypertarget{doc_decisions_4_decided_elektra_malloc_md_md_doc_decisions_4_decided_elektra_malloc}%
 \hypertarget{doc_decisions_4_decided_elektra_malloc_md_autotoc_md2067}{}\doxysection{Problem}\label{doc_decisions_4_decided_elektra_malloc_md_autotoc_md2067}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_elektra_malloc_md_autotoc_md2071}{}\doxysection{Decision}\label{doc_decisions_4_decided_elektra_malloc_md_autotoc_md2071}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_elektra_malloc_md_autotoc_md2072}{}\doxysection{Rationale}\label{doc_decisions_4_decided_elektra_malloc_md_autotoc_md2072}
While the current state might cause some problems with compiler optimizations and discoverability, those issues probably are only very minor in practice. Removing all functions poses a considerable amount of work, which would have to be undone in case we need those functions one day anyway. The current downsides don\textquotesingle{}t justify such a big procedure.\hypertarget{doc_decisions_4_decided_elektra_malloc_md_autotoc_md2073}{}\doxysection{Implications}\label{doc_decisions_4_decided_elektra_malloc_md_autotoc_md2073}
\hypertarget{doc_decisions_4_decided_elektra_malloc_md_autotoc_md2074}{}\doxysection{Related Decisions}\label{doc_decisions_4_decided_elektra_malloc_md_autotoc_md2074}
\hypertarget{doc_decisions_4_decided_elektra_malloc_md_autotoc_md2075}{}\doxysection{Notes}\label{doc_decisions_4_decided_elektra_malloc_md_autotoc_md2075}
