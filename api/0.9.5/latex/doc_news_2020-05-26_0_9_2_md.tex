...
\begin{DoxyItemize}
\item The \href{https://master.libelektra.org/tests/shell/shell_recorder/tutorial_wrapper}{\tt Markdown Shell Recorder} test of the plugin now correctly requires the \hyperlink{autotoc_md781_src_plugins_xmltool_README_md}{`xmltool` plugin}. \+\_\+(René Schwaiger)\+\_\+
\end{DoxyItemize}
