\hypertarget{doc_help_kdb-get_md_autotoc_md1690}{}\doxysection{S\+Y\+N\+O\+P\+S\+IS}\label{doc_help_kdb-get_md_autotoc_md1690}
{\ttfamily kdb get $<$key name$>$}

Where {\ttfamily key name} is the name of the key.\hypertarget{doc_help_kdb-get_md_autotoc_md1691}{}\doxysection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{doc_help_kdb-get_md_autotoc_md1691}
This command is used to retrieve the value of a key.

If you enter a {\ttfamily key name} starting with a leading {\ttfamily /}, then a cascading lookup will be performed in order to attempt to locate the key. In this case, using the {\ttfamily -\/v} option allows the user to see the full key name of the key if it is found.\hypertarget{doc_help_kdb-get_md_autotoc_md1692}{}\doxysection{L\+I\+M\+I\+T\+A\+T\+I\+O\+NS}\label{doc_help_kdb-get_md_autotoc_md1692}
Only keys within the mount point or below the {\ttfamily $<$key name$>$} will be considered during a cascading lookup. A workaround is to pass the {\ttfamily -\/a} option. Use the command {\ttfamily kdb get -\/v $<$key name$>$} to see if an override or a fallback was considered by the lookup.\hypertarget{doc_help_kdb-get_md_autotoc_md1693}{}\doxysection{R\+E\+T\+U\+R\+N V\+A\+L\+U\+ES}\label{doc_help_kdb-get_md_autotoc_md1693}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-get_md_autotoc_md1694}{}\doxysection{O\+P\+T\+I\+O\+NS}\label{doc_help_kdb-get_md_autotoc_md1694}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-get_md_autotoc_md1695}{}\doxysection{E\+X\+A\+M\+P\+L\+ES}\label{doc_help_kdb-get_md_autotoc_md1695}
...
\DoxyCodeLine{kdb meta-\/set /tests/get/examples/kdb-\/get/anotherKey default defaultValue}
\DoxyCodeLine{}
...
\DoxyCodeLine{\#> The key was not found in any other namespace, taking the default from the metadata}
\DoxyCodeLine{\#> The resulting keyname is /tests/get/examples/kdb-\/get/anotherKey}
...
This command will actually get {\ttfamily user/sw/elektra/kdb/\#0/current/format} if the bookmarks commands from \mbox{\hyperlink{doc_help_kdb-set_md}{kdb-\/set(1)}} man pages are executed before.\hypertarget{doc_help_kdb-get_md_autotoc_md1696}{}\doxysection{S\+E\+E A\+L\+SO}\label{doc_help_kdb-get_md_autotoc_md1696}
