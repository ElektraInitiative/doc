...
A reference count of 0 for {\ttfamily Key\+Name}, {\ttfamily Key\+Data} and {\ttfamily Key\+Set\+Data} is illegal outside the public API function calls that cause the creation/deletion these structures.\hypertarget{doc_contrib_copy_on_write_md_autotoc_md1718}{}\doxysection{Integration with $<$tt$>$mmapstorage$<$/tt$>$}\label{doc_contrib_copy_on_write_md_autotoc_md1718}
