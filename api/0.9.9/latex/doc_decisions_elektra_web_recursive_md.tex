...
\Hypertarget{doc_decisions_elektra_web_recursive_md_md_doc_decisions_elektra_web_recursive}%
 \hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1798}{}\doxysection{Problem}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1798}
After deciding how to remotely manage instances and groups of instances (clusters) with Elektra Web, there is still the issue of recursively nested clusters (clusters of clusters).\hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1799}{}\doxysection{Constraints}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1799}
...
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1800}{}\doxysection{Assumptions}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1800}

\begin{DoxyItemize}
\item Use one cluster daemon (clusterd) to manage all clusters and instances.
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1801}{}\doxysection{Considered Alternatives}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1801}
...
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1802}{}\doxysection{Decision}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1802}
Managing the hierarchy in a single clusterd instance.\hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1803}{}\doxysection{Rationale}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1803}
