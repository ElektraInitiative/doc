...
\Hypertarget{doc_help_kdb-cp_md_md_doc_help_kdb_cp}%
 \hypertarget{doc_help_kdb-cp_md_autotoc_md2350}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-cp_md_autotoc_md2350}
{\ttfamily kdb cp $<$source$>$ $<$dest$>$}\hypertarget{doc_help_kdb-cp_md_autotoc_md2351}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-cp_md_autotoc_md2351}
...
Where {\ttfamily source} is the path of the key(s) you want to copy and {\ttfamily dest} is the path where you would like to copy the key(s) to. Note that when using the {\ttfamily -\/r} flag, {\ttfamily source} as well as all of the keys below it will be copied.\hypertarget{doc_help_kdb-cp_md_autotoc_md2352}{}\doxysection{LIMITATIONS}\label{doc_help_kdb-cp_md_autotoc_md2352}
Neither {\ttfamily source} nor {\ttfamily dest} can be a cascading key. (Start with {\ttfamily /}). Make sure to select a namespace.\hypertarget{doc_help_kdb-cp_md_autotoc_md2353}{}\doxysection{RETURN VALUES}\label{doc_help_kdb-cp_md_autotoc_md2353}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-cp_md_autotoc_md2354}{}\doxysection{OPTIONS}\label{doc_help_kdb-cp_md_autotoc_md2354}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-cp_md_autotoc_md2355}{}\doxysection{EXAMPLES}\label{doc_help_kdb-cp_md_autotoc_md2355}
