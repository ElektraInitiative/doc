...
\Hypertarget{doc_decisions_ensure_md_md_doc_decisions_ensure}%
 \hypertarget{doc_decisions_ensure_md_autotoc_md1781}{}\doxysection{Problem}\label{doc_decisions_ensure_md_autotoc_md1781}
Applications want to ensure that some functionality (=global plugin) is present in Elektra.\hypertarget{doc_decisions_ensure_md_autotoc_md1782}{}\doxysection{Constraints}\label{doc_decisions_ensure_md_autotoc_md1782}
\hypertarget{doc_decisions_ensure_md_autotoc_md1783}{}\doxysection{Assumptions}\label{doc_decisions_ensure_md_autotoc_md1783}
\hypertarget{doc_decisions_ensure_md_autotoc_md1784}{}\doxysection{Considered Alternatives}\label{doc_decisions_ensure_md_autotoc_md1784}
...
\end{DoxyItemize}\hypertarget{doc_decisions_ensure_md_autotoc_md1785}{}\doxysection{Decision}\label{doc_decisions_ensure_md_autotoc_md1785}
Integrate {\ttfamily kdb\+Ensure} in {\ttfamily kdb\+Open(\+Key $\ast$error\+Key, Key\+Set $\ast$contract)} but only allow global plugins.\hypertarget{doc_decisions_ensure_md_autotoc_md1786}{}\doxysection{Rationale}\label{doc_decisions_ensure_md_autotoc_md1786}
...
\end{DoxyItemize}\hypertarget{doc_decisions_ensure_md_autotoc_md1787}{}\doxysection{Implications}\label{doc_decisions_ensure_md_autotoc_md1787}
...
It is safe to use the contract {\ttfamily Key\+Set} also for {\ttfamily kdb\+Get} and {\ttfamily kdb\+Set} invocations. Contract {\ttfamily Key\+Set}s only contain {\ttfamily Key}s below {\ttfamily system\+:/elektra/contract}. Therefore, normal {\ttfamily Key\+Set}s should not interfere.\hypertarget{doc_decisions_ensure_md_autotoc_md1788}{}\doxysection{Related Decisions}\label{doc_decisions_ensure_md_autotoc_md1788}

\begin{DoxyItemize}
\item \mbox{\hyperlink{doc_decisions_global_plugins_md}{Global Plugins}}
\end{DoxyItemize}\hypertarget{doc_decisions_ensure_md_autotoc_md1789}{}\doxysection{Notes}\label{doc_decisions_ensure_md_autotoc_md1789}
