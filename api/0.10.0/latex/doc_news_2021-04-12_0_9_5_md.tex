...
We are proud to release Elektra 0.\+9.\+5.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3823}{}\doxysection{What is Elektra?}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3823}
...
You can try out the latest Elektra release using our docker image \href{https://hub.docker.com/r/elektra/elektra}{\texttt{ elektra/elektra}}. This is the quickest way to get started with Elektra without compiling and other obstacles, simply run {\ttfamily docker run -\/it elektra/elektra}.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3824}{}\doxysection{Highlights}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3824}
...
\label{_hl-1}%
\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3825}{}\doxysubsection{$<$tt$>$kdb\+Open$<$/tt$>$ Contracts}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3825}
...
For more information take a look at \mbox{\hyperlink{doc_dev_kdb-contracts_md}{doc/dev/kdb-\/contracts.md}}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3826}{}\doxysection{Plugins}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3826}
The following section lists news about the \href{https://www.libelektra.org/plugins/readme}{\texttt{ plugins}} we updated in this release.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3827}{}\doxysubsection{Cache}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3827}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3828}{}\doxysubsection{internalnotification}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3828}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3829}{}\doxysubsection{Dbus \& Dbusrecv}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3829}

\begin{DoxyItemize}
\item Internal changes to ensure compatibility with the new {\ttfamily elektra\+Notification\+Contract}. \+\_\+(Klemens Böswirth)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3830}{}\doxysubsection{YAML Smith \& Yan LR}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3830}

\begin{DoxyItemize}
\item Removed plugins {\ttfamily yamlsmith} and {\ttfamily yanlr}. \+\_\+(René Schwaiger)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3831}{}\doxysubsection{Zeromqsend \& Zeromqrecv}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3831}

\begin{DoxyItemize}
\item Internal changes to ensure compatibility with the new {\ttfamily elektra\+Notification\+Contract}. \+\_\+(Klemens Böswirth)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3832}{}\doxysection{Libraries}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3832}
The text below summarizes updates to the \href{https://www.libelektra.org/libraries/readme}{\texttt{ C (and C++)-\/based libraries}} of Elektra.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3833}{}\doxysubsection{Compatibility}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3833}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3834}{}\doxysubsection{Core}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3834}
\label{_key-copy}%
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3835}{}\doxysubsection{Io}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3835}

\begin{DoxyItemize}
\item {\ttfamily elektra\+Set\+Io\+Binding} has been removed. Use {\ttfamily elektra\+Io\+Contract} instead. \+\_\+(Klemens Böswirth)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3836}{}\doxysubsection{Notification}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3836}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3837}{}\doxysection{Bindings}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3837}
Bindings allow you to utilize Elektra using \href{https://www.libelektra.org/bindings/readme}{\texttt{ various programming languages}}. This section keeps you up-\/to-\/date with the multi-\/language support provided by Elektra.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3838}{}\doxysubsection{JNA}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3838}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3839}{}\doxysubsubsection{Outlook}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3839}
Ongoing work on bringing the JNA binding up to scratch and improving developer experience. Both for JNA binding API consumers, as well as future JNA binding contrubutors. \+\_\+(\+Michael Tucek)\+\_\+\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3840}{}\doxysubsection{Python \& Lua}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3840}
Add support for keyset.\+remove(key). \+\_\+(\+Manuel Mausz)\+\_\+\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3841}{}\doxysection{Tools}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3841}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3842}{}\doxysection{Examples}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3842}

\begin{DoxyItemize}
\item Fix enums in examples/spec. \+\_\+(\+Markus Raab)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3843}{}\doxysection{Documentation}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3843}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3844}{}\doxysection{Tests}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3844}

\begin{DoxyItemize}
\item Added small test for jna Return plugin ({\ttfamily Return.\+java}), {\ttfamily Key\+Name\+Iterator.\+java} \+\_\+(@aaronabebe)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3845}{}\doxysection{Packaging}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3845}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3846}{}\doxysection{Build}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3846}
\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3847}{}\doxysubsection{CMake}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3847}

\begin{DoxyItemize}
\item Fix issue where the library runpaths of the jni plugin could not be resolved. \+\_\+(\+Robert Sowula)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3848}{}\doxysubsection{Docker}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3848}

\begin{DoxyItemize}
\item Update Alpine Linux images to version 3.\+13.\+1 and update Elektra release image. \+\_\+(Mihael Pranjić)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3849}{}\doxysection{Infrastructure}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3849}
\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3850}{}\doxysubsection{Cirrus}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3850}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3851}{}\doxysubsection{Git\+Hub Actions}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3851}

\begin{DoxyItemize}
\item Fix issues with {\ttfamily dbus} and java paths, exclude {\ttfamily jni}. \+\_\+(Mihael Pranjić)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3852}{}\doxysubsection{Jenkins}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3852}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3853}{}\doxysection{Website}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3853}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3854}{}\doxysection{Outlook}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3854}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3855}{}\doxysection{Statistics}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3855}
...
Thanks to all authors for making this release possible!\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3856}{}\doxysection{Join the Initiative!}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3856}
...
As first step, you could give us feedback about these release notes. Contact us via our \href{https://issues.libelektra.org}{\texttt{ issue tracker}}.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3857}{}\doxysection{Get the Release!}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3857}
...
Already built API documentation can be found \href{https://doc.libelektra.org/api/0.9.5/html/}{\texttt{ here}} or on \href{https://github.com/ElektraInitiative/doc/tree/master/api/0.9.5}{\texttt{ Git\+Hub}}.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3858}{}\doxysection{Stay tuned!}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3858}
