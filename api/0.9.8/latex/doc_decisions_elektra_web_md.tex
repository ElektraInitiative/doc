...
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_md_autotoc_md1747}{}\doxysection{Assumptions}\label{doc_decisions_elektra_web_md_autotoc_md1747}
\hypertarget{doc_decisions_elektra_web_md_autotoc_md1748}{}\doxysection{Considered Alternatives}\label{doc_decisions_elektra_web_md_autotoc_md1748}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_md_autotoc_md1749}{}\doxysection{Decision}\label{doc_decisions_elektra_web_md_autotoc_md1749}
Use one cluster daemon (clusterd) to manage all clusters and instances.\hypertarget{doc_decisions_elektra_web_md_autotoc_md1750}{}\doxysection{Rationale}\label{doc_decisions_elektra_web_md_autotoc_md1750}
