\hypertarget{doc_tutorials_python-kdb_md_autotoc_md2761}{}\doxysection{Introduction}\label{doc_tutorials_python-kdb_md_autotoc_md2761}
When programming in Python it is possible to access the kdb database, changing values of existing keys, adding and deleting keys and a few other things.\hypertarget{doc_tutorials_python-kdb_md_autotoc_md2762}{}\doxysection{Installation}\label{doc_tutorials_python-kdb_md_autotoc_md2762}
Either \href{https://www.libelektra.org/bindings/swig_python}{\texttt{ build}} the package or install from a repository.\hypertarget{doc_tutorials_python-kdb_md_autotoc_md2763}{}\doxysubsection{Alpine Linux}\label{doc_tutorials_python-kdb_md_autotoc_md2763}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_python-kdb_md_autotoc_md2764}{}\doxysection{First Steps}\label{doc_tutorials_python-kdb_md_autotoc_md2764}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_python-kdb_md_autotoc_md2765}{}\doxysection{Keyset}\label{doc_tutorials_python-kdb_md_autotoc_md2765}
...
Keys can be added to a keyset using {\ttfamily append}. If the key already exists, the value will be updated. Calling `keyset\+\_\+name\mbox{[}'/path/to/key\textquotesingle{}\mbox{]} = \textquotesingle{}new\+\_\+value\`{} does not work for updating keys already in a keyset.
