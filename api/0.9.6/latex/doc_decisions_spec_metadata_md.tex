...
\Hypertarget{doc_decisions_spec_metadata_md_md_doc_decisions_spec_metadata}%
 \hypertarget{doc_decisions_spec_metadata_md_autotoc_md2014}{}\doxysection{Problem}\label{doc_decisions_spec_metadata_md_autotoc_md2014}
...
If metadata is merged from different namespaces, e.\+g., {\ttfamily spec\+:} and {\ttfamily user\+:}, metadata from one namespace might end up in keys of other namespaces, e.\+g., metadata from {\ttfamily spec\+:} might end up in {\ttfamily user\+:}.\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2015}{}\doxysection{Constraints}\label{doc_decisions_spec_metadata_md_autotoc_md2015}
...
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2016}{}\doxysection{Assumptions}\label{doc_decisions_spec_metadata_md_autotoc_md2016}

\begin{DoxyItemize}
\item Metadata can always safely merged from {\ttfamily spec\+:/} to other namespace.
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2017}{}\doxysection{Considered Alternatives}\label{doc_decisions_spec_metadata_md_autotoc_md2017}
...
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2018}{}\doxysection{Decision}\label{doc_decisions_spec_metadata_md_autotoc_md2018}
...
The {\ttfamily kdb mount} tool will add the {\ttfamily meta} plugin configuration when mounting a storage plugin to {\ttfamily spec\+:/}.\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2019}{}\doxysection{Rationale}\label{doc_decisions_spec_metadata_md_autotoc_md2019}
...
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2020}{}\doxysection{Implications}\label{doc_decisions_spec_metadata_md_autotoc_md2020}
...
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2021}{}\doxysection{Related Decisions}\label{doc_decisions_spec_metadata_md_autotoc_md2021}
...
\end{DoxyItemize}\hypertarget{doc_decisions_spec_metadata_md_autotoc_md2022}{}\doxysection{Notes}\label{doc_decisions_spec_metadata_md_autotoc_md2022}
