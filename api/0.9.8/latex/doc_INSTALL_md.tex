...
\Hypertarget{doc_INSTALL_md_md_doc_INSTALL}%
 \hypertarget{doc_INSTALL_md_autotoc_md2594}{}\doxysection{Status}\label{doc_INSTALL_md_autotoc_md2594}
The graph below shows an (incomplete) list of available packages for Elektra.

\href{https://repology.org/metapackage/elektra/versions}{\texttt{ }}\hypertarget{doc_INSTALL_md_autotoc_md2595}{}\doxysection{Linux}\label{doc_INSTALL_md_autotoc_md2595}
...
\end{DoxyItemize}\hypertarget{doc_INSTALL_md_autotoc_md2596}{}\doxysubsection{Debian/\+Ubuntu}\label{doc_INSTALL_md_autotoc_md2596}
...
\hypertarget{doc_INSTALL_md_autotoc_md2597}{}\doxysubsection{Fedora}\label{doc_INSTALL_md_autotoc_md2597}
...
\end{DoxyCode}
\hypertarget{doc_INSTALL_md_autotoc_md2598}{}\doxysubsection{open\+SUSE}\label{doc_INSTALL_md_autotoc_md2598}
...
\end{DoxyCode}
\hypertarget{doc_INSTALL_md_autotoc_md2599}{}\doxysubsection{Install}\label{doc_INSTALL_md_autotoc_md2599}
...
\end{DoxyCode}
\hypertarget{doc_INSTALL_md_autotoc_md2600}{}\doxysection{mac\+OS}\label{doc_INSTALL_md_autotoc_md2600}
...
. We also provide a tap containing a more elaborate formula \href{http://github.com/ElektraInitiative/homebrew-elektra}{\texttt{ here}}.\hypertarget{doc_INSTALL_md_autotoc_md2601}{}\doxysection{Windows}\label{doc_INSTALL_md_autotoc_md2601}
...
Otherwise please refer to the section {\ttfamily OS Independent} below.\hypertarget{doc_INSTALL_md_autotoc_md2602}{}\doxysection{OS Independent}\label{doc_INSTALL_md_autotoc_md2602}
First follow the steps in \mbox{\hyperlink{doc_COMPILE_md}{COMPILE}}.

After you completed building Elektra on your own, there are multiple options how to install it. For example, with make or CPack tools. We recommend to use the packages from our build server or that you generate your own packages with CPack.\hypertarget{doc_INSTALL_md_autotoc_md2603}{}\doxysubsection{CPack}\label{doc_INSTALL_md_autotoc_md2603}
...
\hypertarget{doc_INSTALL_md_autotoc_md2604}{}\doxysubsubsection{Debian/\+Ubuntu}\label{doc_INSTALL_md_autotoc_md2604}
...
\end{DoxyCode}
\hypertarget{doc_INSTALL_md_autotoc_md2605}{}\doxysubsubsection{Fedora}\label{doc_INSTALL_md_autotoc_md2605}
...
\end{DoxyCode}
\hypertarget{doc_INSTALL_md_autotoc_md2606}{}\doxysubsection{make}\label{doc_INSTALL_md_autotoc_md2606}
...
\end{DoxyCode}
\hypertarget{doc_INSTALL_md_autotoc_md2607}{}\doxysection{Troubleshooting}\label{doc_INSTALL_md_autotoc_md2607}
\hypertarget{doc_INSTALL_md_autotoc_md2608}{}\doxysubsection{Error Loading Libraries}\label{doc_INSTALL_md_autotoc_md2608}
...
and run {\ttfamily ldconfig} as root.\hypertarget{doc_INSTALL_md_autotoc_md2609}{}\doxysection{Installation Manuals}\label{doc_INSTALL_md_autotoc_md2609}
For some of the plugins and tools that ship with Elektra, additional installation manuals have been written. You can find them in the \mbox{\hyperlink{md_doc_tutorials_README_doc_tutorials_README_md}{tutorial overview}}.\hypertarget{doc_INSTALL_md_autotoc_md2610}{}\doxysection{See Also}\label{doc_INSTALL_md_autotoc_md2610}
