...
``{\ttfamily  @section autotoc\+\_\+md3725 Create an empty array with the name}user\+:/tests/sequence` kdb meta-\/set user\+:/tests/sequence array \textquotesingle{}\textquotesingle{} 
\begin{DoxyCode}
.
