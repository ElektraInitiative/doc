...
The cryptographic operations are performed by Gnu\+PG via the {\ttfamily libgpgme} library.\hypertarget{md_src_plugins_gpgme_README_autotoc_md241}{}\doxysection{Installation}\label{md_src_plugins_gpgme_README_autotoc_md241}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/experimental}.\hypertarget{md_src_plugins_gpgme_README_autotoc_md242}{}\doxysection{Dependencies}\label{md_src_plugins_gpgme_README_autotoc_md242}

\begin{DoxyItemize}
\item {\ttfamily libgpgme11} version 1.\+10 or later
\end{DoxyItemize}\hypertarget{md_src_plugins_gpgme_README_autotoc_md243}{}\doxysection{Build Information}\label{md_src_plugins_gpgme_README_autotoc_md243}
The plugin has been tested on Ubuntu 18.\+04 with {\ttfamily libgpgme} version 1.\+10.\hypertarget{md_src_plugins_gpgme_README_autotoc_md244}{}\doxysection{Examples}\label{md_src_plugins_gpgme_README_autotoc_md244}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_gpgme_README_autotoc_md245}{}\doxysection{Configuration}\label{md_src_plugins_gpgme_README_autotoc_md245}
\hypertarget{md_src_plugins_gpgme_README_autotoc_md246}{}\doxysubsection{Gnu\+PG Keys}\label{md_src_plugins_gpgme_README_autotoc_md246}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_gpgme_README_autotoc_md247}{}\doxysubsection{Textmode}\label{md_src_plugins_gpgme_README_autotoc_md247}
{\ttfamily gpgme} operates in textmode per default. In textmode the output of GPG is ASCII armored.

Textmode can be disabled by setting {\ttfamily /gpgme/textmode} to {\ttfamily 0} in the plugin configuration.\hypertarget{md_src_plugins_gpgme_README_autotoc_md248}{}\doxysection{Technical Details}\label{md_src_plugins_gpgme_README_autotoc_md248}
\hypertarget{md_src_plugins_gpgme_README_autotoc_md249}{}\doxysubsection{Message Format}\label{md_src_plugins_gpgme_README_autotoc_md249}
