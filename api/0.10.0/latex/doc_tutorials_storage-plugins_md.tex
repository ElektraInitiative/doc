...
takes more work. Before you continue with this text, please make sure that you read all of the linked documents above.\hypertarget{doc_tutorials_storage-plugins_md_autotoc_md4590}{}\doxysection{Don’t Add Additional Keys}\label{doc_tutorials_storage-plugins_md_autotoc_md4590}
...
. For more information on why we allow “holes” in the hierarchy, please take a look \mbox{\hyperlink{doc_decisions_6_implemented_holes_md}{here}}.\hypertarget{doc_tutorials_storage-plugins_md_autotoc_md4591}{}\doxysection{Differentiate Between Empty Keys and Keys Containing an Empty String}\label{doc_tutorials_storage-plugins_md_autotoc_md4591}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_storage-plugins_md_autotoc_md4592}{}\doxysection{Convert Boolean Data}\label{doc_tutorials_storage-plugins_md_autotoc_md4592}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_storage-plugins_md_autotoc_md4593}{}\doxysection{Support Values Inside Non-\/\+Leaf Keys}\label{doc_tutorials_storage-plugins_md_autotoc_md4593}
...
. To make sure that your storage plugin works correctly, please just replace {\ttfamily yamlcpp} with the name of your plugin and verify that the test above still works.\hypertarget{doc_tutorials_storage-plugins_md_autotoc_md4594}{}\doxysection{Support Array And Non-\/\+Array Data Properly}\label{doc_tutorials_storage-plugins_md_autotoc_md4594}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_storage-plugins_md_autotoc_md4595}{}\doxysection{Storing Comments}\label{doc_tutorials_storage-plugins_md_autotoc_md4595}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_storage-plugins_md_autotoc_md4596}{}\doxysection{Ordering of Elements}\label{doc_tutorials_storage-plugins_md_autotoc_md4596}
