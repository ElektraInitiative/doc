...
\Hypertarget{doc_decisions_bootstrap_md_md_doc_decisions_bootstrap}%
 \hypertarget{doc_decisions_bootstrap_md_autotoc_md1704}{}\doxysection{Problem}\label{doc_decisions_bootstrap_md_autotoc_md1704}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1705}{}\doxysection{Constraints}\label{doc_decisions_bootstrap_md_autotoc_md1705}

\begin{DoxyItemize}
\item Bootstrap should be fast and not unnecessarily read large files
\end{DoxyItemize}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1706}{}\doxysection{Assumptions}\label{doc_decisions_bootstrap_md_autotoc_md1706}
\hypertarget{doc_decisions_bootstrap_md_autotoc_md1707}{}\doxysection{Considered Alternatives}\label{doc_decisions_bootstrap_md_autotoc_md1707}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1708}{}\doxysection{Decision}\label{doc_decisions_bootstrap_md_autotoc_md1708}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1709}{}\doxysection{Rationale}\label{doc_decisions_bootstrap_md_autotoc_md1709}
\hypertarget{doc_decisions_bootstrap_md_autotoc_md1710}{}\doxysection{Implications}\label{doc_decisions_bootstrap_md_autotoc_md1710}
\hypertarget{doc_decisions_bootstrap_md_autotoc_md1711}{}\doxysection{Related Decisions}\label{doc_decisions_bootstrap_md_autotoc_md1711}
\hypertarget{doc_decisions_bootstrap_md_autotoc_md1712}{}\doxysection{Notes}\label{doc_decisions_bootstrap_md_autotoc_md1712}
