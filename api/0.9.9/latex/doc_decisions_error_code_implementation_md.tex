...
\Hypertarget{doc_decisions_error_code_implementation_md_md_doc_decisions_error_code_implementation}%
 \hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1825}{}\doxysection{Problem}\label{doc_decisions_error_code_implementation_md_autotoc_md1825}
In the previous error concept it was very useful to generate macros as we often added new errors. The code generation itself, however, was not ideal for cross compilation.\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1826}{}\doxysection{Constraints}\label{doc_decisions_error_code_implementation_md_autotoc_md1826}
\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1827}{}\doxysection{Assumptions}\label{doc_decisions_error_code_implementation_md_autotoc_md1827}

\begin{DoxyItemize}
\item Error codes do not change very often
\end{DoxyItemize}\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1828}{}\doxysection{Considered Alternatives}\label{doc_decisions_error_code_implementation_md_autotoc_md1828}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1829}{}\doxysection{Decision}\label{doc_decisions_error_code_implementation_md_autotoc_md1829}
...
When adding a new error code, language bindings have to be adapted accordingly such as the Rust or Java Binding.\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1830}{}\doxysection{Rationale}\label{doc_decisions_error_code_implementation_md_autotoc_md1830}

\begin{DoxyItemize}
\item Updates to error codes will imply syncing every binding. This though should happen in very rare circumstances.
\end{DoxyItemize}\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1831}{}\doxysection{Implications}\label{doc_decisions_error_code_implementation_md_autotoc_md1831}

\begin{DoxyItemize}
\item The current bindings stay untouched
\item Tutorial on how to write a binding should be written
\end{DoxyItemize}\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1832}{}\doxysection{Related Decisions}\label{doc_decisions_error_code_implementation_md_autotoc_md1832}
\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1833}{}\doxysection{Notes}\label{doc_decisions_error_code_implementation_md_autotoc_md1833}
