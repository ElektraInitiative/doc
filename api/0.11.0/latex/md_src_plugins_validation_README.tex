...
This plugin is a check plugin which checks string values of Keys using regular expressions.\hypertarget{md_src_plugins_validation_README_autotoc_md614}{}\doxysection{Usage}\label{md_src_plugins_validation_README_autotoc_md614}
