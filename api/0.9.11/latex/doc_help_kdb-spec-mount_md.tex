...
\Hypertarget{doc_help_kdb-spec-mount_md_md_doc_help_kdb_spec_mount}%
 \hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2730}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-spec-mount_md_autotoc_md2730}
...
{\ttfamily kdb smount} is an alias and can be used in the same way as {\ttfamily kdb spec-\/mount}.\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2731}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-spec-mount_md_autotoc_md2731}
...
\end{DoxyCode}
\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2732}{}\doxysection{IMPORTANT}\label{doc_help_kdb-spec-mount_md_autotoc_md2732}
...
\end{DoxyCode}
\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2733}{}\doxysection{OPTIONS}\label{doc_help_kdb-spec-mount_md_autotoc_md2733}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2734}{}\doxysection{KDB}\label{doc_help_kdb-spec-mount_md_autotoc_md2734}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2735}{}\doxysection{EXAMPLES}\label{doc_help_kdb-spec-mount_md_autotoc_md2735}
...
Additionally, add {\ttfamily ini} plugin (instead of some default resolver) with a config for INI\+:~\newline
 {\ttfamily sudo kdb spec-\/mount /example ini section=NULL}\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2736}{}\doxysection{SEE ALSO}\label{doc_help_kdb-spec-mount_md_autotoc_md2736}
