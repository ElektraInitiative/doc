...
All libraries and plugins from Elektra must be installed in exactly the same major and minor version, so no library or plugin-\/specific version information exists.\hypertarget{doc_VERSION_md_autotoc_md4124}{}\doxysection{Scope}\label{doc_VERSION_md_autotoc_md4124}
...
\end{DoxyItemize}\hypertarget{doc_VERSION_md_autotoc_md4125}{}\doxysection{Behavior}\label{doc_VERSION_md_autotoc_md4125}
...
Any inconsistency within these artifacts within each other or with the implementation constitutes a bug.\hypertarget{doc_VERSION_md_autotoc_md4126}{}\doxysection{Compatibility}\label{doc_VERSION_md_autotoc_md4126}
...
In {\ttfamily 1.\+0.$\ast$} the API and ABI must be always forward-\/compatible and backwards-\/compatible. That means that Elektra\textquotesingle{}s libraries and plugins may be upgraded and downgraded without any effect on applications, only bug or docu fixes are allowed.
...
References\+: \href{http://tldp.org/HOWTO/Program-Library-HOWTO/shared-libraries.html}{\texttt{ http\+://tldp.\+org/\+HOWTO/\+Program-\/\+Library-\/\+HOWTO/shared-\/libraries.\+html}} \href{http://packages.debian.org/de/sid/icheck}{\texttt{ http\+://packages.\+debian.\+org/de/sid/icheck}}\hypertarget{doc_VERSION_md_autotoc_md4127}{}\doxysection{Bindings}\label{doc_VERSION_md_autotoc_md4127}
