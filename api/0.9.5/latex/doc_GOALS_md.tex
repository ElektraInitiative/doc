...
\hypertarget{doc_GOALS_md_autotoc_md2511}{}\section{Users}\label{doc_GOALS_md_autotoc_md2511}
These goals are about Elektra\textquotesingle{}s users, again in order of importance. Again, lower goals need to be ignored if goals are in conflict.\hypertarget{doc_GOALS_md_autotoc_md2512}{}\subsection{1. Application Developers}\label{doc_GOALS_md_autotoc_md2512}
...
\hypertarget{doc_GOALS_md_autotoc_md2513}{}\subsection{2. Administrators}\label{doc_GOALS_md_autotoc_md2513}
...
\hypertarget{doc_GOALS_md_autotoc_md2514}{}\subsection{3. Maintainers}\label{doc_GOALS_md_autotoc_md2514}
...
\hypertarget{doc_GOALS_md_autotoc_md2515}{}\subsection{4. Possibility to Represent any Configuration File Format}\label{doc_GOALS_md_autotoc_md2515}
...
\hypertarget{doc_GOALS_md_autotoc_md2516}{}\section{Non-\/\+Goals\+:}\label{doc_GOALS_md_autotoc_md2516}
...
\end{DoxyItemize}\hypertarget{doc_GOALS_md_autotoc_md2517}{}\subsection{Further Readings}\label{doc_GOALS_md_autotoc_md2517}
