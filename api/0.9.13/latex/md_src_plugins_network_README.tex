...
If {\ttfamily gethostbyname()} returns a \char`\"{}try again\char`\"{} error, two retries will be attempted. If all retries were consumed, the plugin will proceed in the same manner as with other errors.\hypertarget{md_src_plugins_network_README_autotoc_md380}{}\doxysection{Future Work}\label{md_src_plugins_network_README_autotoc_md380}
