...
\Hypertarget{doc_help_elektra-faq_md_md_doc_help_elektra_faq}%
 \hypertarget{doc_help_elektra-faq_md_autotoc_md2241}{}\doxysection{I Am Stuck. Where Can I Get Help?}\label{doc_help_elektra-faq_md_autotoc_md2241}
...
Please do not waste too much time to find something out yourself. Information where people get stuck is valuable to improve Elektra and its documentation. Even if you find out directly after you posted the question\+: the pointer can be helpful for other people having the same problem.\hypertarget{doc_help_elektra-faq_md_autotoc_md2242}{}\doxysection{Isn\textquotesingle{}t it Easier to Implement a new Parser Than to use Elektra?}\label{doc_help_elektra-faq_md_autotoc_md2242}
...
So it pays off to use Elektra -- in the short and in the long term.\hypertarget{doc_help_elektra-faq_md_autotoc_md2243}{}\doxysection{Why Do I Need Elektra If I Already Use Configuration Management Tools?}\label{doc_help_elektra-faq_md_autotoc_md2243}
...
As an intermediate step, we can \mbox{\hyperlink{doc_help_elektra-mounting_md}{mount}} existing configuration files and operate on them.\hypertarget{doc_help_elektra-faq_md_autotoc_md2244}{}\doxysection{Do We Retain the Old Way of Configuring Things, i.\+e. Manually Editing an INI File in /etc?}\label{doc_help_elektra-faq_md_autotoc_md2244}
...
So do not worry too much, do not hesitate to ask any question. We welcome feedback, only then we can improve the documentation such as this FAQ!\hypertarget{doc_help_elektra-faq_md_autotoc_md2247}{}\doxysection{What Should I Do If I Found a Bug?}\label{doc_help_elektra-faq_md_autotoc_md2247}
Please check the \href{https://git.libelektra.org/issues}{\texttt{ issue tracker}} if it has already been reported. If it has not, please \href{https://git.libelektra.org/issues/new}{\texttt{ fill out the template}}. If you are in doubt, please report it.\hypertarget{doc_help_elektra-faq_md_autotoc_md2248}{}\doxysection{How Can I Contribute to Elektra?}\label{doc_help_elektra-faq_md_autotoc_md2248}
...
Please start by reading here.\hypertarget{doc_help_elektra-faq_md_autotoc_md2249}{}\doxysection{What Is Elektra’s License?}\label{doc_help_elektra-faq_md_autotoc_md2249}
New BSD license which allows us to have plugins link against GPL and GPL-\/incompatible libraries. If you compile Elektra, e.\+g., with GPL plugins, the result is GPL.\hypertarget{doc_help_elektra-faq_md_autotoc_md2250}{}\doxysection{Which version should I use?}\label{doc_help_elektra-faq_md_autotoc_md2250}
...
For details of versioning principles, see \mbox{\hyperlink{doc_VERSION_md}{here}}.\hypertarget{doc_help_elektra-faq_md_autotoc_md2251}{}\doxysection{Who Are the Authors?}\label{doc_help_elektra-faq_md_autotoc_md2251}
\mbox{\hyperlink{doc_AUTHORS_md}{List of authors}}.\hypertarget{doc_help_elektra-faq_md_autotoc_md2252}{}\doxysection{How Can I Advertise Elektra?}\label{doc_help_elektra-faq_md_autotoc_md2252}
