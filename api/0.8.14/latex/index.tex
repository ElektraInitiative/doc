...
See the Readme for more information \hyperlink{README_md}{Readme}. See the \hyperlink{md_doc_help_elektra-glossary_doc_help_elektra-glossary_md}{glossary} for the used terminology.
...
\item The keys for your application, called say {\itshape myapp}, should be created under {\ttfamily @p /sw/org/myapp/\#0/current}
\begin{DoxyItemize}
