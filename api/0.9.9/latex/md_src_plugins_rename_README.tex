...
\item basic
\item advanced
\end{DoxyItemize}\hypertarget{md_src_plugins_rename_README_autotoc_md470}{}\doxysection{Basic Transformations}\label{md_src_plugins_rename_README_autotoc_md470}
are applied before and after the advanced transformations.\hypertarget{md_src_plugins_rename_README_autotoc_md471}{}\doxysubsection{Get}\label{md_src_plugins_rename_README_autotoc_md471}
...
converts the whole keyname below the parent\+Key to upper-\/ or lowercase. if no configuration or {\ttfamily unchanged} is used no transformation is done here.\hypertarget{md_src_plugins_rename_README_autotoc_md472}{}\doxysubsection{Set}\label{md_src_plugins_rename_README_autotoc_md472}
...
{\ttfamily keyname} tells the plugin to keep the name of the advanced transformation\hypertarget{md_src_plugins_rename_README_autotoc_md473}{}\doxysection{Advanced Transformations}\label{md_src_plugins_rename_README_autotoc_md473}
\hypertarget{md_src_plugins_rename_README_autotoc_md474}{}\doxysubsection{Cut}\label{md_src_plugins_rename_README_autotoc_md474}
\hypertarget{md_src_plugins_rename_README_autotoc_md475}{}\doxysubsubsection{Operation}\label{md_src_plugins_rename_README_autotoc_md475}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_rename_README_autotoc_md476}{}\doxysubsubsection{Configuration}\label{md_src_plugins_rename_README_autotoc_md476}
...
If an invalid configuration is given or the cut operation would cause a parent key duplicate, the affected keys are simply skipped and not renamed.\hypertarget{md_src_plugins_rename_README_autotoc_md477}{}\doxysubsection{Replace}\label{md_src_plugins_rename_README_autotoc_md477}
Using the {\ttfamily /replacewith} global key or {\ttfamily rename/to} Meta\+Key the rename plugin will replace the part removed by {\ttfamily cut} with the supplied String\hypertarget{md_src_plugins_rename_README_autotoc_md478}{}\doxysubsubsection{To upper/lower}\label{md_src_plugins_rename_README_autotoc_md478}
...
you can use {\ttfamily tolower=0} to get the keys {\ttfamily key} and {\ttfamily other/key}.\hypertarget{md_src_plugins_rename_README_autotoc_md479}{}\doxysubsubsection{Examples}\label{md_src_plugins_rename_README_autotoc_md479}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_rename_README_autotoc_md480}{}\doxysection{Planned Operations}\label{md_src_plugins_rename_README_autotoc_md480}
