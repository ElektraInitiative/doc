\hypertarget{classkdb_1_1KDB}{}\section{kdb\+:\+:K\+DB Class Reference}
\label{classkdb_1_1KDB}\index{kdb\+::\+K\+DB@{kdb\+::\+K\+DB}}
...
\begin{DoxyCompactList}\small\item\em Constructs a class \hyperlink{classkdb_1_1KDB}{K\+DB}. \end{DoxyCompactList}\item 
\hyperlink{classkdb_1_1KDB_adecb001cb936bd869ef06c7c71fdf0ef}{K\+DB} (\hyperlink{classkdb_1_1KeySet}{Key\+Set} \&contract)
\begin{DoxyCompactList}\small\item\em Constructs a class \hyperlink{classkdb_1_1KDB}{K\+DB}. \end{DoxyCompactList}\item 
\hyperlink{classkdb_1_1KDB_a95ef4570ac2d7ddbe2b4c0ad7810c742}{K\+DB} (\hyperlink{classkdb_1_1KeySet}{Key\+Set} \&contract, \hyperlink{classkdb_1_1Key}{Key} \&error\+Key)
\begin{DoxyCompactList}\small\item\em Constructs a class \hyperlink{classkdb_1_1KDB}{K\+DB}. \end{DoxyCompactList}\item 
...
virtual void \hyperlink{classkdb_1_1KDB_a8bd17da51bd531a2726185e7bbf4ecf9}{open} (\hyperlink{classkdb_1_1KeySet}{Key\+Set} \&contract, \hyperlink{classkdb_1_1Key}{Key} \&error\+Key)
\begin{DoxyCompactList}\small\item\em Open the database. \end{DoxyCompactList}\item 
...
\end{DoxyPrecond}
The method will bootstrap itself the following way. The first step is to open the default backend. With it system\+:/elektra/mountpoints will be loaded and all needed libraries and mountpoints will be determined. Then the global plugins and global keyset data from the {\ttfamily contract} is processed. Finally, the libraries for backends will be loaded and with it the {\ttfamily \hyperlink{classkdb_1_1KDB}{K\+DB}} data structure will be initialized.
...
\{
        ...
        \hyperlink{classkdb_1_1KDB_a7e0637995ce9f294cdbc6f167df6db40}{KDB} * h = \hyperlink{group__kdb_ga844e1299a84c3fbf1d3a905c5c893ba5}{kdbOpen} (NULL, parent);
...
\}
\end{DoxyCodeInclude}
 You don\textquotesingle{}t need \hyperlink{group__kdb_ga844e1299a84c3fbf1d3a905c5c893ba5}{kdb\+Open()} if you only want to manipulate plain in-\/memory \hyperlink{classkdb_1_1Key}{Key} or \hyperlink{classkdb_1_1KeySet}{Key\+Set} objects.
...
{\em contract} & the contract that should be ensured before opening the \hyperlink{classkdb_1_1KDB}{K\+DB} all data is copied and the \hyperlink{classkdb_1_1KeySet}{Key\+Set} can safely be used for e.\+g. \hyperlink{group__kdb_ga28e385fd9cb7ccfe0b2f1ed2f62453a1}{kdb\+Get()} later \\
\hline
...
\index{kdb\+::\+K\+DB@{kdb\+::\+K\+DB}!K\+DB@{K\+DB}}
\index{K\+DB@{K\+DB}!kdb\+::\+K\+DB@{kdb\+::\+K\+DB}}
\subsubsection{\texorpdfstring{K\+D\+B()}{KDB()}\hspace{0.1cm}{\footnotesize\ttfamily [1/4]}}
...
\index{kdb\+::\+K\+DB@{kdb\+::\+K\+DB}!K\+DB@{K\+DB}}
\index{K\+DB@{K\+DB}!kdb\+::\+K\+DB@{kdb\+::\+K\+DB}}
\subsubsection{\texorpdfstring{K\+D\+B()}{KDB()}\hspace{0.1cm}{\footnotesize\ttfamily [2/4]}}
...
\index{kdb\+::\+K\+DB@{kdb\+::\+K\+DB}!K\+DB@{K\+DB}}
\index{K\+DB@{K\+DB}!kdb\+::\+K\+DB@{kdb\+::\+K\+DB}}
\subsubsection{\texorpdfstring{K\+D\+B()}{KDB()}\hspace{0.1cm}{\footnotesize\ttfamily [3/4]}}
{\footnotesize\ttfamily kdb\+::\+K\+D\+B\+::\+K\+DB (\begin{DoxyParamCaption}\item[{\hyperlink{classkdb_1_1KeySet}{Key\+Set} \&}]{contract }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [explicit]}}
...
\index{kdb\+::\+K\+DB@{kdb\+::\+K\+DB}!K\+DB@{K\+DB}}
\index{K\+DB@{K\+DB}!kdb\+::\+K\+DB@{kdb\+::\+K\+DB}}
\subsubsection{\texorpdfstring{K\+D\+B()}{KDB()}\hspace{0.1cm}{\footnotesize\ttfamily [4/4]}}
{\footnotesize\ttfamily kdb\+::\+K\+D\+B\+::\+K\+DB (\begin{DoxyParamCaption}\item[{\hyperlink{classkdb_1_1KeySet}{Key\+Set} \&}]{contract,  }\item[{\hyperlink{classkdb_1_1Key}{Key} \&}]{error\+Key }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
\index{kdb\+::\+K\+DB@{kdb\+::\+K\+DB}!close@{close}}
\index{close@{close}!kdb\+::\+K\+DB@{kdb\+::\+K\+DB}}
...
\index{kdb\+::\+K\+DB@{kdb\+::\+K\+DB}!get@{get}}
\index{get@{get}!kdb\+::\+K\+DB@{kdb\+::\+K\+DB}}
...
\hyperlink{classkdb_1_1KDB_a7e0637995ce9f294cdbc6f167df6db40}{KDB} * handle = \hyperlink{group__kdb_ga844e1299a84c3fbf1d3a905c5c893ba5}{kdbOpen} (NULL, key);
...
If you want to be sure to get a fresh keyset again, you need to open a second handle to the key database using \hyperlink{group__kdb_ga844e1299a84c3fbf1d3a905c5c893ba5}{kdb\+Open()}.
...
\hyperlink{group__kdb_ga844e1299a84c3fbf1d3a905c5c893ba5}{kdb\+Open()} which needs to be called before 
...
\index{kdb\+::\+K\+DB@{kdb\+::\+K\+DB}!open@{open}}
\index{open@{open}!kdb\+::\+K\+DB@{kdb\+::\+K\+DB}}
...
{\footnotesize\ttfamily void kdb\+::\+K\+D\+B\+::open (\begin{DoxyParamCaption}\item[{\hyperlink{classkdb_1_1KeySet}{Key\+Set} \&}]{contract,  }\item[{\hyperlink{classkdb_1_1Key}{Key} \&}]{error\+Key }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}
...
\index{kdb\+::\+K\+DB@{kdb\+::\+K\+DB}!set@{set}}
\index{set@{set}!kdb\+::\+K\+DB@{kdb\+::\+K\+DB}}
...
The {\ttfamily parent\+Key} \hyperlink{classkdb_1_1Key}{Key} must be a valid \hyperlink{classkdb_1_1Key}{Key}, e.\+g. constructed with \hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{key\+New()}. It must not have read-\/only name, value or metadata.
\end{DoxyPrecond}
...
\hyperlink{classkdb_1_1KDB_a7e0637995ce9f294cdbc6f167df6db40}{KDB} * handle = \hyperlink{group__kdb_ga844e1299a84c3fbf1d3a905c5c893ba5}{kdbOpen} (NULL, parentKey);
...
\hline
{\em -\/1} & on failure, no changes in \hyperlink{classkdb_1_1KDB}{K\+DB}, an error will be set on {\ttfamily parent\+Key} if possible (see \char`\"{}\+Errors\char`\"{} above) \\
\hline
\end{DoxyRetVals}
\begin{DoxySeeAlso}{See also}
