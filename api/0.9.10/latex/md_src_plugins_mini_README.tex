...
\end{DoxyCode}
\hypertarget{md_src_plugins_mini_README_autotoc_md338}{}\doxysubsubsection{Escaping}\label{md_src_plugins_mini_README_autotoc_md338}
...
In the case of {\bfseries{key names}} you {\bfseries{must not use any of the characters mentioned above}} ({\ttfamily ;}, {\ttfamily \#} and {\ttfamily =}) at all. Otherwise the behavior of the plugin will be {\bfseries{undefined}}.\hypertarget{md_src_plugins_mini_README_autotoc_md339}{}\doxysubsection{Limitations}\label{md_src_plugins_mini_README_autotoc_md339}
