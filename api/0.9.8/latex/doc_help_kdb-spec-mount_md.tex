...
\Hypertarget{doc_help_kdb-spec-mount_md_md_doc_help_kdb_spec_mount}%
 \hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2557}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-spec-mount_md_autotoc_md2557}
...
{\ttfamily kdb smount} is an alias and can be used in the same way as {\ttfamily kdb spec-\/mount}.\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2558}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-spec-mount_md_autotoc_md2558}
...
\end{DoxyCode}
\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2559}{}\doxysection{IMPORTANT}\label{doc_help_kdb-spec-mount_md_autotoc_md2559}
...
\end{DoxyCode}
\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2560}{}\doxysection{OPTIONS}\label{doc_help_kdb-spec-mount_md_autotoc_md2560}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2561}{}\doxysection{KDB}\label{doc_help_kdb-spec-mount_md_autotoc_md2561}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2562}{}\doxysection{EXAMPLES}\label{doc_help_kdb-spec-mount_md_autotoc_md2562}
...
Additionally, add {\ttfamily ini} plugin (instead of some default resolver) with a config for INI\+:~\newline
 {\ttfamily sudo kdb spec-\/mount /example ini section=NULL}\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2563}{}\doxysection{SEE ALSO}\label{doc_help_kdb-spec-mount_md_autotoc_md2563}
