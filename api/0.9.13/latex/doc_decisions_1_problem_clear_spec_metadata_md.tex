\label{doc_decisions_1_problem_clear_spec_metadata_md_md_doc_decisions_1_problem_clear_spec_metadata}%
\Hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_md_doc_decisions_1_problem_clear_spec_metadata}%
 \hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1964}{}\doxysection{Problem}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1964}
...
If metadata is merged from different namespaces, e.\+g., {\ttfamily spec\+:} and {\ttfamily user\+:}; metadata from one namespace might end up in keys of other namespaces, e.\+g.; metadata from {\ttfamily spec\+:} might end up in {\ttfamily user\+:}.\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1965}{}\doxysection{Constraints}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1965}
...
\end{DoxyItemize}\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1966}{}\doxysection{Assumptions}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1966}

\begin{DoxyItemize}
\item Metadata can always safely merged from {\ttfamily spec\+:/} to other namespace.
\end{DoxyItemize}\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1967}{}\doxysection{Considered Alternatives}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1967}
...
\end{DoxyItemize}\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1968}{}\doxysection{Decision}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1968}
...
The {\ttfamily kdb mount} tool will add the {\ttfamily meta} plugin configuration when mounting a storage plugin to {\ttfamily spec\+:/}.\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1969}{}\doxysection{Rationale}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1969}
...
\end{DoxyItemize}\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1970}{}\doxysection{Implications}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1970}
...
\end{DoxyItemize}\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1971}{}\doxysection{Related Decisions}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1971}
...
\end{DoxyItemize}\hypertarget{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1972}{}\doxysection{Notes}\label{doc_decisions_1_problem_clear_spec_metadata_md_autotoc_md1972}
