...
We are proud to release Elektra 0.\+9.\+5.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3444}{}\doxysection{What is Elektra?}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3444}
...
You can try out the latest Elektra release using our docker image \href{https://hub.docker.com/r/elektra/elektra}{\texttt{ elektra/elektra}}. This is the quickest way to get started with Elektra without compiling and other obstacles, simply run {\ttfamily docker run -\/it elektra/elektra}.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3445}{}\doxysection{Highlights}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3445}
...
\label{_hl-1}%
\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3446}{}\doxysubsection{$<$tt$>$kdb\+Open$<$/tt$>$ Contracts}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3446}
...
For more information take a look at \mbox{\hyperlink{doc_dev_kdb-contracts_md}{doc/dev/kdb-\/contracts.md}}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3447}{}\doxysection{Plugins}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3447}
The following section lists news about the \href{https://www.libelektra.org/plugins/readme}{\texttt{ plugins}} we updated in this release.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3448}{}\doxysubsection{Cache}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3448}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3449}{}\doxysubsection{internalnotification}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3449}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3450}{}\doxysubsection{Dbus \& Dbusrecv}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3450}

\begin{DoxyItemize}
\item Internal changes to ensure compatibility with the new {\ttfamily elektra\+Notification\+Contract}. \+\_\+(Klemens Böswirth)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3451}{}\doxysubsection{YAML Smith \& Yan LR}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3451}

\begin{DoxyItemize}
\item Removed plugins {\ttfamily yamlsmith} and {\ttfamily yanlr}. \+\_\+(René Schwaiger)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3452}{}\doxysubsection{Zeromqsend \& Zeromqrecv}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3452}

\begin{DoxyItemize}
\item Internal changes to ensure compatibility with the new {\ttfamily elektra\+Notification\+Contract}. \+\_\+(Klemens Böswirth)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3453}{}\doxysection{Libraries}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3453}
The text below summarizes updates to the \href{https://www.libelektra.org/libraries/readme}{\texttt{ C (and C++)-\/based libraries}} of Elektra.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3454}{}\doxysubsection{Compatibility}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3454}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3455}{}\doxysubsection{Core}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3455}
\label{_key-copy}%
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3456}{}\doxysubsection{Io}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3456}

\begin{DoxyItemize}
\item {\ttfamily elektra\+Set\+Io\+Binding} has been removed. Use {\ttfamily elektra\+Io\+Contract} instead. \+\_\+(Klemens Böswirth)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3457}{}\doxysubsection{Notification}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3457}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3458}{}\doxysection{Bindings}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3458}
Bindings allow you to utilize Elektra using \href{https://www.libelektra.org/bindings/readme}{\texttt{ various programming languages}}. This section keeps you up to date with the multi-\/language support provided by Elektra.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3459}{}\doxysubsection{JNA}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3459}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3460}{}\doxysubsubsection{Outlook}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3460}
Ongoing work on bringing the JNA binding up to scratch and improving developer experience. Both for JNA binding API consumers, as well as future JNA binding contrubutors. \+\_\+(\+Michael Tucek)\+\_\+\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3461}{}\doxysubsection{Python \& Lua}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3461}
Add support for keyset.\+remove(key). \+\_\+(\+Manuel Mausz)\+\_\+\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3462}{}\doxysection{Tools}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3462}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3463}{}\doxysection{Examples}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3463}

\begin{DoxyItemize}
\item Fix enums in examples/spec. \+\_\+(\+Markus Raab)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3464}{}\doxysection{Documentation}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3464}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3465}{}\doxysection{Tests}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3465}

\begin{DoxyItemize}
\item Added small test for jna Return plugin ({\ttfamily Return.\+java}), {\ttfamily Key\+Name\+Iterator.\+java} \+\_\+(@aaronabebe)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3466}{}\doxysection{Packaging}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3466}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3467}{}\doxysection{Build}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3467}
\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3468}{}\doxysubsection{CMake}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3468}

\begin{DoxyItemize}
\item Fix issue where the library runpaths of the jni plugin could not be resolved. \+\_\+(\+Robert Sowula)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3469}{}\doxysubsection{Docker}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3469}

\begin{DoxyItemize}
\item Update Alpine Linux images to version 3.\+13.\+1 and update Elektra release image. \+\_\+(Mihael Pranjić)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3470}{}\doxysection{Infrastructure}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3470}
\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3471}{}\doxysubsection{Cirrus}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3471}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3472}{}\doxysubsection{Git\+Hub Actions}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3472}

\begin{DoxyItemize}
\item Fix issues with {\ttfamily dbus} and java paths, exclude {\ttfamily jni}. \+\_\+(Mihael Pranjić)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3473}{}\doxysubsection{Jenkins}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3473}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3474}{}\doxysection{Website}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3474}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3475}{}\doxysection{Outlook}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3475}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3476}{}\doxysection{Statistics}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3476}
...
Thanks to all authors for making this release possible!\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3477}{}\doxysection{Join the Initiative!}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3477}
...
As first step, you could give us feedback about these release notes. Contact us via our \href{https://issues.libelektra.org}{\texttt{ issue tracker}}.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3478}{}\doxysection{Get the Release!}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3478}
...
Already built API-\/\+Docu can be found \href{https://doc.libelektra.org/api/0.9.5/html/}{\texttt{ here}} or on \href{https://github.com/ElektraInitiative/doc/tree/master/api/0.9.5}{\texttt{ Git\+Hub}}.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3479}{}\doxysection{Stay tuned!}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3479}
