...
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md418}{}\doxysubsection{$<$tt$>$benchmark\+\_\+storage$<$/tt$>$}\label{md_src_plugins_quickdump_benchmarks_autotoc_md418}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md419}{}\doxysubsection{$<$tt$>$benchmark\+\_\+plugingetset$<$/tt$>$}\label{md_src_plugins_quickdump_benchmarks_autotoc_md419}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md421}{}\doxysubsubsection{Version 1}\label{md_src_plugins_quickdump_benchmarks_autotoc_md421}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md422}{}\doxyparagraph{File sizes}\label{md_src_plugins_quickdump_benchmarks_autotoc_md422}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md423}{}\doxyparagraph{get and set}\label{md_src_plugins_quickdump_benchmarks_autotoc_md423}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md424}{}\doxyparagraph{get only}\label{md_src_plugins_quickdump_benchmarks_autotoc_md424}
The values are mean ± standard deviation. {\ttfamily factor} is {\ttfamily dump / quickdump} like above
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md425}{}\doxysubsubsection{Version 2}\label{md_src_plugins_quickdump_benchmarks_autotoc_md425}
Running the same {\ttfamily benchmark\+\_\+plugingetset} tests with version 2 of the plugin yields\+:\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md426}{}\doxyparagraph{File sizes}\label{md_src_plugins_quickdump_benchmarks_autotoc_md426}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md427}{}\doxyparagraph{get and set}\label{md_src_plugins_quickdump_benchmarks_autotoc_md427}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md428}{}\doxyparagraph{get only}\label{md_src_plugins_quickdump_benchmarks_autotoc_md428}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md429}{}\doxysubsubsection{Version 3}\label{md_src_plugins_quickdump_benchmarks_autotoc_md429}
Running the same {\ttfamily benchmark\+\_\+plugingetset} tests with version 3 of the plugin yields\+:\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md430}{}\doxyparagraph{File sizes}\label{md_src_plugins_quickdump_benchmarks_autotoc_md430}
{\ttfamily factor} is {\ttfamily v1 / v2} like above (bigger is better)
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md431}{}\doxyparagraph{get and set}\label{md_src_plugins_quickdump_benchmarks_autotoc_md431}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md432}{}\doxyparagraph{get only}\label{md_src_plugins_quickdump_benchmarks_autotoc_md432}
