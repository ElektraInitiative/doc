...
Allows to list all available backends.  
...
\begin{center}
\leavevmode
\includegraphics[width=300pt]{backends_8hpp__incl}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em Allows to list backends. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Allows to list all available backends. \begin{DoxyCopyright}{Copyright}
