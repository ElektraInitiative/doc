\hypertarget{doc_decisions_unit_testing_md_autotoc_md1361}{}\doxysection{Problem}\label{doc_decisions_unit_testing_md_autotoc_md1361}
The previous unit testing framework started as hack to have a bit more than simple asserts. It is not easy to use (needs explicit enumeration of all test cases) and lacks really important features (e.\+g. output of the assertion that failed).\hypertarget{doc_decisions_unit_testing_md_autotoc_md1362}{}\doxysection{Constraints}\label{doc_decisions_unit_testing_md_autotoc_md1362}
...
\item mocking?
\end{DoxyItemize}\hypertarget{doc_decisions_unit_testing_md_autotoc_md1363}{}\doxysection{Assumptions}\label{doc_decisions_unit_testing_md_autotoc_md1363}
\hypertarget{doc_decisions_unit_testing_md_autotoc_md1364}{}\doxysection{Considered Alternatives}\label{doc_decisions_unit_testing_md_autotoc_md1364}

\begin{DoxyItemize}
\item Continue with current framework
\item Boost Unit Testing framework
\end{DoxyItemize}\hypertarget{doc_decisions_unit_testing_md_autotoc_md1365}{}\doxysection{Decision}\label{doc_decisions_unit_testing_md_autotoc_md1365}
...
\end{DoxyItemize}\hypertarget{doc_decisions_unit_testing_md_autotoc_md1366}{}\doxysection{Rationale}\label{doc_decisions_unit_testing_md_autotoc_md1366}
...
\end{DoxyItemize}\hypertarget{doc_decisions_unit_testing_md_autotoc_md1367}{}\doxysection{Implications}\label{doc_decisions_unit_testing_md_autotoc_md1367}
...
\end{DoxyItemize}\hypertarget{doc_decisions_unit_testing_md_autotoc_md1368}{}\doxysection{Related Decisions}\label{doc_decisions_unit_testing_md_autotoc_md1368}

\begin{DoxyItemize}
\item \mbox{\hyperlink{doc_decisions_script_testing_md}{Script Testing}}
\end{DoxyItemize}\hypertarget{doc_decisions_unit_testing_md_autotoc_md1369}{}\doxysection{Notes}\label{doc_decisions_unit_testing_md_autotoc_md1369}
