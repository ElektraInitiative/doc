...
The configuration view of elektra-\/web is similar to the tree view of the \href{https://master.libelektra.org/src/tools/qt-gui}{\texttt{ qt-\/gui}}, but with dynamic fields rendered via key metadata.\hypertarget{doc_tutorials_install-webui_md_autotoc_md3608}{}\doxysection{Dependencies}\label{doc_tutorials_install-webui_md_autotoc_md3608}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3609}{}\doxysection{Building with elektra-\/web Tool}\label{doc_tutorials_install-webui_md_autotoc_md3609}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3610}{}\doxysection{Getting Started}\label{doc_tutorials_install-webui_md_autotoc_md3610}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3611}{}\doxysection{Getting Started (docker)}\label{doc_tutorials_install-webui_md_autotoc_md3611}

\begin{DoxyItemize}
\item Create and run a new docker container\+: {\ttfamily docker run -\/d -\/it -\/p 33333\+:33333 -\/p 33334\+:33334 elektra/web}
\item You can now access the client on\+: \href{http://localhost:33334}{\texttt{ http\+://localhost\+:33334}}
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3612}{}\doxysection{Running from source}\label{doc_tutorials_install-webui_md_autotoc_md3612}
...
\end{DoxyItemize}
\item You can now access the client on\+: \href{http://localhost:33334}{\texttt{ http\+://localhost\+:33334}}
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3613}{}\doxysection{Use-\/cases}\label{doc_tutorials_install-webui_md_autotoc_md3613}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3614}{}\doxysubsection{Running elektra-\/web on a Single Instance}\label{doc_tutorials_install-webui_md_autotoc_md3614}
...
Now, when you open \href{http://localhost:33334}{\texttt{ http\+://localhost\+:33334}} in your browser, the configuration page for the instance will be opened immediately.\hypertarget{doc_tutorials_install-webui_md_autotoc_md3615}{}\doxysubsection{Using a Different $<$tt$>$kdb$<$/tt$>$ Executable}\label{doc_tutorials_install-webui_md_autotoc_md3615}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3616}{}\doxysection{Overview}\label{doc_tutorials_install-webui_md_autotoc_md3616}
...
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3617}{}\doxysection{API}\label{doc_tutorials_install-webui_md_autotoc_md3617}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3618}{}\doxysection{Test REST API on localhost}\label{doc_tutorials_install-webui_md_autotoc_md3618}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3619}{}\doxysection{Auth}\label{doc_tutorials_install-webui_md_autotoc_md3619}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3621}{}\doxysection{Development Guides}\label{doc_tutorials_install-webui_md_autotoc_md3621}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3622}{}\doxysubsection{Updating Dependencies}\label{doc_tutorials_install-webui_md_autotoc_md3622}
...
Check for outdated dependencies via {\ttfamily npm outdated}. Dependencies can then be updated by running {\ttfamily npm update}.\hypertarget{doc_tutorials_install-webui_md_autotoc_md3623}{}\doxysubsection{Building Docker Image}\label{doc_tutorials_install-webui_md_autotoc_md3623}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3624}{}\doxysubsection{Adding Support for New Metadata}\label{doc_tutorials_install-webui_md_autotoc_md3624}
