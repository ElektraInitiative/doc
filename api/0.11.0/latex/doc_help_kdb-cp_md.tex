...
\Hypertarget{doc_help_kdb-cp_md_md_doc_help_kdb_cp}%
 \hypertarget{doc_help_kdb-cp_md_autotoc_md2885}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-cp_md_autotoc_md2885}
{\ttfamily kdb cp $<$source$>$ $<$dest$>$}\hypertarget{doc_help_kdb-cp_md_autotoc_md2886}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-cp_md_autotoc_md2886}
...
The argument {\ttfamily source} is the path of the key(s) you want to copy and {\ttfamily dest} is the path where you would like to copy the key(s) to. Note that when using the {\ttfamily -\/r} flag, {\ttfamily source} as well as all the keys below will be copied.\hypertarget{doc_help_kdb-cp_md_autotoc_md2887}{}\doxysection{LIMITATIONS}\label{doc_help_kdb-cp_md_autotoc_md2887}
Neither {\ttfamily source} nor {\ttfamily dest} can be a cascading key. (Start with {\ttfamily /}). Make sure to select a namespace.\hypertarget{doc_help_kdb-cp_md_autotoc_md2888}{}\doxysection{RETURN VALUES}\label{doc_help_kdb-cp_md_autotoc_md2888}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-cp_md_autotoc_md2889}{}\doxysection{OPTIONS}\label{doc_help_kdb-cp_md_autotoc_md2889}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-cp_md_autotoc_md2890}{}\doxysection{EXAMPLES}\label{doc_help_kdb-cp_md_autotoc_md2890}
