...
This plugin is a logging plugin which prints a timestamp during all placements of backend.\hypertarget{md_src_plugins_timeofday_README_autotoc_md535}{}\doxysection{Installation}\label{md_src_plugins_timeofday_README_autotoc_md535}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/extra}.\hypertarget{md_src_plugins_timeofday_README_autotoc_md536}{}\doxysection{Usage}\label{md_src_plugins_timeofday_README_autotoc_md536}
...
The first digit column shows the complete time passed, the second column shows the time from invocation to invocation.\hypertarget{md_src_plugins_timeofday_README_autotoc_md537}{}\doxysection{Module Loading}\label{md_src_plugins_timeofday_README_autotoc_md537}
