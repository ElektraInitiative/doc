...
\begin{center}
\leavevmode
\includegraphics[width=342pt]{interactivemergestrategy_8hpp__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=220pt]{interactivemergestrategy_8hpp__dep__incl}
\end{center}
\end{figure}
...
Interactive merge strategy asking for user input at each step. \begin{DoxyCopyright}{Copyright}
