...
With exception of the parameters of \mbox{\hyperlink{group__keytest_gaf6e66e12fe04d535a5d1c8218ced803e}{key\+Cmp()}}, the following contract holds for all parameters of type Key\+: \begin{DoxyPrecond}{Precondition}
The Key has been properly initialized via \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{key\+New()}} 
\end{DoxyPrecond}
...
\end{DoxyInvariant}
\begin{DoxyPostcond}{Postcondition}
If the result is 0, {\ttfamily k1} and {\ttfamily k2} cannot be used in the same Key\+Set
\end{DoxyPostcond}
