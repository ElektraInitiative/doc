...
\Hypertarget{doc_decisions_0a_postponed_validation_md_md_doc_decisions_0a_postponed_validation}%
 \hypertarget{doc_decisions_0a_postponed_validation_md_autotoc_md1863}{}\doxysection{Problem}\label{doc_decisions_0a_postponed_validation_md_autotoc_md1863}
...
If validation of a key fails, each plugin decides on its own how to handle the issue and proceed in ways that might be different from what is expected or desired.\hypertarget{doc_decisions_0a_postponed_validation_md_autotoc_md1864}{}\doxysection{Constraints}\label{doc_decisions_0a_postponed_validation_md_autotoc_md1864}
\hypertarget{doc_decisions_0a_postponed_validation_md_autotoc_md1865}{}\doxysection{Assumptions}\label{doc_decisions_0a_postponed_validation_md_autotoc_md1865}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0a_postponed_validation_md_autotoc_md1866}{}\doxysection{Considered Alternatives}\label{doc_decisions_0a_postponed_validation_md_autotoc_md1866}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0a_postponed_validation_md_autotoc_md1867}{}\doxysection{Decision}\label{doc_decisions_0a_postponed_validation_md_autotoc_md1867}
Don\textquotesingle{}t do anything for 1.\+0.

Later, maybe introduce a wrapper plugin to iterate over the keyset and delegate the validation of each key to the corresponding validation plugin.\hypertarget{doc_decisions_0a_postponed_validation_md_autotoc_md1868}{}\doxysection{Rationale}\label{doc_decisions_0a_postponed_validation_md_autotoc_md1868}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0a_postponed_validation_md_autotoc_md1869}{}\doxysection{Implications}\label{doc_decisions_0a_postponed_validation_md_autotoc_md1869}
...
Returning 1 if validation succeeded, 0 on failure\hypertarget{doc_decisions_0a_postponed_validation_md_autotoc_md1870}{}\doxysection{Related Decisions}\label{doc_decisions_0a_postponed_validation_md_autotoc_md1870}
\hypertarget{doc_decisions_0a_postponed_validation_md_autotoc_md1871}{}\doxysection{Notes}\label{doc_decisions_0a_postponed_validation_md_autotoc_md1871}
