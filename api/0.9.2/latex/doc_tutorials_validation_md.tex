\hypertarget{doc_tutorials_validation_md_autotoc_md2811}{}\doxysection{Introduction}\label{doc_tutorials_validation_md_autotoc_md2811}
...
Elektra provides a generic way to validate any configuration before it is written to disc.\hypertarget{doc_tutorials_validation_md_autotoc_md2812}{}\doxysection{User Interfaces}\label{doc_tutorials_validation_md_autotoc_md2812}
...
\end{DoxyEnumerate}\hypertarget{doc_tutorials_validation_md_autotoc_md2813}{}\doxysection{Metadata Together With Keys}\label{doc_tutorials_validation_md_autotoc_md2813}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_validation_md_autotoc_md2814}{}\doxysection{Get Started with $<$tt$>$spec$<$/tt$>$}\label{doc_tutorials_validation_md_autotoc_md2814}
These issues are resolved straightforward by separating the configuration from its configuration specification (often called schemata in X\+ML or J\+S\+ON). The purpose of the \mbox{\hyperlink{doc_tutorials_namespaces_md}{spec namespace}} is to hold the configuration specification, i.\+e., the description of how to validate the keys of all other namespaces.
...
\DoxyCodeLine{kdb rm -\/r user/tests/spec || kdb rm -\/r system/tests/spec}
\end{DoxyCode}
\hypertarget{doc_tutorials_validation_md_autotoc_md2815}{}\doxysubsection{Specfiles}\label{doc_tutorials_validation_md_autotoc_md2815}
...
Let us create an example {\itshape Specfile} in the dump format, which supports metadata (although the specfile is stored in the dump format, we can still create it using the human readable \mbox{\hyperlink{md_src_plugins_ni_README_src_plugins_ni_README_md}{ni format}} by using {\ttfamily kdb import})\+:
...
\end{DoxyCode}
\hypertarget{doc_tutorials_validation_md_autotoc_md2816}{}\doxysection{Rejecting Configuration Keys}\label{doc_tutorials_validation_md_autotoc_md2816}
