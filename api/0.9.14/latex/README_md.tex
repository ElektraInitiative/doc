...
Elektra provides a mature, consistent and easily comprehensible API. Its modularity effectively avoids code duplication across applications and tools concerning their configuration tasks. Elektra abstracts from cross-\/platform-\/related issues and enables applications to be aware of other applications\textquotesingle{} configurations, leveraging easy application integration.\hypertarget{README_md_autotoc_md4625}{}\doxysection{Often Used Links}\label{README_md_autotoc_md4625}
...
\end{DoxyItemize}\hypertarget{README_md_autotoc_md4626}{}\doxysection{Overview}\label{README_md_autotoc_md4626}
...
In case you are worried about linking to such a powerful library. The core is a small library implemented in C, works cross-\/platform, and does not need any external dependencies. There are bindings for other languages in case C is too low-\/level for you.\hypertarget{README_md_autotoc_md4627}{}\doxysection{Contact}\label{README_md_autotoc_md4627}
Do not hesitate to ask any question on \href{https://issues.libelektra.org/}{\texttt{ Git\+Hub issue tracker}} or directly to one of the \mbox{\hyperlink{doc_AUTHORS_md}{authors}}.\hypertarget{README_md_autotoc_md4628}{}\doxysection{Quickstart}\label{README_md_autotoc_md4628}
\hypertarget{README_md_autotoc_md4629}{}\doxysubsection{Installation}\label{README_md_autotoc_md4629}
...
\hypertarget{README_md_autotoc_md4630}{}\doxysubsection{Usage}\label{README_md_autotoc_md4630}
...
\end{DoxyItemize}\hypertarget{README_md_autotoc_md4631}{}\doxysubsection{Documentation}\label{README_md_autotoc_md4631}
...
\hypertarget{README_md_autotoc_md4632}{}\doxysection{Facts and Features}\label{README_md_autotoc_md4632}
...
\end{DoxyItemize}\hypertarget{README_md_autotoc_md4633}{}\doxysection{News}\label{README_md_autotoc_md4633}
Go to the \href{https://www.libelektra.org}{\texttt{ website}}, see the news, and its \href{https://www.libelektra.org/news/feed.rss}{\texttt{ RSS feed}}.\hypertarget{README_md_autotoc_md4634}{}\doxysection{Download}\label{README_md_autotoc_md4634}
...
Releases can be downloaded from \href{https://www.libelektra.org/ftp/elektra/releases/}{\texttt{ here}}.\hypertarget{README_md_autotoc_md4635}{}\doxysection{Build Server}\label{README_md_autotoc_md4635}
The \href{https://build.libelektra.org/}{\texttt{ build server}} builds Elektra for every pull request and on every commit in various ways and also produces \href{https://doc.libelektra.org/coverage/master/debian-buster-full/}{\texttt{ LCOV code coverage report}}.\hypertarget{README_md_autotoc_md4636}{}\doxysection{Contributing}\label{README_md_autotoc_md4636}
Take a look at \mbox{\hyperlink{doc_IDEAS_md}{how to start contributing}}.\hypertarget{README_md_autotoc_md4637}{}\doxysection{Goals}\label{README_md_autotoc_md4637}
