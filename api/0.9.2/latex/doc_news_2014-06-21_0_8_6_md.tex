...
\end{DoxyItemize}\hypertarget{doc_news_2014-06-21_0_8_6_md_autotoc_md1909}{}\doxysection{Introduction}\label{doc_news_2014-06-21_0_8_6_md_autotoc_md1909}
...
Additionally (not related to github), we now have a \href{https://doc.libelektra.org/coverage/master/debian-buster-full}{\texttt{ L\+C\+OV code coverage report}}!\hypertarget{doc_news_2014-06-21_0_8_6_md_autotoc_md1910}{}\doxysection{Improvements}\label{doc_news_2014-06-21_0_8_6_md_autotoc_md1910}
...
Clang, icc and gcc are now all supported and tested.\hypertarget{doc_news_2014-06-21_0_8_6_md_autotoc_md1911}{}\doxysection{Technical Previews}\label{doc_news_2014-06-21_0_8_6_md_autotoc_md1911}
...
The libtools library is back to life again! It has the same idea as its predecessor, but it is much more powerful. Because of the plugin system libtools is able to export and import any configuration format Elektra supports. Additionally it adds support for mounting backends. While most of its functionality is mature, the A\+PI is not final, though.\hypertarget{doc_news_2014-06-21_0_8_6_md_autotoc_md1912}{}\doxysection{A\+P\+I Changes}\label{doc_news_2014-06-21_0_8_6_md_autotoc_md1912}
The A\+PI and A\+BI is as always backwards-\/compatible within the 0.\+8 series.

This time it is, however, not forward-\/compatible (that means programs linked against 0.\+8.\+6 might not work with 0.\+8.\+5), because \mbox{\hyperlink{group__keyset_ga3604cc41505f7e19db945cece67190b6}{ks\+At\+Cursor()}} was added.
...
Note for maintainers\+: libelektratools now needs to be installed so that the kdb tool will work.\hypertarget{doc_news_2014-06-21_0_8_6_md_autotoc_md1913}{}\doxysection{Outlook}\label{doc_news_2014-06-21_0_8_6_md_autotoc_md1913}
...
Finally, as you already noticed, Ian Donnelly is working on a semantic 3-\/way merge to make distribution and package upgrades smoother. This is done as G\+S\+OC project. The progress is documented here\+: \href{http://community.libelektra.org/wp/}{\texttt{ http\+://community.\+libelektra.\+org/wp/}}\hypertarget{doc_news_2014-06-21_0_8_6_md_autotoc_md1914}{}\doxysection{Get It!}\label{doc_news_2014-06-21_0_8_6_md_autotoc_md1914}
