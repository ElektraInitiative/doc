...
\item {\ttfamily fcrypt}.
\end{DoxyEnumerate}\hypertarget{doc_tutorials_crypto_md_autotoc_md3741}{}\doxysection{Prerequisites -\/ Gnu\+PG}\label{doc_tutorials_crypto_md_autotoc_md3741}
...
The {\ttfamily fcrypt} plugin and the {\ttfamily crypto} plugin support both versions (version 1 and version 2) of GPG.\hypertarget{doc_tutorials_crypto_md_autotoc_md3742}{}\doxysection{Introduction}\label{doc_tutorials_crypto_md_autotoc_md3742}
...
We also show how to approach integrity with the signature features of the {\ttfamily fcrypt} plugin.\hypertarget{doc_tutorials_crypto_md_autotoc_md3743}{}\doxysection{Configuration File Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md3743}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3744}{}\doxysection{Configuration File Signatures}\label{doc_tutorials_crypto_md_autotoc_md3744}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3745}{}\doxysubsection{Combining Signatures and Encryption}\label{doc_tutorials_crypto_md_autotoc_md3745}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3746}{}\doxysection{Configuration Value Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md3746}
...
As a result you get \char`\"{}1234\char`\"{}.\hypertarget{doc_tutorials_crypto_md_autotoc_md3748}{}\doxysubsection{Disabling Encryption}\label{doc_tutorials_crypto_md_autotoc_md3748}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3749}{}\doxysubsection{Complete Example}\label{doc_tutorials_crypto_md_autotoc_md3749}
The complete example looks like this\+:
