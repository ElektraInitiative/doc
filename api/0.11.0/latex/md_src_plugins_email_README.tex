...
\hypertarget{md_src_plugins_email_README_autotoc_md199}{}\doxysubsection{Introduction}\label{md_src_plugins_email_README_autotoc_md199}
This plugin validates email addresses using regular expressions. The plugin does not support the full RFC5321 spec. For more information see \href{\#Limitations}{\texttt{ Limitations}} below.\hypertarget{md_src_plugins_email_README_autotoc_md200}{}\doxysubsection{Installation}\label{md_src_plugins_email_README_autotoc_md200}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/experimental}.\hypertarget{md_src_plugins_email_README_autotoc_md201}{}\doxysubsection{Usage}\label{md_src_plugins_email_README_autotoc_md201}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_email_README_autotoc_md202}{}\doxysubsection{Limitations}\label{md_src_plugins_email_README_autotoc_md202}
