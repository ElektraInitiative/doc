...
\Hypertarget{doc_decisions_elektra_web_recursive_md_md_doc_decisions_elektra_web_recursive}%
 \hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1763}{}\doxysection{Problem}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1763}
After deciding how to remotely manage instances and groups of instances (clusters) with Elektra Web, there is still the issue of recursively nested clusters (clusters of clusters).\hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1764}{}\doxysection{Constraints}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1764}
...
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1765}{}\doxysection{Assumptions}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1765}

\begin{DoxyItemize}
\item Use one cluster daemon (clusterd) to manage all clusters and instances.
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1766}{}\doxysection{Considered Alternatives}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1766}
...
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1767}{}\doxysection{Decision}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1767}
Managing the hierarchy in a single clusterd instance.\hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1768}{}\doxysection{Rationale}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1768}
