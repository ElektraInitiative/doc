...
\end{DoxyNote}
So it is shallow copy, to create a deep copy you have to \hyperlink{classkdb_1_1KeySet_a72d0b50194fb1900c468b53e749369a2}{dup()} every key (it still won't copy metadata, but they are C\+O\+W)\+: 
\begin{DoxyCodeInclude}
