...
The {\ttfamily blockresolver} can be used to only resolve a tagged block inside a configuration file.\hypertarget{md_src_plugins_blockresolver_README_autotoc_md60}{}\doxysection{Installation}\label{md_src_plugins_blockresolver_README_autotoc_md60}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/experimental}.\hypertarget{md_src_plugins_blockresolver_README_autotoc_md61}{}\doxysubsection{Implementation Details}\label{md_src_plugins_blockresolver_README_autotoc_md61}
{\ttfamily blockresolver} extracts the requested block from the configurations file and writes it into a temporary file. Afterwards Elektra will only work on the temporary file until kdb\+Set is called. On kdb\+Set the contents of the temporary file will be merged with parts outside of the requested block from the original file.\hypertarget{md_src_plugins_blockresolver_README_autotoc_md62}{}\doxysection{Usage}\label{md_src_plugins_blockresolver_README_autotoc_md62}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_blockresolver_README_autotoc_md63}{}\doxysection{Limitations}\label{md_src_plugins_blockresolver_README_autotoc_md63}
Currently the identifier must be unique.\hypertarget{md_src_plugins_blockresolver_README_autotoc_md64}{}\doxysection{Example}\label{md_src_plugins_blockresolver_README_autotoc_md64}
