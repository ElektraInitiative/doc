...
\Hypertarget{doc_tutorials_arrays_md_md_doc_tutorials_arrays}%
 \hypertarget{doc_tutorials_arrays_md_autotoc_md3450}{}\doxysection{Key-\/\+Value Pairs}\label{doc_tutorials_arrays_md_autotoc_md3450}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md3451}{}\doxysection{Array Keys}\label{doc_tutorials_arrays_md_autotoc_md3451}
Since Elektra sorts keys alphabetically we can use the key-\/value pair structure described above to store sequences of values (aka. arrays).\hypertarget{doc_tutorials_arrays_md_autotoc_md3452}{}\doxysubsection{Empty Arrays}\label{doc_tutorials_arrays_md_autotoc_md3452}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md3453}{}\doxysubsection{Array Elements}\label{doc_tutorials_arrays_md_autotoc_md3453}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md3454}{}\doxysubsection{Metadata}\label{doc_tutorials_arrays_md_autotoc_md3454}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md3455}{}\doxysection{Closing Remarks}\label{doc_tutorials_arrays_md_autotoc_md3455}
