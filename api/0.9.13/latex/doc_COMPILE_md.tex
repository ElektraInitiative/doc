...
\Hypertarget{doc_COMPILE_md_md_doc_COMPILE}%
 \hypertarget{doc_COMPILE_md_autotoc_md763}{}\doxysection{Dependencies}\label{doc_COMPILE_md_autotoc_md763}
...
\end{DoxyCode}
\hypertarget{doc_COMPILE_md_autotoc_md764}{}\doxysection{Quick Guide}\label{doc_COMPILE_md_autotoc_md764}
...
The last line only runs tests without writing onto your system. See \mbox{\hyperlink{doc_TESTING_md}{TESTING}} for how to run more tests. Afterwards you can use {\ttfamily sudo make install \&\& sudo ldconfig} to install Elektra. See \mbox{\hyperlink{doc_INSTALL_md}{INSTALL}} for more information about installation of self-\/compiled Elektra (such as how to uninstall it).\hypertarget{doc_COMPILE_md_autotoc_md765}{}\doxysection{Optional Dependencies}\label{doc_COMPILE_md_autotoc_md765}
\begin{quote}
...
\hypertarget{doc_COMPILE_md_autotoc_md766}{}\doxysubsection{Documentation dependencies}\label{doc_COMPILE_md_autotoc_md766}
...
\end{DoxyCode}
\hypertarget{doc_COMPILE_md_autotoc_md767}{}\doxysubsection{Plugin dependencies}\label{doc_COMPILE_md_autotoc_md767}
...
\end{DoxyCode}
\hypertarget{doc_COMPILE_md_autotoc_md768}{}\doxysection{Preparation}\label{doc_COMPILE_md_autotoc_md768}
...
Some scripts in the folder of the same name may help you running CMake.\hypertarget{doc_COMPILE_md_autotoc_md769}{}\doxysubsection{Compilers}\label{doc_COMPILE_md_autotoc_md769}
...
To change the compiler with {\ttfamily ccmake}, you may need to toggle advanced options (key {\ttfamily t}).\hypertarget{doc_COMPILE_md_autotoc_md770}{}\doxysubsection{Options}\label{doc_COMPILE_md_autotoc_md770}
...
Examples for this are especially in the subsection {\ttfamily PLUGINS} below, but they work in the same fashion for {\ttfamily BINDINGS} and {\ttfamily TOOLS}.\hypertarget{doc_COMPILE_md_autotoc_md771}{}\doxysubsubsection{Plugins}\label{doc_COMPILE_md_autotoc_md771}
...
You can add resolver with any combination of the flags, even if they are not available in {\ttfamily ALL}.\hypertarget{doc_COMPILE_md_autotoc_md772}{}\doxysubsubsection{Tools}\label{doc_COMPILE_md_autotoc_md772}
...
\end{DoxyCode}
\hypertarget{doc_COMPILE_md_autotoc_md773}{}\doxysubsubsection{Bindings}\label{doc_COMPILE_md_autotoc_md773}
...
For a list of available bindings see binding\textquotesingle{}s README.md.\hypertarget{doc_COMPILE_md_autotoc_md774}{}\doxysubsubsection{$<$tt$>$\+CMAKE\+\_\+\+BUILD\+\_\+\+TYPE$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md774}
{\ttfamily Debug}, {\ttfamily Release} or {\ttfamily Rel\+With\+Deb\+Info} See help bar at bottom of {\ttfamily ccmake} for that option or\+: \href{https://www.cmake.org/Wiki/CMake_Useful_Variables}{\texttt{ https\+://www.\+cmake.\+org/\+Wiki/\+CMake\+\_\+\+Useful\+\_\+\+Variables}}\hypertarget{doc_COMPILE_md_autotoc_md775}{}\doxysubsubsection{$<$tt$>$\+BUILD\+\_\+\+SHARED$<$/tt$>$, $<$tt$>$\+BUILD\+\_\+\+FULL$<$/tt$>$ and $<$tt$>$\+BUILD\+\_\+\+STATIC$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md775}
...
\end{DoxyCode}
\hypertarget{doc_COMPILE_md_autotoc_md776}{}\doxysubsubsection{$<$tt$>$\+BUILD\+\_\+\+DOCUMENTATION$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md776}
...
\hypertarget{doc_COMPILE_md_autotoc_md777}{}\doxysubsubsection{$<$tt$>$\+BUILD\+\_\+\+PDF$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md777}
Build documentation with La\+TeX.

See \href{\#documentation-dependencies}{\texttt{ Documentation dependencies}} for the required dependencies.\hypertarget{doc_COMPILE_md_autotoc_md778}{}\doxysubsubsection{Developer Options}\label{doc_COMPILE_md_autotoc_md778}
...
Continue reading \mbox{\hyperlink{doc_TESTING_md}{testing}} for more information about testing.\hypertarget{doc_COMPILE_md_autotoc_md779}{}\doxysubsubsection{$<$tt$>$\+CMAKE\+\_\+\+INSTALL\+\_\+\+PREFIX$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md779}
...
If you want to create a package afterwards it is ok to use paths that you can write to (e.\+g. {\ttfamily -\/DCMAKE\+\_\+\+INSTALL\+\_\+\+PREFIX=/home/username/})\hypertarget{doc_COMPILE_md_autotoc_md780}{}\doxysubsubsection{$<$tt$>$\+LIB\+\_\+\+SUFFIX$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md780}
Lets you install libraries into architecture specific folder. E.\+g. for 32/64 bit systems you might install libraries under {\ttfamily lib64}. Set {\ttfamily LIB\+\_\+\+SUFFIX} to {\ttfamily 64} to achieve exactly that. So the system library folder will be {\ttfamily CMAKE\+\_\+\+INSTALL\+\_\+\+PREFIX/lib64} then.\hypertarget{doc_COMPILE_md_autotoc_md781}{}\doxysubsubsection{$<$tt$>$\+TARGET\+\_\+\+INCLUDE\+\_\+\+FOLDER$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md781}
By default include folders will be installed below {\ttfamily CMAKE\+\_\+\+INSTALL\+\_\+\+PREFIX/include/elektra}. This entry let you change the elektra. If the entry is empty, the include files will be installed directly to {\ttfamily CMAKE\+\_\+\+INSTALL\+\_\+\+PREFIX/include}.\hypertarget{doc_COMPILE_md_autotoc_md782}{}\doxysubsubsection{$<$tt$>$\+TARGET\+\_\+\+PLUGIN\+\_\+\+FOLDER$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md782}
Similar to above, but with the plugins. Default is\+: {\ttfamily CMAKE\+\_\+\+INSTALL\+\_\+\+PREFIX/lib\$\{LIB\+\_\+\+SUFFIX\}/elektra} It can be also left empty to install plugins next to other libraries.\hypertarget{doc_COMPILE_md_autotoc_md783}{}\doxysubsubsection{$<$tt$>$\+GTEST\+\_\+\+ROOT$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md783}
...
It is recommended that you browse through all the options using {\ttfamily ccmake}. Afterwards press {\ttfamily c} again (maybe multiple times until all variables are resolved) and then {\ttfamily g} to generate. Finally press {\ttfamily e} to exit.\hypertarget{doc_COMPILE_md_autotoc_md784}{}\doxysubsubsection{$<$tt$>$\+INSTALL\+\_\+\+BUILD\+\_\+\+TOOLS$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md784}
Specifies that the build tools, i.\+e. {\ttfamily elektra-\/export-\/symbols} and {\ttfamily elektra-\/export-\/symbols} are installed (by default off). Is needed for cross-\/compilation.\hypertarget{doc_COMPILE_md_autotoc_md785}{}\doxysubsubsection{$<$tt$>$\+INSTALL\+\_\+\+SYSTEM\+\_\+\+FILES$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md785}
...
\hypertarget{doc_COMPILE_md_autotoc_md786}{}\doxysubsubsection{$<$tt$>$\+ENABLE\+\_\+\+OPTIMIZATIONS$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md786}
In order to keep the binaries as small as possible this flag allows trading memory for speed.\hypertarget{doc_COMPILE_md_autotoc_md787}{}\doxysection{Building}\label{doc_COMPILE_md_autotoc_md787}
\hypertarget{doc_COMPILE_md_autotoc_md788}{}\doxysubsection{Without IDE}\label{doc_COMPILE_md_autotoc_md788}
...
Continue by reading \mbox{\hyperlink{doc_INSTALL_md}{INSTALL}}.\hypertarget{doc_COMPILE_md_autotoc_md789}{}\doxysubsection{With Code\+Blocks}\label{doc_COMPILE_md_autotoc_md789}
...
{\bfseries{Note 3\+:}} For Gentoo it\textquotesingle{}s recommended to emerge sys-\/apps/lsb-\/release to name the package right even thou not required.\hypertarget{doc_COMPILE_md_autotoc_md790}{}\doxysection{Maintainer\textquotesingle{}s Guide}\label{doc_COMPILE_md_autotoc_md790}
\hypertarget{doc_COMPILE_md_autotoc_md791}{}\doxysubsection{Multiarch}\label{doc_COMPILE_md_autotoc_md791}
...
\end{DoxyCode}
\hypertarget{doc_COMPILE_md_autotoc_md792}{}\doxysubsection{$<$tt$>$\+RPATH$<$/tt$>$}\label{doc_COMPILE_md_autotoc_md792}
...
Alternatively, which gives you the advantage not to clutter the main library path, is to add the plugin folder in {\ttfamily /etc/ld.so.\+conf.\+d/elektra}. Note that it still allows applications to link against plugins.\hypertarget{doc_COMPILE_md_autotoc_md793}{}\doxysection{Troubleshooting}\label{doc_COMPILE_md_autotoc_md793}
\hypertarget{doc_COMPILE_md_autotoc_md794}{}\doxysubsection{Dependencies not Available for Cent OS}\label{doc_COMPILE_md_autotoc_md794}
...
\end{DoxyCode}
\hypertarget{doc_COMPILE_md_autotoc_md795}{}\doxysubsection{Cross Compiling}\label{doc_COMPILE_md_autotoc_md795}
