...
\item \hyperlink{md_src_plugins_ini_README_src_plugins_ini_README_md}{ini} parses I\+NI files based on \href{http://code.google.com/p/inih/}{\tt inih}.
\item \hyperlink{md_src_plugins_yajl_README_src_plugins_yajl_README_md}{yajl} uses J\+S\+ON.
\end{DoxyItemize}
