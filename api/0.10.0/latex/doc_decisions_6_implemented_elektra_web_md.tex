...
\Hypertarget{doc_decisions_6_implemented_elektra_web_md_md_doc_decisions_6_implemented_elektra_web}%
 \hypertarget{doc_decisions_6_implemented_elektra_web_md_autotoc_md2315}{}\doxysection{Problem}\label{doc_decisions_6_implemented_elektra_web_md_autotoc_md2315}
For Elektra Web, there needs to be a way to remotely manage instances and groups of instances (clusters). The remote configuration of a single instance is simple. However, to manage multiple instances, we need to store the information to access the daemons, as well as information about the grouping (clusters) of daemons.\hypertarget{doc_decisions_6_implemented_elektra_web_md_autotoc_md2316}{}\doxysection{Constraints}\label{doc_decisions_6_implemented_elektra_web_md_autotoc_md2316}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_elektra_web_md_autotoc_md2317}{}\doxysection{Assumptions}\label{doc_decisions_6_implemented_elektra_web_md_autotoc_md2317}
\hypertarget{doc_decisions_6_implemented_elektra_web_md_autotoc_md2318}{}\doxysection{Considered Alternatives}\label{doc_decisions_6_implemented_elektra_web_md_autotoc_md2318}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_elektra_web_md_autotoc_md2319}{}\doxysection{Decision}\label{doc_decisions_6_implemented_elektra_web_md_autotoc_md2319}
Use one cluster daemon (clusterd) to manage all clusters and instances.\hypertarget{doc_decisions_6_implemented_elektra_web_md_autotoc_md2320}{}\doxysection{Rationale}\label{doc_decisions_6_implemented_elektra_web_md_autotoc_md2320}
