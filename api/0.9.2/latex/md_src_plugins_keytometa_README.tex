...
The keys are ordered by the \char`\"{}order\char`\"{} metadata. If two keys are equal according to the order metadata, they are ordered by name instead.\hypertarget{md_src_plugins_keytometa_README_autotoc_md367}{}\doxysection{Append Strategies}\label{md_src_plugins_keytometa_README_autotoc_md367}
The append strategy specifies which key will receive the resulting metadata. Currently the plugin supports the following strategies\+:\hypertarget{md_src_plugins_keytometa_README_autotoc_md368}{}\doxysubsection{Parent Strategy}\label{md_src_plugins_keytometa_README_autotoc_md368}
...
If child1, child2 and child3 were tagged with {\ttfamily convert/append = parent}, key1 would receive the metadata from child1 and child3. Key2 would receive the metadata from child2.\hypertarget{md_src_plugins_keytometa_README_autotoc_md369}{}\doxysubsection{Next Strategy}\label{md_src_plugins_keytometa_README_autotoc_md369}
...
If key1 and key3 were tagged with {\ttfamily convert/append = next}, key2 would receive the metadata resulting from key1 and key4 would receive the metadata resulting from key3.\hypertarget{md_src_plugins_keytometa_README_autotoc_md370}{}\doxysubsection{Previous Strategy}\label{md_src_plugins_keytometa_README_autotoc_md370}
...
If key2 and key4 were tagged with {\ttfamily convert/append = previous}, key1 would receive the metadata resulting from key2 and key3 would receive the metadata resulting from key4.\hypertarget{md_src_plugins_keytometa_README_autotoc_md371}{}\doxysection{Merging}\label{md_src_plugins_keytometa_README_autotoc_md371}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_keytometa_README_autotoc_md372}{}\doxysubsection{Same-\/\+Level Appending}\label{md_src_plugins_keytometa_README_autotoc_md372}
...
\DoxyCodeLine{    \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40ac66e4a49d09212b79f5754ca6db5bd2e}{KEY\_VALUE}}, \textcolor{stringliteral}{"*\#comment*"},}
\DoxyCodeLine{    \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40a040582834bb2d90049947d7ef74e87e2}{KEY\_META}}, \textcolor{stringliteral}{"convert/metaname"}, \textcolor{stringliteral}{"comment"},}
\DoxyCodeLine{    \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40a040582834bb2d90049947d7ef74e87e2}{KEY\_META}}, \textcolor{stringliteral}{"convert/append"}, \textcolor{stringliteral}{"next"},}
...
\DoxyCodeLine{    \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40ac66e4a49d09212b79f5754ca6db5bd2e}{KEY\_VALUE}}, \textcolor{stringliteral}{""}, \textcolor{comment}{/* disable the path matching mode */}}
\DoxyCodeLine{    \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END}})}
\DoxyCodeLine{\textcolor{comment}{// ...}}
\DoxyCodeLine{;}
\end{DoxyCode}
