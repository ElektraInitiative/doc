...
The configuration view of elektra-\/web is similar to the tree view of the \href{https://master.libelektra.org/src/tools/qt-gui}{\texttt{ qt-\/gui}}, but with dynamic fields rendered via key metadata.\hypertarget{doc_tutorials_install-webui_md_autotoc_md3569}{}\doxysection{Dependencies}\label{doc_tutorials_install-webui_md_autotoc_md3569}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3570}{}\doxysection{Building with elektra-\/web Tool}\label{doc_tutorials_install-webui_md_autotoc_md3570}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3571}{}\doxysection{Getting Started}\label{doc_tutorials_install-webui_md_autotoc_md3571}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3572}{}\doxysection{Getting Started (docker)}\label{doc_tutorials_install-webui_md_autotoc_md3572}

\begin{DoxyItemize}
\item Create and run a new docker container\+: {\ttfamily docker run -\/d -\/it -\/p 33333\+:33333 -\/p 33334\+:33334 elektra/web}
\item You can now access the client on\+: \href{http://localhost:33334}{\texttt{ http\+://localhost\+:33334}}
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3573}{}\doxysection{Running from source}\label{doc_tutorials_install-webui_md_autotoc_md3573}
...
\end{DoxyItemize}
\item You can now access the client on\+: \href{http://localhost:33334}{\texttt{ http\+://localhost\+:33334}}
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3574}{}\doxysection{Use-\/cases}\label{doc_tutorials_install-webui_md_autotoc_md3574}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3575}{}\doxysubsection{Running elektra-\/web on a Single Instance}\label{doc_tutorials_install-webui_md_autotoc_md3575}
...
Now, when you open \href{http://localhost:33334}{\texttt{ http\+://localhost\+:33334}} in your browser, the configuration page for the instance will be opened immediately.\hypertarget{doc_tutorials_install-webui_md_autotoc_md3576}{}\doxysubsection{Using a Different $<$tt$>$kdb$<$/tt$>$ Executable}\label{doc_tutorials_install-webui_md_autotoc_md3576}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3577}{}\doxysection{Overview}\label{doc_tutorials_install-webui_md_autotoc_md3577}
...
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3578}{}\doxysection{API}\label{doc_tutorials_install-webui_md_autotoc_md3578}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3579}{}\doxysection{Test REST API on localhost}\label{doc_tutorials_install-webui_md_autotoc_md3579}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3580}{}\doxysection{Auth}\label{doc_tutorials_install-webui_md_autotoc_md3580}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3582}{}\doxysection{Development Guides}\label{doc_tutorials_install-webui_md_autotoc_md3582}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3583}{}\doxysubsection{Updating Dependencies}\label{doc_tutorials_install-webui_md_autotoc_md3583}
...
Check for outdated dependencies via {\ttfamily npm outdated}. Dependencies can then be updated by running {\ttfamily npm update}.\hypertarget{doc_tutorials_install-webui_md_autotoc_md3584}{}\doxysubsection{Building Docker Image}\label{doc_tutorials_install-webui_md_autotoc_md3584}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3585}{}\doxysubsection{Adding Support for New Metadata}\label{doc_tutorials_install-webui_md_autotoc_md3585}
