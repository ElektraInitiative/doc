...
\Hypertarget{doc_decisions_simplify_api_md_md_doc_decisions_simplify_api}%
 \hypertarget{doc_decisions_simplify_api_md_autotoc_md2159}{}\doxysection{Problem}\label{doc_decisions_simplify_api_md_autotoc_md2159}
...
The urgency of this decision is that API can be easily introduced later but we cannot get rid of it after 1.\+0.\hypertarget{doc_decisions_simplify_api_md_autotoc_md2160}{}\doxysection{Constraints}\label{doc_decisions_simplify_api_md_autotoc_md2160}
To not disturb main features such as\+:


\begin{DoxyItemize}
\item 
\end{DoxyItemize}\hypertarget{doc_decisions_simplify_api_md_autotoc_md2161}{}\doxysection{Assumptions}\label{doc_decisions_simplify_api_md_autotoc_md2161}
Binary data is not a core feature, if needed the plugin system can also work without (properly tagged) binary data in key sets.\hypertarget{doc_decisions_simplify_api_md_autotoc_md2162}{}\doxysection{Considered Alternatives}\label{doc_decisions_simplify_api_md_autotoc_md2162}

\begin{DoxyItemize}
\item flags for binary data
\end{DoxyItemize}\hypertarget{doc_decisions_simplify_api_md_autotoc_md2163}{}\doxysection{Decision}\label{doc_decisions_simplify_api_md_autotoc_md2163}
...
\end{DoxyItemize}\hypertarget{doc_decisions_simplify_api_md_autotoc_md2164}{}\doxysection{Rationale}\label{doc_decisions_simplify_api_md_autotoc_md2164}
\hypertarget{doc_decisions_simplify_api_md_autotoc_md2165}{}\doxysection{Implications}\label{doc_decisions_simplify_api_md_autotoc_md2165}
\hypertarget{doc_decisions_simplify_api_md_autotoc_md2166}{}\doxysection{Related Decisions}\label{doc_decisions_simplify_api_md_autotoc_md2166}

\begin{DoxyItemize}
\item \mbox{\hyperlink{doc_decisions_binary_md}{Binary}}
\item \mbox{\hyperlink{doc_decisions_elektra_prefix_md}{Elektra Prefix}}
\end{DoxyItemize}\hypertarget{doc_decisions_simplify_api_md_autotoc_md2167}{}\doxysection{Notes}\label{doc_decisions_simplify_api_md_autotoc_md2167}
