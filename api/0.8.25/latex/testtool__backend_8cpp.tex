...
\index{testtool\+\_\+backend.\+cpp@{testtool\+\_\+backend.\+cpp}!output\+G\+Test@{output\+G\+Test}}
\index{output\+G\+Test@{output\+G\+Test}!testtool\+\_\+backend.\+cpp@{testtool\+\_\+backend.\+cpp}}
\subsubsection{\texorpdfstring{output\+G\+Test()}{outputGTest()}}
{\footnotesize\ttfamily void output\+G\+Test (\begin{DoxyParamCaption}\item[{\hyperlink{classkdb_1_1KeySet}{kdb\+::\+Key\+Set}}]{tocheck,  }\item[{std\+::string}]{name }\end{DoxyParamCaption})}
