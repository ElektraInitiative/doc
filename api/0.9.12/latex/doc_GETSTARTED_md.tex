...
\Hypertarget{doc_GETSTARTED_md_md_doc_GETSTARTED}%
 This document is intended for developers who want to get started with developing with Elektra.\hypertarget{doc_GETSTARTED_md_autotoc_md2688}{}\doxysection{Skill requirements}\label{doc_GETSTARTED_md_autotoc_md2688}
...
\end{DoxyItemize}\hypertarget{doc_GETSTARTED_md_autotoc_md2689}{}\doxysection{Software requirements}\label{doc_GETSTARTED_md_autotoc_md2689}
...
\end{DoxyCode}
\hypertarget{doc_GETSTARTED_md_autotoc_md2690}{}\doxysection{Installation}\label{doc_GETSTARTED_md_autotoc_md2690}
...
\end{DoxyCode}
\hypertarget{doc_GETSTARTED_md_autotoc_md2691}{}\doxysection{Hello first steps!}\label{doc_GETSTARTED_md_autotoc_md2691}
