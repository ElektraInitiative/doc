...
Plugin specific config.\hypertarget{md_src_plugins_list_README_autotoc_md388}{}\doxysection{Exported Functions}\label{md_src_plugins_list_README_autotoc_md388}
...
Finally, {\ttfamily elektra\+List\+Find\+Plugin} looks for a plugin in the config, and if found returns its handle.\hypertarget{md_src_plugins_list_README_autotoc_md389}{}\doxysection{Example}\label{md_src_plugins_list_README_autotoc_md389}
