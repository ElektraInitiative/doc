...
\begin{DoxyItemize}
\item {\ttfamily libaugeas-\/dev} \#note\+: You need version 0.\+16 or higher which is not in debian wheezy
\end{DoxyItemize}
...
/usr/lib/libaugeas.so.\+0\+: version `\+A\+U\+G\+E\+A\+S\+\_\+0.16.\+0' not found (required by kdb)
...
Note that, without configuring the plugin to use a lens, the plugin would bail out an error on the first usage\+: \begin{DoxyVerb}    kdb ls system/hosts
