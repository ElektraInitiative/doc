...
But let\textquotesingle{}s demonstrate this with an example\+:\hypertarget{doc_tutorials_cascading_md_autotoc_md4199}{}\doxysubsection{Add a Key to the system Namespace}\label{doc_tutorials_cascading_md_autotoc_md4199}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_cascading_md_autotoc_md4200}{}\doxysubsection{Add a Key to the user Namespace}\label{doc_tutorials_cascading_md_autotoc_md4200}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_cascading_md_autotoc_md4202}{}\doxysubsection{Add a Key to the proc Namespace}\label{doc_tutorials_cascading_md_autotoc_md4202}
The {\bfseries{proc}} namespace is not accessible by the command line tool {\bfseries{kdb}}, as it is unique for each running process using Elektra. So we have to omit an example for this namespace at this point. \mbox{\hyperlink{doc_help_elektra-glossary_md}{Elektrified}} applications can use this namespace to override configuration from other namespaces internally.\hypertarget{doc_tutorials_cascading_md_autotoc_md4203}{}\doxysubsection{Add a Key to the spec Namespace}\label{doc_tutorials_cascading_md_autotoc_md4203}
The {\bfseries{spec}} namespace is used to store metadata about keys and therefore Elektra handles the {\bfseries{spec}} namespace differently to other namespaces. The following part of the tutorial is dedicated to the impact of the {\bfseries{spec}} namespace on cascading lookups.\hypertarget{doc_tutorials_cascading_md_autotoc_md4204}{}\doxysection{Write Operations and the cascading Namespace}\label{doc_tutorials_cascading_md_autotoc_md4204}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_cascading_md_autotoc_md4205}{}\doxysection{Override Links}\label{doc_tutorials_cascading_md_autotoc_md4205}
