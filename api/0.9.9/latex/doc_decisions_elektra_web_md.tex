...
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_md_autotoc_md1782}{}\doxysection{Assumptions}\label{doc_decisions_elektra_web_md_autotoc_md1782}
\hypertarget{doc_decisions_elektra_web_md_autotoc_md1783}{}\doxysection{Considered Alternatives}\label{doc_decisions_elektra_web_md_autotoc_md1783}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_md_autotoc_md1784}{}\doxysection{Decision}\label{doc_decisions_elektra_web_md_autotoc_md1784}
Use one cluster daemon (clusterd) to manage all clusters and instances.\hypertarget{doc_decisions_elektra_web_md_autotoc_md1785}{}\doxysection{Rationale}\label{doc_decisions_elektra_web_md_autotoc_md1785}
