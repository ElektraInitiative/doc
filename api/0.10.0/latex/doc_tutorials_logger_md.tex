...
\Hypertarget{doc_tutorials_logger_md_md_doc_tutorials_logger}%
 \hypertarget{doc_tutorials_logger_md_autotoc_md4466}{}\doxysection{Quickstart}\label{doc_tutorials_logger_md_autotoc_md4466}
...
The file sink behaves like syslog, if it has been enabled (see below).\hypertarget{doc_tutorials_logger_md_autotoc_md4467}{}\doxysection{Step by Step Guide}\label{doc_tutorials_logger_md_autotoc_md4467}
\hypertarget{doc_tutorials_logger_md_autotoc_md4468}{}\doxysubsection{Preparation}\label{doc_tutorials_logger_md_autotoc_md4468}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md4469}{}\doxysubsubsection{Log Everything}\label{doc_tutorials_logger_md_autotoc_md4469}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md4470}{}\doxysubsubsection{File Specific Logging}\label{doc_tutorials_logger_md_autotoc_md4470}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md4471}{}\doxysubsection{Enabling and Disabling Sinks}\label{doc_tutorials_logger_md_autotoc_md4471}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md4472}{}\doxysubsection{Compilation}\label{doc_tutorials_logger_md_autotoc_md4472}

\begin{DoxyEnumerate}
\item Enable the logger\+: e.\+g. run {\ttfamily cmake} with the switch {\ttfamily -\/DENABLE\+\_\+\+LOGGER=ON}
\item Build Elektra
\end{DoxyEnumerate}\hypertarget{doc_tutorials_logger_md_autotoc_md4473}{}\doxysection{Log Levels}\label{doc_tutorials_logger_md_autotoc_md4473}
