...
\Hypertarget{doc_INSTALL_md_md_doc_INSTALL}%
 \hypertarget{doc_INSTALL_md_autotoc_md2770}{}\doxysection{Status}\label{doc_INSTALL_md_autotoc_md2770}
The graph below shows an (incomplete) list of available packages for Elektra.

\href{https://repology.org/metapackage/elektra/versions}{\texttt{ }}\hypertarget{doc_INSTALL_md_autotoc_md2771}{}\doxysection{Linux}\label{doc_INSTALL_md_autotoc_md2771}
...
\end{DoxyItemize}\hypertarget{doc_INSTALL_md_autotoc_md2772}{}\doxysubsection{Debian/\+Ubuntu}\label{doc_INSTALL_md_autotoc_md2772}
...
\hypertarget{doc_INSTALL_md_autotoc_md2773}{}\doxysubsection{Fedora}\label{doc_INSTALL_md_autotoc_md2773}
...
\end{DoxyCode}
\hypertarget{doc_INSTALL_md_autotoc_md2774}{}\doxysubsection{open\+SUSE}\label{doc_INSTALL_md_autotoc_md2774}
...
\end{DoxyCode}
\hypertarget{doc_INSTALL_md_autotoc_md2775}{}\doxysubsection{Install}\label{doc_INSTALL_md_autotoc_md2775}
...
\end{DoxyCode}
\hypertarget{doc_INSTALL_md_autotoc_md2776}{}\doxysection{mac\+OS}\label{doc_INSTALL_md_autotoc_md2776}
...
. We also provide a tap containing a more elaborate formula \href{http://github.com/ElektraInitiative/homebrew-elektra}{\texttt{ here}}.\hypertarget{doc_INSTALL_md_autotoc_md2777}{}\doxysection{Windows}\label{doc_INSTALL_md_autotoc_md2777}
...
Otherwise please refer to the section {\ttfamily OS Independent} below.\hypertarget{doc_INSTALL_md_autotoc_md2778}{}\doxysection{OS Independent}\label{doc_INSTALL_md_autotoc_md2778}
First follow the steps in \mbox{\hyperlink{doc_COMPILE_md}{COMPILE}}.

After you completed building Elektra on your own, there are multiple options how to install it. For example, with make or CPack tools. We recommend using the packages from our build server or that you generate your own packages with CPack.\hypertarget{doc_INSTALL_md_autotoc_md2779}{}\doxysubsection{CPack}\label{doc_INSTALL_md_autotoc_md2779}
...
\hypertarget{doc_INSTALL_md_autotoc_md2780}{}\doxysubsubsection{Debian/\+Ubuntu}\label{doc_INSTALL_md_autotoc_md2780}
...
\end{DoxyCode}
\hypertarget{doc_INSTALL_md_autotoc_md2781}{}\doxysubsubsection{Fedora}\label{doc_INSTALL_md_autotoc_md2781}
...
\end{DoxyCode}
\hypertarget{doc_INSTALL_md_autotoc_md2782}{}\doxysubsection{make}\label{doc_INSTALL_md_autotoc_md2782}
...
\end{DoxyCode}
\hypertarget{doc_INSTALL_md_autotoc_md2783}{}\doxysection{Troubleshooting}\label{doc_INSTALL_md_autotoc_md2783}
\hypertarget{doc_INSTALL_md_autotoc_md2784}{}\doxysubsection{Error Loading Libraries}\label{doc_INSTALL_md_autotoc_md2784}
...
and run {\ttfamily ldconfig} as root.\hypertarget{doc_INSTALL_md_autotoc_md2785}{}\doxysection{Installation Manuals}\label{doc_INSTALL_md_autotoc_md2785}
For some plugins and tools that ship with Elektra, additional installation manuals have been written. You can find them in the \mbox{\hyperlink{md_doc_tutorials_README_doc_tutorials_README_md}{tutorial overview}}.\hypertarget{doc_INSTALL_md_autotoc_md2786}{}\doxysection{See Also}\label{doc_INSTALL_md_autotoc_md2786}
