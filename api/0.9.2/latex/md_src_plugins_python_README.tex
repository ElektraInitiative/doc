...
What a Python script can do is not really limited by design, so any kind of plugin may be implemented. The python plugin is especially useful to write filter and logging scripts.\hypertarget{md_src_plugins_python_README_autotoc_md541}{}\doxysection{Usage}\label{md_src_plugins_python_README_autotoc_md541}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_python_README_autotoc_md542}{}\doxysubsection{Plugin Configuration}\label{md_src_plugins_python_README_autotoc_md542}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_python_README_autotoc_md543}{}\doxysubsection{Python Scripts}\label{md_src_plugins_python_README_autotoc_md543}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_python_README_autotoc_md544}{}\doxysection{Example}\label{md_src_plugins_python_README_autotoc_md544}
...
Further examples can be found in the python directory.\hypertarget{md_src_plugins_python_README_autotoc_md545}{}\doxysection{Disclaimer}\label{md_src_plugins_python_README_autotoc_md545}
