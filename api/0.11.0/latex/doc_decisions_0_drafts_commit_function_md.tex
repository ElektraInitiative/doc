...
\Hypertarget{doc_decisions_0_drafts_commit_function_md_md_doc_decisions_0_drafts_commit_function}%
 \hypertarget{doc_decisions_0_drafts_commit_function_md_autotoc_md1741}{}\doxysection{Problem}\label{doc_decisions_0_drafts_commit_function_md_autotoc_md1741}
...
With the introduction of the new backend, a new {\ttfamily kdb\+Commit} function was introduced to {\ttfamily struct \+\_\+\+Plugin} (matching {\ttfamily kdb\+Error}). We also added a {\ttfamily kdb\+Init}. Therefore, some phases of {\ttfamily kdb\+Get}/{\ttfamily kdb\+Set} now use separate functions, but not all of them do. This partial use of separate functions can be weird and unintuitive.\hypertarget{doc_decisions_0_drafts_commit_function_md_autotoc_md1742}{}\doxysection{Constraints}\label{doc_decisions_0_drafts_commit_function_md_autotoc_md1742}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0_drafts_commit_function_md_autotoc_md1743}{}\doxysection{Assumptions}\label{doc_decisions_0_drafts_commit_function_md_autotoc_md1743}
\hypertarget{doc_decisions_0_drafts_commit_function_md_autotoc_md1744}{}\doxysection{Considered Alternatives}\label{doc_decisions_0_drafts_commit_function_md_autotoc_md1744}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_0_drafts_commit_function_md_autotoc_md1745}{}\doxysection{Decision}\label{doc_decisions_0_drafts_commit_function_md_autotoc_md1745}
\hypertarget{doc_decisions_0_drafts_commit_function_md_autotoc_md1746}{}\doxysection{Rationale}\label{doc_decisions_0_drafts_commit_function_md_autotoc_md1746}
\hypertarget{doc_decisions_0_drafts_commit_function_md_autotoc_md1747}{}\doxysection{Implications}\label{doc_decisions_0_drafts_commit_function_md_autotoc_md1747}
\hypertarget{doc_decisions_0_drafts_commit_function_md_autotoc_md1748}{}\doxysection{Related Decisions}\label{doc_decisions_0_drafts_commit_function_md_autotoc_md1748}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0_drafts_commit_function_md_autotoc_md1749}{}\doxysection{Notes}\label{doc_decisions_0_drafts_commit_function_md_autotoc_md1749}
