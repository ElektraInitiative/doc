...
\Hypertarget{doc_decisions_error_codes_md_md_doc_decisions_error_codes}%
 \hypertarget{doc_decisions_error_codes_md_autotoc_md1851}{}\doxysection{Problem}\label{doc_decisions_error_codes_md_autotoc_md1851}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_codes_md_autotoc_md1852}{}\doxysection{Constraints}\label{doc_decisions_error_codes_md_autotoc_md1852}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_codes_md_autotoc_md1853}{}\doxysection{Assumptions}\label{doc_decisions_error_codes_md_autotoc_md1853}
\hypertarget{doc_decisions_error_codes_md_autotoc_md1854}{}\doxysection{Considered Alternatives}\label{doc_decisions_error_codes_md_autotoc_md1854}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_codes_md_autotoc_md1855}{}\doxysection{Decision}\label{doc_decisions_error_codes_md_autotoc_md1855}
...
To see an explanation of the categories along with a guideline on how to categorize please see the \mbox{\hyperlink{doc_dev_error-categorization_md}{Error Codes Guideline}}\hypertarget{doc_decisions_error_codes_md_autotoc_md1856}{}\doxysection{Rationale}\label{doc_decisions_error_codes_md_autotoc_md1856}
...
These categories are chosen because they can help developers to react programmatically and cover the majority of use cases to our present knowledge. If there is ever the need for another reaction based category, it can be extended very easily.\hypertarget{doc_decisions_error_codes_md_autotoc_md1857}{}\doxysection{Implications}\label{doc_decisions_error_codes_md_autotoc_md1857}
...
Current errors will be migrated.\hypertarget{doc_decisions_error_codes_md_autotoc_md1858}{}\doxysection{Related Decisions}\label{doc_decisions_error_codes_md_autotoc_md1858}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_codes_md_autotoc_md1859}{}\doxysection{Notes}\label{doc_decisions_error_codes_md_autotoc_md1859}
