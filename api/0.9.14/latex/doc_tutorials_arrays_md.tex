...
\Hypertarget{doc_tutorials_arrays_md_md_doc_tutorials_arrays}%
 \hypertarget{doc_tutorials_arrays_md_autotoc_md4202}{}\doxysection{Key-\/\+Value Pairs}\label{doc_tutorials_arrays_md_autotoc_md4202}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md4203}{}\doxysection{Array Keys}\label{doc_tutorials_arrays_md_autotoc_md4203}
Since Elektra keys sorts keys alphabetically, we can use the key-\/value pair structure described above to store sequences of values (aka. arrays).\hypertarget{doc_tutorials_arrays_md_autotoc_md4204}{}\doxysubsection{Empty Arrays}\label{doc_tutorials_arrays_md_autotoc_md4204}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md4205}{}\doxysubsection{Array Elements}\label{doc_tutorials_arrays_md_autotoc_md4205}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md4206}{}\doxysubsection{Metadata}\label{doc_tutorials_arrays_md_autotoc_md4206}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md4207}{}\doxysection{Closing Remarks}\label{doc_tutorials_arrays_md_autotoc_md4207}
