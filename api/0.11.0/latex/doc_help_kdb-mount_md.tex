...
\Hypertarget{doc_help_kdb-mount_md_md_doc_help_kdb_mount}%
 \hypertarget{doc_help_kdb-mount_md_autotoc_md3020}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-mount_md_autotoc_md3020}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{doc_help_kdb-mount_md_autotoc_md3021}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-mount_md_autotoc_md3021}
...
For cascading mount points (starting with {\ttfamily /}) a mount point for the namespace {\ttfamily dir}, {\ttfamily user} and {\ttfamily system} is created. Each of this mount point uses a different configuration file, either below current directory, below home directory or anywhere in the system. Use {\ttfamily kdb file $<$path$>$} to determine where the file(s) are.\hypertarget{doc_help_kdb-mount_md_autotoc_md3023}{}\doxysection{OPTIONS}\label{doc_help_kdb-mount_md_autotoc_md3023}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-mount_md_autotoc_md3024}{}\doxysection{KDB}\label{doc_help_kdb-mount_md_autotoc_md3024}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-mount_md_autotoc_md3025}{}\doxysection{EXAMPLES}\label{doc_help_kdb-mount_md_autotoc_md3025}
...
To recode and rename a configuration file using Elektra\+:~\newline
 {\ttfamily kdb mount recode.\+txt dir\+:/recode ni rename cut=path iconv to=utf8,from=latin1}\hypertarget{doc_help_kdb-mount_md_autotoc_md3026}{}\doxysection{SEE ALSO}\label{doc_help_kdb-mount_md_autotoc_md3026}
...
\item \mbox{\hyperlink{doc_help_kdb-mountOdbc_md}{kdb-\/mount\+Odbc(1)}}.
