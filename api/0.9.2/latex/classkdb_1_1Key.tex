...
ckdb\+::\+Key $\ast$ \mbox{\hyperlink{classkdb_1_1Key_a46b471460cf05cc52ea16676ba765ff0}{operator-\/$>$}} () const
\item 
...
\DoxyCodeLine{\mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} *k = \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}}(0);}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} *k =\mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}}(\textcolor{stringliteral}{""}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END}}); \textcolor{comment}{// Has the same effect as above}}
\DoxyCodeLine{\textcolor{comment}{// work with it}}
\DoxyCodeLine{\mbox{\hyperlink{group__key_ga3df95bbc2494e3e6703ece5639be5bb1}{keyDel}} (k);}
\end{DoxyCodeInclude}
...
\DoxyCodeLine{\mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} *k=\mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}}(\textcolor{stringliteral}{"user/some/example"}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END}});}
\DoxyCodeLine{\textcolor{comment}{// work with it}}
\DoxyCodeLine{\mbox{\hyperlink{group__key_ga3df95bbc2494e3e6703ece5639be5bb1}{keyDel}} (k);}
\end{DoxyCodeInclude}
...
A simple example is\+: 
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} * k = \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}} (\textcolor{stringliteral}{"user/my/long"}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END}});}
...
\end{DoxyCodeInclude}
 \begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{group__keyname_ga6e804bd453f98c28b0ff51430d1df407}{key\+Set\+Base\+Name()}} to \mbox{\hyperlink{classkdb_1_1Key_a615124f0a2b291e03975b49c233654d7}{set}} a base name 

\mbox{\hyperlink{group__keyname_ga7699091610e7f3f43d2949514a4b35d9}{key\+Set\+Name()}} to \mbox{\hyperlink{classkdb_1_1Key_a615124f0a2b291e03975b49c233654d7}{set}} a new name.
\end{DoxySeeAlso}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void} h (\mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} * k)}
\DoxyCodeLine{\{}
\DoxyCodeLine{        \textcolor{comment}{// receive key c}}
\DoxyCodeLine{        \mbox{\hyperlink{group__key_ga6a12cbbe656a1ad9f41b8c681d7a2f92}{keyCopy}} (k, \mbox{\hyperlink{classkdb_1_1Key_ab5bc93e22f4cf40b9d2b1fc32cc260be}{copy}});}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void} g (\mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} * k)}
\DoxyCodeLine{\{}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void} j (\mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} * k)}
\DoxyCodeLine{\{}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void} i (\mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} * k)}
\DoxyCodeLine{\{}
\DoxyCodeLine{        \mbox{\hyperlink{group__keyname_ga7699091610e7f3f43d2949514a4b35d9}{keySetName}} (k, \mbox{\hyperlink{group__keyname_ga8e805c726a60da921d3736cda7813513}{keyName}} (\mbox{\hyperlink{classkdb_1_1Key_ab5bc93e22f4cf40b9d2b1fc32cc260be}{copy}}));}
\DoxyCodeLine{        \mbox{\hyperlink{group__keyvalue_ga622bde1eb0e0c4994728331326340ef2}{keySetString}} (k, \mbox{\hyperlink{group__keyvalue_ga880936f2481d28e6e2acbe7486a21d05}{keyString}} (\mbox{\hyperlink{classkdb_1_1Key_ab5bc93e22f4cf40b9d2b1fc32cc260be}{copy}}));}
\DoxyCodeLine{        \mbox{\hyperlink{group__keymeta_ga8e63720a65610a29597494d0671f9401}{keyCopyAllMeta}} (k, \mbox{\hyperlink{classkdb_1_1Key_ab5bc93e22f4cf40b9d2b1fc32cc260be}{copy}});}
...
\DoxyCodeLine{        \mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} * shared = \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}} (0);}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int} f (\textcolor{keyword}{const} \mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} * source)}
\DoxyCodeLine{\{}
\DoxyCodeLine{        \mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} * \mbox{\hyperlink{classkdb_1_1Key_ababb1ccd9f18db379eb4a62f8db87bf5}{dup}} = \mbox{\hyperlink{group__key_gae6ec6a60cc4b8c1463fa08623d056ce3}{keyDup}} (source);}
\DoxyCodeLine{        \textcolor{comment}{// work with duplicate}}
\DoxyCodeLine{        \mbox{\hyperlink{group__key_ga3df95bbc2494e3e6703ece5639be5bb1}{keyDel}} (\mbox{\hyperlink{classkdb_1_1Key_ababb1ccd9f18db379eb4a62f8db87bf5}{dup}});}
...
Like for a new key after \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{key\+New()}} a subsequent \mbox{\hyperlink{group__keyset_gaa5a1d467a4d71041edce68ea7748ce45}{ks\+Append\+Key()}} makes a \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} take care of the lifecycle of the key.


\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int} g (\textcolor{keyword}{const} \mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} * source, KeySet * ks)}
\DoxyCodeLine{\{}
\DoxyCodeLine{        \mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} * \mbox{\hyperlink{classkdb_1_1Key_ababb1ccd9f18db379eb4a62f8db87bf5}{dup}} = \mbox{\hyperlink{group__key_gae6ec6a60cc4b8c1463fa08623d056ce3}{keyDup}} (source);}
\DoxyCodeLine{        \textcolor{comment}{// work with duplicate}}
\DoxyCodeLine{        \mbox{\hyperlink{group__keyset_gaa5a1d467a4d71041edce68ea7748ce45}{ksAppendKey}} (ks, \mbox{\hyperlink{classkdb_1_1Key_ababb1ccd9f18db379eb4a62f8db87bf5}{dup}});}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} *key = \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}} (\textcolor{stringliteral}{"user/keyname"}, KEY\_TYPE, KEY\_TYPE\_BINARY, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END}});}
...
\end{DoxySeeAlso}
\mbox{\Hypertarget{classkdb_1_1Key_aae77aecb3dece445f103b3ce81b02515}\label{classkdb_1_1Key_aae77aecb3dece445f103b3ce81b02515}} 
\index{kdb::Key@{kdb::Key}!getFullName@{getFullName}}
\index{getFullName@{getFullName}!kdb::Key@{kdb::Key}}
...
\hline
\end{DoxyExceptions}
\mbox{\Hypertarget{classkdb_1_1Key_a92d6ec8adb547051b2861749e25e954e}\label{classkdb_1_1Key_a92d6ec8adb547051b2861749e25e954e}} 
\index{kdb::Key@{kdb::Key}!getFullNameSize@{getFullNameSize}}
\index{getFullNameSize@{getFullNameSize}!kdb::Key@{kdb::Key}}
\doxysubsubsection{\texorpdfstring{getFullNameSize()}{getFullNameSize()}}
...
\end{DoxySeeAlso}
\mbox{\Hypertarget{classkdb_1_1Key_a71b191c56eacb692c2f92ed440b32b46}\label{classkdb_1_1Key_a71b191c56eacb692c2f92ed440b32b46}} 
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} *k = \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}}(\textcolor{stringliteral}{"user/proper\_name"}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END}}); \textcolor{comment}{// ref counter = 0}}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} *k = \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}}(0); \textcolor{comment}{// ref counter = 0}}
...
\end{DoxySeeAlso}
\mbox{\Hypertarget{classkdb_1_1Key_a3a27bc4aa9dc8237ce2151ae37fde119}\label{classkdb_1_1Key_a3a27bc4aa9dc8237ce2151ae37fde119}} 
\index{kdb::Key@{kdb::Key}!isInactive@{isInactive}}
\index{isInactive@{isInactive}!kdb::Key@{kdb::Key}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} *k1 = \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}}(\textcolor{stringliteral}{"user/a"}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END}});}
\DoxyCodeLine{\mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} *k2 = \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}}(\textcolor{stringliteral}{"user/b"}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END}});}
\DoxyCodeLine{}
...
And even more\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} *k1 = \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}}(\textcolor{stringliteral}{"user/a"}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40a77ca60362fa8daca8d5347db4385068b}{KEY\_OWNER}}, \textcolor{stringliteral}{"markus"}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END}});}
\DoxyCodeLine{\mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} *k2 = \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}}(\textcolor{stringliteral}{"user/a"}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40a77ca60362fa8daca8d5347db4385068b}{KEY\_OWNER}}, \textcolor{stringliteral}{"max"}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END}});}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// keyCmp(k1,k2) < 0}}
\DoxyCodeLine{\textcolor{comment}{// keyCmp(k2,k1) > 0}}
\end{DoxyCode}
...
\mbox{\hyperlink{group__key_ga4aabc4272506dd63161db2bbb42de8ae}{key\+Get\+Ref()}} for longer explanation, \mbox{\hyperlink{group__key_ga3df95bbc2494e3e6703ece5639be5bb1}{key\+Del()}}, \mbox{\hyperlink{group__key_ga6970a6f254d67af7e39f8e469bb162f1}{key\+Inc\+Ref()}} 
\end{DoxySeeAlso}
\mbox{\Hypertarget{classkdb_1_1Key_a46b471460cf05cc52ea16676ba765ff0}\label{classkdb_1_1Key_a46b471460cf05cc52ea16676ba765ff0}} 
\index{kdb::Key@{kdb::Key}!operator-\/$>$@{operator-\/$>$}}
\index{operator-\/$>$@{operator-\/$>$}!kdb::Key@{kdb::Key}}
\doxysubsubsection{\texorpdfstring{operator-\/$>$()}{operator->()}}
{\footnotesize\ttfamily \mbox{\hyperlink{classkdb_1_1Key}{Key}} $\ast$ kdb\+::\+Key\+::operator-\/$>$ (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}
...
A simple example is\+: 
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} * k = \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}} (\textcolor{stringliteral}{"user/my/long/name"}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END}});}
