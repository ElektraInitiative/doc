...
\Hypertarget{doc_tutorials_merge_md_md_doc_tutorials_merge}%
 \hypertarget{doc_tutorials_merge_md_autotoc_md4584}{}\doxysection{Introduction}\label{doc_tutorials_merge_md_autotoc_md4584}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_merge_md_autotoc_md4586}{}\doxysubsection{Strategies}\label{doc_tutorials_merge_md_autotoc_md4586}
...
If no strategy is specified, the merge will default to the preserve strategy as to not risk making the wrong decision. If any of the other strategies are specified, when a conflict is detected, merge will use the Key specified by the strategy ({\ttfamily ours}, {\ttfamily theirs}, {\ttfamily cut} or {\ttfamily import}) for the resulting Key.\hypertarget{doc_tutorials_merge_md_autotoc_md4587}{}\doxysection{Basic Example}\label{doc_tutorials_merge_md_autotoc_md4587}
Basic Usage\+:
...
\end{DoxyCode}
\hypertarget{doc_tutorials_merge_md_autotoc_md4588}{}\doxysection{Examples Using Strategies}\label{doc_tutorials_merge_md_autotoc_md4588}
...
Now we will examine the result Key\+Set with the different strategies.\hypertarget{doc_tutorials_merge_md_autotoc_md4589}{}\doxysubsection{Preserve}\label{doc_tutorials_merge_md_autotoc_md4589}
...
The merge will fail because of a conflict for {\ttfamily key4} since {\ttfamily key4} was deleted in our Key\+Set and edited in their Key\+Set. Since we used preserve, the merge fails and the result Key\+Set is not saved.\hypertarget{doc_tutorials_merge_md_autotoc_md4590}{}\doxysubsection{Ours}\label{doc_tutorials_merge_md_autotoc_md4590}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_merge_md_autotoc_md4591}{}\doxysubsection{Theirs}\label{doc_tutorials_merge_md_autotoc_md4591}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_merge_md_autotoc_md4592}{}\doxysubsection{Cut}\label{doc_tutorials_merge_md_autotoc_md4592}
...
Here the state of theirs is simply copied to the {\ttfamily resultpath}.\hypertarget{doc_tutorials_merge_md_autotoc_md4593}{}\doxysection{SEE ALSO}\label{doc_tutorials_merge_md_autotoc_md4593}
