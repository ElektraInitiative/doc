...
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md414}{}\doxysubsection{$<$tt$>$benchmark\+\_\+storage$<$/tt$>$}\label{md_src_plugins_quickdump_benchmarks_autotoc_md414}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md415}{}\doxysubsection{$<$tt$>$benchmark\+\_\+plugingetset$<$/tt$>$}\label{md_src_plugins_quickdump_benchmarks_autotoc_md415}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md417}{}\doxysubsubsection{Version 1}\label{md_src_plugins_quickdump_benchmarks_autotoc_md417}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md418}{}\doxyparagraph{File sizes}\label{md_src_plugins_quickdump_benchmarks_autotoc_md418}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md419}{}\doxyparagraph{get and set}\label{md_src_plugins_quickdump_benchmarks_autotoc_md419}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md420}{}\doxyparagraph{get only}\label{md_src_plugins_quickdump_benchmarks_autotoc_md420}
The values are mean ± standard deviation. {\ttfamily factor} is {\ttfamily dump / quickdump} like above
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md421}{}\doxysubsubsection{Version 2}\label{md_src_plugins_quickdump_benchmarks_autotoc_md421}
Running the same {\ttfamily benchmark\+\_\+plugingetset} tests with version 2 of the plugin yields\+:\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md422}{}\doxyparagraph{File sizes}\label{md_src_plugins_quickdump_benchmarks_autotoc_md422}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md425}{}\doxysubsubsection{Version 3}\label{md_src_plugins_quickdump_benchmarks_autotoc_md425}
Running the same {\ttfamily benchmark\+\_\+plugingetset} tests with version 3 of the plugin yields\+:\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md426}{}\doxyparagraph{File sizes}\label{md_src_plugins_quickdump_benchmarks_autotoc_md426}
{\ttfamily factor} is {\ttfamily v1 / v2} like above (bigger is better)
