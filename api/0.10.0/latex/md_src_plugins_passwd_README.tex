...
This plugin parses {\ttfamily passwd} files, e.\+g. {\ttfamily /etc/passwd}.\hypertarget{md_src_plugins_passwd_README_autotoc_md384}{}\doxysection{Installation}\label{md_src_plugins_passwd_README_autotoc_md384}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/experimental}.\hypertarget{md_src_plugins_passwd_README_autotoc_md385}{}\doxysection{Implementation Details}\label{md_src_plugins_passwd_README_autotoc_md385}
...
For writing {\ttfamily putpwent} (GNU\+\_\+\+SOURCE) will be used. If it is not available the plugin will write straight to the config file.\hypertarget{md_src_plugins_passwd_README_autotoc_md386}{}\doxysection{Requirements}\label{md_src_plugins_passwd_README_autotoc_md386}
For the plugin to be build at least {\ttfamily POSIX\+\_\+\+C\+\_\+\+SOURCE $>$= 200809L} compatibility is required.\hypertarget{md_src_plugins_passwd_README_autotoc_md387}{}\doxysection{Configuration}\label{md_src_plugins_passwd_README_autotoc_md387}
If the config key {\ttfamily index} is set to {\ttfamily name} passwd entries will be sorted by name, if not set or set to {\ttfamily uid} passwd entries will be sorted by uid\hypertarget{md_src_plugins_passwd_README_autotoc_md388}{}\doxysection{Fields}\label{md_src_plugins_passwd_README_autotoc_md388}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_passwd_README_autotoc_md389}{}\doxysection{Usage}\label{md_src_plugins_passwd_README_autotoc_md389}
