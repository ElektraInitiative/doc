...
\Hypertarget{doc_decisions_4_decided_library_split_md_md_doc_decisions_4_decided_library_split}%
 \hypertarget{doc_decisions_4_decided_library_split_md_autotoc_md2169}{}\doxysection{Problem}\label{doc_decisions_4_decided_library_split_md_autotoc_md2169}
Only {\ttfamily libelektra-\/core} is supposed to access private data, but this contradicts the goal to keep the library minimal. {\ttfamily \mbox{\hyperlink{kdbprivate_8h}{kdbprivate.\+h}}} was too generic, it contained many other parts next to the struct definitions of Key/\+Key\+Set.\hypertarget{doc_decisions_4_decided_library_split_md_autotoc_md2170}{}\doxysection{Constraints}\label{doc_decisions_4_decided_library_split_md_autotoc_md2170}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_library_split_md_autotoc_md2171}{}\doxysection{Assumptions}\label{doc_decisions_4_decided_library_split_md_autotoc_md2171}
\hypertarget{doc_decisions_4_decided_library_split_md_autotoc_md2172}{}\doxysection{Considered Alternatives}\label{doc_decisions_4_decided_library_split_md_autotoc_md2172}

\begin{DoxyItemize}
\item keep current situation
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_library_split_md_autotoc_md2173}{}\doxysection{Decision}\label{doc_decisions_4_decided_library_split_md_autotoc_md2173}
...
All currently planned libraries and their respective API prefixes are listed in the \href{\#notes}{\texttt{ Notes}} below.\hypertarget{doc_decisions_4_decided_library_split_md_autotoc_md2174}{}\doxysection{Rationale}\label{doc_decisions_4_decided_library_split_md_autotoc_md2174}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_library_split_md_autotoc_md2175}{}\doxysection{Implications}\label{doc_decisions_4_decided_library_split_md_autotoc_md2175}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_library_split_md_autotoc_md2176}{}\doxysection{Related Decisions}\label{doc_decisions_4_decided_library_split_md_autotoc_md2176}
\hypertarget{doc_decisions_4_decided_library_split_md_autotoc_md2177}{}\doxysection{Notes}\label{doc_decisions_4_decided_library_split_md_autotoc_md2177}
