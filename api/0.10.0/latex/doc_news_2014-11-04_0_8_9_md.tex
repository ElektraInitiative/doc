...
Again we managed to do an amazing feature release in just two month. In 416 commits we modified 393 files with 23462 insertions(+) and 9046 deletions(-\/).\hypertarget{doc_news_2014-11-04_0_8_9_md_autotoc_md3175}{}\doxysection{Most awaited}\label{doc_news_2014-11-04_0_8_9_md_autotoc_md3175}
The most awaited feature in this release is certainly the {\itshape qt-\/gui} developed by Raffael Pancheri. It includes a rich feature set including searching, unmounting, importing and exporting. A lot of functionality is quite stable now, even though its version is 0.\+0.\+1 alpha. If you find any bugs or want to give general feedback, feel free to use the issue tracker of the Elektra Initiative. A screenshot can be found \href{https://github.com/ElektraInitiative/libelektra/blob/master/doc/images/screenshot-qt-gui.png}{\texttt{ here}} To compile it (together with Elektra), see the README \href{https://github.com/ElektraInitiative/libelektra/tree/master/src/tools/qt-gui}{\texttt{ here}}
...
Finally, the {\itshape gen} tool added a Python package called {\ttfamily support}.\hypertarget{doc_news_2014-11-04_0_8_9_md_autotoc_md3177}{}\doxysection{Other Bits}\label{doc_news_2014-11-04_0_8_9_md_autotoc_md3177}
...
Felix converted the METADATA spec to ini files and added a proposal how comments can be improved.\hypertarget{doc_news_2014-11-04_0_8_9_md_autotoc_md3178}{}\doxysubsection{Refactoring\+:}\label{doc_news_2014-11-04_0_8_9_md_autotoc_md3178}
...
\end{DoxyItemize}\hypertarget{doc_news_2014-11-04_0_8_9_md_autotoc_md3179}{}\doxysubsection{Optimization\+:}\label{doc_news_2014-11-04_0_8_9_md_autotoc_md3179}
...
\end{DoxyItemize}\hypertarget{doc_news_2014-11-04_0_8_9_md_autotoc_md3180}{}\doxysubsection{Fixes\+:}\label{doc_news_2014-11-04_0_8_9_md_autotoc_md3180}
...
\end{DoxyItemize}\hypertarget{doc_news_2014-11-04_0_8_9_md_autotoc_md3181}{}\doxysection{Get It!}\label{doc_news_2014-11-04_0_8_9_md_autotoc_md3181}
...
already built API documentation can be found \href{https://doc.libelektra.org/api/0.8.9/html/}{\texttt{ here}}
