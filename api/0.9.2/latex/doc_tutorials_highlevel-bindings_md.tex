...
Writing bindings for high-\/level A\+PI is different from writing bindings for other parts of Elektra. This is mainly because the high-\/level A\+PI has different goals.\hypertarget{doc_tutorials_highlevel-bindings_md_autotoc_md2636}{}\doxysection{Goals}\label{doc_tutorials_highlevel-bindings_md_autotoc_md2636}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_highlevel-bindings_md_autotoc_md2637}{}\doxysection{When to write Bindings}\label{doc_tutorials_highlevel-bindings_md_autotoc_md2637}
...
If not, designing an A\+PI to meet our goals is up to you. While designing the A\+PI you should keep in mind that you can always use code-\/generator ({\ttfamily kdb gen}) templates like the C A\+PI does.\hypertarget{doc_tutorials_highlevel-bindings_md_autotoc_md2638}{}\doxysection{How to write Bindings}\label{doc_tutorials_highlevel-bindings_md_autotoc_md2638}
Since the C high-\/level A\+PI consists of a shared library A\+PI and a code-\/generated part, your binding will also have these two parts.\hypertarget{doc_tutorials_highlevel-bindings_md_autotoc_md2639}{}\doxysubsection{Bindings for the $<$tt$>$highlevel$<$/tt$>$ Library}\label{doc_tutorials_highlevel-bindings_md_autotoc_md2639}
...
The generated code should still be understandable. So if writing a more idiomatic A\+PI on top of the direct mapping, significantly simplifies the generated code (and maybe also the template), you should write such an A\+PI.\hypertarget{doc_tutorials_highlevel-bindings_md_autotoc_md2640}{}\doxysubsection{Bindings for the $<$tt$>$lowlevel$<$/tt$>$ Library}\label{doc_tutorials_highlevel-bindings_md_autotoc_md2640}
...
Remember that Elektra has internal iterators (for metadata+keysets) but in general we prefer external iterators by either copying the Key\+Set per iterator or using {\ttfamily ks\+At\+Cursor}.\hypertarget{doc_tutorials_highlevel-bindings_md_autotoc_md2641}{}\doxysubsection{Variadic Functions}\label{doc_tutorials_highlevel-bindings_md_autotoc_md2641}
...
\end{DoxyEnumerate}\hypertarget{doc_tutorials_highlevel-bindings_md_autotoc_md2642}{}\doxysubsection{Creating the Code-\/\+Generator Template}\label{doc_tutorials_highlevel-bindings_md_autotoc_md2642}
