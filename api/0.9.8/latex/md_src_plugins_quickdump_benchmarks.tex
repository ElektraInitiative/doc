...
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md409}{}\doxysubsection{$<$tt$>$benchmark\+\_\+storage$<$/tt$>$}\label{md_src_plugins_quickdump_benchmarks_autotoc_md409}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md410}{}\doxysubsection{$<$tt$>$benchmark\+\_\+plugingetset$<$/tt$>$}\label{md_src_plugins_quickdump_benchmarks_autotoc_md410}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md412}{}\doxysubsubsection{Version 1}\label{md_src_plugins_quickdump_benchmarks_autotoc_md412}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md413}{}\doxyparagraph{File sizes}\label{md_src_plugins_quickdump_benchmarks_autotoc_md413}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md414}{}\doxyparagraph{get and set}\label{md_src_plugins_quickdump_benchmarks_autotoc_md414}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md415}{}\doxyparagraph{get only}\label{md_src_plugins_quickdump_benchmarks_autotoc_md415}
The values are mean ± standard deviation. {\ttfamily factor} is {\ttfamily dump / quickdump} like above
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md416}{}\doxysubsubsection{Version 2}\label{md_src_plugins_quickdump_benchmarks_autotoc_md416}
Running the same {\ttfamily benchmark\+\_\+plugingetset} tests with version 2 of the plugin yields\+:\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md417}{}\doxyparagraph{File sizes}\label{md_src_plugins_quickdump_benchmarks_autotoc_md417}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md418}{}\doxyparagraph{get and set}\label{md_src_plugins_quickdump_benchmarks_autotoc_md418}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md419}{}\doxyparagraph{get only}\label{md_src_plugins_quickdump_benchmarks_autotoc_md419}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md420}{}\doxysubsubsection{Version 3}\label{md_src_plugins_quickdump_benchmarks_autotoc_md420}
Running the same {\ttfamily benchmark\+\_\+plugingetset} tests with version 3 of the plugin yields\+:\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md421}{}\doxyparagraph{File sizes}\label{md_src_plugins_quickdump_benchmarks_autotoc_md421}
{\ttfamily factor} is {\ttfamily v1 / v2} like above (bigger is better)
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md422}{}\doxyparagraph{get and set}\label{md_src_plugins_quickdump_benchmarks_autotoc_md422}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md423}{}\doxyparagraph{get only}\label{md_src_plugins_quickdump_benchmarks_autotoc_md423}
