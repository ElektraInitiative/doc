...
\item[\mbox{\hyperlink{deprecated__deprecated000002}{Deprecated}}]The handling of synchronization is done internally and does not need to be checked by neither application nor plugins.\end{DoxyRefDesc}
