...
Let us start with a motivating example first\+:\hypertarget{doc_tutorials_mount_md_autotoc_md3618}{}\doxysection{Mount the Lookup Table for Hostnames}\label{doc_tutorials_mount_md_autotoc_md3618}
...
Because of that only root can mount files.\hypertarget{doc_tutorials_mount_md_autotoc_md3619}{}\doxysection{Resolver}\label{doc_tutorials_mount_md_autotoc_md3619}
...
But resolvers are not the only plugins Elektra uses\+:\hypertarget{doc_tutorials_mount_md_autotoc_md3620}{}\doxysection{Plugins}\label{doc_tutorials_mount_md_autotoc_md3620}
...
When you mount a file you can tell Elektra which plugins it should use for reading and writing to configuration files.\hypertarget{doc_tutorials_mount_md_autotoc_md3621}{}\doxysubsubsection{Meta Data}\label{doc_tutorials_mount_md_autotoc_md3621}
...
If you want to find out more about validation I recommend reading \mbox{\hyperlink{doc_tutorials_validation_md}{this}} tutorial next.\hypertarget{doc_tutorials_mount_md_autotoc_md3622}{}\doxysubsubsection{Backends}\label{doc_tutorials_mount_md_autotoc_md3622}
The plugins together with the configuration file form a {\itshape backend}. The backend determines how Elektra stores data below a mount point. You can examine every mount points backend by looking at the configuration below {\ttfamily system\+:/elektra/mountpoints/$<$mount point$>$/}.\hypertarget{doc_tutorials_mount_md_autotoc_md3623}{}\doxysection{Limitations}\label{doc_tutorials_mount_md_autotoc_md3623}
