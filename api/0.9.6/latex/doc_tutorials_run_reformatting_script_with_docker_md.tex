...
This is a step-\/by-\/step guide. Just follow the steps and you are good to go!\hypertarget{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md3684}{}\doxysection{Prerequisites}\label{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md3684}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md3685}{}\doxysection{What to Begin With?}\label{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md3685}
\hypertarget{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md3686}{}\doxysubsection{1. Build Your Own Docker Image}\label{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md3686}
...
The image tag {\ttfamily buildelektra-\/sid} we suggested can be replaced by a name of your own choosing. Note that currently our {\ttfamily sid} image is the only one with all the necessary tools installed.\hypertarget{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md3687}{}\doxysubsection{2. Run the Docker Container}\label{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md3687}
...
Again, if you changed the image tag {\ttfamily buildelektra-\/sid}, please change it above as well.\hypertarget{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md3688}{}\doxysubsection{3. Running the Script}\label{doc_tutorials_run_reformatting_script_with_docker_md_autotoc_md3688}
