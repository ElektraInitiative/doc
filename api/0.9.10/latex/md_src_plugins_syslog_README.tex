...
Configure the plugin with {\ttfamily log/get=1} to enable logging when configuration is loaded. For example, {\ttfamily kdb gmount syslog log/get=1}.\hypertarget{md_src_plugins_syslog_README_autotoc_md535}{}\doxysection{Installation}\label{md_src_plugins_syslog_README_autotoc_md535}
