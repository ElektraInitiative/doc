...
\item 
class \hyperlink{classkdb_1_1tools_1_1PluginDatabase}{kdb\+::tools\+::\+Plugin\+Database}
\begin{DoxyCompactList}\small\item\em Loads all plugins and allows us to query them. \end{DoxyCompactList}\item 
class \hyperlink{classkdb_1_1tools_1_1ModulesPluginDatabase}{kdb\+::tools\+::\+Modules\+Plugin\+Database}
\begin{DoxyCompactList}\small\item\em A plugin database that works with installed modules. \end{DoxyCompactList}\item 
class \hyperlink{classkdb_1_1tools_1_1MockPluginDatabase}{kdb\+::tools\+::\+Mock\+Plugin\+Database}
