\hypertarget{doc_help_kdb-find-tools_md_autotoc_md1661}{}\doxysection{S\+Y\+N\+O\+P\+S\+IS}\label{doc_help_kdb-find-tools_md_autotoc_md1661}

\begin{DoxyCode}{0}
\DoxyCodeLine{kdb find-\/tools [-\/h] [-\/-\/warnings] [-\/-\/good] [-\/-\/alltags] [-\/n NAME] [-\/a AUTHOR] [-\/d DATE]}
\DoxyCodeLine{               [-\/t TAGS [TAGS ...]] [-\/b BRIEF] [-\/e EXECUTE]}
\end{DoxyCode}
\hypertarget{doc_help_kdb-find-tools_md_autotoc_md1662}{}\doxysection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{doc_help_kdb-find-tools_md_autotoc_md1662}
...
All methods can be combined. For example if you search all bash scripts which do some configuration work. You can type {\ttfamily kdb find-\/tools -\/t configuration -\/e bash}.\hypertarget{doc_help_kdb-find-tools_md_autotoc_md1663}{}\doxysection{The Right Way to Add Your Script to the Find Tools}\label{doc_help_kdb-find-tools_md_autotoc_md1663}
...
Beware, that these metatags should be applied at the beginning of the file (in the first 10 rows)!\hypertarget{doc_help_kdb-find-tools_md_autotoc_md1664}{}\doxysection{Example}\label{doc_help_kdb-find-tools_md_autotoc_md1664}
...
\end{DoxyCode}
\hypertarget{doc_help_kdb-find-tools_md_autotoc_md1665}{}\doxysection{Notes}\label{doc_help_kdb-find-tools_md_autotoc_md1665}
