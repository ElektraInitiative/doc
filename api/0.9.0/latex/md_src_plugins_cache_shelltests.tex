\hypertarget{md_src_plugins_cache_shelltests_src_plugins_cache_shelltests_md}{}\section{Additional shell tests for cache}\label{md_src_plugins_cache_shelltests_src_plugins_cache_shelltests_md}
This file contains important shell tests for mmapstorage which do not fit well into the plugin R\+E\+A\+D\+ME.

\section*{Test kdb cp with cache and default resolver (refression test)}
...
\section*{Test kdb cp with cache and multifile resolver (refression test)}
