...
For other applications, e.\+g. modifying {\ttfamily smb.\+conf} you should prefer the \mbox{\hyperlink{md_src_plugins_ini_README_src_plugins_ini_README_md}{ini plugin}}.\hypertarget{md_src_plugins_ni_README_autotoc_md503}{}\doxysection{Usage}\label{md_src_plugins_ni_README_autotoc_md503}
...
For in-\/detail explanation of the syntax (nested keys are not supported by the plugin) \href{/home/mpranj/workspace/libelektra/src/plugins/ni/nickel-1.1.0/include/bohr/ni.h}{\texttt{ see /src/plugins/ni/nickel-\/1.1.\+0/include/bohr/ni.h}}\hypertarget{md_src_plugins_ni_README_autotoc_md504}{}\doxysection{Examples}\label{md_src_plugins_ni_README_autotoc_md504}
\`{}\`{}{\ttfamily  @section autotoc\+\_\+md505 Mount the}ni{\ttfamily plugin at}spec/tests/ni\`{} sudo kdb mount file.\+ini spec/tests/ni ni\hypertarget{md_src_plugins_ni_README_autotoc_md506}{}\doxysection{Add some metadata}\label{md_src_plugins_ni_README_autotoc_md506}
kdb meta-\/set spec/tests/ni/key metakey metavalue kdb meta-\/set spec/tests/ni/key check/type char\hypertarget{md_src_plugins_ni_README_autotoc_md507}{}\doxysection{Retrieve metadata}\label{md_src_plugins_ni_README_autotoc_md507}
kdb meta-\/ls spec/tests/ni/key \#$>$ check/type \#$>$ metakey kdb meta-\/get spec/tests/ni/key metakey \#$>$ metavalue\hypertarget{md_src_plugins_ni_README_autotoc_md508}{}\doxysection{Add and retrieve key values}\label{md_src_plugins_ni_README_autotoc_md508}
kdb get spec/tests/ni/key \#$>$ kdb set spec/tests/ni/key value kdb set spec/tests/ni/key/to nothing kdb get spec/tests/ni/key \#$>$ value kdb get spec/tests/ni/key/to \#$>$ nothing\hypertarget{md_src_plugins_ni_README_autotoc_md509}{}\doxysection{Undo modifications}\label{md_src_plugins_ni_README_autotoc_md509}
kdb rm -\/r spec/tests/ni sudo kdb umount spec/tests/ni \`{}\`{}\`{}\hypertarget{md_src_plugins_ni_README_autotoc_md510}{}\doxysubsection{Limitations}\label{md_src_plugins_ni_README_autotoc_md510}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_ni_README_autotoc_md511}{}\doxysubsection{Nickel}\label{md_src_plugins_ni_README_autotoc_md511}
