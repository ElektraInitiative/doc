\hypertarget{doc_help_kdb-cmerge_md_autotoc_md1615}{}\doxysection{N\+A\+ME}\label{doc_help_kdb-cmerge_md_autotoc_md1615}
kdb-\/cmerge -\/ Join three key sets together\hypertarget{doc_help_kdb-cmerge_md_autotoc_md1616}{}\doxysection{S\+Y\+N\+O\+P\+S\+IS}\label{doc_help_kdb-cmerge_md_autotoc_md1616}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-cmerge_md_autotoc_md1617}{}\doxysection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{doc_help_kdb-cmerge_md_autotoc_md1617}
{\ttfamily kdb cmerge} can incorporate changes from two modified versions (our and their) into a common preceding version (base) of a key set. This lets you merge the sets of changes represented by the two newer key sets. This is called a three-\/way merge between key sets.~\newline
 ...
 This tool currently exists alongside {\ttfamily kdb merge} until it is completely ready to supersede it. At this moment, cmerge will be renamed to merge.\hypertarget{doc_help_kdb-cmerge_md_autotoc_md1618}{}\doxysection{O\+P\+T\+I\+O\+NS}\label{doc_help_kdb-cmerge_md_autotoc_md1618}
...
Strategies have their own \mbox{\hyperlink{doc_help_elektra-cmerge-strategy_md}{man page}} which can be accessed with {\ttfamily man elektra-\/cmerge-\/strategies}.\hypertarget{doc_help_kdb-cmerge_md_autotoc_md1619}{}\doxysection{R\+E\+T\+U\+R\+N V\+A\+L\+UE}\label{doc_help_kdb-cmerge_md_autotoc_md1619}
...
The result of the merge is stored in {\ttfamily result}.\hypertarget{doc_help_kdb-cmerge_md_autotoc_md1620}{}\doxysection{T\+H\+R\+E\+E-\/\+W\+A\+Y M\+E\+R\+GE}\label{doc_help_kdb-cmerge_md_autotoc_md1620}
...
\hypertarget{doc_help_kdb-cmerge_md_autotoc_md1621}{}\doxysection{C\+O\+N\+F\+L\+I\+C\+TS}\label{doc_help_kdb-cmerge_md_autotoc_md1621}
...
\hypertarget{doc_help_kdb-cmerge_md_autotoc_md1622}{}\doxysection{E\+X\+A\+M\+P\+L\+ES}\label{doc_help_kdb-cmerge_md_autotoc_md1622}
...
\`{}\`{}\`{}~\newline
\hypertarget{doc_help_kdb-cmerge_md_autotoc_md1623}{}\doxysection{S\+E\+E A\+L\+SO}\label{doc_help_kdb-cmerge_md_autotoc_md1623}
