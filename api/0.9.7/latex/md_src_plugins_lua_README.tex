...
What a Lua script can do is not really limited by design, so any kind of plugin may be implemented. The lua plugin is especially useful to write filter and logging scripts.\hypertarget{md_src_plugins_lua_README_autotoc_md318}{}\doxysection{Installation}\label{md_src_plugins_lua_README_autotoc_md318}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/lua}.\hypertarget{md_src_plugins_lua_README_autotoc_md319}{}\doxysection{Usage}\label{md_src_plugins_lua_README_autotoc_md319}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_lua_README_autotoc_md320}{}\doxysubsection{Lua Scripts}\label{md_src_plugins_lua_README_autotoc_md320}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_lua_README_autotoc_md321}{}\doxysection{Example}\label{md_src_plugins_lua_README_autotoc_md321}
...
Further examples can be found in the lua directory.\hypertarget{md_src_plugins_lua_README_autotoc_md322}{}\doxysection{Disclaimer}\label{md_src_plugins_lua_README_autotoc_md322}
