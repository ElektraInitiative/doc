...
\hypertarget{md_src_plugins_length_README_autotoc_md299}{}\doxysubsection{Introduction}\label{md_src_plugins_length_README_autotoc_md299}
This plugins purpose is to check the maximum length of strings. For example if {\ttfamily check/length/max} is set to 3, Strings with more than 3 characters will not validate (e.\+g. \char`\"{}abcd\char`\"{}), whereas \char`\"{}abc\char`\"{} would validate.\hypertarget{md_src_plugins_length_README_autotoc_md300}{}\doxysubsection{Installation}\label{md_src_plugins_length_README_autotoc_md300}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/experimental}.\hypertarget{md_src_plugins_length_README_autotoc_md301}{}\doxysubsection{Usage}\label{md_src_plugins_length_README_autotoc_md301}
...
\DoxyCodeLine{kdb meta-\/set /tests/length/text check/length/max 3}
\DoxyCodeLine{}
\DoxyCodeLine{\# Try to set a longer string}
\DoxyCodeLine{kdb set /tests/length/text abcd}
\DoxyCodeLine{\# STDERR: .*Validation Semantic.*}
\DoxyCodeLine{\# ERROR:  C03200}
\DoxyCodeLine{\# RET:    5}
\DoxyCodeLine{}
\DoxyCodeLine{\# Set a correct string}
\DoxyCodeLine{kdb set /tests/length/text abc}
\DoxyCodeLine{kdb get /tests/length/text}
\DoxyCodeLine{}
\DoxyCodeLine{\# Undo modifications to the database}
\DoxyCodeLine{kdb rm -\/r /tests/length}
\DoxyCodeLine{kdb umount /tests/length}

\end{DoxyCode}
\hypertarget{md_src_plugins_length_README_autotoc_md302}{}\doxysubsection{Limitations}\label{md_src_plugins_length_README_autotoc_md302}
