...
\Hypertarget{doc_tutorials_namespaces_md_md_doc_tutorials_namespaces}%
 \hypertarget{doc_tutorials_namespaces_md_autotoc_md3624}{}\doxysection{Structure of the Key Database}\label{doc_tutorials_namespaces_md_autotoc_md3624}
...
For example {\ttfamily kdb get /b/c} should return {\ttfamily Value 2} now, if you set the values before.\hypertarget{doc_tutorials_namespaces_md_autotoc_md3625}{}\doxysection{Namespaces}\label{doc_tutorials_namespaces_md_autotoc_md3625}
...
At this point the key database should have this structure\+: \hypertarget{doc_tutorials_namespaces_md_autotoc_md3626}{}\doxysubsection{Cascading Keys}\label{doc_tutorials_namespaces_md_autotoc_md3626}
...
Having namespaces enables both admins and users to set specific parts of the application\textquotesingle{}s configuration, as you will see in the following example.\hypertarget{doc_tutorials_namespaces_md_autotoc_md3627}{}\doxysection{How it Works on the Command Line (kdb)}\label{doc_tutorials_namespaces_md_autotoc_md3627}
