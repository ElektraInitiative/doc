...
This plugin spawns a new process with a user-\/defined executable and delegates all operations to the new process.\hypertarget{md_src_plugins_process_README_autotoc_md397}{}\doxysection{Usage}\label{md_src_plugins_process_README_autotoc_md397}
...
If communication can be established, the child process will be kept running until {\ttfamily elektra\+Stdprocio\+Close}.\hypertarget{md_src_plugins_process_README_autotoc_md398}{}\doxysection{Protocol}\label{md_src_plugins_process_README_autotoc_md398}
...
\end{DoxyCode}
 \end{quote}
\hypertarget{md_src_plugins_process_README_autotoc_md399}{}\doxysubsection{Initialization}\label{md_src_plugins_process_README_autotoc_md399}
...
\hypertarget{md_src_plugins_process_README_autotoc_md400}{}\doxysubsection{Operation}\label{md_src_plugins_process_README_autotoc_md400}
...
\hypertarget{md_src_plugins_process_README_autotoc_md402}{}\doxysubsection{Errors}\label{md_src_plugins_process_README_autotoc_md402}
If an unexpected error occurs on either side of the protocol, the connection should be terminated and the child process shall exit.\hypertarget{md_src_plugins_process_README_autotoc_md403}{}\doxysection{Examples}\label{md_src_plugins_process_README_autotoc_md403}
...
\end{DoxyCode}
 \end{quote}
\hypertarget{md_src_plugins_process_README_autotoc_md404}{}\doxysection{Limitations}\label{md_src_plugins_process_README_autotoc_md404}
