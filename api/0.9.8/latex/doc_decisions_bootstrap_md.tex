...
\Hypertarget{doc_decisions_bootstrap_md_md_doc_decisions_bootstrap}%
 \hypertarget{doc_decisions_bootstrap_md_autotoc_md1670}{}\doxysection{Problem}\label{doc_decisions_bootstrap_md_autotoc_md1670}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1671}{}\doxysection{Constraints}\label{doc_decisions_bootstrap_md_autotoc_md1671}
...
\end{DoxyItemize}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1672}{}\doxysection{Assumptions}\label{doc_decisions_bootstrap_md_autotoc_md1672}

\begin{DoxyItemize}
\item Bootstrap should be fast and not unnecessarily read large files
\end{DoxyItemize}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1673}{}\doxysection{Considered Alternatives}\label{doc_decisions_bootstrap_md_autotoc_md1673}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1674}{}\doxysection{Decision}\label{doc_decisions_bootstrap_md_autotoc_md1674}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1675}{}\doxysection{Rationale}\label{doc_decisions_bootstrap_md_autotoc_md1675}

\begin{DoxyItemize}
\item Solves both problems
\item Is fully compatible with any existing setup
\item People can decide if and how to migrate
\end{DoxyItemize}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1676}{}\doxysection{Implications}\label{doc_decisions_bootstrap_md_autotoc_md1676}

\begin{DoxyItemize}
\item added scripts/upgrade-\/bootstrap
\end{DoxyItemize}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1677}{}\doxysection{Related Decisions}\label{doc_decisions_bootstrap_md_autotoc_md1677}
\hypertarget{doc_decisions_bootstrap_md_autotoc_md1678}{}\doxysection{Notes}\label{doc_decisions_bootstrap_md_autotoc_md1678}
