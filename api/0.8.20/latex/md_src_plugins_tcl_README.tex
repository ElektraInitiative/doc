...
kdb setmeta user/examples/tcl/key comment \char`\"{}\+This key contains example data.\char`\"{} \section*{A known limitation of the plugin is that it discards whitespace characters}
