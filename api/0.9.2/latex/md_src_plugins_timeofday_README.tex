...
This plugin is a logging plugin which prints a timestamp during all placements of backend.\hypertarget{md_src_plugins_timeofday_README_autotoc_md691}{}\doxysection{Usage}\label{md_src_plugins_timeofday_README_autotoc_md691}
...
The first digit column shows the complete time passed, the second column shows the time from invocation to invocation.\hypertarget{md_src_plugins_timeofday_README_autotoc_md692}{}\doxysection{Module Loading}\label{md_src_plugins_timeofday_README_autotoc_md692}
