\hypertarget{doc_tutorials_cmerge_md_autotoc_md2577}{}\doxysection{Introduction}\label{doc_tutorials_cmerge_md_autotoc_md2577}
...
{\ttfamily our}, {\ttfamily their} and {\ttfamily base} represent the three keys that are used in a three-\/way merge. As in the {\ttfamily diff3} tool, required are the three files M\+Y\+F\+I\+LE (our), O\+L\+D\+F\+I\+LE (base) and Y\+O\+U\+R\+F\+I\+LE (their) The result off the three-\/way merge will be stored in {\ttfamily result}.\hypertarget{doc_tutorials_cmerge_md_autotoc_md2578}{}\doxysection{Simple example}\label{doc_tutorials_cmerge_md_autotoc_md2578}
...
\DoxyCodeLine{\#> a}
\end{DoxyCode}
\hypertarget{doc_tutorials_cmerge_md_autotoc_md2579}{}\doxysubsection{hosts}\label{doc_tutorials_cmerge_md_autotoc_md2579}
...
\DoxyCodeLine{\#> ::2}
\end{DoxyCode}
\hypertarget{doc_tutorials_cmerge_md_autotoc_md2580}{}\doxysection{Metadata}\label{doc_tutorials_cmerge_md_autotoc_md2580}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_cmerge_md_autotoc_md2581}{}\doxysection{Arrays}\label{doc_tutorials_cmerge_md_autotoc_md2581}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_cmerge_md_autotoc_md2582}{}\doxysection{Scripts}\label{doc_tutorials_cmerge_md_autotoc_md2582}
...
\end{DoxyEnumerate}\hypertarget{doc_tutorials_cmerge_md_autotoc_md2583}{}\doxysection{Calling the A\+PI}\label{doc_tutorials_cmerge_md_autotoc_md2583}
