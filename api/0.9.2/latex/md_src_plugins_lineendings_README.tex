...
The Lineendings Plugin verifies the line endings of a file. If inconsistent line endings or line endings that don\textquotesingle{}t match {\ttfamily valid} are detected the plugin yields an error.\hypertarget{md_src_plugins_lineendings_README_autotoc_md385}{}\doxysection{Configuration}\label{md_src_plugins_lineendings_README_autotoc_md385}
