...
int \hyperlink{split_8c_ad04a357eb6e46aa889e7f72f063e0263}{split\+Buildup} (Split $\ast$split, K\+D\+B $\ast$kdb, Key $\ast$parent\+Key)
...
int \hyperlink{split_8c_ae4fcdbb3d58fb0baba1459e0d8b0a94b}{split\+Divide} (Split $\ast$split, K\+D\+B $\ast$handle, Key\+Set $\ast$ks)
...
void \hyperlink{split_8c_a9c5bcc3cf34af26d3d8c69bb3cc9dadb}{split\+Update\+File\+Name} (Split $\ast$split, K\+D\+B $\ast$handle, Key $\ast$key)
\begin{DoxyCompactList}\small\item\em Update the (configuration) file name for the parent key. \end{DoxyCompactList}\item 
int \hyperlink{split_8c_abd8e79fdbec5faf611bbd26df137343e}{split\+Appoint} (Split $\ast$split, K\+D\+B $\ast$handle, Key\+Set $\ast$ks)
\begin{DoxyCompactList}\small\item\em Appoints all keys from ks to yet unsynced splits. \end{DoxyCompactList}\item 
int \hyperlink{split_8c_afbeff288abf59244ddd44d82cb8d93d2}{split\+Get} (Split $\ast$split, Key $\ast$warning\+Key, K\+D\+B $\ast$handle)
...
int \hyperlink{split_8c_a8daa06c04a49e532a8cbd4a52b08b2c5}{split\+Merge} (Split $\ast$split, Key\+Set $\ast$dest)
...
\hypertarget{split_8c_afa0850f1eb48f9f3cf6298c588b92246}{\index{split.\+c@{split.\+c}!split\+Append@{split\+Append}}
...
)}}\label{split_8c_afa0850f1eb48f9f3cf6298c588b92246}
...
\end{DoxyReturn}
\hypertarget{split_8c_abd8e79fdbec5faf611bbd26df137343e}{\index{split.\+c@{split.\+c}!split\+Appoint@{split\+Appoint}}
...
\item[{Key\+Set $\ast$}]{ks}
\end{DoxyParamCaption}
)}}\label{split_8c_abd8e79fdbec5faf611bbd26df137343e}
...
\hline
\end{DoxyRetVals}
\hypertarget{split_8c_ad04a357eb6e46aa889e7f72f063e0263}{\index{split.\+c@{split.\+c}!split\+Buildup@{split\+Buildup}}
...
\item[{Key $\ast$}]{parent\+Key}
\end{DoxyParamCaption}
)}}\label{split_8c_ad04a357eb6e46aa889e7f72f063e0263}
...
\hline
\end{DoxyRetVals}
\hypertarget{split_8c_a455004883f0e5afccc5c78308060d70d}{\index{split.\+c@{split.\+c}!split\+Del@{split\+Del}}
...
\end{DoxyParamCaption}
)}}\label{split_8c_a455004883f0e5afccc5c78308060d70d}
...
\hline
\end{DoxyParams}
\hypertarget{split_8c_ae4fcdbb3d58fb0baba1459e0d8b0a94b}{\index{split.\+c@{split.\+c}!split\+Divide@{split\+Divide}}
...
\item[{Key\+Set $\ast$}]{ks}
\end{DoxyParamCaption}
)}}\label{split_8c_ae4fcdbb3d58fb0baba1459e0d8b0a94b}
...
\hline
\end{DoxyRetVals}
\hypertarget{split_8c_afbeff288abf59244ddd44d82cb8d93d2}{\index{split.\+c@{split.\+c}!split\+Get@{split\+Get}}
...
\item[{K\+D\+B $\ast$}]{handle}
\end{DoxyParamCaption}
)}}\label{split_8c_afbeff288abf59244ddd44d82cb8d93d2}
...
\hline
\end{DoxyRetVals}
\hypertarget{split_8c_a8daa06c04a49e532a8cbd4a52b08b2c5}{\index{split.\+c@{split.\+c}!split\+Merge@{split\+Merge}}
\index{split\+Merge@{split\+Merge}!split.\+c@{split.\+c}}
\subsubsection[{split\+Merge}]{\setlength{\rightskip}{0pt plus 5cm}int split\+Merge (
\begin{DoxyParamCaption}
\item[{Split $\ast$}]{split, }
\item[{Key\+Set $\ast$}]{dest}
\end{DoxyParamCaption}
)}}\label{split_8c_a8daa06c04a49e532a8cbd4a52b08b2c5}
...
\hline
\end{DoxyRetVals}
\hypertarget{split_8c_aa17259b07015cf6c06f14814f52d01fb}{\index{split.\+c@{split.\+c}!split\+New@{split\+New}}
\index{split\+New@{split\+New}!split.\+c@{split.\+c}}
\subsubsection[{split\+New}]{\setlength{\rightskip}{0pt plus 5cm}Split$\ast$ split\+New (
\begin{DoxyParamCaption}
\item[{void}]{}
\end{DoxyParamCaption}
)}}\label{split_8c_aa17259b07015cf6c06f14814f52d01fb}
...
\end{DoxySeeAlso}
\hypertarget{split_8c_af8a0571065ace2b371e017cabdb9eca7}{\index{split.\+c@{split.\+c}!split\+Prepare@{split\+Prepare}}
...
\item[{Split $\ast$}]{split}
\end{DoxyParamCaption}
)}}\label{split_8c_af8a0571065ace2b371e017cabdb9eca7}
...
\hline
\end{DoxyParams}
\hypertarget{split_8c_a1fff7d9e737c42074ab661a1cd136b4c}{\index{split.\+c@{split.\+c}!split\+Remove@{split\+Remove}}
...
\item[{size\+\_\+t}]{where}
\end{DoxyParamCaption}
)}}\label{split_8c_a1fff7d9e737c42074ab661a1cd136b4c}
...
\end{DoxyPostcond}
\hypertarget{split_8c_af6fb30481571a63cfb7745adaa02d526}{\index{split.\+c@{split.\+c}!split\+Sync@{split\+Sync}}
\index{split\+Sync@{split\+Sync}!split.\+c@{split.\+c}}
\subsubsection[{split\+Sync}]{\setlength{\rightskip}{0pt plus 5cm}int split\+Sync (
\begin{DoxyParamCaption}
\item[{Split $\ast$}]{split}
\end{DoxyParamCaption}
)}}\label{split_8c_af6fb30481571a63cfb7745adaa02d526}
...
\hline
\end{DoxyParams}
\hypertarget{split_8c_a9c5bcc3cf34af26d3d8c69bb3cc9dadb}{\index{split.\+c@{split.\+c}!split\+Update\+File\+Name@{split\+Update\+File\+Name}}
...
\item[{Key $\ast$}]{key}
\end{DoxyParamCaption}
)}}\label{split_8c_a9c5bcc3cf34af26d3d8c69bb3cc9dadb}
...
\hline
\end{DoxyParams}
\hypertarget{split_8c_a7e1938ac64ef0c120c69c6c8c3943080}{\index{split.\+c@{split.\+c}!split\+Update\+Size@{split\+Update\+Size}}
...
\item[{Split $\ast$}]{split}
\end{DoxyParamCaption}
)}}\label{split_8c_a7e1938ac64ef0c120c69c6c8c3943080}
