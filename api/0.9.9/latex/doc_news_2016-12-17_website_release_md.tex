...
\end{DoxyItemize}\hypertarget{doc_news_2016-12-17_website_release_md_autotoc_md2974}{}\doxysection{Highlight}\label{doc_news_2016-12-17_website_release_md_autotoc_md2974}
...
\end{DoxyEnumerate}\hypertarget{doc_news_2016-12-17_website_release_md_autotoc_md2975}{}\doxysection{Introduction}\label{doc_news_2016-12-17_website_release_md_autotoc_md2975}
...
But sharing of snippets does not only help other users, it can help yourself as well because you can search for them easier. You also have access to the snippets in various formats at any time, allowing you to use them across multiple system by mounting them with the \href{https://master.libelektra.org/src/plugins/curlget}{\texttt{ curlget}} resolver!\hypertarget{doc_news_2016-12-17_website_release_md_autotoc_md2976}{}\doxysection{The Website}\label{doc_news_2016-12-17_website_release_md_autotoc_md2976}
The website was written by Marvin Mall in the course of his \href{https://www.libelektra.org/ftp/elektra/publications/mall2016rest.pdf}{\texttt{ bachelor thesis}} as part of the front-\/end he developed for his snippet sharing service. His main goals were to create a proper appearance for Elektra, but also to create a platform that promotes his service. We think that this worked out quite well by connecting the website with the service the way it was done.\hypertarget{doc_news_2016-12-17_website_release_md_autotoc_md2977}{}\doxysubsection{Documentation}\label{doc_news_2016-12-17_website_release_md_autotoc_md2977}
...
If you are interested in the techniques we use to structure our files, you can have a look at the website readme. The website is already the fourth view of our markdown pages! The others are man pages, doxygen, and github.\hypertarget{doc_news_2016-12-17_website_release_md_autotoc_md2978}{}\doxysubsection{Homepage \& News}\label{doc_news_2016-12-17_website_release_md_autotoc_md2978}
...
We hope that you enjoy our new appearance as much as we do!\hypertarget{doc_news_2016-12-17_website_release_md_autotoc_md2979}{}\doxysubsection{Snippet Sharing}\label{doc_news_2016-12-17_website_release_md_autotoc_md2979}
...
Snippets shared with the service are \href{https://www.libelektra.org/devgettingstarted/license}{\texttt{ BSD licensed}}. The snippets can also be downloaded directly as bundle from a separate \href{https://github.com/ElektraInitiative/snippets}{\texttt{ Git\+Hub repository}}. As soon as a snippet is added, changed or deleted on the website, a job that updates the repository is triggered. So you can expect the repository to be always up-\/to-\/date.\hypertarget{doc_news_2016-12-17_website_release_md_autotoc_md2980}{}\doxysubsection{No\+Script}\label{doc_news_2016-12-17_website_release_md_autotoc_md2980}
...
\end{DoxyEnumerate}\hypertarget{doc_news_2016-12-17_website_release_md_autotoc_md2981}{}\doxysection{Domains}\label{doc_news_2016-12-17_website_release_md_autotoc_md2981}
...
While most {\ttfamily libelektra.\+org} now point to the new website, you can still directly go to \href{https://git.libelektra.org}{\texttt{ github}} and also to the \href{https://bugs.libelektra.org}{\texttt{ bug tracker}}.

The old Wordpress installation was shut down because of security concerns.\hypertarget{doc_news_2016-12-17_website_release_md_autotoc_md2982}{}\doxysection{Feedback}\label{doc_news_2016-12-17_website_release_md_autotoc_md2982}
At this point there is not much more to say about the new website except for\+: Feel free to explore it!

We greatly appreciate all feedback, be it for the website, the snippet sharing service or other parts of the Elektra project. We always have an open ear for suggestions and we also like to help with technical issues, simply \href{https://bugs.libelektra.org}{\texttt{ leave us a note on github}}!\hypertarget{doc_news_2016-12-17_website_release_md_autotoc_md2983}{}\doxysection{Stay tuned!}\label{doc_news_2016-12-17_website_release_md_autotoc_md2983}
