...
\Hypertarget{doc_tutorials_run_all_tests_with_docker_md_md_doc_tutorials_run_all_tests_with_docker}%
 Running all the tests like the build server requires multiple dependencies. To overcome this problem, instead of trying to install all the necessary dependencies on your own, an appropriate Docker image can be used. This way you can easily and quickly run all the tests.\hypertarget{doc_tutorials_run_all_tests_with_docker_md_autotoc_md3963}{}\doxysection{Who Is This Guide For?}\label{doc_tutorials_run_all_tests_with_docker_md_autotoc_md3963}
For anyone who wants to run all the tests, like it is done by the build server.

This is a step-\/by-\/step guide. Just follow the steps and you are good to go!\hypertarget{doc_tutorials_run_all_tests_with_docker_md_autotoc_md3964}{}\doxysection{Prerequisites}\label{doc_tutorials_run_all_tests_with_docker_md_autotoc_md3964}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_run_all_tests_with_docker_md_autotoc_md3965}{}\doxysection{What to Begin With?}\label{doc_tutorials_run_all_tests_with_docker_md_autotoc_md3965}
\hypertarget{doc_tutorials_run_all_tests_with_docker_md_autotoc_md3966}{}\doxysubsection{1. Docker Image}\label{doc_tutorials_run_all_tests_with_docker_md_autotoc_md3966}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_run_all_tests_with_docker_md_autotoc_md3967}{}\doxysubsection{2. Run the Docker Container}\label{doc_tutorials_run_all_tests_with_docker_md_autotoc_md3967}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_run_all_tests_with_docker_md_autotoc_md3968}{}\doxysubsubsection{2.\+a Run the Docker Container with podman}\label{doc_tutorials_run_all_tests_with_docker_md_autotoc_md3968}
...
Do not forget the {\ttfamily \+:Z} label. You can read more about the labels in the podman \href{https://docs.podman.io/en/latest/index.html}{\texttt{ documentation}}.\hypertarget{doc_tutorials_run_all_tests_with_docker_md_autotoc_md3969}{}\doxysubsection{3. Build}\label{doc_tutorials_run_all_tests_with_docker_md_autotoc_md3969}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_run_all_tests_with_docker_md_autotoc_md3970}{}\doxysubsection{4. Run Tests}\label{doc_tutorials_run_all_tests_with_docker_md_autotoc_md3970}
