We are proud to present Elektra 0.\+8.\+25.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2259}{}\doxysection{What is Elektra?}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2259}
...
You can also read the news \href{https://www.libelektra.org/news/0.8.25-release}{\texttt{ on our website}}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2260}{}\doxysection{Metadata}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2260}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2261}{}\doxysection{Highlight}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2261}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2262}{}\doxysubsection{mmap storage}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2262}
...
Thanks to Mihael Pranjić for this improvement.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2263}{}\doxysubsection{Hybrid Search Algorithm for $<$tt$>$ks\+Lookup (...)$<$/tt$>$}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2263}
...
Because of the automatic decision, usually nothing needs to be done by A\+PI users to take advantage of this improvement. Advanced A\+PI user, however, can overrule the hybrid search by passing {\ttfamily K\+D\+B\+\_\+\+O\+\_\+\+O\+P\+M\+P\+HM} or {\ttfamily K\+D\+B\+\_\+\+O\+\_\+\+B\+I\+N\+S\+E\+A\+R\+CH} to {\ttfamily ks\+Lookup (...)}. The constants are defined in \href{https://master.libelektra.org/src/include/kdbproposal.h}{\texttt{ kdbproposal.\+h}}. For low-\/memory systems the building of the hash map can be disabled altogether at build-\/time by disabling the C\+Make variable {\ttfamily E\+N\+A\+B\+L\+E\+\_\+\+O\+P\+T\+I\+M\+I\+Z\+A\+T\+I\+O\+NS} (by default enabled now).

The implemented randomized \href{https://master.libelektra.org/doc/dev/data-structures.md\#order-preserving-minimal-perfect-hash-map-aka-opmphm}{\texttt{ O\+P\+M\+P\+HM}} algorithm is in 99.\+5\% of the measured random cases optimal. However the randomization property of the algorithm leaves an uncertainty.
...
Thanks to Kurt Micheli for this improvement.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2264}{}\doxysection{Plugins}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2264}
The following section lists news about the \href{https://www.libelektra.org/plugins/readme}{\texttt{ plugins}} we updated in this release.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2265}{}\doxysubsection{Directory Value}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2265}
We improved the performance of the \href{https://libelektra.org/plugins/directoryvalue}{\texttt{ directoryvalue plugin}}. \+\_\+(René Schwaiger)\+\_\+ This plugin is used for configuration file formats that do not support that directories contain values, like it is the case in J\+S\+ON. A program manipulating a 13 MB J\+S\+ON file which first did not succeed within 10 hours is now finished in 44 seconds.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2266}{}\doxysubsection{Process}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2266}
There is a new, experimental plugin called \href{https://libelektra.org/plugins/process}{\texttt{ process}}. This plugin utilizes the pluginprocess library in order to execute arbitrary other plugins in an own process, acting as a proxy itself. Therefore it is not required to explicitly change a plugin\textquotesingle{}s implementation if it shall be executed in an own process. This plugin is not completely finished yet, as currently there is no way for it to mimic the proxied plugin\textquotesingle{}s contract in Elektra. It can be used with simple plugins like {\ttfamily dump} however, check the limitations in the readme for more details. \+\_\+(\+Armin Wurzinger)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2267}{}\doxysubsection{F\+S\+Tab}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2267}
The detection of the {\ttfamily mntent} functions now also works correctly, if you use the compiler switch {\ttfamily -\/Werror}. \+\_\+(René Schwaiger)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2268}{}\doxysubsection{passwd}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2268}
We fixed an issue with the passwd plugin not properly setting compile flags. This resolves a problem with undefined functions when building with musl. \+\_\+(\+Lukas Winkler)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2269}{}\doxysubsection{gpgme}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2269}
The experimental \href{https://libelektra.org/plugins/gpgme}{\texttt{ gpgme plugin}} was brought into existence to provide cryptographic functions using Gnu\+GP via the {\ttfamily libgpgme} library. \+\_\+(\+Peter Nirschl)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2270}{}\doxysubsection{network}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2270}
The {\ttfamily network} plugin now also allows for non-\/numerical hosts (i.\+e. \char`\"{}localhost\char`\"{}) to be set and tries to resolve it via D\+NS. \+\_\+(\+Michael Zronek)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2271}{}\doxysubsection{Y\+A\+M\+Bi}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2271}
This new plugin parses a subset of Y\+A\+ML using a parser generated by \href{https://www.gnu.org/software/bison}{\texttt{ Bison}}. \+\_\+(René Schwaiger)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2272}{}\doxysubsection{Y\+A\+M\+L C\+PP}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2272}
The build system now disables the plugin automatically, if you use a G\+CC compiler ({\ttfamily 6.\+x} or earlier) and enable the option {\ttfamily E\+N\+A\+B\+L\+E\+\_\+\+A\+S\+AN}. We updated the behavior, since otherwise the plugin will report memory leaks at runtime. \+\_\+(René Schwaiger)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2273}{}\doxysubsection{Yan LR}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2273}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2274}{}\doxysubsection{Y\+Awn}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2274}
This new plugin parses a subset of Y\+A\+ML using the Earley Parser library Y\+A\+EP. \+\_\+(René Schwaiger)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2275}{}\doxysubsection{Reference}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2275}
This new plugin can be used to validate that the value of a key is a reference to another key. \+\_\+(Klemens Böswirth)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2276}{}\doxysection{Libraries}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2276}
The text below summarizes updates to the \href{https://www.libelektra.org/libraries/readme}{\texttt{ C (and C++)-\/based libraries}} of Elektra.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2277}{}\doxysubsection{Compatibility}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2277}
...
\end{DoxyCode}
\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2278}{}\doxysubsection{Infos for Package Maintainers}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2278}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2279}{}\doxysubsection{Core}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2279}
Optimize elektra\+Ks\+Filter to not duplicate keys \+\_\+(\+Markus Raab)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2280}{}\doxysubsection{Globbing}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2280}
A new library which can be used to match keys against globbing patterns was introduced. \+\_\+(Klemens Böswirth)\+\_\+

The A\+PI is still experimental, so it should not be used externally for now.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2281}{}\doxysubsection{Ease}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2281}
{\ttfamily libease} provides the function {\ttfamily elektra\+Array\+Validate\+Base\+Name\+String}, which can be used to validate that a given string is an Elektra array name. \+\_\+(Klemens Böswirth)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2282}{}\doxysection{Bindings}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2282}
Bindings allow you to utilize Elektra using \href{https://www.libelektra.org/bindings/readme}{\texttt{ various programming languages}}. This section keeps you up to date with the multi-\/language support provided by Elektra.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2283}{}\doxysubsection{Ruby}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2283}
Do not use private Elektra headers for Ruby bindings as preparation for a Ruby {\ttfamily libelektra} gem. \+\_\+(\+Bernhard Denner)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2284}{}\doxysection{Tools}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2284}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2285}{}\doxysection{Scripts}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2285}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2286}{}\doxysection{Documentation}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2286}
...
\item Go into more detail in \href{https://master.libelektra.org/doc/BUILDSERVER.md}{\texttt{ B\+U\+I\+L\+D\+S\+E\+R\+V\+E\+R.\+md}}. \+\_\+(\+Lukas Winkler)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2287}{}\doxysection{Tests}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2287}
...
\item The \href{https://master.libelektra.org/doc/TESTING.md}{\texttt{ C\+Framework}} macro {\ttfamily compare\+\_\+key} now also checks if the meta values of keys are equal. \+\_\+(René Schwaiger)\+\_\+
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2288}{}\doxysection{Build}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2288}
\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2289}{}\doxysubsection{C\+Make}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2289}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2290}{}\doxysubsection{Docker}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2290}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2291}{}\doxysubsection{Vagrant}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2291}

\begin{DoxyItemize}
\item Added Vagrantfile for Ubuntu artful 32-\/bit. \+\_\+(Mihael Pranjić)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2292}{}\doxysection{Infrastructure}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2292}
\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2293}{}\doxysubsection{Jenkins}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2293}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2294}{}\doxysubsection{Travis}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2294}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2295}{}\doxysection{Website}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2295}
The website is generated from the repository, so all information about plugins, bindings and tools are always up to date.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2296}{}\doxysection{Outlook}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2296}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2297}{}\doxysection{Statistics}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2297}
...
We welcome new contributors!\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2298}{}\doxysection{Finished Thesis}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2298}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2299}{}\doxysection{Get It!}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2299}
...
Already built A\+P\+I-\/\+Docu can be found \href{https://doc.libelektra.org/api/0.8.25/html/}{\texttt{ here}} or \href{https://github.com/ElektraInitiative/doc/tree/master/api/0.8.25}{\texttt{ Git\+Hub}}.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md2300}{}\doxysection{Stay tuned!}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md2300}
