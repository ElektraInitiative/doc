...
\hypertarget{doc_dev_kdb-operations_md_autotoc_md2697}{}\doxysection{$<$tt$>$open$<$/tt$>$ Operation}\label{doc_dev_kdb-operations_md_autotoc_md2697}
...
\end{DoxyItemize}\hypertarget{doc_dev_kdb-operations_md_autotoc_md2698}{}\doxysection{$<$tt$>$get$<$/tt$>$ Operation}\label{doc_dev_kdb-operations_md_autotoc_md2698}
...
\end{DoxyItemize}\hypertarget{doc_dev_kdb-operations_md_autotoc_md2699}{}\doxysection{$<$tt$>$set$<$/tt$>$ Operation}\label{doc_dev_kdb-operations_md_autotoc_md2699}
...
\item keys with other namespaces are always illegal in {\ttfamily ks}
\end{DoxyItemize}\hypertarget{doc_dev_kdb-operations_md_autotoc_md2700}{}\doxysection{$<$tt$>$close$<$/tt$>$ Operation}\label{doc_dev_kdb-operations_md_autotoc_md2700}
