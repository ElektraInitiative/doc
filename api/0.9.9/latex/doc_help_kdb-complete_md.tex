...
\Hypertarget{doc_help_kdb-complete_md_md_doc_help_kdb_complete}%
 \hypertarget{doc_help_kdb-complete_md_autotoc_md2452}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-complete_md_autotoc_md2452}
{\ttfamily kdb complete \mbox{[}path\mbox{]}}

Where {\ttfamily path} is the path for which the user would like to receive completion suggestion. If {\ttfamily path} is not specified, it will show every possible completion. It\textquotesingle{}s synonymous to calling {\ttfamily kdb complete \char`\"{}\char`\"{}}.\hypertarget{doc_help_kdb-complete_md_autotoc_md2453}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-complete_md_autotoc_md2453}
Show suggestions how the current name could be completed. Suggestions will include existing key names, path segments of existing key names, namespaces and mount points. Additionally, the output will indicate whether the given path is a node or a leaf in the hierarchy of keys, nodes end with \textquotesingle{}/\textquotesingle{} as opposed to leaves. It will also work for cascading keys, and will additionally display a cascading key\textquotesingle{}s namespace in the output to indicate from which namespace this suggestion originates from.\hypertarget{doc_help_kdb-complete_md_autotoc_md2454}{}\doxysection{OPTIONS}\label{doc_help_kdb-complete_md_autotoc_md2454}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-complete_md_autotoc_md2455}{}\doxysection{EXAMPLES}\label{doc_help_kdb-complete_md_autotoc_md2455}
...
\end{DoxyCode}
\hypertarget{doc_help_kdb-complete_md_autotoc_md2456}{}\doxysection{SEE ALSO}\label{doc_help_kdb-complete_md_autotoc_md2456}
