...
Absolute paths are still relative to their namespace (see {\ttfamily kdb plugin-\/info resolver}). Only system+spec mount points are actually absolute. Read \hyperlink{doc_help_elektra-namespaces_md}{elektra-\/namespaces(7)} for further information.
