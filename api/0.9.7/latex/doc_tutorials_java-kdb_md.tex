...
\Hypertarget{doc_tutorials_java-kdb_md_md_doc_tutorials_java_kdb}%
 \hypertarget{doc_tutorials_java-kdb_md_autotoc_md3624}{}\doxysection{Introduction}\label{doc_tutorials_java-kdb_md_autotoc_md3624}
When programming in Java it is possible to access the key database, changing values of existing keys or adding new ones and a few other things. It is also possible to write plugins for Elektra in Java but we will focus on using the Java binding in this tutorial.\hypertarget{doc_tutorials_java-kdb_md_autotoc_md3625}{}\doxysection{First Steps}\label{doc_tutorials_java-kdb_md_autotoc_md3625}
...
The key being passend to {\ttfamily KDB\+::open} is used to store warnings and error information. If an error occurs, it will be mapped to the appropriate specialization of {\ttfamily KDBException}.
...
\end{DoxyCode}
\hypertarget{doc_tutorials_java-kdb_md_autotoc_md3626}{}\doxysection{A word about releasing native ressources}\label{doc_tutorials_java-kdb_md_autotoc_md3626}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_java-kdb_md_autotoc_md3628}{}\doxysection{Saving Keys}\label{doc_tutorials_java-kdb_md_autotoc_md3628}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_java-kdb_md_autotoc_md3631}{}\doxysubsection{Read Multiple Keys From KDB}\label{doc_tutorials_java-kdb_md_autotoc_md3631}
This example shows how to read multiple keys. It provides comments for further clarification. Further information can be found here.\hypertarget{doc_tutorials_java-kdb_md_autotoc_md3632}{}\doxysection{Java Plugin Tutorial}\label{doc_tutorials_java-kdb_md_autotoc_md3632}
