...
\begin{DoxyCode}{0}
\DoxyCodeLine{Key *parentKey = \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}}(\textcolor{stringliteral}{"/sw/app/\#0"}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40afc1567f74444ff9c219f7456b652b4ec}{KEY\_CASCADING\_NAME}}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END}});}
...
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{group__keyset_gad2e30fb6d4739d917c5abb2ac2f9c1a1}{ksLookupByName}}(ks, \textcolor{stringliteral}{"/sw/app/\#0/promise"}, 0);}
\end{DoxyCode}
...
Note that the fallback, override and cascading works on {\itshape key level}, and not like most other systems have implemented, on configuration {\itshape file level}.\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md1947}{}\doxysection{Namespaces}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md1947}
...
As always, A\+P\+I+\+A\+BI is stable and compatible.\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md1950}{}\doxysection{Proposed}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md1950}
...
Finally, a bunch of new lookup options were added, which might not be useful for the public A\+PI (they allow us to disable the specification-\/aware features mentioned in the beginning).\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md1951}{}\doxysection{Obsolete and removed concepts}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md1951}
\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md1952}{}\doxysubsection{umount}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md1952}
...
Old mountpoints need to be removed with their 0.\+8.\+10 name ({\ttfamily \+\_\+} instead of {\ttfamily /}).\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md1953}{}\doxysubsection{directory keys}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md1953}
Additionally, the so called directory keys were also removed. Elektra was and still is completely key-\/value based. The {\ttfamily /} separator is only used for mountpoints.\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md1954}{}\doxysubsection{fstab}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md1954}
The plugin fstab is also improved\+: Slashes in mountpoints are escaped properly with the internal escaping engine of \mbox{\hyperlink{group__keyname_gaa942091fc4bd5c2699e49ddc50829524}{key\+Add\+Base\+Name()}} (i.\+e. without any problematic {\ttfamily /} replacements).\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md1955}{}\doxysubsection{dirname}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md1955}
get\+Dir\+Name() was removed from C++, gi-\/lua, gi-\/python2, gi-\/python3, swig-\/lua, swig-\/python2 and swig-\/python3. It was never present in C and did not fit well with \mbox{\hyperlink{group__keyname_gaaff35e7ca8af5560c47e662ceb9465f5}{key\+Base\+Name()}} (which returns an unescaped name, which is not possible for the dirname). (Thanks to Manuel Mausz)\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md1956}{}\doxysubsection{invalid parent names}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md1956}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{Key *parentKey = \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}}(\textcolor{stringliteral}{"/"}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END}});}
\end{DoxyCode}


should be used instead (if you want to get or store everything). They have identical behaviour, except that invalid names (that cannot be distinguished from empty names) will produce a warning. In the next major version invalid parent\+Names will produce an error.\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md1957}{}\doxysection{K\+D\+B Behaviour}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md1957}
...
Filesystem problems, e.\+g. permission, now always lead to the same errors (\#9, \#75, \#109, \#110), regardless of the storage plugin.\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md1958}{}\doxysection{Qt-\/\+Gui 0.\+0.\+6}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md1958}
...
A huge thanks to Raffael Pancheri for his contributions. His thesis can be found at \href{https://www.libelektra.org/ftp/elektra/pancheri2015gui.pdf}{\texttt{ here}}.\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md1959}{}\doxysection{Bug fixing}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md1959}
...
\end{DoxyItemize}\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md1960}{}\doxysection{Further gems}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md1960}
...
\end{DoxyItemize}\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md1961}{}\doxysection{Further Notes}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md1961}
...
already built A\+P\+I-\/\+Docu can be found \href{https://doc.libelektra.org/api/0.8.11/html/}{\texttt{ here}}\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md1963}{}\doxysection{Stay tuned!}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md1963}
