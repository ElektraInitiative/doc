...
\Hypertarget{doc_tutorials_command-line-options_md_md_doc_tutorials_command_line_options}%
 \hypertarget{doc_tutorials_command-line-options_md_autotoc_md4227}{}\doxysection{Introduction}\label{doc_tutorials_command-line-options_md_autotoc_md4227}
...
While you can specify multiple options (or environment variables, see below) for a single key, only one of them can be used at the same time. Using two or more options (or variables) that are all linked to the same key, will result in an error.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md4231}{}\doxysubsubsection{Option Arguments}\label{doc_tutorials_command-line-options_md_autotoc_md4231}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_command-line-options_md_autotoc_md4232}{}\doxysubsection{Environment Variables}\label{doc_tutorials_command-line-options_md_autotoc_md4232}
Elektra also supports parsing environment variables in a similar manner. For these there are however, less configuration options. You can simply specify one or more environment variables for a key using the {\ttfamily env} metakey (or {\ttfamily env/\#} meta-\/array for multiple).\hypertarget{doc_tutorials_command-line-options_md_autotoc_md4233}{}\doxysubsection{Arrays}\label{doc_tutorials_command-line-options_md_autotoc_md4233}
...
Environment variables obviously cannot be repeated, instead a behavior similar to that used for PATH is adopted. On Windows the variable will be split at each \textquotesingle{};\textquotesingle{} character. On all other systems \textquotesingle{}\+:\textquotesingle{} is used as a separator.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md4234}{}\doxysubsection{Parameter Arguments}\label{doc_tutorials_command-line-options_md_autotoc_md4234}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_command-line-options_md_autotoc_md4236}{}\doxysubsection{Sub-\/\+Commands}\label{doc_tutorials_command-line-options_md_autotoc_md4236}
...
The C code for this example is located in {\ttfamily examples/opts\+Commands.\+c}.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md4237}{}\doxysubsection{Precedence}\label{doc_tutorials_command-line-options_md_autotoc_md4237}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_command-line-options_md_autotoc_md4238}{}\doxysubsection{Limitations}\label{doc_tutorials_command-line-options_md_autotoc_md4238}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_command-line-options_md_autotoc_md4239}{}\doxysection{Help Message}\label{doc_tutorials_command-line-options_md_autotoc_md4239}
...
\hypertarget{doc_tutorials_command-line-options_md_autotoc_md4240}{}\doxysubsection{Structure of the Help Message}\label{doc_tutorials_command-line-options_md_autotoc_md4240}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_command-line-options_md_autotoc_md4243}{}\doxysubsubsection{Custom Usage Line}\label{doc_tutorials_command-line-options_md_autotoc_md4243}
...
Please note, that this will replace the whole usage line including the program name taken from {\ttfamily argv\mbox{[}0\mbox{]}}.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md4244}{}\doxysubsubsection{Adding a Prefix Text}\label{doc_tutorials_command-line-options_md_autotoc_md4244}
If you just want to add information above the options list, but not replace the whole usage line, you can do so by adding a prefix text. This can be done by \href{\#manual-help-message}{\texttt{ manually generating the help message}} or by passing the key {\ttfamily /help/prefix} in the {\ttfamily gopts\+Config} Key\+Set. The value of {\ttfamily /help/prefix} will be inserted between the usage line and the options list.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md4245}{}\doxysection{Examples}\label{doc_tutorials_command-line-options_md_autotoc_md4245}
...
\label{_elektra-opts}%
\hypertarget{doc_tutorials_command-line-options_md_autotoc_md4246}{}\doxysection{Advanced Use\+: Calling $<$tt$>$elektra\+Get\+Opts$<$/tt$>$ directly}\label{doc_tutorials_command-line-options_md_autotoc_md4246}
...
\hypertarget{doc_tutorials_command-line-options_md_autotoc_md4247}{}\doxysection{Advanced Use\+: Manually Generating the Help Message}\label{doc_tutorials_command-line-options_md_autotoc_md4247}
