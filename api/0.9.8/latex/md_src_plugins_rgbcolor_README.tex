...
This plugin validates hex-\/formatted rgb color strings and normalizes them to decimal rgba format. It also accepts \href{https://www.w3.org/TR/css-color-3/\#svg-color}{\texttt{ named colors}} and normalizes them.\hypertarget{md_src_plugins_rgbcolor_README_autotoc_md488}{}\doxysection{Usage}\label{md_src_plugins_rgbcolor_README_autotoc_md488}
Add the metakey {\ttfamily check/rgbcolor} with an arbitrary value (e.\+g. {\ttfamily \char`\"{}\char`\"{}}) to the key that you want to check and normalize.\hypertarget{md_src_plugins_rgbcolor_README_autotoc_md489}{}\doxysection{Installation}\label{md_src_plugins_rgbcolor_README_autotoc_md489}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/extra}.\hypertarget{md_src_plugins_rgbcolor_README_autotoc_md490}{}\doxysection{Examples}\label{md_src_plugins_rgbcolor_README_autotoc_md490}
