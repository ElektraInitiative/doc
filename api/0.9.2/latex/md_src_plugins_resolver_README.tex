...
($\sim$ and {\ttfamily pwd} are resolved from system)\hypertarget{md_src_plugins_resolver_README_autotoc_md620}{}\doxysection{Example}\label{md_src_plugins_resolver_README_autotoc_md620}
...
See \mbox{\hyperlink{doc_tutorials_mount_md}{the mount tutorial}} for more examples.\hypertarget{md_src_plugins_resolver_README_autotoc_md621}{}\doxysection{Variants}\label{md_src_plugins_resolver_README_autotoc_md621}
...
See \mbox{\hyperlink{doc_COMPILE_md}{C\+O\+M\+P\+I\+LE.md}} for a documentation of possible variants.\hypertarget{md_src_plugins_resolver_README_autotoc_md622}{}\doxysubsection{X\+D\+G Compatibility}\label{md_src_plugins_resolver_README_autotoc_md622}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_resolver_README_autotoc_md623}{}\doxysection{Reading Configuration}\label{md_src_plugins_resolver_README_autotoc_md623}
...
\end{DoxyEnumerate}\hypertarget{md_src_plugins_resolver_README_autotoc_md624}{}\doxysection{Writing Configuration}\label{md_src_plugins_resolver_README_autotoc_md624}
...
We have an optimistic approach. Locking is only used to detect concurrent cooperative processes in the short moment between prepare and commit. A conflict will be raised in that situation. When processes do not lock the file it might be overwritten. This is, however, very unlikely on file systems with nanosecond precision.\hypertarget{md_src_plugins_resolver_README_autotoc_md625}{}\doxysection{Exported Functions and Data}\label{md_src_plugins_resolver_README_autotoc_md625}
The resolver provides 2 functions for other plugins to use.\hypertarget{md_src_plugins_resolver_README_autotoc_md626}{}\doxysubsection{filename}\label{md_src_plugins_resolver_README_autotoc_md626}
...
{\ttfamily Elektra\+Resolved} and {\ttfamily Elektra\+Resolve\+Tempfile} are both defined in \href{/home/mpranj/workspace/libelektra/src/plugins/resolver/shared.h}{\texttt{ shared.\+h}}.
...
\end{DoxyItemize}\hypertarget{md_src_plugins_resolver_README_autotoc_md627}{}\doxysubsection{free\+Handle}\label{md_src_plugins_resolver_README_autotoc_md627}
frees the handle returned by {\ttfamily filename}.

Signature\+: {\ttfamily void $\ast$ free\+Handle (Elektra\+Resolved $\ast$ handle)}

where {\ttfamily handle} is the handle returned by {\ttfamily filename}.\hypertarget{md_src_plugins_resolver_README_autotoc_md628}{}\doxysection{Limitations}\label{md_src_plugins_resolver_README_autotoc_md628}
