...
\Hypertarget{doc_decisions_array_md_md_doc_decisions_array}%
 \hypertarget{doc_decisions_array_md_autotoc_md1651}{}\doxysection{Problem}\label{doc_decisions_array_md_autotoc_md1651}
Currently it is inefficient to detect the length of an array and it is impossible to know if a key (without subkeys) should be an array or not.\hypertarget{doc_decisions_array_md_autotoc_md1652}{}\doxysection{Constraints}\label{doc_decisions_array_md_autotoc_md1652}

\begin{DoxyItemize}
\item None
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1653}{}\doxysection{Assumptions}\label{doc_decisions_array_md_autotoc_md1653}
\hypertarget{doc_decisions_array_md_autotoc_md1654}{}\doxysection{Considered Alternatives}\label{doc_decisions_array_md_autotoc_md1654}
...
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1655}{}\doxysection{Decision}\label{doc_decisions_array_md_autotoc_md1655}
...
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1656}{}\doxysection{Rationale}\label{doc_decisions_array_md_autotoc_md1656}
...
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1657}{}\doxysection{Implications}\label{doc_decisions_array_md_autotoc_md1657}
...
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1658}{}\doxysection{Related Decisions}\label{doc_decisions_array_md_autotoc_md1658}
...
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1659}{}\doxysection{Notes}\label{doc_decisions_array_md_autotoc_md1659}
