...
\Hypertarget{doc_decisions_0_drafts_operation_sequences_md_md_doc_decisions_0_drafts_operation_sequences}%
 \hypertarget{doc_decisions_0_drafts_operation_sequences_md_autotoc_md1785}{}\doxysection{Problem}\label{doc_decisions_0_drafts_operation_sequences_md_autotoc_md1785}
...
As can be seen, the change tracking within the {\ttfamily dbus} and {\ttfamily logchange} plugins wrongly calculates everything below {\ttfamily user\+:/a} are new keys that have been added, and everything below {\ttfamily user\+:/b} was removed.\hypertarget{doc_decisions_0_drafts_operation_sequences_md_autotoc_md1787}{}\doxysection{Constraints}\label{doc_decisions_0_drafts_operation_sequences_md_autotoc_md1787}

\begin{DoxyEnumerate}
\item As far as possible, we must check for illegal sequences and raise an error when an illegal sequence occurs
\end{DoxyEnumerate}\hypertarget{doc_decisions_0_drafts_operation_sequences_md_autotoc_md1788}{}\doxysection{Assumptions}\label{doc_decisions_0_drafts_operation_sequences_md_autotoc_md1788}
1. 2. 3.\hypertarget{doc_decisions_0_drafts_operation_sequences_md_autotoc_md1789}{}\doxysection{Considered Alternatives}\label{doc_decisions_0_drafts_operation_sequences_md_autotoc_md1789}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_0_drafts_operation_sequences_md_autotoc_md1790}{}\doxysection{Decision}\label{doc_decisions_0_drafts_operation_sequences_md_autotoc_md1790}
\hypertarget{doc_decisions_0_drafts_operation_sequences_md_autotoc_md1791}{}\doxysection{Rationale}\label{doc_decisions_0_drafts_operation_sequences_md_autotoc_md1791}
\hypertarget{doc_decisions_0_drafts_operation_sequences_md_autotoc_md1792}{}\doxysection{Implications}\label{doc_decisions_0_drafts_operation_sequences_md_autotoc_md1792}

\begin{DoxyItemize}
\item 
\item 
\item 
\end{DoxyItemize}\hypertarget{doc_decisions_0_drafts_operation_sequences_md_autotoc_md1793}{}\doxysection{Related Decisions}\label{doc_decisions_0_drafts_operation_sequences_md_autotoc_md1793}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0_drafts_operation_sequences_md_autotoc_md1794}{}\doxysection{Notes}\label{doc_decisions_0_drafts_operation_sequences_md_autotoc_md1794}
