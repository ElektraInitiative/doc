...
\Hypertarget{doc_CODING_md_md_doc_CODING}%
 This document provides an introduction in how the source code of libelektra is organized and how and where to add functionality.\hypertarget{doc_CODING_md_autotoc_md1573}{}\doxysection{Folder structure}\label{doc_CODING_md_autotoc_md1573}
...
More about the structure you find in the folder\textquotesingle{}s {\ttfamily README.\+md}.\hypertarget{doc_CODING_md_autotoc_md1574}{}\doxysection{General Information}\label{doc_CODING_md_autotoc_md1574}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1575}{}\doxysection{Source Code}\label{doc_CODING_md_autotoc_md1575}
The same guidelines apply to all code in the repository including the plugins.\hypertarget{doc_CODING_md_autotoc_md1576}{}\doxysubsection{General Guidelines}\label{doc_CODING_md_autotoc_md1576}
...
If you see inconsistency within the rules do not hesitate to open an issue about it.\hypertarget{doc_CODING_md_autotoc_md1577}{}\doxysubsection{Code Comments}\label{doc_CODING_md_autotoc_md1577}
...
Read \mbox{\hyperlink{doc_dev_logging_md}{HERE}} for how to enable the logger.
...
\end{DoxyEnumerate}\hypertarget{doc_CODING_md_autotoc_md1578}{}\doxysubsection{Coding Style}\label{doc_CODING_md_autotoc_md1578}
...
{\bfseries{Example\+:}} \href{/home/jenkins/workspace/libelektra-release/src/libs/elektra/kdb.c}{\texttt{ src/libs/elektra/kdb.\+c}}\hypertarget{doc_CODING_md_autotoc_md1580}{}\doxysubsubsection{Clang Format}\label{doc_CODING_md_autotoc_md1580}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1581}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md1581}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1582}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md1582}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1583}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md1583}
...
. After that change Text\+Mate will reformat C and C++ code with {\ttfamily clang-\/format} every time you save a file.\hypertarget{doc_CODING_md_autotoc_md1584}{}\doxysubsection{C++ Guidelines}\label{doc_CODING_md_autotoc_md1584}
...
{\bfseries{Example\+:}} \href{/home/jenkins/workspace/libelektra-release/src/bindings/cpp/include/kdb.hpp}{\texttt{ src/bindings/cpp/include/kdb.\+hpp}}\hypertarget{doc_CODING_md_autotoc_md1585}{}\doxysubsection{CMake Guidelines}\label{doc_CODING_md_autotoc_md1585}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1586}{}\doxysubsubsection{cmake format}\label{doc_CODING_md_autotoc_md1586}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1587}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md1587}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1588}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md1588}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1589}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md1589}
...
in a file called \href{https://macromates.com/blog/2011/git-style-configuration}{\texttt{ {\ttfamily .tm\+\_\+properties}}} in the root of Elektra’s repository.\hypertarget{doc_CODING_md_autotoc_md1590}{}\doxysubsection{Groovy Guidelines}\label{doc_CODING_md_autotoc_md1590}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1591}{}\doxysubsection{Java}\label{doc_CODING_md_autotoc_md1591}
We use a similar style for Java and C/\+C++ code. This means we also use {\ttfamily clang-\/format} to format Java code. For more information on how to install {\ttfamily clang-\/format}, please take a look at the subheading “\+Clang Format” of the {\bfseries{“C Guidelines”}}.\hypertarget{doc_CODING_md_autotoc_md1592}{}\doxysubsubsection{Clang Format}\label{doc_CODING_md_autotoc_md1592}
\hypertarget{doc_CODING_md_autotoc_md1593}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md1593}
...
if ! \char`\"{}\$\{\+TM\+\_\+\+CLANG\+\_\+\+FORMAT\+:-\/clang-\/format\}\char`\"{} \textbackslash{} -\/style=\char`\"{}\$\{\+TM\+\_\+\+CLANG\+\_\+\+FORMAT\+\_\+\+STYLE\+:-\/file\}\char`\"{} \textbackslash{} -\/assume-\/filename=\char`\"{}\$\{\+TM\+\_\+\+FILEPATH\}\char`\"{}; then . \char`\"{}\$\+TM\+\_\+\+SUPPORT\+\_\+\+PATH/lib/bash\+\_\+init.\+sh\char`\"{} exit\+\_\+show\+\_\+tool\+\_\+tip fi \`{}\`{}\`{}
\item Save your new command\+: {\ttfamily ⌘} + {\ttfamily S}
\end{DoxyEnumerate}
\end{DoxyEnumerate}\hypertarget{doc_CODING_md_autotoc_md1594}{}\doxysubsection{Java\+Script Guidelines}\label{doc_CODING_md_autotoc_md1594}
\hypertarget{doc_CODING_md_autotoc_md1595}{}\doxysubsubsection{Prettier}\label{doc_CODING_md_autotoc_md1595}
We use \href{https://prettier.io}{\texttt{ {\ttfamily prettier}}} to format Java\+Script files.\hypertarget{doc_CODING_md_autotoc_md1596}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md1596}
\doxysubparagraph*{mac\+OS}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{npm install -\/-\/global prettier@2.2.1}

\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1597}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md1597}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1598}{}\doxysubsection{Markdown Guidelines}\label{doc_CODING_md_autotoc_md1598}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1599}{}\doxysubsubsection{Prettier}\label{doc_CODING_md_autotoc_md1599}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1600}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md1600}
For information on how to install the tool, please take a look at “\+Java\+Script Guidelines” → “\+Prettier” → “\+Installation”.\hypertarget{doc_CODING_md_autotoc_md1601}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md1601}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1602}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md1602}
...
\item Save your new command\+: {\ttfamily ⌘} + {\ttfamily S}
\end{DoxyEnumerate}
\end{DoxyEnumerate}\hypertarget{doc_CODING_md_autotoc_md1603}{}\doxysubsection{Shell Guidelines}\label{doc_CODING_md_autotoc_md1603}

\begin{DoxyItemize}
\item Please only use \href{https://en.wikipedia.org/wiki/POSIX}{\texttt{ POSIX}} functionality.
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1604}{}\doxysubsubsection{shfmt}\label{doc_CODING_md_autotoc_md1604}
We use \href{https://github.com/mvdan/sh}{\texttt{ {\ttfamily shfmt}}} to format Shell files in the repository.\hypertarget{doc_CODING_md_autotoc_md1605}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md1605}
\doxysubparagraph*{mac\+OS}
...
\DoxyCodeLine{  curl -\/L "{}https://github.com/mvdan/sh/releases/download/v3.2.4/shfmt\_v3.2.4\_linux\_amd64"{} -\/o shfmt \&\& \(\backslash\)}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1606}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md1606}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1607}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md1607}
...
\item Save your new command\+: {\ttfamily ⌘} + {\ttfamily S}
\end{DoxyEnumerate}
\end{DoxyEnumerate}\hypertarget{doc_CODING_md_autotoc_md1608}{}\doxysubsection{Doxygen Guidelines}\label{doc_CODING_md_autotoc_md1608}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1609}{}\doxysubsection{File Headers}\label{doc_CODING_md_autotoc_md1609}
...
The duplication of the filename, author and date is not needed, because this information is tracked using git and \mbox{\hyperlink{doc_AUTHORS_md}{doc/\+AUTHORS.md}} already.\hypertarget{doc_CODING_md_autotoc_md1610}{}\doxysection{Further Readings}\label{doc_CODING_md_autotoc_md1610}
