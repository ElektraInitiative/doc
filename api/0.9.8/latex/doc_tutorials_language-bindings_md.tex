...
\Hypertarget{doc_tutorials_language-bindings_md_md_doc_tutorials_language_bindings}%
 \hypertarget{doc_tutorials_language-bindings_md_autotoc_md3640}{}\doxysection{Introduction}\label{doc_tutorials_language-bindings_md_autotoc_md3640}
In this section, we will explain the how to write a language binding for Elektra.\hypertarget{doc_tutorials_language-bindings_md_autotoc_md3641}{}\doxysubsection{High-\/level API}\label{doc_tutorials_language-bindings_md_autotoc_md3641}
Writing bindings for the high-\/level API is described in a \mbox{\hyperlink{doc_tutorials_highlevel-bindings_md}{different document}}, since it is a bit less straightforward and needs additional considerations.\hypertarget{doc_tutorials_language-bindings_md_autotoc_md3642}{}\doxysection{TODO}\label{doc_tutorials_language-bindings_md_autotoc_md3642}
...
\end{DoxyEnumerate}
\end{DoxyEnumerate}\hypertarget{doc_tutorials_language-bindings_md_autotoc_md3643}{}\doxysection{CMake Integration}\label{doc_tutorials_language-bindings_md_autotoc_md3643}
\hypertarget{doc_tutorials_language-bindings_md_autotoc_md3644}{}\doxysubsection{Building}\label{doc_tutorials_language-bindings_md_autotoc_md3644}
...
We can then explicitly include the bindings using {\ttfamily cmake -\/DBINDINGS=\char`\"{}our\+\_\+binding\char`\"{} ..} in the build directory and follow the further steps for \mbox{\hyperlink{doc_COMPILE_md}{compilation}}.\hypertarget{doc_tutorials_language-bindings_md_autotoc_md3645}{}\doxysubsection{Testing}\label{doc_tutorials_language-bindings_md_autotoc_md3645}
...
See the Java binding for examples.\hypertarget{doc_tutorials_language-bindings_md_autotoc_md3646}{}\doxysection{Error Handling}\label{doc_tutorials_language-bindings_md_autotoc_md3646}
...
If you have a language which does not support inheritance this way like Go\+Lang, you can still use the error code itself since the hierarchy is integrated in it. For example you can check if the code starts with {\ttfamily C01...} to catch all {\ttfamily Permanent Errors}.\hypertarget{doc_tutorials_language-bindings_md_autotoc_md3647}{}\doxysubsection{Error Message}\label{doc_tutorials_language-bindings_md_autotoc_md3647}
