...
\Hypertarget{doc_tutorials_specification_md_md_doc_tutorials_specification}%
 \hypertarget{doc_tutorials_specification_md_autotoc_md3733}{}\doxysection{Overview}\label{doc_tutorials_specification_md_autotoc_md3733}
\hypertarget{doc_tutorials_specification_md_autotoc_md3734}{}\doxysubsection{Introduction}\label{doc_tutorials_specification_md_autotoc_md3734}
In this tutorial you will learn how to interactively use the {\ttfamily Spec\+Elektra} specification language and {\ttfamily kdb} to write a configuration specification for an example application.\hypertarget{doc_tutorials_specification_md_autotoc_md3735}{}\doxysubsection{What you should already know}\label{doc_tutorials_specification_md_autotoc_md3735}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md3736}{}\doxysubsection{What you’ll Learn}\label{doc_tutorials_specification_md_autotoc_md3736}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md3737}{}\doxysubsection{What you\textquotesingle{}ll do}\label{doc_tutorials_specification_md_autotoc_md3737}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md3738}{}\doxysection{Example App Overview}\label{doc_tutorials_specification_md_autotoc_md3738}
...
\item a backup date
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md3739}{}\doxysection{Getting Started}\label{doc_tutorials_specification_md_autotoc_md3739}
...
Otherwise refer to the \href{https://www.libelektra.org/getstarted/guide}{\texttt{ getting started guide}} to install it.\hypertarget{doc_tutorials_specification_md_autotoc_md3740}{}\doxysection{Mounting the Specification}\label{doc_tutorials_specification_md_autotoc_md3740}
\hypertarget{doc_tutorials_specification_md_autotoc_md3741}{}\doxysubsection{Step 1\+: Mount a Specification File}\label{doc_tutorials_specification_md_autotoc_md3741}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md3742}{}\doxysubsection{Step 2\+: Define a mountpoint}\label{doc_tutorials_specification_md_autotoc_md3742}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md3743}{}\doxysubsection{Step 3\+: Do a specification mount}\label{doc_tutorials_specification_md_autotoc_md3743}
...
This specification mount makes sure that the paths where the concrete configuration should be, in this case {\ttfamily app.\+ni}, are ready to fulfill or specification, in this case {\ttfamily spec.\+ni}.\hypertarget{doc_tutorials_specification_md_autotoc_md3744}{}\doxysection{Adding your first key to the specification}\label{doc_tutorials_specification_md_autotoc_md3744}
\hypertarget{doc_tutorials_specification_md_autotoc_md3745}{}\doxysubsection{Step 1\+: Adding the server port}\label{doc_tutorials_specification_md_autotoc_md3745}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md3746}{}\doxysubsection{Step 2\+: Adding more metadata}\label{doc_tutorials_specification_md_autotoc_md3746}
...
Did it work? I hope not. The validation plugin you specified will now correctly validate the port you enter and give you an error.\hypertarget{doc_tutorials_specification_md_autotoc_md3747}{}\doxysubsection{Step 3\+: Adding boolean keys}\label{doc_tutorials_specification_md_autotoc_md3747}
Next up you will configure the {\ttfamily secure} property of our server. This boolean key will toggle if your server encrypts the communication via SSL or not.
...
\DoxyCodeLine{kdb meta-\/set spec:/sw/org/app/\(\backslash\)\#0/current/server/secure description "{}describes if the REST server uses SSL for communication or not"{}}
...
You can read more about this in the documentation for the \href{https://www.libelektra.org/plugins/type\#normalization}{\texttt{ type plugin}}.\hypertarget{doc_tutorials_specification_md_autotoc_md3748}{}\doxysection{Adding the database keys to the specification}\label{doc_tutorials_specification_md_autotoc_md3748}
\hypertarget{doc_tutorials_specification_md_autotoc_md3749}{}\doxysubsection{Step 1\+: Adding the database ip}\label{doc_tutorials_specification_md_autotoc_md3749}
...
\DoxyCodeLine{ meta:/description = describes if the REST server uses SSL for communication or not}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md3750}{}\doxysubsection{Step 2\+: Adding the database dialect}\label{doc_tutorials_specification_md_autotoc_md3750}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{kdb meta-\/set spec:/sw/org/app/\(\backslash\)\#0/current/database/dialect default mssql}
\DoxyCodeLine{kdb meta-\/set spec:/sw/org/app/\(\backslash\)\#0/current/database/dialect example mysql}
\DoxyCodeLine{kdb meta-\/set spec:/sw/org/app/\(\backslash\)\#0/current/database/dialect description "{}SQL dialect of the database server, that the application will connect to (postgresql|mysql|mssql|mariadb|sqlite)"{}}
...
\DoxyCodeLine{ meta:/description = SQL dialect of the database server, that the application will connect to (postgresql|mysql|mssql|mariadb|sqlite)}
\DoxyCodeLine{ meta:/check/enum/\#4 = sqlite}
\DoxyCodeLine{ meta:/check/enum/\#3 = mariadb}
\DoxyCodeLine{ meta:/default = mssql}
\DoxyCodeLine{ meta:/check/enum = \#4}

\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md3751}{}\doxysection{Adding the backup date}\label{doc_tutorials_specification_md_autotoc_md3751}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md3752}{}\doxysection{Final specification code}\label{doc_tutorials_specification_md_autotoc_md3752}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md3753}{}\doxysection{Summary}\label{doc_tutorials_specification_md_autotoc_md3753}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md3754}{}\doxysection{Learn more}\label{doc_tutorials_specification_md_autotoc_md3754}
