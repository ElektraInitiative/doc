...
This is a high performance storage plugin that supports full Elektra semantics.\hypertarget{md_src_plugins_mmapstorage_README_autotoc_md338}{}\doxysection{Format}\label{md_src_plugins_mmapstorage_README_autotoc_md338}
The storage format uses Elektra\textquotesingle{}s in-\/memory data layout and employs the {\ttfamily mmap()} system call to read/write data. The format is not portable across different architectures/platforms. The format can be seen as a memory dump of a keyset. Therefore, the files must not be edited by hand. Files written by mmapstorage are not intended to be human-\/readable.\hypertarget{md_src_plugins_mmapstorage_README_autotoc_md339}{}\doxysection{Usage}\label{md_src_plugins_mmapstorage_README_autotoc_md339}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_mmapstorage_README_autotoc_md340}{}\doxysection{Compiling}\label{md_src_plugins_mmapstorage_README_autotoc_md340}
...
The {\ttfamily mmapstorage} will always be compiled on a supported system (see \href{\#dependencies}{\texttt{ Dependencies}}). When zlib is available, we will additionally compile the {\ttfamily mmapstorage\+\_\+crc} variant. The first variant does not do a CRC32 checksum of the critical data, while the second variant always checks the CRC32 checksum for additional security.\hypertarget{md_src_plugins_mmapstorage_README_autotoc_md341}{}\doxysection{Installation}\label{md_src_plugins_mmapstorage_README_autotoc_md341}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The {\ttfamily mmapstorage} variant is part of the {\ttfamily libelektra5} package and the {\ttfamily mmapstorage\+\_\+crc} is part of the {\ttfamily libelektra5-\/extra} package.\hypertarget{md_src_plugins_mmapstorage_README_autotoc_md342}{}\doxysection{Dependencies}\label{md_src_plugins_mmapstorage_README_autotoc_md342}
POSIX compliant system (including XSI extensions).

Additionally, zlib is needed for the {\ttfamily mmapstorage\+\_\+crc} compilation variant\+: {\ttfamily zlib1g-\/dev} or {\ttfamily zlib-\/devel}.\hypertarget{md_src_plugins_mmapstorage_README_autotoc_md343}{}\doxysection{Examples}\label{md_src_plugins_mmapstorage_README_autotoc_md343}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_mmapstorage_README_autotoc_md344}{}\doxysection{Limitations}\label{md_src_plugins_mmapstorage_README_autotoc_md344}
