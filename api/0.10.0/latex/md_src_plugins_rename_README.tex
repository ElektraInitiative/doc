...
\item basic
\item advanced
\end{DoxyItemize}\hypertarget{md_src_plugins_rename_README_autotoc_md475}{}\doxysection{Basic Transformations}\label{md_src_plugins_rename_README_autotoc_md475}
are applied before and after the advanced transformations.\hypertarget{md_src_plugins_rename_README_autotoc_md476}{}\doxysubsection{Get}\label{md_src_plugins_rename_README_autotoc_md476}
...
converts the whole keyname below the parent\+Key to upper-\/ or lowercase. if no configuration or {\ttfamily unchanged} is used no transformation is done here.\hypertarget{md_src_plugins_rename_README_autotoc_md477}{}\doxysubsection{Set}\label{md_src_plugins_rename_README_autotoc_md477}
...
{\ttfamily keyname} tells the plugin to keep the name of the advanced transformation\hypertarget{md_src_plugins_rename_README_autotoc_md478}{}\doxysection{Advanced Transformations}\label{md_src_plugins_rename_README_autotoc_md478}
\hypertarget{md_src_plugins_rename_README_autotoc_md479}{}\doxysubsection{Cut}\label{md_src_plugins_rename_README_autotoc_md479}
\hypertarget{md_src_plugins_rename_README_autotoc_md480}{}\doxysubsubsection{Operation}\label{md_src_plugins_rename_README_autotoc_md480}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_rename_README_autotoc_md481}{}\doxysubsubsection{Configuration}\label{md_src_plugins_rename_README_autotoc_md481}
...
If an invalid configuration is given or the cut operation would cause a parent key duplicate, the affected keys are simply skipped and not renamed.\hypertarget{md_src_plugins_rename_README_autotoc_md482}{}\doxysubsection{Replace}\label{md_src_plugins_rename_README_autotoc_md482}
Using the {\ttfamily /replacewith} global key or {\ttfamily rename/to} Meta\+Key the rename plugin will replace the part removed by {\ttfamily cut} with the supplied String\hypertarget{md_src_plugins_rename_README_autotoc_md483}{}\doxysubsubsection{To upper/lower}\label{md_src_plugins_rename_README_autotoc_md483}
...
you can use {\ttfamily tolower=0} to get the keys {\ttfamily key} and {\ttfamily other/key}.\hypertarget{md_src_plugins_rename_README_autotoc_md484}{}\doxysubsubsection{Examples}\label{md_src_plugins_rename_README_autotoc_md484}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_rename_README_autotoc_md485}{}\doxysection{Planned Operations}\label{md_src_plugins_rename_README_autotoc_md485}
