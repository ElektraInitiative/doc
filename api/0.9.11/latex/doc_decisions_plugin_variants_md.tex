...
\Hypertarget{doc_decisions_plugin_variants_md_md_doc_decisions_plugin_variants}%
 \hypertarget{doc_decisions_plugin_variants_md_autotoc_md2077}{}\doxysection{Problem}\label{doc_decisions_plugin_variants_md_autotoc_md2077}
...
The current issue is that there is no way to enumerate possible plugin variants as needed to list all functionality of Elektra.\hypertarget{doc_decisions_plugin_variants_md_autotoc_md2078}{}\doxysection{Constraints}\label{doc_decisions_plugin_variants_md_autotoc_md2078}
...
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md2079}{}\doxysection{Assumptions}\label{doc_decisions_plugin_variants_md_autotoc_md2079}

\begin{DoxyItemize}
\item The number of variants needs to be bounded\+: plugin variants need to be fully enumerable
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md2080}{}\doxysection{Considered Alternatives}\label{doc_decisions_plugin_variants_md_autotoc_md2080}
...
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md2081}{}\doxysection{Decision}\label{doc_decisions_plugin_variants_md_autotoc_md2081}
...
\end{DoxyItemize}
\end{DoxyEnumerate}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md2082}{}\doxysubsection{Example}\label{doc_decisions_plugin_variants_md_autotoc_md2082}
...
\end{DoxyCode}
\hypertarget{doc_decisions_plugin_variants_md_autotoc_md2083}{}\doxysection{Rationale}\label{doc_decisions_plugin_variants_md_autotoc_md2083}
...
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md2084}{}\doxysection{Implications}\label{doc_decisions_plugin_variants_md_autotoc_md2084}
...
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md2085}{}\doxysection{Current state}\label{doc_decisions_plugin_variants_md_autotoc_md2085}
...
gets ignored.\hypertarget{doc_decisions_plugin_variants_md_autotoc_md2086}{}\doxysection{Related Decisions}\label{doc_decisions_plugin_variants_md_autotoc_md2086}

\begin{DoxyItemize}
\item \mbox{\hyperlink{doc_decisions_cmake_plugins_md}{CMake Plugins}}
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md2087}{}\doxysection{Notes}\label{doc_decisions_plugin_variants_md_autotoc_md2087}
