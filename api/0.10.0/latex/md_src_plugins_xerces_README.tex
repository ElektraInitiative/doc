...
\end{DoxyItemize}\hypertarget{md_src_plugins_xerces_README_autotoc_md607}{}\doxysection{Installation}\label{md_src_plugins_xerces_README_autotoc_md607}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/xerces}.

To include this plugin in a homebrew installation run {\ttfamily brew tap elektrainitiative/elektra} followed by {\ttfamily brew install elektrainitiative/elektra/elektra -\/-\/with-\/xerces}\hypertarget{md_src_plugins_xerces_README_autotoc_md608}{}\doxysection{Usage}\label{md_src_plugins_xerces_README_autotoc_md608}
...
The root element of the resulting XML file will be \char`\"{}xerces\char`\"{} again, restored via the metadata. If you don\textquotesingle{}t want this behavior, delete the metadata {\ttfamily xerces/rootname} on the mount point, then it uses the mount point\textquotesingle{}s name instead.\hypertarget{md_src_plugins_xerces_README_autotoc_md609}{}\doxysection{Dependencies}\label{md_src_plugins_xerces_README_autotoc_md609}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_xerces_README_autotoc_md610}{}\doxysection{Limitations}\label{md_src_plugins_xerces_README_autotoc_md610}
...
XSD transformations, schemas or DTDs are not supported yet.\hypertarget{md_src_plugins_xerces_README_autotoc_md611}{}\doxysection{Examples}\label{md_src_plugins_xerces_README_autotoc_md611}
\hypertarget{md_src_plugins_xerces_README_autotoc_md612}{}\doxysubsection{Mounting, setting a key and exporting}\label{md_src_plugins_xerces_README_autotoc_md612}
