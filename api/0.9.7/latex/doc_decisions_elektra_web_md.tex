...
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_md_autotoc_md1760}{}\doxysection{Assumptions}\label{doc_decisions_elektra_web_md_autotoc_md1760}
\hypertarget{doc_decisions_elektra_web_md_autotoc_md1761}{}\doxysection{Considered Alternatives}\label{doc_decisions_elektra_web_md_autotoc_md1761}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_md_autotoc_md1762}{}\doxysection{Decision}\label{doc_decisions_elektra_web_md_autotoc_md1762}
Use one cluster daemon (clusterd) to manage all clusters and instances.\hypertarget{doc_decisions_elektra_web_md_autotoc_md1763}{}\doxysection{Rationale}\label{doc_decisions_elektra_web_md_autotoc_md1763}
