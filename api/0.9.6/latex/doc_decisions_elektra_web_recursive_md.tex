...
\Hypertarget{doc_decisions_elektra_web_recursive_md_md_doc_decisions_elektra_web_recursive}%
 \hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1762}{}\doxysection{Problem}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1762}
After deciding how to remotely manage instances and groups of instances (clusters) with Elektra Web, there is still the issue of recursively nested clusters (clusters of clusters).\hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1763}{}\doxysection{Constraints}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1763}
...
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1764}{}\doxysection{Assumptions}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1764}

\begin{DoxyItemize}
\item Use one cluster daemon (clusterd) to manage all clusters and instances.
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1765}{}\doxysection{Considered Alternatives}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1765}
...
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1766}{}\doxysection{Decision}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1766}
Managing the hierarchy in a single clusterd instance.\hypertarget{doc_decisions_elektra_web_recursive_md_autotoc_md1767}{}\doxysection{Rationale}\label{doc_decisions_elektra_web_recursive_md_autotoc_md1767}
