...
\Hypertarget{doc_tutorials_specification_md_md_doc_tutorials_specification}%
 \hypertarget{doc_tutorials_specification_md_autotoc_md3977}{}\doxysection{Overview}\label{doc_tutorials_specification_md_autotoc_md3977}
\hypertarget{doc_tutorials_specification_md_autotoc_md3978}{}\doxysubsection{Introduction}\label{doc_tutorials_specification_md_autotoc_md3978}
In this tutorial you will learn how to interactively use the {\ttfamily Spec\+Elektra} specification language and {\ttfamily kdb} to write a configuration specification for an example application.\hypertarget{doc_tutorials_specification_md_autotoc_md3979}{}\doxysubsection{What you should already know}\label{doc_tutorials_specification_md_autotoc_md3979}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md3980}{}\doxysubsection{What you’ll learn}\label{doc_tutorials_specification_md_autotoc_md3980}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md3981}{}\doxysubsection{What you\textquotesingle{}ll do}\label{doc_tutorials_specification_md_autotoc_md3981}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md3982}{}\doxysection{Example App Overview}\label{doc_tutorials_specification_md_autotoc_md3982}
...
\item a backup date
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md3983}{}\doxysection{Getting Started}\label{doc_tutorials_specification_md_autotoc_md3983}
...
Otherwise refer to the \href{https://www.libelektra.org/getstarted/guide}{\texttt{ getting started guide}} to install it.\hypertarget{doc_tutorials_specification_md_autotoc_md3984}{}\doxysection{Mounting the Specification}\label{doc_tutorials_specification_md_autotoc_md3984}
\hypertarget{doc_tutorials_specification_md_autotoc_md3985}{}\doxysubsection{Step 1\+: Mount a Specification File}\label{doc_tutorials_specification_md_autotoc_md3985}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md3986}{}\doxysubsection{Step 2\+: Define a mountpoint}\label{doc_tutorials_specification_md_autotoc_md3986}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md3987}{}\doxysubsection{Step 3\+: Do a specification mount}\label{doc_tutorials_specification_md_autotoc_md3987}
...
For more information about namespaces in Elektra please see \href{https://www.libelektra.org/manpages/elektra-namespaces}{\texttt{ here}}, a tutorial about the topic is available \href{https://www.libelektra.org/tutorials/namespaces}{\texttt{ here}}.\hypertarget{doc_tutorials_specification_md_autotoc_md3988}{}\doxysection{Adding your first key to the specification}\label{doc_tutorials_specification_md_autotoc_md3988}
\hypertarget{doc_tutorials_specification_md_autotoc_md3989}{}\doxysubsection{Step 1\+: Adding the server port}\label{doc_tutorials_specification_md_autotoc_md3989}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md3990}{}\doxysubsection{Step 2\+: Adding more metadata}\label{doc_tutorials_specification_md_autotoc_md3990}
...
In this example, the {\ttfamily network} plugin and the {\ttfamily type} plugin are emitting warnings or errors, because the valid ranges for {\ttfamily port} and {\ttfamily unsigned\+\_\+short} are the same.\hypertarget{doc_tutorials_specification_md_autotoc_md3991}{}\doxysubsection{Step 3\+: Adding boolean keys}\label{doc_tutorials_specification_md_autotoc_md3991}
...
You can read more about this in the documentation for the \href{https://www.libelektra.org/plugins/type\#normalization}{\texttt{ type plugin}}.\hypertarget{doc_tutorials_specification_md_autotoc_md3992}{}\doxysection{Adding the database keys to the specification}\label{doc_tutorials_specification_md_autotoc_md3992}
\hypertarget{doc_tutorials_specification_md_autotoc_md3993}{}\doxysubsection{Step 1\+: Adding the database ip}\label{doc_tutorials_specification_md_autotoc_md3993}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md3994}{}\doxysubsection{Step 2\+: Adding the database dialect}\label{doc_tutorials_specification_md_autotoc_md3994}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md3995}{}\doxysection{Adding the backup date}\label{doc_tutorials_specification_md_autotoc_md3995}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md3996}{}\doxysection{Final specification code}\label{doc_tutorials_specification_md_autotoc_md3996}
...
\hypertarget{doc_tutorials_specification_md_autotoc_md3997}{}\doxysection{Using the specification}\label{doc_tutorials_specification_md_autotoc_md3997}
...
Please note that also in these examples, the file referred to by the absolute path {\ttfamily /etc/spec.ni} is a {\bfseries{new file}} where the content of the file {\ttfamily ./spec.ni} in the working directory gets imported or copied to.\hypertarget{doc_tutorials_specification_md_autotoc_md3998}{}\doxysection{Cleanup}\label{doc_tutorials_specification_md_autotoc_md3998}
...
In case something went wrong and you want to reset the whole content of your kdb, please refer to \href{https://www.libelektra.org/manpages/kdb-reset}{\texttt{ the manpage of kdb reset}}.\hypertarget{doc_tutorials_specification_md_autotoc_md3999}{}\doxysection{Summary}\label{doc_tutorials_specification_md_autotoc_md3999}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md4000}{}\doxysection{Learn more}\label{doc_tutorials_specification_md_autotoc_md4000}
