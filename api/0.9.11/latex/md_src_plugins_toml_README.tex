...
This plugin is a storage plugin for reading and writing TOML files. The plugin retains most of the file structure of a read TOML file such as comments, empty lines and TOML tables. It supports all kinds of TOML specific types and tables, including nested inline tables and multiline strings.\hypertarget{md_src_plugins_toml_README_autotoc_md554}{}\doxysection{Requirements}\label{md_src_plugins_toml_README_autotoc_md554}
The plugin needs Flex ($>$=2.\+6.\+2) and Bison ($>$=3) for parsing TOML files.\hypertarget{md_src_plugins_toml_README_autotoc_md555}{}\doxysection{Types}\label{md_src_plugins_toml_README_autotoc_md555}
\hypertarget{md_src_plugins_toml_README_autotoc_md556}{}\doxysubsection{Reading}\label{md_src_plugins_toml_README_autotoc_md556}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_toml_README_autotoc_md557}{}\doxysubsection{Writing}\label{md_src_plugins_toml_README_autotoc_md557}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_toml_README_autotoc_md558}{}\doxysection{Numbers}\label{md_src_plugins_toml_README_autotoc_md558}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_toml_README_autotoc_md559}{}\doxysection{Strings}\label{md_src_plugins_toml_README_autotoc_md559}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_toml_README_autotoc_md561}{}\doxysection{TOML specific structures}\label{md_src_plugins_toml_README_autotoc_md561}
TOML specific structures are represented by the metakey {\ttfamily tomltype} on a certain key. It will be set when the TOML plugin reads a TOML structure from a file. Additionally, this metakey can be set by the user, if they want a certain TOML structure to be written. No automatic inference of this metakey is done on writing.\hypertarget{md_src_plugins_toml_README_autotoc_md562}{}\doxysubsection{Simple Tables}\label{md_src_plugins_toml_README_autotoc_md562}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_toml_README_autotoc_md563}{}\doxysubsection{Table Arrays}\label{md_src_plugins_toml_README_autotoc_md563}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_toml_README_autotoc_md564}{}\doxysubsection{Inline Tables}\label{md_src_plugins_toml_README_autotoc_md564}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_toml_README_autotoc_md565}{}\doxysubsection{Arrays}\label{md_src_plugins_toml_README_autotoc_md565}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_toml_README_autotoc_md566}{}\doxysection{Comments and Empty Lines}\label{md_src_plugins_toml_README_autotoc_md566}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_toml_README_autotoc_md567}{}\doxysubsection{Comments in Arrays}\label{md_src_plugins_toml_README_autotoc_md567}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_toml_README_autotoc_md568}{}\doxysection{Order}\label{md_src_plugins_toml_README_autotoc_md568}
...
In this example, {\ttfamily d} and {\ttfamily common} have the same parent, the file root. This means, they need to be sorted with each other. {\ttfamily d} would be placed before {\ttfamily common} by it\textquotesingle{}s order, since it was set before, and thus, has lesser order. However, their order never gets compared, since {\ttfamily common} is a simple table and {\ttfamily d} is not, so {\ttfamily d} will get sorted before the table regardless of order.\hypertarget{md_src_plugins_toml_README_autotoc_md569}{}\doxysection{Limitations}\label{md_src_plugins_toml_README_autotoc_md569}
