...
Elektra provides a mature, consistent and easily comprehensible API. Its modularity effectively avoids code duplication across applications and tools concerning their configuration tasks. Elektra abstracts from cross-\/platform-\/related issues and enables applications to be aware of other applications\textquotesingle{} configurations, leveraging easy application integration.\hypertarget{README_md_autotoc_md3831}{}\doxysection{Often Used Links}\label{README_md_autotoc_md3831}
...
\end{DoxyItemize}\hypertarget{README_md_autotoc_md3832}{}\doxysection{Overview}\label{README_md_autotoc_md3832}
...
In case you are worried about linking to such a powerful library. The core is a small library implemented in C, works cross-\/platform, and does not need any external dependencies. There are bindings for other languages in case C is too low-\/level for you.\hypertarget{README_md_autotoc_md3833}{}\doxysection{Contact}\label{README_md_autotoc_md3833}
Do not hesitate to ask any question on \href{https://issues.libelektra.org/}{\texttt{ Git\+Hub issue tracker}} or directly to one of the \mbox{\hyperlink{doc_AUTHORS_md}{authors}}.\hypertarget{README_md_autotoc_md3834}{}\doxysection{Quickstart}\label{README_md_autotoc_md3834}
\hypertarget{README_md_autotoc_md3835}{}\doxysubsection{Installation}\label{README_md_autotoc_md3835}
...
\hypertarget{README_md_autotoc_md3836}{}\doxysubsection{Usage}\label{README_md_autotoc_md3836}
...
\end{DoxyItemize}\hypertarget{README_md_autotoc_md3837}{}\doxysubsection{Documentation}\label{README_md_autotoc_md3837}
...
\hypertarget{README_md_autotoc_md3838}{}\doxysection{Facts and Features}\label{README_md_autotoc_md3838}
...
\end{DoxyItemize}\hypertarget{README_md_autotoc_md3839}{}\doxysection{News}\label{README_md_autotoc_md3839}
Go to the \href{https://www.libelektra.org}{\texttt{ website}}, see the news, and its \href{https://www.libelektra.org/news/feed.rss}{\texttt{ RSS feed}}.\hypertarget{README_md_autotoc_md3840}{}\doxysection{Download}\label{README_md_autotoc_md3840}
...
Releases can be downloaded from \href{https://www.libelektra.org/ftp/elektra/releases/}{\texttt{ here}}.\hypertarget{README_md_autotoc_md3841}{}\doxysection{Build Server}\label{README_md_autotoc_md3841}
The \href{https://build.libelektra.org/}{\texttt{ build server}} builds Elektra for every pull request and on every commit in various ways and also produces \href{https://doc.libelektra.org/coverage/master/debian-buster-full/}{\texttt{ LCOV code coverage report}}.\hypertarget{README_md_autotoc_md3842}{}\doxysection{Contributing}\label{README_md_autotoc_md3842}
Take a look at \mbox{\hyperlink{doc_IDEAS_md}{how to start contributing}}.\hypertarget{README_md_autotoc_md3843}{}\doxysection{Goals}\label{README_md_autotoc_md3843}
