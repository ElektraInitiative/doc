...
\Hypertarget{doc_tutorials_command-line-options_md_md_doc_tutorials_command_line_options}%
 \hypertarget{doc_tutorials_command-line-options_md_autotoc_md3452}{}\doxysection{Introduction}\label{doc_tutorials_command-line-options_md_autotoc_md3452}
...
The last parameter {\ttfamily gopts\+Config} can be used to provide additional configuration values to {\ttfamily gopts}. For example, this can be used to configure the auto-\/generated help message. The keys that {\ttfamily gopts} accepts in this Key\+Set will be explained throughout the document . A full list can be found in the \mbox{\hyperlink{md_src_plugins_gopts_README_src_plugins_gopts_README_md}{\`{}gopts\`{} README}}.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3454}{}\doxysection{Specification}\label{doc_tutorials_command-line-options_md_autotoc_md3454}
This section describes the specification used by the command-\/line option and environment variable parser.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3455}{}\doxysubsection{Options}\label{doc_tutorials_command-line-options_md_autotoc_md3455}
...
While you can specify multiple options (or environment variables, see below) for a single key, only one of them can be used at the same time. Using two or more options (or variables) that are all linked to the same key, will result in an error.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3456}{}\doxysubsubsection{Option Arguments}\label{doc_tutorials_command-line-options_md_autotoc_md3456}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3457}{}\doxysubsection{Environment Variables}\label{doc_tutorials_command-line-options_md_autotoc_md3457}
Elektra also supports parsing environment variables in a similar manner. For these there are however, less configuration options. You can simply specify one or more environment variables for a key using the {\ttfamily env} metakey (or {\ttfamily env/\#} meta-\/array for multiple).\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3458}{}\doxysubsection{Arrays}\label{doc_tutorials_command-line-options_md_autotoc_md3458}
...
Environment variables obviously cannot be repeated, instead a behavior similar that used for PATH is adopted. On Windows the variable will be split at each \textquotesingle{};\textquotesingle{} character. On all other systems \textquotesingle{}\+:\textquotesingle{} is used as a separator.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3459}{}\doxysubsection{Parameter Arguments}\label{doc_tutorials_command-line-options_md_autotoc_md3459}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3461}{}\doxysubsection{Sub-\/\+Commands}\label{doc_tutorials_command-line-options_md_autotoc_md3461}
...
The C code for this example is located in {\ttfamily examples/opts\+Commands.\+c}.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3462}{}\doxysubsection{Precedence}\label{doc_tutorials_command-line-options_md_autotoc_md3462}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3463}{}\doxysubsection{Limitations}\label{doc_tutorials_command-line-options_md_autotoc_md3463}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3464}{}\doxysection{Help Message}\label{doc_tutorials_command-line-options_md_autotoc_md3464}
...
\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3465}{}\doxysubsection{Structure of the Help Message}\label{doc_tutorials_command-line-options_md_autotoc_md3465}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3468}{}\doxysubsubsection{Custom Usage Line}\label{doc_tutorials_command-line-options_md_autotoc_md3468}
...
Please note, that this will replace the whole usage line including the program name taken from {\ttfamily argv\mbox{[}0\mbox{]}}.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3469}{}\doxysubsubsection{Adding a Prefix Text}\label{doc_tutorials_command-line-options_md_autotoc_md3469}
If you just want to add information above the options list, but not replace the whole usage line, you can do so by adding a prefix text. This can be done by \href{\#manual-help-message}{\texttt{ manually generating the help message}} or by passing the key {\ttfamily /help/prefix} in the {\ttfamily gopts\+Config} Key\+Set. The value of {\ttfamily /help/prefix} will be inserted between the usage line and the options list.\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3470}{}\doxysection{Examples}\label{doc_tutorials_command-line-options_md_autotoc_md3470}
...
\label{_elektra-opts}%
\hypertarget{doc_tutorials_command-line-options_md_autotoc_md3471}{}\doxysection{Advanced Use\+: Calling $<$tt$>$elektra\+Get\+Opts$<$/tt$>$ directly}\label{doc_tutorials_command-line-options_md_autotoc_md3471}
