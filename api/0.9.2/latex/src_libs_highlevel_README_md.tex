...
The A\+PI supports all C\+O\+R\+BA Basic Data Types, except for {\ttfamily wchar}, as well as the {\ttfamily string} type (see also \href{\#data-types}{\texttt{ Data Types}} below).\hypertarget{src_libs_highlevel_README_md_autotoc_md6}{}\doxysection{Setup}\label{src_libs_highlevel_README_md_autotoc_md6}
...
The default callback simply logs the error with {\ttfamily E\+L\+E\+K\+T\+R\+A\+\_\+\+L\+O\+G\+\_\+\+D\+E\+B\+UG} and then calls {\ttfamily exit()} with exit code {\ttfamily E\+X\+I\+T\+\_\+\+F\+A\+I\+L\+U\+RE} It is expected that you implement your own callback, so that you get proper error message logged in your applications preferred format. Using the default callback is only viable for very simple applications, because you won\textquotesingle{}t get any indication as to which key caused the error (unless you compiled Elektra with debug logging enabled).\hypertarget{src_libs_highlevel_README_md_autotoc_md13}{}\doxysection{Data Types}\label{src_libs_highlevel_README_md_autotoc_md13}
...
There is also the type {\ttfamily enum} with constant {\ttfamily K\+D\+B\+\_\+\+T\+Y\+P\+E\+\_\+\+E\+N\+UM}. It is only supported via the \mbox{\hyperlink{doc_help_elektra-highlevel-gen_md}{code-\/generation A\+PI}}.\hypertarget{src_libs_highlevel_README_md_autotoc_md14}{}\doxyparagraph{Note about Floating Point Types}\label{src_libs_highlevel_README_md_autotoc_md14}
...
\hypertarget{src_libs_highlevel_README_md_autotoc_md17}{}\doxysubsection{Read Values from the K\+DB}\label{src_libs_highlevel_README_md_autotoc_md17}
...
You can find the complete list of the available functions for all supported value types in \href{/home/mpranj/workspace/libelektra/src/include/elektra.h}{\texttt{ elektra.\+h}}\hypertarget{src_libs_highlevel_README_md_autotoc_md18}{}\doxysubsection{Writing Values to the K\+DB}\label{src_libs_highlevel_README_md_autotoc_md18}
...
The high-\/level A\+PI does not support binary key values at this time.\hypertarget{src_libs_highlevel_README_md_autotoc_md23}{}\doxysection{Example}\label{src_libs_highlevel_README_md_autotoc_md23}
