...
\begin{quote}
Please note that the parameters passed to add\+\_\+plugin need to be constant between all invocations. Some {\ttfamily find\+\_\+package} cache their variables, others do not, which might lead to toggling variables. To avoid problem, make a variable containing all L\+I\+N\+K\+\_\+\+L\+I\+B\+R\+A\+R\+I\+ES or D\+E\+P\+E\+N\+D\+E\+N\+C\+I\+ES within D\+E\+P\+E\+N\+D\+E\+N\+C\+Y\+\_\+\+P\+H\+A\+SE. \end{quote}
