...
\hypertarget{md_src_plugins_email_README_autotoc_md178}{}\doxysubsection{Introduction}\label{md_src_plugins_email_README_autotoc_md178}
This plugin validates email addresses using regular expressions. The plugin does not support the full RFC5321 spec. For more information see \href{\#Limitations}{\texttt{ Limitations}} below.\hypertarget{md_src_plugins_email_README_autotoc_md179}{}\doxysubsection{Installation}\label{md_src_plugins_email_README_autotoc_md179}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/experimental}.\hypertarget{md_src_plugins_email_README_autotoc_md180}{}\doxysubsection{Usage}\label{md_src_plugins_email_README_autotoc_md180}
...
\DoxyCodeLine{kdb meta-\/set /tests/email/noaddr check/email}
\DoxyCodeLine{kdb set /tests/email/noaddr invalid..address@com}
\DoxyCodeLine{\# RET: 0}
\DoxyCodeLine{}
\DoxyCodeLine{\# Check the validity of the email stored in `/tests/email/adr`}
\DoxyCodeLine{kdb meta-\/set /tests/email/adr check/email "{}"{}}
\DoxyCodeLine{}
\DoxyCodeLine{\# Set a correct email address}
\DoxyCodeLine{kdb set /tests/email/adr test+email@dev.libelektra.com}
\DoxyCodeLine{kdb get /tests/email/adr}
\DoxyCodeLine{\#> test+email@dev.libelektra.com}
\DoxyCodeLine{}
\DoxyCodeLine{\# Try to set incorrect addresses}
\DoxyCodeLine{kdb set /tests/email/adr invalid..address@com}
\DoxyCodeLine{\# STDERR: .*Validation Semantic.*}
\DoxyCodeLine{\# ERROR:  C03200}
\DoxyCodeLine{\# RET: 5}
\DoxyCodeLine{}
\DoxyCodeLine{kdb set /tests/email/adr not.@email.com}
\DoxyCodeLine{\# STDERR: .*Validation Semantic.*}
\DoxyCodeLine{\# ERROR:  C03200}
\DoxyCodeLine{\# RET: 5}
\DoxyCodeLine{}
\DoxyCodeLine{kdb set /tests/email/adr @}
\DoxyCodeLine{\# STDERR: .*Validation Semantic.*}
\DoxyCodeLine{\# ERROR:  C03200}
\DoxyCodeLine{\# RET: 5}
\DoxyCodeLine{}
\DoxyCodeLine{\# Undo modifications to the database}
\DoxyCodeLine{kdb rm -\/r /tests/email}
\DoxyCodeLine{kdb umount /tests/email}

\end{DoxyCode}
\hypertarget{md_src_plugins_email_README_autotoc_md181}{}\doxysubsection{Limitations}\label{md_src_plugins_email_README_autotoc_md181}
