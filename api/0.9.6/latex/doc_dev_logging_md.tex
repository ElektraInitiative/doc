\label{doc_dev_logging_md_md_doc_dev_logging}%
\Hypertarget{doc_dev_logging_md_md_doc_dev_logging}%
 \hypertarget{doc_dev_logging_md_autotoc_md2172}{}\doxysection{Quickstart}\label{doc_dev_logging_md_autotoc_md2172}
...
The file sink behaves like syslog, if it has been enabled (see below).\hypertarget{doc_dev_logging_md_autotoc_md2173}{}\doxysection{Step by Step Guide}\label{doc_dev_logging_md_autotoc_md2173}
\hypertarget{doc_dev_logging_md_autotoc_md2174}{}\doxysubsection{Preparation}\label{doc_dev_logging_md_autotoc_md2174}
...
\end{DoxyCode}
\hypertarget{doc_dev_logging_md_autotoc_md2175}{}\doxysubsubsection{Log Everything}\label{doc_dev_logging_md_autotoc_md2175}
...
\end{DoxyCode}
\hypertarget{doc_dev_logging_md_autotoc_md2176}{}\doxysubsubsection{File Specific Logging}\label{doc_dev_logging_md_autotoc_md2176}
...
\end{DoxyCode}
\hypertarget{doc_dev_logging_md_autotoc_md2177}{}\doxysubsection{Enabling and Disabling Sinks}\label{doc_dev_logging_md_autotoc_md2177}
...
\end{DoxyCode}
\hypertarget{doc_dev_logging_md_autotoc_md2178}{}\doxysubsection{Compilation}\label{doc_dev_logging_md_autotoc_md2178}

\begin{DoxyEnumerate}
\item Enable the logger\+: e.\+g. run {\ttfamily cmake} with the switch {\ttfamily -\/DENABLE\+\_\+\+LOGGER=ON}
\item Build Elektra
\end{DoxyEnumerate}\hypertarget{doc_dev_logging_md_autotoc_md2179}{}\doxysection{Log Levels}\label{doc_dev_logging_md_autotoc_md2179}
