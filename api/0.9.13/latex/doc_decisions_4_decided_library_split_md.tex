...
\Hypertarget{doc_decisions_4_decided_library_split_md_md_doc_decisions_4_decided_library_split}%
 \hypertarget{doc_decisions_4_decided_library_split_md_autotoc_md2133}{}\doxysection{Problem}\label{doc_decisions_4_decided_library_split_md_autotoc_md2133}
Only {\ttfamily libelektra-\/core} is supposed to access private data, but this contradicts the goal to keep the library minimal. {\ttfamily \mbox{\hyperlink{kdbprivate_8h}{kdbprivate.\+h}}} was too generic, it contained many other parts next to the struct definitions of Key/\+Key\+Set.\hypertarget{doc_decisions_4_decided_library_split_md_autotoc_md2134}{}\doxysection{Constraints}\label{doc_decisions_4_decided_library_split_md_autotoc_md2134}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_library_split_md_autotoc_md2135}{}\doxysection{Assumptions}\label{doc_decisions_4_decided_library_split_md_autotoc_md2135}
\hypertarget{doc_decisions_4_decided_library_split_md_autotoc_md2136}{}\doxysection{Considered Alternatives}\label{doc_decisions_4_decided_library_split_md_autotoc_md2136}

\begin{DoxyItemize}
\item keep current situation
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_library_split_md_autotoc_md2137}{}\doxysection{Decision}\label{doc_decisions_4_decided_library_split_md_autotoc_md2137}
...
All currently planned libraries and their respective API prefixes are listed in the \href{\#notes}{\texttt{ Notes}} below.\hypertarget{doc_decisions_4_decided_library_split_md_autotoc_md2138}{}\doxysection{Rationale}\label{doc_decisions_4_decided_library_split_md_autotoc_md2138}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_library_split_md_autotoc_md2139}{}\doxysection{Implications}\label{doc_decisions_4_decided_library_split_md_autotoc_md2139}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_library_split_md_autotoc_md2140}{}\doxysection{Related Decisions}\label{doc_decisions_4_decided_library_split_md_autotoc_md2140}
\hypertarget{doc_decisions_4_decided_library_split_md_autotoc_md2141}{}\doxysection{Notes}\label{doc_decisions_4_decided_library_split_md_autotoc_md2141}
