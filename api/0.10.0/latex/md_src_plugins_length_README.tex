...
\hypertarget{md_src_plugins_length_README_autotoc_md309}{}\doxysubsection{Introduction}\label{md_src_plugins_length_README_autotoc_md309}
This plugins purpose is to check the maximum length of strings. For example if {\ttfamily check/length/max} is set to 3, Strings with more than 3 characters will not validate (e.\+g. \char`\"{}abcd\char`\"{}), whereas \char`\"{}abc\char`\"{} would validate.\hypertarget{md_src_plugins_length_README_autotoc_md310}{}\doxysubsection{Installation}\label{md_src_plugins_length_README_autotoc_md310}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/experimental}.\hypertarget{md_src_plugins_length_README_autotoc_md311}{}\doxysubsection{Usage}\label{md_src_plugins_length_README_autotoc_md311}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_length_README_autotoc_md312}{}\doxysubsection{Limitations}\label{md_src_plugins_length_README_autotoc_md312}
