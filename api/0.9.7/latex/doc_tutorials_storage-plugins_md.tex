...
takes more work. Before you continue with this text, please make sure that you read all of the linked documents above.\hypertarget{doc_tutorials_storage-plugins_md_autotoc_md3755}{}\doxysection{Don’t Add Additional Keys}\label{doc_tutorials_storage-plugins_md_autotoc_md3755}
...
. For more information on why we allow “holes” in the hierarchy, please take a look \mbox{\hyperlink{doc_decisions_holes_md}{here}}.\hypertarget{doc_tutorials_storage-plugins_md_autotoc_md3756}{}\doxysection{Differentiate Between Empty Keys and Keys Containing an Empty String}\label{doc_tutorials_storage-plugins_md_autotoc_md3756}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_storage-plugins_md_autotoc_md3757}{}\doxysection{Convert Boolean Data}\label{doc_tutorials_storage-plugins_md_autotoc_md3757}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_storage-plugins_md_autotoc_md3758}{}\doxysection{Support Values Inside Non-\/\+Leaf Keys}\label{doc_tutorials_storage-plugins_md_autotoc_md3758}
...
. To make sure that your storage plugin works correctly, please just replace {\ttfamily yamlcpp} with the name of your plugin and verify that the test above still works.\hypertarget{doc_tutorials_storage-plugins_md_autotoc_md3759}{}\doxysection{Support Array And Non-\/\+Array Data Properly}\label{doc_tutorials_storage-plugins_md_autotoc_md3759}
