...
What a Lua script can do is not really limited by design, so any kind of plugin may be implemented. The lua plugin is especially useful to write filter and logging scripts.\hypertarget{md_src_plugins_lua_README_autotoc_md325}{}\doxysection{Installation}\label{md_src_plugins_lua_README_autotoc_md325}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/lua}.\hypertarget{md_src_plugins_lua_README_autotoc_md326}{}\doxysection{Usage}\label{md_src_plugins_lua_README_autotoc_md326}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_lua_README_autotoc_md327}{}\doxysubsection{Lua Scripts}\label{md_src_plugins_lua_README_autotoc_md327}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_lua_README_autotoc_md328}{}\doxysection{Example}\label{md_src_plugins_lua_README_autotoc_md328}
...
Further examples can be found in the lua directory.\hypertarget{md_src_plugins_lua_README_autotoc_md329}{}\doxysection{Disclaimer}\label{md_src_plugins_lua_README_autotoc_md329}
