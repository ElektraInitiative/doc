...
Plugin specific config.\hypertarget{md_src_plugins_list_README_autotoc_md314}{}\doxysection{Exported Functions}\label{md_src_plugins_list_README_autotoc_md314}
...
Finally, {\ttfamily elektra\+List\+Find\+Plugin} looks for a plugin in the config, and if found returns its handle.\hypertarget{md_src_plugins_list_README_autotoc_md315}{}\doxysection{Example}\label{md_src_plugins_list_README_autotoc_md315}
