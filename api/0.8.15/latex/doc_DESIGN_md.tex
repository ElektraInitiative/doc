...
Elektra's function share common error codes. Every function must return {\ttfamily -\/1} on error, if it return type is integer (like {\ttfamily int}, {\ttfamily ssize\+\_\+t}). If the function returns a pointer, {\ttfamily 0} ({\ttfamily N\+U\+L\+L}) will indicate an error. This behaviour can't be used for functions that return integers, since {\ttfamily 0} is a valid size and can also be used to represent the boolean value {\ttfamily false}.
