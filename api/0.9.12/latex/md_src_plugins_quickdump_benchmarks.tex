...
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md423}{}\doxysubsection{$<$tt$>$benchmark\+\_\+storage$<$/tt$>$}\label{md_src_plugins_quickdump_benchmarks_autotoc_md423}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md424}{}\doxysubsection{$<$tt$>$benchmark\+\_\+plugingetset$<$/tt$>$}\label{md_src_plugins_quickdump_benchmarks_autotoc_md424}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md426}{}\doxysubsubsection{Version 1}\label{md_src_plugins_quickdump_benchmarks_autotoc_md426}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md427}{}\doxyparagraph{File sizes}\label{md_src_plugins_quickdump_benchmarks_autotoc_md427}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md428}{}\doxyparagraph{get and set}\label{md_src_plugins_quickdump_benchmarks_autotoc_md428}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md429}{}\doxyparagraph{get only}\label{md_src_plugins_quickdump_benchmarks_autotoc_md429}
The values are mean ± standard deviation. {\ttfamily factor} is {\ttfamily dump / quickdump} like above
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md430}{}\doxysubsubsection{Version 2}\label{md_src_plugins_quickdump_benchmarks_autotoc_md430}
Running the same {\ttfamily benchmark\+\_\+plugingetset} tests with version 2 of the plugin yields\+:\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md431}{}\doxyparagraph{File sizes}\label{md_src_plugins_quickdump_benchmarks_autotoc_md431}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md432}{}\doxyparagraph{get and set}\label{md_src_plugins_quickdump_benchmarks_autotoc_md432}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md433}{}\doxyparagraph{get only}\label{md_src_plugins_quickdump_benchmarks_autotoc_md433}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md434}{}\doxysubsubsection{Version 3}\label{md_src_plugins_quickdump_benchmarks_autotoc_md434}
Running the same {\ttfamily benchmark\+\_\+plugingetset} tests with version 3 of the plugin yields\+:\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md435}{}\doxyparagraph{File sizes}\label{md_src_plugins_quickdump_benchmarks_autotoc_md435}
{\ttfamily factor} is {\ttfamily v1 / v2} like above (bigger is better)
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md436}{}\doxyparagraph{get and set}\label{md_src_plugins_quickdump_benchmarks_autotoc_md436}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md437}{}\doxyparagraph{get only}\label{md_src_plugins_quickdump_benchmarks_autotoc_md437}
