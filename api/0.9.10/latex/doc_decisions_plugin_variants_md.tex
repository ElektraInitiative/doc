...
\Hypertarget{doc_decisions_plugin_variants_md_md_doc_decisions_plugin_variants}%
 \hypertarget{doc_decisions_plugin_variants_md_autotoc_md2054}{}\doxysection{Problem}\label{doc_decisions_plugin_variants_md_autotoc_md2054}
...
The current issue is that there is no way to enumerate possible plugin variants as needed to list all functionality of Elektra.\hypertarget{doc_decisions_plugin_variants_md_autotoc_md2055}{}\doxysection{Constraints}\label{doc_decisions_plugin_variants_md_autotoc_md2055}
...
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md2056}{}\doxysection{Assumptions}\label{doc_decisions_plugin_variants_md_autotoc_md2056}

\begin{DoxyItemize}
\item The number of variants needs to be bounded\+: plugin variants need to be fully enumerable
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md2057}{}\doxysection{Considered Alternatives}\label{doc_decisions_plugin_variants_md_autotoc_md2057}
...
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md2058}{}\doxysection{Decision}\label{doc_decisions_plugin_variants_md_autotoc_md2058}
...
\end{DoxyItemize}
\end{DoxyEnumerate}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md2059}{}\doxysubsection{Example}\label{doc_decisions_plugin_variants_md_autotoc_md2059}
...
\end{DoxyCode}
\hypertarget{doc_decisions_plugin_variants_md_autotoc_md2060}{}\doxysection{Rationale}\label{doc_decisions_plugin_variants_md_autotoc_md2060}
...
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md2061}{}\doxysection{Implications}\label{doc_decisions_plugin_variants_md_autotoc_md2061}
...
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md2062}{}\doxysection{Current state}\label{doc_decisions_plugin_variants_md_autotoc_md2062}
...
gets ignored.\hypertarget{doc_decisions_plugin_variants_md_autotoc_md2063}{}\doxysection{Related Decisions}\label{doc_decisions_plugin_variants_md_autotoc_md2063}

\begin{DoxyItemize}
\item \mbox{\hyperlink{doc_decisions_cmake_plugins_md}{CMake Plugins}}
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md2064}{}\doxysection{Notes}\label{doc_decisions_plugin_variants_md_autotoc_md2064}
