...
\Hypertarget{doc_news_2018-11-18_0_8_25_md_md_doc_news_2018_11_18_0_8_25}%
 We are proud to present Elektra 0.\+8.\+25.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3158}{}\doxysection{What is Elektra?}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3158}
...
You can also read the news \href{https://www.libelektra.org/news/0.8.25-release}{\texttt{ on our website}}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3159}{}\doxysection{Metadata}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3159}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3160}{}\doxysection{Highlight}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3160}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3161}{}\doxysubsection{mmap storage}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3161}
...
Thanks to Mihael Pranjić for this improvement.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3162}{}\doxysubsection{Hybrid Search Algorithm for $<$tt$>$ks\+Lookup (...)$<$/tt$>$}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3162}
...
Thanks to Kurt Micheli for this improvement.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3163}{}\doxysection{Plugins}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3163}
The following section lists news about the \href{https://www.libelektra.org/plugins/readme}{\texttt{ plugins}} we updated in this release.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3164}{}\doxysubsection{Directory Value}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3164}
We improved the performance of the \href{https://libelektra.org/plugins/directoryvalue}{\texttt{ directoryvalue plugin}}. \+\_\+(René Schwaiger)\+\_\+ This plugin is used for configuration file formats that do not support that directories contain values, like it is the case in JSON. A program manipulating a 13 MB JSON file which first did not succeed within 10 hours is now finished in 44 seconds.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3165}{}\doxysubsection{Process}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3165}
There is a new, experimental plugin called \href{https://libelektra.org/plugins/process}{\texttt{ process}}. This plugin utilizes the pluginprocess library in order to execute arbitrary other plugins in an own process, acting as a proxy itself. Therefore it is not required to explicitly change a plugin\textquotesingle{}s implementation if it shall be executed in an own process. This plugin is not completely finished yet, as currently there is no way for it to mimic the proxied plugin\textquotesingle{}s contract in Elektra. It can be used with simple plugins like {\ttfamily dump} however, check the limitations in the readme for more details. \+\_\+(\+Armin Wurzinger)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3166}{}\doxysubsection{FSTab}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3166}
The detection of the {\ttfamily mntent} functions now also works correctly, if you use the compiler switch {\ttfamily -\/Werror}. \+\_\+(René Schwaiger)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3167}{}\doxysubsection{passwd}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3167}
We fixed an issue with the passwd plugin not properly setting compile flags. This resolves a problem with undefined functions when building with musl. \+\_\+(\+Lukas Winkler)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3168}{}\doxysubsection{gpgme}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3168}
The experimental \href{https://libelektra.org/plugins/gpgme}{\texttt{ gpgme plugin}} was brought into existence to provide cryptographic functions using Gnu\+GP via the {\ttfamily libgpgme} library. \+\_\+(\+Peter Nirschl)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3169}{}\doxysubsection{network}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3169}
The {\ttfamily network} plugin now also allows for non-\/numerical hosts (i.\+e. \char`\"{}localhost\char`\"{}) to be set and tries to resolve it via DNS. \+\_\+(\+Michael Zronek)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3170}{}\doxysubsection{YAMBi}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3170}
This new plugin parses a subset of YAML using a parser generated by \href{https://www.gnu.org/software/bison}{\texttt{ Bison}}. \+\_\+(René Schwaiger)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3171}{}\doxysubsection{YAML CPP}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3171}
The build system now disables the plugin automatically, if you use a GCC compiler ({\ttfamily 6.\+x} or earlier) and enable the option {\ttfamily ENABLE\+\_\+\+ASAN}. We updated the behavior, since otherwise the plugin will report memory leaks at runtime. \+\_\+(René Schwaiger)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3172}{}\doxysubsection{Yan LR}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3172}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3173}{}\doxysubsection{YAwn}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3173}
This new plugin parses a subset of YAML using the Earley Parser library YAEP. \+\_\+(René Schwaiger)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3174}{}\doxysubsection{Reference}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3174}
This new plugin can be used to validate that the value of a key is a reference to another key. \+\_\+(Klemens Böswirth)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3175}{}\doxysection{Libraries}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3175}
The text below summarizes updates to the \href{https://www.libelektra.org/libraries/readme}{\texttt{ C (and C++)-\/based libraries}} of Elektra.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3176}{}\doxysubsection{Compatibility}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3176}
...
\end{DoxyCode}
\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3177}{}\doxysubsection{Infos for Package Maintainers}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3177}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3178}{}\doxysubsection{Core}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3178}
Optimize elektra\+Ks\+Filter to not duplicate keys \+\_\+(\+Markus Raab)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3179}{}\doxysubsection{Globbing}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3179}
A new library which can be used to match keys against globbing patterns was introduced. \+\_\+(Klemens Böswirth)\+\_\+

The API is still experimental, so it should not be used externally for now.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3180}{}\doxysubsection{Ease}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3180}
{\ttfamily libease} provides the function {\ttfamily elektra\+Array\+Validate\+Base\+Name\+String}, which can be used to validate that a given string is an Elektra array name. \+\_\+(Klemens Böswirth)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3181}{}\doxysection{Bindings}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3181}
Bindings allow you to utilize Elektra using \href{https://www.libelektra.org/bindings/readme}{\texttt{ various programming languages}}. This section keeps you up-\/to-\/date with the multi-\/language support provided by Elektra.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3182}{}\doxysubsection{Ruby}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3182}
Do not use private Elektra headers for Ruby bindings as preparation for a Ruby {\ttfamily libelektra} gem. \+\_\+(\+Bernhard Denner)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3183}{}\doxysection{Tools}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3183}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3184}{}\doxysection{Scripts}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3184}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3185}{}\doxysection{Documentation}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3185}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3186}{}\doxysection{Tests}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3186}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3187}{}\doxysection{Build}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3187}
\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3188}{}\doxysubsection{CMake}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3188}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3189}{}\doxysubsection{Docker}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3189}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3190}{}\doxysubsection{Vagrant}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3190}

\begin{DoxyItemize}
\item Added Vagrantfile for Ubuntu artful 32-\/bit. \+\_\+(Mihael Pranjić)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3191}{}\doxysection{Infrastructure}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3191}
\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3192}{}\doxysubsection{Jenkins}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3192}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3193}{}\doxysubsection{Travis}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3193}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3194}{}\doxysection{Website}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3194}
The website is generated from the repository, so all information about plugins, bindings and tools are always up-\/to-\/date.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3195}{}\doxysection{Outlook}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3195}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3196}{}\doxysection{Statistics}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3196}
...
We welcome new contributors!\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3197}{}\doxysection{Finished Thesis}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3197}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3198}{}\doxysection{Get It!}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3198}
...
Already built API-\/\+Docu can be found \href{https://doc.libelektra.org/api/0.8.25/html/}{\texttt{ here}} or \href{https://github.com/ElektraInitiative/doc/tree/master/api/0.8.25}{\texttt{ Git\+Hub}}.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3199}{}\doxysection{Stay tuned!}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3199}
