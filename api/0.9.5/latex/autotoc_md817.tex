...
echo \char`\"{}some key\+: @some  value\char`\"{} $>$$>$ {\ttfamily kdb file /tests/yamlcpp} kdb get \char`\"{}/tests/yamlcpp/some key\char`\"{} \hypertarget{autotoc_md817_autotoc_md825}{}\section{S\+T\+D\+E\+R\+R\+: .$\ast$yaml-\/cpp\+: error at line 2, column 11\+: unknown token.$\ast$}\label{autotoc_md817_autotoc_md825}
\hypertarget{autotoc_md817_autotoc_md826}{}\section{E\+R\+R\+O\+R\+: C03100}\label{autotoc_md817_autotoc_md826}
\hypertarget{autotoc_md817_autotoc_md827}{}\section{R\+E\+T\+: 5}\label{autotoc_md817_autotoc_md827}
\hypertarget{autotoc_md817_autotoc_md828}{}\section{Overwrite incorrect data}\label{autotoc_md817_autotoc_md828}
echo \char`\"{}🔑\+: value\char`\"{} $>$ {\ttfamily kdb file /tests/yamlcpp}\hypertarget{autotoc_md817_autotoc_md829}{}\section{Add some values via `kdb set`}\label{autotoc_md817_autotoc_md829}
kdb set /tests/yamlcpp 🎵 kdb set /tests/yamlcpp/fleetwood mac kdb set /tests/yamlcpp/the chain\hypertarget{autotoc_md817_autotoc_md830}{}\section{Retrieve the new values}\label{autotoc_md817_autotoc_md830}
kdb get /tests/yamlcpp \#$>$ 🎵 kdb get /tests/yamlcpp/the \#$>$ chain kdb get /tests/yamlcpp/fleetwood \#$>$ mac\hypertarget{autotoc_md817_autotoc_md831}{}\section{Undo modifications}\label{autotoc_md817_autotoc_md831}
...
\end{DoxyCode}
 \hypertarget{autotoc_md817_autotoc_md832}{}\section{Mount yamlcpp plugin to `user\+:/tests/yamlcpp`}\label{autotoc_md817_autotoc_md832}
sudo kdb mount config.\+yaml user\+:/tests/yamlcpp yamlcpp\hypertarget{autotoc_md817_autotoc_md833}{}\section{Manually add an array to the database}\label{autotoc_md817_autotoc_md833}
echo \textquotesingle{}sunny\+:\textquotesingle{} $>$ {\ttfamily kdb file user\+:/tests/yamlcpp} echo \textquotesingle{} -\/ Charlie\textquotesingle{} $>$$>$ {\ttfamily kdb file user\+:/tests/yamlcpp} echo \textquotesingle{} -\/ Dee\textquotesingle{} $>$$>$ {\ttfamily kdb file user\+:/tests/yamlcpp}\hypertarget{autotoc_md817_autotoc_md834}{}\section{List the array entries}\label{autotoc_md817_autotoc_md834}
kdb ls user\+:/tests/yamlcpp \#$>$ user\+:/tests/yamlcpp/sunny \#$>$ user\+:/tests/yamlcpp/sunny/\#0 \#$>$ user\+:/tests/yamlcpp/sunny/\#1\hypertarget{autotoc_md817_autotoc_md835}{}\section{Read an array entry}\label{autotoc_md817_autotoc_md835}
kdb get user\+:/tests/yamlcpp/sunny/\#1 \#$>$ Dee\hypertarget{autotoc_md817_autotoc_md836}{}\section{You can retrieve the last index of an array by reading the metakey `array`}\label{autotoc_md817_autotoc_md836}
kdb meta-\/get user\+:/tests/yamlcpp/sunny array \hypertarget{autotoc_md817_autotoc_md837}{}\section{1}\label{autotoc_md817_autotoc_md837}
\hypertarget{autotoc_md817_autotoc_md838}{}\section{Extend the array}\label{autotoc_md817_autotoc_md838}
kdb set user\+:/tests/yamlcpp/sunny/\#2 Dennis kdb set user\+:/tests/yamlcpp/sunny/\#3 Frank kdb set user\+:/tests/yamlcpp/sunny/\#4 Mac\hypertarget{autotoc_md817_autotoc_md839}{}\section{The plugin supports empty array fields}\label{autotoc_md817_autotoc_md839}
kdb set user\+:/tests/yamlcpp/sunny/\#\+\_\+10 \textquotesingle{}The Waitress\textquotesingle{} kdb meta-\/get user\+:/tests/yamlcpp/sunny array \#$>$ \#\+\_\+10 kdb get user\+:/tests/yamlcpp/sunny/\#\+\_\+9 \hypertarget{autotoc_md817_autotoc_md840}{}\section{R\+E\+T\+: 11}\label{autotoc_md817_autotoc_md840}
...
kdb ls user\+:/tests/yamlcpp \#$>$ user\+:/tests/yamlcpp/array \#$>$ user\+:/tests/yamlcpp/array/\#0 \#$>$ user\+:/tests/yamlcpp/array/\#1/🔑 \#$>$ user\+:/tests/yamlcpp/key\hypertarget{autotoc_md817_autotoc_md852}{}\section{The plugin stores array keys using Y\+A\+M\+L sequences.}\label{autotoc_md817_autotoc_md852}
...
``{\ttfamily  @section autotoc\+\_\+md862 Mount yamlcpp plugin to}user\+:/tests/yamlcpp` sudo kdb mount config.\+yaml user\+:/tests/yamlcpp yamlcpp\hypertarget{autotoc_md817_autotoc_md863}{}\section{Manually add a key including metadata to the database}\label{autotoc_md817_autotoc_md863}
...
kdb set user\+:/tests/yamlcpp/typetest/number \char`\"{}\+One\char`\"{} \hypertarget{autotoc_md817_autotoc_md867}{}\section{R\+E\+T\+: 5}\label{autotoc_md817_autotoc_md867}
...
\hypertarget{autotoc_md817_autotoc_md874}{}\section{The command `kdb get` prints the data as hexadecimal byte values.}\label{autotoc_md817_autotoc_md874}
...
\end{DoxyCode}
 \hypertarget{autotoc_md817_autotoc_md881}{}\section{Mount Y\+A\+M\+L C\+P\+P plugin at `user\+:/tests/yamlcpp`}\label{autotoc_md817_autotoc_md881}
...
kdb get user\+:/tests/yamlcpp/truth \#$>$ 1\hypertarget{autotoc_md817_autotoc_md887}{}\section{A boolean in Elektra has the type `boolean`}\label{autotoc_md817_autotoc_md887}
