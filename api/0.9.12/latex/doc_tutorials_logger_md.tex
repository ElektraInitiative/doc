...
\Hypertarget{doc_tutorials_logger_md_md_doc_tutorials_logger}%
 \hypertarget{doc_tutorials_logger_md_autotoc_md4322}{}\doxysection{Quickstart}\label{doc_tutorials_logger_md_autotoc_md4322}
...
The file sink behaves like syslog, if it has been enabled (see below).\hypertarget{doc_tutorials_logger_md_autotoc_md4323}{}\doxysection{Step by Step Guide}\label{doc_tutorials_logger_md_autotoc_md4323}
\hypertarget{doc_tutorials_logger_md_autotoc_md4324}{}\doxysubsection{Preparation}\label{doc_tutorials_logger_md_autotoc_md4324}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md4325}{}\doxysubsubsection{Log Everything}\label{doc_tutorials_logger_md_autotoc_md4325}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md4326}{}\doxysubsubsection{File Specific Logging}\label{doc_tutorials_logger_md_autotoc_md4326}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md4327}{}\doxysubsection{Enabling and Disabling Sinks}\label{doc_tutorials_logger_md_autotoc_md4327}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md4328}{}\doxysubsection{Compilation}\label{doc_tutorials_logger_md_autotoc_md4328}

\begin{DoxyEnumerate}
\item Enable the logger\+: e.\+g. run {\ttfamily cmake} with the switch {\ttfamily -\/DENABLE\+\_\+\+LOGGER=ON}
\item Build Elektra
\end{DoxyEnumerate}\hypertarget{doc_tutorials_logger_md_autotoc_md4329}{}\doxysection{Log Levels}\label{doc_tutorials_logger_md_autotoc_md4329}
