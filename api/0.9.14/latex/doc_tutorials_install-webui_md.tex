...
The configuration view of elektra-\/web is similar to the tree view of the \href{https://master.libelektra.org/src/tools/qt-gui}{\texttt{ qt-\/gui}}, but with dynamic fields rendered via key metadata.\hypertarget{doc_tutorials_install-webui_md_autotoc_md4319}{}\doxysection{Dependencies}\label{doc_tutorials_install-webui_md_autotoc_md4319}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md4320}{}\doxysection{Building with elektra-\/web Tool}\label{doc_tutorials_install-webui_md_autotoc_md4320}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md4321}{}\doxysection{Getting Started}\label{doc_tutorials_install-webui_md_autotoc_md4321}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md4322}{}\doxysection{Getting Started (docker)}\label{doc_tutorials_install-webui_md_autotoc_md4322}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md4323}{}\doxysection{Running from source}\label{doc_tutorials_install-webui_md_autotoc_md4323}
...
\end{DoxyItemize}
\item You can now access the client on\+: \href{http://localhost:33334}{\texttt{ http\+://localhost\+:33334}}
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md4324}{}\doxysection{Use-\/cases}\label{doc_tutorials_install-webui_md_autotoc_md4324}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md4325}{}\doxysubsection{Running elektra-\/web on a Single Instance}\label{doc_tutorials_install-webui_md_autotoc_md4325}
...
Now, when you open \href{http://localhost:33334}{\texttt{ http\+://localhost\+:33334}} in your browser, the configuration page for the instance will be opened immediately.\hypertarget{doc_tutorials_install-webui_md_autotoc_md4326}{}\doxysection{Overview}\label{doc_tutorials_install-webui_md_autotoc_md4326}
...
\hypertarget{doc_tutorials_install-webui_md_autotoc_md4327}{}\doxysection{API}\label{doc_tutorials_install-webui_md_autotoc_md4327}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md4328}{}\doxysection{Test REST API on localhost}\label{doc_tutorials_install-webui_md_autotoc_md4328}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md4329}{}\doxysection{Auth}\label{doc_tutorials_install-webui_md_autotoc_md4329}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md4331}{}\doxysection{Development Guides}\label{doc_tutorials_install-webui_md_autotoc_md4331}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md4332}{}\doxysubsection{Updating Dependencies}\label{doc_tutorials_install-webui_md_autotoc_md4332}
...
Check for outdated dependencies via {\ttfamily npm outdated}. Dependencies can then be updated by running {\ttfamily npm update}.\hypertarget{doc_tutorials_install-webui_md_autotoc_md4333}{}\doxysubsection{Building Docker Image}\label{doc_tutorials_install-webui_md_autotoc_md4333}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md4334}{}\doxysubsection{Adding Support for New Metadata}\label{doc_tutorials_install-webui_md_autotoc_md4334}
