...
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md639}{}\doxysubsection{Introduction}\label{md_src_plugins_yamlcpp_README_autotoc_md639}
The YAML CPP plugin reads and writes configuration data via the \href{https://github.com/jbeder/yaml-cpp}{\texttt{ yaml-\/cpp}} library.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md640}{}\doxysubsection{Installation}\label{md_src_plugins_yamlcpp_README_autotoc_md640}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/yamlcpp}.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md641}{}\doxysubsection{Usage}\label{md_src_plugins_yamlcpp_README_autotoc_md641}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md642}{}\doxysubsection{Arrays}\label{md_src_plugins_yamlcpp_README_autotoc_md642}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md643}{}\doxysubsubsection{Nested Arrays}\label{md_src_plugins_yamlcpp_README_autotoc_md643}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md644}{}\doxysubsubsection{Sparse Arrays}\label{md_src_plugins_yamlcpp_README_autotoc_md644}
Since Elektra allows \mbox{\hyperlink{doc_decisions_6_implemented_holes_md}{“holes”}} in a key set, YAML CPP has to support small key sets that describe relatively complex data.
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md645}{}\doxysubsection{Metadata}\label{md_src_plugins_yamlcpp_README_autotoc_md645}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md646}{}\doxysubsection{Binary Data}\label{md_src_plugins_yamlcpp_README_autotoc_md646}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md647}{}\doxysubsection{Empty}\label{md_src_plugins_yamlcpp_README_autotoc_md647}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md648}{}\doxysubsection{Binary Values}\label{md_src_plugins_yamlcpp_README_autotoc_md648}
Elektra \mbox{\hyperlink{doc_decisions_5_partially_implemented_boolean_md}{saves binary data as either \`{}0\`{} or \`{}1\`{}}}. The YAML CPP plugin supports this design decision by converting between YAML’s and Elektra’s boolean type.
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md649}{}\doxysubsection{Dependencies}\label{md_src_plugins_yamlcpp_README_autotoc_md649}
This plugin requires \href{https://github.com/jbeder/yaml-cpp}{\texttt{ yaml-\/cpp}}. On a Debian based OS the package for the library is called \href{https://packages.debian.org/libyaml-cpp-dev}{\texttt{ {\ttfamily libyaml-\/cpp-\/dev}}}. On mac\+OS you can install the package \href{https://repology.org/project/yaml-cpp}{\texttt{ {\ttfamily yaml-\/cpp}}} via \href{https://brew.sh}{\texttt{ Home\+Brew}}.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md650}{}\doxysubsection{Limitations}\label{md_src_plugins_yamlcpp_README_autotoc_md650}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md651}{}\doxysubsubsection{Leaf Values}\label{md_src_plugins_yamlcpp_README_autotoc_md651}
...
. However, if we use this approach we are not able to support Elektra’s array type properly.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md652}{}\doxyparagraph{Directory Values}\label{md_src_plugins_yamlcpp_README_autotoc_md652}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md653}{}\doxysubsubsection{Special Values}\label{md_src_plugins_yamlcpp_README_autotoc_md653}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md654}{}\doxysubsubsection{Other Limitations}\label{md_src_plugins_yamlcpp_README_autotoc_md654}
