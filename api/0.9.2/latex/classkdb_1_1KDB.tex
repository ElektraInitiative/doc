\hypertarget{classkdb_1_1KDB}{}\doxysection{kdb\+::K\+DB Class Reference}
...
\DoxyCodeLine{        \mbox{\hyperlink{classkdb_1_1KDB_a7e0637995ce9f294cdbc6f167df6db40}{KDB}} * h = \mbox{\hyperlink{group__kdb_ga6808defe5870f328dd17910aacbdc6ca}{kdbOpen}} (parent);}
...
\DoxyCodeLine{\}}
\end{DoxyCodeInclude}
 You don\textquotesingle{}t need \mbox{\hyperlink{group__kdb_ga6808defe5870f328dd17910aacbdc6ca}{kdb\+Open()}} if you only want to manipulate plain in-\/memory \mbox{\hyperlink{classkdb_1_1Key}{Key}} or \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} objects.
...
\index{KDB@{KDB}!kdb::KDB@{kdb::KDB}}
\doxysubsubsection{\texorpdfstring{KDB()}{KDB()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{kdb::KDB@{kdb::KDB}!KDB@{KDB}}
\index{KDB@{KDB}!kdb::KDB@{kdb::KDB}}
\doxysubsubsection{\texorpdfstring{KDB()}{KDB()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\hline
\end{DoxyRetVals}
\mbox{\Hypertarget{classkdb_1_1KDB_a1e2a35e42941b9fee756e528a3ef14b6}\label{classkdb_1_1KDB_a1e2a35e42941b9fee756e528a3ef14b6}} 
\index{kdb::KDB@{kdb::KDB}!ensure@{ensure}}
\index{ensure@{ensure}!kdb::KDB@{kdb::KDB}}
...
Ensures that the conditions defined in {\ttfamily contract} are met by this \mbox{\hyperlink{classkdb_1_1KDB}{K\+DB}}. 
...
\DoxyCodeLine{\mbox{\hyperlink{classkdb_1_1KDB_a7e0637995ce9f294cdbc6f167df6db40}{KDB}} * handle = \mbox{\hyperlink{group__kdb_ga6808defe5870f328dd17910aacbdc6ca}{kdbOpen}} (key);}
...
\DoxyCodeLine{\{}
\DoxyCodeLine{        \mbox{\hyperlink{classkdb_1_1KeySet}{KeySet}} config;}
\DoxyCodeLine{        \mbox{\hyperlink{classkdb_1_1KDB}{KDB}} \mbox{\hyperlink{namespacekdb}{kdb}};}
\DoxyCodeLine{        \mbox{\hyperlink{namespacekdb}{kdb}}.get (config, \textcolor{stringliteral}{"/sw/MyApp"});}
\DoxyCodeLine{}
\DoxyCodeLine{        \mbox{\hyperlink{classkdb_1_1Key}{Key}} k = config.\mbox{\hyperlink{classkdb_1_1KeySet_a78125fb19c6aebb0d8fc1a7238b78ace}{lookup}} (\textcolor{stringliteral}{"/sw/MyApp/mykey"});}
\DoxyCodeLine{        \textcolor{keywordflow}{if} (k)}
\DoxyCodeLine{        \{}
\DoxyCodeLine{                std::cout << k << \textcolor{stringliteral}{" is "} << k.\mbox{\hyperlink{classkdb_1_1Key_ac558a1f1b2cb50d77fbabcbb24950c05}{get}}<\textcolor{keywordtype}{int}> () << std::endl;}
\DoxyCodeLine{        \}}
...
\DoxyCodeLine{\mbox{\hyperlink{classkdb_1_1KDB_a7e0637995ce9f294cdbc6f167df6db40}{KDB}} * handle = \mbox{\hyperlink{group__kdb_ga6808defe5870f328dd17910aacbdc6ca}{kdbOpen}} (parentKey);}
\DoxyCodeLine{}
