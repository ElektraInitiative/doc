...
\end{DoxyItemize}\hypertarget{md_src_plugins_xerces_README_autotoc_md584}{}\doxysection{Installation}\label{md_src_plugins_xerces_README_autotoc_md584}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/xerces}.

To include this plugin in a homebrew installation run {\ttfamily brew tap elektrainitiative/elektra} followed by {\ttfamily brew install elektrainitiative/elektra/elektra -\/-\/with-\/xerces}\hypertarget{md_src_plugins_xerces_README_autotoc_md585}{}\doxysection{Usage}\label{md_src_plugins_xerces_README_autotoc_md585}
...
The root element of the resulting XML file will be \char`\"{}xerces\char`\"{} again, restored via the metadata. If you don\textquotesingle{}t want this behavior, delete the metadata {\ttfamily xerces/rootname} on the mount point, then it uses the mount point\textquotesingle{}s name instead.\hypertarget{md_src_plugins_xerces_README_autotoc_md586}{}\doxysection{Dependencies}\label{md_src_plugins_xerces_README_autotoc_md586}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_xerces_README_autotoc_md587}{}\doxysection{Limitations}\label{md_src_plugins_xerces_README_autotoc_md587}
...
XSD transformations, schemas or DTDs are not supported yet.\hypertarget{md_src_plugins_xerces_README_autotoc_md588}{}\doxysection{Examples}\label{md_src_plugins_xerces_README_autotoc_md588}
\hypertarget{md_src_plugins_xerces_README_autotoc_md589}{}\doxysubsection{Mounting, setting a key and exporting}\label{md_src_plugins_xerces_README_autotoc_md589}
