...
\begin{DoxyItemize}
\item \mbox{\hyperlink{autotoc_md593_src_plugins_reference_examples_alternative_README_md}{alternative}} shows how the {\ttfamily alternative} value of {\ttfamily check/reference} gets processed.
\item \mbox{\hyperlink{autotoc_md594_src_plugins_reference_examples_complex_README_md}{complex}} shows how the plugin can be used together with the spec plugin, to validate complex recursive structures. 
\end{DoxyItemize}