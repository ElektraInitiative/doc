...
\Hypertarget{doc_decisions_0a_postponed_plugin_variants_md_md_doc_decisions_0a_postponed_plugin_variants}%
 \hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1852}{}\doxysection{Problem}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1852}
...
The current issue is that there is no way to enumerate possible plugin variants as needed to list all functionality of Elektra.\hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1853}{}\doxysection{Constraints}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1853}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1854}{}\doxysection{Assumptions}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1854}

\begin{DoxyItemize}
\item The number of variants needs to be bounded\+: plugin variants need to be fully enumerable
\end{DoxyItemize}\hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1855}{}\doxysection{Considered Alternatives}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1855}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1856}{}\doxysection{Decision}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1856}
...
\end{DoxyItemize}
\end{DoxyEnumerate}\hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1857}{}\doxysubsection{Example}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1857}
...
\end{DoxyCode}
\hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1858}{}\doxysection{Rationale}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1858}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1859}{}\doxysection{Implications}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1859}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1860}{}\doxysection{Current state}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1860}
...
gets ignored.\hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1861}{}\doxysection{Related Decisions}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1861}

\begin{DoxyItemize}
\item \mbox{\hyperlink{doc_decisions_6_implemented_cmake_plugins_md}{CMake Plugins}}
\end{DoxyItemize}\hypertarget{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1862}{}\doxysection{Notes}\label{doc_decisions_0a_postponed_plugin_variants_md_autotoc_md1862}
