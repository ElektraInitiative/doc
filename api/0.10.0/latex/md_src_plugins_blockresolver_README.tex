...
The {\ttfamily blockresolver} can be used to only resolve a tagged block inside a configuration file.\hypertarget{md_src_plugins_blockresolver_README_autotoc_md72}{}\doxysection{Installation}\label{md_src_plugins_blockresolver_README_autotoc_md72}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/experimental}.\hypertarget{md_src_plugins_blockresolver_README_autotoc_md73}{}\doxysubsection{Implementation Details}\label{md_src_plugins_blockresolver_README_autotoc_md73}
{\ttfamily blockresolver} extracts the requested block from the configurations file and writes it into a temporary file. Afterwards Elektra will only work on the temporary file until kdb\+Set is called. On kdb\+Set the contents of the temporary file will be merged with parts outside of the requested block from the original file.\hypertarget{md_src_plugins_blockresolver_README_autotoc_md74}{}\doxysection{Usage}\label{md_src_plugins_blockresolver_README_autotoc_md74}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_blockresolver_README_autotoc_md75}{}\doxysection{Limitations}\label{md_src_plugins_blockresolver_README_autotoc_md75}
Currently the identifier must be unique.\hypertarget{md_src_plugins_blockresolver_README_autotoc_md76}{}\doxysection{Example}\label{md_src_plugins_blockresolver_README_autotoc_md76}
