...
\Hypertarget{doc_CODING_md_md_doc_CODING}%
 This document provides an introduction in how the source code of libelektra is organized and how and where to add functionality.\hypertarget{doc_CODING_md_autotoc_md1592}{}\doxysection{Folder structure}\label{doc_CODING_md_autotoc_md1592}
...
You can find more information about the structure in the {\ttfamily README.\+md}.\hypertarget{doc_CODING_md_autotoc_md1593}{}\doxysection{General Information}\label{doc_CODING_md_autotoc_md1593}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1594}{}\doxysection{Source Code}\label{doc_CODING_md_autotoc_md1594}
The same guidelines apply to all code in the repository including the plugins.\hypertarget{doc_CODING_md_autotoc_md1595}{}\doxysubsection{General Guidelines}\label{doc_CODING_md_autotoc_md1595}
...
If you see inconsistency within the rules do not hesitate to open an issue about it.\hypertarget{doc_CODING_md_autotoc_md1596}{}\doxysubsection{Code Comments}\label{doc_CODING_md_autotoc_md1596}
...
\end{DoxyEnumerate}\hypertarget{doc_CODING_md_autotoc_md1597}{}\doxysubsection{Coding Style}\label{doc_CODING_md_autotoc_md1597}
...
{\bfseries{Example\+:}} \href{/home/jenkins/workspace/libelektra-release/src/libs/elektra/kdb.c}{\texttt{ src/libs/elektra/kdb.\+c}}\hypertarget{doc_CODING_md_autotoc_md1599}{}\doxysubsubsection{Clang Format}\label{doc_CODING_md_autotoc_md1599}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1601}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md1601}
...
After that change Text\+Mate will reformat C and C++ code with {\ttfamily clang-\/format} every time you save a file.\hypertarget{doc_CODING_md_autotoc_md1603}{}\doxysubsection{C++ Guidelines}\label{doc_CODING_md_autotoc_md1603}
...
{\bfseries{Example\+:}} \href{/home/jenkins/workspace/libelektra-release/src/bindings/cpp/include/kdb.hpp}{\texttt{ src/bindings/cpp/include/kdb.\+hpp}}\hypertarget{doc_CODING_md_autotoc_md1604}{}\doxysubsection{CMake Guidelines}\label{doc_CODING_md_autotoc_md1604}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1605}{}\doxysubsubsection{cmake format}\label{doc_CODING_md_autotoc_md1605}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1606}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md1606}
...
in a file called \href{https://macromates.com/blog/2011/git-style-configuration}{\texttt{ {\ttfamily .tm\+\_\+properties}}} in the root of Elektra’s repository.\hypertarget{doc_CODING_md_autotoc_md1609}{}\doxysubsection{Java \& Groovy Guidelines}\label{doc_CODING_md_autotoc_md1609}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1610}{}\doxysubsubsection{Usage}\label{doc_CODING_md_autotoc_md1610}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1611}{}\doxysubsection{Java\+Script Guidelines}\label{doc_CODING_md_autotoc_md1611}
\hypertarget{doc_CODING_md_autotoc_md1612}{}\doxysubsubsection{Prettier}\label{doc_CODING_md_autotoc_md1612}
We use \href{https://prettier.io}{\texttt{ {\ttfamily prettier}}} to format Java\+Script files.\hypertarget{doc_CODING_md_autotoc_md1613}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md1613}
\doxysubparagraph*{mac\+OS}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1614}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md1614}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1615}{}\doxysubsection{Markdown Guidelines}\label{doc_CODING_md_autotoc_md1615}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1616}{}\doxysubsubsection{Prettier}\label{doc_CODING_md_autotoc_md1616}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1617}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md1617}
For information on how to install the tool, please take a look at “\+Java\+Script Guidelines” → “\+Prettier” → “\+Installation”.\hypertarget{doc_CODING_md_autotoc_md1618}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md1618}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1619}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md1619}
...
\item Save your new command\+: {\ttfamily ⌘} + {\ttfamily S}
\end{DoxyEnumerate}
\end{DoxyEnumerate}\hypertarget{doc_CODING_md_autotoc_md1620}{}\doxysubsection{Shell Guidelines}\label{doc_CODING_md_autotoc_md1620}

\begin{DoxyItemize}
\item Please only use \href{https://en.wikipedia.org/wiki/POSIX}{\texttt{ POSIX}} functionality.
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1621}{}\doxysubsubsection{shfmt}\label{doc_CODING_md_autotoc_md1621}
We use \href{https://github.com/mvdan/sh}{\texttt{ {\ttfamily shfmt}}} to format Shell files in the repository.\hypertarget{doc_CODING_md_autotoc_md1622}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md1622}
\doxysubparagraph*{mac\+OS}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1623}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md1623}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1624}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md1624}
...
\item Save your new command\+: {\ttfamily ⌘} + {\ttfamily S}
\end{DoxyEnumerate}
\end{DoxyEnumerate}\hypertarget{doc_CODING_md_autotoc_md1625}{}\doxysubsection{Doxygen Guidelines}\label{doc_CODING_md_autotoc_md1625}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1626}{}\doxysubsection{File Headers}\label{doc_CODING_md_autotoc_md1626}
...
The duplication of the filename, author and date is not needed, because this information is tracked using git and \mbox{\hyperlink{doc_AUTHORS_md}{doc/\+AUTHORS.md}} already.\hypertarget{doc_CODING_md_autotoc_md1627}{}\doxysection{Further Readings}\label{doc_CODING_md_autotoc_md1627}
