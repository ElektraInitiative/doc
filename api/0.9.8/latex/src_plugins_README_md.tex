...
\begin{DoxyItemize}
\item ni parses INI files based on (including metadata) \href{https://lab.burn.capital/chaz-attic/bohr/-/blob/main/include/bohr/ni.h}{\texttt{ ni}}.
\end{DoxyItemize}
...
\item process proxy plugin that executes other plugins in a separate process (useful for interpreter plugins and plugins with global setup like {\ttfamily xerces})
