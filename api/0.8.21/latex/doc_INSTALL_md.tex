...
To use the debian repository of the latest builds from master put following files in {\ttfamily /etc/apt/sources.list}.
...
A tap for \href{http://brew.sh}{\tt Homebrew} is available \href{http://github.com/ElektraInitiative/homebrew-elektra}{\tt here}. To install Elektra using this tap just use the two shell commands listed below. \begin{DoxyVerb}    brew tap ElektraInitiative/homebrew-elektra
