...
Concepts are in man page section 7 and are prefixed with {\ttfamily elektra-\/}. You should start reading \hyperlink{doc_help_elektra-introduction_md}{elektra-\/introduction(7)}.
...
Documentation of plugins is available using the \hyperlink{doc_help_kdb-info_md}{kdb-\/info(1)} tool. Run {\ttfamily kdb list} for a list of plugins.
