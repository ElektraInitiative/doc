...
\Hypertarget{doc_decisions_high_level_api_md_md_doc_decisions_high_level_api}%
 \hypertarget{doc_decisions_high_level_api_md_autotoc_md1875}{}\doxysection{Problem}\label{doc_decisions_high_level_api_md_autotoc_md1875}
Projects usually do not want to use low-\/level APIs. {\ttfamily KDB} and {\ttfamily Key\+Set} is useful for plugins and to implement APIs but not to be directly used in applications.\hypertarget{doc_decisions_high_level_api_md_autotoc_md1876}{}\doxysection{Constraints}\label{doc_decisions_high_level_api_md_autotoc_md1876}
...
\end{DoxyItemize}
\end{DoxyEnumerate}\hypertarget{doc_decisions_high_level_api_md_autotoc_md1877}{}\doxysection{Assumptions}\label{doc_decisions_high_level_api_md_autotoc_md1877}
...
\end{DoxyItemize}\hypertarget{doc_decisions_high_level_api_md_autotoc_md1878}{}\doxysection{Considered Alternatives}\label{doc_decisions_high_level_api_md_autotoc_md1878}
...
\end{DoxyItemize}\hypertarget{doc_decisions_high_level_api_md_autotoc_md1879}{}\doxysection{Decision}\label{doc_decisions_high_level_api_md_autotoc_md1879}
...
\end{DoxyItemize}\hypertarget{doc_decisions_high_level_api_md_autotoc_md1880}{}\doxysection{Rationale}\label{doc_decisions_high_level_api_md_autotoc_md1880}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_high_level_api_md_autotoc_md1881}{}\doxysection{Implications}\label{doc_decisions_high_level_api_md_autotoc_md1881}
\hypertarget{doc_decisions_high_level_api_md_autotoc_md1882}{}\doxysection{Related Decisions}\label{doc_decisions_high_level_api_md_autotoc_md1882}
\hypertarget{doc_decisions_high_level_api_md_autotoc_md1883}{}\doxysection{Notes}\label{doc_decisions_high_level_api_md_autotoc_md1883}
