...
can be compared against the return values of the shell commandos.\hypertarget{md_src_plugins_shell_README_autotoc_md638}{}\doxysection{Example}\label{md_src_plugins_shell_README_autotoc_md638}
