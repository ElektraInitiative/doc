\hypertarget{doc_help_kdb-complete_md_autotoc_md1624}{}\doxysection{S\+Y\+N\+O\+P\+S\+IS}\label{doc_help_kdb-complete_md_autotoc_md1624}
{\ttfamily kdb complete \mbox{[}path\mbox{]}}

Where {\ttfamily path} is the path for which the user would like to receive completion suggestion. If {\ttfamily path} is not specified, it will show every possible completion. Its synonymous to calling {\ttfamily kdb complete \char`\"{}\char`\"{}}.\hypertarget{doc_help_kdb-complete_md_autotoc_md1625}{}\doxysection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{doc_help_kdb-complete_md_autotoc_md1625}
Show suggestions how the current name could be completed. Suggestions will include existing key names, path segments of existing key names, namespaces and mount points. Additionally, the output will indicate whether the given path is a node or a leaf in the hierarchy of keys, nodes end with \textquotesingle{}/\textquotesingle{} as opposed to leaves. It will also work for cascading keys, and will additionally display a cascading key\textquotesingle{}s namespace in the output to indicate from which namespace this suggestion originates from.\hypertarget{doc_help_kdb-complete_md_autotoc_md1626}{}\doxysection{O\+P\+T\+I\+O\+NS}\label{doc_help_kdb-complete_md_autotoc_md1626}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-complete_md_autotoc_md1627}{}\doxysection{E\+X\+A\+M\+P\+L\+ES}\label{doc_help_kdb-complete_md_autotoc_md1627}
...
\end{DoxyCode}
\hypertarget{doc_help_kdb-complete_md_autotoc_md1628}{}\doxysection{S\+E\+E A\+L\+SO}\label{doc_help_kdb-complete_md_autotoc_md1628}
