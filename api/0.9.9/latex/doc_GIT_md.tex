...
\Hypertarget{doc_GIT_md_md_doc_GIT}%
 \hypertarget{doc_GIT_md_autotoc_md2323}{}\doxysection{Basic GIT Commands}\label{doc_GIT_md_autotoc_md2323}
...
\end{DoxyCode}
\hypertarget{doc_GIT_md_autotoc_md2324}{}\doxysection{Basic Configuration}\label{doc_GIT_md_autotoc_md2324}
make sure to do\+:
...
\end{DoxyCode}
\hypertarget{doc_GIT_md_autotoc_md2325}{}\doxysection{The Commit Message}\label{doc_GIT_md_autotoc_md2325}
...
Most commits should have a longer description in the body.\hypertarget{doc_GIT_md_autotoc_md2326}{}\doxysection{Remote Branches}\label{doc_GIT_md_autotoc_md2326}
...
\end{DoxyVerb}
 This is the development branch. Please try to not work directly on it, but instead you should use feature branches. So the only commits on master should be non-\/fastforward merges from features branches. Commits on master should always compile and all test cases should pass successfully. (see config option above)\hypertarget{doc_GIT_md_autotoc_md2327}{}\doxysection{Local Branches}\label{doc_GIT_md_autotoc_md2327}
...
\end{DoxyCode}
\hypertarget{doc_GIT_md_autotoc_md2328}{}\doxysection{Working with forks}\label{doc_GIT_md_autotoc_md2328}
