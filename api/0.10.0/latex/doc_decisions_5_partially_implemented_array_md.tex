...
\Hypertarget{doc_decisions_5_partially_implemented_array_md_md_doc_decisions_5_partially_implemented_array}%
 \hypertarget{doc_decisions_5_partially_implemented_array_md_autotoc_md2171}{}\doxysection{Problem}\label{doc_decisions_5_partially_implemented_array_md_autotoc_md2171}
Currently it is inefficient to detect the length of an array and it is impossible to know if a key (without subkeys) should be an array or not.\hypertarget{doc_decisions_5_partially_implemented_array_md_autotoc_md2172}{}\doxysection{Constraints}\label{doc_decisions_5_partially_implemented_array_md_autotoc_md2172}

\begin{DoxyItemize}
\item None
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_array_md_autotoc_md2173}{}\doxysection{Assumptions}\label{doc_decisions_5_partially_implemented_array_md_autotoc_md2173}
\hypertarget{doc_decisions_5_partially_implemented_array_md_autotoc_md2174}{}\doxysection{Considered Alternatives}\label{doc_decisions_5_partially_implemented_array_md_autotoc_md2174}
...
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_array_md_autotoc_md2175}{}\doxysection{Decision}\label{doc_decisions_5_partially_implemented_array_md_autotoc_md2175}
...
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_array_md_autotoc_md2176}{}\doxysection{Rationale}\label{doc_decisions_5_partially_implemented_array_md_autotoc_md2176}
...
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_array_md_autotoc_md2177}{}\doxysection{Implications}\label{doc_decisions_5_partially_implemented_array_md_autotoc_md2177}
...
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_array_md_autotoc_md2178}{}\doxysection{Related Decisions}\label{doc_decisions_5_partially_implemented_array_md_autotoc_md2178}
...
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_array_md_autotoc_md2179}{}\doxysection{Notes}\label{doc_decisions_5_partially_implemented_array_md_autotoc_md2179}
