...
\end{DoxyItemize}\hypertarget{md_src_plugins_noresolver_README_src_plugins_noresolver_README_md}{}\doxysection{Explanation}\label{md_src_plugins_noresolver_README_src_plugins_noresolver_README_md}
