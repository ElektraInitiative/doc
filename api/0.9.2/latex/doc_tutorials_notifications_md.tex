\hypertarget{doc_tutorials_notifications_md_autotoc_md2717}{}\doxysection{Preface}\label{doc_tutorials_notifications_md_autotoc_md2717}
{\bfseries{The features described in this document are experimental.}}

This document explains how notifications are implemented in Elektra and how they can be used by application developers.\hypertarget{doc_tutorials_notifications_md_autotoc_md2718}{}\doxysection{Notifications -\/ Overview \& Concept}\label{doc_tutorials_notifications_md_autotoc_md2718}
...
When a configuration key is changed Elektra can generate change notifications that allow applications to process those changes. Developers can choose whether and how they want to receive and handle those notifications but not whether notifications are sent or which transport is used. How notifications are sent is specified in the {\itshape notification configuration} by the system operator.\hypertarget{doc_tutorials_notifications_md_autotoc_md2719}{}\doxysection{Notification Configuration}\label{doc_tutorials_notifications_md_autotoc_md2719}
...
Plugins usable as transport plugin are marked with {\ttfamily notification} on the \href{https://www.libelektra.org/plugins/readme\#notification-and-logging}{\texttt{ plugin page}}.\hypertarget{doc_tutorials_notifications_md_autotoc_md2720}{}\doxysection{How to integrate an I/\+O binding and send notifications asynchronously}\label{doc_tutorials_notifications_md_autotoc_md2720}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{testio__doc_8c_a3c04138a5bfe5d72780bb7e82a18e627}{main}} (\textcolor{keywordtype}{void})}
\DoxyCodeLine{\{}
\DoxyCodeLine{        KDB* repo;}
\DoxyCodeLine{}
\DoxyCodeLine{        \textcolor{comment}{// Open KDB}}
\DoxyCodeLine{        Key * key = \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}} (\textcolor{stringliteral}{"/sw/myorg/myapp/\#0/current"}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END}});}
\DoxyCodeLine{        KDB * \mbox{\hyperlink{namespacekdb}{kdb}} = \mbox{\hyperlink{group__kdb_ga6808defe5870f328dd17910aacbdc6ca}{kdbOpen}} (key);}
\DoxyCodeLine{}
...
\DoxyCodeLine{}
\DoxyCodeLine{        \textcolor{comment}{// Use I/O binding for our kdb instance}}
\DoxyCodeLine{        \mbox{\hyperlink{group__kdbio_ga187345483bdfbb404919c6797bc2db77}{elektraIoSetBinding}} (\mbox{\hyperlink{namespacekdb}{kdb}}, binding);}
\DoxyCodeLine{}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{doc_tutorials_notifications_md_autotoc_md2721}{}\doxysection{How to receive notifications}\label{doc_tutorials_notifications_md_autotoc_md2721}
...
In order to handle change notifications a developer can either register a variable or a callback.\hypertarget{doc_tutorials_notifications_md_autotoc_md2722}{}\doxysubsection{Register a variable}\label{doc_tutorials_notifications_md_autotoc_md2722}
...
\DoxyCodeLine{        \mbox{\hyperlink{group__kdbio_ga187345483bdfbb404919c6797bc2db77}{elektraIoSetBinding}} (\mbox{\hyperlink{namespacekdb}{kdb}}, binding);}
\DoxyCodeLine{}
\DoxyCodeLine{        \textcolor{comment}{// Initialize notification wrapper}}
\DoxyCodeLine{        \mbox{\hyperlink{group__kdbnotification_gaeae96154abdb5fdbf1b34a01e2b23e44}{elektraNotificationOpen}} (\mbox{\hyperlink{namespacekdb}{kdb}});}
\DoxyCodeLine{}
\DoxyCodeLine{        \textcolor{comment}{// Register "value" for updates}}
\DoxyCodeLine{        Key * registeredKey = \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}} (\textcolor{stringliteral}{"/sw/myorg/myapp/\#0/current/value"}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END}});}
\DoxyCodeLine{        \textcolor{keywordtype}{int} value;}
\DoxyCodeLine{        \mbox{\hyperlink{group__kdbnotification_ga362d557489c4199f6c765480a8a3cade}{elektraNotificationRegisterInt}} (repo, registeredKey, \&value);}
\DoxyCodeLine{}
...
\DoxyCodeLine{        KeySet * config = \mbox{\hyperlink{group__keyset_ga671e1aaee3ae9dc13b4834a4ddbd2c3c}{ksNew}}(0, \mbox{\hyperlink{kdbenum_8c_a7a28fce3773b2c873c94ac80b8b4cd54}{KS\_END}});}
...
\DoxyCodeLine{}
\DoxyCodeLine{        \textcolor{comment}{// Cleanup}}
\DoxyCodeLine{        \mbox{\hyperlink{group__kdbnotification_ga5685dafbd4131011365628d6d9213594}{elektraNotificationClose}} (\mbox{\hyperlink{namespacekdb}{kdb}});}
\DoxyCodeLine{        \mbox{\hyperlink{group__kdb_gadb54dc9fda17ee07deb9444df745c96f}{kdbClose}} (\mbox{\hyperlink{namespacekdb}{kdb}}, key);}
...
\DoxyCodeLine{}
\DoxyCodeLine{        Key * color = \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}} (\textcolor{stringliteral}{"/sw/myorg/myapp/\#0/current/color"}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END}});}
\DoxyCodeLine{}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{doc_tutorials_notifications_md_autotoc_md2724}{}\doxysubsection{How-\/\+To\+: Reload K\+D\+B when Elektra\textquotesingle{}s configuration has changed}\label{doc_tutorials_notifications_md_autotoc_md2724}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{Key * elektraKey = \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}} (\textcolor{stringliteral}{"/elektra"}, \mbox{\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END}});}
...
\DoxyCodeLine{        \}}
\DoxyCodeLine{}
\DoxyCodeLine{        \mbox{\hyperlink{namespacekdb}{kdb}} = \mbox{\hyperlink{group__kdb_ga6808defe5870f328dd17910aacbdc6ca}{kdbOpen}} (parentKey);}
\DoxyCodeLine{        \mbox{\hyperlink{group__kdbio_ga187345483bdfbb404919c6797bc2db77}{elektraIoSetBinding}} (\mbox{\hyperlink{namespacekdb}{kdb}}, binding);}
\DoxyCodeLine{        \mbox{\hyperlink{group__kdbnotification_gaeae96154abdb5fdbf1b34a01e2b23e44}{elektraNotificationOpen}} (\mbox{\hyperlink{namespacekdb}{kdb}});}
\DoxyCodeLine{}
...
Building on these findings we will now present guidelines for preventing emergent misbehavior when using the notification A\+PI and callbacks in particular.\hypertarget{doc_tutorials_notifications_md_autotoc_md2726}{}\doxysubsection{Guideline 1\+: Avoid callbacks}\label{doc_tutorials_notifications_md_autotoc_md2726}
\begin{quote}
...
Generally waiting before reacting to changes reduces the risk for unwanted synchronization by decoupling the application temporally. Waiting can be implemented using random time delays which further promotes decoupling since applications react at different points in time to changes. Waiting can also be implemented using a flag\+: Callbacks set the flag and when the control flow is in the main loop again, the pending updates are applied and the flag is cleared.\hypertarget{doc_tutorials_notifications_md_autotoc_md2728}{}\doxysubsection{Guideline 3\+: Avoid updates as reaction to change}\label{doc_tutorials_notifications_md_autotoc_md2728}
\begin{quote}
...
This guideline applies especially to callbacks but is also relevant when variables are polled for changes by the application.\hypertarget{doc_tutorials_notifications_md_autotoc_md2729}{}\doxysubsection{Guideline 4\+: Do not use notifications for synchronization}\label{doc_tutorials_notifications_md_autotoc_md2729}
\begin{quote}
...
For example, this happens when applications synchronize themselves at startup by incrementing a counter in the key database. When a certain limit of application instances is reached the applications proceed with different behavior. If this behavior affects other applications phase change has occurred.\hypertarget{doc_tutorials_notifications_md_autotoc_md2730}{}\doxysubsection{Guideline 5\+: Apply changes immediately}\label{doc_tutorials_notifications_md_autotoc_md2730}
\begin{quote}
...
When a configuration setting is updated within an application this guideline suggests to write the change immediately to the key database using {\ttfamily \mbox{\hyperlink{group__kdb_ga11436b058408f83d303ca5e996832bcf}{kdb\+Set()}}}. This ensures that other applications have the same view of the key database and operate on current settings.\hypertarget{doc_tutorials_notifications_md_autotoc_md2731}{}\doxysubsection{Guideline 6\+: Be careful on what to call inside callbacks}\label{doc_tutorials_notifications_md_autotoc_md2731}
\begin{quote}
...
Closing and cleaning up the K\+DB handle will cause an application crash because the control flow returns from the callback to now removed code. While this can be considered an implementation detail it aligns with \href{\#guidline-2-wait-before-reacting-to-changes}{\texttt{ Guideline 2}} since reinitialization of K\+DB uses more resources than other operations like {\ttfamily \mbox{\hyperlink{group__kdb_ga28e385fd9cb7ccfe0b2f1ed2f62453a1}{kdb\+Get()}}} or {\ttfamily \mbox{\hyperlink{group__kdb_ga11436b058408f83d303ca5e996832bcf}{kdb\+Set()}}}.\hypertarget{doc_tutorials_notifications_md_autotoc_md2732}{}\doxysection{Logging}\label{doc_tutorials_notifications_md_autotoc_md2732}
...
Now both reading from and writing to Elektra\textquotesingle{}s key database is logged.\hypertarget{doc_tutorials_notifications_md_autotoc_md2733}{}\doxysection{How to create your own I/\+O Binding}\label{doc_tutorials_notifications_md_autotoc_md2733}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\$ kdb global-\/mount syslog log/get=1}
\end{DoxyCode}
