\hypertarget{doc_decisions_validation_md_autotoc_md1370}{}\doxysection{Problem}\label{doc_decisions_validation_md_autotoc_md1370}
...
If validation of a key fails, each plugin decides on its own how to handle the issue and proceed in ways that might be different than what is expected or desired.\hypertarget{doc_decisions_validation_md_autotoc_md1371}{}\doxysection{Constraints}\label{doc_decisions_validation_md_autotoc_md1371}
\hypertarget{doc_decisions_validation_md_autotoc_md1372}{}\doxysection{Assumptions}\label{doc_decisions_validation_md_autotoc_md1372}
...
\end{DoxyItemize}\hypertarget{doc_decisions_validation_md_autotoc_md1373}{}\doxysection{Considered Alternatives}\label{doc_decisions_validation_md_autotoc_md1373}
...
\end{DoxyItemize}\hypertarget{doc_decisions_validation_md_autotoc_md1374}{}\doxysection{Decision}\label{doc_decisions_validation_md_autotoc_md1374}
Use a wrapper plugin to iterate over the keyset and delegate the validation of each key to the corresponding validation plugin.\hypertarget{doc_decisions_validation_md_autotoc_md1375}{}\doxysection{Rationale}\label{doc_decisions_validation_md_autotoc_md1375}
...
\end{DoxyItemize}\hypertarget{doc_decisions_validation_md_autotoc_md1376}{}\doxysection{Implications}\label{doc_decisions_validation_md_autotoc_md1376}
...
returning 1 if validation succeeded, 0 on failure\hypertarget{doc_decisions_validation_md_autotoc_md1377}{}\doxysection{Related Decisions}\label{doc_decisions_validation_md_autotoc_md1377}
\hypertarget{doc_decisions_validation_md_autotoc_md1378}{}\doxysection{Notes}\label{doc_decisions_validation_md_autotoc_md1378}
