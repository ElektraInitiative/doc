...
The configuration view of elektra-\/web is similar to the tree view of the \href{https://master.libelektra.org/src/tools/qt-gui}{\texttt{ qt-\/gui}}, but with dynamic fields rendered via key metadata.\hypertarget{doc_tutorials_install-webui_md_autotoc_md3839}{}\doxysection{Dependencies}\label{doc_tutorials_install-webui_md_autotoc_md3839}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3840}{}\doxysection{Building with elektra-\/web Tool}\label{doc_tutorials_install-webui_md_autotoc_md3840}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3841}{}\doxysection{Getting Started}\label{doc_tutorials_install-webui_md_autotoc_md3841}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3842}{}\doxysection{Getting Started (docker)}\label{doc_tutorials_install-webui_md_autotoc_md3842}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3843}{}\doxysection{Running from source}\label{doc_tutorials_install-webui_md_autotoc_md3843}
...
\end{DoxyItemize}
\item You can now access the client on\+: \href{http://localhost:33334}{\texttt{ http\+://localhost\+:33334}}
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3844}{}\doxysection{Use-\/cases}\label{doc_tutorials_install-webui_md_autotoc_md3844}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3845}{}\doxysubsection{Running elektra-\/web on a Single Instance}\label{doc_tutorials_install-webui_md_autotoc_md3845}
...
Now, when you open \href{http://localhost:33334}{\texttt{ http\+://localhost\+:33334}} in your browser, the configuration page for the instance will be opened immediately.\hypertarget{doc_tutorials_install-webui_md_autotoc_md3846}{}\doxysection{Overview}\label{doc_tutorials_install-webui_md_autotoc_md3846}
...
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3847}{}\doxysection{API}\label{doc_tutorials_install-webui_md_autotoc_md3847}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3848}{}\doxysection{Test REST API on localhost}\label{doc_tutorials_install-webui_md_autotoc_md3848}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3849}{}\doxysection{Auth}\label{doc_tutorials_install-webui_md_autotoc_md3849}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3851}{}\doxysection{Development Guides}\label{doc_tutorials_install-webui_md_autotoc_md3851}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3852}{}\doxysubsection{Updating Dependencies}\label{doc_tutorials_install-webui_md_autotoc_md3852}
...
Check for outdated dependencies via {\ttfamily npm outdated}. Dependencies can then be updated by running {\ttfamily npm update}.\hypertarget{doc_tutorials_install-webui_md_autotoc_md3853}{}\doxysubsection{Building Docker Image}\label{doc_tutorials_install-webui_md_autotoc_md3853}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3854}{}\doxysubsection{Adding Support for New Metadata}\label{doc_tutorials_install-webui_md_autotoc_md3854}
