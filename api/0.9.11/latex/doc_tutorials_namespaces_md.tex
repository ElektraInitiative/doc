...
\Hypertarget{doc_tutorials_namespaces_md_md_doc_tutorials_namespaces}%
 \hypertarget{doc_tutorials_namespaces_md_autotoc_md3962}{}\doxysection{Structure of the Key Database}\label{doc_tutorials_namespaces_md_autotoc_md3962}
...
Now add the key $\ast$$\ast$/a$\ast$$\ast$ with the Value {\bfseries{Value 1}} and the key $\ast$$\ast$/b/c$\ast$$\ast$ with the Value {\bfseries{Value 2}}\+:
...
For example {\ttfamily kdb get /b/c} should return {\ttfamily Value 2} now, if you set the values before.\hypertarget{doc_tutorials_namespaces_md_autotoc_md3963}{}\doxysection{Namespaces}\label{doc_tutorials_namespaces_md_autotoc_md3963}
...
At this point the key database should have this structure\+: \hypertarget{doc_tutorials_namespaces_md_autotoc_md3964}{}\doxysubsection{Cascading Keys}\label{doc_tutorials_namespaces_md_autotoc_md3964}
...
Having namespaces enables both admins and users to set specific parts of the application\textquotesingle{}s configuration, as you will see in the following example.\hypertarget{doc_tutorials_namespaces_md_autotoc_md3965}{}\doxysection{How it Works on the Command Line (kdb)}\label{doc_tutorials_namespaces_md_autotoc_md3965}
