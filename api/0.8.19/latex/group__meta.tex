...
In versions before Elektra 0.\+8 only limited metadata was available. Now any metadata can be added. These A\+P\+I methods are implementations of the 0.\+7 A\+P\+I using 0.\+8 metadata.
...
Key $\ast$key = key\+New(\char`\"{}user/test\char`\"{}, K\+E\+Y\+\_\+\+E\+N\+D); elektra\+Meta\+Array\+Add(key, \char`\"{}test\char`\"{}, \char`\"{}val0\char`\"{}); key now has \char`\"{}test/\#0\char`\"{} with value \char`\"{}val0\char`\"{} as metadata elektra\+Meta\+Array\+Add(key, \char`\"{}test\char`\"{}, \char`\"{}val1\char`\"{}); appends \char`\"{}test/\#1\char`\"{} with value \char`\"{}val1\char`\"{} to key
...
\begin{DoxyRefDesc}{Deprecated}
\item[\hyperlink{deprecated__deprecated000024}{Deprecated}]This A\+P\+I is obsolete.\end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Deprecated}
\item[\hyperlink{deprecated__deprecated000025}{Deprecated}]This A\+P\+I is obsolete.\end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Deprecated}
\item[\hyperlink{deprecated__deprecated000017}{Deprecated}]This A\+P\+I is obsolete.\end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Deprecated}
\item[\hyperlink{deprecated__deprecated000019}{Deprecated}]This A\+P\+I is obsolete. It is only a mapping to key\+Set\+Meta(key, \char`\"{}mode\char`\"{}, str) which should be prefered.\end{DoxyRefDesc}
