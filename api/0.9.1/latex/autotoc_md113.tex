...
\begin{DoxyCode}{0}
\DoxyCodeLine{PLUGINS=crypto;crypto\_gcrypt;crypto\_openssl;crypto\_botan}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{brew install openssl botan libgcrypt pkg-config cmake}
\DoxyCodeLine{\# The next step is required for pkg-config to find the include files of OpenSSL}
\DoxyCodeLine{ln -s /usr/local/opt/openssl/include/openssl/ /usr/local/include/openssl}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{kdb mount test.ecf user/t crypto\_gcrypt "crypto/key=9CCC3B514E196C6308CCD230666260C14A525406"}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{kdb mount test.ecf user/t crypto\_gcrypt}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{kdb mount test.ecf user/t crypto\_gcrypt "crypto/key=847378ABCF0A552B48082A80C52E8E92F785163F"}
\end{DoxyCode}
