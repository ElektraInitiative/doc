...
echo \char`\"{}key=false\char`\"{} $>$ {\ttfamily kdb file /tests/conditionals/sub}\hypertarget{autotoc_md84_autotoc_md96}{}\section{should fail and yield an error}\label{autotoc_md84_autotoc_md96}
