...
\Hypertarget{doc_decisions_high_level_api_md_md_doc_decisions_high_level_api}%
 \hypertarget{doc_decisions_high_level_api_md_autotoc_md1918}{}\doxysection{Problem}\label{doc_decisions_high_level_api_md_autotoc_md1918}
Projects usually do not want to use low-\/level APIs. {\ttfamily KDB} and {\ttfamily Key\+Set} is useful for plugins and to implement APIs but not to be directly used in applications.\hypertarget{doc_decisions_high_level_api_md_autotoc_md1919}{}\doxysection{Constraints}\label{doc_decisions_high_level_api_md_autotoc_md1919}
...
\end{DoxyItemize}
\end{DoxyEnumerate}\hypertarget{doc_decisions_high_level_api_md_autotoc_md1920}{}\doxysection{Assumptions}\label{doc_decisions_high_level_api_md_autotoc_md1920}
...
\end{DoxyItemize}\hypertarget{doc_decisions_high_level_api_md_autotoc_md1921}{}\doxysection{Considered Alternatives}\label{doc_decisions_high_level_api_md_autotoc_md1921}
...
\end{DoxyItemize}\hypertarget{doc_decisions_high_level_api_md_autotoc_md1922}{}\doxysection{Decision}\label{doc_decisions_high_level_api_md_autotoc_md1922}
...
\end{DoxyItemize}\hypertarget{doc_decisions_high_level_api_md_autotoc_md1923}{}\doxysection{Rationale}\label{doc_decisions_high_level_api_md_autotoc_md1923}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_high_level_api_md_autotoc_md1924}{}\doxysection{Implications}\label{doc_decisions_high_level_api_md_autotoc_md1924}
\hypertarget{doc_decisions_high_level_api_md_autotoc_md1925}{}\doxysection{Related Decisions}\label{doc_decisions_high_level_api_md_autotoc_md1925}
\hypertarget{doc_decisions_high_level_api_md_autotoc_md1926}{}\doxysection{Notes}\label{doc_decisions_high_level_api_md_autotoc_md1926}
