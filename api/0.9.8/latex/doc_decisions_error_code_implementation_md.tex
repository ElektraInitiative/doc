...
\Hypertarget{doc_decisions_error_code_implementation_md_md_doc_decisions_error_code_implementation}%
 \hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1790}{}\doxysection{Problem}\label{doc_decisions_error_code_implementation_md_autotoc_md1790}
In the previous error concept it was very useful to generate macros as we often added new errors. The code generation itself, however, was not ideal for cross compilation.\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1791}{}\doxysection{Constraints}\label{doc_decisions_error_code_implementation_md_autotoc_md1791}
\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1792}{}\doxysection{Assumptions}\label{doc_decisions_error_code_implementation_md_autotoc_md1792}

\begin{DoxyItemize}
\item Error codes do not change very often
\end{DoxyItemize}\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1793}{}\doxysection{Considered Alternatives}\label{doc_decisions_error_code_implementation_md_autotoc_md1793}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1794}{}\doxysection{Decision}\label{doc_decisions_error_code_implementation_md_autotoc_md1794}
...
When adding a new error code, language bindings have to be adapted accordingly such as the Rust or Java Binding.\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1795}{}\doxysection{Rationale}\label{doc_decisions_error_code_implementation_md_autotoc_md1795}

\begin{DoxyItemize}
\item Updates to error codes will imply syncing every binding. This though should happen in very rare circumstances.
\end{DoxyItemize}\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1796}{}\doxysection{Implications}\label{doc_decisions_error_code_implementation_md_autotoc_md1796}

\begin{DoxyItemize}
\item The current bindings stay untouched
\item Tutorial on how to write a binding should be written
\end{DoxyItemize}\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1797}{}\doxysection{Related Decisions}\label{doc_decisions_error_code_implementation_md_autotoc_md1797}
\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1798}{}\doxysection{Notes}\label{doc_decisions_error_code_implementation_md_autotoc_md1798}
