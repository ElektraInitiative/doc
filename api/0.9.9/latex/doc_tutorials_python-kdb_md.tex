...
\Hypertarget{doc_tutorials_python-kdb_md_md_doc_tutorials_python_kdb}%
 \hypertarget{doc_tutorials_python-kdb_md_autotoc_md3892}{}\doxysection{Table of Contents}\label{doc_tutorials_python-kdb_md_autotoc_md3892}
...
\item \href{\#Debian-buster}{\texttt{ Debian buster}}
\end{DoxyItemize}
\item \href{\#Import-kdb}{\texttt{ Import kdb}}
\item \href{\#Keyset}{\texttt{ Keyset}}
\item \href{\#Keys}{\texttt{ Keys}}
\end{DoxyItemize}\hypertarget{doc_tutorials_python-kdb_md_autotoc_md3893}{}\doxysection{Introduction}\label{doc_tutorials_python-kdb_md_autotoc_md3893}
When programming in Python it is possible to access the kdb database, changing values of existing keys, adding and deleting keys and a few other things.\hypertarget{doc_tutorials_python-kdb_md_autotoc_md3894}{}\doxysection{Installation}\label{doc_tutorials_python-kdb_md_autotoc_md3894}
Either \href{https://www.libelektra.org/bindings/swig_python}{\texttt{ build}} the package or install from a repository.\hypertarget{doc_tutorials_python-kdb_md_autotoc_md3895}{}\doxysubsection{Alpine Linux}\label{doc_tutorials_python-kdb_md_autotoc_md3895}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_python-kdb_md_autotoc_md3896}{}\doxysubsection{Debian buster}\label{doc_tutorials_python-kdb_md_autotoc_md3896}

\begin{DoxyCode}{0}
\DoxyCodeLine{docker run -\/it debian:buster}
...
Append \textquotesingle{}deb \href{https://debs.libelektra.org/buster}{\texttt{ https\+://debs.\+libelektra.\+org/buster}} buster main\textquotesingle{} to /etc/apt/sources.list
...
\end{DoxyCode}
\hypertarget{doc_tutorials_python-kdb_md_autotoc_md3897}{}\doxysection{Import kdb}\label{doc_tutorials_python-kdb_md_autotoc_md3897}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_python-kdb_md_autotoc_md3898}{}\doxysection{Keyset}\label{doc_tutorials_python-kdb_md_autotoc_md3898}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_python-kdb_md_autotoc_md3899}{}\doxysection{Keys}\label{doc_tutorials_python-kdb_md_autotoc_md3899}
