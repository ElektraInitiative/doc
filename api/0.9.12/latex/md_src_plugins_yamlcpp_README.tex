...
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md634}{}\doxysubsection{Introduction}\label{md_src_plugins_yamlcpp_README_autotoc_md634}
The YAML CPP plugin reads and writes configuration data via the \href{https://github.com/jbeder/yaml-cpp}{\texttt{ yaml-\/cpp}} library.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md635}{}\doxysubsection{Installation}\label{md_src_plugins_yamlcpp_README_autotoc_md635}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/yamlcpp}.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md636}{}\doxysubsection{Usage}\label{md_src_plugins_yamlcpp_README_autotoc_md636}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md637}{}\doxysubsection{Arrays}\label{md_src_plugins_yamlcpp_README_autotoc_md637}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md638}{}\doxysubsubsection{Nested Arrays}\label{md_src_plugins_yamlcpp_README_autotoc_md638}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md639}{}\doxysubsubsection{Sparse Arrays}\label{md_src_plugins_yamlcpp_README_autotoc_md639}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md640}{}\doxysubsection{Metadata}\label{md_src_plugins_yamlcpp_README_autotoc_md640}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md641}{}\doxysubsection{Binary Data}\label{md_src_plugins_yamlcpp_README_autotoc_md641}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md642}{}\doxysubsection{Empty}\label{md_src_plugins_yamlcpp_README_autotoc_md642}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md643}{}\doxysubsection{Binary Values}\label{md_src_plugins_yamlcpp_README_autotoc_md643}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md644}{}\doxysubsection{Dependencies}\label{md_src_plugins_yamlcpp_README_autotoc_md644}
This plugin requires \href{https://github.com/jbeder/yaml-cpp}{\texttt{ yaml-\/cpp}}. On a Debian based OS the package for the library is called \href{https://packages.debian.org/libyaml-cpp-dev}{\texttt{ {\ttfamily libyaml-\/cpp-\/dev}}}. On mac\+OS you can install the package \href{https://repology.org/project/yaml-cpp}{\texttt{ {\ttfamily yaml-\/cpp}}} via \href{https://brew.sh}{\texttt{ Home\+Brew}}.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md645}{}\doxysubsection{Limitations}\label{md_src_plugins_yamlcpp_README_autotoc_md645}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md646}{}\doxysubsubsection{Leaf Values}\label{md_src_plugins_yamlcpp_README_autotoc_md646}
...
. However, if we use this approach we are not able to support Elektra’s array type properly.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md647}{}\doxyparagraph{Directory Values}\label{md_src_plugins_yamlcpp_README_autotoc_md647}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md648}{}\doxysubsubsection{Special Values}\label{md_src_plugins_yamlcpp_README_autotoc_md648}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md649}{}\doxysubsubsection{Other Limitations}\label{md_src_plugins_yamlcpp_README_autotoc_md649}
