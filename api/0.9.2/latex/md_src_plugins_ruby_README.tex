...
This plugin is an Elektra to Ruby bridge and makes is possible to implement Elektra plugins with Ruby. This plugin requires the {\ttfamily ruby} binding.\hypertarget{md_src_plugins_ruby_README_autotoc_md633}{}\doxysection{Configuration Options}\label{md_src_plugins_ruby_README_autotoc_md633}
The plugin has the following configuration options\+:


\begin{DoxyItemize}
\item {\ttfamily script}\+: path to the Ruby plugin to use (mandatory)
\end{DoxyItemize}\hypertarget{md_src_plugins_ruby_README_autotoc_md634}{}\doxysection{Usage}\label{md_src_plugins_ruby_README_autotoc_md634}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_ruby_README_autotoc_md635}{}\doxysection{Implementing Ruby Plugins}\label{md_src_plugins_ruby_README_autotoc_md635}
...
\DoxyCodeLine{end}
\end{DoxyCode}
\hypertarget{md_src_plugins_ruby_README_autotoc_md636}{}\doxysection{Known Issues}\label{md_src_plugins_ruby_README_autotoc_md636}
