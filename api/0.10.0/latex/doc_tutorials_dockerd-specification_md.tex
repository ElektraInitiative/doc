...
\Hypertarget{doc_tutorials_dockerd-specification_md_md_doc_tutorials_dockerd_specification}%
 \hypertarget{doc_tutorials_dockerd-specification_md_autotoc_md4378}{}\doxysection{Overview}\label{doc_tutorials_dockerd-specification_md_autotoc_md4378}
\hypertarget{doc_tutorials_dockerd-specification_md_autotoc_md4379}{}\doxysubsection{Introduction}\label{doc_tutorials_dockerd-specification_md_autotoc_md4379}
In this tutorial you will learn how to interactively use the {\ttfamily Spec\+Elektra} specification language and {\ttfamily kdb} to write a configuration specification for \href{https://docs.docker.com/engine/reference/commandline/dockerd/}{\texttt{ dockerd}}.\hypertarget{doc_tutorials_dockerd-specification_md_autotoc_md4380}{}\doxysubsection{What you should already know}\label{doc_tutorials_dockerd-specification_md_autotoc_md4380}

\begin{DoxyItemize}
\item Already know how to write a \mbox{\hyperlink{doc_tutorials_specification_md}{specification}}
\end{DoxyItemize}\hypertarget{doc_tutorials_dockerd-specification_md_autotoc_md4381}{}\doxysubsection{What you’ll learn}\label{doc_tutorials_dockerd-specification_md_autotoc_md4381}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_dockerd-specification_md_autotoc_md4382}{}\doxysubsection{What you\textquotesingle{}ll do}\label{doc_tutorials_dockerd-specification_md_autotoc_md4382}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_dockerd-specification_md_autotoc_md4383}{}\doxysubsection{Scope}\label{doc_tutorials_dockerd-specification_md_autotoc_md4383}
...
\hypertarget{doc_tutorials_dockerd-specification_md_autotoc_md4384}{}\doxysection{Getting Started}\label{doc_tutorials_dockerd-specification_md_autotoc_md4384}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_dockerd-specification_md_autotoc_md4385}{}\doxysection{Specification Types (values)}\label{doc_tutorials_dockerd-specification_md_autotoc_md4385}
{\ttfamily Elektra} supports multiple types which leads to a more flexible specification. See \mbox{\hyperlink{md_src_plugins_type_README_src_plugins_type_README_md}{type plugin}} for information about all the types that are supported.\hypertarget{doc_tutorials_dockerd-specification_md_autotoc_md4386}{}\doxysection{Mount Setup}\label{doc_tutorials_dockerd-specification_md_autotoc_md4386}
We will be mounting an existing example \href{/home/jenkins/workspace/libelektra-release/examples/spec/dockerd.ini}{\texttt{ dockerd-\/spec}}.\hypertarget{doc_tutorials_dockerd-specification_md_autotoc_md4387}{}\doxysubsection{Step 1\+: Mount dockerd specification}\label{doc_tutorials_dockerd-specification_md_autotoc_md4387}
...
\hypertarget{doc_tutorials_dockerd-specification_md_autotoc_md4388}{}\doxysubsection{Step 2\+: Define a mountpoint}\label{doc_tutorials_dockerd-specification_md_autotoc_md4388}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_dockerd-specification_md_autotoc_md4389}{}\doxysubsection{Step 3\+: Define $<$tt$>$json$<$/tt$>$ as plugin}\label{doc_tutorials_dockerd-specification_md_autotoc_md4389}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_dockerd-specification_md_autotoc_md4390}{}\doxysubsection{Step 4\+: Do a specification mount}\label{doc_tutorials_dockerd-specification_md_autotoc_md4390}
...
\hypertarget{doc_tutorials_dockerd-specification_md_autotoc_md4392}{}\doxysubsection{Array specification}\label{doc_tutorials_dockerd-specification_md_autotoc_md4392}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_dockerd-specification_md_autotoc_md4393}{}\doxysubsection{Enum specification (for keys were only a set of possible options can be used)}\label{doc_tutorials_dockerd-specification_md_autotoc_md4393}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_dockerd-specification_md_autotoc_md4394}{}\doxysubsection{Wildcard specifications (for keys where a list of possible options can be used)}\label{doc_tutorials_dockerd-specification_md_autotoc_md4394}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_dockerd-specification_md_autotoc_md4395}{}\doxysubsection{Array specifications (for keys where a list of possible options can be used)}\label{doc_tutorials_dockerd-specification_md_autotoc_md4395}
...
The above specification defines that we can create array elements and each can have {\ttfamily base} or {\ttfamily size}.\hypertarget{doc_tutorials_dockerd-specification_md_autotoc_md4396}{}\doxysection{Final specification code}\label{doc_tutorials_dockerd-specification_md_autotoc_md4396}
...
\hypertarget{doc_tutorials_dockerd-specification_md_autotoc_md4397}{}\doxysection{Adding full example specification (with kdb import)}\label{doc_tutorials_dockerd-specification_md_autotoc_md4397}
...
\begin{quote}
NOTE\+: We want display the output because it is too long to display ($\sim$ 400-\/500 lines). \end{quote}
\hypertarget{doc_tutorials_dockerd-specification_md_autotoc_md4398}{}\doxysection{Appendix (full specification)}\label{doc_tutorials_dockerd-specification_md_autotoc_md4398}
