...
This plugin is a blacklist plugin that blocks the assignment of specific values to a key.\hypertarget{md_src_plugins_blacklist_README_autotoc_md60}{}\doxysection{Usage}\label{md_src_plugins_blacklist_README_autotoc_md60}
...
All values in the array will be rejected. The array indices don\textquotesingle{}t have to be continuous, using e.\+g. only {\ttfamily \#1}, {\ttfamily \#2} and {\ttfamily \#4} is also allowed. Just make sure {\ttfamily check/blacklist} is set to the largest index in the array.\hypertarget{md_src_plugins_blacklist_README_autotoc_md61}{}\doxysection{Installation}\label{md_src_plugins_blacklist_README_autotoc_md61}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/extra}.\hypertarget{md_src_plugins_blacklist_README_autotoc_md62}{}\doxysection{Examples}\label{md_src_plugins_blacklist_README_autotoc_md62}
...
\DoxyCodeLine{kdb set /tests/blacklist "{}"{}}
\DoxyCodeLine{kdb set /tests/blacklist/value water}
...
\DoxyCodeLine{kdb set /tests/blacklist/value earth}
\DoxyCodeLine{}
\DoxyCodeLine{\# should fail}
\DoxyCodeLine{kdb set /tests/blacklist/value fire}
\DoxyCodeLine{\# RET:5}
\DoxyCodeLine{\# ERROR:C03200}
\DoxyCodeLine{}
\DoxyCodeLine{\# should fail}
\DoxyCodeLine{kdb set /tests/blacklist/value air}
\DoxyCodeLine{\# RET:5}
\DoxyCodeLine{\# ERROR:C03200}
\DoxyCodeLine{}
\DoxyCodeLine{\# should fail}
\DoxyCodeLine{kdb set /tests/blacklist/value cold/water}
\DoxyCodeLine{\# RET:5}
\DoxyCodeLine{\# ERROR:C03200}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{kdb set /tests/blacklist/empty water}
\DoxyCodeLine{kdb meta-\/set spec:/tests/blacklist/empty check/blacklist '\#0'}
\DoxyCodeLine{kdb meta-\/set spec:/tests/blacklist/empty check/blacklist/\#0 ''}
\DoxyCodeLine{}
\DoxyCodeLine{\# should succeed}
\DoxyCodeLine{kdb set /tests/blacklist/empty earth}
\DoxyCodeLine{}
\DoxyCodeLine{\# should fail}
\DoxyCodeLine{kdb set /tests/blacklist/empty ''}
\DoxyCodeLine{\# RET:5}
\DoxyCodeLine{\# ERROR:C03200}
\DoxyCodeLine{}
