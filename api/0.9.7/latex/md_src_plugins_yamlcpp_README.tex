...
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md606}{}\doxysubsection{Introduction}\label{md_src_plugins_yamlcpp_README_autotoc_md606}
The YAML CPP plugin reads and writes configuration data via the \href{https://github.com/jbeder/yaml-cpp}{\texttt{ yaml-\/cpp}} library.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md607}{}\doxysubsection{Installation}\label{md_src_plugins_yamlcpp_README_autotoc_md607}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/yamlcpp}.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md608}{}\doxysubsection{Usage}\label{md_src_plugins_yamlcpp_README_autotoc_md608}
...
\DoxyCodeLine{echo "{}🔑 : 🐳"{}               > `kdb file /tests/yamlcpp`}
\DoxyCodeLine{\# Retrieve the value of the manually added key}
\DoxyCodeLine{kdb get /tests/yamlcpp/🔑}
\DoxyCodeLine{\#> 🐳}
\DoxyCodeLine{}
\DoxyCodeLine{\# Manually add syntactically incorrect data}
\DoxyCodeLine{echo "{}some key: @some  value"{} >> `kdb file /tests/yamlcpp`}
\DoxyCodeLine{kdb get "{}/tests/yamlcpp/some key"{}}
...
\DoxyCodeLine{echo "{}🔑: value"{} >  `kdb file /tests/yamlcpp`}
\DoxyCodeLine{}
\DoxyCodeLine{\# Add some values via `kdb set`}
\DoxyCodeLine{kdb set /tests/yamlcpp 🎵}
\DoxyCodeLine{kdb set /tests/yamlcpp/fleetwood mac}
\DoxyCodeLine{kdb set /tests/yamlcpp/the chain}
\DoxyCodeLine{}
\DoxyCodeLine{\# Retrieve the new values}
\DoxyCodeLine{kdb get /tests/yamlcpp}
\DoxyCodeLine{\#> 🎵}
\DoxyCodeLine{kdb get /tests/yamlcpp/the}
\DoxyCodeLine{\#> chain}
\DoxyCodeLine{kdb get /tests/yamlcpp/fleetwood}
\DoxyCodeLine{\#> mac}
\DoxyCodeLine{}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md609}{}\doxysubsection{Arrays}\label{md_src_plugins_yamlcpp_README_autotoc_md609}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md610}{}\doxysubsubsection{Nested Arrays}\label{md_src_plugins_yamlcpp_README_autotoc_md610}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md611}{}\doxysubsubsection{Sparse Arrays}\label{md_src_plugins_yamlcpp_README_autotoc_md611}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md612}{}\doxysubsection{Metadata}\label{md_src_plugins_yamlcpp_README_autotoc_md612}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md613}{}\doxysubsection{Binary Data}\label{md_src_plugins_yamlcpp_README_autotoc_md613}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md614}{}\doxysubsection{Empty}\label{md_src_plugins_yamlcpp_README_autotoc_md614}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md615}{}\doxysubsection{Binary Values}\label{md_src_plugins_yamlcpp_README_autotoc_md615}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md616}{}\doxysubsection{Dependencies}\label{md_src_plugins_yamlcpp_README_autotoc_md616}
This plugin requires \href{https://github.com/jbeder/yaml-cpp}{\texttt{ yaml-\/cpp}}. On a Debian based OS the package for the library is called \href{https://packages.debian.org/libyaml-cpp-dev}{\texttt{ {\ttfamily libyaml-\/cpp-\/dev}}}. On mac\+OS you can install the package \href{https://repology.org/project/yaml-cpp}{\texttt{ {\ttfamily yaml-\/cpp}}} via \href{https://brew.sh}{\texttt{ Home\+Brew}}.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md617}{}\doxysubsection{Limitations}\label{md_src_plugins_yamlcpp_README_autotoc_md617}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md618}{}\doxysubsubsection{Leaf Values}\label{md_src_plugins_yamlcpp_README_autotoc_md618}
...
. However, if we use this approach we are not able to support Elektra’s array type properly.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md619}{}\doxyparagraph{Directory Values}\label{md_src_plugins_yamlcpp_README_autotoc_md619}
To overcome the limitation described above, the YAML CPP plugin requires the \mbox{\hyperlink{md_src_plugins_directoryvalue_README_src_plugins_directoryvalue_README_md}{Directory Value}} plugin. This plugin converts the value of a non-\/leaf node to a leaf node with the name {\ttfamily \+\_\+\+\_\+\+\_\+dirdata}. For example, let us assume we have the following key set\+:
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md620}{}\doxysubsubsection{Special Values}\label{md_src_plugins_yamlcpp_README_autotoc_md620}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md621}{}\doxysubsubsection{Other Limitations}\label{md_src_plugins_yamlcpp_README_autotoc_md621}
