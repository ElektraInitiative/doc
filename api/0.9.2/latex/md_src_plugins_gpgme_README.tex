...
The cryptographic operations are performed by Gnu\+PG via the {\ttfamily libgpgme} library.\hypertarget{md_src_plugins_gpgme_README_autotoc_md247}{}\doxysection{Dependencies}\label{md_src_plugins_gpgme_README_autotoc_md247}

\begin{DoxyItemize}
\item {\ttfamily libgpgme11} version 1.\+10 or later
\end{DoxyItemize}\hypertarget{md_src_plugins_gpgme_README_autotoc_md248}{}\doxysection{Build Information}\label{md_src_plugins_gpgme_README_autotoc_md248}
The plugin has been tested on Ubuntu 18.\+04 with {\ttfamily libgpgme} version 1.\+10.\hypertarget{md_src_plugins_gpgme_README_autotoc_md249}{}\doxysection{Examples}\label{md_src_plugins_gpgme_README_autotoc_md249}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_gpgme_README_autotoc_md250}{}\doxysection{Configuration}\label{md_src_plugins_gpgme_README_autotoc_md250}
\hypertarget{md_src_plugins_gpgme_README_autotoc_md251}{}\doxysubsection{Gnu\+P\+G Keys}\label{md_src_plugins_gpgme_README_autotoc_md251}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_gpgme_README_autotoc_md252}{}\doxysubsection{Textmode}\label{md_src_plugins_gpgme_README_autotoc_md252}
{\ttfamily gpgme} operates in textmode per default. In textmode the output of G\+PG is A\+S\+C\+II armored.

Textmode can be disabled by setting {\ttfamily /gpgme/textmode} to {\ttfamily 0} in the plugin configuration.\hypertarget{md_src_plugins_gpgme_README_autotoc_md253}{}\doxysection{Technical Details}\label{md_src_plugins_gpgme_README_autotoc_md253}
\hypertarget{md_src_plugins_gpgme_README_autotoc_md254}{}\doxysubsection{Message Format}\label{md_src_plugins_gpgme_README_autotoc_md254}
