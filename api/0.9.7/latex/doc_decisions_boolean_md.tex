...
\Hypertarget{doc_decisions_boolean_md_md_doc_decisions_boolean}%
 \hypertarget{doc_decisions_boolean_md_autotoc_md1674}{}\doxysection{Problem}\label{doc_decisions_boolean_md_autotoc_md1674}
Inconsistent use of booleans in various parts of Elektra.\hypertarget{doc_decisions_boolean_md_autotoc_md1675}{}\doxysection{Constraints}\label{doc_decisions_boolean_md_autotoc_md1675}

\begin{DoxyItemize}
\item needs to be string
\end{DoxyItemize}\hypertarget{doc_decisions_boolean_md_autotoc_md1676}{}\doxysection{Assumptions}\label{doc_decisions_boolean_md_autotoc_md1676}
\hypertarget{doc_decisions_boolean_md_autotoc_md1677}{}\doxysection{Considered Alternatives}\label{doc_decisions_boolean_md_autotoc_md1677}
...
\end{DoxyItemize}\hypertarget{doc_decisions_boolean_md_autotoc_md1678}{}\doxysection{Decision}\label{doc_decisions_boolean_md_autotoc_md1678}
...
\end{DoxyItemize}\hypertarget{doc_decisions_boolean_md_autotoc_md1679}{}\doxysection{Rationale}\label{doc_decisions_boolean_md_autotoc_md1679}

\begin{DoxyItemize}
\item most easy to implement
\item allows non-\/presence to be false
\item plugins allow us to convert to any other behavior
\end{DoxyItemize}\hypertarget{doc_decisions_boolean_md_autotoc_md1680}{}\doxysection{Implications}\label{doc_decisions_boolean_md_autotoc_md1680}
...
\end{DoxyItemize}\hypertarget{doc_decisions_boolean_md_autotoc_md1681}{}\doxysection{Related Decisions}\label{doc_decisions_boolean_md_autotoc_md1681}
\hypertarget{doc_decisions_boolean_md_autotoc_md1682}{}\doxysection{Notes}\label{doc_decisions_boolean_md_autotoc_md1682}
