...
\Hypertarget{doc_decisions_high_level_api_md_md_doc_decisions_high_level_api}%
 \hypertarget{doc_decisions_high_level_api_md_autotoc_md1915}{}\doxysection{Problem}\label{doc_decisions_high_level_api_md_autotoc_md1915}
Projects usually do not want to use low-\/level APIs. {\ttfamily KDB} and {\ttfamily Key\+Set} is useful for plugins and to implement APIs but not to be directly used in applications.\hypertarget{doc_decisions_high_level_api_md_autotoc_md1916}{}\doxysection{Constraints}\label{doc_decisions_high_level_api_md_autotoc_md1916}
...
\end{DoxyItemize}
\end{DoxyEnumerate}\hypertarget{doc_decisions_high_level_api_md_autotoc_md1917}{}\doxysection{Assumptions}\label{doc_decisions_high_level_api_md_autotoc_md1917}
...
\end{DoxyItemize}\hypertarget{doc_decisions_high_level_api_md_autotoc_md1918}{}\doxysection{Considered Alternatives}\label{doc_decisions_high_level_api_md_autotoc_md1918}
...
\end{DoxyItemize}\hypertarget{doc_decisions_high_level_api_md_autotoc_md1919}{}\doxysection{Decision}\label{doc_decisions_high_level_api_md_autotoc_md1919}
...
\end{DoxyItemize}\hypertarget{doc_decisions_high_level_api_md_autotoc_md1920}{}\doxysection{Rationale}\label{doc_decisions_high_level_api_md_autotoc_md1920}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_high_level_api_md_autotoc_md1921}{}\doxysection{Implications}\label{doc_decisions_high_level_api_md_autotoc_md1921}
\hypertarget{doc_decisions_high_level_api_md_autotoc_md1922}{}\doxysection{Related Decisions}\label{doc_decisions_high_level_api_md_autotoc_md1922}
\hypertarget{doc_decisions_high_level_api_md_autotoc_md1923}{}\doxysection{Notes}\label{doc_decisions_high_level_api_md_autotoc_md1923}
