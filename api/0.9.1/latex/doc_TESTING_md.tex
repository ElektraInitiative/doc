...
\begin{DoxyCode}{0}
\DoxyCodeLine{~e/scripts/configure-debian -DCMAKE\_C\_COMPILER=/usr/src/afl/afl-2.52b/afl-gcc -DCMAKE\_CXX\_COMPILER=/usr/src/afl/afl-2.52b/afl-g++ ~e}
\end{DoxyCode}
...
\DoxyCodeLine{cp ~e/src/plugins/ini/ini/* testcase\_dir}
\end{DoxyCode}
