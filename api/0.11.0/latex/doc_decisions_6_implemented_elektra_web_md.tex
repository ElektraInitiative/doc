...
\Hypertarget{doc_decisions_6_implemented_elektra_web_md_md_doc_decisions_6_implemented_elektra_web}%
 \hypertarget{doc_decisions_6_implemented_elektra_web_md_autotoc_md2342}{}\doxysection{Problem}\label{doc_decisions_6_implemented_elektra_web_md_autotoc_md2342}
For Elektra Web, there needs to be a way to remotely manage instances and groups of instances (clusters). The remote configuration of a single instance is simple. However, to manage multiple instances, we need to store the information to access the daemons, as well as information about the grouping (clusters) of daemons.\hypertarget{doc_decisions_6_implemented_elektra_web_md_autotoc_md2343}{}\doxysection{Constraints}\label{doc_decisions_6_implemented_elektra_web_md_autotoc_md2343}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_elektra_web_md_autotoc_md2344}{}\doxysection{Assumptions}\label{doc_decisions_6_implemented_elektra_web_md_autotoc_md2344}
\hypertarget{doc_decisions_6_implemented_elektra_web_md_autotoc_md2345}{}\doxysection{Considered Alternatives}\label{doc_decisions_6_implemented_elektra_web_md_autotoc_md2345}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_elektra_web_md_autotoc_md2346}{}\doxysection{Decision}\label{doc_decisions_6_implemented_elektra_web_md_autotoc_md2346}
Use one cluster daemon (clusterd) to manage all clusters and instances.\hypertarget{doc_decisions_6_implemented_elektra_web_md_autotoc_md2347}{}\doxysection{Rationale}\label{doc_decisions_6_implemented_elektra_web_md_autotoc_md2347}
