...
Thus when a key starts with {\ttfamily /} such cascading will automatically performed.\hypertarget{doc_help_elektra-cascading_md_autotoc_md2223}{}\doxysection{SPEC}\label{doc_help_elektra-cascading_md_autotoc_md2223}
...
\end{DoxyCode}
\hypertarget{doc_help_elektra-cascading_md_autotoc_md2224}{}\doxysection{CASCADING}\label{doc_help_elektra-cascading_md_autotoc_md2224}
