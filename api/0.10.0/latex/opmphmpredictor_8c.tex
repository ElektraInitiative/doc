\hypertarget{opmphmpredictor_8c}{}\doxysection{opmphmpredictor.\+c File Reference}
...
\begin{DoxyCompactList}\small\item\em Heuristic function above the OPMPHM usage is worth. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Predictcs at the first ks\+Lookup (...) after a Key\+Set changed if it will be worth using the OPMPHM. \end{DoxyCompactList}\item 
...
Predictcs at the first ks\+Lookup (...) after a Key\+Set changed if it will be worth using the OPMPHM. 
