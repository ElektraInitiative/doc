...
nullKey=\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}(0);
\hyperlink{group__key_ga3df95bbc2494e3e6703ece5639be5bb1}{keyDel} (nullKey);

\textcolor{comment}{// Is the same as above}
nullKey=\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}(\textcolor{stringliteral}{""}, \hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END});
\hyperlink{group__key_ga3df95bbc2494e3e6703ece5639be5bb1}{keyDel} (nullKey);

\textcolor{comment}{// Create and initialize a key with a name and nothing else}
emptyNamedKey=\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}(\textcolor{stringliteral}{"user/some/example"},\hyperlink{group__key_gga91fb3178848bd682000958089abbaf40aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END});
\hyperlink{group__key_ga3df95bbc2494e3e6703ece5639be5bb1}{keyDel} (emptyNamedKey);
\end{DoxyCode}


\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{key\-New()} allocates memory for a key object and cleans everything up. After that, it processes the given argument list.
...
\hyperlink{group__keyset_gaa5a1d467a4d71041edce68ea7748ce45}{ksAppendKey}(ks,\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}(0));       \textcolor{comment}{// an empty key}

\hyperlink{group__keyset_gaa5a1d467a4d71041edce68ea7748ce45}{ksAppendKey}(ks,\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}(\textcolor{stringliteral}{"user/sw"},              \textcolor{comment}{// the name of
       the key}
...
\hyperlink{group__keyset_gaa5a1d467a4d71041edce68ea7748ce45}{ksAppendKey}(ks,\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}(\textcolor{stringliteral}{"user/tmp/ex1"},
...
\hyperlink{group__keyset_gaa5a1d467a4d71041edce68ea7748ce45}{ksAppendKey}(ks,\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}(\textcolor{stringliteral}{"user/tmp/ex2"},
...
\hyperlink{group__keyset_gaa5a1d467a4d71041edce68ea7748ce45}{ksAppendKey}(ks,\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}(\textcolor{stringliteral}{"user/tmp/ex4"},
...
\hyperlink{group__keyset_gaa5a1d467a4d71041edce68ea7748ce45}{ksAppendKey}(ks,\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew}(\textcolor{stringliteral}{"user/tmp/ex5"},
        KEY\_TYPE,
...
{\em Key\-Invalid\-Name} & if key could not be constructed (typically name wrong or at runtime on allocation problems)\\
\hline
\end{DoxyExceptions}
...
\begin{DoxySeeAlso}{See Also}
\hyperlink{classkdb_1_1Key_a4c5a3d463127ade0b766c4298002daa3}{set\-Meta()}, \hyperlink{classkdb_1_1Key_a7a4952f9ee22e6787fc9d43507114612}{get\-Meta()}, \hyperlink{classkdb_1_1Key_a53f6d2196a7f17c4bdc544207bdc5f4c}{copy\-Meta()}, \hyperlink{classkdb_1_1Key_aec0910bf293db33deac6a3f81359cb48}{copy\-All\-Meta()} 
\end{DoxySeeAlso}
...
unlike in the C version, it is safe to change the returned string. 
\end{DoxyNote}
\hypertarget{classkdb_1_1Key_aee1d42f22eda4d84d78ab72cd60cc005}{\index{kdb\-::\-Key@{kdb\-::\-Key}!get\-Name\-Size@{get\-Name\-Size}}
...
\end{DoxyRetVals}
\begin{DoxySeeAlso}{See Also}
\hyperlink{classkdb_1_1Key_a7a4952f9ee22e6787fc9d43507114612}{get\-Meta()} 
\end{DoxySeeAlso}
...
\hyperlink{group__keyname_ga6e804bd453f98c28b0ff51430d1df407}{key\-Set\-Base\-Name()} 
\end{DoxySeeAlso}
 (const std\-::string \&) \hypertarget{classkdb_1_1Key_ab64ec9d578e083dad3e43322535cf108}{\index{kdb\-::\-Key@{kdb\-::\-Key}!operator-\/$>$@{operator-\/$>$}}
\index{operator-\/$>$@{operator-\/$>$}!kdb::Key@{kdb\-::\-Key}}
...
\begin{DoxySeeAlso}{See Also}
\hyperlink{classkdb_1_1Key_a2305da805095605aca38d53f2733fb57}{del\-Meta()}, \hyperlink{classkdb_1_1Key_a7a4952f9ee22e6787fc9d43507114612}{get\-Meta()}, \hyperlink{classkdb_1_1Key_a53f6d2196a7f17c4bdc544207bdc5f4c}{copy\-Meta()}, \hyperlink{classkdb_1_1Key_aec0910bf293db33deac6a3f81359cb48}{copy\-All\-Meta()} 
\end{DoxySeeAlso}
