...
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md592}{}\doxysubsection{Introduction}\label{md_src_plugins_yamlcpp_README_autotoc_md592}
The YAML CPP plugin reads and writes configuration data via the \href{https://github.com/jbeder/yaml-cpp}{\texttt{ yaml-\/cpp}} library.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md593}{}\doxysubsection{Installation}\label{md_src_plugins_yamlcpp_README_autotoc_md593}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/yamlcpp}.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md594}{}\doxysubsection{Usage}\label{md_src_plugins_yamlcpp_README_autotoc_md594}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md595}{}\doxysubsection{Arrays}\label{md_src_plugins_yamlcpp_README_autotoc_md595}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md596}{}\doxysubsubsection{Nested Arrays}\label{md_src_plugins_yamlcpp_README_autotoc_md596}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md597}{}\doxysubsubsection{Sparse Arrays}\label{md_src_plugins_yamlcpp_README_autotoc_md597}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md598}{}\doxysubsection{Metadata}\label{md_src_plugins_yamlcpp_README_autotoc_md598}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md599}{}\doxysubsection{Binary Data}\label{md_src_plugins_yamlcpp_README_autotoc_md599}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md600}{}\doxysubsection{Empty}\label{md_src_plugins_yamlcpp_README_autotoc_md600}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md601}{}\doxysubsection{Binary Values}\label{md_src_plugins_yamlcpp_README_autotoc_md601}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md602}{}\doxysubsection{Dependencies}\label{md_src_plugins_yamlcpp_README_autotoc_md602}
This plugin requires \href{https://github.com/jbeder/yaml-cpp}{\texttt{ yaml-\/cpp}}. On a Debian based OS the package for the library is called \href{https://packages.debian.org/libyaml-cpp-dev}{\texttt{ {\ttfamily libyaml-\/cpp-\/dev}}}. On mac\+OS you can install the package \href{https://repology.org/project/yaml-cpp}{\texttt{ {\ttfamily yaml-\/cpp}}} via \href{https://brew.sh}{\texttt{ Home\+Brew}}.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md603}{}\doxysubsection{Limitations}\label{md_src_plugins_yamlcpp_README_autotoc_md603}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md604}{}\doxysubsubsection{Leaf Values}\label{md_src_plugins_yamlcpp_README_autotoc_md604}
...
. However, if we use this approach we are not able to support Elektra’s array type properly.\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md605}{}\doxyparagraph{Directory Values}\label{md_src_plugins_yamlcpp_README_autotoc_md605}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md606}{}\doxysubsubsection{Special Values}\label{md_src_plugins_yamlcpp_README_autotoc_md606}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_yamlcpp_README_autotoc_md607}{}\doxysubsubsection{Other Limitations}\label{md_src_plugins_yamlcpp_README_autotoc_md607}
