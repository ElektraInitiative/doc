...
\Hypertarget{doc_decisions_4_decided_keyname_md_md_doc_decisions_4_decided_keyname}%
 \hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2108}{}\doxysection{Problem}\label{doc_decisions_4_decided_keyname_md_autotoc_md2108}
...
The question now is, which representations should be used by {\ttfamily libelektra-\/core} and how.\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2109}{}\doxysection{Constraints}\label{doc_decisions_4_decided_keyname_md_autotoc_md2109}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2110}{}\doxysection{Assumptions}\label{doc_decisions_4_decided_keyname_md_autotoc_md2110}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2111}{}\doxysection{Considered Alternatives}\label{doc_decisions_4_decided_keyname_md_autotoc_md2111}
\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2112}{}\doxysubsection{Only escaped name}\label{doc_decisions_4_decided_keyname_md_autotoc_md2112}
...
Even with a separate namespace field, most benefits of \char`\"{}\+Only unescaped name\char`\"{} are retained. The memory consumption is near minimal (alignment padding can cause a difference). Comparisons are exactly the same, just with an additional namespace byte comparison beforehand.\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2115}{}\doxysubsection{Both escaped and unescaped name}\label{doc_decisions_4_decided_keyname_md_autotoc_md2115}
...
The issue with this approach is the insane memory consumption. Keynames can already be quite long and {\ttfamily Key} is at the base of Elektra. Storing every name twice in only slightly different forms essentially doubles the memory consumption.\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2116}{}\doxysubsection{Both escaped and unescaped name, but only unescaped stored}\label{doc_decisions_4_decided_keyname_md_autotoc_md2116}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2119}{}\doxysection{Rationale}\label{doc_decisions_4_decided_keyname_md_autotoc_md2119}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2120}{}\doxysection{Implications}\label{doc_decisions_4_decided_keyname_md_autotoc_md2120}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2121}{}\doxysection{Related Decisions}\label{doc_decisions_4_decided_keyname_md_autotoc_md2121}
\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2122}{}\doxysection{Notes}\label{doc_decisions_4_decided_keyname_md_autotoc_md2122}
\hypertarget{doc_decisions_4_decided_keyname_md_autotoc_md2123}{}\doxysubsection{Printing unescaped name in GDB}\label{doc_decisions_4_decided_keyname_md_autotoc_md2123}
