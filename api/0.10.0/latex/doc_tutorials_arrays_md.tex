...
\Hypertarget{doc_tutorials_arrays_md_md_doc_tutorials_arrays}%
 \hypertarget{doc_tutorials_arrays_md_autotoc_md4285}{}\doxysection{Key-\/\+Value Pairs}\label{doc_tutorials_arrays_md_autotoc_md4285}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md4286}{}\doxysection{Array Keys}\label{doc_tutorials_arrays_md_autotoc_md4286}
Since Elektra keys sorts keys alphabetically, we can use the key-\/value pair structure described above to store sequences of values (aka. arrays).\hypertarget{doc_tutorials_arrays_md_autotoc_md4287}{}\doxysubsection{Empty Arrays}\label{doc_tutorials_arrays_md_autotoc_md4287}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md4288}{}\doxysubsection{Array Elements}\label{doc_tutorials_arrays_md_autotoc_md4288}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md4289}{}\doxysubsection{Metadata}\label{doc_tutorials_arrays_md_autotoc_md4289}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md4290}{}\doxysection{Closing Remarks}\label{doc_tutorials_arrays_md_autotoc_md4290}
