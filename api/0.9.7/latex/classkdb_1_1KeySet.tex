...
\begin{DoxyCompactList}\small\item\em Return the first \mbox{\hyperlink{classkdb_1_1Key}{Key}} in the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}}. \end{DoxyCompactList}\item 
\mbox{\hyperlink{classkdb_1_1Key}{Key}} \mbox{\hyperlink{classkdb_1_1KeySet_a16deed50e0d8cfee023d4423a119df51}{tail}} () const
\begin{DoxyCompactList}\small\item\em Return the last \mbox{\hyperlink{classkdb_1_1Key}{Key}} in the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}}. \end{DoxyCompactList}\item 
...
void \mbox{\hyperlink{classkdb_1_1KeySet_aa36d35d8f12233a4c8f88d9bb13429c3}{set\+Cursor}} (elektra\+Cursor cursor) const
\begin{DoxyCompactList}\small\item\em Set the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} internal cursor to {\ttfamily cursor}. \end{DoxyCompactList}\item 
elektra\+Cursor \mbox{\hyperlink{classkdb_1_1KeySet_accc11bcf2a4b5937ce9f0787c011c2d9}{get\+Cursor}} () const
\begin{DoxyCompactList}\small\item\em Get the internal cursor of the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}}. \end{DoxyCompactList}\item 
...
\begin{DoxyItemize}
\item in \mbox{\hyperlink{group__keyset_ga60f1ddcf23272f2b29b90e92ebe9b56f}{ks\+Lookup()}}\+: points to the found key
...
\DoxyCodeLine{}
\DoxyCodeLine{Key * \mbox{\hyperlink{classkdb_1_1KeySet_a0a0fc4efecd6dcbfde5fc35301b60349}{current}};}
\DoxyCodeLine{\mbox{\hyperlink{group__keyset_gabe793ff51f1728e3429c84a8a9086b70}{ksRewind}} (myConfig);}
\DoxyCodeLine{\textcolor{keywordflow}{while} ((\mbox{\hyperlink{classkdb_1_1KeySet_a0a0fc4efecd6dcbfde5fc35301b60349}{current}} = \mbox{\hyperlink{group__keyset_ga317321c9065b5a4b3e33fe1c399bcec9}{ksNext}} (myConfig)) != 0)}
\DoxyCodeLine{\{}
\DoxyCodeLine{        printf (\textcolor{stringliteral}{"{}Key name is \%s.\(\backslash\)n"{}}, \mbox{\hyperlink{group__keyname_ga8e805c726a60da921d3736cda7813513}{keyName}} (\mbox{\hyperlink{classkdb_1_1KeySet_a0a0fc4efecd6dcbfde5fc35301b60349}{current}}));}
\DoxyCodeLine{\}}
...
\DoxyCodeLine{        orig.\mbox{\hyperlink{classkdb_1_1KeySet_a5bc5a16a726e959adaf3cf8506e7b849}{rewind}} ();}
\DoxyCodeLine{        \textcolor{keywordflow}{while} (orig.\mbox{\hyperlink{classkdb_1_1KeySet_affd52d130faf184361297f9e7f0c9f16}{next}} ())}
\DoxyCodeLine{        \{}
\DoxyCodeLine{                deepCopy.\mbox{\hyperlink{classkdb_1_1KeySet_a0d4b2f3aa9f58d10053561135b50233e}{append}} (orig.\mbox{\hyperlink{classkdb_1_1KeySet_a0a0fc4efecd6dcbfde5fc35301b60349}{current}} ().\mbox{\hyperlink{classkdb_1_1Key_a51d5873239ba67ffd3b475522e647434}{dup}} ());}
\DoxyCodeLine{        \}}
...
A destructor for \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} objects. Cleans all internal dynamic attributes, decrements all reference pointers to all Keys and then calls \mbox{\hyperlink{group__key_ga3df95bbc2494e3e6703ece5639be5bb1}{key\+Del()}} on all contained Keys. Afterwards \mbox{\hyperlink{internal_8c_a7f572149d2e0bfe18023a6ac969f195c}{elektra\+Free()}} is used to release the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}}\textquotesingle{}s object memory (that was previously allocated by \mbox{\hyperlink{group__keyset_ga671e1aaee3ae9dc13b4834a4ddbd2c3c}{ks\+New()}}).


\begin{DoxyParams}{Parameters}
{\em ks} & the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} that should be deleted\\
\hline
\end{DoxyParams}

\begin{DoxyRetVals}{Return values}
{\em 0} & when the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} was successfully freed \\
\hline
...
\end{DoxyReturn}
Appends a \mbox{\hyperlink{classkdb_1_1Key}{Key}} to the end of {\ttfamily ks}. Hands the ownership of the \mbox{\hyperlink{classkdb_1_1Key}{Key}} {\ttfamily to\+Append} to the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} {\ttfamily ks}. ks\+Del(ks) uses key\+Del(k) to delete every \mbox{\hyperlink{classkdb_1_1Key}{Key}} unless it got its reference counter incremented by \mbox{\hyperlink{group__key_ga6970a6f254d67af7e39f8e469bb162f1}{key\+Inc\+Ref()}}, e.\+g. by another \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} that contains this \mbox{\hyperlink{classkdb_1_1Key}{Key}}.
...
\mbox{\hyperlink{group__key_ga6970a6f254d67af7e39f8e469bb162f1}{key\+Inc\+Ref()}} for manually increasing a \mbox{\hyperlink{classkdb_1_1Key}{Key}}\textquotesingle{}s reference counter 
\end{DoxySeeAlso}
...
First all Keys in {\ttfamily dest} will be deleted. Afterwards the content of {\ttfamily source} will be added to the destination and \mbox{\hyperlink{group__keyset_ga4287b9416912c5f2ab9c195cb74fb094}{ks\+Current()}} will be set properly in {\ttfamily dest}.
\end{DoxyParagraph}
...
\index{kdb::KeySet@{kdb::KeySet}!current@{current}}
\index{current@{current}!kdb::KeySet@{kdb::KeySet}}
...
\begin{DoxyNote}{Note}
You must not delete the \mbox{\hyperlink{classkdb_1_1Key}{Key}} or change the \mbox{\hyperlink{classkdb_1_1Key}{Key}}, use \mbox{\hyperlink{group__keyset_gae42530b04defb772059de0600159cf69}{ks\+Pop()}} if you want to delete it.
\end{DoxyNote}

\begin{DoxyParams}{Parameters}
{\em ks} & the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} object to get the current \mbox{\hyperlink{classkdb_1_1Key}{Key}} from\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\end{DoxySince}
\begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{group__keyset_ga317321c9065b5a4b3e33fe1c399bcec9}{ks\+Next()}} to \mbox{\hyperlink{classkdb_1_1KeySet_a65208974b44da0162ef70dd7a173748f}{get}} the \mbox{\hyperlink{classkdb_1_1KeySet_affd52d130faf184361297f9e7f0c9f16}{next}} \mbox{\hyperlink{classkdb_1_1Key}{Key}} in the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} 

\mbox{\hyperlink{group__keyset_gabe793ff51f1728e3429c84a8a9086b70}{ks\+Rewind()}} for resetting the internal cursor of the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} 
\end{DoxySeeAlso}
...
\index{kdb::KeySet@{kdb::KeySet}!getCursor@{getCursor}}
\index{getCursor@{getCursor}!kdb::KeySet@{kdb::KeySet}}
...
Get the internal cursor of the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}}. 

\begin{DoxyWarning}{Warning}
Cursors are getting invalid when the \mbox{\hyperlink{classkdb_1_1Key}{Key}} was \mbox{\hyperlink{group__keyset_gae42530b04defb772059de0600159cf69}{ks\+Pop()}}ed or \mbox{\hyperlink{group__keyset_ga60f1ddcf23272f2b29b90e92ebe9b56f}{ks\+Lookup()}} with KDB\+\_\+\+O\+\_\+\+POP was used.
\end{DoxyWarning}
\hypertarget{group__keyset_readahead}{}\doxysubsection{Read ahead}\label{group__keyset_readahead}
With the cursors it is possible to read ahead in a \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}}\+:
...
It can also be used to restore the state of a \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} in a function
...
It is of course possible to make the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} const and cast its const away to set the cursor. Another way to achieve the same is to \mbox{\hyperlink{group__keyset_gac59e4b328245463f1451f68d5106151c}{ks\+Dup()}} the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}}, but it is not as efficient.
...
You can also use the cursor directly by initializing it to some index in the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} and then incrementing or decrementing it, to iterate over the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}}.


\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{        Key * cur;}
\DoxyCodeLine{        \textcolor{keywordflow}{for} (elektraCursor cursor = 0; (cur = \mbox{\hyperlink{group__keyset_ga12b8fefaa20546e4790d60338b0db836}{ksAtCursor}} (ks, cursor)) != NULL; ++cursor)}
\DoxyCodeLine{        \{}
...
\DoxyCodeLine{        Key * cur;}
\DoxyCodeLine{}
\DoxyCodeLine{        \textcolor{keywordflow}{while} ((cur = \mbox{\hyperlink{group__keyset_ga12b8fefaa20546e4790d60338b0db836}{ksAtCursor}} (ks, cursor)) != 0)}
\DoxyCodeLine{        \{}
\DoxyCodeLine{                printf (\textcolor{stringliteral}{"{}\%s\(\backslash\)n"{}}, \mbox{\hyperlink{group__keyname_ga8e805c726a60da921d3736cda7813513}{keyName}} (cur));}
\DoxyCodeLine{                ++cursor;}
\DoxyCodeLine{        \}}
...
\end{DoxyCodeInclude}
 \begin{DoxyNote}{Note}
Only use a cursor for the same \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} which it was made for.
\end{DoxyNote}

\begin{DoxyParams}{Parameters}
{\em ks} & the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} object to get the cursor from\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\mbox{\hyperlink{group__keyset_ga12b8fefaa20546e4790d60338b0db836}{ks\+At\+Cursor()}} for getting the \mbox{\hyperlink{classkdb_1_1Key}{Key}} \mbox{\hyperlink{classkdb_1_1KeySet_a40e32f2d9f34f03fa8ec85945f49b630}{at}} a specific position 
\end{DoxySeeAlso}
...
\index{kdb::KeySet@{kdb::KeySet}!head@{head}}
\index{head@{head}!kdb::KeySet@{kdb::KeySet}}
...
Return the first \mbox{\hyperlink{classkdb_1_1Key}{Key}} in the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}}. 

\begin{DoxyReturn}{Returns}
alphabetical first key
\end{DoxyReturn}
The \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}}\textquotesingle{}s cursor will not be affected.

If \mbox{\hyperlink{group__keyset_ga4287b9416912c5f2ab9c195cb74fb094}{ks\+Current()}}==\mbox{\hyperlink{group__keyset_gae7dbf3aef70e67b5328475eb3d1f92f5}{ks\+Head()}} you know you are on the first \mbox{\hyperlink{classkdb_1_1Key}{Key}}.


\begin{DoxyParams}{Parameters}
{\em ks} & the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} object to get the first \mbox{\hyperlink{classkdb_1_1Key}{Key}} from\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
the first \mbox{\hyperlink{classkdb_1_1Key}{Key}} of a \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} 
\end{DoxyReturn}

\begin{DoxyRetVals}{Return values}
{\em 0} & on NULL pointer or empty \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}}\\
\hline
\end{DoxyRetVals}
\begin{DoxySince}{Since}
1.\+0.\+0 
\end{DoxySince}
\begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{group__keyset_gadca442c4ab43cf532b15091d7711559e}{ks\+Tail()}} for getting the last \mbox{\hyperlink{classkdb_1_1Key}{Key}} of the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} 

\mbox{\hyperlink{group__keyset_gabe793ff51f1728e3429c84a8a9086b70}{ks\+Rewind()}}, \mbox{\hyperlink{group__keyset_ga4287b9416912c5f2ab9c195cb74fb094}{ks\+Current()}} and \mbox{\hyperlink{group__keyset_ga317321c9065b5a4b3e33fe1c399bcec9}{ks\+Next()}} for iterating over the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} 
\end{DoxySeeAlso}
...
If found, {\ttfamily ks} internal cursor will be positioned in the matched \mbox{\hyperlink{classkdb_1_1Key}{Key}} (also accessible by \mbox{\hyperlink{group__keyset_ga4287b9416912c5f2ab9c195cb74fb094}{ks\+Current()}}), and a pointer to the \mbox{\hyperlink{classkdb_1_1Key}{Key}} is returned. If not found, {\ttfamily ks} internal cursor will not move, and a NULL pointer is returned.
...
When \mbox{\hyperlink{group__keyset_ggada05f4bbf46fde81d0d57df86e73d914a52fb5f2cc86773d393da62bebebf7984}{KDB\+\_\+\+O\+\_\+\+POP}} is set the \mbox{\hyperlink{classkdb_1_1Key}{Key}} which was found will be \mbox{\hyperlink{group__keyset_gae42530b04defb772059de0600159cf69}{ks\+Pop()}}ed. \mbox{\hyperlink{group__keyset_ga4287b9416912c5f2ab9c195cb74fb094}{ks\+Current()}} will not be changed, only iff \mbox{\hyperlink{group__keyset_ga4287b9416912c5f2ab9c195cb74fb094}{ks\+Current()}} is the searched \mbox{\hyperlink{classkdb_1_1Key}{Key}}, then the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} will be \mbox{\hyperlink{group__keyset_gabe793ff51f1728e3429c84a8a9086b70}{ks\+Rewind()}}ed.
\end{DoxyParagraph}
\begin{DoxyNote}{Note}
...
\end{DoxyNote}
\begin{DoxyWarning}{Warning}
All cursors on the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} will be invalid iff you use \mbox{\hyperlink{group__keyset_ggada05f4bbf46fde81d0d57df86e73d914a52fb5f2cc86773d393da62bebebf7984}{KDB\+\_\+\+O\+\_\+\+POP}}, so don\textquotesingle{}t use this if you rely on a cursor, see \mbox{\hyperlink{group__keyset_gace0444eb8ec958a429794f8586fc72e7}{ks\+Get\+Cursor()}}.
\end{DoxyWarning}
The invalidation of cursors does not matter if you use multiple Key\+Sets, e.\+g. by using \mbox{\hyperlink{group__keyset_gac59e4b328245463f1451f68d5106151c}{ks\+Dup()}}. E.\+g., to separate \mbox{\hyperlink{group__keyset_ga60f1ddcf23272f2b29b90e92ebe9b56f}{ks\+Lookup()}} with \mbox{\hyperlink{group__keyset_ggada05f4bbf46fde81d0d57df86e73d914a52fb5f2cc86773d393da62bebebf7984}{KDB\+\_\+\+O\+\_\+\+POP}} and \mbox{\hyperlink{group__keyset_gaa5a1d467a4d71041edce68ea7748ce45}{ks\+Append\+Key()}}\+:
...
\DoxyCodeLine{        \textcolor{keywordflow}{while} ((\mbox{\hyperlink{classkdb_1_1KeySet_a0a0fc4efecd6dcbfde5fc35301b60349}{current}} = \mbox{\hyperlink{group__keyset_ga317321c9065b5a4b3e33fe1c399bcec9}{ksNext}} (iterator)))}
\DoxyCodeLine{        \{}
\DoxyCodeLine{                Key * key = \mbox{\hyperlink{group__keyset_ga60f1ddcf23272f2b29b90e92ebe9b56f}{ksLookup}} (\mbox{\hyperlink{classkdb_1_1KeySet_a2b8537e388edfbb6941d771106c0ae3a}{lookup}}, \mbox{\hyperlink{classkdb_1_1KeySet_a0a0fc4efecd6dcbfde5fc35301b60349}{current}}, \mbox{\hyperlink{group__keyset_ggada05f4bbf46fde81d0d57df86e73d914a52fb5f2cc86773d393da62bebebf7984}{KDB\_O\_POP}});}
...
\mbox{\hyperlink{group__keyset_ga4287b9416912c5f2ab9c195cb74fb094}{ks\+Current()}}, \mbox{\hyperlink{group__keyset_gabe793ff51f1728e3429c84a8a9086b70}{ks\+Rewind()}}, \mbox{\hyperlink{group__keyset_ga317321c9065b5a4b3e33fe1c399bcec9}{ks\+Next()}} for iterating over a \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}}
\end{DoxySeeAlso}
\begin{DoxyNote}{Note}
...
\index{kdb::KeySet@{kdb::KeySet}!next@{next}}
\index{next@{next}!kdb::KeySet@{kdb::KeySet}}
...
Returns the next \mbox{\hyperlink{classkdb_1_1Key}{Key}} in a \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}}. 
...
You\textquotesingle{}ll get a NULL pointer if the \mbox{\hyperlink{classkdb_1_1Key}{Key}} at the end of the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} has been reached. On subsequent calls of \mbox{\hyperlink{group__keyset_ga317321c9065b5a4b3e33fe1c399bcec9}{ks\+Next()}} it will still return the NULL pointer.

The {\ttfamily ks} internal cursor will be changed, so it is not const.

\begin{DoxyNote}{Note}
You must not delete or change the \mbox{\hyperlink{classkdb_1_1Key}{Key}}, use \mbox{\hyperlink{group__keyset_gae42530b04defb772059de0600159cf69}{ks\+Pop()}} if you want to delete it.

That applications must do \mbox{\hyperlink{group__keyset_ga60f1ddcf23272f2b29b90e92ebe9b56f}{ks\+Lookup()}} with an cascading \mbox{\hyperlink{classkdb_1_1Key}{Key}} for every single \mbox{\hyperlink{classkdb_1_1Key}{Key}} before using it, because specifications allow to hide or override Keys.
\end{DoxyNote}

\begin{DoxyParams}{Parameters}
{\em ks} & the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} object to work with\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyRetVals}{Return values}
{\em 0} & when the end of the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} has been reached \\
\hline
{\em 0} & on NULL pointer\\
\hline
\end{DoxyRetVals}
...
\mbox{\hyperlink{group__keyset_ga4287b9416912c5f2ab9c195cb74fb094}{ks\+Current()}} for getting the \mbox{\hyperlink{classkdb_1_1Key}{Key}} the cursor currently points \mbox{\hyperlink{classkdb_1_1KeySet_a40e32f2d9f34f03fa8ec85945f49b630}{at}} 
...
\mbox{\hyperlink{group__keyset_gadca442c4ab43cf532b15091d7711559e}{ks\+Tail()}} for getting the last \mbox{\hyperlink{classkdb_1_1Key}{Key}} of a \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} without removing it 
\end{DoxySeeAlso}
...
\index{kdb::KeySet@{kdb::KeySet}!rewind@{rewind}}
\index{rewind@{rewind}!kdb::KeySet@{kdb::KeySet}}
...
Use it to set the cursor to the beginning of the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}}. \mbox{\hyperlink{group__keyset_ga4287b9416912c5f2ab9c195cb74fb094}{ks\+Current()}} will always return NULL afterwards. So you want to use \mbox{\hyperlink{group__keyset_ga317321c9065b5a4b3e33fe1c399bcec9}{ks\+Next()}} first.
...
\begin{DoxyParams}{Parameters}
{\em ks} & the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} that should be rewound\\
\hline
\end{DoxyParams}
...
\end{DoxySince}
\begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{group__keyset_ga317321c9065b5a4b3e33fe1c399bcec9}{ks\+Next()}} for moving the cursor to the \mbox{\hyperlink{classkdb_1_1KeySet_affd52d130faf184361297f9e7f0c9f16}{next}} entry in the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} 

\mbox{\hyperlink{group__keyset_ga4287b9416912c5f2ab9c195cb74fb094}{ks\+Current()}} for getting the \mbox{\hyperlink{classkdb_1_1KeySet_a0a0fc4efecd6dcbfde5fc35301b60349}{current}} element in the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} 
\end{DoxySeeAlso}
...
\index{kdb::KeySet@{kdb::KeySet}!setCursor@{setCursor}}
\index{setCursor@{setCursor}!kdb::KeySet@{kdb::KeySet}}
...
Set the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} internal cursor to {\ttfamily cursor}. 

Use it to set the cursor to a stored position. \mbox{\hyperlink{group__keyset_ga4287b9416912c5f2ab9c195cb74fb094}{ks\+Current()}} will then return the \mbox{\hyperlink{classkdb_1_1Key}{Key}} at the position of the supplied cursor.

\begin{DoxyWarning}{Warning}
Cursors may get invalid when the \mbox{\hyperlink{classkdb_1_1Key}{Key}} was \mbox{\hyperlink{group__keyset_gae42530b04defb772059de0600159cf69}{ks\+Pop()}}ed or \mbox{\hyperlink{group__keyset_ga60f1ddcf23272f2b29b90e92ebe9b56f}{ks\+Lookup()}} was used together with KDB\+\_\+\+O\+\_\+\+POP.
\end{DoxyWarning}
...
An invalid cursor will set the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} to its beginning like \mbox{\hyperlink{group__keyset_gabe793ff51f1728e3429c84a8a9086b70}{ks\+Rewind()}}. When you set an invalid cursor \mbox{\hyperlink{group__keyset_ga4287b9416912c5f2ab9c195cb74fb094}{ks\+Current()}} is 0 and \mbox{\hyperlink{group__keyset_ga317321c9065b5a4b3e33fe1c399bcec9}{ks\+Next()}} == \mbox{\hyperlink{group__keyset_gae7dbf3aef70e67b5328475eb3d1f92f5}{ks\+Head()}}.


\begin{DoxyParams}{Parameters}
{\em ks} & the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} object where the cursor should be set \\
\hline
...
\begin{DoxyRetVals}{Return values}
{\em 0} & when the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} has been \mbox{\hyperlink{group__keyset_gabe793ff51f1728e3429c84a8a9086b70}{ks\+Rewind()}}ed \\
\hline
{\em 1} & otherwise \\
\hline
{\em -\/1} & on NULL pointer\\
...
\end{DoxySince}
\begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{group__keyset_gace0444eb8ec958a429794f8586fc72e7}{ks\+Get\+Cursor()}} for getting the cursor \mbox{\hyperlink{classkdb_1_1KeySet_a40e32f2d9f34f03fa8ec85945f49b630}{at}} the \mbox{\hyperlink{classkdb_1_1KeySet_a0a0fc4efecd6dcbfde5fc35301b60349}{current}} position 

\mbox{\hyperlink{group__keyset_ga317321c9065b5a4b3e33fe1c399bcec9}{ks\+Next()}} for moving the internal cursor forward 

\mbox{\hyperlink{group__keyset_ga4287b9416912c5f2ab9c195cb74fb094}{ks\+Current()}} for getting the \mbox{\hyperlink{classkdb_1_1Key}{Key}} \mbox{\hyperlink{classkdb_1_1KeySet_a40e32f2d9f34f03fa8ec85945f49b630}{at}} the \mbox{\hyperlink{classkdb_1_1KeySet_a0a0fc4efecd6dcbfde5fc35301b60349}{current}} position 
\end{DoxySeeAlso}
...
\index{kdb::KeySet@{kdb::KeySet}!setKeySet@{setKeySet}}
\index{setKeySet@{setKeySet}!kdb::KeySet@{kdb::KeySet}}
\doxysubsubsection{\texorpdfstring{setKeySet()}{setKeySet()}}
...
\index{kdb::KeySet@{kdb::KeySet}!tail@{tail}}
\index{tail@{tail}!kdb::KeySet@{kdb::KeySet}}
...
Return the last \mbox{\hyperlink{classkdb_1_1Key}{Key}} in the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}}. 
...
If \mbox{\hyperlink{group__keyset_ga4287b9416912c5f2ab9c195cb74fb094}{ks\+Current()}}==\mbox{\hyperlink{group__keyset_gadca442c4ab43cf532b15091d7711559e}{ks\+Tail()}} you know you are on the last key. \mbox{\hyperlink{group__keyset_ga317321c9065b5a4b3e33fe1c399bcec9}{ks\+Next()}} will return a NULL pointer afterwards.


\begin{DoxyParams}{Parameters}
{\em ks} & the \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} object to get the last \mbox{\hyperlink{classkdb_1_1Key}{Key}} from\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
the last \mbox{\hyperlink{classkdb_1_1Key}{Key}} of a \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} 
\end{DoxyReturn}
...
\end{DoxySince}
\begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{group__keyset_gae7dbf3aef70e67b5328475eb3d1f92f5}{ks\+Head()}} for getting the first \mbox{\hyperlink{classkdb_1_1Key}{Key}} of a \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} 
