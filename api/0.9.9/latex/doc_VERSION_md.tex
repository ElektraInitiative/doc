...
All libraries and plugins from Elektra must be installed in exactly the same major and minor version, so no library or plugin-\/specific version information exists.\hypertarget{doc_VERSION_md_autotoc_md4002}{}\doxysection{Scope}\label{doc_VERSION_md_autotoc_md4002}
...
\end{DoxyItemize}\hypertarget{doc_VERSION_md_autotoc_md4003}{}\doxysection{Behavior}\label{doc_VERSION_md_autotoc_md4003}
...
Any inconsistency within these artifacts within each other or with the implementation constitutes a bug.\hypertarget{doc_VERSION_md_autotoc_md4004}{}\doxysection{Compatibility}\label{doc_VERSION_md_autotoc_md4004}
...
References\+: \href{http://tldp.org/HOWTO/Program-Library-HOWTO/shared-libraries.html}{\texttt{ http\+://tldp.\+org/\+HOWTO/\+Program-\/\+Library-\/\+HOWTO/shared-\/libraries.\+html}} \href{http://packages.debian.org/de/sid/icheck}{\texttt{ http\+://packages.\+debian.\+org/de/sid/icheck}}\hypertarget{doc_VERSION_md_autotoc_md4005}{}\doxysection{Bindings}\label{doc_VERSION_md_autotoc_md4005}
