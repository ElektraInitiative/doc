...
The cryptographic operations are performed by Gnu\+PG via the {\ttfamily libgpgme} library.\hypertarget{md_src_plugins_gpgme_README_autotoc_md233}{}\doxysection{Installation}\label{md_src_plugins_gpgme_README_autotoc_md233}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/experimental}.\hypertarget{md_src_plugins_gpgme_README_autotoc_md234}{}\doxysection{Dependencies}\label{md_src_plugins_gpgme_README_autotoc_md234}

\begin{DoxyItemize}
\item {\ttfamily libgpgme11} version 1.\+10 or later
\end{DoxyItemize}\hypertarget{md_src_plugins_gpgme_README_autotoc_md235}{}\doxysection{Build Information}\label{md_src_plugins_gpgme_README_autotoc_md235}
The plugin has been tested on Ubuntu 18.\+04 with {\ttfamily libgpgme} version 1.\+10.\hypertarget{md_src_plugins_gpgme_README_autotoc_md236}{}\doxysection{Examples}\label{md_src_plugins_gpgme_README_autotoc_md236}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_gpgme_README_autotoc_md237}{}\doxysection{Configuration}\label{md_src_plugins_gpgme_README_autotoc_md237}
\hypertarget{md_src_plugins_gpgme_README_autotoc_md238}{}\doxysubsection{Gnu\+PG Keys}\label{md_src_plugins_gpgme_README_autotoc_md238}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_gpgme_README_autotoc_md239}{}\doxysubsection{Textmode}\label{md_src_plugins_gpgme_README_autotoc_md239}
{\ttfamily gpgme} operates in textmode per default. In textmode the output of GPG is ASCII armored.

Textmode can be disabled by setting {\ttfamily /gpgme/textmode} to {\ttfamily 0} in the plugin configuration.\hypertarget{md_src_plugins_gpgme_README_autotoc_md240}{}\doxysection{Technical Details}\label{md_src_plugins_gpgme_README_autotoc_md240}
\hypertarget{md_src_plugins_gpgme_README_autotoc_md241}{}\doxysubsection{Message Format}\label{md_src_plugins_gpgme_README_autotoc_md241}
