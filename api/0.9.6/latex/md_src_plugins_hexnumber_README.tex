...
This plugin is used to read configuration files that use hexadecimal values. All \char`\"{}hex-\/values\char`\"{} (see below) will be converted into decimal when Elektra reads values from the mounted file. When Elektra writes back to the file the converted values will be converted back and stored as before ({\ttfamily 0X} will be replaced with {\ttfamily 0x}).\hypertarget{md_src_plugins_hexnumber_README_autotoc_md239}{}\doxysection{Installation}\label{md_src_plugins_hexnumber_README_autotoc_md239}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/extra}.\hypertarget{md_src_plugins_hexnumber_README_autotoc_md240}{}\doxysubsection{What are \char`\"{}hex-\/values\char`\"{}?}\label{md_src_plugins_hexnumber_README_autotoc_md240}
...
\end{DoxyEnumerate}\hypertarget{md_src_plugins_hexnumber_README_autotoc_md241}{}\doxysection{Configuration}\label{md_src_plugins_hexnumber_README_autotoc_md241}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_hexnumber_README_autotoc_md242}{}\doxysection{Usage \& Example}\label{md_src_plugins_hexnumber_README_autotoc_md242}
