...
Exporting a Key\+Set to the nickle format\+: \begin{DoxyVerb}kdb export spec/ni ni > example.ni
\end{DoxyVerb}


For in-\/detail explanation of the syntax (nested keys are not supported by the plugin, however) \href{https://github.com/ElektraInitiative/libelektra/tree/master/src/plugins/ni/nickel-1.1.0/include/bohr/ni.h}{\tt see nickel-\/1.\+1.\+0/include/bohr/ni.h}
...
src\+\_\+plugins\+\_\+ni\+\_\+bohr libraries \char`\"{}https\+://github.\+com/chazomaticus/bohr\char`\"{} 