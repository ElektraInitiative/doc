...
\Hypertarget{doc_decisions_6_implemented_ensure_md_md_doc_decisions_6_implemented_ensure}%
 \hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2333}{}\doxysection{Problem}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2333}
Applications want to ensure that some functionality (hooks) is present in Elektra.\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2334}{}\doxysection{Constraints}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2334}
\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2335}{}\doxysection{Assumptions}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2335}
\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2336}{}\doxysection{Considered Alternatives}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2336}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2337}{}\doxysection{Decision}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2337}
Integrate {\ttfamily kdb\+Ensure} in {\ttfamily kdb\+Open(\+Key $\ast$error\+Key, Key\+Set $\ast$contract)} but only allow hooks.\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2338}{}\doxysection{Rationale}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2338}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2339}{}\doxysection{Implications}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2339}
...
It is safe to use the contract {\ttfamily Key\+Set} also for {\ttfamily kdb\+Get} and {\ttfamily kdb\+Set} invocations. Contract {\ttfamily Key\+Set}s only contain {\ttfamily Key}s below {\ttfamily system\+:/elektra/contract}. Therefore, normal {\ttfamily Key\+Set}s should not interfere.\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2340}{}\doxysection{Related Decisions}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2340}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2341}{}\doxysection{Notes}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2341}
