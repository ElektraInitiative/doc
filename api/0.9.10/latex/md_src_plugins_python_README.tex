...
What a Python script can do is not really limited by design, so any kind of plugin may be implemented. The python plugin is especially useful to write filter and logging scripts.\hypertarget{md_src_plugins_python_README_autotoc_md410}{}\doxysection{Installation}\label{md_src_plugins_python_README_autotoc_md410}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/python}.\hypertarget{md_src_plugins_python_README_autotoc_md411}{}\doxysection{Usage}\label{md_src_plugins_python_README_autotoc_md411}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_python_README_autotoc_md412}{}\doxysubsection{Plugin Configuration}\label{md_src_plugins_python_README_autotoc_md412}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_python_README_autotoc_md413}{}\doxysubsection{Python Scripts}\label{md_src_plugins_python_README_autotoc_md413}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_python_README_autotoc_md414}{}\doxysection{Example}\label{md_src_plugins_python_README_autotoc_md414}
...
Further examples can be found in the python directory.\hypertarget{md_src_plugins_python_README_autotoc_md415}{}\doxysection{Disclaimer}\label{md_src_plugins_python_README_autotoc_md415}
