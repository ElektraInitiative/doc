...
\Hypertarget{doc_decisions_bootstrap_md_md_doc_decisions_bootstrap}%
 \hypertarget{doc_decisions_bootstrap_md_autotoc_md1683}{}\doxysection{Problem}\label{doc_decisions_bootstrap_md_autotoc_md1683}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1684}{}\doxysection{Constraints}\label{doc_decisions_bootstrap_md_autotoc_md1684}
...
\end{DoxyItemize}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1685}{}\doxysection{Assumptions}\label{doc_decisions_bootstrap_md_autotoc_md1685}

\begin{DoxyItemize}
\item Bootstrap should be fast and not unnecessarily read large files
\end{DoxyItemize}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1686}{}\doxysection{Considered Alternatives}\label{doc_decisions_bootstrap_md_autotoc_md1686}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1687}{}\doxysection{Decision}\label{doc_decisions_bootstrap_md_autotoc_md1687}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1688}{}\doxysection{Rationale}\label{doc_decisions_bootstrap_md_autotoc_md1688}

\begin{DoxyItemize}
\item Solves both problems
\item Is fully compatible with any existing setup
\item People can decide if and how to migrate
\end{DoxyItemize}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1689}{}\doxysection{Implications}\label{doc_decisions_bootstrap_md_autotoc_md1689}

\begin{DoxyItemize}
\item added scripts/upgrade-\/bootstrap
\end{DoxyItemize}\hypertarget{doc_decisions_bootstrap_md_autotoc_md1690}{}\doxysection{Related Decisions}\label{doc_decisions_bootstrap_md_autotoc_md1690}
\hypertarget{doc_decisions_bootstrap_md_autotoc_md1691}{}\doxysection{Notes}\label{doc_decisions_bootstrap_md_autotoc_md1691}
