...
\Hypertarget{doc_help_elektra-faq_md_md_doc_help_elektra_faq}%
 \hypertarget{doc_help_elektra-faq_md_autotoc_md2772}{}\doxysection{I Am Stuck. Where Can I Get Help?}\label{doc_help_elektra-faq_md_autotoc_md2772}
...
Please do not waste too much time to find something out yourself. Information where people get stuck is valuable to improve Elektra and its documentation. Even if you find out directly after you posted the question\+: the pointer can be helpful for other people having the same problem.\hypertarget{doc_help_elektra-faq_md_autotoc_md2773}{}\doxysection{Isn\textquotesingle{}t it Easier to Implement a new Parser Than to use Elektra?}\label{doc_help_elektra-faq_md_autotoc_md2773}
...
So it pays off to use Elektra -- in the short and in the long term.\hypertarget{doc_help_elektra-faq_md_autotoc_md2774}{}\doxysection{Why Do I Need Elektra If I Already Use Configuration Management Tools?}\label{doc_help_elektra-faq_md_autotoc_md2774}
Short answer\+: Try
...
See \mbox{\hyperlink{doc_VISION_md}{our vision}} for an example.\hypertarget{doc_help_elektra-faq_md_autotoc_md2775}{}\doxysection{If Elektra Already Exists so Long, why isn\textquotesingle{}t it more Widespread?}\label{doc_help_elektra-faq_md_autotoc_md2775}
...
\end{DoxyEnumerate}\hypertarget{doc_help_elektra-faq_md_autotoc_md2776}{}\doxysection{Do We Retain the Old Way of Configuring Things, i.\+e. Manually Editing an INI File in /etc?}\label{doc_help_elektra-faq_md_autotoc_md2776}
...
Writing configuration files is much more tricky, as Elektra avoids data loss in the case of concurrent writes, even if the other application does not use Elektra. Elektra uses optimistic writes and rolls backs when it detects that configuration files were modified.\hypertarget{doc_help_elektra-faq_md_autotoc_md2777}{}\doxysection{Do We Retain the Way of Reloading/\+Restarting the System Service?}\label{doc_help_elektra-faq_md_autotoc_md2777}
Elektra does not interfere with restarting. It is a passive library. It provides some techniques for reloading but they are optional. We recommend, however, that you keep the in-\/memory and persistent configuration always in sync via immediate writes on changes and immediate reloading after notifications.\hypertarget{doc_help_elektra-faq_md_autotoc_md2778}{}\doxysection{Is This an Actual Problem of Elektra or Is It Just Me?}\label{doc_help_elektra-faq_md_autotoc_md2778}
...
So do not worry too much, do not hesitate to ask any question. We welcome feedback, only then we can improve the documentation such as this FAQ!\hypertarget{doc_help_elektra-faq_md_autotoc_md2779}{}\doxysection{What Should I Do If I Found a Bug?}\label{doc_help_elektra-faq_md_autotoc_md2779}
Please check the \href{https://git.libelektra.org/issues}{\texttt{ issue tracker}} if it has already been reported. If it has not, please \href{https://git.libelektra.org/issues/new}{\texttt{ fill out the template}}. If you are in doubt, please report it.\hypertarget{doc_help_elektra-faq_md_autotoc_md2780}{}\doxysection{How Can I Contribute to Elektra?}\label{doc_help_elektra-faq_md_autotoc_md2780}
...
Please start by reading here.\hypertarget{doc_help_elektra-faq_md_autotoc_md2781}{}\doxysection{What Is Elektra’s License?}\label{doc_help_elektra-faq_md_autotoc_md2781}
New BSD license which allows us to have plugins link against GPL and GPL-\/incompatible libraries. If you compile Elektra, e.\+g., with GPL plugins, the result is GPL. We are \href{https://reuse.software/}{\texttt{ reuse}} compliant.\hypertarget{doc_help_elektra-faq_md_autotoc_md2782}{}\doxysection{Which version should I use?}\label{doc_help_elektra-faq_md_autotoc_md2782}
...
For details of versioning principles, see \mbox{\hyperlink{doc_VERSION_md}{here}}.\hypertarget{doc_help_elektra-faq_md_autotoc_md2783}{}\doxysection{Who Are the Authors?}\label{doc_help_elektra-faq_md_autotoc_md2783}
\mbox{\hyperlink{doc_AUTHORS_md}{List of authors}}.\hypertarget{doc_help_elektra-faq_md_autotoc_md2784}{}\doxysection{How Can I Advertise Elektra?}\label{doc_help_elektra-faq_md_autotoc_md2784}
