...
This plugin is an implementation of a parser and generator of the /etc/fstab file.\hypertarget{md_src_plugins_fstab_README_autotoc_md231}{}\doxysection{Old fstab Entries}\label{md_src_plugins_fstab_README_autotoc_md231}
...
setmntent is used, so it is only conforming to B\+SD 4.\+3 and linux and you can\textquotesingle{}t use any comments.\hypertarget{md_src_plugins_fstab_README_autotoc_md232}{}\doxysection{New fstab Entries}\label{md_src_plugins_fstab_README_autotoc_md232}
Specification\+:
...
Spaces in the names are replaced by \textbackslash{}040 in the fstab.\hypertarget{md_src_plugins_fstab_README_autotoc_md233}{}\doxysection{Example}\label{md_src_plugins_fstab_README_autotoc_md233}
Mount the plugin\+:
