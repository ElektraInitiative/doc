...
The multifile-\/resolver does so by calling resolver and storage plugins for each file matching a given pattern.\hypertarget{md_src_plugins_multifile_README_autotoc_md363}{}\doxysection{Plugin Configuration}\label{md_src_plugins_multifile_README_autotoc_md363}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_multifile_README_autotoc_md364}{}\doxysection{Usage}\label{md_src_plugins_multifile_README_autotoc_md364}
...
{\ttfamily kdb mount -\/R multifile -\/c storage=\char`\"{}toml\char`\"{},pattern=\char`\"{}$\ast$.\+toml\char`\"{},recursive=,resolver=\char`\"{}resolver\char`\"{} /path /mountpoint}\hypertarget{md_src_plugins_multifile_README_autotoc_md365}{}\doxysection{Examples}\label{md_src_plugins_multifile_README_autotoc_md365}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_multifile_README_autotoc_md366}{}\doxysection{Limitations}\label{md_src_plugins_multifile_README_autotoc_md366}
