...
\Hypertarget{doc_decisions_6_implemented_ensure_md_md_doc_decisions_6_implemented_ensure}%
 \hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2369}{}\doxysection{Problem}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2369}
Applications want to ensure that some functionality (hooks) is present in Elektra.\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2370}{}\doxysection{Constraints}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2370}
\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2371}{}\doxysection{Assumptions}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2371}
\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2372}{}\doxysection{Considered Alternatives}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2372}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2373}{}\doxysection{Decision}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2373}
Integrate {\ttfamily kdb\+Ensure} in {\ttfamily kdb\+Open(\+Key $\ast$error\+Key, Key\+Set $\ast$contract)} but only allow hooks.\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2374}{}\doxysection{Rationale}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2374}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2375}{}\doxysection{Implications}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2375}
...
It is safe to use the contract {\ttfamily Key\+Set} also for {\ttfamily kdb\+Get} and {\ttfamily kdb\+Set} invocations. Contract {\ttfamily Key\+Set}s only contain {\ttfamily Key}s below {\ttfamily system\+:/elektra/contract}. Therefore, normal {\ttfamily Key\+Set}s should not interfere.\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2376}{}\doxysection{Related Decisions}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2376}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_ensure_md_autotoc_md2377}{}\doxysection{Notes}\label{doc_decisions_6_implemented_ensure_md_autotoc_md2377}
