...
\Hypertarget{doc_decisions_6_implemented_elektra_web_recursive_md_md_doc_decisions_6_implemented_elektra_web_recursive}%
 \hypertarget{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2315}{}\doxysection{Problem}\label{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2315}
After deciding how to remotely manage instances and groups of instances (clusters) with Elektra Web, there is still the issue of recursively nested clusters (clusters of clusters).\hypertarget{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2316}{}\doxysection{Constraints}\label{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2316}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2317}{}\doxysection{Assumptions}\label{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2317}

\begin{DoxyItemize}
\item Use one cluster daemon (clusterd) to manage all clusters and instances.
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2318}{}\doxysection{Considered Alternatives}\label{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2318}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2319}{}\doxysection{Decision}\label{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2319}
Managing the hierarchy in a single clusterd instance.\hypertarget{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2320}{}\doxysection{Rationale}\label{doc_decisions_6_implemented_elektra_web_recursive_md_autotoc_md2320}
