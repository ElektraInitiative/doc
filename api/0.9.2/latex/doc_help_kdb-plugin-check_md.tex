\hypertarget{doc_help_kdb-plugin-check_md_autotoc_md1792}{}\doxysection{S\+Y\+N\+O\+P\+S\+IS}\label{doc_help_kdb-plugin-check_md_autotoc_md1792}
{\ttfamily kdb plugin-\/check \mbox{[}$<$plugin$>$\mbox{]}}\hypertarget{doc_help_kdb-plugin-check_md_autotoc_md1793}{}\doxysection{D\+E\+S\+C\+R\+I\+P\+T\+I\+ON}\label{doc_help_kdb-plugin-check_md_autotoc_md1793}
This command is used to perform checks on the key database or an Elektra plugin.

Where the option argument, {\ttfamily plugin} is the plugin that a user wants to check. Use {\ttfamily -\/c} to pass options to that plugin. If no {\ttfamily plugin} argument is provided a check will be performed on the key database itself. Special values are returned upon exit to represent the outcome of a check.\hypertarget{doc_help_kdb-plugin-check_md_autotoc_md1794}{}\doxysection{O\+P\+T\+I\+O\+NS}\label{doc_help_kdb-plugin-check_md_autotoc_md1794}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-plugin-check_md_autotoc_md1795}{}\doxysection{R\+E\+T\+U\+R\+N V\+A\+L\+U\+ES}\label{doc_help_kdb-plugin-check_md_autotoc_md1795}
...
Since the error code is a return value, it is not automatically displayed to the shell. If the user wants to have the value printed, they must do so manually (by running a command such as {\ttfamily echo \$?}).\hypertarget{doc_help_kdb-plugin-check_md_autotoc_md1796}{}\doxysection{E\+X\+A\+M\+P\+L\+ES}\label{doc_help_kdb-plugin-check_md_autotoc_md1796}
...
To check the {\ttfamily line} plugin\+:~\newline
 {\ttfamily kdb plugin-\/check line}\hypertarget{doc_help_kdb-plugin-check_md_autotoc_md1797}{}\doxysection{S\+E\+E A\+L\+SO}\label{doc_help_kdb-plugin-check_md_autotoc_md1797}
