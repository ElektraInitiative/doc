...
\Hypertarget{doc_decisions_unit_testing_md_md_doc_decisions_unit_testing}%
 \hypertarget{doc_decisions_unit_testing_md_autotoc_md2204}{}\doxysection{Problem}\label{doc_decisions_unit_testing_md_autotoc_md2204}
The previous unit testing framework started as hack to have a bit more than simple asserts. It is not easy to use (needs explicit enumeration of all test cases) and lacks really important features (e.\+g. output of the assertion that failed).\hypertarget{doc_decisions_unit_testing_md_autotoc_md2205}{}\doxysection{Constraints}\label{doc_decisions_unit_testing_md_autotoc_md2205}
...
\item mocking?
\end{DoxyItemize}\hypertarget{doc_decisions_unit_testing_md_autotoc_md2206}{}\doxysection{Assumptions}\label{doc_decisions_unit_testing_md_autotoc_md2206}
\hypertarget{doc_decisions_unit_testing_md_autotoc_md2207}{}\doxysection{Considered Alternatives}\label{doc_decisions_unit_testing_md_autotoc_md2207}

\begin{DoxyItemize}
\item Continue with current framework
\item Boost Unit Testing framework
\end{DoxyItemize}\hypertarget{doc_decisions_unit_testing_md_autotoc_md2208}{}\doxysection{Decision}\label{doc_decisions_unit_testing_md_autotoc_md2208}
...
\end{DoxyItemize}\hypertarget{doc_decisions_unit_testing_md_autotoc_md2209}{}\doxysection{Rationale}\label{doc_decisions_unit_testing_md_autotoc_md2209}
...
\end{DoxyItemize}\hypertarget{doc_decisions_unit_testing_md_autotoc_md2210}{}\doxysection{Implications}\label{doc_decisions_unit_testing_md_autotoc_md2210}
...
\end{DoxyItemize}\hypertarget{doc_decisions_unit_testing_md_autotoc_md2211}{}\doxysection{Related Decisions}\label{doc_decisions_unit_testing_md_autotoc_md2211}

\begin{DoxyItemize}
\item \mbox{\hyperlink{doc_decisions_script_testing_md}{Script Testing}}
\end{DoxyItemize}\hypertarget{doc_decisions_unit_testing_md_autotoc_md2212}{}\doxysection{Notes}\label{doc_decisions_unit_testing_md_autotoc_md2212}
