...
The configuration view of elektra-\/web is similar to the tree view of the \href{https://master.libelektra.org/src/tools/qt-gui}{\texttt{ qt-\/gui}}, but with dynamic fields rendered via key metadata.\hypertarget{md_doc_tutorials_install_webui_autotoc_md4538}{}\doxysubsection{Dependencies}\label{md_doc_tutorials_install_webui_autotoc_md4538}
...
\end{DoxyItemize}\hypertarget{md_doc_tutorials_install_webui_autotoc_md4539}{}\doxysubsection{Building with elektra-\/web Tool}\label{md_doc_tutorials_install_webui_autotoc_md4539}
...
\end{DoxyItemize}\hypertarget{md_doc_tutorials_install_webui_autotoc_md4540}{}\doxysubsection{Getting Started (docker)}\label{md_doc_tutorials_install_webui_autotoc_md4540}
...
\end{DoxyItemize}\hypertarget{md_doc_tutorials_install_webui_autotoc_md4541}{}\doxysubsection{Running from source}\label{md_doc_tutorials_install_webui_autotoc_md4541}
...
\end{DoxyItemize}
\item You can now access the client on\+: \href{http://localhost:33334}{\texttt{ http\+://localhost\+:33334}}
\end{DoxyItemize}\hypertarget{md_doc_tutorials_install_webui_autotoc_md4542}{}\doxysubsection{Use-\/cases}\label{md_doc_tutorials_install_webui_autotoc_md4542}
\hypertarget{md_doc_tutorials_install_webui_autotoc_md4543}{}\doxysubsubsection{Running elektra-\/web on a Single Instance}\label{md_doc_tutorials_install_webui_autotoc_md4543}
...
Now, when you open \href{http://localhost:33334}{\texttt{ http\+://localhost\+:33334}} in your browser, the configuration page for the instance will be opened immediately.\hypertarget{md_doc_tutorials_install_webui_autotoc_md4544}{}\doxysubsection{Overview}\label{md_doc_tutorials_install_webui_autotoc_md4544}
...
\hypertarget{md_doc_tutorials_install_webui_autotoc_md4545}{}\doxysubsection{API}\label{md_doc_tutorials_install_webui_autotoc_md4545}
...
\end{DoxyItemize}\hypertarget{md_doc_tutorials_install_webui_autotoc_md4546}{}\doxysubsection{Test REST API on localhost}\label{md_doc_tutorials_install_webui_autotoc_md4546}
...
\end{DoxyCode}
\hypertarget{md_doc_tutorials_install_webui_autotoc_md4547}{}\doxysubsection{Auth}\label{md_doc_tutorials_install_webui_autotoc_md4547}
...
\end{DoxyItemize}\hypertarget{md_doc_tutorials_install_webui_autotoc_md4549}{}\doxysubsection{Development Guides}\label{md_doc_tutorials_install_webui_autotoc_md4549}
\hypertarget{md_doc_tutorials_install_webui_autotoc_md4550}{}\doxysubsubsection{Updating Dependencies}\label{md_doc_tutorials_install_webui_autotoc_md4550}
...
Check for outdated dependencies via {\ttfamily npm outdated}. Dependencies can then be updated by running {\ttfamily npm update}.\hypertarget{md_doc_tutorials_install_webui_autotoc_md4551}{}\doxysubsubsection{Building Docker Image}\label{md_doc_tutorials_install_webui_autotoc_md4551}
...
\end{DoxyCode}
\hypertarget{md_doc_tutorials_install_webui_autotoc_md4552}{}\doxysubsubsection{Adding Support for New Metadata}\label{md_doc_tutorials_install_webui_autotoc_md4552}
