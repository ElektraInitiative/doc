...
\item {\ttfamily fcrypt}.
\end{DoxyEnumerate}\hypertarget{doc_tutorials_crypto_md_autotoc_md2623}{}\doxysection{Prerequisites -\/ Gnu\+PG}\label{doc_tutorials_crypto_md_autotoc_md2623}
...
The {\ttfamily fcrypt} plugin and the {\ttfamily crypto} plugin support both versions (version 1 and version 2) of G\+PG.\hypertarget{doc_tutorials_crypto_md_autotoc_md2624}{}\doxysection{Introduction}\label{doc_tutorials_crypto_md_autotoc_md2624}
...
We also show how to approach integrity with the signature features of the {\ttfamily fcrypt} plugin.\hypertarget{doc_tutorials_crypto_md_autotoc_md2625}{}\doxysection{Configuration File Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md2625}
...
\DoxyCodeLine{kdb umount user/tests}
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md2626}{}\doxysection{Configuration File Signatures}\label{doc_tutorials_crypto_md_autotoc_md2626}
...
\DoxyCodeLine{kdb umount user/tests}
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md2627}{}\doxysubsection{Combining Signatures and Encryption}\label{doc_tutorials_crypto_md_autotoc_md2627}
...
\DoxyCodeLine{kdb umount user/tests}
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md2628}{}\doxysection{Configuration Value Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md2628}
...
As a result you get \char`\"{}1234\char`\"{}.\hypertarget{doc_tutorials_crypto_md_autotoc_md2630}{}\doxysubsection{Disabling Encryption}\label{doc_tutorials_crypto_md_autotoc_md2630}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md2631}{}\doxysubsection{Complete Example}\label{doc_tutorials_crypto_md_autotoc_md2631}
The complete example looks like this\+:
