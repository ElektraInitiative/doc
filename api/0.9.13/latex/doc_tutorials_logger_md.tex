...
\Hypertarget{doc_tutorials_logger_md_md_doc_tutorials_logger}%
 \hypertarget{doc_tutorials_logger_md_autotoc_md4345}{}\doxysection{Quickstart}\label{doc_tutorials_logger_md_autotoc_md4345}
...
The file sink behaves like syslog, if it has been enabled (see below).\hypertarget{doc_tutorials_logger_md_autotoc_md4346}{}\doxysection{Step by Step Guide}\label{doc_tutorials_logger_md_autotoc_md4346}
\hypertarget{doc_tutorials_logger_md_autotoc_md4347}{}\doxysubsection{Preparation}\label{doc_tutorials_logger_md_autotoc_md4347}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md4348}{}\doxysubsubsection{Log Everything}\label{doc_tutorials_logger_md_autotoc_md4348}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md4349}{}\doxysubsubsection{File Specific Logging}\label{doc_tutorials_logger_md_autotoc_md4349}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md4350}{}\doxysubsection{Enabling and Disabling Sinks}\label{doc_tutorials_logger_md_autotoc_md4350}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md4351}{}\doxysubsection{Compilation}\label{doc_tutorials_logger_md_autotoc_md4351}

\begin{DoxyEnumerate}
\item Enable the logger\+: e.\+g. run {\ttfamily cmake} with the switch {\ttfamily -\/DENABLE\+\_\+\+LOGGER=ON}
\item Build Elektra
\end{DoxyEnumerate}\hypertarget{doc_tutorials_logger_md_autotoc_md4352}{}\doxysection{Log Levels}\label{doc_tutorials_logger_md_autotoc_md4352}
