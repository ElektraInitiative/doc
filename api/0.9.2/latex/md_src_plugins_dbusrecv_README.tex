...
This plugin is a notification plugin, which receives a signal from D-\/\+Bus when the key database (K\+DB) has been modified. It is compatible with the sending D-\/\+Bus plugin.\hypertarget{md_src_plugins_dbusrecv_README_autotoc_md166}{}\doxysection{Dependencies}\label{md_src_plugins_dbusrecv_README_autotoc_md166}

\begin{DoxyItemize}
\item {\ttfamily libdbus-\/1-\/dev}
\end{DoxyItemize}\hypertarget{md_src_plugins_dbusrecv_README_autotoc_md167}{}\doxysection{Usage}\label{md_src_plugins_dbusrecv_README_autotoc_md167}
...
This plugin cannot be directly used to receive notifications. Applications that use the notification feature implicitly use it when this plugin is mounted globally.\hypertarget{md_src_plugins_dbusrecv_README_autotoc_md168}{}\doxysection{Transport Plugin}\label{md_src_plugins_dbusrecv_README_autotoc_md168}
