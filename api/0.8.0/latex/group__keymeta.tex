...
Get the group ID of a key.\hypertarget{group__keymeta_GID}{}\subsection{GID}\label{group__keymeta_GID}
...
Get the user ID of a key.\hypertarget{group__keymeta_UID}{}\subsection{UID}\label{group__keymeta_UID}
...
Reading the key means to get the value and comment by \hyperlink{group__kdb_ga28e385fd9cb7ccfe0b2f1ed2f62453a1}{kdbGet()} or all highlevel methods.
