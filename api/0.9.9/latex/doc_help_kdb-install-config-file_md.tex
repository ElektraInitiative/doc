...
\Hypertarget{doc_help_kdb-install-config-file_md_md_doc_help_kdb_install_config_file}%
 \hypertarget{doc_help_kdb-install-config-file_md_autotoc_md2546}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-install-config-file_md_autotoc_md2546}
...
The script has to be called as administrator (e.\+g. with {\ttfamily sudo}).\hypertarget{doc_help_kdb-install-config-file_md_autotoc_md2547}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-install-config-file_md_autotoc_md2547}
...
\end{DoxyEnumerate}\hypertarget{doc_help_kdb-install-config-file_md_autotoc_md2548}{}\doxysection{EXAMPLES}\label{doc_help_kdb-install-config-file_md_autotoc_md2548}
