...
This plugin allows you to read and write CSV files using Elektra. It aims to be compatible with RFC 4180. Rows and columns are written using Elektra\textquotesingle{}s arrays ({\ttfamily \#0}, {\ttfamily \#1},..). By configuring the plugin you can give columns a name.\hypertarget{md_src_plugins_csvstorage_README_autotoc_md115}{}\doxysection{Configuration}\label{md_src_plugins_csvstorage_README_autotoc_md115}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_src_plugins_csvstorage_README_autotoc_md116}{}\doxysection{Examples}\label{md_src_plugins_csvstorage_README_autotoc_md116}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_csvstorage_README_autotoc_md117}{}\doxysubsection{Usage}\label{md_src_plugins_csvstorage_README_autotoc_md117}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_csvstorage_README_autotoc_md118}{}\doxysection{Column as index}\label{md_src_plugins_csvstorage_README_autotoc_md118}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_csvstorage_README_autotoc_md119}{}\doxysection{Export filter}\label{md_src_plugins_csvstorage_README_autotoc_md119}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_csvstorage_README_autotoc_md120}{}\doxysubsection{Limitations}\label{md_src_plugins_csvstorage_README_autotoc_md120}
