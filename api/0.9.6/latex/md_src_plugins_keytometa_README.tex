...
The keys are ordered by the \char`\"{}order\char`\"{} metadata. If two keys are equal according to the order metadata, they are ordered by name instead.\hypertarget{md_src_plugins_keytometa_README_autotoc_md281}{}\doxysection{Installation}\label{md_src_plugins_keytometa_README_autotoc_md281}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/extra}.\hypertarget{md_src_plugins_keytometa_README_autotoc_md282}{}\doxysection{Append Strategies}\label{md_src_plugins_keytometa_README_autotoc_md282}
The append strategy specifies which key will receive the resulting metadata. Currently the plugin supports the following strategies\+:\hypertarget{md_src_plugins_keytometa_README_autotoc_md283}{}\doxysubsection{Parent Strategy}\label{md_src_plugins_keytometa_README_autotoc_md283}
...
If child1, child2 and child3 were tagged with {\ttfamily convert/append = parent}, key1 would receive the metadata from child1 and child3. Key2 would receive the metadata from child2.\hypertarget{md_src_plugins_keytometa_README_autotoc_md284}{}\doxysubsection{Next Strategy}\label{md_src_plugins_keytometa_README_autotoc_md284}
...
If key1 and key3 were tagged with {\ttfamily convert/append = next}, key2 would receive the metadata resulting from key1 and key4 would receive the metadata resulting from key3.\hypertarget{md_src_plugins_keytometa_README_autotoc_md285}{}\doxysubsection{Previous Strategy}\label{md_src_plugins_keytometa_README_autotoc_md285}
...
If key2 and key4 were tagged with {\ttfamily convert/append = previous}, key1 would receive the metadata resulting from key2 and key3 would receive the metadata resulting from key4.\hypertarget{md_src_plugins_keytometa_README_autotoc_md286}{}\doxysection{Merging}\label{md_src_plugins_keytometa_README_autotoc_md286}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_keytometa_README_autotoc_md287}{}\doxysubsection{Same-\/\+Level Appending}\label{md_src_plugins_keytometa_README_autotoc_md287}
...
\DoxyCodeLine{    \mbox{\hyperlink{group__key_gga9b703ca49f48b482def322b77d3e6bc8a040582834bb2d90049947d7ef74e87e2}{KEY\_META}}, \textcolor{stringliteral}{"{}convert/metaname"{}}, \textcolor{stringliteral}{"{}comment"{}},}
