...
\Hypertarget{doc_decisions_4_decided_header_file_structure_md_md_doc_decisions_4_decided_header_file_structure}%
 \hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2058}{}\doxysection{Problem}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2058}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2059}{}\doxysection{Constraints}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2059}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2060}{}\doxysection{Assumptions}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2060}
...
\end{DoxyEnumerate}
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2061}{}\doxysection{Considered Alternatives}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2061}
\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2062}{}\doxysection{Decision}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2062}
The decision is split into 4 subsections \char`\"{}\+Libraries\char`\"{}, \char`\"{}\+Plugins\char`\"{}, \char`\"{}\+Tools\char`\"{} and \char`\"{}\+Tests\char`\"{}, because the different parts of Elektra have different requirements.\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2063}{}\doxysubsection{Libraries}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2063}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2064}{}\doxysubsection{Plugins}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2064}
...
Importantly, however, headers belonging to plugins must not be used outside the plugin.\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2065}{}\doxysubsection{Tools}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2065}
...
Just like with plugins, the headers belonging to tools must not be used elsewhere.\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2066}{}\doxysubsection{Tests}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2066}
...
If a symbol is needed in only one file and for tests, option 1 should be preferred. For symbols that are used in multiple files, a header needs to exist anyway. In any case, these unit tests should not be installed and should statically link the library into the test executable. This way we don\textquotesingle{}t pollute our {\ttfamily symbols.\+map} files and keep the number of exported symbols down.\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2067}{}\doxysection{Rationale}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2067}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2068}{}\doxysection{Implications}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2068}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2069}{}\doxysection{Related Decisions}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2069}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_header_file_structure_md_autotoc_md2070}{}\doxysection{Notes}\label{doc_decisions_4_decided_header_file_structure_md_autotoc_md2070}
