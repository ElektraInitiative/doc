...
system:/sw/apache/httpd/#0/current/num\_processes
...
\begin{DoxyCode}
user:/
user:/env/#1/LD\_LIBRARY\_PATH
user:/sw/apps/abc/#0/current/default-setting
user:/sw/kde/kicker/#0/current/preferred\_applications/#0
\end{DoxyCode}
...
\item \href{/home/jenkins/workspace/libelektra-release/src/libs/elektra/keyname.c}{\tt key name source file} or \href{https://doc.libelektra.org/api/master/html/group__keyname.html#details}{\tt its rendered A\+PI documentation}
