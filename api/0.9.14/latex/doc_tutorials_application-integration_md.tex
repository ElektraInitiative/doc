...
\end{DoxyItemize}\hypertarget{doc_tutorials_application-integration_md_autotoc_md4194}{}\doxysection{Elektrify}\label{doc_tutorials_application-integration_md_autotoc_md4194}
...
For more information about that, continue reading \href{https://master.libelektra.org/src/tools/pythongen}{\texttt{ here}}.\hypertarget{doc_tutorials_application-integration_md_autotoc_md4197}{}\doxysection{Specification}\label{doc_tutorials_application-integration_md_autotoc_md4197}
...
To make this work within your application make sure to always call {\ttfamily ks\+Lookup} before using a value from Elektra.\hypertarget{doc_tutorials_application-integration_md_autotoc_md4199}{}\doxysubsection{Specfiles}\label{doc_tutorials_application-integration_md_autotoc_md4199}
