...
\begin{DoxyCodeInclude}
        Key * cutpoint = \hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{keyNew} (\textcolor{stringliteral}{"meta:/warnings"}, \hyperlink{group__key_gga9b703ca49f48b482def322b77d3e6bc8aa8adb6fcb92dec58fb19410eacfdd403}{KEY\_END});
        KeySet * warnings = \hyperlink{group__keyset_ga6b00cf82b59af4d883a9bad6cf4a4a4a}{ksCut} (\hyperlink{group__keymeta_ga11706f1753e67933f7cffc5c0345cd29}{keyMeta} (warningKey), cutpoint);

        \textcolor{keywordflow}{if} (!warningKey || \hyperlink{group__keyset_ga7474ad6b0a0fa969dbdf267ba5770eee}{ksGetSize} (warnings) == 0)
        \{
                \hyperlink{group__keyset_ga27e5c16473b02a422238c8d970db7ac8}{ksDel} (warnings);
                \hyperlink{group__key_ga3df95bbc2494e3e6703ece5639be5bb1}{keyDel} (cutpoint);
                \textcolor{keywordflow}{return} 1;
        \}

        printf (\textcolor{stringliteral}{"There are %zu warnings\(\backslash\)n"}, \hyperlink{group__keyset_ga7474ad6b0a0fa969dbdf267ba5770eee}{ksGetSize} (warnings));
        elektraCursor i = 1;
        \textcolor{keywordflow}{while} (i < \hyperlink{group__keyset_ga7474ad6b0a0fa969dbdf267ba5770eee}{ksGetSize} (warnings))
        \{
                ++i;
                Key * cur = \hyperlink{group__keyset_ga12b8fefaa20546e4790d60338b0db836}{ksAtCursor} (warnings, i);
                \textcolor{keywordflow}{while} (!\hyperlink{group__keytest_ga0150fb549225d8789e7297b919965e72}{keyIsDirectlyBelow} (cutpoint, cur))
                \{
                        printf (\textcolor{stringliteral}{"%s: %s\(\backslash\)n"}, \hyperlink{group__keyname_ga8e805c726a60da921d3736cda7813513}{keyName} (cur) + 
      \hyperlink{group__keyname_gabdbcfa51ed8a387e47ead207affa2d2e}{keyGetNameSize} (cutpoint), \hyperlink{group__keyvalue_ga880936f2481d28e6e2acbe7486a21d05}{keyString} (cur));
                        ++i;
                        cur = \hyperlink{group__keyset_ga12b8fefaa20546e4790d60338b0db836}{ksAtCursor} (warnings, i);
                \}
