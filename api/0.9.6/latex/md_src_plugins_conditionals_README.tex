...
This plugin uses if-\/then-\/else like conditions. It also works as global plugin.\hypertarget{md_src_plugins_conditionals_README_autotoc_md82}{}\doxysection{Installation}\label{md_src_plugins_conditionals_README_autotoc_md82}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/extra}.\hypertarget{md_src_plugins_conditionals_README_autotoc_md83}{}\doxysection{Check Syntax}\label{md_src_plugins_conditionals_README_autotoc_md83}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_conditionals_README_autotoc_md84}{}\doxysubsection{Testing if Key Exists}\label{md_src_plugins_conditionals_README_autotoc_md84}
{\ttfamily (! a/key)} evaluates to true if the key {\ttfamily a/key} doesn\textquotesingle{}t exist, to false if it exists.\hypertarget{md_src_plugins_conditionals_README_autotoc_md85}{}\doxysubsection{Assign Syntax}\label{md_src_plugins_conditionals_README_autotoc_md85}
...
\DoxyCodeLine{echo 'key1=val1'                                               >  `kdb file /tests/conditionals`}
\DoxyCodeLine{echo '[key1]'                                                    >> `kdb file /tests/conditionals`}
\DoxyCodeLine{echo "{}check/condition=(./ == 'val1') ? (../sub/key == 'true')"{} >> `kdb file /tests/conditionals`}
\DoxyCodeLine{}
\DoxyCodeLine{echo "{}key=false"{} > `kdb file /tests/conditionals/sub`}
\DoxyCodeLine{}
\DoxyCodeLine{\# should fail and yield an error}
\DoxyCodeLine{kdb export /tests/conditionals ni}
\DoxyCodeLine{\# ERROR:C03200}
...
\DoxyCodeLine{}
\DoxyCodeLine{kdb set /tests/conditionals/sub/key true}
\DoxyCodeLine{}
