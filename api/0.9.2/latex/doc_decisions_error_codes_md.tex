\hypertarget{doc_decisions_error_codes_md_autotoc_md1169}{}\doxysection{Problem}\label{doc_decisions_error_codes_md_autotoc_md1169}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_codes_md_autotoc_md1170}{}\doxysection{Constraints}\label{doc_decisions_error_codes_md_autotoc_md1170}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_codes_md_autotoc_md1171}{}\doxysection{Assumptions}\label{doc_decisions_error_codes_md_autotoc_md1171}
\hypertarget{doc_decisions_error_codes_md_autotoc_md1172}{}\doxysection{Considered Alternatives}\label{doc_decisions_error_codes_md_autotoc_md1172}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_codes_md_autotoc_md1173}{}\doxysection{Decision}\label{doc_decisions_error_codes_md_autotoc_md1173}
...
To see an explanation of the categories along with a guideline on how to categorize please see the \mbox{\hyperlink{doc_dev_error-categorization_md}{Error Codes Guideline}}\hypertarget{doc_decisions_error_codes_md_autotoc_md1174}{}\doxysection{Rationale}\label{doc_decisions_error_codes_md_autotoc_md1174}
...
These categories are chosen because they can help developers to react programmatically and cover the majority of use cases to our present knowledge. If there is ever the need for another reaction based category, it can be extended very easily.\hypertarget{doc_decisions_error_codes_md_autotoc_md1175}{}\doxysection{Implications}\label{doc_decisions_error_codes_md_autotoc_md1175}
...
Current errors will be migrated.\hypertarget{doc_decisions_error_codes_md_autotoc_md1176}{}\doxysection{Related Decisions}\label{doc_decisions_error_codes_md_autotoc_md1176}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_codes_md_autotoc_md1177}{}\doxysection{Notes}\label{doc_decisions_error_codes_md_autotoc_md1177}
