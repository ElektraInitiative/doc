...
\Hypertarget{doc_KEYNAMES_md_md_doc_KEYNAMES}%
 This document is a full explanation of how {\itshape key names} work in Elektra.\hypertarget{doc_KEYNAMES_md_autotoc_md2756}{}\doxysection{0. Reference Implementation}\label{doc_KEYNAMES_md_autotoc_md2756}
...
{\itshape To Elektra developers\+:} Feel free to add any unclear or previous incorrect examples to the test cases in \href{/home/jenkins/workspace/libelektra-release/tests/ctest/test_keyname.c}{\texttt{ tests/ctest/test\+\_\+keyname.\+c}}. These tests are very fast (1000+ test cases per second) and the more tests the better.\hypertarget{doc_KEYNAMES_md_autotoc_md2757}{}\doxysection{1. Key Name Parts and Namespaces}\label{doc_KEYNAMES_md_autotoc_md2757}
...
\hypertarget{doc_KEYNAMES_md_autotoc_md2758}{}\doxysubsection{1.\+1. Key Hierarchy}\label{doc_KEYNAMES_md_autotoc_md2758}
...
\hypertarget{doc_KEYNAMES_md_autotoc_md2759}{}\doxysubsubsection{1.\+1.\+1. The \char`\"{}is below\char`\"{} Relation}\label{doc_KEYNAMES_md_autotoc_md2759}
...
\hypertarget{doc_KEYNAMES_md_autotoc_md2760}{}\doxysubsubsection{1.\+1.\+2. The \char`\"{}parent\char`\"{} Confusion}\label{doc_KEYNAMES_md_autotoc_md2760}
...
There is also the term \char`\"{}(the) parent key\char`\"{}. In many cases, this is refers to a very specific key in the given context that is a \char`\"{}common parent\char`\"{} to a certain set of keys. If you are working within such a context, be careful about \char`\"{}a parent key\char`\"{} vs. \char`\"{}the parent key\char`\"{}.\hypertarget{doc_KEYNAMES_md_autotoc_md2761}{}\doxysubsection{1.\+2. Namespaces and Root Keys}\label{doc_KEYNAMES_md_autotoc_md2761}
...
To resolve the namespace, we just look at each of the namespaces in the ranking defined above. We then use the first namespace where the key actually exists. Namespace resolution is performed, when {\ttfamily ks\+Lookup}/{\ttfamily ks\+Lookup\+By\+Name} is called with a key name with namespace \char`\"{}cascading\char`\"{} \href{\#footnote-2}{\texttt{ \mbox{[}2\mbox{]}}}. \label{_ref-footnote-2}%
 This is also done, if you call {\ttfamily kdb get} or {\ttfamily kdb set} with a key name with namespace \char`\"{}cascading\char`\"{}.\hypertarget{doc_KEYNAMES_md_autotoc_md2762}{}\doxysection{2. Escaped Names}\label{doc_KEYNAMES_md_autotoc_md2762}
...
\end{longtabu}
\hypertarget{doc_KEYNAMES_md_autotoc_md2764}{}\doxysubsection{2.\+2. Other Escape Sequences}\label{doc_KEYNAMES_md_autotoc_md2764}
...
The characters in question are\+: {\ttfamily .}, {\ttfamily \#}, {\ttfamily \%}. The conditions under which these characters can be escaped can be found \href{\#4.1.-illegal-escape-sequences}{\texttt{ below}}.\hypertarget{doc_KEYNAMES_md_autotoc_md2765}{}\doxysection{3. Unescaped Names}\label{doc_KEYNAMES_md_autotoc_md2765}
...
\hypertarget{doc_KEYNAMES_md_autotoc_md2767}{}\doxysubsection{4.\+1. Illegal Escape Sequences}\label{doc_KEYNAMES_md_autotoc_md2767}
...
\end{longtabu}
\hypertarget{doc_KEYNAMES_md_autotoc_md2769}{}\doxysection{4.\+3. Reserved Key Names}\label{doc_KEYNAMES_md_autotoc_md2769}
