...
\item {\ttfamily fcrypt}.
\end{DoxyEnumerate}\hypertarget{doc_tutorials_crypto_md_autotoc_md4268}{}\doxysection{Prerequisites -\/ Gnu\+PG}\label{doc_tutorials_crypto_md_autotoc_md4268}
...
The {\ttfamily fcrypt} plugin and the {\ttfamily crypto} plugin support both versions (version 1 and version 2) of GPG.\hypertarget{doc_tutorials_crypto_md_autotoc_md4269}{}\doxysection{Introduction}\label{doc_tutorials_crypto_md_autotoc_md4269}
...
We also show how to approach integrity with the signature features of the {\ttfamily fcrypt} plugin.\hypertarget{doc_tutorials_crypto_md_autotoc_md4270}{}\doxysection{Configuration File Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md4270}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md4271}{}\doxysection{Configuration File Signatures}\label{doc_tutorials_crypto_md_autotoc_md4271}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md4272}{}\doxysubsection{Combining Signatures and Encryption}\label{doc_tutorials_crypto_md_autotoc_md4272}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md4273}{}\doxysection{Configuration Value Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md4273}
...
As a result you get \char`\"{}1234\char`\"{}.\hypertarget{doc_tutorials_crypto_md_autotoc_md4275}{}\doxysubsection{Disabling Encryption}\label{doc_tutorials_crypto_md_autotoc_md4275}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md4276}{}\doxysubsection{Complete Example}\label{doc_tutorials_crypto_md_autotoc_md4276}
The complete example looks like this\+:
