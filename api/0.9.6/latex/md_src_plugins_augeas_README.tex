...
This is because {\ttfamily ld} tries to link {\ttfamily /usr/lib/libaugeas.so.\+0} which is an older version of Augeas. Simply add the path to the newer library to your ld search paths (consult your system documentation on how to do this).\hypertarget{md_src_plugins_augeas_README_autotoc_md46}{}\doxysection{Mounting and Configuration}\label{md_src_plugins_augeas_README_autotoc_md46}
...
This happens because the plugin does not know which lens it should use to read and write the configuration. For that reason, the lens configuration option was supplied together with the mount command.\hypertarget{md_src_plugins_augeas_README_autotoc_md47}{}\doxysection{Restrictions}\label{md_src_plugins_augeas_README_autotoc_md47}
\hypertarget{md_src_plugins_augeas_README_autotoc_md48}{}\doxysubsection{Inner Node Values}\label{md_src_plugins_augeas_README_autotoc_md48}
...
The operation simply fails with an undescriptive error.\hypertarget{md_src_plugins_augeas_README_autotoc_md49}{}\doxysubsection{Leaky Abstraction of Order}\label{md_src_plugins_augeas_README_autotoc_md49}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_augeas_README_autotoc_md50}{}\doxysection{Planned Improvements}\label{md_src_plugins_augeas_README_autotoc_md50}
