...
\Hypertarget{doc_decisions_2_solutions_clear_simplify_api_md_md_doc_decisions_2_solutions_clear_simplify_api}%
 \hypertarget{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2017}{}\doxysection{Problem}\label{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2017}
...
The urgency of this decision is that API can be easily introduced later but we cannot get rid of it after 1.\+0.\hypertarget{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2018}{}\doxysection{Constraints}\label{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2018}

\begin{DoxyItemize}
\item To not disturb main features as described in use cases.
\end{DoxyItemize}\hypertarget{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2019}{}\doxysection{Assumptions}\label{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2019}
...
\end{DoxyItemize}\hypertarget{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2020}{}\doxysection{Considered Alternatives}\label{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2020}

\begin{DoxyItemize}
\item flags for binary data
\end{DoxyItemize}\hypertarget{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2021}{}\doxysection{Decision}\label{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2021}
...
\end{DoxyItemize}\hypertarget{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2022}{}\doxysection{Rationale}\label{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2022}
\hypertarget{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2023}{}\doxysection{Implications}\label{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2023}
\hypertarget{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2024}{}\doxysection{Related Decisions}\label{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2024}
...
\end{DoxyItemize}\hypertarget{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2025}{}\doxysection{Notes}\label{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2025}
