...
\Hypertarget{doc_decisions_boolean_md_md_doc_decisions_boolean}%
 \hypertarget{doc_decisions_boolean_md_autotoc_md1681}{}\doxysection{Problem}\label{doc_decisions_boolean_md_autotoc_md1681}
Inconsistent use of booleans in various parts of Elektra.\hypertarget{doc_decisions_boolean_md_autotoc_md1682}{}\doxysection{Constraints}\label{doc_decisions_boolean_md_autotoc_md1682}

\begin{DoxyItemize}
\item needs to be string
\end{DoxyItemize}\hypertarget{doc_decisions_boolean_md_autotoc_md1683}{}\doxysection{Assumptions}\label{doc_decisions_boolean_md_autotoc_md1683}
\hypertarget{doc_decisions_boolean_md_autotoc_md1684}{}\doxysection{Considered Alternatives}\label{doc_decisions_boolean_md_autotoc_md1684}
...
\end{DoxyItemize}\hypertarget{doc_decisions_boolean_md_autotoc_md1685}{}\doxysection{Decision}\label{doc_decisions_boolean_md_autotoc_md1685}
...
\end{DoxyItemize}\hypertarget{doc_decisions_boolean_md_autotoc_md1686}{}\doxysection{Rationale}\label{doc_decisions_boolean_md_autotoc_md1686}

\begin{DoxyItemize}
\item most easy to implement
\item allows non-\/presence to be false
\item plugins allow us to convert to any other behavior
\end{DoxyItemize}\hypertarget{doc_decisions_boolean_md_autotoc_md1687}{}\doxysection{Implications}\label{doc_decisions_boolean_md_autotoc_md1687}
...
\end{DoxyItemize}\hypertarget{doc_decisions_boolean_md_autotoc_md1688}{}\doxysection{Related Decisions}\label{doc_decisions_boolean_md_autotoc_md1688}
\hypertarget{doc_decisions_boolean_md_autotoc_md1689}{}\doxysection{Notes}\label{doc_decisions_boolean_md_autotoc_md1689}
