\hypertarget{autotoc_md555_src_plugins_reference_examples_complex_README_md}{}\section{Example\+: Validating Complex Recursive Structures}\label{autotoc_md555_src_plugins_reference_examples_complex_README_md}
