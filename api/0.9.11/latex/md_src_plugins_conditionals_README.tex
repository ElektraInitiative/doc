...
This plugin uses if-\/then-\/else like conditions. It also works as global plugin.\hypertarget{md_src_plugins_conditionals_README_autotoc_md92}{}\doxysection{Installation}\label{md_src_plugins_conditionals_README_autotoc_md92}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/extra}.\hypertarget{md_src_plugins_conditionals_README_autotoc_md93}{}\doxysection{Check Syntax}\label{md_src_plugins_conditionals_README_autotoc_md93}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_conditionals_README_autotoc_md94}{}\doxysubsection{Testing if Key Exists}\label{md_src_plugins_conditionals_README_autotoc_md94}
{\ttfamily (! a/key)} evaluates to true if the key {\ttfamily a/key} doesn\textquotesingle{}t exist, to false if it exists.\hypertarget{md_src_plugins_conditionals_README_autotoc_md95}{}\doxysubsection{Assign Syntax}\label{md_src_plugins_conditionals_README_autotoc_md95}
