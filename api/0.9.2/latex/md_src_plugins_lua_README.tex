...
What a Lua script can do is not really limited by design, so any kind of plugin may be implemented. The lua plugin is especially useful to write filter and logging scripts.\hypertarget{md_src_plugins_lua_README_autotoc_md393}{}\doxysection{Usage}\label{md_src_plugins_lua_README_autotoc_md393}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_lua_README_autotoc_md394}{}\doxysubsection{Lua Scripts}\label{md_src_plugins_lua_README_autotoc_md394}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_lua_README_autotoc_md395}{}\doxysection{Example}\label{md_src_plugins_lua_README_autotoc_md395}
...
Further examples can be found in the lua directory.\hypertarget{md_src_plugins_lua_README_autotoc_md396}{}\doxysection{Disclaimer}\label{md_src_plugins_lua_README_autotoc_md396}
