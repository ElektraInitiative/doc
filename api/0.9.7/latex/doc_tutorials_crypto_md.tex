...
\item {\ttfamily fcrypt}.
\end{DoxyEnumerate}\hypertarget{doc_tutorials_crypto_md_autotoc_md3531}{}\doxysection{Prerequisites -\/ Gnu\+PG}\label{doc_tutorials_crypto_md_autotoc_md3531}
...
The {\ttfamily fcrypt} plugin and the {\ttfamily crypto} plugin support both versions (version 1 and version 2) of GPG.\hypertarget{doc_tutorials_crypto_md_autotoc_md3532}{}\doxysection{Introduction}\label{doc_tutorials_crypto_md_autotoc_md3532}
...
We also show how to approach integrity with the signature features of the {\ttfamily fcrypt} plugin.\hypertarget{doc_tutorials_crypto_md_autotoc_md3533}{}\doxysection{Configuration File Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md3533}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3534}{}\doxysection{Configuration File Signatures}\label{doc_tutorials_crypto_md_autotoc_md3534}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3535}{}\doxysubsection{Combining Signatures and Encryption}\label{doc_tutorials_crypto_md_autotoc_md3535}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3536}{}\doxysection{Configuration Value Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md3536}
...
As a result you get \char`\"{}1234\char`\"{}.\hypertarget{doc_tutorials_crypto_md_autotoc_md3538}{}\doxysubsection{Disabling Encryption}\label{doc_tutorials_crypto_md_autotoc_md3538}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3539}{}\doxysubsection{Complete Example}\label{doc_tutorials_crypto_md_autotoc_md3539}
The complete example looks like this\+:
