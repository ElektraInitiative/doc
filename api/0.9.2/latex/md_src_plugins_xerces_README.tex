...
\end{DoxyItemize}\hypertarget{md_src_plugins_xerces_README_autotoc_md719}{}\doxysection{Usage}\label{md_src_plugins_xerces_README_autotoc_md719}
...
The root element of the resulting X\+ML file will be \char`\"{}xerces\char`\"{} again, restored via the metadata. If you don\textquotesingle{}t want this behavior, delete the metadata {\ttfamily xerces/rootname} on the mount point, then it uses the mount point\textquotesingle{}s name instead.\hypertarget{md_src_plugins_xerces_README_autotoc_md720}{}\doxysection{Dependencies}\label{md_src_plugins_xerces_README_autotoc_md720}
...
To include this plugin in a homebrew installation run {\ttfamily brew tap elektrainitiative/elektra} followed by {\ttfamily brew install elektrainitiative/elektra/elektra -\/-\/with-\/xerces}\hypertarget{md_src_plugins_xerces_README_autotoc_md721}{}\doxysection{Limitations}\label{md_src_plugins_xerces_README_autotoc_md721}
...
X\+SD transformations, schemas or D\+T\+Ds are not supported yet.\hypertarget{md_src_plugins_xerces_README_autotoc_md722}{}\doxysection{Examples}\label{md_src_plugins_xerces_README_autotoc_md722}
\hypertarget{md_src_plugins_xerces_README_autotoc_md723}{}\doxysubsection{Mounting, setting a key and exporting}\label{md_src_plugins_xerces_README_autotoc_md723}
