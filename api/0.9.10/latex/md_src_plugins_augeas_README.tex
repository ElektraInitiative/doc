...
\end{DoxyCode}
\hypertarget{md_src_plugins_augeas_README_autotoc_md47}{}\doxysection{Restrictions}\label{md_src_plugins_augeas_README_autotoc_md47}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_augeas_README_autotoc_md49}{}\doxysubsection{Leaky Abstraction of Order}\label{md_src_plugins_augeas_README_autotoc_md49}
