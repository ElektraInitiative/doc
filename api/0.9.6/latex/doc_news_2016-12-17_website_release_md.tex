...
\end{DoxyItemize}\hypertarget{doc_news_2016-12-17_website_release_md_autotoc_md2830}{}\doxysection{Highlight}\label{doc_news_2016-12-17_website_release_md_autotoc_md2830}
...
\end{DoxyEnumerate}\hypertarget{doc_news_2016-12-17_website_release_md_autotoc_md2831}{}\doxysection{Introduction}\label{doc_news_2016-12-17_website_release_md_autotoc_md2831}
...
But sharing of snippets does not only help other users, it can help yourself as well because you can search for them easier. You also have access to the snippets in various formats at any time, allowing you to use them across multiple system by mounting them with the \href{https://master.libelektra.org/src/plugins/curlget}{\texttt{ curlget}} resolver!\hypertarget{doc_news_2016-12-17_website_release_md_autotoc_md2832}{}\doxysection{The Website}\label{doc_news_2016-12-17_website_release_md_autotoc_md2832}
The website was written by Marvin Mall in the course of his \href{https://www.libelektra.org/ftp/elektra/mall2016rest.pdf}{\texttt{ bachelor thesis}} as part of the front-\/end he developed for his snippet sharing service. His main goals were to create a proper appearance for Elektra, but also to create a platform that promotes his service. We think that this worked out quite well by connecting the website with the service the way it was done.\hypertarget{doc_news_2016-12-17_website_release_md_autotoc_md2833}{}\doxysubsection{Documentation}\label{doc_news_2016-12-17_website_release_md_autotoc_md2833}
...
If you are interested in the techniques we use to structure our files, you can have a look at the website readme. The website is already the fourth view of our markdown pages! The others are man pages, doxygen, and github.\hypertarget{doc_news_2016-12-17_website_release_md_autotoc_md2834}{}\doxysubsection{Homepage \& News}\label{doc_news_2016-12-17_website_release_md_autotoc_md2834}
...
We hope that you enjoy our new appearance as much as we do!\hypertarget{doc_news_2016-12-17_website_release_md_autotoc_md2835}{}\doxysubsection{Snippet Sharing}\label{doc_news_2016-12-17_website_release_md_autotoc_md2835}
...
Snippets shared with the service are \href{https://www.libelektra.org/devgettingstarted/license}{\texttt{ BSD licensed}}. The snippets can also be downloaded directly as bundle from a separate \href{https://github.com/ElektraInitiative/snippets}{\texttt{ Git\+Hub repository}}. As soon as a snippet is added, changed or deleted on the website, a job that updates the repository is triggered. So you can expect the repository to be always up-\/to-\/date.\hypertarget{doc_news_2016-12-17_website_release_md_autotoc_md2836}{}\doxysubsection{No\+Script}\label{doc_news_2016-12-17_website_release_md_autotoc_md2836}
...
\end{DoxyEnumerate}\hypertarget{doc_news_2016-12-17_website_release_md_autotoc_md2837}{}\doxysection{Domains}\label{doc_news_2016-12-17_website_release_md_autotoc_md2837}
...
The old Wordpress installation was shut down because of security concerns.\hypertarget{doc_news_2016-12-17_website_release_md_autotoc_md2838}{}\doxysection{Feedback}\label{doc_news_2016-12-17_website_release_md_autotoc_md2838}
At this point there is not much more to say about the new website except for\+: Feel free to explore it!

We greatly appreciate all feedback, be it for the website, the snippet sharing service or other parts of the Elektra project. We always have an open ear for suggestions and we also like to help with technical issues, simply \href{https://bugs.libelektra.org}{\texttt{ leave us a note on github}}!\hypertarget{doc_news_2016-12-17_website_release_md_autotoc_md2839}{}\doxysection{Stay tuned!}\label{doc_news_2016-12-17_website_release_md_autotoc_md2839}
