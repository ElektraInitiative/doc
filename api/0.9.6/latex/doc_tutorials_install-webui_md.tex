...
The configuration view of elektra-\/web is similar to the tree view of the \href{https://master.libelektra.org/src/tools/qt-gui}{\texttt{ qt-\/gui}}, but with dynamic fields rendered via key metadata.\hypertarget{doc_tutorials_install-webui_md_autotoc_md3563}{}\doxysection{Dependencies}\label{doc_tutorials_install-webui_md_autotoc_md3563}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3564}{}\doxysection{Building with elektra-\/web Tool}\label{doc_tutorials_install-webui_md_autotoc_md3564}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3565}{}\doxysection{Getting Started}\label{doc_tutorials_install-webui_md_autotoc_md3565}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3566}{}\doxysection{Getting Started (docker)}\label{doc_tutorials_install-webui_md_autotoc_md3566}

\begin{DoxyItemize}
\item Create and run a new docker container\+: {\ttfamily docker run -\/d -\/it -\/p 33333\+:33333 -\/p 33334\+:33334 elektra/web}
\item You can now access the client on\+: \href{http://localhost:33334}{\texttt{ http\+://localhost\+:33334}}
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3567}{}\doxysection{Running from source}\label{doc_tutorials_install-webui_md_autotoc_md3567}
...
\end{DoxyItemize}
\item You can now access the client on\+: \href{http://localhost:33334}{\texttt{ http\+://localhost\+:33334}}
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3568}{}\doxysection{Use-\/cases}\label{doc_tutorials_install-webui_md_autotoc_md3568}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3569}{}\doxysubsection{Running elektra-\/web on a Single Instance}\label{doc_tutorials_install-webui_md_autotoc_md3569}
...
Now, when you open \href{http://localhost:33334}{\texttt{ http\+://localhost\+:33334}} in your browser, the configuration page for the instance will be opened immediately.\hypertarget{doc_tutorials_install-webui_md_autotoc_md3570}{}\doxysubsection{Using a Different $<$tt$>$kdb$<$/tt$>$ Executable}\label{doc_tutorials_install-webui_md_autotoc_md3570}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3571}{}\doxysection{Overview}\label{doc_tutorials_install-webui_md_autotoc_md3571}
...
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3572}{}\doxysection{API}\label{doc_tutorials_install-webui_md_autotoc_md3572}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3573}{}\doxysection{Test REST API on localhost}\label{doc_tutorials_install-webui_md_autotoc_md3573}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3574}{}\doxysection{Auth}\label{doc_tutorials_install-webui_md_autotoc_md3574}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3576}{}\doxysection{Development Guides}\label{doc_tutorials_install-webui_md_autotoc_md3576}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3577}{}\doxysubsection{Updating Dependencies}\label{doc_tutorials_install-webui_md_autotoc_md3577}
...
Check for outdated dependencies via {\ttfamily npm outdated}. Dependencies can then be updated by running {\ttfamily npm update}.\hypertarget{doc_tutorials_install-webui_md_autotoc_md3578}{}\doxysubsection{Building Docker Image}\label{doc_tutorials_install-webui_md_autotoc_md3578}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3579}{}\doxysubsection{Adding Support for New Metadata}\label{doc_tutorials_install-webui_md_autotoc_md3579}
