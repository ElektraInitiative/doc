\label{doc_usecases_elektra_web_UC_setup_instance_md_md_doc_usecases_elektra_web_UC_setup_instance}%
\Hypertarget{doc_usecases_elektra_web_UC_setup_instance_md_md_doc_usecases_elektra_web_UC_setup_instance}%
 \hypertarget{doc_usecases_elektra_web_UC_setup_instance_md_autotoc_md3776}{}\doxysection{Summary}\label{doc_usecases_elektra_web_UC_setup_instance_md_autotoc_md3776}
...
\end{DoxyItemize}\hypertarget{doc_usecases_elektra_web_UC_setup_instance_md_autotoc_md3777}{}\doxysection{Scenarios}\label{doc_usecases_elektra_web_UC_setup_instance_md_autotoc_md3777}

\begin{DoxyItemize}
\item {\bfseries{Main success scenario\+:}} User successfully sets up elektrad on the instance and connects it to elektra-\/web.
\item {\bfseries{Alternative scenario\+:}} Authentication issues when connecting the services, e.\+g. wrong API key.
