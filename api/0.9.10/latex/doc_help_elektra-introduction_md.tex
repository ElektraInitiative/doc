...
Information on Elektra can be found on the \href{https://www.libelektra.org}{\texttt{ website}}. For introduction in the terminology, make sure to read \mbox{\hyperlink{doc_help_elektra-glossary_md}{the glossary}}.\hypertarget{doc_help_elektra-introduction_md_autotoc_md2394}{}\doxysection{Motivation}\label{doc_help_elektra-introduction_md_autotoc_md2394}
\hypertarget{doc_help_elektra-introduction_md_autotoc_md2395}{}\doxysubsection{Why Elektra?}\label{doc_help_elektra-introduction_md_autotoc_md2395}
...
For further views see \mbox{\hyperlink{doc_WHY_md}{why Elektra}}\hypertarget{doc_help_elektra-introduction_md_autotoc_md2396}{}\doxysubsection{Why Is It Important?}\label{doc_help_elektra-introduction_md_autotoc_md2396}
...
To support a global key database, a mutual agreement on some level is needed. Elektra provides this common layer with its data structures. Each elektrified application lies on top of this abstraction layer and it can talk to each part of the global key database using the classes presented next.\hypertarget{doc_help_elektra-introduction_md_autotoc_md2397}{}\doxysubsection{SEE ALSO}\label{doc_help_elektra-introduction_md_autotoc_md2397}
