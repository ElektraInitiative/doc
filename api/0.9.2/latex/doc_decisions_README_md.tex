...
To add a new decision copy {\ttfamily template.\+md} and add a link in the appropriate section here.\hypertarget{doc_decisions_README_md_autotoc_md1311}{}\doxysection{Implemented}\label{doc_decisions_README_md_autotoc_md1311}
...
\item \mbox{\hyperlink{doc_decisions_high_level_api_md}{High Level A\+PI}}
\end{DoxyItemize}\hypertarget{doc_decisions_README_md_autotoc_md1312}{}\doxysection{Decided}\label{doc_decisions_README_md_autotoc_md1312}
...
\end{DoxyItemize}\hypertarget{doc_decisions_README_md_autotoc_md1313}{}\doxysection{In Discussion}\label{doc_decisions_README_md_autotoc_md1313}
...
\end{DoxyItemize}\hypertarget{doc_decisions_README_md_autotoc_md1314}{}\doxysection{Rejected}\label{doc_decisions_README_md_autotoc_md1314}
...
\end{DoxyItemize}\hypertarget{doc_decisions_README_md_autotoc_md1315}{}\doxysection{Drafts}\label{doc_decisions_README_md_autotoc_md1315}
