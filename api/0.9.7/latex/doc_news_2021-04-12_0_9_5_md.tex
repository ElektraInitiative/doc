...
We are proud to release Elektra 0.\+9.\+5.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3302}{}\doxysection{What is Elektra?}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3302}
...
You can try out the latest Elektra release using our docker image \href{https://hub.docker.com/r/elektra/elektra}{\texttt{ elektra/elektra}}. This is the quickest way to get started with Elektra without compiling and other obstacles, simply run {\ttfamily docker run -\/it elektra/elektra}.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3303}{}\doxysection{Highlights}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3303}
...
\label{_hl-1}%
\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3304}{}\doxysubsection{$<$tt$>$kdb\+Open$<$/tt$>$ Contracts}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3304}
...
For more information take a look at \mbox{\hyperlink{doc_dev_kdb-contracts_md}{doc/dev/kdb-\/contracts.md}}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3305}{}\doxysection{Plugins}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3305}
The following section lists news about the \href{https://www.libelektra.org/plugins/readme}{\texttt{ plugins}} we updated in this release.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3306}{}\doxysubsection{Cache}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3306}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3307}{}\doxysubsection{internalnotification}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3307}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3308}{}\doxysubsection{Dbus \& Dbusrecv}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3308}

\begin{DoxyItemize}
\item Internal changes to ensure compatibility with the new {\ttfamily elektra\+Notification\+Contract}. \+\_\+(Klemens Böswirth)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3309}{}\doxysubsection{YAML Smith \& Yan LR}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3309}

\begin{DoxyItemize}
\item Removed plugins {\ttfamily yamlsmith} and {\ttfamily yanlr}. \+\_\+(René Schwaiger)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3310}{}\doxysubsection{Zeromqsend \& Zeromqrecv}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3310}

\begin{DoxyItemize}
\item Internal changes to ensure compatibility with the new {\ttfamily elektra\+Notification\+Contract}. \+\_\+(Klemens Böswirth)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3311}{}\doxysection{Libraries}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3311}
The text below summarizes updates to the \href{https://www.libelektra.org/libraries/readme}{\texttt{ C (and C++)-\/based libraries}} of Elektra.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3312}{}\doxysubsection{Compatibility}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3312}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3313}{}\doxysubsection{Core}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3313}
\label{_key-copy}%
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3314}{}\doxysubsection{Io}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3314}

\begin{DoxyItemize}
\item {\ttfamily elektra\+Set\+Io\+Binding} has been removed. Use {\ttfamily elektra\+Io\+Contract} instead. \+\_\+(Klemens Böswirth)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3315}{}\doxysubsection{Notification}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3315}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3316}{}\doxysection{Bindings}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3316}
Bindings allow you to utilize Elektra using \href{https://www.libelektra.org/bindings/readme}{\texttt{ various programming languages}}. This section keeps you up to date with the multi-\/language support provided by Elektra.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3317}{}\doxysubsection{JNA}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3317}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3318}{}\doxysubsubsection{Outlook}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3318}
Ongoing work on bringing the JNA binding up to scratch and improving developer experience. Both for JNA binding API consumers, as well as future JNA binding contrubutors. \+\_\+(\+Michael Tucek)\+\_\+\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3319}{}\doxysubsection{Python \& Lua}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3319}
Add support for keyset.\+remove(key). \+\_\+(\+Manuel Mausz)\+\_\+\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3320}{}\doxysection{Tools}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3320}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3321}{}\doxysection{Examples}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3321}

\begin{DoxyItemize}
\item Fix enums in examples/spec. \+\_\+(\+Markus Raab)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3322}{}\doxysection{Documentation}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3322}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3323}{}\doxysection{Tests}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3323}

\begin{DoxyItemize}
\item Added small test for jna Return plugin ({\ttfamily Return.\+java}), {\ttfamily Key\+Name\+Iterator.\+java} \+\_\+(@aaronabebe)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3324}{}\doxysection{Packaging}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3324}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3325}{}\doxysection{Build}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3325}
\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3326}{}\doxysubsection{CMake}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3326}

\begin{DoxyItemize}
\item Fix issue where the library runpaths of the jni plugin could not be resolved. \+\_\+(\+Robert Sowula)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3327}{}\doxysubsection{Docker}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3327}

\begin{DoxyItemize}
\item Update Alpine Linux images to version 3.\+13.\+1 and update Elektra release image. \+\_\+(Mihael Pranjić)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3328}{}\doxysection{Infrastructure}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3328}
\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3329}{}\doxysubsection{Cirrus}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3329}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3330}{}\doxysubsection{Git\+Hub Actions}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3330}

\begin{DoxyItemize}
\item Fix issues with {\ttfamily dbus} and java paths, exclude {\ttfamily jni}. \+\_\+(Mihael Pranjić)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3331}{}\doxysubsection{Jenkins}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3331}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3332}{}\doxysection{Website}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3332}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3333}{}\doxysection{Outlook}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3333}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3334}{}\doxysection{Statistics}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3334}
...
Thanks to all authors for making this release possible!\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3335}{}\doxysection{Join the Initiative!}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3335}
...
As first step, you could give us feedback about these release notes. Contact us via our \href{https://issues.libelektra.org}{\texttt{ issue tracker}}.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3336}{}\doxysection{Get the Release!}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3336}
...
Already built API-\/\+Docu can be found \href{https://doc.libelektra.org/api/0.9.5/html/}{\texttt{ here}} or on \href{https://github.com/ElektraInitiative/doc/tree/master/api/0.9.5}{\texttt{ Git\+Hub}}.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3337}{}\doxysection{Stay tuned!}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3337}
