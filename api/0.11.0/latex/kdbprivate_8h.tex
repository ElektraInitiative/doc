...
\begin{DoxyCompactItemize}
\item 
struct \+\_\+\+Elektra\+Diff $\ast$ \mbox{\hyperlink{kdbprivate_8h_a787071deee24cac14b7b3bae48ca7580}{elektra\+Diff\+New}} (Key\+Set $\ast$added\+Keys, Key\+Set $\ast$removed\+Keys, Key\+Set $\ast$modified\+Keys, Key\+Set $\ast$modified\+New\+Keys, Key $\ast$parent\+Key)
\begin{DoxyCompactList}\small\item\em Create an Elektra\+Diff. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Remove all the keys in {\ttfamily sub} from {\ttfamily total}. \end{DoxyCompactList}\item 
...
\mbox{\Hypertarget{kdbprivate_8h_a787071deee24cac14b7b3bae48ca7580}\label{kdbprivate_8h_a787071deee24cac14b7b3bae48ca7580}} 
...
{\footnotesize\ttfamily struct \+\_\+\+Elektra\+Diff$\ast$ elektra\+Diff\+New (\begin{DoxyParamCaption}\item[{Key\+Set $\ast$}]{added\+Keys,  }\item[{Key\+Set $\ast$}]{removed\+Keys,  }\item[{Key\+Set $\ast$}]{modified\+Keys,  }\item[{Key\+Set $\ast$}]{modified\+New\+Keys,  }\item[{Key $\ast$}]{parent\+Key }\end{DoxyParamCaption})}



Create an Elektra\+Diff. 
...
Same goes for the parent key, please use {\ttfamily key\+Inc\+Ref} if you plan to use it after deleting the Elektra\+Diff
...
\hline
{\em modified\+Keys} & the modified keys \\
\hline
{\em modified\+New\+Keys} & the modified keys with the new values \\
\hline
