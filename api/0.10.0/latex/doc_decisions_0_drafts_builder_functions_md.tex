...
\Hypertarget{doc_decisions_0_drafts_builder_functions_md_md_doc_decisions_0_drafts_builder_functions}%
 \hypertarget{doc_decisions_0_drafts_builder_functions_md_autotoc_md1714}{}\doxysection{Problem}\label{doc_decisions_0_drafts_builder_functions_md_autotoc_md1714}
...
We call these functions \char`\"{}builder functions\char`\"{} compared to the \mbox{\hyperlink{doc_decisions_0_drafts_constructor_functions_md}{Constructor Functions for {\ttfamily Key} and {\ttfamily Key\+Set}}}constructor functions\char`\"{}\char`\"{} in {\ttfamily libelektra-\/core}.\hypertarget{doc_decisions_0_drafts_builder_functions_md_autotoc_md1715}{}\doxysection{Constraints}\label{doc_decisions_0_drafts_builder_functions_md_autotoc_md1715}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0_drafts_builder_functions_md_autotoc_md1716}{}\doxysection{Assumptions}\label{doc_decisions_0_drafts_builder_functions_md_autotoc_md1716}
\hypertarget{doc_decisions_0_drafts_builder_functions_md_autotoc_md1717}{}\doxysection{Considered Alternatives}\label{doc_decisions_0_drafts_builder_functions_md_autotoc_md1717}
\hypertarget{doc_decisions_0_drafts_builder_functions_md_autotoc_md1718}{}\doxysubsection{Language Agnostic}\label{doc_decisions_0_drafts_builder_functions_md_autotoc_md1718}
\begin{quote}
...
One neat benefit of this solution is that these simple functions can be called from any language.\hypertarget{doc_decisions_0_drafts_builder_functions_md_autotoc_md1719}{}\doxysubsection{Variadic Arguments}\label{doc_decisions_0_drafts_builder_functions_md_autotoc_md1719}
...
Compared to the language agnostic version, this loose type safety and doesn\textquotesingle{}t really provide any advantages. Separating the keyname parts into separate arguments could also be done in the language agnostic version, by using an array {\ttfamily const char $\ast$ parts\mbox{[}\mbox{]}} inside the {\ttfamily Key\+Name} struct.\hypertarget{doc_decisions_0_drafts_builder_functions_md_autotoc_md1720}{}\doxysubsection{Macros and Bindings}\label{doc_decisions_0_drafts_builder_functions_md_autotoc_md1720}
...
\end{DoxyCode}
\hypertarget{doc_decisions_0_drafts_builder_functions_md_autotoc_md1721}{}\doxysection{Decision}\label{doc_decisions_0_drafts_builder_functions_md_autotoc_md1721}
\hypertarget{doc_decisions_0_drafts_builder_functions_md_autotoc_md1722}{}\doxysection{Rationale}\label{doc_decisions_0_drafts_builder_functions_md_autotoc_md1722}
\hypertarget{doc_decisions_0_drafts_builder_functions_md_autotoc_md1723}{}\doxysection{Implications}\label{doc_decisions_0_drafts_builder_functions_md_autotoc_md1723}

\begin{DoxyItemize}
\item 
\item 
\item 
\end{DoxyItemize}\hypertarget{doc_decisions_0_drafts_builder_functions_md_autotoc_md1724}{}\doxysection{Related Decisions}\label{doc_decisions_0_drafts_builder_functions_md_autotoc_md1724}

\begin{DoxyItemize}
\item \mbox{[}\mbox{]}(doc\+\_\+decisions\+\_\+0\+\_\+drafts\+\_\+\+\_\+\+README\+\_\+md)
\item \mbox{[}\mbox{]}(doc\+\_\+decisions\+\_\+0\+\_\+drafts\+\_\+\+\_\+\+README\+\_\+md)
\item \mbox{[}\mbox{]}(doc\+\_\+decisions\+\_\+0\+\_\+drafts\+\_\+\+\_\+\+README\+\_\+md)
\end{DoxyItemize}\hypertarget{doc_decisions_0_drafts_builder_functions_md_autotoc_md1725}{}\doxysection{Notes}\label{doc_decisions_0_drafts_builder_functions_md_autotoc_md1725}
