...
\Hypertarget{doc_decisions_5_partially_implemented_array_md_md_doc_decisions_5_partially_implemented_array}%
 \hypertarget{doc_decisions_5_partially_implemented_array_md_autotoc_md2162}{}\doxysection{Problem}\label{doc_decisions_5_partially_implemented_array_md_autotoc_md2162}
Currently it is inefficient to detect the length of an array and it is impossible to know if a key (without subkeys) should be an array or not.\hypertarget{doc_decisions_5_partially_implemented_array_md_autotoc_md2163}{}\doxysection{Constraints}\label{doc_decisions_5_partially_implemented_array_md_autotoc_md2163}

\begin{DoxyItemize}
\item None
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_array_md_autotoc_md2164}{}\doxysection{Assumptions}\label{doc_decisions_5_partially_implemented_array_md_autotoc_md2164}
\hypertarget{doc_decisions_5_partially_implemented_array_md_autotoc_md2165}{}\doxysection{Considered Alternatives}\label{doc_decisions_5_partially_implemented_array_md_autotoc_md2165}
...
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_array_md_autotoc_md2166}{}\doxysection{Decision}\label{doc_decisions_5_partially_implemented_array_md_autotoc_md2166}
...
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_array_md_autotoc_md2167}{}\doxysection{Rationale}\label{doc_decisions_5_partially_implemented_array_md_autotoc_md2167}
...
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_array_md_autotoc_md2168}{}\doxysection{Implications}\label{doc_decisions_5_partially_implemented_array_md_autotoc_md2168}
...
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_array_md_autotoc_md2169}{}\doxysection{Related Decisions}\label{doc_decisions_5_partially_implemented_array_md_autotoc_md2169}
...
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_array_md_autotoc_md2170}{}\doxysection{Notes}\label{doc_decisions_5_partially_implemented_array_md_autotoc_md2170}
