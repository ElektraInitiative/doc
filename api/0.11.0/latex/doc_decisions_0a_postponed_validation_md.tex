...
\Hypertarget{doc_decisions_0a_postponed_validation_md_md_doc_decisions_0a_postponed_validation}%
 \hypertarget{doc_decisions_0a_postponed_validation_md_autotoc_md1878}{}\doxysection{Problem}\label{doc_decisions_0a_postponed_validation_md_autotoc_md1878}
...
If validation of a key fails, each plugin decides on its own how to handle the issue and proceed in ways that might be different from what is expected or desired.\hypertarget{doc_decisions_0a_postponed_validation_md_autotoc_md1879}{}\doxysection{Constraints}\label{doc_decisions_0a_postponed_validation_md_autotoc_md1879}
\hypertarget{doc_decisions_0a_postponed_validation_md_autotoc_md1880}{}\doxysection{Assumptions}\label{doc_decisions_0a_postponed_validation_md_autotoc_md1880}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0a_postponed_validation_md_autotoc_md1881}{}\doxysection{Considered Alternatives}\label{doc_decisions_0a_postponed_validation_md_autotoc_md1881}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0a_postponed_validation_md_autotoc_md1882}{}\doxysection{Decision}\label{doc_decisions_0a_postponed_validation_md_autotoc_md1882}
Don\textquotesingle{}t do anything for 1.\+0.

Later, maybe introduce a wrapper plugin to iterate over the keyset and delegate the validation of each key to the corresponding validation plugin.\hypertarget{doc_decisions_0a_postponed_validation_md_autotoc_md1883}{}\doxysection{Rationale}\label{doc_decisions_0a_postponed_validation_md_autotoc_md1883}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0a_postponed_validation_md_autotoc_md1884}{}\doxysection{Implications}\label{doc_decisions_0a_postponed_validation_md_autotoc_md1884}
...
Returning 1 if validation succeeded, 0 on failure\hypertarget{doc_decisions_0a_postponed_validation_md_autotoc_md1885}{}\doxysection{Related Decisions}\label{doc_decisions_0a_postponed_validation_md_autotoc_md1885}
\hypertarget{doc_decisions_0a_postponed_validation_md_autotoc_md1886}{}\doxysection{Notes}\label{doc_decisions_0a_postponed_validation_md_autotoc_md1886}
