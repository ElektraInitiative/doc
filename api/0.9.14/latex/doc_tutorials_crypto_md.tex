...
\item {\ttfamily fcrypt}.
\end{DoxyEnumerate}\hypertarget{doc_tutorials_crypto_md_autotoc_md4281}{}\doxysection{Prerequisites -\/ Gnu\+PG}\label{doc_tutorials_crypto_md_autotoc_md4281}
...
The {\ttfamily fcrypt} plugin and the {\ttfamily crypto} plugin support both versions (version 1 and version 2) of GPG.\hypertarget{doc_tutorials_crypto_md_autotoc_md4282}{}\doxysection{Introduction}\label{doc_tutorials_crypto_md_autotoc_md4282}
...
We also show how to approach integrity with the signature features of the {\ttfamily fcrypt} plugin.\hypertarget{doc_tutorials_crypto_md_autotoc_md4283}{}\doxysection{Configuration File Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md4283}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md4284}{}\doxysection{Configuration File Signatures}\label{doc_tutorials_crypto_md_autotoc_md4284}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md4285}{}\doxysubsection{Combining Signatures and Encryption}\label{doc_tutorials_crypto_md_autotoc_md4285}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md4286}{}\doxysection{Configuration Value Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md4286}
...
As a result you get \char`\"{}1234\char`\"{}.\hypertarget{doc_tutorials_crypto_md_autotoc_md4288}{}\doxysubsection{Disabling Encryption}\label{doc_tutorials_crypto_md_autotoc_md4288}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md4289}{}\doxysubsection{Complete Example}\label{doc_tutorials_crypto_md_autotoc_md4289}
The complete example looks like this\+:
