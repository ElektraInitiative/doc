\hypertarget{group__highlevel}{}\doxysection{High-\/level API}
...
Key $\ast$ \mbox{\hyperlink{group__highlevel_gac822ee43ab690e671ed47129a8b47cdc}{elektra\+Find\+Array\+Element\+Key}} (Elektra $\ast$elektra, const char $\ast$name, kdb\+\_\+long\+\_\+long\+\_\+t index, KDBType type)
...
KDBType \mbox{\hyperlink{group__highlevel_ga295b4302c968c7285bc4dc1307c0e2cf}{elektra\+Get\+Array\+Element\+Type}} (Elektra $\ast$elektra, const char $\ast$keyname, kdb\+\_\+long\+\_\+long\+\_\+t index)
...
void \mbox{\hyperlink{group__highlevel_ga965e0b2ce7d5e8938965259c3f584600}{elektra\+Set\+Raw\+String\+Array\+Element}} (Elektra $\ast$elektra, const char $\ast$name, kdb\+\_\+long\+\_\+long\+\_\+t index, const char $\ast$value, KDBType type, Elektra\+Error $\ast$$\ast$error)
...
\begin{DoxyCompactList}\small\item\em Frees the memory used by the error and sets the referenced error variable to NULL. \end{DoxyCompactList}\item 
...
\mbox{\Hypertarget{group__highlevel_ga582eae2b8293ab18ebe4451c92858389}\label{group__highlevel_ga582eae2b8293ab18ebe4451c92858389}} 
\index{High-\/level API@{High-\/level API}!checkSpec@{checkSpec}}
\index{checkSpec@{checkSpec}!High-\/level API@{High-\/level API}}
\doxysubsubsection{\texorpdfstring{checkSpec()}{checkSpec()}}
{\footnotesize\ttfamily kdb\+\_\+boolean\+\_\+t check\+Spec (\begin{DoxyParamCaption}\item[{Key $\ast$const}]{parent\+Key,  }\item[{Key\+Set $\ast$}]{contract,  }\item[{Elektra\+Error $\ast$$\ast$}]{error }\end{DoxyParamCaption})}
...
{\em parent\+Key} & The parent\+Key of the application \\
\hline
{\em contract} & The contract passed to HL API by the application. \\
\hline
{\em error} & Pointer used to report errors \\
\hline
\end{DoxyParams}

\begin{DoxyRetVals}{Return values}
{\em True} & if the checks were successful (or not required). \\
\hline
{\em False} & if the checks were required but unsuccessful. \\
\hline
\end{DoxyRetVals}
...
If \mbox{\hyperlink{group__highlevel_ga22c0775760a9f42f29337c06bf8b2ab5}{elektra\+Error\+Code()}} is called on the resulting struct, it will return NULL.
...
{\footnotesize\ttfamily Key $\ast$ elektra\+Find\+Array\+Element\+Key (\begin{DoxyParamCaption}\item[{Elektra $\ast$}]{elektra,  }\item[{const char $\ast$}]{name,  }\item[{kdb\+\_\+long\+\_\+long\+\_\+t}]{index,  }\item[{KDBType}]{type }\end{DoxyParamCaption})}



Helper function for code generation. 

Finds an array element Key from its relative name and index. Also checks type metadata, if {\ttfamily type} is not NULL.
...
{\footnotesize\ttfamily Key $\ast$ elektra\+Find\+Key (\begin{DoxyParamCaption}\item[{Elektra $\ast$}]{elektra,  }\item[{const char $\ast$}]{name,  }\item[{KDBType}]{type }\end{DoxyParamCaption})}



Helper function for code generation. 

Finds a Key from its relative name. Also checks type metadata, if {\ttfamily type} is not NULL.
...
{\footnotesize\ttfamily KDBType elektra\+Get\+Array\+Element\+Type (\begin{DoxyParamCaption}\item[{Elektra $\ast$}]{elektra,  }\item[{const char $\ast$}]{keyname,  }\item[{kdb\+\_\+long\+\_\+long\+\_\+t}]{index }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily KDBType elektra\+Get\+Type (\begin{DoxyParamCaption}\item[{Elektra $\ast$}]{elektra,  }\item[{const char $\ast$}]{keyname }\end{DoxyParamCaption})}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
the help key if found, NULL otherwise The pointer returned may become invalid, when any {\ttfamily elektra\+Set$\ast$()} function or any other function that modifies the state of {\ttfamily elektra} is called. It will always become invalid, when \mbox{\hyperlink{group__highlevel_ga9b688b7250e5f9d8ea6701cc2cc269af}{elektra\+Close()}} is called on {\ttfamily elektra}. 
\end{DoxyReturn}
...
\begin{DoxyParams}{Parameters}
{\em application} & Your application\textquotesingle{}s base name. The simplest version for this string is \char`\"{}/sw/org/$<$appname$>$/\#0/current\char`\"{}, where \textquotesingle{}$<$appname$>$\textquotesingle{} is a unique name for your application. For more information see the man-\/page elektra-\/key-\/names(7). \\
\hline
{\em defaults} & A Key\+Set containing default values. If you pass NULL, trying to read a non-\/existent value will cause a fatal error. It is recommended, to only pass NULL, if you are using a specification, which provides default values inside of the KDB. If a key in this Key\+Set doesn\textquotesingle{}t have a value, we will use the value of the \char`\"{}default\char`\"{} metakey of this key. \\
\hline
{\em contract} & Will be passed to \mbox{\hyperlink{group__kdb_ga844e1299a84c3fbf1d3a905c5c893ba5}{kdb\+Open()}} as the contract. \\
\hline
...
\mbox{\hyperlink{group__kdb_ga844e1299a84c3fbf1d3a905c5c893ba5}{kdb\+Open}} 
\end{DoxySeeAlso}
...
{\footnotesize\ttfamily void elektra\+Set\+Raw\+String (\begin{DoxyParamCaption}\item[{Elektra $\ast$}]{elektra,  }\item[{const char $\ast$}]{name,  }\item[{const char $\ast$}]{value,  }\item[{KDBType}]{type,  }\item[{Elektra\+Error $\ast$$\ast$}]{error }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily void elektra\+Set\+Raw\+String\+Array\+Element (\begin{DoxyParamCaption}\item[{Elektra $\ast$}]{elektra,  }\item[{const char $\ast$}]{name,  }\item[{kdb\+\_\+long\+\_\+long\+\_\+t}]{index,  }\item[{const char $\ast$}]{value,  }\item[{KDBType}]{type,  }\item[{Elektra\+Error $\ast$$\ast$}]{error }\end{DoxyParamCaption})}
