...
\Hypertarget{doc_decisions_error_code_implementation_md_md_doc_decisions_error_code_implementation}%
 \hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1803}{}\doxysection{Problem}\label{doc_decisions_error_code_implementation_md_autotoc_md1803}
In the previous error concept it was very useful to generate macros as we often added new errors. The code generation itself, however, was not ideal for cross compilation.\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1804}{}\doxysection{Constraints}\label{doc_decisions_error_code_implementation_md_autotoc_md1804}
\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1805}{}\doxysection{Assumptions}\label{doc_decisions_error_code_implementation_md_autotoc_md1805}

\begin{DoxyItemize}
\item Error codes do not change very often
\end{DoxyItemize}\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1806}{}\doxysection{Considered Alternatives}\label{doc_decisions_error_code_implementation_md_autotoc_md1806}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1807}{}\doxysection{Decision}\label{doc_decisions_error_code_implementation_md_autotoc_md1807}
...
When adding a new error code, language bindings have to be adapted accordingly such as the Rust or Java Binding.\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1808}{}\doxysection{Rationale}\label{doc_decisions_error_code_implementation_md_autotoc_md1808}

\begin{DoxyItemize}
\item Updates to error codes will imply syncing every binding. This though should happen in very rare circumstances.
\end{DoxyItemize}\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1809}{}\doxysection{Implications}\label{doc_decisions_error_code_implementation_md_autotoc_md1809}

\begin{DoxyItemize}
\item The current bindings stay untouched
\item Tutorial on how to write a binding should be written
\end{DoxyItemize}\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1810}{}\doxysection{Related Decisions}\label{doc_decisions_error_code_implementation_md_autotoc_md1810}
\hypertarget{doc_decisions_error_code_implementation_md_autotoc_md1811}{}\doxysection{Notes}\label{doc_decisions_error_code_implementation_md_autotoc_md1811}
