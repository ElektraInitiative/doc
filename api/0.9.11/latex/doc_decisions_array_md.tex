...
\Hypertarget{doc_decisions_array_md_md_doc_decisions_array}%
 \hypertarget{doc_decisions_array_md_autotoc_md1668}{}\doxysection{Problem}\label{doc_decisions_array_md_autotoc_md1668}
Currently it is inefficient to detect the length of an array and it is impossible to know if a key (without subkeys) should be an array or not.\hypertarget{doc_decisions_array_md_autotoc_md1669}{}\doxysection{Constraints}\label{doc_decisions_array_md_autotoc_md1669}

\begin{DoxyItemize}
\item None
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1670}{}\doxysection{Assumptions}\label{doc_decisions_array_md_autotoc_md1670}
\hypertarget{doc_decisions_array_md_autotoc_md1671}{}\doxysection{Considered Alternatives}\label{doc_decisions_array_md_autotoc_md1671}
...
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1672}{}\doxysection{Decision}\label{doc_decisions_array_md_autotoc_md1672}
...
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1673}{}\doxysection{Rationale}\label{doc_decisions_array_md_autotoc_md1673}
...
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1674}{}\doxysection{Implications}\label{doc_decisions_array_md_autotoc_md1674}
...
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1675}{}\doxysection{Related Decisions}\label{doc_decisions_array_md_autotoc_md1675}
...
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1676}{}\doxysection{Notes}\label{doc_decisions_array_md_autotoc_md1676}
