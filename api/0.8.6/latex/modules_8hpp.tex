...
\begin{center}
\leavevmode
\includegraphics[width=238pt]{modules_8hpp__dep__incl}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em Allows to load plugins. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Allows to load plugins. \begin{DoxyCopyright}{Copyright}
