...
\Hypertarget{doc_decisions_escaped_name_md_md_doc_decisions_escaped_name}%
 \hypertarget{doc_decisions_escaped_name_md_autotoc_md1825}{}\doxysection{Problem}\label{doc_decisions_escaped_name_md_autotoc_md1825}
Currently we store both the escaped and unescaped name in a Key and in a way that there cannot be an optimization not to store it (there are functions handling out the pointer).\hypertarget{doc_decisions_escaped_name_md_autotoc_md1826}{}\doxysection{Constraints}\label{doc_decisions_escaped_name_md_autotoc_md1826}

\begin{DoxyItemize}
\item allow implementations of Elektra to not store two names
\end{DoxyItemize}\hypertarget{doc_decisions_escaped_name_md_autotoc_md1827}{}\doxysection{Assumptions}\label{doc_decisions_escaped_name_md_autotoc_md1827}

\begin{DoxyItemize}
\item the memory consumption of storing the name twice is considerable
\end{DoxyItemize}\hypertarget{doc_decisions_escaped_name_md_autotoc_md1828}{}\doxysection{Considered Alternatives}\label{doc_decisions_escaped_name_md_autotoc_md1828}

\begin{DoxyItemize}
\item store it twice
\item store it once but in one memory block
\end{DoxyItemize}\hypertarget{doc_decisions_escaped_name_md_autotoc_md1829}{}\doxysection{Decision}\label{doc_decisions_escaped_name_md_autotoc_md1829}
...
\end{DoxyItemize}\hypertarget{doc_decisions_escaped_name_md_autotoc_md1830}{}\doxysection{Rationale}\label{doc_decisions_escaped_name_md_autotoc_md1830}
\hypertarget{doc_decisions_escaped_name_md_autotoc_md1831}{}\doxysection{Implications}\label{doc_decisions_escaped_name_md_autotoc_md1831}
...
\end{DoxyItemize}\hypertarget{doc_decisions_escaped_name_md_autotoc_md1832}{}\doxysection{Related Decisions}\label{doc_decisions_escaped_name_md_autotoc_md1832}
\hypertarget{doc_decisions_escaped_name_md_autotoc_md1833}{}\doxysection{Notes}\label{doc_decisions_escaped_name_md_autotoc_md1833}
