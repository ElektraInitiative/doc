...
\Hypertarget{doc_help_elektra-spec_md_md_doc_help_elektra_spec}%
 \hypertarget{doc_help_elektra-spec_md_autotoc_md2281}{}\doxysection{INTRODUCTION}\label{doc_help_elektra-spec_md_autotoc_md2281}
...
It is, however, not limited to this but can express any other key database semantics (new plugins might be necessary, though).\hypertarget{doc_help_elektra-spec_md_autotoc_md2282}{}\doxysection{Application}\label{doc_help_elektra-spec_md_autotoc_md2282}
...
So Keys in {\ttfamily spec} allow us to specify which keys are read by the application. The description key will be copied (referred to) to {\ttfamily folder/anotherkey} of any namespace, so that it can easily be accessed.\hypertarget{doc_help_elektra-spec_md_autotoc_md2283}{}\doxysection{Cascading Lookup}\label{doc_help_elektra-spec_md_autotoc_md2283}
...
Note that the fallback, override and cascading works on {\itshape key level}, and not like most other systems have implemented, on configuration {\itshape file level}.\hypertarget{doc_help_elektra-spec_md_autotoc_md2284}{}\doxysection{Validation}\label{doc_help_elektra-spec_md_autotoc_md2284}
...
\end{DoxyCode}
\hypertarget{doc_help_elektra-spec_md_autotoc_md2285}{}\doxysection{Mounting}\label{doc_help_elektra-spec_md_autotoc_md2285}
...
\end{DoxyCode}
\hypertarget{doc_help_elektra-spec_md_autotoc_md2286}{}\doxysection{SEE ALSO}\label{doc_help_elektra-spec_md_autotoc_md2286}
