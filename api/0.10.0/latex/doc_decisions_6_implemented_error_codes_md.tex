...
\Hypertarget{doc_decisions_6_implemented_error_codes_md_md_doc_decisions_6_implemented_error_codes}%
 \hypertarget{doc_decisions_6_implemented_error_codes_md_autotoc_md2360}{}\doxysection{Problem}\label{doc_decisions_6_implemented_error_codes_md_autotoc_md2360}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_error_codes_md_autotoc_md2361}{}\doxysection{Constraints}\label{doc_decisions_6_implemented_error_codes_md_autotoc_md2361}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_error_codes_md_autotoc_md2362}{}\doxysection{Assumptions}\label{doc_decisions_6_implemented_error_codes_md_autotoc_md2362}
\hypertarget{doc_decisions_6_implemented_error_codes_md_autotoc_md2363}{}\doxysection{Considered Alternatives}\label{doc_decisions_6_implemented_error_codes_md_autotoc_md2363}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_error_codes_md_autotoc_md2364}{}\doxysection{Decision}\label{doc_decisions_6_implemented_error_codes_md_autotoc_md2364}
...
To see an explanation of the categories along with a guideline on how to categorize please see the \mbox{\hyperlink{doc_dev_error-categorization_md}{Error Codes Guideline}}\hypertarget{doc_decisions_6_implemented_error_codes_md_autotoc_md2365}{}\doxysection{Rationale}\label{doc_decisions_6_implemented_error_codes_md_autotoc_md2365}
...
These categories are chosen because they can help developers to react programmatically and cover the majority of use cases to our present knowledge. If there is ever the need for another reaction based category, it can be extended very easily.\hypertarget{doc_decisions_6_implemented_error_codes_md_autotoc_md2366}{}\doxysection{Implications}\label{doc_decisions_6_implemented_error_codes_md_autotoc_md2366}
...
Current errors will be migrated.\hypertarget{doc_decisions_6_implemented_error_codes_md_autotoc_md2367}{}\doxysection{Related Decisions}\label{doc_decisions_6_implemented_error_codes_md_autotoc_md2367}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_error_codes_md_autotoc_md2368}{}\doxysection{Notes}\label{doc_decisions_6_implemented_error_codes_md_autotoc_md2368}
