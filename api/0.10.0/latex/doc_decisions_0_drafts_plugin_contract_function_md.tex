...
\Hypertarget{doc_decisions_0_drafts_plugin_contract_function_md_md_doc_decisions_0_drafts_plugin_contract_function}%
 \hypertarget{doc_decisions_0_drafts_plugin_contract_function_md_autotoc_md1795}{}\doxysection{Problem}\label{doc_decisions_0_drafts_plugin_contract_function_md_autotoc_md1795}
...
Additionally, the actual public API exported from shared library to make it a plugin is the {\ttfamily ELEKTRA\+\_\+\+PLUGIN\+\_\+\+EXPORT} function. This function always calls {\ttfamily elektra\+Plugin\+Export}, which allocates and half initializes a {\ttfamily struct \+\_\+\+Plugin}. Specifically, only the {\ttfamily name} field and the {\ttfamily kdb$\ast$} function pointers are set. This same information is also provided via the contract. The function pointers are all listed in {\ttfamily system\+:/elektra/modules/$<$plugin$>$/exports/$\ast$} and the {\ttfamily $<$plugin$>$} part of the name is the {\ttfamily name} of the plugin.\hypertarget{doc_decisions_0_drafts_plugin_contract_function_md_autotoc_md1796}{}\doxysection{Constraints}\label{doc_decisions_0_drafts_plugin_contract_function_md_autotoc_md1796}
\hypertarget{doc_decisions_0_drafts_plugin_contract_function_md_autotoc_md1797}{}\doxysection{Assumptions}\label{doc_decisions_0_drafts_plugin_contract_function_md_autotoc_md1797}
\hypertarget{doc_decisions_0_drafts_plugin_contract_function_md_autotoc_md1798}{}\doxysection{Considered Alternatives}\label{doc_decisions_0_drafts_plugin_contract_function_md_autotoc_md1798}
...
\hypertarget{doc_decisions_0_drafts_plugin_contract_function_md_autotoc_md1799}{}\doxysection{Decision}\label{doc_decisions_0_drafts_plugin_contract_function_md_autotoc_md1799}
\hypertarget{doc_decisions_0_drafts_plugin_contract_function_md_autotoc_md1800}{}\doxysection{Rationale}\label{doc_decisions_0_drafts_plugin_contract_function_md_autotoc_md1800}
\hypertarget{doc_decisions_0_drafts_plugin_contract_function_md_autotoc_md1801}{}\doxysection{Implications}\label{doc_decisions_0_drafts_plugin_contract_function_md_autotoc_md1801}
\hypertarget{doc_decisions_0_drafts_plugin_contract_function_md_autotoc_md1802}{}\doxysection{Related Decisions}\label{doc_decisions_0_drafts_plugin_contract_function_md_autotoc_md1802}
...
\end{DoxyItemize}\hypertarget{doc_decisions_0_drafts_plugin_contract_function_md_autotoc_md1803}{}\doxysection{Notes}\label{doc_decisions_0_drafts_plugin_contract_function_md_autotoc_md1803}
