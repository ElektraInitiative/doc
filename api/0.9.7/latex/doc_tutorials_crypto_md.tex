...
\item {\ttfamily fcrypt}.
\end{DoxyEnumerate}\hypertarget{doc_tutorials_crypto_md_autotoc_md3569}{}\doxysection{Prerequisites -\/ Gnu\+PG}\label{doc_tutorials_crypto_md_autotoc_md3569}
...
The {\ttfamily fcrypt} plugin and the {\ttfamily crypto} plugin support both versions (version 1 and version 2) of GPG.\hypertarget{doc_tutorials_crypto_md_autotoc_md3570}{}\doxysection{Introduction}\label{doc_tutorials_crypto_md_autotoc_md3570}
...
We also show how to approach integrity with the signature features of the {\ttfamily fcrypt} plugin.\hypertarget{doc_tutorials_crypto_md_autotoc_md3571}{}\doxysection{Configuration File Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md3571}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3572}{}\doxysection{Configuration File Signatures}\label{doc_tutorials_crypto_md_autotoc_md3572}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3573}{}\doxysubsection{Combining Signatures and Encryption}\label{doc_tutorials_crypto_md_autotoc_md3573}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3574}{}\doxysection{Configuration Value Encryption/\+Decryption}\label{doc_tutorials_crypto_md_autotoc_md3574}
...
As a result you get \char`\"{}1234\char`\"{}.\hypertarget{doc_tutorials_crypto_md_autotoc_md3576}{}\doxysubsection{Disabling Encryption}\label{doc_tutorials_crypto_md_autotoc_md3576}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_crypto_md_autotoc_md3577}{}\doxysubsection{Complete Example}\label{doc_tutorials_crypto_md_autotoc_md3577}
The complete example looks like this\+:
