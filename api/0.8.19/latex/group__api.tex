...
\hline
\end{DoxyRetVals}
\hypertarget{group__api_ga6e151fb2c313e51d2a1a20588fc9aa92}{\index{A\+P\+I Proposals for Elektra@{A\+P\+I Proposals for Elektra}!key\+Rel2@{key\+Rel2}}
\index{key\+Rel2@{key\+Rel2}!A\+P\+I Proposals for Elektra@{A\+P\+I Proposals for Elektra}}
\subsubsection[{key\+Rel2}]{\setlength{\rightskip}{0pt plus 5cm}int key\+Rel2 (
\begin{DoxyParamCaption}
\item[{const Key $\ast$}]{key, }
\item[{const Key $\ast$}]{check, }
\item[{Key\+Rel\+Type}]{which}
\end{DoxyParamCaption}
)}}\label{group__api_ga6e151fb2c313e51d2a1a20588fc9aa92}
