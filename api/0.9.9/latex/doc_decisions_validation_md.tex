...
\Hypertarget{doc_decisions_validation_md_md_doc_decisions_validation}%
 \hypertarget{doc_decisions_validation_md_autotoc_md2178}{}\doxysection{Problem}\label{doc_decisions_validation_md_autotoc_md2178}
...
If validation of a key fails, each plugin decides on its own how to handle the issue and proceed in ways that might be different from what is expected or desired.\hypertarget{doc_decisions_validation_md_autotoc_md2179}{}\doxysection{Constraints}\label{doc_decisions_validation_md_autotoc_md2179}
\hypertarget{doc_decisions_validation_md_autotoc_md2180}{}\doxysection{Assumptions}\label{doc_decisions_validation_md_autotoc_md2180}
...
\end{DoxyItemize}\hypertarget{doc_decisions_validation_md_autotoc_md2181}{}\doxysection{Considered Alternatives}\label{doc_decisions_validation_md_autotoc_md2181}
...
\end{DoxyItemize}\hypertarget{doc_decisions_validation_md_autotoc_md2182}{}\doxysection{Decision}\label{doc_decisions_validation_md_autotoc_md2182}
Use a wrapper plugin to iterate over the keyset and delegate the validation of each key to the corresponding validation plugin.\hypertarget{doc_decisions_validation_md_autotoc_md2183}{}\doxysection{Rationale}\label{doc_decisions_validation_md_autotoc_md2183}
...
\end{DoxyItemize}\hypertarget{doc_decisions_validation_md_autotoc_md2184}{}\doxysection{Implications}\label{doc_decisions_validation_md_autotoc_md2184}
...
returning 1 if validation succeeded, 0 on failure\hypertarget{doc_decisions_validation_md_autotoc_md2185}{}\doxysection{Related Decisions}\label{doc_decisions_validation_md_autotoc_md2185}
\hypertarget{doc_decisions_validation_md_autotoc_md2186}{}\doxysection{Notes}\label{doc_decisions_validation_md_autotoc_md2186}
