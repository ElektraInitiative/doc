...
The configuration view of elektra-\/web is similar to the tree view of the \href{https://master.libelektra.org/src/tools/qt-gui}{\texttt{ qt-\/gui}}, but with dynamic fields rendered via key metadata.\hypertarget{doc_tutorials_install-webui_md_autotoc_md2659}{}\doxysection{Dependencies}\label{doc_tutorials_install-webui_md_autotoc_md2659}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md2660}{}\doxysection{Building with elektra-\/web Tool}\label{doc_tutorials_install-webui_md_autotoc_md2660}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md2661}{}\doxysection{Getting Started}\label{doc_tutorials_install-webui_md_autotoc_md2661}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md2662}{}\doxysection{Getting Started (docker)}\label{doc_tutorials_install-webui_md_autotoc_md2662}

\begin{DoxyItemize}
\item Create and run a new docker container\+: {\ttfamily docker run -\/d -\/it -\/p 33333\+:33333 -\/p 33334\+:33334 elektra/web}
\item You can now access the client on\+: \href{http://localhost:33334}{\texttt{ http\+://localhost\+:33334}}
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md2663}{}\doxysection{Running from source}\label{doc_tutorials_install-webui_md_autotoc_md2663}
...
\end{DoxyItemize}
\item You can now access the client on\+: \href{http://localhost:33334}{\texttt{ http\+://localhost\+:33334}}
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md2664}{}\doxysection{Use-\/cases}\label{doc_tutorials_install-webui_md_autotoc_md2664}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md2665}{}\doxysubsection{Running elektra-\/web on a Single Instance}\label{doc_tutorials_install-webui_md_autotoc_md2665}
...
Now, when you open \href{http://localhost:33334}{\texttt{ http\+://localhost\+:33334}} in your browser, the configuration page for the instance will be opened immediately.\hypertarget{doc_tutorials_install-webui_md_autotoc_md2666}{}\doxysubsection{Using a Different $<$tt$>$kdb$<$/tt$>$ Executable}\label{doc_tutorials_install-webui_md_autotoc_md2666}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md2667}{}\doxysection{Overview}\label{doc_tutorials_install-webui_md_autotoc_md2667}
...
\hypertarget{doc_tutorials_install-webui_md_autotoc_md2668}{}\doxysection{A\+PI}\label{doc_tutorials_install-webui_md_autotoc_md2668}


\href{https://apiblueprint.org/}{\texttt{ A\+PI blueprints}} are available for both A\+P\+Is\+:
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md2669}{}\doxysection{Test R\+E\+S\+T A\+P\+I on localhost}\label{doc_tutorials_install-webui_md_autotoc_md2669}
...
Now the server is runing on \href{http://localhost:33333}{\texttt{ http\+://localhost\+:33333}}. After that you can test A\+PI with help of Postman or other tool, which allows to send R\+E\+ST A\+PI requests.
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md2670}{}\doxysection{Auth}\label{doc_tutorials_install-webui_md_autotoc_md2670}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md2672}{}\doxysection{Development Guides}\label{doc_tutorials_install-webui_md_autotoc_md2672}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md2673}{}\doxysubsection{Updating Dependencies}\label{doc_tutorials_install-webui_md_autotoc_md2673}
...
Check for outdated dependencies via {\ttfamily npm outdated}. Dependencies can then be updated by running {\ttfamily npm update}.\hypertarget{doc_tutorials_install-webui_md_autotoc_md2674}{}\doxysubsection{Building Docker Image}\label{doc_tutorials_install-webui_md_autotoc_md2674}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md2675}{}\doxysubsection{Adding Support for New Metadata}\label{doc_tutorials_install-webui_md_autotoc_md2675}
