...
\Hypertarget{doc_decisions_array_md_md_doc_decisions_array}%
 \hypertarget{doc_decisions_array_md_autotoc_md1656}{}\doxysection{Problem}\label{doc_decisions_array_md_autotoc_md1656}
Currently it is inefficient to detect the length of an array and it is impossible to know if a key (without subkeys) should be an array or not.\hypertarget{doc_decisions_array_md_autotoc_md1657}{}\doxysection{Constraints}\label{doc_decisions_array_md_autotoc_md1657}

\begin{DoxyItemize}
\item None
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1658}{}\doxysection{Assumptions}\label{doc_decisions_array_md_autotoc_md1658}
\hypertarget{doc_decisions_array_md_autotoc_md1659}{}\doxysection{Considered Alternatives}\label{doc_decisions_array_md_autotoc_md1659}
...
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1660}{}\doxysection{Decision}\label{doc_decisions_array_md_autotoc_md1660}
...
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1661}{}\doxysection{Rationale}\label{doc_decisions_array_md_autotoc_md1661}
...
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1662}{}\doxysection{Implications}\label{doc_decisions_array_md_autotoc_md1662}
...
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1663}{}\doxysection{Related Decisions}\label{doc_decisions_array_md_autotoc_md1663}
...
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1664}{}\doxysection{Notes}\label{doc_decisions_array_md_autotoc_md1664}
