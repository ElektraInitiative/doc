...
\Hypertarget{doc_decisions_4_decided_internal_cache_md_md_doc_decisions_4_decided_internal_cache}%
 \hypertarget{doc_decisions_4_decided_internal_cache_md_autotoc_md2080}{}\doxysection{Problem}\label{doc_decisions_4_decided_internal_cache_md_autotoc_md2080}
{\ttfamily kdb\+Get} might return more or fewer keys than requested. This was found confusing several times.\hypertarget{doc_decisions_4_decided_internal_cache_md_autotoc_md2081}{}\doxysubsection{More Keys}\label{doc_decisions_4_decided_internal_cache_md_autotoc_md2081}
...
\end{DoxyCode}
\hypertarget{doc_decisions_4_decided_internal_cache_md_autotoc_md2082}{}\doxysubsection{Fewer Keys}\label{doc_decisions_4_decided_internal_cache_md_autotoc_md2082}
...
It was found unexpected that the second assert -\/ should find key (2) -\/ will fail.\hypertarget{doc_decisions_4_decided_internal_cache_md_autotoc_md2083}{}\doxysection{Constraints}\label{doc_decisions_4_decided_internal_cache_md_autotoc_md2083}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_internal_cache_md_autotoc_md2084}{}\doxysection{Assumptions}\label{doc_decisions_4_decided_internal_cache_md_autotoc_md2084}
\hypertarget{doc_decisions_4_decided_internal_cache_md_autotoc_md2085}{}\doxysection{Considered Alternatives}\label{doc_decisions_4_decided_internal_cache_md_autotoc_md2085}
\hypertarget{doc_decisions_4_decided_internal_cache_md_autotoc_md2086}{}\doxysubsection{Keep Current Situation}\label{doc_decisions_4_decided_internal_cache_md_autotoc_md2086}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_internal_cache_md_autotoc_md2087}{}\doxysubsection{Changing $<$tt$>$parent\+Key$<$/tt$>$ according to mountpoints}\label{doc_decisions_4_decided_internal_cache_md_autotoc_md2087}
\char`\"{}\+More keys\char`\"{}\+:
...
A very simple way to make it work would be to make the keys returned by kdb\+Get read-\/only. If we do not do this, we need a deep-\/copy or a copy-\/on-\/write copy.\hypertarget{doc_decisions_4_decided_internal_cache_md_autotoc_md2088}{}\doxysubsection{Cachefilter Plugin}\label{doc_decisions_4_decided_internal_cache_md_autotoc_md2088}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_internal_cache_md_autotoc_md2089}{}\doxysubsection{MMAP Cache with parent key}\label{doc_decisions_4_decided_internal_cache_md_autotoc_md2089}
...
However, in an application that used {\ttfamily system\+:/foo} as the parent, the {\ttfamily meta\+:/override} would work with your proposal. This seems like very confusing behavior, because both the application and the plugin seemingly use the same parent key.\hypertarget{doc_decisions_4_decided_internal_cache_md_autotoc_md2091}{}\doxysubsection{Data restrictions}\label{doc_decisions_4_decided_internal_cache_md_autotoc_md2091}
Make all the keys returned by kdb\+Get completely read-\/only. To change the data it is required to append an entirely new key to replace the existing one. Then we just need to keep a shallow copy internally.\hypertarget{doc_decisions_4_decided_internal_cache_md_autotoc_md2092}{}\doxysubsection{API restrictions}\label{doc_decisions_4_decided_internal_cache_md_autotoc_md2092}
...
This only fixes the \char`\"{}\+Fewer Keys\char`\"{} issue.\hypertarget{doc_decisions_4_decided_internal_cache_md_autotoc_md2093}{}\doxysubsection{Copy On Write}\label{doc_decisions_4_decided_internal_cache_md_autotoc_md2093}
...
Possible copy-\/on-\/write implementations are described in \mbox{\hyperlink{doc_decisions_6_implemented_copy_on_write_md}{another decision}}.\hypertarget{doc_decisions_4_decided_internal_cache_md_autotoc_md2094}{}\doxysection{Decision}\label{doc_decisions_4_decided_internal_cache_md_autotoc_md2094}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_internal_cache_md_autotoc_md2097}{}\doxysection{Related Decisions}\label{doc_decisions_4_decided_internal_cache_md_autotoc_md2097}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_internal_cache_md_autotoc_md2098}{}\doxysection{Notes}\label{doc_decisions_4_decided_internal_cache_md_autotoc_md2098}
