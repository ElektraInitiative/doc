...
``` \hypertarget{autotoc_md265_autotoc_md272}{}\section{Backup-\/and-\/\+Restore\+:/tests/hosts}\label{autotoc_md265_autotoc_md272}
sudo kdb mount --with-\/recommends hosts /tests/hosts hosts\hypertarget{autotoc_md265_autotoc_md273}{}\section{Create hosts file for testing}\label{autotoc_md265_autotoc_md273}
echo \textquotesingle{}127.\+0.\+0.\+1 localhost\textquotesingle{} $>$ {\ttfamily kdb file /tests/hosts} echo \textquotesingle{}\+:\+:1 localhost\textquotesingle{} $>$$>$ {\ttfamily kdb file /tests/hosts}\hypertarget{autotoc_md265_autotoc_md274}{}\section{Check the file}\label{autotoc_md265_autotoc_md274}
cat {\ttfamily kdb file /tests/hosts} \#$>$ 127.\+0.\+0.\+1 localhost \#$>$ \+:\+:1 localhost\hypertarget{autotoc_md265_autotoc_md275}{}\section{Check if the values are read correctly}\label{autotoc_md265_autotoc_md275}
kdb get /tests/hosts/ipv4/localhost \#$>$ 127.\+0.\+0.\+1 kdb get /tests/hosts/ipv6/localhost \#$>$ \+:\+:1\hypertarget{autotoc_md265_autotoc_md276}{}\section{Should both fail with error 04200 and return 5}\label{autotoc_md265_autotoc_md276}
kdb set /tests/hosts/ipv4/localhost \+:\+:1 \hypertarget{autotoc_md265_autotoc_md277}{}\section{R\+E\+T\+:5}\label{autotoc_md265_autotoc_md277}
\hypertarget{autotoc_md265_autotoc_md278}{}\section{E\+R\+R\+O\+R\+:\+C03200}\label{autotoc_md265_autotoc_md278}
kdb set /tests/hosts/ipv6/localhost 127.\+0.\+0.\+1 \hypertarget{autotoc_md265_autotoc_md279}{}\section{R\+E\+T\+:5}\label{autotoc_md265_autotoc_md279}
\hypertarget{autotoc_md265_autotoc_md280}{}\section{E\+R\+R\+O\+R\+:\+C03200}\label{autotoc_md265_autotoc_md280}
\hypertarget{autotoc_md265_autotoc_md281}{}\section{cleanup}\label{autotoc_md265_autotoc_md281}
kdb rm -\/r /tests/hosts sudo kdb umount /tests/hosts ```\hypertarget{autotoc_md265_autotoc_md282}{}\subsection{Limitations}\label{autotoc_md265_autotoc_md282}
