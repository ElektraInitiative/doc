...
\mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} \mbox{\hyperlink{classkdb_1_1KeySet_a36666eb6ebbaa8a6d890f5c794af0f10}{dup}} () const
\begin{DoxyCompactList}\small\item\em Duplicate a keyset. \end{DoxyCompactList}\item 
...
\mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} \mbox{\hyperlink{classkdb_1_1KeySet_ab072d98cdae38df72392103ff275107a}{cut}} (const \mbox{\hyperlink{classkdb_1_1Key}{Key}} \&k)
...
\mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} \mbox{\hyperlink{classkdb_1_1KeySet_a790ebc11c59866063dc3bdc055d48467}{cut}} (std\+::string const \&name)
\begin{DoxyCompactList}\small\item\em Cuts out all Keys from \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} {\ttfamily ks} that are below or at {\ttfamily cutpoint}. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Search in a key set, either yielding the actual index of the key, if the key has been found within the key set, or a negative value indicating the insertion index of the key, if the key would be inserted. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\end{DoxyNote}
So it is shallow copy, to create a deep copy you have to \mbox{\hyperlink{classkdb_1_1KeySet_a36666eb6ebbaa8a6d890f5c794af0f10}{dup()}} every key (it still won\textquotesingle{}t copy metadata, but they are COW)\+: 
\begin{DoxyCodeInclude}{0}
...
\DoxyCodeLine{        \{}
\DoxyCodeLine{                deepCopy.\mbox{\hyperlink{classkdb_1_1KeySet_a0d4b2f3aa9f58d10053561135b50233e}{append}} (orig.\mbox{\hyperlink{classkdb_1_1KeySet_a40e32f2d9f34f03fa8ec85945f49b630}{at}} (it).\mbox{\hyperlink{classkdb_1_1Key_a282cacfae0341dfa8729dc70211945a0}{dup}} ());}
\DoxyCodeLine{        \}}
...
\end{DoxyCodeInclude}
 \begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{classkdb_1_1KeySet_a36666eb6ebbaa8a6d890f5c794af0f10}{dup}} 
\end{DoxySeeAlso}
...
Replaces all keys in {\ttfamily this} with the ones from {\ttfamily other}. This is only a shallow copy. For a deep copy you need to manually \mbox{\hyperlink{classkdb_1_1Key_a282cacfae0341dfa8729dc70211945a0}{Key\+::dup}} every key.
...
\end{DoxySeeAlso}
\mbox{\Hypertarget{classkdb_1_1KeySet_ab072d98cdae38df72392103ff275107a}\label{classkdb_1_1KeySet_ab072d98cdae38df72392103ff275107a}} 
...
{\footnotesize\ttfamily \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} kdb\+::\+Key\+Set\+::cut (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classkdb_1_1Key}{Key}} \&}]{k }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
\end{DoxySeeAlso}
\mbox{\Hypertarget{classkdb_1_1KeySet_a790ebc11c59866063dc3bdc055d48467}\label{classkdb_1_1KeySet_a790ebc11c59866063dc3bdc055d48467}} 
\index{kdb::KeySet@{kdb::KeySet}!cut@{cut}}
\index{cut@{cut}!kdb::KeySet@{kdb::KeySet}}
\doxysubsubsection{\texorpdfstring{cut()}{cut()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} kdb\+::\+Key\+Set\+::cut (\begin{DoxyParamCaption}\item[{std\+::string const \&}]{name }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
\mbox{\hyperlink{group__kdb_ga28e385fd9cb7ccfe0b2f1ed2f62453a1}{kdb\+Get()}} for an explanation on why you might \mbox{\hyperlink{classkdb_1_1KeySet_a65208974b44da0162ef70dd7a173748f}{get}} more Keys than you requested. 
\end{DoxySeeAlso}
\mbox{\Hypertarget{classkdb_1_1KeySet_a36666eb6ebbaa8a6d890f5c794af0f10}\label{classkdb_1_1KeySet_a36666eb6ebbaa8a6d890f5c794af0f10}} 
\index{kdb::KeySet@{kdb::KeySet}!dup@{dup}}
\index{dup@{dup}!kdb::KeySet@{kdb::KeySet}}
\doxysubsubsection{\texorpdfstring{dup()}{dup()}}
{\footnotesize\ttfamily \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} kdb\+::\+Key\+Set\+::dup (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}
