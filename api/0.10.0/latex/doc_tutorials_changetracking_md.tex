...
\Hypertarget{doc_tutorials_changetracking_md_md_doc_tutorials_changetracking}%
 Elektra provides developers of applications and plugins a way to determine changes made to a {\ttfamily Key\+Set} relative to the last known state of the key database. This can be useful if you are writing a plugin that works with changes of the configuration.\hypertarget{doc_tutorials_changetracking_md_autotoc_md4303}{}\doxysection{Basics}\label{doc_tutorials_changetracking_md_autotoc_md4303}
...
The two main data structures you will encounter are {\ttfamily Change\+Tracking\+Context} and {\ttfamily Elektra\+Diff}.\hypertarget{doc_tutorials_changetracking_md_autotoc_md4304}{}\doxysection{Getting the difference between Key\+Sets}\label{doc_tutorials_changetracking_md_autotoc_md4304}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_changetracking_md_autotoc_md4305}{}\doxysection{Getting the changes within a transaction in a plugin}\label{doc_tutorials_changetracking_md_autotoc_md4305}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_changetracking_md_autotoc_md4306}{}\doxysection{Getting the changes as an application developer}\label{doc_tutorials_changetracking_md_autotoc_md4306}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_changetracking_md_autotoc_md4307}{}\doxysection{Working with the diff}\label{doc_tutorials_changetracking_md_autotoc_md4307}
