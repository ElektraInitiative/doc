...
\begin{DoxyItemize}
\item \hyperlink{autotoc_md835_src_plugins_yajl_README_md}{Y\+A\+JL} , and
\item \hyperlink{autotoc_md865_src_plugins_yamlcpp_README_md}{Y\+A\+ML C\+PP}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item The \href{https://master.libelektra.org/tests/shell/shell_recorder/tutorial_wrapper}{\tt Markdown Shell Recorder} test of the plugin now also works, if you execute it as root user. \+\_\+(René Schwaiger)\+\_\+
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item Yajl now correctly supports Elektras boolean types using the {\ttfamily type} plugin. For example, setting {\ttfamily on}, {\ttfamily enable} or {\ttfamily true} all map to J\+S\+O\+Ns native {\ttfamily true} value. See the \hyperlink{autotoc_md803_src_plugins_type_README_md}{type} plugin for more details about boolean types. \+\_\+(\+Philipp Gackstatter)\+\_\+
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item Added a tutorial on how to write language bindings. Visit our new \hyperlink{doc_tutorials_language-bindings_md}{R\+E\+A\+D\+ME}. \+\_\+(\+Michael Zronek, Raphael Gruber, Philipp Gackstatter)\+\_\+
\item Clarified subtyping in the language bindings tutorial. \+\_\+(\+Michael Zronek)\+\_\+
\item A \hyperlink{doc_tutorials_highlevel-bindings_md}{second tutorial} on writing bindings for the high-\/level A\+PI was created as well. \+\_\+(Klemens Böswirth, Raphael Gruber)\+\_\+
\item Added \hyperlink{autotoc_md825_src_plugins_xerces_README_md}{info} on how to include xerces plugin with homebrew installation. \+\_\+(Anton Hößl)\+\_\+
\item The \hyperlink{doc_COMPILE_md}{compile instructions} do not assume that you use {\ttfamily make} or {\ttfamily gcc} to build Elektra anymore. \+\_\+(René Schwaiger)\+\_\+
...
\item Clarified warnings metadata in the \hyperlink{doc_dev_error-handling_md}{error-\/handling guideline}. \+\_\+(\+Michael Zronek)\+\_\+
