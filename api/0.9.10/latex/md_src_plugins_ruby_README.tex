...
This plugin is an Elektra to Ruby bridge and makes is possible to implement Elektra plugins with Ruby. This plugin requires the {\ttfamily ruby} binding.\hypertarget{md_src_plugins_ruby_README_autotoc_md500}{}\doxysection{Installation}\label{md_src_plugins_ruby_README_autotoc_md500}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/ruby}.\hypertarget{md_src_plugins_ruby_README_autotoc_md501}{}\doxysection{Configuration Options}\label{md_src_plugins_ruby_README_autotoc_md501}
The plugin has the following configuration options\+:


\begin{DoxyItemize}
\item {\ttfamily script}\+: path to the Ruby plugin to use (mandatory)
\end{DoxyItemize}\hypertarget{md_src_plugins_ruby_README_autotoc_md502}{}\doxysection{Usage}\label{md_src_plugins_ruby_README_autotoc_md502}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_ruby_README_autotoc_md503}{}\doxysection{Implementing Ruby Plugins}\label{md_src_plugins_ruby_README_autotoc_md503}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_ruby_README_autotoc_md504}{}\doxysection{Known Issues}\label{md_src_plugins_ruby_README_autotoc_md504}
