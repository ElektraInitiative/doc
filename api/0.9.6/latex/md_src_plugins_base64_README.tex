...
\begin{DoxyCode}{0}
\DoxyCodeLine{\# Mount TOML and Base64 plugin (provides `binary`) with the configuration key `binary/meta`}
\DoxyCodeLine{kdb mount test\_config.toml user:/tests/base64 ni base64 binary/meta=}
\DoxyCodeLine{}
