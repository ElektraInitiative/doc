\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1300}{}\doxysection{Problem}\label{doc_decisions_plugin_variants_md_autotoc_md1300}
...
The current issue is that there is no way to enumerate possible plugin variants as needed to list all functionality of Elektra.\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1301}{}\doxysection{Constraints}\label{doc_decisions_plugin_variants_md_autotoc_md1301}
...
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1302}{}\doxysection{Assumptions}\label{doc_decisions_plugin_variants_md_autotoc_md1302}

\begin{DoxyItemize}
\item The number of variants needs to be bounded\+: plugin variants need to be fully enumerable
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1303}{}\doxysection{Considered Alternatives}\label{doc_decisions_plugin_variants_md_autotoc_md1303}
...
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1304}{}\doxysection{Decision}\label{doc_decisions_plugin_variants_md_autotoc_md1304}
...
\end{DoxyItemize}
\end{DoxyEnumerate}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1305}{}\doxysubsection{Example}\label{doc_decisions_plugin_variants_md_autotoc_md1305}
...
\end{DoxyCode}
\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1306}{}\doxysection{Rationale}\label{doc_decisions_plugin_variants_md_autotoc_md1306}
...
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1307}{}\doxysection{Implications}\label{doc_decisions_plugin_variants_md_autotoc_md1307}
...
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1308}{}\doxysection{Current state}\label{doc_decisions_plugin_variants_md_autotoc_md1308}
...
gets ignored.\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1309}{}\doxysection{Related Decisions}\label{doc_decisions_plugin_variants_md_autotoc_md1309}

\begin{DoxyItemize}
\item \mbox{\hyperlink{doc_decisions_cmake_plugins_md}{C\+Make Plugins}}
\end{DoxyItemize}\hypertarget{doc_decisions_plugin_variants_md_autotoc_md1310}{}\doxysection{Notes}\label{doc_decisions_plugin_variants_md_autotoc_md1310}
