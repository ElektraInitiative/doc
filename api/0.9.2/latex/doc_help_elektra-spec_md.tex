\hypertarget{doc_help_elektra-spec_md_autotoc_md1586}{}\doxysection{I\+N\+T\+R\+O\+D\+U\+C\+T\+I\+ON}\label{doc_help_elektra-spec_md_autotoc_md1586}
...
It is, however, not limited to this but can express any other key database semantics (new plugins might be necessary, though).\hypertarget{doc_help_elektra-spec_md_autotoc_md1587}{}\doxysection{Application}\label{doc_help_elektra-spec_md_autotoc_md1587}
...
So Keys in {\ttfamily spec} allow us to specify which keys are read by the application. The description key will be copied (referred to) to {\ttfamily folder/anotherkey} of any namespace, so that it can easily be accessed.\hypertarget{doc_help_elektra-spec_md_autotoc_md1588}{}\doxysection{Cascading Lookup}\label{doc_help_elektra-spec_md_autotoc_md1588}
...
Note that the fallback, override and cascading works on {\itshape key level}, and not like most other systems have implemented, on configuration {\itshape file level}.\hypertarget{doc_help_elektra-spec_md_autotoc_md1589}{}\doxysection{Validation}\label{doc_help_elektra-spec_md_autotoc_md1589}
...
\end{DoxyCode}
\hypertarget{doc_help_elektra-spec_md_autotoc_md1590}{}\doxysection{Mounting}\label{doc_help_elektra-spec_md_autotoc_md1590}
...
\end{DoxyCode}
\hypertarget{doc_help_elektra-spec_md_autotoc_md1591}{}\doxysection{S\+E\+E A\+L\+SO}\label{doc_help_elektra-spec_md_autotoc_md1591}
