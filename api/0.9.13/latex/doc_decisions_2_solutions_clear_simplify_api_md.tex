...
\Hypertarget{doc_decisions_2_solutions_clear_simplify_api_md_md_doc_decisions_2_solutions_clear_simplify_api}%
 \hypertarget{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2013}{}\doxysection{Problem}\label{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2013}
...
The urgency of this decision is that API can be easily introduced later but we cannot get rid of it after 1.\+0.\hypertarget{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2014}{}\doxysection{Constraints}\label{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2014}

\begin{DoxyItemize}
\item To not disturb main features as described in use cases.
\end{DoxyItemize}\hypertarget{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2015}{}\doxysection{Assumptions}\label{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2015}
...
\end{DoxyItemize}\hypertarget{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2016}{}\doxysection{Considered Alternatives}\label{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2016}

\begin{DoxyItemize}
\item flags for binary data
\end{DoxyItemize}\hypertarget{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2017}{}\doxysection{Decision}\label{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2017}
...
\end{DoxyItemize}\hypertarget{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2018}{}\doxysection{Rationale}\label{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2018}
\hypertarget{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2019}{}\doxysection{Implications}\label{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2019}
\hypertarget{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2020}{}\doxysection{Related Decisions}\label{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2020}
...
\end{DoxyItemize}\hypertarget{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2021}{}\doxysection{Notes}\label{doc_decisions_2_solutions_clear_simplify_api_md_autotoc_md2021}
