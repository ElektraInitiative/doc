...
\Hypertarget{doc_decisions_highlevel_help_message_md_md_doc_decisions_highlevel_help_message}%
 This decision {\itshape does not} assume code-\/generation is used. For the case of code-\/generation see the \href{\#notes}{\texttt{ Notes}} section.\hypertarget{doc_decisions_highlevel_help_message_md_autotoc_md1884}{}\doxysection{Problem}\label{doc_decisions_highlevel_help_message_md_autotoc_md1884}
We want to allow to print the help message no matter what errors happened in {\ttfamily kdb\+Open} or {\ttfamily kdb\+Get}.\hypertarget{doc_decisions_highlevel_help_message_md_autotoc_md1885}{}\doxysection{Constraints}\label{doc_decisions_highlevel_help_message_md_autotoc_md1885}
...
\end{DoxyItemize}\hypertarget{doc_decisions_highlevel_help_message_md_autotoc_md1886}{}\doxysection{Assumptions}\label{doc_decisions_highlevel_help_message_md_autotoc_md1886}
...
\end{DoxyItemize}\hypertarget{doc_decisions_highlevel_help_message_md_autotoc_md1887}{}\doxysection{Considered Alternatives}\label{doc_decisions_highlevel_help_message_md_autotoc_md1887}
...
\end{DoxyItemize}\hypertarget{doc_decisions_highlevel_help_message_md_autotoc_md1888}{}\doxysection{Decision}\label{doc_decisions_highlevel_help_message_md_autotoc_md1888}
Ignore missing {\ttfamily require}d keys (in help mode), but fail for every other error.\hypertarget{doc_decisions_highlevel_help_message_md_autotoc_md1889}{}\doxysection{Rationale}\label{doc_decisions_highlevel_help_message_md_autotoc_md1889}
...
In any case after this the user definitely know how to interact with the KDB. Since we assumed that there won\textquotesingle{}t be any errors before the KDB was changed, we can assume that the user caused other errors by changing the KDB.\hypertarget{doc_decisions_highlevel_help_message_md_autotoc_md1890}{}\doxysection{Notes}\label{doc_decisions_highlevel_help_message_md_autotoc_md1890}
