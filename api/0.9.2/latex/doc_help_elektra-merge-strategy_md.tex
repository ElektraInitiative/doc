...
Note\+: For a two-\/way merge, the {\ttfamily ours} version of the keys is used in place of {\ttfamily base}\hypertarget{doc_help_elektra-merge-strategy_md_autotoc_md1566}{}\doxysection{3-\/\+W\+AY}\label{doc_help_elektra-merge-strategy_md_autotoc_md1566}
