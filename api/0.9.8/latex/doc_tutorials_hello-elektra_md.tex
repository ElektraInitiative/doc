...
\begin{DoxyCode}{0}
\DoxyCodeLine{-\/-\/ The C compiler identification is Clang 12.0.0}
\DoxyCodeLine{-\/-\/ The CXX compiler identification is Clang 12.0.0}
...
\DoxyCodeLine{-\/-\/ Elektra 0.9.8 found}
