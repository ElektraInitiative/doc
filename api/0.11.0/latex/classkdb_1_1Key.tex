...
\begin{DoxyCompactList}\small\item\em Constructs a key with the name {\ttfamily /}. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Decrement the reference counter of a \mbox{\hyperlink{classkdb_1_1Key}{Key}} object. \end{DoxyCompactList}\item 
uint16\+\_\+t \mbox{\hyperlink{classkdb_1_1Key_ac9ddf5c032e497a238fcef1d4a277e0c}{get\+Reference\+Counter}} () const
\begin{DoxyCompactList}\small\item\em Return the current reference counter value of a \mbox{\hyperlink{classkdb_1_1Key}{Key}} object. \end{DoxyCompactList}\item 
...
\mbox{\hyperlink{classkdb_1_1Key}{Key}} \mbox{\hyperlink{classkdb_1_1Key_a282cacfae0341dfa8729dc70211945a0}{dup}} (\mbox{\hyperlink{group__key_ga9ff42b1e9a97222562bfda3dd1f8c735}{elektra\+Copy\+Flags}} flags=\mbox{\hyperlink{group__key_gga9ff42b1e9a97222562bfda3dd1f8c735a3e04e17514f102f1e9217308d44e7612}{KEY\+\_\+\+CP\+\_\+\+ALL}}) const
\item 
...
bool \mbox{\hyperlink{classkdb_1_1Key_a74a1da8dbeab6729f4e08823b391370f}{is\+Below}} (std\+::string const \&name) const
...
\begin{DoxyCompactList}\small\item\em Check if the \mbox{\hyperlink{classkdb_1_1Key}{Key}} {\ttfamily check} is below the \mbox{\hyperlink{classkdb_1_1Key}{Key}} {\ttfamily key} or not. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{classkdb_1_1Key_a2214576e8b6e286f5ea0a8e08ab540d5}{is\+Below\+Or\+Same}} (std\+::string const \&name) const
...
\begin{DoxyCompactList}\small\item\em Check if a key is below or same. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{classkdb_1_1Key_a380d63ba4ef23814a8aec5ee80f154d9}{is\+Direct\+Below}} (std\+::string const \&name) const
...
Copies of keys are cheap because they are only flat. If you really need a deep copy, you can use \mbox{\hyperlink{classkdb_1_1Key_a0aa7da64aac085e0eff5912fec977848}{copy()}} or \mbox{\hyperlink{classkdb_1_1Key_a282cacfae0341dfa8729dc70211945a0}{dup()}}. If you \mbox{\hyperlink{classkdb_1_1Key_a9ae719043e6e99f5f3d6fb85837306f8}{release()}} an object, the reference counter will stay All other operations operate on references.
\end{DoxyParagraph}
...
Constructs a key with the name {\ttfamily /}. 
...
{\ttfamily name} is a valid \mbox{\hyperlink{classkdb_1_1Key}{Key}} name 

Variable arguments are a valid combination 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
returns a new, fully initialized \mbox{\hyperlink{classkdb_1_1Key}{Key}} object with the valid \mbox{\hyperlink{classkdb_1_1Key}{Key}} name and all data given by variable arguments
\end{DoxyPostcond}
...
\end{DoxySince}
\begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{group__key_ga3df95bbc2494e3e6703ece5639be5bb1}{key\+Del()}} for deallocating a created \mbox{\hyperlink{classkdb_1_1Key}{Key}} object 
...
\end{DoxyItemize}\mbox{\Hypertarget{classkdb_1_1Key_acbf7642258d46da2c4427f4104cf01ee}\label{classkdb_1_1Key_acbf7642258d46da2c4427f4104cf01ee}} 
\index{kdb::Key@{kdb::Key}!Key@{Key}}
\index{Key@{Key}!kdb::Key@{kdb::Key}}
...
\end{DoxyItemize}\mbox{\Hypertarget{classkdb_1_1Key_aa0dc94c7e676a0d280e5817e4c6238d3}\label{classkdb_1_1Key_aa0dc94c7e676a0d280e5817e4c6238d3}} 
\index{kdb::Key@{kdb::Key}!Key@{Key}}
\index{Key@{Key}!kdb::Key@{kdb::Key}}
...
\end{DoxyItemize}\mbox{\Hypertarget{classkdb_1_1Key_a35dd6ae58d125a298e30aed13b15c1f4}\label{classkdb_1_1Key_a35dd6ae58d125a298e30aed13b15c1f4}} 
...
\end{DoxyCodeInclude}
 \begin{DoxyPrecond}{Precondition}
{\ttfamily dest} must be a valid \mbox{\hyperlink{classkdb_1_1Key}{Key}} (created with key\+New) 

{\ttfamily dest} must not have read-\/only flags set 

{\ttfamily source} must be a valid \mbox{\hyperlink{classkdb_1_1Key}{Key}} or NULL 
\end{DoxyPrecond}
\begin{DoxyInvariant}{Invariant}
...
\DoxyCodeLine{        \{}
\DoxyCodeLine{                current = \mbox{\hyperlink{group__keyset_gab3fb5e067c672d9fd60a4022b2ae9dd1}{ksAtCursor}} (ks, it);}
...
Afterwards {\ttfamily source} and {\ttfamily dest} will have the same metadata referred with {\ttfamily meta\+Name}. If the \mbox{\hyperlink{classkdb_1_1Key}{Key}} with name {\ttfamily meta\+Name} doesn\textquotesingle{}t exist in {\ttfamily source} -\/ it gets deleted in {\ttfamily dest}.
...
\DoxyCodeLine{        \textcolor{keywordflow}{for} (elektraCursor it = 0; it < \mbox{\hyperlink{group__keyset_ga7474ad6b0a0fa969dbdf267ba5770eee}{ksGetSize}} (ks); ++it)}
\DoxyCodeLine{        \{}
\DoxyCodeLine{                \mbox{\hyperlink{classkdb_1_1Key_a5679f5cae63caddd64a60388b9cc77fa}{Key}} * current = \mbox{\hyperlink{group__keyset_gab3fb5e067c672d9fd60a4022b2ae9dd1}{ksAtCursor}} (ks, it);}
...
\end{DoxySeeAlso}
\mbox{\Hypertarget{classkdb_1_1Key_a282cacfae0341dfa8729dc70211945a0}\label{classkdb_1_1Key_a282cacfae0341dfa8729dc70211945a0}} 
\index{kdb::Key@{kdb::Key}!dup@{dup}}
\index{dup@{dup}!kdb::Key@{kdb::Key}}
\doxysubsubsection{\texorpdfstring{dup()}{dup()}}
{\footnotesize\ttfamily \mbox{\hyperlink{classkdb_1_1Key}{Key}} kdb\+::\+Key\+::dup (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{group__key_ga9ff42b1e9a97222562bfda3dd1f8c735}{elektra\+Copy\+Flags}}}]{flags = {\ttfamily \mbox{\hyperlink{group__key_gga9ff42b1e9a97222562bfda3dd1f8c735a3e04e17514f102f1e9217308d44e7612}{KEY\+\_\+\+CP\+\_\+\+ALL}}} }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}
...
\begin{DoxyRetVals}{Return values}
{\em -\/1} & if the \mbox{\hyperlink{classkdb_1_1Key}{Key}} or the \mbox{\hyperlink{classkdb_1_1Key}{Key}}\textquotesingle{}s basename is NULL\\
\hline
\end{DoxyRetVals}
\begin{DoxySince}{Since}
1.\+0.\+0
...
\begin{DoxyPostcond}{Postcondition}
returns the exact amount of bytes needed to store {\ttfamily key\textquotesingle{}s} value (including NULL terminators)
\end{DoxyPostcond}
...
unlike in the C version, it is safe to change the returned string. 
\end{DoxyNote}
\mbox{\Hypertarget{classkdb_1_1Key_a976627183cdc6835a969475e99ec8bc1}\label{classkdb_1_1Key_a976627183cdc6835a969475e99ec8bc1}} 
...
\end{DoxySeeAlso}
\mbox{\Hypertarget{classkdb_1_1Key_ac9ddf5c032e497a238fcef1d4a277e0c}\label{classkdb_1_1Key_ac9ddf5c032e497a238fcef1d4a277e0c}} 
...
{\footnotesize\ttfamily uint16\+\_\+t kdb\+::\+Key\+::get\+Reference\+Counter (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}



Return the current reference counter value of a \mbox{\hyperlink{classkdb_1_1Key}{Key}} object. 
...
\end{DoxyParagraph}
\begin{DoxyPrecond}{Precondition}
{\ttfamily key} is not NULL and has stored data 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
...
\doxysubsubsection{\texorpdfstring{isBelow()}{isBelow()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\end{DoxySeeAlso}
\mbox{\Hypertarget{classkdb_1_1Key_a74a1da8dbeab6729f4e08823b391370f}\label{classkdb_1_1Key_a74a1da8dbeab6729f4e08823b391370f}} 
\index{kdb::Key@{kdb::Key}!isBelow@{isBelow}}
\index{isBelow@{isBelow}!kdb::Key@{kdb::Key}}
\doxysubsubsection{\texorpdfstring{isBelow()}{isBelow()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily bool kdb\+::\+Key\+::is\+Below (\begin{DoxyParamCaption}\item[{std\+::string const \&}]{name }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}
...
\begin{DoxyParams}{Parameters}
{\em name} & the name of the other key \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
true if our key is below k
...
\doxysubsubsection{\texorpdfstring{isBelowOrSame()}{isBelowOrSame()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\end{DoxySeeAlso}
\mbox{\Hypertarget{classkdb_1_1Key_a2214576e8b6e286f5ea0a8e08ab540d5}\label{classkdb_1_1Key_a2214576e8b6e286f5ea0a8e08ab540d5}} 
\index{kdb::Key@{kdb::Key}!isBelowOrSame@{isBelowOrSame}}
\index{isBelowOrSame@{isBelowOrSame}!kdb::Key@{kdb::Key}}
\doxysubsubsection{\texorpdfstring{isBelowOrSame()}{isBelowOrSame()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily bool kdb\+::\+Key\+::is\+Below\+Or\+Same (\begin{DoxyParamCaption}\item[{std\+::string const \&}]{name }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}
...
\doxysubsubsection{\texorpdfstring{isDirectBelow()}{isDirectBelow()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\mbox{\hyperlink{group__keyname_gab29a850168d9b31c9529e90cf9ab68be}{key\+Get\+Name()}}, \mbox{\hyperlink{group__keyname_ga7699091610e7f3f43d2949514a4b35d9}{key\+Set\+Name()}} for getting / setting the \mbox{\hyperlink{classkdb_1_1Key}{Key}}\textquotesingle{}s name 
\end{DoxySeeAlso}
\mbox{\Hypertarget{classkdb_1_1Key_a380d63ba4ef23814a8aec5ee80f154d9}\label{classkdb_1_1Key_a380d63ba4ef23814a8aec5ee80f154d9}} 
\index{kdb::Key@{kdb::Key}!isDirectBelow@{isDirectBelow}}
\index{isDirectBelow@{isDirectBelow}!kdb::Key@{kdb::Key}}
\doxysubsubsection{\texorpdfstring{isDirectBelow()}{isDirectBelow()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily bool kdb\+::\+Key\+::is\+Direct\+Below (\begin{DoxyParamCaption}\item[{std\+::string const \&}]{name }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}
...
\begin{DoxyPrecond}{Precondition}
The Keys {\ttfamily k1} and {\ttfamily k2} have been properly initialized via \mbox{\hyperlink{group__key_gad23c65b44bf48d773759e1f9a4d43b89}{key\+New()}} or are NULL 
\end{DoxyPrecond}
\begin{DoxyInvariant}{Invariant}
All parts of the Keys remain unchanged 
\end{DoxyInvariant}
\begin{DoxyPostcond}{Postcondition}
If the result is 0, {\ttfamily k1} and {\ttfamily k2} cannot be used in the same \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}}
\end{DoxyPostcond}
...
\begin{DoxyParams}{Parameters}
{\em key} & the \mbox{\hyperlink{classkdb_1_1Key}{Key}} object whose reference counter should be increased\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyPrecond}{Precondition}
{\ttfamily new\+String\+Value} is a NULL terminated string 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
Value of the \mbox{\hyperlink{classkdb_1_1Key}{Key}} is set to the UTF-\/8 encoded value of {\ttfamily new\+String\+Value} 

Metakey {\ttfamily meta\+:/binary} is cleared
\end{DoxyPostcond}
...
\begin{DoxyRetVals}{Return values}
{\em -\/1} & if \mbox{\hyperlink{classkdb_1_1Key}{Key}} is NULL \\
\hline
{\em -\/1} & if \mbox{\hyperlink{classkdb_1_1Key}{Key}} was inserted into \mbox{\hyperlink{classkdb_1_1KeySet}{Key\+Set}} before \\
\hline
...
\end{DoxyNote}
\begin{DoxyPrecond}{Precondition}
{\ttfamily data\+Size} matches the length of {\ttfamily new\+Binary} 

{\ttfamily new\+Binary} is not NULL and {\ttfamily data\+Size} $>$ 0 

{\ttfamily key} is not read-\/only 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
{\ttfamily key\textquotesingle{}s} value set exactly to the data in {\ttfamily new\+Binary} 

\char`\"{}binary\char`\"{} key set in {\ttfamily key\textquotesingle{}s} metadata
\end{DoxyPostcond}
