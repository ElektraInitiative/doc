...
\Hypertarget{doc_decisions_array_md_md_doc_decisions_array}%
 \hypertarget{doc_decisions_array_md_autotoc_md1642}{}\doxysection{Problem}\label{doc_decisions_array_md_autotoc_md1642}
Currently it is inefficient to detect the length of an array and it is impossible to know if a key (without subkeys) should be an array or not.\hypertarget{doc_decisions_array_md_autotoc_md1643}{}\doxysection{Constraints}\label{doc_decisions_array_md_autotoc_md1643}

\begin{DoxyItemize}
\item None
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1644}{}\doxysection{Assumptions}\label{doc_decisions_array_md_autotoc_md1644}
\hypertarget{doc_decisions_array_md_autotoc_md1645}{}\doxysection{Considered Alternatives}\label{doc_decisions_array_md_autotoc_md1645}
...
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1646}{}\doxysection{Decision}\label{doc_decisions_array_md_autotoc_md1646}
...
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1647}{}\doxysection{Rationale}\label{doc_decisions_array_md_autotoc_md1647}
...
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1648}{}\doxysection{Implications}\label{doc_decisions_array_md_autotoc_md1648}
...
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1649}{}\doxysection{Related Decisions}\label{doc_decisions_array_md_autotoc_md1649}
...
\end{DoxyItemize}\hypertarget{doc_decisions_array_md_autotoc_md1650}{}\doxysection{Notes}\label{doc_decisions_array_md_autotoc_md1650}
