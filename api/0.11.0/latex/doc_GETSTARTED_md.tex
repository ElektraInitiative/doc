...
\Hypertarget{doc_GETSTARTED_md_md_doc_GETSTARTED}%
 This document is intended for developers who want to get started with developing with Elektra.\hypertarget{doc_GETSTARTED_md_autotoc_md2733}{}\doxysection{Skill requirements}\label{doc_GETSTARTED_md_autotoc_md2733}
...
\end{DoxyItemize}\hypertarget{doc_GETSTARTED_md_autotoc_md2734}{}\doxysection{Software requirements}\label{doc_GETSTARTED_md_autotoc_md2734}
...
\end{DoxyCode}
\hypertarget{doc_GETSTARTED_md_autotoc_md2735}{}\doxysection{Installation}\label{doc_GETSTARTED_md_autotoc_md2735}
...
\end{DoxyCode}
\hypertarget{doc_GETSTARTED_md_autotoc_md2736}{}\doxysection{Hello first steps!}\label{doc_GETSTARTED_md_autotoc_md2736}
