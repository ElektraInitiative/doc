\hypertarget{doc_decisions_global_plugins_md_autotoc_md1196}{}\doxysection{Problem}\label{doc_decisions_global_plugins_md_autotoc_md1196}
...
\end{DoxyItemize}\hypertarget{doc_decisions_global_plugins_md_autotoc_md1197}{}\doxysection{Constraints}\label{doc_decisions_global_plugins_md_autotoc_md1197}
...
\end{DoxyItemize}\hypertarget{doc_decisions_global_plugins_md_autotoc_md1198}{}\doxysection{Assumptions}\label{doc_decisions_global_plugins_md_autotoc_md1198}

\begin{DoxyItemize}
\item we can enumerate all positions that are useful for global plugins
\end{DoxyItemize}\hypertarget{doc_decisions_global_plugins_md_autotoc_md1199}{}\doxysection{Considered Alternatives}\label{doc_decisions_global_plugins_md_autotoc_md1199}

\begin{DoxyItemize}
\item using different plugin interface (like hooks)
\end{DoxyItemize}\hypertarget{doc_decisions_global_plugins_md_autotoc_md1200}{}\doxysection{Decision}\label{doc_decisions_global_plugins_md_autotoc_md1200}
\hypertarget{doc_decisions_global_plugins_md_autotoc_md1201}{}\doxysubsection{Positions}\label{doc_decisions_global_plugins_md_autotoc_md1201}
...
\end{DoxyItemize}\hypertarget{doc_decisions_global_plugins_md_autotoc_md1202}{}\doxysubsection{Return Values}\label{doc_decisions_global_plugins_md_autotoc_md1202}
...
\end{DoxyItemize}\hypertarget{doc_decisions_global_plugins_md_autotoc_md1203}{}\doxysubsection{Detection Within Plugins}\label{doc_decisions_global_plugins_md_autotoc_md1203}
...
Exception\+: {\ttfamily foreach} plugins only get filenames, so to know in which foreach loop you are, you need to add additional {\ttfamily once} placements to correctly track your state.\hypertarget{doc_decisions_global_plugins_md_autotoc_md1204}{}\doxysubsection{Contract}\label{doc_decisions_global_plugins_md_autotoc_md1204}
...
\end{DoxyCode}
\hypertarget{doc_decisions_global_plugins_md_autotoc_md1205}{}\doxysubsection{Application-\/\+Specific Global Plugins}\label{doc_decisions_global_plugins_md_autotoc_md1205}
...
\end{DoxyItemize}\hypertarget{doc_decisions_global_plugins_md_autotoc_md1206}{}\doxysection{Rationale}\label{doc_decisions_global_plugins_md_autotoc_md1206}
Some nice features that will be implemented as global plugins.\hypertarget{doc_decisions_global_plugins_md_autotoc_md1207}{}\doxysubsection{Transformation}\label{doc_decisions_global_plugins_md_autotoc_md1207}
...
\end{DoxyItemize}\hypertarget{doc_decisions_global_plugins_md_autotoc_md1208}{}\doxysubsection{Global Lock}\label{doc_decisions_global_plugins_md_autotoc_md1208}
simplifies threading and process locking by not having to think about recursive cases.

Now called {\ttfamily semlock}-\/plugin.\hypertarget{doc_decisions_global_plugins_md_autotoc_md1209}{}\doxysubsection{Shell Plugins}\label{doc_decisions_global_plugins_md_autotoc_md1209}
...
\end{DoxyCode}
\hypertarget{doc_decisions_global_plugins_md_autotoc_md1210}{}\doxysubsection{Inference Plugins}\label{doc_decisions_global_plugins_md_autotoc_md1210}
...
Now called {\ttfamily spec}-\/plugin.\hypertarget{doc_decisions_global_plugins_md_autotoc_md1211}{}\doxysubsection{Journalling Plugins}\label{doc_decisions_global_plugins_md_autotoc_md1211}
...
\DoxyCodeLine{getresolver/after/once}
\end{DoxyCode}
\hypertarget{doc_decisions_global_plugins_md_autotoc_md1212}{}\doxysection{Implications}\label{doc_decisions_global_plugins_md_autotoc_md1212}
\hypertarget{doc_decisions_global_plugins_md_autotoc_md1213}{}\doxysubsection{Default Global Plugins}\label{doc_decisions_global_plugins_md_autotoc_md1213}
...
State diagrams of plugins need to be redrawn to also include global plugin states.\hypertarget{doc_decisions_global_plugins_md_autotoc_md1214}{}\doxysection{Related Decisions}\label{doc_decisions_global_plugins_md_autotoc_md1214}
\hypertarget{doc_decisions_global_plugins_md_autotoc_md1215}{}\doxysection{Notes}\label{doc_decisions_global_plugins_md_autotoc_md1215}
\hypertarget{doc_decisions_global_plugins_md_autotoc_md1216}{}\doxysubsection{Open Points}\label{doc_decisions_global_plugins_md_autotoc_md1216}

\begin{DoxyItemize}
\item How to test global plugins? (Test plugin that mounts itself on every position and checks if it is called correctly?)
\end{DoxyItemize}\hypertarget{doc_decisions_global_plugins_md_autotoc_md1217}{}\doxysection{Implementation Hints}\label{doc_decisions_global_plugins_md_autotoc_md1217}
