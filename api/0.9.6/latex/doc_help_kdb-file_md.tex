...
\Hypertarget{doc_help_kdb-file_md_md_doc_help_kdb_file}%
 \hypertarget{doc_help_kdb-file_md_autotoc_md2357}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-file_md_autotoc_md2357}
{\ttfamily kdb file $<$key name$>$}~\newline


Where {\ttfamily key name} is the name of the key to check.~\newline
\hypertarget{doc_help_kdb-file_md_autotoc_md2358}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-file_md_autotoc_md2358}
This command prints which file a given key is stored in.~\newline
 ...
 This command makes use of Elektra’s {\ttfamily resolver} plugin which the uer can learn more about by running the command {\ttfamily kdb plugin-\/info resolver}.\hypertarget{doc_help_kdb-file_md_autotoc_md2359}{}\doxysection{OPTIONS}\label{doc_help_kdb-file_md_autotoc_md2359}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-file_md_autotoc_md2360}{}\doxysection{KDB}\label{doc_help_kdb-file_md_autotoc_md2360}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-file_md_autotoc_md2361}{}\doxysection{EXAMPLES}\label{doc_help_kdb-file_md_autotoc_md2361}
To find which file a key is stored in\+:~\newline
 {\ttfamily kdb file user\+:/example/key}~\newline
\hypertarget{doc_help_kdb-file_md_autotoc_md2362}{}\doxysection{SEE ALSO}\label{doc_help_kdb-file_md_autotoc_md2362}
