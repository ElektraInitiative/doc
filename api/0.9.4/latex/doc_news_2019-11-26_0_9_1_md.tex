...
\begin{DoxyItemize}
\item \hyperlink{autotoc_md777_src_plugins_yajl_README_md}{Y\+A\+JL} , and
\item \hyperlink{autotoc_md807_src_plugins_yamlcpp_README_md}{Y\+A\+ML C\+PP}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item Yajl now correctly supports Elektras boolean types using the {\ttfamily type} plugin. For example, setting {\ttfamily on}, {\ttfamily enable} or {\ttfamily true} all map to J\+S\+O\+Ns native {\ttfamily true} value. See the \hyperlink{autotoc_md745_src_plugins_type_README_md}{type} plugin for more details about boolean types. \+\_\+(\+Philipp Gackstatter)\+\_\+
\end{DoxyItemize}
...
\item Added \hyperlink{autotoc_md767_src_plugins_xerces_README_md}{info} on how to include xerces plugin with homebrew installation. \+\_\+(Anton Hößl)\+\_\+
