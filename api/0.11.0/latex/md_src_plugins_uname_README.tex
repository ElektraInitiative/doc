...
This plugin is a storage plugin that will use the syscall {\ttfamily uname (2)}. No resolver is needed for that plugin to work.\hypertarget{md_src_plugins_uname_README_autotoc_md603}{}\doxysection{Installation}\label{md_src_plugins_uname_README_autotoc_md603}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/extra}.\hypertarget{md_src_plugins_uname_README_autotoc_md604}{}\doxysection{Special Values}\label{md_src_plugins_uname_README_autotoc_md604}
...
\item version
\item machine
\end{DoxyItemize}\hypertarget{md_src_plugins_uname_README_autotoc_md605}{}\doxysection{Errors}\label{md_src_plugins_uname_README_autotoc_md605}
The only documented error in {\ttfamily uname(2)} is when an invalid buffer is passed to it. As this is an implementation error only, this plugin should not run into errors.\hypertarget{md_src_plugins_uname_README_autotoc_md606}{}\doxysection{Restrictions}\label{md_src_plugins_uname_README_autotoc_md606}
This plugin is read-\/only.\hypertarget{md_src_plugins_uname_README_autotoc_md607}{}\doxysection{Example}\label{md_src_plugins_uname_README_autotoc_md607}
