...
\Hypertarget{doc_decisions_6_implemented_logging_md_md_doc_decisions_6_implemented_logging}%
 \hypertarget{doc_decisions_6_implemented_logging_md_autotoc_md2446}{}\doxysection{Problem}\label{doc_decisions_6_implemented_logging_md_autotoc_md2446}
Both code comments and assertions are unfortunately not very popular. A quite efficient way to still get some documentation about the code are logging statements. In Elektra they are currently inconsistent and unusable. Thus there is an urge for this decision.\hypertarget{doc_decisions_6_implemented_logging_md_autotoc_md2447}{}\doxysection{Constraints}\label{doc_decisions_6_implemented_logging_md_autotoc_md2447}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_logging_md_autotoc_md2448}{}\doxysection{Assumptions}\label{doc_decisions_6_implemented_logging_md_autotoc_md2448}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_logging_md_autotoc_md2449}{}\doxysection{Considered Alternatives}\label{doc_decisions_6_implemented_logging_md_autotoc_md2449}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_logging_md_autotoc_md2450}{}\doxysection{Decision}\label{doc_decisions_6_implemented_logging_md_autotoc_md2450}
Provide a Macro
...
{\ttfamily elektra\+Log} is implemented in a separate {\ttfamily \mbox{\hyperlink{log_8c}{log.\+c}}} file. If someone needs filtering, logging to different sources or similar, he/she simply modifies {\ttfamily \mbox{\hyperlink{log_8c}{log.\+c}}}.\hypertarget{doc_decisions_6_implemented_logging_md_autotoc_md2451}{}\doxysubsection{Severity}\label{doc_decisions_6_implemented_logging_md_autotoc_md2451}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_logging_md_autotoc_md2452}{}\doxysubsection{Modules}\label{doc_decisions_6_implemented_logging_md_autotoc_md2452}
...
The module name {\ttfamily $<$NAME$>$} shall be consistent with module names used in {\ttfamily module\+:} of {\ttfamily src/error/specification}.\hypertarget{doc_decisions_6_implemented_logging_md_autotoc_md2453}{}\doxysection{Rationale}\label{doc_decisions_6_implemented_logging_md_autotoc_md2453}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_logging_md_autotoc_md2454}{}\doxysection{Implications}\label{doc_decisions_6_implemented_logging_md_autotoc_md2454}
The current VERBOSE would be turned off forever and the code within VERBOSE needs to be migrated to {\ttfamily ELEKTRA\+\_\+\+LOG}.\hypertarget{doc_decisions_6_implemented_logging_md_autotoc_md2455}{}\doxysection{Related Decisions}\label{doc_decisions_6_implemented_logging_md_autotoc_md2455}
\hypertarget{doc_decisions_6_implemented_logging_md_autotoc_md2456}{}\doxysection{Notes}\label{doc_decisions_6_implemented_logging_md_autotoc_md2456}
