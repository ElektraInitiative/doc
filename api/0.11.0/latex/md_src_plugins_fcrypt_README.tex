...
\hypertarget{md_src_plugins_fcrypt_README_autotoc_md209}{}\doxysubsection{Introduction}\label{md_src_plugins_fcrypt_README_autotoc_md209}
...
This plugin encrypts backend files before the commit is executed (thus {\ttfamily precommit}). The plugin decrypts the backend files before the getstorage opens it (thus {\ttfamily pregetstorage}). After the getstorage plugin has read the backend file, the plugin decrypts the backend file again (thus {\ttfamily postgetstorage}).\hypertarget{md_src_plugins_fcrypt_README_autotoc_md210}{}\doxysubsection{Installation}\label{md_src_plugins_fcrypt_README_autotoc_md210}
See \mbox{\hyperlink{doc_INSTALL_md}{installation}}. The package is called {\ttfamily libelektra5-\/experimental}.\hypertarget{md_src_plugins_fcrypt_README_autotoc_md211}{}\doxysubsection{Security Considerations}\label{md_src_plugins_fcrypt_README_autotoc_md211}
...
If the temporary directory is mounted on a hard disk, GPG writes the decrypted data on that disk. Thus we recommend to either mount {\ttfamily /tmp} to a RAM disk or specify another path as temporary directory within the plugin configuration (see Configuration below).\hypertarget{md_src_plugins_fcrypt_README_autotoc_md212}{}\doxysubsection{Known Issues}\label{md_src_plugins_fcrypt_README_autotoc_md212}
...
Please note that this is a workaround until a more sustainable solution is found.\hypertarget{md_src_plugins_fcrypt_README_autotoc_md213}{}\doxysubsection{Dependencies}\label{md_src_plugins_fcrypt_README_autotoc_md213}
\hypertarget{md_src_plugins_fcrypt_README_autotoc_md214}{}\doxysubsubsection{Crypto Plugin}\label{md_src_plugins_fcrypt_README_autotoc_md214}
This plugin uses parts of the {\ttfamily crypto} plugin.\hypertarget{md_src_plugins_fcrypt_README_autotoc_md215}{}\doxysubsubsection{Gnu\+PG (\+GPG)}\label{md_src_plugins_fcrypt_README_autotoc_md215}
Please refer to crypto.\hypertarget{md_src_plugins_fcrypt_README_autotoc_md216}{}\doxysubsection{Restrictions}\label{md_src_plugins_fcrypt_README_autotoc_md216}
Please refer to crypto.\hypertarget{md_src_plugins_fcrypt_README_autotoc_md217}{}\doxysubsection{Examples}\label{md_src_plugins_fcrypt_README_autotoc_md217}
...
\href{https://asciinema.org/a/153014}{\texttt{ https\+://asciinema.\+org/a/153014}}\hypertarget{md_src_plugins_fcrypt_README_autotoc_md218}{}\doxysubsection{Configuration}\label{md_src_plugins_fcrypt_README_autotoc_md218}
\hypertarget{md_src_plugins_fcrypt_README_autotoc_md219}{}\doxysubsubsection{Signatures}\label{md_src_plugins_fcrypt_README_autotoc_md219}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_fcrypt_README_autotoc_md220}{}\doxysubsubsection{GPG Configuration}\label{md_src_plugins_fcrypt_README_autotoc_md220}
The GPG Configuration is described in crypto.\hypertarget{md_src_plugins_fcrypt_README_autotoc_md221}{}\doxysubsubsection{Textmode}\label{md_src_plugins_fcrypt_README_autotoc_md221}
...
Textmode can be disabled by setting {\ttfamily fcrypt/textmode} to {\ttfamily 0} in the plugin configuration.\hypertarget{md_src_plugins_fcrypt_README_autotoc_md222}{}\doxysubsubsection{Temporary Directory}\label{md_src_plugins_fcrypt_README_autotoc_md222}
