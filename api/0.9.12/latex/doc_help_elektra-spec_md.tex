...
\Hypertarget{doc_help_elektra-spec_md_md_doc_help_elektra_spec}%
 \hypertarget{doc_help_elektra-spec_md_autotoc_md2788}{}\doxysection{INTRODUCTION}\label{doc_help_elektra-spec_md_autotoc_md2788}
...
It is, however, not limited to this but can express any other key database semantics (new plugins might be necessary, though).\hypertarget{doc_help_elektra-spec_md_autotoc_md2789}{}\doxysection{Application}\label{doc_help_elektra-spec_md_autotoc_md2789}
...
So Keys in {\ttfamily spec} allow us to specify which keys are read by the application. The description key will be copied (referred to) to {\ttfamily folder/anotherkey} of any namespace, so that it can easily be accessed.\hypertarget{doc_help_elektra-spec_md_autotoc_md2790}{}\doxysection{Cascading Lookup}\label{doc_help_elektra-spec_md_autotoc_md2790}
...
Note that the fallback, override and cascading works on {\itshape key level}, and not like most other systems have implemented, on configuration {\itshape file level}.\hypertarget{doc_help_elektra-spec_md_autotoc_md2791}{}\doxysection{Validation}\label{doc_help_elektra-spec_md_autotoc_md2791}
...
\end{DoxyCode}
\hypertarget{doc_help_elektra-spec_md_autotoc_md2792}{}\doxysection{Mounting}\label{doc_help_elektra-spec_md_autotoc_md2792}
...
\end{DoxyCode}
\hypertarget{doc_help_elektra-spec_md_autotoc_md2793}{}\doxysection{SEE ALSO}\label{doc_help_elektra-spec_md_autotoc_md2793}
