...
\Hypertarget{doc_news_2018-11-18_0_8_25_md_md_doc_news_2018_11_18_0_8_25}%
 We are proud to present Elektra 0.\+8.\+25.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3482}{}\doxysection{What is Elektra?}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3482}
...
You can also read the news \href{https://www.libelektra.org/news/0.8.25-release}{\texttt{ on our website}}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3483}{}\doxysection{Metadata}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3483}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3484}{}\doxysection{Highlight}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3484}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3485}{}\doxysubsection{mmap storage}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3485}
...
Thanks to Mihael Pranjić for this improvement.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3486}{}\doxysubsection{Hybrid Search Algorithm for $<$tt$>$ks\+Lookup (...)$<$/tt$>$}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3486}
...
Thanks to Kurt Micheli for this improvement.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3487}{}\doxysection{Plugins}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3487}
The following section lists news about the \href{https://www.libelektra.org/plugins/readme}{\texttt{ plugins}} we updated in this release.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3488}{}\doxysubsection{Directory Value}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3488}
We improved the performance of the \href{https://libelektra.org/plugins/directoryvalue}{\texttt{ directoryvalue plugin}}. \+\_\+(René Schwaiger)\+\_\+ This plugin is used for configuration file formats that do not support that directories contain values, like it is the case in JSON. A program manipulating a 13 MB JSON file which first did not succeed within 10 hours is now finished in 44 seconds.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3489}{}\doxysubsection{Process}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3489}
There is a new, experimental plugin called \href{https://libelektra.org/plugins/process}{\texttt{ process}}. This plugin utilizes the pluginprocess library in order to execute arbitrary other plugins in an own process, acting as a proxy itself. Therefore it is not required to explicitly change a plugin\textquotesingle{}s implementation if it shall be executed in an own process. This plugin is not completely finished yet, as currently there is no way for it to mimic the proxied plugin\textquotesingle{}s contract in Elektra. It can be used with simple plugins like {\ttfamily dump} however, check the limitations in the readme for more details. \+\_\+(\+Armin Wurzinger)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3490}{}\doxysubsection{FSTab}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3490}
The detection of the {\ttfamily mntent} functions now also works correctly, if you use the compiler switch {\ttfamily -\/Werror}. \+\_\+(René Schwaiger)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3491}{}\doxysubsection{passwd}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3491}
We fixed an issue with the passwd plugin not properly setting compile flags. This resolves a problem with undefined functions when building with musl. \+\_\+(\+Lukas Winkler)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3492}{}\doxysubsection{gpgme}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3492}
The experimental \href{https://libelektra.org/plugins/gpgme}{\texttt{ gpgme plugin}} was brought into existence to provide cryptographic functions using Gnu\+GP via the {\ttfamily libgpgme} library. \+\_\+(\+Peter Nirschl)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3493}{}\doxysubsection{network}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3493}
The {\ttfamily network} plugin now also allows for non-\/numerical hosts (i.\+e. \char`\"{}localhost\char`\"{}) to be set and tries to resolve it via DNS. \+\_\+(\+Michael Zronek)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3494}{}\doxysubsection{YAMBi}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3494}
This new plugin parses a subset of YAML using a parser generated by \href{https://www.gnu.org/software/bison}{\texttt{ Bison}}. \+\_\+(René Schwaiger)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3495}{}\doxysubsection{YAML CPP}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3495}
The build system now disables the plugin automatically, if you use a GCC compiler ({\ttfamily 6.\+x} or earlier) and enable the option {\ttfamily ENABLE\+\_\+\+ASAN}. We updated the behavior, since otherwise the plugin will report memory leaks at runtime. \+\_\+(René Schwaiger)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3496}{}\doxysubsection{Yan LR}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3496}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3497}{}\doxysubsection{YAwn}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3497}
This new plugin parses a subset of YAML using the Earley Parser library YAEP. \+\_\+(René Schwaiger)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3498}{}\doxysubsection{Reference}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3498}
This new plugin can be used to validate that the value of a key is a reference to another key. \+\_\+(Klemens Böswirth)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3499}{}\doxysection{Libraries}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3499}
The text below summarizes updates to the \href{https://www.libelektra.org/libraries/readme}{\texttt{ C (and C++)-\/based libraries}} of Elektra.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3500}{}\doxysubsection{Compatibility}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3500}
...
\end{DoxyCode}
\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3501}{}\doxysubsection{Infos for Package Maintainers}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3501}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3502}{}\doxysubsection{Core}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3502}
Optimize elektra\+Ks\+Filter to not duplicate keys \+\_\+(\+Markus Raab)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3503}{}\doxysubsection{Globbing}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3503}
A new library which can be used to match keys against globbing patterns was introduced. \+\_\+(Klemens Böswirth)\+\_\+

The API is still experimental, so it should not be used externally for now.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3504}{}\doxysubsection{Ease}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3504}
{\ttfamily libease} provides the function {\ttfamily elektra\+Array\+Validate\+Base\+Name\+String}, which can be used to validate that a given string is an Elektra array name. \+\_\+(Klemens Böswirth)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3505}{}\doxysection{Bindings}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3505}
Bindings allow you to utilize Elektra using \href{https://www.libelektra.org/bindings/readme}{\texttt{ various programming languages}}. This section keeps you up-\/to-\/date with the multi-\/language support provided by Elektra.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3506}{}\doxysubsection{Ruby}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3506}
Do not use private Elektra headers for Ruby bindings as preparation for a Ruby {\ttfamily libelektra} gem. \+\_\+(\+Bernhard Denner)\+\_\+\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3507}{}\doxysection{Tools}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3507}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3508}{}\doxysection{Scripts}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3508}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3509}{}\doxysection{Documentation}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3509}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3510}{}\doxysection{Tests}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3510}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3511}{}\doxysection{Build}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3511}
\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3512}{}\doxysubsection{CMake}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3512}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3513}{}\doxysubsection{Docker}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3513}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3514}{}\doxysubsection{Vagrant}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3514}

\begin{DoxyItemize}
\item Added Vagrantfile for Ubuntu artful 32-\/bit. \+\_\+(Mihael Pranjić)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3515}{}\doxysection{Infrastructure}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3515}
\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3516}{}\doxysubsection{Jenkins}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3516}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3517}{}\doxysubsection{Travis}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3517}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3518}{}\doxysection{Website}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3518}
The website is generated from the repository, so all information about plugins, bindings and tools are always up-\/to-\/date.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3519}{}\doxysection{Outlook}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3519}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3520}{}\doxysection{Statistics}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3520}
...
We welcome new contributors!\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3521}{}\doxysection{Finished Thesis}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3521}
...
\end{DoxyItemize}\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3522}{}\doxysection{Get It!}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3522}
...
Already built API documentation can be found \href{https://doc.libelektra.org/api/0.8.25/html/}{\texttt{ here}} or \href{https://github.com/ElektraInitiative/doc/tree/master/api/0.8.25}{\texttt{ Git\+Hub}}.\hypertarget{doc_news_2018-11-18_0_8_25_md_autotoc_md3523}{}\doxysection{Stay tuned!}\label{doc_news_2018-11-18_0_8_25_md_autotoc_md3523}
