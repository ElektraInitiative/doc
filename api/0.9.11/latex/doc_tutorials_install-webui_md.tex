...
The configuration view of elektra-\/web is similar to the tree view of the \href{https://master.libelektra.org/src/tools/qt-gui}{\texttt{ qt-\/gui}}, but with dynamic fields rendered via key metadata.\hypertarget{doc_tutorials_install-webui_md_autotoc_md3899}{}\doxysection{Dependencies}\label{doc_tutorials_install-webui_md_autotoc_md3899}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3900}{}\doxysection{Building with elektra-\/web Tool}\label{doc_tutorials_install-webui_md_autotoc_md3900}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3901}{}\doxysection{Getting Started}\label{doc_tutorials_install-webui_md_autotoc_md3901}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3902}{}\doxysection{Getting Started (docker)}\label{doc_tutorials_install-webui_md_autotoc_md3902}

\begin{DoxyItemize}
\item Create and run a new docker container\+: {\ttfamily docker run -\/d -\/it -\/p 33333\+:33333 -\/p 33334\+:33334 elektra/web}
\item You can now access the client on\+: \href{http://localhost:33334}{\texttt{ http\+://localhost\+:33334}}
\item You can also build it yourself in {\ttfamily scripts/docker/web/} (see \href{\#building-docker-image}{\texttt{ Building Docker Image}})
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3903}{}\doxysection{Running from source}\label{doc_tutorials_install-webui_md_autotoc_md3903}
...
\end{DoxyItemize}
\item You can now access the client on\+: \href{http://localhost:33334}{\texttt{ http\+://localhost\+:33334}}
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3904}{}\doxysection{Use-\/cases}\label{doc_tutorials_install-webui_md_autotoc_md3904}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3905}{}\doxysubsection{Running elektra-\/web on a Single Instance}\label{doc_tutorials_install-webui_md_autotoc_md3905}
...
Now, when you open \href{http://localhost:33334}{\texttt{ http\+://localhost\+:33334}} in your browser, the configuration page for the instance will be opened immediately.\hypertarget{doc_tutorials_install-webui_md_autotoc_md3906}{}\doxysection{Overview}\label{doc_tutorials_install-webui_md_autotoc_md3906}
...
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3907}{}\doxysection{API}\label{doc_tutorials_install-webui_md_autotoc_md3907}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3908}{}\doxysection{Test REST API on localhost}\label{doc_tutorials_install-webui_md_autotoc_md3908}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3909}{}\doxysection{Auth}\label{doc_tutorials_install-webui_md_autotoc_md3909}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_install-webui_md_autotoc_md3911}{}\doxysection{Development Guides}\label{doc_tutorials_install-webui_md_autotoc_md3911}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3912}{}\doxysubsection{Updating Dependencies}\label{doc_tutorials_install-webui_md_autotoc_md3912}
...
Check for outdated dependencies via {\ttfamily npm outdated}. Dependencies can then be updated by running {\ttfamily npm update}.\hypertarget{doc_tutorials_install-webui_md_autotoc_md3913}{}\doxysubsection{Building Docker Image}\label{doc_tutorials_install-webui_md_autotoc_md3913}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_install-webui_md_autotoc_md3914}{}\doxysubsection{Adding Support for New Metadata}\label{doc_tutorials_install-webui_md_autotoc_md3914}
