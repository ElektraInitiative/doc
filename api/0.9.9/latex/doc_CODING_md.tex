...
\Hypertarget{doc_CODING_md_md_doc_CODING}%
 This document provides an introduction in how the source code of libelektra is organized and how and where to add functionality.\hypertarget{doc_CODING_md_autotoc_md1582}{}\doxysection{Folder structure}\label{doc_CODING_md_autotoc_md1582}
...
More about the structure you find in the folder\textquotesingle{}s {\ttfamily README.\+md}.\hypertarget{doc_CODING_md_autotoc_md1583}{}\doxysection{General Information}\label{doc_CODING_md_autotoc_md1583}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1584}{}\doxysection{Source Code}\label{doc_CODING_md_autotoc_md1584}
The same guidelines apply to all code in the repository including the plugins.\hypertarget{doc_CODING_md_autotoc_md1585}{}\doxysubsection{General Guidelines}\label{doc_CODING_md_autotoc_md1585}
...
If you see inconsistency within the rules do not hesitate to open an issue about it.\hypertarget{doc_CODING_md_autotoc_md1586}{}\doxysubsection{Code Comments}\label{doc_CODING_md_autotoc_md1586}
...
\end{DoxyEnumerate}\hypertarget{doc_CODING_md_autotoc_md1587}{}\doxysubsection{Coding Style}\label{doc_CODING_md_autotoc_md1587}
...
{\bfseries{Example\+:}} \href{/home/jenkins/workspace/libelektra-release/src/libs/elektra/kdb.c}{\texttt{ src/libs/elektra/kdb.\+c}}\hypertarget{doc_CODING_md_autotoc_md1589}{}\doxysubsubsection{Clang Format}\label{doc_CODING_md_autotoc_md1589}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1590}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md1590}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1591}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md1591}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1592}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md1592}
...
After that change Text\+Mate will reformat C and C++ code with {\ttfamily clang-\/format} every time you save a file.\hypertarget{doc_CODING_md_autotoc_md1593}{}\doxysubsection{C++ Guidelines}\label{doc_CODING_md_autotoc_md1593}
...
{\bfseries{Example\+:}} \href{/home/jenkins/workspace/libelektra-release/src/bindings/cpp/include/kdb.hpp}{\texttt{ src/bindings/cpp/include/kdb.\+hpp}}\hypertarget{doc_CODING_md_autotoc_md1594}{}\doxysubsection{CMake Guidelines}\label{doc_CODING_md_autotoc_md1594}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1595}{}\doxysubsubsection{cmake format}\label{doc_CODING_md_autotoc_md1595}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1596}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md1596}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1598}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md1598}
...
in a file called \href{https://macromates.com/blog/2011/git-style-configuration}{\texttt{ {\ttfamily .tm\+\_\+properties}}} in the root of Elektra’s repository.\hypertarget{doc_CODING_md_autotoc_md1599}{}\doxysubsection{Java \& Groovy Guidelines}\label{doc_CODING_md_autotoc_md1599}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1600}{}\doxysubsubsection{Usage}\label{doc_CODING_md_autotoc_md1600}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1601}{}\doxysubsection{Java\+Script Guidelines}\label{doc_CODING_md_autotoc_md1601}
\hypertarget{doc_CODING_md_autotoc_md1602}{}\doxysubsubsection{Prettier}\label{doc_CODING_md_autotoc_md1602}
We use \href{https://prettier.io}{\texttt{ {\ttfamily prettier}}} to format Java\+Script files.\hypertarget{doc_CODING_md_autotoc_md1603}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md1603}
\doxysubparagraph*{mac\+OS}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1604}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md1604}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1605}{}\doxysubsection{Markdown Guidelines}\label{doc_CODING_md_autotoc_md1605}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1606}{}\doxysubsubsection{Prettier}\label{doc_CODING_md_autotoc_md1606}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1607}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md1607}
For information on how to install the tool, please take a look at “\+Java\+Script Guidelines” → “\+Prettier” → “\+Installation”.\hypertarget{doc_CODING_md_autotoc_md1608}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md1608}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1609}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md1609}
...
\item Save your new command\+: {\ttfamily ⌘} + {\ttfamily S}
\end{DoxyEnumerate}
\end{DoxyEnumerate}\hypertarget{doc_CODING_md_autotoc_md1610}{}\doxysubsection{Shell Guidelines}\label{doc_CODING_md_autotoc_md1610}

\begin{DoxyItemize}
\item Please only use \href{https://en.wikipedia.org/wiki/POSIX}{\texttt{ POSIX}} functionality.
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1611}{}\doxysubsubsection{shfmt}\label{doc_CODING_md_autotoc_md1611}
We use \href{https://github.com/mvdan/sh}{\texttt{ {\ttfamily shfmt}}} to format Shell files in the repository.\hypertarget{doc_CODING_md_autotoc_md1612}{}\doxyparagraph{Installation}\label{doc_CODING_md_autotoc_md1612}
\doxysubparagraph*{mac\+OS}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1613}{}\doxyparagraph{Usage}\label{doc_CODING_md_autotoc_md1613}
...
\end{DoxyCode}
\hypertarget{doc_CODING_md_autotoc_md1614}{}\doxyparagraph{Tool Integration}\label{doc_CODING_md_autotoc_md1614}
...
\item Save your new command\+: {\ttfamily ⌘} + {\ttfamily S}
\end{DoxyEnumerate}
\end{DoxyEnumerate}\hypertarget{doc_CODING_md_autotoc_md1615}{}\doxysubsection{Doxygen Guidelines}\label{doc_CODING_md_autotoc_md1615}
...
\end{DoxyItemize}\hypertarget{doc_CODING_md_autotoc_md1616}{}\doxysubsection{File Headers}\label{doc_CODING_md_autotoc_md1616}
...
The duplication of the filename, author and date is not needed, because this information is tracked using git and \mbox{\hyperlink{doc_AUTHORS_md}{doc/\+AUTHORS.md}} already.\hypertarget{doc_CODING_md_autotoc_md1617}{}\doxysection{Further Readings}\label{doc_CODING_md_autotoc_md1617}
