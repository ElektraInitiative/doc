...
{\ttfamily Key\+Set} and {\ttfamily Key} already handle most parts of checking pre-\/ and postconditions imposed on data structures. Elektra’s core provides preconditions and weak postconditions for the plugins.\hypertarget{doc_help_elektra-contracts_md_autotoc_md2743}{}\doxysection{SEE ALSO}\label{doc_help_elektra-contracts_md_autotoc_md2743}
