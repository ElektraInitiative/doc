...
\end{DoxyCode}
\hypertarget{doc_tutorials_benchmarking_md_autotoc_md3502}{}\doxysubsection{Using the Plugin Benchmark Helper Tool}\label{doc_tutorials_benchmarking_md_autotoc_md3502}
...
. As you can see in the output above a real configuration file that tests the performance of the \mbox{\hyperlink{md_src_plugins_yamlcpp_README}{YAML CPP}} plugin should be much larger.\hypertarget{doc_tutorials_benchmarking_md_autotoc_md3503}{}\doxysubsection{Comparing Execution Times}\label{doc_tutorials_benchmarking_md_autotoc_md3503}
