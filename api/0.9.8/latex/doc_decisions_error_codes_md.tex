...
\Hypertarget{doc_decisions_error_codes_md_md_doc_decisions_error_codes}%
 \hypertarget{doc_decisions_error_codes_md_autotoc_md1799}{}\doxysection{Problem}\label{doc_decisions_error_codes_md_autotoc_md1799}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_codes_md_autotoc_md1800}{}\doxysection{Constraints}\label{doc_decisions_error_codes_md_autotoc_md1800}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_codes_md_autotoc_md1801}{}\doxysection{Assumptions}\label{doc_decisions_error_codes_md_autotoc_md1801}
\hypertarget{doc_decisions_error_codes_md_autotoc_md1802}{}\doxysection{Considered Alternatives}\label{doc_decisions_error_codes_md_autotoc_md1802}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_codes_md_autotoc_md1803}{}\doxysection{Decision}\label{doc_decisions_error_codes_md_autotoc_md1803}
...
To see an explanation of the categories along with a guideline on how to categorize please see the \mbox{\hyperlink{doc_dev_error-categorization_md}{Error Codes Guideline}}\hypertarget{doc_decisions_error_codes_md_autotoc_md1804}{}\doxysection{Rationale}\label{doc_decisions_error_codes_md_autotoc_md1804}
...
These categories are chosen because they can help developers to react programmatically and cover the majority of use cases to our present knowledge. If there is ever the need for another reaction based category, it can be extended very easily.\hypertarget{doc_decisions_error_codes_md_autotoc_md1805}{}\doxysection{Implications}\label{doc_decisions_error_codes_md_autotoc_md1805}
...
Current errors will be migrated.\hypertarget{doc_decisions_error_codes_md_autotoc_md1806}{}\doxysection{Related Decisions}\label{doc_decisions_error_codes_md_autotoc_md1806}
...
\end{DoxyItemize}\hypertarget{doc_decisions_error_codes_md_autotoc_md1807}{}\doxysection{Notes}\label{doc_decisions_error_codes_md_autotoc_md1807}
