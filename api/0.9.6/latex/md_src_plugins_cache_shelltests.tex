...
This file contains important shell tests for mmapstorage which do not fit well into the plugin README.\hypertarget{md_src_plugins_cache_shelltests_autotoc_md73}{}\doxysection{Test kdb cp with cache and default resolver (refression test)}\label{md_src_plugins_cache_shelltests_autotoc_md73}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_cache_shelltests_autotoc_md74}{}\doxysection{Test kdb cp with cache and multifile resolver (refression test)}\label{md_src_plugins_cache_shelltests_autotoc_md74}
