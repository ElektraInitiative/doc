...
See \href{https://libelektra.org}{\texttt{ https\+://libelektra.\+org}}\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2735}{}\doxysection{Overview}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2735}
...
\item the spec mount.
\end{DoxyEnumerate}\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2737}{}\doxysection{Spec Plugin}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2737}
...
But we want {\ttfamily check/type} to be not only a documentation, but also enforced.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2738}{}\doxysection{Spec Mount}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2738}
...
The main idea of the spec-\/mount is\+: search a plugin for every specification (metadata) found in the spec-\/namespace.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2739}{}\doxysection{General Mount Improvements}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2739}
...
Thanks to Manuel Mausz for fixing many bugs related to the library split and also adapting all the bindings for it.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2741}{}\doxysubsection{Benchmark}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2741}
...
{\ttfamily libelektra.\+so} is still present for compatibility reasons. It should not be used for new applications. Some unimportant parts, however, moved to the \char`\"{}sugar\char`\"{} libraries. E.\+g. the symbol {\ttfamily elektra\+Key\+Cut\+Name\+Part} is no longer part of {\ttfamily libelektra.\+so}.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2743}{}\doxysubsection{Bootstrapping}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2743}
...
\href{https://github.com/ElektraInitiative/libelektra/blob/master/doc/decisions/bootstrap.md}{\texttt{ Details are here}}\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2744}{}\doxysection{Plugins}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2744}
...
Larger changes were done in the following plugins\+:\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2745}{}\doxysubsection{INI}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2745}
...
A huge thanks to Thomas Waser.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2746}{}\doxysubsection{Rename}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2746}
Thanks to Thomas Waser {\ttfamily rename} is now fixed for cascading keys. Additionally, it does not change the {\ttfamily sync} status of the keys so that notification plugins work properly afterwards.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2747}{}\doxysubsection{Crypto}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2747}
...
Thanks to Peter Nirschl, especially the patience for also supporting different platforms where dependencies need to be handled differently.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2748}{}\doxysection{KDB}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2748}
...
\end{DoxyItemize}\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2750}{}\doxysection{C++11 migration}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2750}
...
If you haven\textquotesingle{}t removed it from your flags already, there is no use anymore to set {\ttfamily ENABLE\+\_\+\+CXX11}.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2751}{}\doxysection{Documentation}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2751}
...
\end{DoxyItemize}\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2753}{}\doxysection{Packaging and Build System}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2753}
...
Read about \href{https://github.com/ElektraInitiative/libelektra\#packages}{\texttt{ other packages here}}.\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2754}{}\doxysection{Fixes and Improvements}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2754}
...
\end{DoxyItemize}\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2755}{}\doxysection{Get It!}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2755}
...
already built API-\/\+Docu can be found \href{https://doc.libelektra.org/api/0.8.15/html/}{\texttt{ here}}\hypertarget{doc_news_2016-02-16_0_8_15_md_autotoc_md2756}{}\doxysection{Stay tuned!}\label{doc_news_2016-02-16_0_8_15_md_autotoc_md2756}
