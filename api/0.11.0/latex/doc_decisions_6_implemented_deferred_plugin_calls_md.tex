...
\Hypertarget{doc_decisions_6_implemented_deferred_plugin_calls_md_md_doc_decisions_6_implemented_deferred_plugin_calls}%
 \hypertarget{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2333}{}\doxysection{Issue}\label{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2333}
...
Other examples is the \char`\"{}multifile\char`\"{} plugin which use multiple plugins to support different file formats. These plugins also \char`\"{}hide\char`\"{} functions exported by encapsulated plugins.\hypertarget{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2334}{}\doxysection{Constraints}\label{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2334}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2335}{}\doxysection{Assumptions}\label{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2335}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2336}{}\doxysection{Considered Alternatives}\label{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2336}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2337}{}\doxysection{Decision}\label{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2337}
...
Plugins that support deferred calls shall have the following declaration for their functions {\ttfamily void some\+Plugin\+Function (Plugin $\ast$ plugin, Key\+Set $\ast$ parameters)}. The calling developer is responsible for ensuring that the called functions have a compatible declaration. Encapsulated plugins that do not export a specified function name are omitted.\hypertarget{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2338}{}\doxysection{Argument}\label{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2338}
The solution allows changing encapsulating plugin implementations without breaking callers.\hypertarget{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2339}{}\doxysection{Implications}\label{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2339}
The called function receive their parameters via a Key\+Set.

While called functions could return data using the {\ttfamily parameters} Key\+Set (or a separate Key\+Set) there is no defined moment when the data can be collected. Defining such a moment would break the lazy-\/loading constraint. It is recommended to use callbacks passed as {\ttfamily parameters}. Callback function declarations are not limited by this decision.\hypertarget{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2340}{}\doxysection{Related Decisions}\label{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2340}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2341}{}\doxysection{Notes}\label{doc_decisions_6_implemented_deferred_plugin_calls_md_autotoc_md2341}
