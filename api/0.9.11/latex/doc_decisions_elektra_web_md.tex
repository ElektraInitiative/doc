...
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_md_autotoc_md1799}{}\doxysection{Assumptions}\label{doc_decisions_elektra_web_md_autotoc_md1799}
\hypertarget{doc_decisions_elektra_web_md_autotoc_md1800}{}\doxysection{Considered Alternatives}\label{doc_decisions_elektra_web_md_autotoc_md1800}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{doc_decisions_elektra_web_md_autotoc_md1801}{}\doxysection{Decision}\label{doc_decisions_elektra_web_md_autotoc_md1801}
Use one cluster daemon (clusterd) to manage all clusters and instances.\hypertarget{doc_decisions_elektra_web_md_autotoc_md1802}{}\doxysection{Rationale}\label{doc_decisions_elektra_web_md_autotoc_md1802}
