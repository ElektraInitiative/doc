\label{doc_decisions_4_decided_library_directory_structure_md_md_doc_decisions_4_decided_library_directory_structure}%
\Hypertarget{doc_decisions_4_decided_library_directory_structure_md_md_doc_decisions_4_decided_library_directory_structure}%
 \hypertarget{doc_decisions_4_decided_library_directory_structure_md_autotoc_md2133}{}\doxysection{Problem}\label{doc_decisions_4_decided_library_directory_structure_md_autotoc_md2133}
Currently {\ttfamily src/libs/elektra} contains the source of several libraries. Each of the libraries should have its own folder. Furthermore, we need to allow rust source to exist in parallel.\hypertarget{doc_decisions_4_decided_library_directory_structure_md_autotoc_md2134}{}\doxysection{Constraints}\label{doc_decisions_4_decided_library_directory_structure_md_autotoc_md2134}
...
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_library_directory_structure_md_autotoc_md2135}{}\doxysection{Assumptions}\label{doc_decisions_4_decided_library_directory_structure_md_autotoc_md2135}
\hypertarget{doc_decisions_4_decided_library_directory_structure_md_autotoc_md2136}{}\doxysection{Considered Alternatives}\label{doc_decisions_4_decided_library_directory_structure_md_autotoc_md2136}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_library_directory_structure_md_autotoc_md2137}{}\doxysection{Decision}\label{doc_decisions_4_decided_library_directory_structure_md_autotoc_md2137}
...
For now benchmarks will remain in the top-\/level {\ttfamily benchmarks} directory, unless there is a language specific reason to have them next to the code they benchmark (like unit-\/tests). In future this may change to facilitate automated performance-\/regression tests.\hypertarget{doc_decisions_4_decided_library_directory_structure_md_autotoc_md2138}{}\doxysection{Rationale}\label{doc_decisions_4_decided_library_directory_structure_md_autotoc_md2138}
...
Therefore, the top-\/level project should only exist, if the language allows projects that only include sub-\/modules. Otherwise, fully separate projects for every plugin/library/etc. should be used to preserve modularity.\hypertarget{doc_decisions_4_decided_library_directory_structure_md_autotoc_md2139}{}\doxysection{Implications}\label{doc_decisions_4_decided_library_directory_structure_md_autotoc_md2139}
\hypertarget{doc_decisions_4_decided_library_directory_structure_md_autotoc_md2140}{}\doxysection{Related Decisions}\label{doc_decisions_4_decided_library_directory_structure_md_autotoc_md2140}

\begin{DoxyItemize}
\item \mbox{\hyperlink{doc_decisions_4_decided_header_file_structure_md}{Header File Structure}}
\end{DoxyItemize}\hypertarget{doc_decisions_4_decided_library_directory_structure_md_autotoc_md2141}{}\doxysection{Notes}\label{doc_decisions_4_decided_library_directory_structure_md_autotoc_md2141}
