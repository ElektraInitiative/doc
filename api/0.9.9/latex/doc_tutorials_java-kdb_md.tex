...
\Hypertarget{doc_tutorials_java-kdb_md_md_doc_tutorials_java_kdb}%
 \hypertarget{doc_tutorials_java-kdb_md_autotoc_md3796}{}\doxysection{Introduction}\label{doc_tutorials_java-kdb_md_autotoc_md3796}
When programming in Java it is possible to access the key database, changing values of existing keys or adding new ones and a few other things. It is also possible to write plugins for Elektra in Java but we will focus on using the Java binding in this tutorial.\hypertarget{doc_tutorials_java-kdb_md_autotoc_md3797}{}\doxysection{First Steps}\label{doc_tutorials_java-kdb_md_autotoc_md3797}
...
If an error occurs, detailed information can be obtained from the thrown {\ttfamily KDBException}.\hypertarget{doc_tutorials_java-kdb_md_autotoc_md3798}{}\doxysection{A word about releasing native resources}\label{doc_tutorials_java-kdb_md_autotoc_md3798}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_java-kdb_md_autotoc_md3800}{}\doxysection{Saving Keys}\label{doc_tutorials_java-kdb_md_autotoc_md3800}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_java-kdb_md_autotoc_md3803}{}\doxysubsection{Read Multiple Keys From KDB}\label{doc_tutorials_java-kdb_md_autotoc_md3803}
This example shows how to read multiple keys. It provides comments for further clarification. Further information can be found here.\hypertarget{doc_tutorials_java-kdb_md_autotoc_md3804}{}\doxysection{Java Plugin Tutorial}\label{doc_tutorials_java-kdb_md_autotoc_md3804}
