...
We are proud to release Elektra 0.\+9.\+5.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3432}{}\doxysection{What is Elektra?}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3432}
...
You can try out the latest Elektra release using our docker image \href{https://hub.docker.com/r/elektra/elektra}{\texttt{ elektra/elektra}}. This is the quickest way to get started with Elektra without compiling and other obstacles, simply run {\ttfamily docker run -\/it elektra/elektra}.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3433}{}\doxysection{Highlights}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3433}
...
\label{_hl-1}%
\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3434}{}\doxysubsection{$<$tt$>$kdb\+Open$<$/tt$>$ Contracts}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3434}
...
For more information take a look at \mbox{\hyperlink{doc_dev_kdb-contracts_md}{doc/dev/kdb-\/contracts.md}}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3435}{}\doxysection{Plugins}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3435}
The following section lists news about the \href{https://www.libelektra.org/plugins/readme}{\texttt{ plugins}} we updated in this release.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3436}{}\doxysubsection{Cache}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3436}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3437}{}\doxysubsection{internalnotification}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3437}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3438}{}\doxysubsection{Dbus \& Dbusrecv}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3438}

\begin{DoxyItemize}
\item Internal changes to ensure compatibility with the new {\ttfamily elektra\+Notification\+Contract}. \+\_\+(Klemens Böswirth)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3439}{}\doxysubsection{YAML Smith \& Yan LR}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3439}

\begin{DoxyItemize}
\item Removed plugins {\ttfamily yamlsmith} and {\ttfamily yanlr}. \+\_\+(René Schwaiger)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3440}{}\doxysubsection{Zeromqsend \& Zeromqrecv}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3440}

\begin{DoxyItemize}
\item Internal changes to ensure compatibility with the new {\ttfamily elektra\+Notification\+Contract}. \+\_\+(Klemens Böswirth)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3441}{}\doxysection{Libraries}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3441}
The text below summarizes updates to the \href{https://www.libelektra.org/libraries/readme}{\texttt{ C (and C++)-\/based libraries}} of Elektra.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3442}{}\doxysubsection{Compatibility}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3442}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3443}{}\doxysubsection{Core}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3443}
\label{_key-copy}%
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3444}{}\doxysubsection{Io}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3444}

\begin{DoxyItemize}
\item {\ttfamily elektra\+Set\+Io\+Binding} has been removed. Use {\ttfamily elektra\+Io\+Contract} instead. \+\_\+(Klemens Böswirth)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3445}{}\doxysubsection{Notification}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3445}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3446}{}\doxysection{Bindings}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3446}
Bindings allow you to utilize Elektra using \href{https://www.libelektra.org/bindings/readme}{\texttt{ various programming languages}}. This section keeps you up to date with the multi-\/language support provided by Elektra.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3447}{}\doxysubsection{JNA}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3447}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3448}{}\doxysubsubsection{Outlook}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3448}
Ongoing work on bringing the JNA binding up to scratch and improving developer experience. Both for JNA binding API consumers, as well as future JNA binding contrubutors. \+\_\+(\+Michael Tucek)\+\_\+\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3449}{}\doxysubsection{Python \& Lua}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3449}
Add support for keyset.\+remove(key). \+\_\+(\+Manuel Mausz)\+\_\+\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3450}{}\doxysection{Tools}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3450}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3451}{}\doxysection{Examples}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3451}

\begin{DoxyItemize}
\item Fix enums in examples/spec. \+\_\+(\+Markus Raab)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3452}{}\doxysection{Documentation}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3452}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3453}{}\doxysection{Tests}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3453}

\begin{DoxyItemize}
\item Added small test for jna Return plugin ({\ttfamily Return.\+java}), {\ttfamily Key\+Name\+Iterator.\+java} \+\_\+(@aaronabebe)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3454}{}\doxysection{Packaging}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3454}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3455}{}\doxysection{Build}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3455}
\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3456}{}\doxysubsection{CMake}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3456}

\begin{DoxyItemize}
\item Fix issue where the library runpaths of the jni plugin could not be resolved. \+\_\+(\+Robert Sowula)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3457}{}\doxysubsection{Docker}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3457}

\begin{DoxyItemize}
\item Update Alpine Linux images to version 3.\+13.\+1 and update Elektra release image. \+\_\+(Mihael Pranjić)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3458}{}\doxysection{Infrastructure}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3458}
\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3459}{}\doxysubsection{Cirrus}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3459}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3460}{}\doxysubsection{Git\+Hub Actions}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3460}

\begin{DoxyItemize}
\item Fix issues with {\ttfamily dbus} and java paths, exclude {\ttfamily jni}. \+\_\+(Mihael Pranjić)\+\_\+
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3461}{}\doxysubsection{Jenkins}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3461}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3462}{}\doxysection{Website}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3462}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3463}{}\doxysection{Outlook}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3463}
...
\end{DoxyItemize}\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3464}{}\doxysection{Statistics}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3464}
...
Thanks to all authors for making this release possible!\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3465}{}\doxysection{Join the Initiative!}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3465}
...
As first step, you could give us feedback about these release notes. Contact us via our \href{https://issues.libelektra.org}{\texttt{ issue tracker}}.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3466}{}\doxysection{Get the Release!}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3466}
...
Already built API-\/\+Docu can be found \href{https://doc.libelektra.org/api/0.9.5/html/}{\texttt{ here}} or on \href{https://github.com/ElektraInitiative/doc/tree/master/api/0.9.5}{\texttt{ Git\+Hub}}.\hypertarget{doc_news_2021-04-12_0_9_5_md_autotoc_md3467}{}\doxysection{Stay tuned!}\label{doc_news_2021-04-12_0_9_5_md_autotoc_md3467}
