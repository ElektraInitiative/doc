...
\Hypertarget{doc_INSTALL_md_md_doc_INSTALL}%
 \hypertarget{doc_INSTALL_md_autotoc_md2739}{}\doxysection{Status}\label{doc_INSTALL_md_autotoc_md2739}
The graph below shows an (incomplete) list of available packages for Elektra.

\href{https://repology.org/metapackage/elektra/versions}{\texttt{ }}\hypertarget{doc_INSTALL_md_autotoc_md2740}{}\doxysection{Linux}\label{doc_INSTALL_md_autotoc_md2740}
...
\end{DoxyItemize}\hypertarget{doc_INSTALL_md_autotoc_md2741}{}\doxysubsection{Debian/\+Ubuntu}\label{doc_INSTALL_md_autotoc_md2741}
...
\hypertarget{doc_INSTALL_md_autotoc_md2742}{}\doxysubsection{Fedora}\label{doc_INSTALL_md_autotoc_md2742}
...
\end{DoxyCode}
\hypertarget{doc_INSTALL_md_autotoc_md2743}{}\doxysubsection{open\+SUSE}\label{doc_INSTALL_md_autotoc_md2743}
...
\end{DoxyCode}
\hypertarget{doc_INSTALL_md_autotoc_md2744}{}\doxysubsection{Install}\label{doc_INSTALL_md_autotoc_md2744}
...
\end{DoxyCode}
\hypertarget{doc_INSTALL_md_autotoc_md2745}{}\doxysection{mac\+OS}\label{doc_INSTALL_md_autotoc_md2745}
...
. We also provide a tap containing a more elaborate formula \href{http://github.com/ElektraInitiative/homebrew-elektra}{\texttt{ here}}.\hypertarget{doc_INSTALL_md_autotoc_md2746}{}\doxysection{Windows}\label{doc_INSTALL_md_autotoc_md2746}
...
Otherwise please refer to the section {\ttfamily OS Independent} below.\hypertarget{doc_INSTALL_md_autotoc_md2747}{}\doxysection{OS Independent}\label{doc_INSTALL_md_autotoc_md2747}
First follow the steps in \mbox{\hyperlink{doc_COMPILE_md}{COMPILE}}.

After you completed building Elektra on your own, there are multiple options how to install it. For example, with make or CPack tools. We recommend using the packages from our build server or that you generate your own packages with CPack.\hypertarget{doc_INSTALL_md_autotoc_md2748}{}\doxysubsection{CPack}\label{doc_INSTALL_md_autotoc_md2748}
...
\hypertarget{doc_INSTALL_md_autotoc_md2749}{}\doxysubsubsection{Debian/\+Ubuntu}\label{doc_INSTALL_md_autotoc_md2749}
...
(Otherwise you\textquotesingle{}ll see an error file utility is not available, breaking CPACK\+\_\+\+DEBIAN\+\_\+\+PACKAGE\+\_\+\+SHLIBDEPS and CPACK\+\_\+\+DEBIAN\+\_\+\+PACKAGE\+\_\+\+GENERATE\+\_\+\+SHLIBS.)
...
\end{DoxyCode}
\hypertarget{doc_INSTALL_md_autotoc_md2750}{}\doxysubsubsection{Fedora}\label{doc_INSTALL_md_autotoc_md2750}
...
\end{DoxyCode}
\hypertarget{doc_INSTALL_md_autotoc_md2751}{}\doxysubsection{make}\label{doc_INSTALL_md_autotoc_md2751}
...
\end{DoxyCode}
\hypertarget{doc_INSTALL_md_autotoc_md2752}{}\doxysection{Troubleshooting}\label{doc_INSTALL_md_autotoc_md2752}
\hypertarget{doc_INSTALL_md_autotoc_md2753}{}\doxysubsection{Error Loading Libraries}\label{doc_INSTALL_md_autotoc_md2753}
...
and run {\ttfamily ldconfig} as root.\hypertarget{doc_INSTALL_md_autotoc_md2754}{}\doxysection{Installation Manuals}\label{doc_INSTALL_md_autotoc_md2754}
For some plugins and tools that ship with Elektra, additional installation manuals have been written. You can find them in the \mbox{\hyperlink{md_doc_tutorials_README_doc_tutorials_README_md}{tutorial overview}}.\hypertarget{doc_INSTALL_md_autotoc_md2755}{}\doxysection{See Also}\label{doc_INSTALL_md_autotoc_md2755}
