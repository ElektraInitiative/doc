This file serves as a tutorial on how to get started with writing a java plugin.\hypertarget{doc_tutorials_java-plugins_md_autotoc_md2684}{}\doxysection{Basics}\label{doc_tutorials_java-plugins_md_autotoc_md2684}
If you want to know more about plugins in general, please check out the \mbox{\hyperlink{doc_tutorials_plugins_md}{How-\/\+To\+: Write a Plugin}} page. If you need a tutorial for java, please check out the \mbox{\hyperlink{doc_tutorials_java-kdb_md}{How-\/\+To\+: Java kdb}} page.\hypertarget{doc_tutorials_java-plugins_md_autotoc_md2685}{}\doxysection{Two Types of Java Plugins}\label{doc_tutorials_java-plugins_md_autotoc_md2685}
...
or you can reinstall the Java S\+DK.\hypertarget{doc_tutorials_java-plugins_md_autotoc_md2687}{}\doxysubsection{J\+N\+A Binding}\label{doc_tutorials_java-plugins_md_autotoc_md2687}
...
Here we will look into, how can we write Java Plugins using -\/ {\ttfamily J\+NA Binding}.\hypertarget{doc_tutorials_java-plugins_md_autotoc_md2688}{}\doxysubsection{Writing a Plugin}\label{doc_tutorials_java-plugins_md_autotoc_md2688}
...
It is expected that each method returns -\/1 if an error occurred or 0 if everything worked as expected.\hypertarget{doc_tutorials_java-plugins_md_autotoc_md2689}{}\doxysubsection{Usage of Plugin}\label{doc_tutorials_java-plugins_md_autotoc_md2689}
