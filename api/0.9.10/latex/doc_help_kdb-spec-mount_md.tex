...
\Hypertarget{doc_help_kdb-spec-mount_md_md_doc_help_kdb_spec_mount}%
 \hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2699}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-spec-mount_md_autotoc_md2699}
...
{\ttfamily kdb smount} is an alias and can be used in the same way as {\ttfamily kdb spec-\/mount}.\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2700}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-spec-mount_md_autotoc_md2700}
...
\end{DoxyCode}
\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2701}{}\doxysection{IMPORTANT}\label{doc_help_kdb-spec-mount_md_autotoc_md2701}
...
\end{DoxyCode}
\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2702}{}\doxysection{OPTIONS}\label{doc_help_kdb-spec-mount_md_autotoc_md2702}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2703}{}\doxysection{KDB}\label{doc_help_kdb-spec-mount_md_autotoc_md2703}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2704}{}\doxysection{EXAMPLES}\label{doc_help_kdb-spec-mount_md_autotoc_md2704}
...
Additionally, add {\ttfamily ini} plugin (instead of some default resolver) with a config for INI\+:~\newline
 {\ttfamily sudo kdb spec-\/mount /example ini section=NULL}\hypertarget{doc_help_kdb-spec-mount_md_autotoc_md2705}{}\doxysection{SEE ALSO}\label{doc_help_kdb-spec-mount_md_autotoc_md2705}
