...
\Hypertarget{doc_GIT_md_md_doc_GIT}%
 \hypertarget{doc_GIT_md_autotoc_md2335}{}\doxysection{Basic GIT Commands}\label{doc_GIT_md_autotoc_md2335}
...
\end{DoxyCode}
\hypertarget{doc_GIT_md_autotoc_md2336}{}\doxysection{Basic Configuration}\label{doc_GIT_md_autotoc_md2336}
make sure to do\+:
...
\end{DoxyCode}
\hypertarget{doc_GIT_md_autotoc_md2337}{}\doxysection{The Commit Message}\label{doc_GIT_md_autotoc_md2337}
...
Most commits should have a longer description in the body.\hypertarget{doc_GIT_md_autotoc_md2338}{}\doxysection{Remote Branches}\label{doc_GIT_md_autotoc_md2338}
...
\end{DoxyVerb}
 This is the development branch. Please try to not work directly on it, but instead you should use feature branches. So the only commits on master should be non-\/fastforward merges from features branches. Commits on master should always compile and all test cases should pass successfully. (see config option above)\hypertarget{doc_GIT_md_autotoc_md2339}{}\doxysection{Local Branches}\label{doc_GIT_md_autotoc_md2339}
...
\end{DoxyCode}
\hypertarget{doc_GIT_md_autotoc_md2340}{}\doxysection{Working with forks}\label{doc_GIT_md_autotoc_md2340}
