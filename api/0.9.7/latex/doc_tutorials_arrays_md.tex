...
\Hypertarget{doc_tutorials_arrays_md_md_doc_tutorials_arrays}%
 \hypertarget{doc_tutorials_arrays_md_autotoc_md3456}{}\doxysection{Key-\/\+Value Pairs}\label{doc_tutorials_arrays_md_autotoc_md3456}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md3457}{}\doxysection{Array Keys}\label{doc_tutorials_arrays_md_autotoc_md3457}
Since Elektra sorts keys alphabetically we can use the key-\/value pair structure described above to store sequences of values (aka. arrays).\hypertarget{doc_tutorials_arrays_md_autotoc_md3458}{}\doxysubsection{Empty Arrays}\label{doc_tutorials_arrays_md_autotoc_md3458}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md3459}{}\doxysubsection{Array Elements}\label{doc_tutorials_arrays_md_autotoc_md3459}
...
For array elements with an index larger than {\ttfamily 9} we must add {\bfseries{underscores}} ({\ttfamily \+\_\+}) to the basename, so we do not destroy the alphabetic order of the array. For example, to add a eleventh element to our array we use the following command\+:
...
. For larger indices we add {\bfseries{one underscore less, than the number of digits}} of the index. For example, to add a element with index {\ttfamily 1337} ({\ttfamily 4} digits) we use the basename {\ttfamily \#\+\_\+\+\_\+\+\_\+1337}. We can also generate the basename programmatically\+:
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md3460}{}\doxysubsection{Metadata}\label{doc_tutorials_arrays_md_autotoc_md3460}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_arrays_md_autotoc_md3461}{}\doxysection{Closing Remarks}\label{doc_tutorials_arrays_md_autotoc_md3461}
