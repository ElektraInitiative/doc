...
Again we managed to release with new features, many build system fixes and also other improvements.\hypertarget{doc_news_2015-07-13_0_8_12_md_autotoc_md3188}{}\doxysection{dir namespace}\label{doc_news_2015-07-13_0_8_12_md_autotoc_md3188}
...
Obviously, that does not only work with kdb, but with every elektrified tool.\hypertarget{doc_news_2015-07-13_0_8_12_md_autotoc_md3189}{}\doxysubsection{mount files in dir namespaces}\label{doc_news_2015-07-13_0_8_12_md_autotoc_md3189}
...
In both cases keys below dir/sw/editor would be in the INI file {\ttfamily .dir/editor.\+ini} and not in the file {\ttfamily .dir/default.\+ecf}.\hypertarget{doc_news_2015-07-13_0_8_12_md_autotoc_md3190}{}\doxysubsection{dir together with spec namespace}\label{doc_news_2015-07-13_0_8_12_md_autotoc_md3190}
...
Especially the specification provides flexibility not present in other configuration systems.\hypertarget{doc_news_2015-07-13_0_8_12_md_autotoc_md3192}{}\doxysection{Qt-\/\+Gui 0.\+0.\+7}\label{doc_news_2015-07-13_0_8_12_md_autotoc_md3192}
...
The GUI can be handy for many purposes, e.\+g. we use it already as xml and json editor. Note that there are still \href{https://git.libelektra.org/issues}{\texttt{ some bugs}}.\hypertarget{doc_news_2015-07-13_0_8_12_md_autotoc_md3193}{}\doxysection{Other fixes}\label{doc_news_2015-07-13_0_8_12_md_autotoc_md3193}
...
\end{DoxyItemize}\hypertarget{doc_news_2015-07-13_0_8_12_md_autotoc_md3194}{}\doxysection{Compatibility}\label{doc_news_2015-07-13_0_8_12_md_autotoc_md3194}
...
\item resolving of spec absolute and relative paths are no more handled identical. Instead absolute paths will be searched absolutely, while relatives are below KDB\+\_\+\+DB\+\_\+\+SPEC (as before). This behavior is consistent to the behavior of the other namespaces.
\end{DoxyItemize}

These two points are also the only unit tests that fail when Elektra 0.\+8.\+12 is used with 0.\+8.\+11 unit tests.\hypertarget{doc_news_2015-07-13_0_8_12_md_autotoc_md3195}{}\doxysection{Build Server}\label{doc_news_2015-07-13_0_8_12_md_autotoc_md3195}

\begin{DoxyItemize}
\item special Git\+Hub command to build bindings \char`\"{}jenkins build bindings please\char`\"{}, thanks to Manuel Mausz
...
\end{DoxyItemize}\hypertarget{doc_news_2015-07-13_0_8_12_md_autotoc_md3196}{}\doxysection{Get It!}\label{doc_news_2015-07-13_0_8_12_md_autotoc_md3196}
You can download the release from \href{https://www.libelektra.org/ftp/elektra/releases/elektra-0.8.12.tar.gz}{\texttt{ here}} and now also \href{https://github.com/ElektraInitiative/ftp/tree/master/releases/elektra-0.8.12.tar.gz}{\texttt{ here on Git\+Hub}}
...
already built API documentation can be found \href{https://doc.libelektra.org/api/0.8.12/html/}{\texttt{ here}}\hypertarget{doc_news_2015-07-13_0_8_12_md_autotoc_md3197}{}\doxysection{Stay tuned!}\label{doc_news_2015-07-13_0_8_12_md_autotoc_md3197}
