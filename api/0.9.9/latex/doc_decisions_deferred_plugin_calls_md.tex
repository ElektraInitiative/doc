...
\Hypertarget{doc_decisions_deferred_plugin_calls_md_md_doc_decisions_deferred_plugin_calls}%
 \hypertarget{doc_decisions_deferred_plugin_calls_md_autotoc_md1753}{}\doxysection{Issue}\label{doc_decisions_deferred_plugin_calls_md_autotoc_md1753}
...
Other examples are the \char`\"{}dini\char`\"{} and \char`\"{}multifile\char`\"{} plugins which use multiple plugins to support different file formats. These plugins also \char`\"{}hide\char`\"{} functions exported by encapsulated plugins.\hypertarget{doc_decisions_deferred_plugin_calls_md_autotoc_md1754}{}\doxysection{Constraints}\label{doc_decisions_deferred_plugin_calls_md_autotoc_md1754}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_deferred_plugin_calls_md_autotoc_md1755}{}\doxysection{Assumptions}\label{doc_decisions_deferred_plugin_calls_md_autotoc_md1755}
...
\end{DoxyEnumerate}\hypertarget{doc_decisions_deferred_plugin_calls_md_autotoc_md1756}{}\doxysection{Considered Alternatives}\label{doc_decisions_deferred_plugin_calls_md_autotoc_md1756}
...
\end{DoxyItemize}\hypertarget{doc_decisions_deferred_plugin_calls_md_autotoc_md1757}{}\doxysection{Decision}\label{doc_decisions_deferred_plugin_calls_md_autotoc_md1757}
...
Plugins that support deferred calls shall have the following declaration for their functions {\ttfamily void some\+Plugin\+Function (Plugin $\ast$ plugin, Key\+Set $\ast$ parameters)}. The calling developer is responsible for ensuring that the called functions have a compatible declaration. Encapsulated plugins that do not export a specified function name are omitted.\hypertarget{doc_decisions_deferred_plugin_calls_md_autotoc_md1758}{}\doxysection{Argument}\label{doc_decisions_deferred_plugin_calls_md_autotoc_md1758}
The solution allows changing encapsulating plugin implementations without breaking callers.\hypertarget{doc_decisions_deferred_plugin_calls_md_autotoc_md1759}{}\doxysection{Implications}\label{doc_decisions_deferred_plugin_calls_md_autotoc_md1759}
The called function receive their parameters via a Key\+Set.

While called functions could return data using the {\ttfamily parameters} Key\+Set (or a separate Key\+Set) there is no defined moment when the data can be collected. Defining such a moment would break the lazy-\/loading constraint. It is recommended to use callbacks passed as {\ttfamily parameters}. Callback function declarations are not limited by this decision.\hypertarget{doc_decisions_deferred_plugin_calls_md_autotoc_md1760}{}\doxysection{Related Decisions}\label{doc_decisions_deferred_plugin_calls_md_autotoc_md1760}
...
\end{DoxyItemize}\hypertarget{doc_decisions_deferred_plugin_calls_md_autotoc_md1761}{}\doxysection{Notes}\label{doc_decisions_deferred_plugin_calls_md_autotoc_md1761}
