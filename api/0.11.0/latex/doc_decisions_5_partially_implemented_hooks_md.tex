...
\Hypertarget{doc_decisions_5_partially_implemented_hooks_md_md_doc_decisions_5_partially_implemented_hooks}%
 \hypertarget{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2227}{}\doxysection{Problem}\label{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2227}
...
These problems can be traced back to the placement of the plugins. We need to clean up and simplify the placement.\hypertarget{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2228}{}\doxysection{Constraints}\label{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2228}
...
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2229}{}\doxysection{Assumptions}\label{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2229}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2230}{}\doxysection{Considered Alternatives}\label{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2230}
...
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2231}{}\doxysection{Decision}\label{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2231}
...
We\textquotesingle{}ll hard code the names of the plugins. For changing those plugins symlinks will have to be used.\hypertarget{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2232}{}\doxysection{Rationale}\label{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2232}
...
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2233}{}\doxysection{Implications}\label{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2233}
...
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2234}{}\doxysection{Related Decisions}\label{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2234}
...
\end{DoxyItemize}\hypertarget{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2235}{}\doxysection{Notes}\label{doc_decisions_5_partially_implemented_hooks_md_autotoc_md2235}
