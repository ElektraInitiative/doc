...
\end{DoxyInlineImage}
\hypertarget{src_plugins_README_md_autotoc_md458}{}\doxysubsection{C-\/\+Interface}\label{src_plugins_README_md_autotoc_md458}
...
\end{DoxyItemize}\hypertarget{src_plugins_README_md_autotoc_md459}{}\doxysubsection{KDB-\/\+Interface}\label{src_plugins_README_md_autotoc_md459}
...
\end{DoxyItemize}\hypertarget{src_plugins_README_md_autotoc_md460}{}\doxysection{Installation}\label{src_plugins_README_md_autotoc_md460}
See \mbox{\hyperlink{doc_INSTALL_md}{INSTALL}}. Many plugins are already part of the core package {\ttfamily libelektra5}. The package that includes a plugin which does not belong to the {\ttfamily libelektra5} package can be found in it\textquotesingle{}s README.\+md.\hypertarget{src_plugins_README_md_autotoc_md461}{}\doxysection{See Also}\label{src_plugins_README_md_autotoc_md461}
For an easy introduction, see \mbox{\hyperlink{doc_tutorials_plugins_md}{this tutorial how to write a storage plugin}}. For more background information of the \mbox{\hyperlink{doc_dev_plugins-framework_md}{plugins framework, continue here}}. Otherwise, you can visit the \href{https://doc.libelektra.org/api/latest/html/group__plugin.html}{\texttt{ the API documentation}}.\hypertarget{src_plugins_README_md_autotoc_md462}{}\doxysection{Plugins}\label{src_plugins_README_md_autotoc_md462}
\hypertarget{src_plugins_README_md_autotoc_md463}{}\doxysubsection{Backends}\label{src_plugins_README_md_autotoc_md463}
...
\item backend\+\_\+odbc provides access to ODBC data sources for storing configuration data (keys, values, metadata)
\end{DoxyItemize}\hypertarget{src_plugins_README_md_autotoc_md464}{}\doxysubsection{Resolver}\label{src_plugins_README_md_autotoc_md464}
...
\end{DoxyItemize}\hypertarget{src_plugins_README_md_autotoc_md465}{}\doxysubsection{Storage}\label{src_plugins_README_md_autotoc_md465}
...
\item ansible writes the given Key\+Set as Ansible Playbook that uses the \href{https://galaxy.ansible.com/elektra_initiative/libelektra}{\texttt{ ansible-\/libelektra}} module
\end{DoxyItemize}
...
\end{DoxyItemize}\hypertarget{src_plugins_README_md_autotoc_md466}{}\doxysubsection{System Information}\label{src_plugins_README_md_autotoc_md466}
...
\end{DoxyItemize}\hypertarget{src_plugins_README_md_autotoc_md467}{}\doxysubsection{Filter}\label{src_plugins_README_md_autotoc_md467}
...
\end{DoxyItemize}\hypertarget{src_plugins_README_md_autotoc_md468}{}\doxysubsection{Notification and Logging}\label{src_plugins_README_md_autotoc_md468}
...
\end{DoxyItemize}\hypertarget{src_plugins_README_md_autotoc_md469}{}\doxysubsection{Debug}\label{src_plugins_README_md_autotoc_md469}
...
\end{DoxyItemize}\hypertarget{src_plugins_README_md_autotoc_md470}{}\doxysubsection{Checker}\label{src_plugins_README_md_autotoc_md470}
...
\end{DoxyItemize}\hypertarget{src_plugins_README_md_autotoc_md471}{}\doxysubsection{Interpreter}\label{src_plugins_README_md_autotoc_md471}
...
\end{DoxyItemize}\hypertarget{src_plugins_README_md_autotoc_md472}{}\doxysubsection{Other Important Plugins}\label{src_plugins_README_md_autotoc_md472}
...
\item recorder is the plugin used to implement session recording
\end{DoxyItemize}\hypertarget{src_plugins_README_md_autotoc_md473}{}\doxysubsection{Plugins for Development}\label{src_plugins_README_md_autotoc_md473}
...
\end{DoxyItemize}\hypertarget{src_plugins_README_md_autotoc_md474}{}\doxysubsection{Internal Plugins}\label{src_plugins_README_md_autotoc_md474}
...
\item modules
\item version
\end{DoxyItemize}\hypertarget{src_plugins_README_md_autotoc_md475}{}\doxysubsection{Deprecated Plugins}\label{src_plugins_README_md_autotoc_md475}
