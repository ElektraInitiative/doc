...
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md395}{}\doxysubsection{$<$tt$>$benchmark\+\_\+storage$<$/tt$>$}\label{md_src_plugins_quickdump_benchmarks_autotoc_md395}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md396}{}\doxysubsection{$<$tt$>$benchmark\+\_\+plugingetset$<$/tt$>$}\label{md_src_plugins_quickdump_benchmarks_autotoc_md396}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md398}{}\doxysubsubsection{Version 1}\label{md_src_plugins_quickdump_benchmarks_autotoc_md398}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md399}{}\doxyparagraph{File sizes}\label{md_src_plugins_quickdump_benchmarks_autotoc_md399}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md400}{}\doxyparagraph{get and set}\label{md_src_plugins_quickdump_benchmarks_autotoc_md400}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md401}{}\doxyparagraph{get only}\label{md_src_plugins_quickdump_benchmarks_autotoc_md401}
The values are mean ± standard deviation. {\ttfamily factor} is {\ttfamily dump / quickdump} like above
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md402}{}\doxysubsubsection{Version 2}\label{md_src_plugins_quickdump_benchmarks_autotoc_md402}
Running the same {\ttfamily benchmark\+\_\+plugingetset} tests with version 2 of the plugin yields\+:\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md403}{}\doxyparagraph{File sizes}\label{md_src_plugins_quickdump_benchmarks_autotoc_md403}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md404}{}\doxyparagraph{get and set}\label{md_src_plugins_quickdump_benchmarks_autotoc_md404}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md405}{}\doxyparagraph{get only}\label{md_src_plugins_quickdump_benchmarks_autotoc_md405}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md406}{}\doxysubsubsection{Version 3}\label{md_src_plugins_quickdump_benchmarks_autotoc_md406}
Running the same {\ttfamily benchmark\+\_\+plugingetset} tests with version 3 of the plugin yields\+:\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md407}{}\doxyparagraph{File sizes}\label{md_src_plugins_quickdump_benchmarks_autotoc_md407}
{\ttfamily factor} is {\ttfamily v1 / v2} like above (bigger is better)
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md408}{}\doxyparagraph{get and set}\label{md_src_plugins_quickdump_benchmarks_autotoc_md408}
...
\end{longtabu}
\hypertarget{md_src_plugins_quickdump_benchmarks_autotoc_md409}{}\doxyparagraph{get only}\label{md_src_plugins_quickdump_benchmarks_autotoc_md409}
