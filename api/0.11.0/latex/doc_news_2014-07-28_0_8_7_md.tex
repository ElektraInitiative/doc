\label{doc_news_2014-07-28_0_8_7_md_md_doc_news_2014_07_28_0_8_7}%
\Hypertarget{doc_news_2014-07-28_0_8_7_md_md_doc_news_2014_07_28_0_8_7}%
...
Again, we managed to have a great feature release with dozens of corrections!\hypertarget{doc_news_2014-07-28_0_8_7_md_autotoc_md3235}{}\doxysection{New Features}\label{doc_news_2014-07-28_0_8_7_md_autotoc_md3235}
...
The contextual values now got a \href{https://master.libelektra.org/src/tools/pythongen}{\texttt{ tutorial}} and small fixes.\hypertarget{doc_news_2014-07-28_0_8_7_md_autotoc_md3236}{}\doxysection{Corrections}\label{doc_news_2014-07-28_0_8_7_md_autotoc_md3236}
Thanks to Pino Toscano for fixing a lot of spelling errors, simplify RPATH setting, respect {\ttfamily \$\+HOME} and {\ttfamily \$\+TMPDIR}, improvements of test cases, and his debian-\/packaging efforts.
...
Some remaining mem leaks in rare circumstances were fixed. Valgrind should now never report any leaks, if it does, please report the issue.\hypertarget{doc_news_2014-07-28_0_8_7_md_autotoc_md3237}{}\doxysection{API Changes}\label{doc_news_2014-07-28_0_8_7_md_autotoc_md3237}
Added del\+Meta() for C++, because set\+Meta() with NULL will set the number 0 and not remove the meta.

Arguments of is\+Below, is\+Direct\+Below, is\+Below\+Or\+Same are swapped for better readability. k.\+is\+Below(root) now means the obvious thing. The change only effects the C++ binding, key\+Is\+Below is unaffected by the change.\hypertarget{doc_news_2014-07-28_0_8_7_md_autotoc_md3238}{}\doxysection{Documentation}\label{doc_news_2014-07-28_0_8_7_md_autotoc_md3238}
\href{/home/jenkins/workspace/libelektra-release/doc/METADATA.ini}{\texttt{ Specification of metadata}} and \href{/home/jenkins/workspace/libelektra-release/doc/CONTRACT.ini}{\texttt{ contracts}} written/greatly improved.

\mbox{\hyperlink{doc_decisions_README_md}{Decisions}} are introduced again.

Most often the Key\+Set is ideal, e.\+g. when doing full iteration or when performing set operations. In some cases, however, a hierarchical data structure fits better. This is especially true for GUIs. Luckily, Keys can be in multiple data structures because of their reference counting.\hypertarget{doc_news_2014-07-28_0_8_7_md_autotoc_md3239}{}\doxysection{Other Stuff}\label{doc_news_2014-07-28_0_8_7_md_autotoc_md3239}
We now fully embrace github\+:


\begin{DoxyItemize}
\item We use its issue tracker (all issues from local text files were moved there)
\item We have rewritten many READMEs to use Git\+Hubs Markdown
...
\begin{DoxyItemize}
\item Gentoo
\item \href{https://aur.archlinux.org/packages/libelektra/}{\texttt{ Arch Linux}}
\end{DoxyItemize}
...
A special thanks to Kai-\/\+Uwe Behrmann for providing packages for \href{http://software.opensuse.org/download.html?project=home\%3Abekun&package=elektra}{\texttt{ Cent\+OS, Fedora, Open\+SUSE, RHEL and SLE}}.\hypertarget{doc_news_2014-07-28_0_8_7_md_autotoc_md3240}{}\doxysection{Get It!}\label{doc_news_2014-07-28_0_8_7_md_autotoc_md3240}
