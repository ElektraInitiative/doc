...
\item infos/status = maintained unittest nodep libc configurable unfinished
\item infos/metadata =
...
NOTE\+: currently the modifications a user can make are very limited/not possible. See \href{\#limitations}{\texttt{ Limitations}} below.\hypertarget{md_src_plugins_specload_README_autotoc_md554}{}\doxysection{Dependencies}\label{md_src_plugins_specload_README_autotoc_md554}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_specload_README_autotoc_md555}{}\doxysection{Usage}\label{md_src_plugins_specload_README_autotoc_md555}
...
Note\+: If {\ttfamily file} is specified, {\ttfamily app} will be ignored.\hypertarget{md_src_plugins_specload_README_autotoc_md557}{}\doxysection{Examples}\label{md_src_plugins_specload_README_autotoc_md557}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_specload_README_autotoc_md558}{}\doxysection{Limitations}\label{md_src_plugins_specload_README_autotoc_md558}
