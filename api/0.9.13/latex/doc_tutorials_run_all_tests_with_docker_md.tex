...
\Hypertarget{doc_tutorials_run_all_tests_with_docker_md_md_doc_tutorials_run_all_tests_with_docker}%
 Running all the tests like the build server requires multiple dependencies. To overcome this problem, instead of trying to install all the necessary dependencies on your own, an appropriate Docker image can be used. This way you can easily and quickly run all the tests.\hypertarget{doc_tutorials_run_all_tests_with_docker_md_autotoc_md4431}{}\doxysection{Who Is This Guide For?}\label{doc_tutorials_run_all_tests_with_docker_md_autotoc_md4431}
For anyone who wants to run all the tests, like it is done by the build server.

This is a step-\/by-\/step guide. Just follow the steps and you are good to go!\hypertarget{doc_tutorials_run_all_tests_with_docker_md_autotoc_md4432}{}\doxysection{Prerequisites}\label{doc_tutorials_run_all_tests_with_docker_md_autotoc_md4432}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_run_all_tests_with_docker_md_autotoc_md4433}{}\doxysection{Podman support}\label{doc_tutorials_run_all_tests_with_docker_md_autotoc_md4433}
Alternatively, you can use podman, a different container engine which is compatible with Docker. See \href{https://podman.io/}{\texttt{ https\+://podman.\+io/}} for more details and an installation guide. If you are using podman, and want to follow this tutorial, just replace the docker command with podman.\hypertarget{doc_tutorials_run_all_tests_with_docker_md_autotoc_md4434}{}\doxysection{What to Begin With?}\label{doc_tutorials_run_all_tests_with_docker_md_autotoc_md4434}
\hypertarget{doc_tutorials_run_all_tests_with_docker_md_autotoc_md4435}{}\doxysubsection{1. Docker Image}\label{doc_tutorials_run_all_tests_with_docker_md_autotoc_md4435}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_run_all_tests_with_docker_md_autotoc_md4436}{}\doxysubsection{2. Run the Docker Container}\label{doc_tutorials_run_all_tests_with_docker_md_autotoc_md4436}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_run_all_tests_with_docker_md_autotoc_md4437}{}\doxysubsection{3. Build}\label{doc_tutorials_run_all_tests_with_docker_md_autotoc_md4437}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_run_all_tests_with_docker_md_autotoc_md4438}{}\doxysubsection{4. Run Tests}\label{doc_tutorials_run_all_tests_with_docker_md_autotoc_md4438}
