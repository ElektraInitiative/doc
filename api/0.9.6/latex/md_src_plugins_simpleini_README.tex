...
This plugin reads and writes files written in a basic line-\/oriented ini-\/like format. It is very simplistic without sections, the \mbox{\hyperlink{md_src_plugins_toml_README_src_plugins_toml_README_md}{toml}} plugin and for specifications the \mbox{\hyperlink{md_src_plugins_ni_README_src_plugins_ni_README_md}{ni}} plugin should be preferred. Since the {\ttfamily simpleini} plugin requires the GNU C library it {\bfseries{will not work}} on operating systems that use another C library such as mac\+OS.\hypertarget{md_src_plugins_simpleini_README_autotoc_md486}{}\doxysection{Usage}\label{md_src_plugins_simpleini_README_autotoc_md486}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_simpleini_README_autotoc_md487}{}\doxysection{Configuration}\label{md_src_plugins_simpleini_README_autotoc_md487}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_simpleini_README_autotoc_md488}{}\doxysection{Restrictions}\label{md_src_plugins_simpleini_README_autotoc_md488}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_simpleini_README_autotoc_md489}{}\doxysection{Examples}\label{md_src_plugins_simpleini_README_autotoc_md489}
Mount the plugin\+:
...
\end{DoxyCode}
\hypertarget{md_src_plugins_simpleini_README_autotoc_md490}{}\doxysection{Limitations}\label{md_src_plugins_simpleini_README_autotoc_md490}
