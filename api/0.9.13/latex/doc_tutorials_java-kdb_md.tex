...
\Hypertarget{doc_tutorials_java-kdb_md_md_doc_tutorials_java_kdb}%
 \hypertarget{doc_tutorials_java-kdb_md_autotoc_md4322}{}\doxysection{Introduction}\label{doc_tutorials_java-kdb_md_autotoc_md4322}
When programming in Java it is possible to access the key database, changing values of existing keys or adding new ones and a few other things. It is also possible to write plugins for Elektra in Java but we will focus on using the Java binding in this tutorial.\hypertarget{doc_tutorials_java-kdb_md_autotoc_md4323}{}\doxysection{First Steps}\label{doc_tutorials_java-kdb_md_autotoc_md4323}
...
If an error occurs, detailed information can be obtained from the thrown {\ttfamily KDBException}.\hypertarget{doc_tutorials_java-kdb_md_autotoc_md4324}{}\doxysection{A word about releasing native resources}\label{doc_tutorials_java-kdb_md_autotoc_md4324}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_java-kdb_md_autotoc_md4326}{}\doxysection{Saving Keys}\label{doc_tutorials_java-kdb_md_autotoc_md4326}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_java-kdb_md_autotoc_md4329}{}\doxysubsection{Read Multiple Keys From KDB}\label{doc_tutorials_java-kdb_md_autotoc_md4329}
This example shows how to read multiple keys. It provides comments for further clarification. Further information can be found here.\hypertarget{doc_tutorials_java-kdb_md_autotoc_md4330}{}\doxysection{Java Plugin Tutorial}\label{doc_tutorials_java-kdb_md_autotoc_md4330}
