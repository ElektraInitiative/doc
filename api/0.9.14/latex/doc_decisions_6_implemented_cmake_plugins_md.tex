...
\Hypertarget{doc_decisions_6_implemented_cmake_plugins_md_md_doc_decisions_6_implemented_cmake_plugins}%
 \hypertarget{doc_decisions_6_implemented_cmake_plugins_md_autotoc_md2245}{}\doxysection{Problem}\label{doc_decisions_6_implemented_cmake_plugins_md_autotoc_md2245}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_cmake_plugins_md_autotoc_md2246}{}\doxysection{Constraints}\label{doc_decisions_6_implemented_cmake_plugins_md_autotoc_md2246}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_cmake_plugins_md_autotoc_md2247}{}\doxysection{Assumptions}\label{doc_decisions_6_implemented_cmake_plugins_md_autotoc_md2247}
\hypertarget{doc_decisions_6_implemented_cmake_plugins_md_autotoc_md2248}{}\doxysection{Considered Alternatives}\label{doc_decisions_6_implemented_cmake_plugins_md_autotoc_md2248}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_cmake_plugins_md_autotoc_md2249}{}\doxysection{Decision}\label{doc_decisions_6_implemented_cmake_plugins_md_autotoc_md2249}
...
\end{DoxyItemize}
\end{DoxyEnumerate}\hypertarget{doc_decisions_6_implemented_cmake_plugins_md_autotoc_md2250}{}\doxysection{Rationale}\label{doc_decisions_6_implemented_cmake_plugins_md_autotoc_md2250}
...
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_cmake_plugins_md_autotoc_md2251}{}\doxysection{Implications}\label{doc_decisions_6_implemented_cmake_plugins_md_autotoc_md2251}

\begin{DoxyItemize}
\item need to adopt all CMake\+Lists.\+txt
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_cmake_plugins_md_autotoc_md2252}{}\doxysection{Related Decisions}\label{doc_decisions_6_implemented_cmake_plugins_md_autotoc_md2252}

\begin{DoxyItemize}
\item \mbox{\hyperlink{doc_decisions_0a_postponed_plugin_variants_md}{Plugin Variants}}
\end{DoxyItemize}\hypertarget{doc_decisions_6_implemented_cmake_plugins_md_autotoc_md2253}{}\doxysection{Notes}\label{doc_decisions_6_implemented_cmake_plugins_md_autotoc_md2253}
\hypertarget{doc_decisions_6_implemented_cmake_plugins_md_autotoc_md2254}{}\doxysection{Limitations}\label{doc_decisions_6_implemented_cmake_plugins_md_autotoc_md2254}
