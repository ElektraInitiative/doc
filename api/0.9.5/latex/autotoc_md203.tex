...
\end{DoxyItemize}\hypertarget{autotoc_md203_src_plugins_fcrypt_README_md}{}\section{fcrypt Plugin}\label{autotoc_md203_src_plugins_fcrypt_README_md}
\hypertarget{autotoc_md203_autotoc_md204}{}\subsection{Introduction}\label{autotoc_md203_autotoc_md204}
...
If the temporary directory is mounted on a hard disk, G\+PG writes the decrypted data on that disk. Thus we recommend to either mount {\ttfamily /tmp} to a R\+AM disk or specify another path as temporary directory within the plugin configuration (see Configuration below).\hypertarget{autotoc_md203_autotoc_md206}{}\subsection{Known Issues}\label{autotoc_md203_autotoc_md206}
...
Please note that this is a workaround until a more sustainable solution is found.\hypertarget{autotoc_md203_autotoc_md207}{}\subsection{Dependencies}\label{autotoc_md203_autotoc_md207}
\hypertarget{autotoc_md203_autotoc_md208}{}\subsubsection{Crypto Plugin}\label{autotoc_md203_autotoc_md208}
This plugin uses parts of the {\ttfamily crypto} plugin.\hypertarget{autotoc_md203_autotoc_md209}{}\subsubsection{Gnu\+P\+G (\+G\+P\+G)}\label{autotoc_md203_autotoc_md209}
Please refer to \hyperlink{autotoc_md109_src_plugins_crypto_README_md}{crypto}.\hypertarget{autotoc_md203_autotoc_md210}{}\subsection{Restrictions}\label{autotoc_md203_autotoc_md210}
Please refer to \hyperlink{autotoc_md109_src_plugins_crypto_README_md}{crypto}.\hypertarget{autotoc_md203_autotoc_md211}{}\subsection{Examples}\label{autotoc_md203_autotoc_md211}
...
\href{https://asciinema.org/a/153014}{\tt https\+://asciinema.\+org/a/153014}\hypertarget{autotoc_md203_autotoc_md212}{}\subsection{Configuration}\label{autotoc_md203_autotoc_md212}
\hypertarget{autotoc_md203_autotoc_md213}{}\subsubsection{Signatures}\label{autotoc_md203_autotoc_md213}
...
gpg2 -d signed.ecf
\end{DoxyCode}
\hypertarget{autotoc_md203_autotoc_md214}{}\subsubsection{G\+P\+G Configuration}\label{autotoc_md203_autotoc_md214}
The G\+PG Configuration is described in \hyperlink{autotoc_md109_src_plugins_crypto_README_md}{crypto}.\hypertarget{autotoc_md203_autotoc_md215}{}\subsubsection{Textmode}\label{autotoc_md203_autotoc_md215}
...
Textmode can be disabled by setting {\ttfamily fcrypt/textmode} to {\ttfamily 0} in the plugin configuration.\hypertarget{autotoc_md203_autotoc_md216}{}\subsubsection{Temporary Directory}\label{autotoc_md203_autotoc_md216}
