...
However, there are some notable differences when running containers themselves as a user other than root.\hypertarget{doc_tutorials_using_podman_instead_of_docker_md_autotoc_md4453}{}\doxysection{Who Is This Guide For?}\label{doc_tutorials_using_podman_instead_of_docker_md_autotoc_md4453}
Anyone who uses Podman to run their containers.\hypertarget{doc_tutorials_using_podman_instead_of_docker_md_autotoc_md4454}{}\doxysection{Prerequisites}\label{doc_tutorials_using_podman_instead_of_docker_md_autotoc_md4454}

\begin{DoxyItemize}
\item A working Podman installation
\end{DoxyItemize}\hypertarget{doc_tutorials_using_podman_instead_of_docker_md_autotoc_md4455}{}\doxysection{Basics}\label{doc_tutorials_using_podman_instead_of_docker_md_autotoc_md4455}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_using_podman_instead_of_docker_md_autotoc_md4456}{}\doxysection{Running a container as a user other than root}\label{doc_tutorials_using_podman_instead_of_docker_md_autotoc_md4456}
