...
\Hypertarget{doc_tutorials_specification_md_md_doc_tutorials_specification}%
 \hypertarget{doc_tutorials_specification_md_autotoc_md3695}{}\doxysection{Overview}\label{doc_tutorials_specification_md_autotoc_md3695}
\hypertarget{doc_tutorials_specification_md_autotoc_md3696}{}\doxysubsection{Introduction}\label{doc_tutorials_specification_md_autotoc_md3696}
In this tutorial you will learn how to interactively use the {\ttfamily Spec\+Elektra} specification language and {\ttfamily kdb} to write a configuration specification for an example application.\hypertarget{doc_tutorials_specification_md_autotoc_md3697}{}\doxysubsection{What you should already know}\label{doc_tutorials_specification_md_autotoc_md3697}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md3698}{}\doxysubsection{What you’ll Learn}\label{doc_tutorials_specification_md_autotoc_md3698}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md3699}{}\doxysubsection{What you\textquotesingle{}ll do}\label{doc_tutorials_specification_md_autotoc_md3699}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md3700}{}\doxysection{Example App Overview}\label{doc_tutorials_specification_md_autotoc_md3700}
...
\item a backup date
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md3701}{}\doxysection{Getting Started}\label{doc_tutorials_specification_md_autotoc_md3701}
...
Otherwise refer to the \href{https://www.libelektra.org/getstarted/guide}{\texttt{ getting started guide}} to install it.\hypertarget{doc_tutorials_specification_md_autotoc_md3702}{}\doxysection{Mounting the Specification}\label{doc_tutorials_specification_md_autotoc_md3702}
\hypertarget{doc_tutorials_specification_md_autotoc_md3703}{}\doxysubsection{Step 1\+: Mount a Specification File}\label{doc_tutorials_specification_md_autotoc_md3703}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md3704}{}\doxysubsection{Step 2\+: Define a mountpoint}\label{doc_tutorials_specification_md_autotoc_md3704}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md3705}{}\doxysubsection{Step 3\+: Do a specification mount}\label{doc_tutorials_specification_md_autotoc_md3705}
...
This specification mount makes sure that the paths where the concrete configuration should be, in this case {\ttfamily app.\+ni}, are ready to fulfill or specification, in this case {\ttfamily spec.\+ni}.\hypertarget{doc_tutorials_specification_md_autotoc_md3706}{}\doxysection{Adding your first key to the specification}\label{doc_tutorials_specification_md_autotoc_md3706}
\hypertarget{doc_tutorials_specification_md_autotoc_md3707}{}\doxysubsection{Step 1\+: Adding the server port}\label{doc_tutorials_specification_md_autotoc_md3707}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md3708}{}\doxysubsection{Step 2\+: Adding more metadata}\label{doc_tutorials_specification_md_autotoc_md3708}
...
Did it work? I hope not. The validation plugin you specified will now correctly validate the port you enter and give you an error.\hypertarget{doc_tutorials_specification_md_autotoc_md3709}{}\doxysubsection{Step 3\+: Adding boolean keys}\label{doc_tutorials_specification_md_autotoc_md3709}
...
You can read more about this in the documentation for the \href{https://www.libelektra.org/plugins/type\#normalization}{\texttt{ type plugin}}.\hypertarget{doc_tutorials_specification_md_autotoc_md3710}{}\doxysection{Adding the database keys to the specification}\label{doc_tutorials_specification_md_autotoc_md3710}
\hypertarget{doc_tutorials_specification_md_autotoc_md3711}{}\doxysubsection{Step 1\+: Adding the database ip}\label{doc_tutorials_specification_md_autotoc_md3711}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md3712}{}\doxysubsection{Step 2\+: Adding the database dialect}\label{doc_tutorials_specification_md_autotoc_md3712}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md3713}{}\doxysection{Adding the backup date}\label{doc_tutorials_specification_md_autotoc_md3713}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md3714}{}\doxysection{Final specification code}\label{doc_tutorials_specification_md_autotoc_md3714}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_specification_md_autotoc_md3715}{}\doxysection{Summary}\label{doc_tutorials_specification_md_autotoc_md3715}
...
\end{DoxyItemize}\hypertarget{doc_tutorials_specification_md_autotoc_md3716}{}\doxysection{Learn more}\label{doc_tutorials_specification_md_autotoc_md3716}
