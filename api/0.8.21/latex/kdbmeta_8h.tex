\hypertarget{kdbmeta_8h}{}\section{kdbmeta.\+h File Reference}
...
\begin{center}
\leavevmode
\includegraphics[width=142pt]{kdbmeta_8h__incl}
\end{center}
\end{figure}
...
\item 
const char $\ast$ \hyperlink{kdbmeta_8h_af6485fb8599714b6bbd830cf915ffea5}{key\+Owner} (const Key $\ast$key)
\begin{DoxyCompactList}\small\item\em Return a pointer to the real internal {\ttfamily key} owner. \end{DoxyCompactList}\item 
ssize\+\_\+t \hyperlink{kdbmeta_8h_a4a4561895741ba2ad10acf007c188593}{key\+Get\+Owner\+Size} (const Key $\ast$key)
\begin{DoxyCompactList}\small\item\em Return the size of the owner of the Key with concluding 0. \end{DoxyCompactList}\item 
ssize\+\_\+t \hyperlink{kdbmeta_8h_a6d612841c829a638a8fbbbd4a31cc54a}{key\+Get\+Owner} (const Key $\ast$key, char $\ast$returned, size\+\_\+t max\+Size)
\begin{DoxyCompactList}\small\item\em Return the owner of the key. \end{DoxyCompactList}\item 
ssize\+\_\+t \hyperlink{kdbmeta_8h_aa899d9f0251cb98a89761ef112910eca}{key\+Set\+Owner} (Key $\ast$key, const char $\ast$owner)
...
ssize\+\_\+t \hyperlink{group__meta_gafb89735689929ff717cc9f2d0d0b46a2}{key\+Get\+Comment} (const Key $\ast$key, char $\ast$returned\+Desc, size\+\_\+t max\+Size)
\begin{DoxyCompactList}\small\item\em Get the key comment. \end{DoxyCompactList}\item 
ssize\+\_\+t \hyperlink{group__meta_ga8863a877a84fa46e6017fe72e49b89c1}{key\+Set\+Comment} (Key $\ast$key, const char $\ast$new\+Desc)
...
int \hyperlink{group__meta_gab8b30dfabb0867bd6899e60e7bd193a2}{elektra\+Key\+Cmp\+Order} (const Key $\ast$a, const Key $\ast$b)
\begin{DoxyCompactList}\small\item\em Compare the order metadata of two keys. \end{DoxyCompactList}\item 
Key\+Set $\ast$ \hyperlink{group__meta_gacee3e2d9285dd2bde975a09fdbe50502}{elektra\+Meta\+Array\+To\+KS} (Key $\ast$, const char $\ast$)
\begin{DoxyCompactList}\small\item\em Create a {\ttfamily Key\+Set} from a metakey array. \end{DoxyCompactList}\item 
void \hyperlink{group__meta_ga166c65c4eb2d758ced57b0bd74fb9a57}{elektra\+Meta\+Array\+Add} (Key $\ast$, const char $\ast$, const char $\ast$)
...
char $\ast$ \hyperlink{group__meta_ga04ceef7845af79a2628a2d4e9217bbb5}{elektra\+Meta\+Array\+To\+String} (Key $\ast$, const char $\ast$, const char $\ast$)
\begin{DoxyCompactList}\small\item\em returns the metakey array as a string separated by delim \end{DoxyCompactList}\item 
int \hyperlink{group__meta_gaadfae80314be2415a7654fe8a0d2ee82}{elektra\+Sort\+Topology} (Key\+Set $\ast$, Key $\ast$$\ast$)
...
\index{kdbmeta.\+h@{kdbmeta.\+h}!key\+Get\+Owner@{key\+Get\+Owner}}
\index{key\+Get\+Owner@{key\+Get\+Owner}!kdbmeta.\+h@{kdbmeta.\+h}}
\subsubsection{\texorpdfstring{key\+Get\+Owner()}{keyGetOwner()}}
...
Only {\ttfamily user/}... keys have a owner. For {\ttfamily system/}... keys (that doesn\textquotesingle{}t have a key owner) an empty string (\char`\"{}\char`\"{}) is returned.
...
\index{kdbmeta.\+h@{kdbmeta.\+h}!key\+Get\+Owner\+Size@{key\+Get\+Owner\+Size}}
\index{key\+Get\+Owner\+Size@{key\+Get\+Owner\+Size}!kdbmeta.\+h@{kdbmeta.\+h}}
\subsubsection{\texorpdfstring{key\+Get\+Owner\+Size()}{keyGetOwnerSize()}}
...
buffer = \hyperlink{internal_8c_a35cdc2e5caed3454cb73b4fc7f37858c}{elektraMalloc} (\hyperlink{owner_8c_a4a4561895741ba2ad10acf007c188593}{keyGetOwnerSize} (key));
...
\index{kdbmeta.\+h@{kdbmeta.\+h}!key\+Owner@{key\+Owner}}
\index{key\+Owner@{key\+Owner}!kdbmeta.\+h@{kdbmeta.\+h}}
\subsubsection{\texorpdfstring{key\+Owner()}{keyOwner()}}
...
\hyperlink{owner_8c_a88d6ec200ba0707b7c1b4a88133d2be4}{keySetOwner}(key,\textcolor{stringliteral}{""});
\hyperlink{owner_8c_af6485fb8599714b6bbd830cf915ffea5}{keyOwner}(key); \textcolor{comment}{// you would expect "" here}
\hyperlink{owner_8c_a88d6ec200ba0707b7c1b4a88133d2be4}{keySetOwner}(key,\textcolor{stringliteral}{"system"});
\hyperlink{owner_8c_af6485fb8599714b6bbd830cf915ffea5}{keyOwner}(key); \textcolor{comment}{// you would expect "" here}
\end{DoxyCode}
...
\index{kdbmeta.\+h@{kdbmeta.\+h}!key\+Set\+Owner@{key\+Set\+Owner}}
\index{key\+Set\+Owner@{key\+Set\+Owner}!kdbmeta.\+h@{kdbmeta.\+h}}
\subsubsection{\texorpdfstring{key\+Set\+Owner()}{keySetOwner()}}
...
A owner is a name of a system user related to a U\+ID. The owner decides on which location on the disc the key goes.
