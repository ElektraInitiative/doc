...
\Hypertarget{doc_tutorials_profiling_md_md_doc_tutorials_profiling}%
 \hypertarget{doc_tutorials_profiling_md_autotoc_md3665}{}\doxysection{Execution Time}\label{doc_tutorials_profiling_md_autotoc_md3665}
...
\begin{DoxyEnumerate}
\item \href{http://valgrind.org/docs/manual/cl-manual.html}{\texttt{ Callgrind}} and the graphical frontend \href{https://kcachegrind.github.io/html/Home.html}{\texttt{ KCache\+Grind/\+QCache\+Grind}}, and
...
\end{DoxyEnumerate}\hypertarget{doc_tutorials_profiling_md_autotoc_md3666}{}\doxysubsection{Callgrind}\label{doc_tutorials_profiling_md_autotoc_md3666}
\hypertarget{doc_tutorials_profiling_md_autotoc_md3667}{}\doxysubsubsection{Choosing the Correct Build Type}\label{doc_tutorials_profiling_md_autotoc_md3667}
...
. We use {\ttfamily Debug} here, which should provide the most detailed profiling information.\hypertarget{doc_tutorials_profiling_md_autotoc_md3668}{}\doxysubsubsection{Disabling $<$tt$>$dlclose$<$/tt$>$ Calls}\label{doc_tutorials_profiling_md_autotoc_md3668}
...
. An unfortunate effect of this code update is that Elektra will now leak memory when it unloads a plugin. On the other hand, Callgrind will be able to add source code information about the \mbox{\hyperlink{md_src_plugins_yajl_README}{YAJL}} plugin to the profiling output.\hypertarget{doc_tutorials_profiling_md_autotoc_md3669}{}\doxysubsubsection{Building Elektra}\label{doc_tutorials_profiling_md_autotoc_md3669}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_profiling_md_autotoc_md3670}{}\doxysubsubsection{Profiling the Code}\label{doc_tutorials_profiling_md_autotoc_md3670}
...
. You can now select different parts of the call graph on the left to check which parts of the code take a long time to execute.\hypertarget{doc_tutorials_profiling_md_autotoc_md3671}{}\doxysubsection{XRay}\label{doc_tutorials_profiling_md_autotoc_md3671}
\href{https://llvm.org/docs/XRay.html}{\texttt{ XRay}} is an extension for LLVM that adds profiling code to binaries. Profiling can be dynamically enabled and disabled via the environment variable {\ttfamily XRAY\+\_\+\+OPTIONS}.\hypertarget{doc_tutorials_profiling_md_autotoc_md3672}{}\doxysubsubsection{Choosing the Correct Build Type}\label{doc_tutorials_profiling_md_autotoc_md3672}
...
. We enable the static build ({\ttfamily BUILD\+\_\+\+STATIC=ON}) and disable the dynamic build ({\ttfamily BUILD\+\_\+\+SHARED=OFF}), since \href{http://clang-developers.42468.n3.nabble.com/Xray-with-shared-libraries-td4061859.html}{\texttt{ XRay currently does not support dynamic libraries}}. To enable Xray we use the compiler switch {\ttfamily -\/fxray-\/instrument}. To instrument every function we set the instruction threshold to {\ttfamily 1} with {\ttfamily -\/fxray-\/instruction-\/threshold=1}.
