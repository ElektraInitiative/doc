...
\Hypertarget{doc_help_kdb-merge_md_md_doc_help_kdb_merge}%
 \hypertarget{doc_help_kdb-merge_md_autotoc_md2946}{}\doxysection{SYNOPSIS}\label{doc_help_kdb-merge_md_autotoc_md2946}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-merge_md_autotoc_md2947}{}\doxysection{DESCRIPTION}\label{doc_help_kdb-merge_md_autotoc_md2947}
...
\hypertarget{doc_help_kdb-merge_md_autotoc_md2948}{}\doxysection{THREE-\/\+WAY MERGE}\label{doc_help_kdb-merge_md_autotoc_md2948}
...
\hypertarget{doc_help_kdb-merge_md_autotoc_md2949}{}\doxysection{CONFLICTS}\label{doc_help_kdb-merge_md_autotoc_md2949}
Conflicts occur when a Key has a different value in all three Key\+Sets.~\newline
 Conflicts in a merge can be resolved using a \href{\#STRATEGIES}{\texttt{ strategy}} with the {\ttfamily -\/s} option. To interactively resolve conflicts, use the {\ttfamily -\/i} option.\hypertarget{doc_help_kdb-merge_md_autotoc_md2950}{}\doxysection{OPTIONS}\label{doc_help_kdb-merge_md_autotoc_md2950}
...
\end{DoxyItemize}\hypertarget{doc_help_kdb-merge_md_autotoc_md2951}{}\doxysection{RETURN VALUE}\label{doc_help_kdb-merge_md_autotoc_md2951}

\begin{DoxyItemize}
\item 0\+: Successful.
\item 11\+: A conflict occurred during the merge.
\end{DoxyItemize}\hypertarget{doc_help_kdb-merge_md_autotoc_md2952}{}\doxysection{EXAMPLES}\label{doc_help_kdb-merge_md_autotoc_md2952}
...
\hypertarget{doc_help_kdb-merge_md_autotoc_md2953}{}\doxysection{SEE ALSO}\label{doc_help_kdb-merge_md_autotoc_md2953}
