...
\Hypertarget{doc_tutorials_logger_md_md_doc_tutorials_logger}%
 \hypertarget{doc_tutorials_logger_md_autotoc_md3648}{}\doxysection{Quickstart}\label{doc_tutorials_logger_md_autotoc_md3648}
...
The file sink behaves like syslog, if it has been enabled (see below).\hypertarget{doc_tutorials_logger_md_autotoc_md3649}{}\doxysection{Step by Step Guide}\label{doc_tutorials_logger_md_autotoc_md3649}
\hypertarget{doc_tutorials_logger_md_autotoc_md3650}{}\doxysubsection{Preparation}\label{doc_tutorials_logger_md_autotoc_md3650}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md3651}{}\doxysubsubsection{Log Everything}\label{doc_tutorials_logger_md_autotoc_md3651}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md3652}{}\doxysubsubsection{File Specific Logging}\label{doc_tutorials_logger_md_autotoc_md3652}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md3653}{}\doxysubsection{Enabling and Disabling Sinks}\label{doc_tutorials_logger_md_autotoc_md3653}
...
\end{DoxyCode}
\hypertarget{doc_tutorials_logger_md_autotoc_md3654}{}\doxysubsection{Compilation}\label{doc_tutorials_logger_md_autotoc_md3654}

\begin{DoxyEnumerate}
\item Enable the logger\+: e.\+g. run {\ttfamily cmake} with the switch {\ttfamily -\/DENABLE\+\_\+\+LOGGER=ON}
\item Build Elektra
\end{DoxyEnumerate}\hypertarget{doc_tutorials_logger_md_autotoc_md3655}{}\doxysection{Log Levels}\label{doc_tutorials_logger_md_autotoc_md3655}
