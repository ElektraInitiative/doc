...
This plugin reads and writes files written in a basic line-\/oriented ini-\/like format. It is very simplistic without sections, the toml plugin and for specifications the ni plugin should be preferred. Since the {\ttfamily simpleini} plugin requires the GNU C library it {\bfseries{will not work}} on operating systems that use another C library such as mac\+OS.\hypertarget{md_src_plugins_simpleini_README_autotoc_md508}{}\doxysection{Usage}\label{md_src_plugins_simpleini_README_autotoc_md508}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_simpleini_README_autotoc_md509}{}\doxysection{Configuration}\label{md_src_plugins_simpleini_README_autotoc_md509}
...
\end{DoxyCode}
\hypertarget{md_src_plugins_simpleini_README_autotoc_md510}{}\doxysection{Restrictions}\label{md_src_plugins_simpleini_README_autotoc_md510}
...
\end{DoxyItemize}\hypertarget{md_src_plugins_simpleini_README_autotoc_md511}{}\doxysection{Examples}\label{md_src_plugins_simpleini_README_autotoc_md511}
Mount the plugin\+:
...
\end{DoxyCode}
\hypertarget{md_src_plugins_simpleini_README_autotoc_md512}{}\doxysection{Limitations}\label{md_src_plugins_simpleini_README_autotoc_md512}
