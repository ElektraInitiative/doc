...
Note that the fallback, override and cascading works on {\itshape key level}, and not like most other systems have implemented, on configuration {\itshape file level}.\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md3171}{}\doxysection{Namespaces}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md3171}
...
\item it documents the keys (including lookup behavior and default value)
...
As always, API+\+ABI is stable and compatible.\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md3174}{}\doxysection{Proposed}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md3174}
Many new functions are proposed and can be found in \href{https://doc.libelektra.org/api/0.8.11/html}{\texttt{ the doxygen documentation}} and in \href{https://github.com/ElektraInitiative/libelektra/blob/master/src/include/kdbproposal.h}{\texttt{ kdbproposal.\+h}}.
...
Finally, a bunch of new lookup options were added, which might not be useful for the public API (they allow us to disable the specification-\/aware features mentioned in the beginning).\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md3175}{}\doxysection{Obsolete and removed concepts}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md3175}
\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md3176}{}\doxysubsection{umount}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md3176}
...
Old mountpoints need to be removed with their 0.\+8.\+10 name ({\ttfamily \+\_\+} instead of {\ttfamily /}).\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md3177}{}\doxysubsection{directory keys}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md3177}
Additionally, the so-\/called directory keys were also removed. Elektra was and still is completely key-\/value based. The {\ttfamily /} separator is only used for mountpoints.\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md3178}{}\doxysubsection{fstab}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md3178}
The plugin fstab is also improved\+: Slashes in mountpoints are escaped properly with the internal escaping engine of \mbox{\hyperlink{group__keyname_gaa942091fc4bd5c2699e49ddc50829524}{key\+Add\+Base\+Name()}} (i.\+e. without any problematic {\ttfamily /} replacements).\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md3179}{}\doxysubsection{dirname}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md3179}
get\+Dir\+Name() was removed from C++, gi-\/lua, gi-\/python2, gi-\/python3, swig-\/lua, swig-\/python2 and swig-\/python3. It was never present in C and did not fit well with \mbox{\hyperlink{group__keyname_gaaff35e7ca8af5560c47e662ceb9465f5}{key\+Base\+Name()}} (which returns an unescaped name, which is not possible for the dirname). (Thanks to Manuel Mausz)\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md3180}{}\doxysubsection{invalid parent names}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md3180}
...
should be used instead (if you want to get or store everything). They have identical behavior, except that invalid names (that cannot be distinguished from empty names) will produce a warning. In the next major version invalid parent\+Names will produce an error.\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md3181}{}\doxysection{KDB Behavior}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md3181}
...
Filesystem problems, e.\+g. permission, now always lead to the same errors (\#9, \#75, \#109, \#110), regardless of the storage plugin.\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md3182}{}\doxysection{Qt-\/\+Gui 0.\+0.\+6}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md3182}
...
A huge thanks to Raffael Pancheri for his contributions. His thesis can be found at \href{https://www.libelektra.org/ftp/elektra/publications/pancheri2015gui.pdf}{\texttt{ here}}.\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md3183}{}\doxysection{Bug fixing}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md3183}
...
\end{DoxyItemize}\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md3184}{}\doxysection{Further gems}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md3184}

\begin{DoxyItemize}
\item Examples were improved, added (e.\+g. cascading, namespace) and included in \href{https://doc.libelektra.org/api/0.8.11/html}{\texttt{ Doxygen documentation}}.
...
\end{DoxyItemize}\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md3185}{}\doxysection{Further Notes}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md3185}
...
already built API documentation can be found \href{https://doc.libelektra.org/api/0.8.11/html/}{\texttt{ here}}\hypertarget{doc_news_2015-04-03_0_8_11_md_autotoc_md3187}{}\doxysection{Stay tuned!}\label{doc_news_2015-04-03_0_8_11_md_autotoc_md3187}
